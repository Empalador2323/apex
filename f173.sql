...
prompt APPLICATION 173 - REGISTRO VALES TEST
--
-- Application Export:
--   Application:     173
--   Name:            REGISTRO VALES TEST
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,173)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'REGISTRO VALES TEST')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_405147173')
...
,p_authentication_id=>wwv_flow_api.id(320979831363135718)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20211117162116'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(213699595670133435)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(213699696790133435)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(213699875131133435)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(213700024551133435)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(213700137659133435)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(213700193081133435)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(320961532614135587)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(321164322106141456)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(320979521162135718)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(320981430428135720)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(321913113053182495)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(323067227504230909)
,p_tab_set=>'TS1'
,p_tab_sequence=>40
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(213718345795670357)
,p_tab_set=>'TS1'
,p_tab_sequence=>50
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(320981103029135720)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(320981519922135720)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320961612939135587)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320961703995135587)
,p_page_template_id=>wwv_flow_api.id(320961612939135587)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320961824674135592)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320961911695135592)
,p_page_template_id=>wwv_flow_api.id(320961824674135592)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962028722135592)
,p_page_template_id=>wwv_flow_api.id(320961824674135592)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962114551135592)
,p_page_template_id=>wwv_flow_api.id(320961824674135592)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962222053135592)
,p_page_template_id=>wwv_flow_api.id(320961824674135592)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962317465135592)
,p_page_template_id=>wwv_flow_api.id(320961824674135592)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320962405074135592)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962533335135592)
,p_page_template_id=>wwv_flow_api.id(320962405074135592)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962605217135592)
,p_page_template_id=>wwv_flow_api.id(320962405074135592)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962717045135592)
,p_page_template_id=>wwv_flow_api.id(320962405074135592)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962832572135592)
,p_page_template_id=>wwv_flow_api.id(320962405074135592)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320962925468135592)
,p_page_template_id=>wwv_flow_api.id(320962405074135592)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963028598135592)
,p_page_template_id=>wwv_flow_api.id(320962405074135592)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320963123950135592)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963230005135592)
,p_page_template_id=>wwv_flow_api.id(320963123950135592)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963322913135592)
,p_page_template_id=>wwv_flow_api.id(320963123950135592)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963419122135592)
,p_page_template_id=>wwv_flow_api.id(320963123950135592)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963504603135592)
,p_page_template_id=>wwv_flow_api.id(320963123950135592)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320963609658135592)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963713993135592)
,p_page_template_id=>wwv_flow_api.id(320963609658135592)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963809264135592)
,p_page_template_id=>wwv_flow_api.id(320963609658135592)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320963909669135592)
,p_page_template_id=>wwv_flow_api.id(320963609658135592)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964003451135592)
,p_page_template_id=>wwv_flow_api.id(320963609658135592)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964112166135592)
,p_page_template_id=>wwv_flow_api.id(320963609658135592)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320964207920135632)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964317203135632)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964417554135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964528619135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964615992135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964706782135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964806276135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320964917268135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965021802135634)
,p_page_template_id=>wwv_flow_api.id(320964207920135632)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320965113713135634)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965203450135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965308244135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965424487135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965527169135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965608896135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965706943135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320965818787135634)
,p_page_template_id=>wwv_flow_api.id(320965113713135634)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320965905614135634)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966030335135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966105784135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966222153135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966304439135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966409399135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966513437135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966612049135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966701060135634)
,p_page_template_id=>wwv_flow_api.id(320965905614135634)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320966832128135634)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320966922674135634)
,p_page_template_id=>wwv_flow_api.id(320966832128135634)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967018208135634)
,p_page_template_id=>wwv_flow_api.id(320966832128135634)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967102192135634)
,p_page_template_id=>wwv_flow_api.id(320966832128135634)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967228289135634)
,p_page_template_id=>wwv_flow_api.id(320966832128135634)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967318220135634)
,p_page_template_id=>wwv_flow_api.id(320966832128135634)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967408352135634)
,p_page_template_id=>wwv_flow_api.id(320966832128135634)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320967518582135656)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967615281135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967711294135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967808736135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320967933149135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968025421135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968105608135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968232493135656)
,p_page_template_id=>wwv_flow_api.id(320967518582135656)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320968306567135656)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968418714135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968512575135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968627762135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968713462135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968801245135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320968920504135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969008397135657)
,p_page_template_id=>wwv_flow_api.id(320968306567135656)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320969128991135657)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969228695135657)
,p_page_template_id=>wwv_flow_api.id(320969128991135657)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320969302776135657)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969422195135657)
,p_page_template_id=>wwv_flow_api.id(320969302776135657)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969516020135657)
,p_page_template_id=>wwv_flow_api.id(320969302776135657)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969620230135657)
,p_page_template_id=>wwv_flow_api.id(320969302776135657)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969733600135657)
,p_page_template_id=>wwv_flow_api.id(320969302776135657)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320969821126135657)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320969929260135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970012505135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970106517135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970209397135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970303573135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970425394135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970507310135657)
,p_page_template_id=>wwv_flow_api.id(320969821126135657)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320970609555135668)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970724125135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970805346135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320970917282135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971025851135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971124701135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971200992135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971331312135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971403811135668)
,p_page_template_id=>wwv_flow_api.id(320970609555135668)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320971506790135681)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971621130135681)
,p_page_template_id=>wwv_flow_api.id(320971506790135681)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971720336135681)
,p_page_template_id=>wwv_flow_api.id(320971506790135681)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971830782135681)
,p_page_template_id=>wwv_flow_api.id(320971506790135681)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320971920657135681)
,p_page_template_id=>wwv_flow_api.id(320971506790135681)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972024608135681)
,p_page_template_id=>wwv_flow_api.id(320971506790135681)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972103450135681)
,p_page_template_id=>wwv_flow_api.id(320971506790135681)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(320972222744135681)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972317953135681)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972416510135681)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972519733135682)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972626861135682)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972729531135682)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972812058135682)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(320972902850135682)
,p_page_template_id=>wwv_flow_api.id(320972222744135681)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(320978432251135710)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(320978501753135710)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(320978610158135710)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(320978714071135710)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(320978823445135715)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(320978925314135715)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973024650135682)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973124330135682)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973206461135682)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973303882135692)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973404775135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973501292135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973607046135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973711782135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320973809539135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(320973930656135693)
,p_plug_template_id=>wwv_flow_api.id(320973809539135693)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974003740135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974113517135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974206593135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974310131135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(320974432563135693)
,p_plug_template_id=>wwv_flow_api.id(320974310131135693)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974502051135693)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974610818135696)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320974731945135696)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(320974811586135696)
,p_plug_template_id=>wwv_flow_api.id(320974731945135696)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(320974917151135696)
,p_plug_template_id=>wwv_flow_api.id(320974731945135696)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320975012996135696)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(320975112169135696)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976320726135700)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976425638135701)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976513193135701)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976606830135701)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976733004135701)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976823412135701)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320976907658135701)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977003239135701)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977103256135701)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977215192135701)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977325305135707)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977401834135707)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977502778135707)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(320977628223135707)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975228290135696)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975325501135696)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975409147135696)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975502604135698)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975604139135698)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975720005135698)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975814830135698)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320975933223135698)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320976005098135700)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320976113692135700)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(320976230612135700)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320977731320135707)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320977827204135707)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320977902310135707)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320978012473135710)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320978114244135710)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320978232699135710)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(320978301591135710)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(320979010862135715)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(320979224688135717)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(320979132750135715)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(320979304004135717)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(320966832128135634)
,p_error_template=>wwv_flow_api.id(320963123950135592)
,p_printer_friendly_template=>wwv_flow_api.id(320969302776135657)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(320961612939135587)
,p_default_button_template=>wwv_flow_api.id(320978432251135710)
,p_default_region_template=>wwv_flow_api.id(320974731945135696)
,p_default_chart_template=>wwv_flow_api.id(320974731945135696)
,p_default_form_template=>wwv_flow_api.id(320973809539135693)
,p_default_reportr_template=>wwv_flow_api.id(320974731945135696)
,p_default_tabform_template=>wwv_flow_api.id(320974731945135696)
,p_default_wizard_template=>wwv_flow_api.id(320973809539135693)
,p_default_menur_template=>wwv_flow_api.id(320973303882135692)
,p_default_listr_template=>wwv_flow_api.id(320974731945135696)
,p_default_irr_template=>wwv_flow_api.id(320974206593135693)
,p_default_report_template=>wwv_flow_api.id(320975814830135698)
,p_default_label_template=>wwv_flow_api.id(320977902310135707)
,p_default_menu_template=>wwv_flow_api.id(320979010862135715)
,p_default_calendar_template=>wwv_flow_api.id(320979132750135715)
,p_default_list_template=>wwv_flow_api.id(320977401834135707)
,p_default_option_label=>wwv_flow_api.id(320977902310135707)
,p_default_required_label=>wwv_flow_api.id(320978232699135710)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(213719777689670374)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(320979604875135718)
,p_name=>'ASIGNACION'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(320979725707135718)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(320979831363135718)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
,p_attribute_03=>'custom_auth'
,p_attribute_05=>'N'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(320980031478135718)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(320979411164135717)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(320979411164135717)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(320981628803135721)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320973303882135692)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(320981103029135720)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(320979010862135715)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(321033408623506587)
,p_plug_name=>'INGRESO_INTERNO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320974731945135696)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(321564008772780435)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(321033408623506587)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320974731945135696)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(321896108679886737)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(321901525180957676)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(321033711763506607)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(321033408623506587)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(320978432251135710)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(321033930171506607)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(321033607946506607)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(321034212120506612)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(210946745692407116)
,p_name=>'P1_GALVIAJE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(321896108679886737)
,p_prompt=>'Galviaje'
...
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(320977902310135707)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(223549278381814311)
,p_name=>'P1_CENTRO_COSTO'
,p_item_sequence=>86
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(249121638279346326)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(249121711904346327)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321034410380506617)
,p_name=>'P1_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(321033408623506587)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321034611228506625)
,p_name=>'P1_NMVALE'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(321901525180957676)
,p_use_cache_before_default=>'NO'
...
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(320978232699135710)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321034808013506626)
,p_name=>'P1_FECHA'
,p_item_sequence=>23
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321035019633506626)
,p_name=>'P1_NOTAVIAJE'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(321901525180957676)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321035215128506626)
,p_name=>'P1_CDCLASACT'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321035416864506631)
,p_name=>'P1_CORRACT'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321035616223506632)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321036232474506637)
,p_name=>'P1_CDTIPCOMB'
,p_item_sequence=>12
,p_item_plug_id=>wwv_flow_api.id(321896108679886737)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321036415879506639)
,p_name=>'P1_NMBOMBA'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(321901525180957676)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321036605572506639)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321036814000506640)
,p_name=>'P1_NMORDENC'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(321896108679886737)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321037214331506640)
,p_name=>'P1_KMRETORNO'
,p_item_sequence=>4.5
,p_item_plug_id=>wwv_flow_api.id(321901525180957676)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321037616262506642)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321037819475506643)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321038016596506643)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321100525873100879)
,p_name=>'P1_CDRECIBE'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_prompt=>'Piloto'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321136813399124690)
,p_name=>'P1_CDEMPRESA'
,p_item_sequence=>36
,p_item_plug_id=>wwv_flow_api.id(321033408623506587)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321673210685053995)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321830925325791371)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321846126348125170)
,p_name=>'P1_KM_GLN'
,p_item_sequence=>66
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_prompt=>'Km/Gln'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321846315565130175)
,p_name=>'P1_DISTANCIA'
,p_item_sequence=>76
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_prompt=>'Distancia'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322806414874024926)
,p_name=>'P1_KMSALE'
,p_item_sequence=>75
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322813601873106818)
,p_name=>'P1_RECORRIDO'
,p_item_sequence=>96
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322926224442573031)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322927525508587798)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(324496920117411617)
,p_name=>'P1_ESTADO'
,p_item_sequence=>106
,p_item_plug_id=>wwv_flow_api.id(321564008772780435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(245709984133523633)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(322813601873106818)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(210946818864407117)
...
,p_when_button_pressed=>wwv_flow_api.id(321033607946506607)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(245710299737523636)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(245710573174523638)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(219839247267581801)
,p_name=>'salida'
,p_event_sequence=>5
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322814415731117393)
,p_event_id=>wwv_flow_api.id(219839247267581801)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(324501227981479550)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(324501512854479559)
,p_event_id=>wwv_flow_api.id(324501227981479550)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(321564805009807826)
,p_name=>'cargar datos'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321565104253807862)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321569314287946248)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321570415137961110)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
begin
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321583219320384589)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321614005521712856)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321618716230799081)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321689913492842821)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321873103572561179)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(321874022107567820)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322934222630680310)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322934932107691075)
,p_event_id=>wwv_flow_api.id(321564805009807826)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(249121855086346328)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(249121924691346329)
,p_event_id=>wwv_flow_api.id(249121855086346328)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(321040410137506648)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(321040610297506651)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(324018520218748831)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(321033607946506607)
,p_process_success_message=>'ACTUALIZADO'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(210946888272407118)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(321040828487506651)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20211110104950'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(321929708509974778)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(322011812851507526)
,p_plug_name=>'NUEVO VALE'
,p_parent_plug_id=>wwv_flow_api.id(321929708509974778)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320974731945135696)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(322013030990522189)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(321929708509974778)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(321930103688974790)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(321929708509974778)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(320978432251135710)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(321929905178974789)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(321929708509974778)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(321930319790974803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(223549521082814313)
,p_name=>'ORIGEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(321929708509974778)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321930517900974890)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(321929708509974778)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321930706400974907)
,p_name=>'P2_NMVALE'
,p_is_required=>true
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(322011812851507526)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Numero de Vale'
,p_source=>'NMVALE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321930930912974915)
,p_name=>'P2_FECHA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(322013030990522189)
,p_use_cache_before_default=>'NO'
,p_item_default=>'SYSDATE'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Fecha'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321931114179974915)
,p_name=>'P2_NOTAVIAJE'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(322011812851507526)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321931325354974915)
,p_name=>'P2_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(322013030990522189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321931522254974917)
,p_name=>'P2_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(322013030990522189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321931918783974917)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321932131283974917)
,p_name=>'P2_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(321929708509974778)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321932327089974918)
,p_name=>'P2_CDTIPCOMB'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(321929708509974778)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321932510290974918)
,p_name=>'P2_NMBOMBA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(321929708509974778)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321932728700974918)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321932917819974920)
,p_name=>'P2_NMORDENC'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(321929708509974778)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321933111630974920)
,p_name=>'P2_KMSALE'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(322013030990522189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321933312431974920)
,p_name=>'P2_KMRETORNO'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(322011812851507526)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321933528199974921)
,p_name=>'P2_RECORRIDO'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(322013030990522189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321933721382974921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321933931993974921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321934105009974921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321934333600974923)
,p_name=>'P2_NOBOMBA'
,p_is_required=>true
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(322011812851507526)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321934529136974925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321934717055974925)
,p_name=>'P2_NOFACTURA'
,p_is_required=>true
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(322011812851507526)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(321956531659341131)
,p_name=>'P2_CDRECIBE'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(322013030990522189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322029527506005653)
,p_name=>'P2_TOTAL'
,p_item_sequence=>71
,p_item_plug_id=>wwv_flow_api.id(322011812851507526)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322640108943240631)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322931731066645998)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(322932017264652337)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(325073732204009098)
...
,p_when_button_pressed=>wwv_flow_api.id(321929905178974789)
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(322640621040270867)
,p_name=>'galon'
,p_event_sequence=>4
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322640912088270881)
,p_event_id=>wwv_flow_api.id(322640621040270867)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(322484231383926376)
,p_name=>'Precio'
,p_event_sequence=>5
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322484512559926379)
,p_event_id=>wwv_flow_api.id(322484231383926376)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(322470318065685978)
,p_name=>'INGRESO_EXTERNO'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322470602775685993)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322477727854820023)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322478019658823898)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322478302621831767)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322478718352839659)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322935419599696825)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322935708169702179)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322936429722707326)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(322936613548714871)
,p_event_id=>wwv_flow_api.id(322470318065685978)
,p_event_result=>'TRUE'
,p_action_sequence=>100
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(220728731616655825)
,p_name=>'recorre'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_KMRETORNO'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(220728848289655826)
,p_event_id=>wwv_flow_api.id(220728731616655825)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(321937200937974937)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(321937427394974957)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(322884106032627176)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'km'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(321929905178974789)
);
end;
/
begin
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(252206659542343537)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(321937616887974957)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213726723718670468)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320974206593135693)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(213727094925670468)
,p_name=>'Report 1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213727247038670510)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213727502166670585)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213727933436670587)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213728342089670588)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213728772036670590)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213729145513670591)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213729535381670593)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213729971092670594)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213730342482670596)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213730618573670602)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213731026653670602)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213731444667670605)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(213732319956671030)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(323071006575258304)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(323071222979258304)
,p_name=>'ANULAR VALE'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323071310784258315)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323071431449258317)
,p_db_column_name=>'NMVALE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmvale'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323071515348258318)
,p_db_column_name=>'FECHA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323071604892258320)
,p_db_column_name=>'NOTAVIAJE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Notaviaje'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323071906706258325)
,p_db_column_name=>'CANTDESPACHA'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cantdespacha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072016933258326)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072115676258328)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072206753258329)
,p_db_column_name=>'CDTIPCOMB'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Cdtipcomb'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072332310258331)
,p_db_column_name=>'NMBOMBA'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Nmbomba'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072402925258332)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072512695258334)
,p_db_column_name=>'NMORDENC'
,p_display_order=>13
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072608169258337)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072712777258339)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323072804578258340)
,p_db_column_name=>'RECORRIDO'
,p_display_order=>16
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323073231740258350)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323073320660258351)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323145007702929939)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(323145128921929939)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(219839016724581799)
,p_db_column_name=>'CDDELEGACION'
,p_display_order=>33
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(323073514145258554)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(221707606154280729)
,p_report_id=>wwv_flow_api.id(323073514145258554)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(221707980167280729)
,p_report_id=>wwv_flow_api.id(323073514145258554)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'CDDELEGACION'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213718570915670359)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320973809539135693)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(213719058088670362)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(213718570915670359)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(320978432251135710)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(213719246288670362)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(213718570915670359)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(213721110153670385)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213721566766670387)
,p_name=>'P6_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(213718570915670359)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213721922391670407)
,p_name=>'P6_NMVALE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(213718570915670359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213722209311670429)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213722596878670432)
,p_name=>'P6_NMBOMBA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(213718570915670359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213723004518670434)
,p_name=>'P6_NMORDENC'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(213718570915670359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213725055068670435)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(210946237750407111)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(213719058088670362)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213725450482670441)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213725789924670441)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20211109160544'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(323068705044258270)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320973809539135693)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(323068910345258273)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(323068705044258270)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(320978432251135710)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(323069114588258273)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(323068705044258270)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(323069326465258275)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(219839092340581800)
,p_name=>'P7_CDDELEGACION'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Delegacion'
,p_source=>'CDDELEGACION'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(252206484435343536)
,p_name=>'P7_NOTAVIAJE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323069520491258278)
,p_name=>'P7_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323069702734258282)
,p_name=>'P7_NMVALE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323069921176258289)
,p_name=>'P7_ESTADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323783122103802465)
,p_name=>'P7_RECORRIDO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323783606360809700)
,p_name=>'P7_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323783832873812660)
,p_name=>'P7_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323784831998828187)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323785126607830776)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(325086822745241353)
,p_name=>'P7_KMRETORNO'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(323068705044258270)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323070533142258292)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323070704824258292)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323785706822840465)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'KM'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(323068910345258273)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(342034308794215317)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(252206408512343535)
,p_process_sequence=>46
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323070912204258292)
,p_process_sequence=>56
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(320961612939135587)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(320980306333135718)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(320973809539135693)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(320980610223135720)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(320980306333135718)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(320980433167135720)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(320980306333135718)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(320980505244135720)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(320980832252135720)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(320980733383135720)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(320981023585135720)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(320980912457135720)
,p_process_sequence=>10
