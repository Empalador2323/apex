...
,p_default_application_id=>398
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 398 - SUPER
--
-- Application Export:
--   Application:     398
--   Name:            SUPER
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,398)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'SUPER')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_398')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'84EB3284F54EF6A5DD5405FA713995E403A03DED1B7CE4E260E51769B4FE712B'
...
,p_authentication_id=>wwv_flow_api.id(100930112027635084)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:SUPER'
...
,p_last_upd_yyyymmddhh24miss=>'20201020163009'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16942015163094356)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16942107641094356)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16942237483094356)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16942486783094356)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16942524180094356)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16942651273094358)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(100911803756634926)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(107912115711483204)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(100929825026635078)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(100931519822635131)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_PAGE_1'
,p_tab_text=>'Page 1'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(100931210669635125)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100911932642634939)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912021722634956)
,p_page_template_id=>wwv_flow_api.id(100911932642634939)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100912130101634960)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912218883634960)
,p_page_template_id=>wwv_flow_api.id(100912130101634960)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912316487634960)
,p_page_template_id=>wwv_flow_api.id(100912130101634960)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912431275634960)
,p_page_template_id=>wwv_flow_api.id(100912130101634960)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912500072634960)
,p_page_template_id=>wwv_flow_api.id(100912130101634960)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912619174634960)
,p_page_template_id=>wwv_flow_api.id(100912130101634960)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100912713043634960)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912807737634962)
,p_page_template_id=>wwv_flow_api.id(100912713043634960)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100912926285634962)
,p_page_template_id=>wwv_flow_api.id(100912713043634960)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913025431634962)
,p_page_template_id=>wwv_flow_api.id(100912713043634960)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913129743634962)
,p_page_template_id=>wwv_flow_api.id(100912713043634960)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913230205634962)
,p_page_template_id=>wwv_flow_api.id(100912713043634960)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913327589634962)
,p_page_template_id=>wwv_flow_api.id(100912713043634960)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100913419552634962)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913526413634964)
,p_page_template_id=>wwv_flow_api.id(100913419552634962)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913602010634964)
,p_page_template_id=>wwv_flow_api.id(100913419552634962)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913703347634964)
,p_page_template_id=>wwv_flow_api.id(100913419552634962)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100913808485634964)
,p_page_template_id=>wwv_flow_api.id(100913419552634962)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100913905189634964)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914011015634964)
,p_page_template_id=>wwv_flow_api.id(100913905189634964)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914119443634964)
,p_page_template_id=>wwv_flow_api.id(100913905189634964)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914205807634964)
,p_page_template_id=>wwv_flow_api.id(100913905189634964)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914327537634964)
,p_page_template_id=>wwv_flow_api.id(100913905189634964)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914404928634964)
,p_page_template_id=>wwv_flow_api.id(100913905189634964)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100914500058634964)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914607734634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914701703634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914813485634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100914928687634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915023983634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915117814634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915203090634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915310505634964)
,p_page_template_id=>wwv_flow_api.id(100914500058634964)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100915410902634964)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915525379634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915605945634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915722154634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915829437634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100915923621634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916002461634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916104444634964)
,p_page_template_id=>wwv_flow_api.id(100915410902634964)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100916216598634964)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916318142634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916402392634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916525737634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916617277634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916729628634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916800078634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100916900896634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917002953634965)
,p_page_template_id=>wwv_flow_api.id(100916216598634964)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100917130672634967)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917219867634967)
,p_page_template_id=>wwv_flow_api.id(100917130672634967)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917328005634967)
,p_page_template_id=>wwv_flow_api.id(100917130672634967)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917425812634967)
,p_page_template_id=>wwv_flow_api.id(100917130672634967)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917530893634967)
,p_page_template_id=>wwv_flow_api.id(100917130672634967)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917625403634967)
,p_page_template_id=>wwv_flow_api.id(100917130672634967)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917731160634967)
,p_page_template_id=>wwv_flow_api.id(100917130672634967)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100917831432634967)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100917922596634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918007161634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918102603634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918213037634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918307134634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918421913634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918523997634968)
,p_page_template_id=>wwv_flow_api.id(100917831432634967)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100918627056634970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918710842634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918806985634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100918916666634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919032118634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919115785634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919227717634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919306199634970)
,p_page_template_id=>wwv_flow_api.id(100918627056634970)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100919421473634970)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919509095634970)
,p_page_template_id=>wwv_flow_api.id(100919421473634970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100919627338634970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919732041634970)
,p_page_template_id=>wwv_flow_api.id(100919627338634970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919817762634970)
,p_page_template_id=>wwv_flow_api.id(100919627338634970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100919910620634970)
,p_page_template_id=>wwv_flow_api.id(100919627338634970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920032574634970)
,p_page_template_id=>wwv_flow_api.id(100919627338634970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100920128743634971)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920206911634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920320498634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920415262634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920521889634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920602663634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920708536634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100920802855634971)
,p_page_template_id=>wwv_flow_api.id(100920128743634971)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100920915103634971)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921023603634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921118071634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921231304634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921309469634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921410367634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921514675634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921608904634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921723270634971)
,p_page_template_id=>wwv_flow_api.id(100920915103634971)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100921821929634971)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100921911142634973)
,p_page_template_id=>wwv_flow_api.id(100921821929634971)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922002099634973)
,p_page_template_id=>wwv_flow_api.id(100921821929634971)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922129103634973)
,p_page_template_id=>wwv_flow_api.id(100921821929634971)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922217768634973)
,p_page_template_id=>wwv_flow_api.id(100921821929634971)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922300792634973)
,p_page_template_id=>wwv_flow_api.id(100921821929634971)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922428811634973)
,p_page_template_id=>wwv_flow_api.id(100921821929634971)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100922503959634973)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922623569634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922701186634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922801325634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100922909309634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100923020006634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100923102404634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100923218433634973)
,p_page_template_id=>wwv_flow_api.id(100922503959634973)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(100928719959635026)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(100928815182635032)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(100928925603635032)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(100929024127635032)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(100929125102635032)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(100929201058635032)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923305280634975)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923424609634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923523684634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923610470634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923704093634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923801151634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100923907049634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924018268634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924104678634989)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(100924201039634990)
,p_plug_template_id=>wwv_flow_api.id(100924104678634989)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924313848634990)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924411380634990)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924518751634990)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924607292634992)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(100924726861634992)
,p_plug_template_id=>wwv_flow_api.id(100924607292634992)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924802293634992)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100924923486634993)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100925016664634993)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(100925120509634993)
,p_plug_template_id=>wwv_flow_api.id(100925016664634993)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(100925217360634993)
,p_plug_template_id=>wwv_flow_api.id(100925016664634993)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100925319970634993)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(100925427116634993)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100926628548635014)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100926712446635021)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100926811596635021)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100926923700635021)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927005172635021)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927112602635021)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927230771635021)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927316837635021)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927414323635021)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927524383635021)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927629523635021)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927713224635021)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927812540635021)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(100927902468635021)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100925527786634995)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100925625798635010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100925732595635010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100925807422635010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100925914503635010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100926010072635010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100926131963635012)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100926207650635012)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100926310350635012)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100926416879635012)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(100926509668635012)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928016761635023)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928103964635026)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928200662635026)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928321912635026)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928406134635026)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928528618635026)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(100928619994635026)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(100929323901635034)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(100929512176635048)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(100929414510635039)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(100929630816635062)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(100917130672634967)
,p_error_template=>wwv_flow_api.id(100913419552634962)
,p_printer_friendly_template=>wwv_flow_api.id(100919627338634970)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(100911932642634939)
,p_default_button_template=>wwv_flow_api.id(100928719959635026)
,p_default_region_template=>wwv_flow_api.id(100925016664634993)
,p_default_chart_template=>wwv_flow_api.id(100925016664634993)
,p_default_form_template=>wwv_flow_api.id(100924104678634989)
,p_default_reportr_template=>wwv_flow_api.id(100925016664634993)
,p_default_tabform_template=>wwv_flow_api.id(100925016664634993)
,p_default_wizard_template=>wwv_flow_api.id(100924104678634989)
,p_default_menur_template=>wwv_flow_api.id(100923610470634989)
,p_default_listr_template=>wwv_flow_api.id(100925016664634993)
,p_default_irr_template=>wwv_flow_api.id(100924518751634990)
,p_default_report_template=>wwv_flow_api.id(100926131963635012)
,p_default_label_template=>wwv_flow_api.id(100928200662635026)
,p_default_menu_template=>wwv_flow_api.id(100929323901635034)
,p_default_calendar_template=>wwv_flow_api.id(100929414510635039)
,p_default_list_template=>wwv_flow_api.id(100927713224635021)
,p_default_option_label=>wwv_flow_api.id(100928200662635026)
,p_default_required_label=>wwv_flow_api.id(100928528618635026)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(100929913272635081)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(100930017577635084)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(100930112027635084)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(100929719691635064)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(100929719691635064)
,p_tab_set=>'TS1'
,p_name=>'Page 1'
,p_step_title=>'Page 1'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100931709407635143)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(100923610470634989)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(100931210669635125)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(100929323901635034)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100935616234709728)
,p_plug_name=>'PILOTO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(100925016664634993)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(100938314596765982)
,p_name=>'Viajes'
,p_parent_plug_id=>wwv_flow_api.id(100935616234709728)
,p_template=>wwv_flow_api.id(100924313848634990)
...
'select fechasale fecha, dscliente cliente, cdclaseuni||'' '' ||correlativouni unidad    from tnotaviaje a inner join tclientes b on a.cddestino=b.cdcliente where pilotodes = :P1_PILOTO ',
'order by 1 desc'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_PILOTO'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(100925527786634995)
,p_query_num_rows=>10
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100938607909765995)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100938712629765996)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(101334523434163512)
,p_query_column_id=>3
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(100939002737781529)
,p_name=>'Unidades'
,p_parent_plug_id=>wwv_flow_api.id(100935616234709728)
,p_template=>wwv_flow_api.id(100924313848634990)
...
,p_source_type=>'NATIVE_SQL_REPORT'
,p_query_type=>'SQL'
,p_source=>'select distinct(cdclaseuni||''-''||correlativouni) unidad  from tnotaviaje a inner join tclientes b on a.cddestino=b.cdcliente where pilotodes = :P1_PILOTO order by 1 desc'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_PILOTO'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(100925527786634995)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100939314782781535)
,p_query_column_id=>1
,p_column_alias=>'UNIDAD'
,p_column_display_sequence=>1
,p_column_heading=>'UNIDAD'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(100942003786857503)
,p_name=>'hallazgos'
,p_parent_plug_id=>wwv_flow_api.id(100935616234709728)
,p_template=>wwv_flow_api.id(100924313848634990)
...
'          FROM empleados',
'         WHERE cod_emp = a.cdresponsable)',
'           supervisor,',
'     --  cdpiloto,',
'       --(SELECT nombres || '' '' || apellidos FROM empleados',
'--         WHERE cod_emp = a.cdpiloto)',
'  --         Piloto,',
'       a.comentario_final,',
'       fecha,',
'      -- evaluacion,',
'       anunciada,',
'         (select distinct(tipo) from tcat_supervision c  where c.nmexamen =evaluacion)',
'       Supervision,',
'       b.item,',
'       b.descripcion,',
'       cumple,',
'       --aplica,',
'       DECODE (tipo_descarga,',
'               1, ''GRAVEDAD'',',
'               2, ''BOMBA PORTATIL'',',
'               3, ''BOMBA INCORPORADA'')',
'           AS Ttipo_descarga',
'  FROM tsupervision a INNER JOIN tsupervision_det b ON a.nmsuper = b.nmsuper',
' WHERE fecha >=''01/01/2020'' AND fecha <= to_date(sysdate, ''dd/mm/yyyy'') and ',
'  aplica=''SI'' and cumple =''NO'' and cdpiloto=:p1_piloto',
'  order by fecha desc, evaluacion, item'))
,p_header=>'<div style="overflow:auto;">'
,p_footer=>'</div>'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_PILOTO'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(100925807422635010)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_break_cols=>'0'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100942300919857510)
,p_query_column_id=>1
,p_column_alias=>'NMSUPER'
,p_column_display_sequence=>1
,p_column_heading=>'NMSUPER'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100942413781857510)
,p_query_column_id=>2
,p_column_alias=>'CDRESPONSABLE'
,p_column_display_sequence=>2
,p_column_heading=>'CDRESPONSABLE'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100942518723857510)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100942803432857510)
,p_query_column_id=>4
,p_column_alias=>'COMENTARIO_FINAL'
,p_column_display_sequence=>4
,p_column_heading=>'COMENTARIO_FINAL'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100942917098857510)
,p_query_column_id=>5
,p_column_alias=>'FECHA'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100943026371857510)
,p_query_column_id=>6
,p_column_alias=>'ANUNCIADA'
,p_column_display_sequence=>6
,p_column_heading=>'ANUNCIADA'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100944629847864426)
,p_query_column_id=>7
,p_column_alias=>'SUPERVISION'
,p_column_display_sequence=>11
,p_column_heading=>'Supervision'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100943227441857512)
,p_query_column_id=>8
,p_column_alias=>'ITEM'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100943315112857512)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100943423997857512)
,p_query_column_id=>10
,p_column_alias=>'CUMPLE'
,p_column_display_sequence=>9
,p_column_heading=>'CUMPLE'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100943605398857512)
,p_query_column_id=>11
,p_column_alias=>'TTIPO_DESCARGA'
,p_column_display_sequence=>10
,p_column_heading=>'TTIPO_DESCARGA'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(101328925475023248)
,p_name=>'Ultimas Supervisiones'
,p_parent_plug_id=>wwv_flow_api.id(100935616234709728)
,p_template=>wwv_flow_api.id(100924313848634990)
...
,p_query_type=>'SQL'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select a.fecha,cdresponsable,(SELECT nombre FROM v_nombre_empleado WHERE empleado = a.cdresponsable) supervisor , ''EVALUACION'' as tipo   from (',
'select * from tsupervision order by fecha desc)a  where cdpiloto=66 and evaluacion=''3'' and rownum<=1',
'union all ',
'select a.fecha,cdresponsable,(SELECT nombre FROM v_nombre_empleado WHERE empleado = a.cdresponsable) supervisor , ''DESCARGA'' as tipo   from (',
'select * from tsupervision order by fecha desc) a where cdpiloto=66 and evaluacion=''2'' and rownum<=1',
'union all',
'select a.fecha,cdresponsable,(SELECT nombre FROM v_nombre_empleado WHERE empleado = a.cdresponsable) supervisor , ''CARGA'' as tipo   from (',
'select * from tsupervision order by fecha desc) a where cdpiloto=66 and evaluacion=''1'' and rownum<=1'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_PILOTO'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(100926131963635012)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_show_nulls_as=>' - '
,p_query_no_data_found=>'no data found'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(101329201789023295)
,p_query_column_id=>1
,p_column_alias=>'FECHA'
,p_column_display_sequence=>1
,p_column_heading=>'FECHA'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(101329302232023296)
,p_query_column_id=>2
,p_column_alias=>'CDRESPONSABLE'
,p_column_display_sequence=>2
,p_column_heading=>'CDRESPONSABLE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(101329408812023296)
,p_query_column_id=>3
,p_column_alias=>'SUPERVISOR'
,p_column_display_sequence=>3
,p_column_heading=>'SUPERVISOR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(101329522598023296)
,p_query_column_id=>4
,p_column_alias=>'TIPO'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(107924615720740451)
,p_name=>'OT'
,p_parent_plug_id=>wwv_flow_api.id(100935616234709728)
,p_template=>wwv_flow_api.id(100924313848634990)
...
,p_query_type=>'SQL'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Select fecrea, nmorden, unidad, dsrepara, cdasignado from  tordenserv where estado=''A''  and unidad=:P1_UNIDAD',
'union all ',
'Select fecrea, nmorden, unidad, dsrepara, cdasignado from  tordenserv where estado=''A''  and unidad=:P1_COMPLEMENTO',
'union all ',
'Select fecrea, nmorden, unidad, dsrepara, cdasignado from  tordenserv where estado=''A''  and unidad=:P1_COMPLEMENTO2'))
,p_header=>'<div style="overflow:auto;">'
,p_footer=>'</div>'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_UNIDAD,P1_COMPLEMENTO,P1_COMPLEMENTO2'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(100926131963635012)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(107924903793740526)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(107925000760740529)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(107925123335740529)
,p_query_column_id=>3
,p_column_alias=>'UNIDAD'
,p_column_display_sequence=>3
,p_column_heading=>'UNIDAD'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(107925200474740529)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(107925332106740529)
,p_query_column_id=>5
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100937327358744000)
,p_name=>'P1_PILOTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(100935616234709728)
,p_item_default=>'1274'
,p_prompt=>'Piloto'
...
,p_field_template=>wwv_flow_api.id(100928200662635026)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100937523260745926)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(100935616234709728)
,p_prompt=>'Unidad'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107911727788477592)
,p_name=>'P1_NOMBRE'
,p_item_sequence=>15
,p_item_plug_id=>wwv_flow_api.id(100935616234709728)
,p_prompt=>'Nombre'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107926020880754282)
,p_name=>'P1_COMPLEMENTO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(100935616234709728)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107926308371760104)
,p_name=>'P1_COMPLEMENTO2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(100935616234709728)
...
,p_step_template=>wwv_flow_api.id(100911932642634939)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200821135330'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100930408706635110)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(100924104678634989)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100930720099635118)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(100930408706635110)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(100928719959635026)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100930532693635114)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(100930408706635110)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100930616759635117)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100930921745635125)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100930829631635118)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100931103696635125)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100931019481635125)
,p_process_sequence=>10
