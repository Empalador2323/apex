...
prompt APPLICATION 101 - CHECKLIST PRUEBA
--
-- Application Export:
--   Application:     101
--   Name:            CHECKLIST PRUEBA
--   Date and Time:   09:23 Monday April 18, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'CHECKLIST PRUEBA')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'INOT380101')
...
,p_authentication_id=>wwv_flow_api.id(136504830020324487)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20220110105332'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92704399515325860)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92704534691325862)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92704598589325863)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92704799338325863)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92704971477325863)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92705031473325863)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(135883429769221863)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(135910242593629804)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(136542020911635121)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(135901426918221879)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(135902913786221880)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(135902620258221880)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(135903022008221880)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(84662705579477379)
,p_theme_id=>50
,p_name=>'Page'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(84662916442477416)
,p_theme_id=>50
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135883534834221863)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135883623450221868)
,p_page_template_id=>wwv_flow_api.id(135883534834221863)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135883723303221868)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135883831814221868)
,p_page_template_id=>wwv_flow_api.id(135883723303221868)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135883932210221868)
,p_page_template_id=>wwv_flow_api.id(135883723303221868)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884016367221868)
,p_page_template_id=>wwv_flow_api.id(135883723303221868)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884114307221868)
,p_page_template_id=>wwv_flow_api.id(135883723303221868)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884231901221868)
,p_page_template_id=>wwv_flow_api.id(135883723303221868)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135884338321221868)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884435680221868)
,p_page_template_id=>wwv_flow_api.id(135884338321221868)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884540904221868)
,p_page_template_id=>wwv_flow_api.id(135884338321221868)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884644919221868)
,p_page_template_id=>wwv_flow_api.id(135884338321221868)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884717258221868)
,p_page_template_id=>wwv_flow_api.id(135884338321221868)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884831961221868)
,p_page_template_id=>wwv_flow_api.id(135884338321221868)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135884928522221868)
,p_page_template_id=>wwv_flow_api.id(135884338321221868)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135885024111221868)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885123104221868)
,p_page_template_id=>wwv_flow_api.id(135885024111221868)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885233174221868)
,p_page_template_id=>wwv_flow_api.id(135885024111221868)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885334450221868)
,p_page_template_id=>wwv_flow_api.id(135885024111221868)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885441172221868)
,p_page_template_id=>wwv_flow_api.id(135885024111221868)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135885531141221868)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885640120221868)
,p_page_template_id=>wwv_flow_api.id(135885531141221868)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885717258221868)
,p_page_template_id=>wwv_flow_api.id(135885531141221868)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885836065221868)
,p_page_template_id=>wwv_flow_api.id(135885531141221868)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135885933324221868)
,p_page_template_id=>wwv_flow_api.id(135885531141221868)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886033827221868)
,p_page_template_id=>wwv_flow_api.id(135885531141221868)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135886133799221868)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886244859221868)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886340625221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886428315221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886523096221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886628012221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886744486221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886820255221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135886923950221869)
,p_page_template_id=>wwv_flow_api.id(135886133799221868)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135887043551221869)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887138753221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887231108221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887318348221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887418651221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887523236221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887627734221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887718128221869)
,p_page_template_id=>wwv_flow_api.id(135887043551221869)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135887827908221869)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135887924749221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888015339221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888145730221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888236879221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888324000221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888423241221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888536669221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888619205221869)
,p_page_template_id=>wwv_flow_api.id(135887827908221869)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135888720785221869)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888815162221869)
,p_page_template_id=>wwv_flow_api.id(135888720785221869)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135888935451221869)
,p_page_template_id=>wwv_flow_api.id(135888720785221869)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889028475221869)
,p_page_template_id=>wwv_flow_api.id(135888720785221869)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889127574221869)
,p_page_template_id=>wwv_flow_api.id(135888720785221869)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889234350221869)
,p_page_template_id=>wwv_flow_api.id(135888720785221869)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889324454221869)
,p_page_template_id=>wwv_flow_api.id(135888720785221869)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135889419024221869)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889527308221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889625425221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889719612221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889845415221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135889945960221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890036461221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890134594221869)
,p_page_template_id=>wwv_flow_api.id(135889419024221869)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135890244966221869)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890315233221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890413826221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890523020221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890629679221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890734684221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890824355221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135890922987221869)
,p_page_template_id=>wwv_flow_api.id(135890244966221869)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135891023006221869)
,p_theme_id=>25
,p_name=>'Popup'
,p_internal_name=>'POPUP'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891120535221869)
,p_page_template_id=>wwv_flow_api.id(135891023006221869)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135891219091221871)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891323640221871)
,p_page_template_id=>wwv_flow_api.id(135891219091221871)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891443523221871)
,p_page_template_id=>wwv_flow_api.id(135891219091221871)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891538586221871)
,p_page_template_id=>wwv_flow_api.id(135891219091221871)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891638689221871)
,p_page_template_id=>wwv_flow_api.id(135891219091221871)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135891740193221871)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891828001221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135891913563221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892040257221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892115441221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892228711221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892314032221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892416364221871)
,p_page_template_id=>wwv_flow_api.id(135891740193221871)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135892534180221871)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892620397221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892734587221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892844729221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135892942571221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893044978221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893115664221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893221820221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893317628221871)
,p_page_template_id=>wwv_flow_api.id(135892534180221871)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135893429396221871)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893538538221871)
,p_page_template_id=>wwv_flow_api.id(135893429396221871)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893629599221871)
,p_page_template_id=>wwv_flow_api.id(135893429396221871)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893741021221871)
,p_page_template_id=>wwv_flow_api.id(135893429396221871)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893837457221871)
,p_page_template_id=>wwv_flow_api.id(135893429396221871)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135893926799221871)
,p_page_template_id=>wwv_flow_api.id(135893429396221871)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894040064221871)
,p_page_template_id=>wwv_flow_api.id(135893429396221871)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(135894142706221871)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894228925221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894338752221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894437898221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894544838221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894617795221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894723302221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(135894819542221871)
,p_page_template_id=>wwv_flow_api.id(135894142706221871)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(84669697325477471)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(84669905036477477)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(84670120752477477)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(135900328650221877)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(135900424007221877)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(135900531587221877)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(135900628137221877)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(135900730192221877)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(135900818498221877)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84663221267477418)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84663422401477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84663699823477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84664007791477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84664314983477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84664609161477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84664892200477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84665209881477432)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84665494405477434)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84665798005477440)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84666101317477440)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84666402847477440)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84666715083477440)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84666996126477441)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84667304568477441)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84667622499477441)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135894916118221871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895030688221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895125433221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895231492221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895335972221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895436380221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895541555221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895633813221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895742522221873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(135895833867221874)
,p_plug_template_id=>wwv_flow_api.id(135895742522221873)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135895919284221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896013836221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896127612221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896243973221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(135896321142221874)
,p_plug_template_id=>wwv_flow_api.id(135896243973221874)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896437701221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896518387221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896628066221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(135896730932221874)
,p_plug_template_id=>wwv_flow_api.id(135896628066221874)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(135896842133221874)
,p_plug_template_id=>wwv_flow_api.id(135896628066221874)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135896920535221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(135897035960221874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(84668221753477454)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(84668502698477463)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(84668797915477465)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(84669096968477465)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898228281221876)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898316037221876)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898432955221876)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898545739221876)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898639828221876)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898720757221876)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898822882221876)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135898913663221876)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135899016674221876)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135899145745221876)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135899221121221876)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135899342472221876)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135899415639221876)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(135899524467221876)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(84667902414477448)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897144854221874)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897237155221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897316381221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897416728221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897524449221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897630599221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897729089221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897820487221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135897925724221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135898017441221876)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(135898118485221876)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(84669394073477466)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(84669507162477470)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(84669616570477471)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135899627711221877)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135899734080221877)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135899844550221877)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135899922199221877)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135900044828221877)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135900141841221877)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(135900240670221877)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(84670316848477477)
,p_name=>'Breadcrumb'
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(135900928259221877)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(84670491967477499)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(135901120725221877)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(84670418710477493)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(135901035590221877)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(84670701210477512)
,p_theme_id=>50
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(84662705579477379)
,p_error_template=>wwv_flow_api.id(84662705579477379)
,p_printer_friendly_template=>wwv_flow_api.id(84662705579477379)
,p_default_button_template=>wwv_flow_api.id(84670120752477477)
,p_default_region_template=>wwv_flow_api.id(84666996126477441)
,p_default_chart_template=>wwv_flow_api.id(84666996126477441)
,p_default_form_template=>wwv_flow_api.id(84666996126477441)
,p_default_reportr_template=>wwv_flow_api.id(84667622499477441)
,p_default_tabform_template=>wwv_flow_api.id(84666996126477441)
,p_default_wizard_template=>wwv_flow_api.id(84666996126477441)
,p_default_irr_template=>wwv_flow_api.id(84666996126477441)
,p_default_report_template=>wwv_flow_api.id(84667902414477448)
,p_default_label_template=>wwv_flow_api.id(84669507162477470)
,p_default_calendar_template=>wwv_flow_api.id(84670418710477493)
,p_default_list_template=>wwv_flow_api.id(84668797915477465)
,p_default_option_label=>wwv_flow_api.id(84669507162477470)
,p_default_header_template=>wwv_flow_api.id(84666402847477440)
,p_default_footer_template=>wwv_flow_api.id(84665798005477440)
,p_default_required_label=>wwv_flow_api.id(84669616570477471)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(135901231800221879)
,p_theme_id=>25
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(135888720785221869)
,p_error_template=>wwv_flow_api.id(135885024111221868)
,p_printer_friendly_template=>wwv_flow_api.id(135891219091221871)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(135883534834221863)
,p_default_button_template=>wwv_flow_api.id(135900328650221877)
,p_default_region_template=>wwv_flow_api.id(135896628066221874)
,p_default_chart_template=>wwv_flow_api.id(135896628066221874)
,p_default_form_template=>wwv_flow_api.id(135895742522221873)
,p_default_reportr_template=>wwv_flow_api.id(135896628066221874)
,p_default_tabform_template=>wwv_flow_api.id(135896628066221874)
,p_default_wizard_template=>wwv_flow_api.id(135895742522221873)
,p_default_menur_template=>wwv_flow_api.id(135895231492221873)
,p_default_listr_template=>wwv_flow_api.id(135896628066221874)
,p_default_irr_template=>wwv_flow_api.id(135896127612221874)
,p_default_report_template=>wwv_flow_api.id(135897729089221876)
,p_default_label_template=>wwv_flow_api.id(135899844550221877)
,p_default_menu_template=>wwv_flow_api.id(135900928259221877)
,p_default_calendar_template=>wwv_flow_api.id(135901035590221877)
,p_default_list_template=>wwv_flow_api.id(135899342472221876)
,p_default_option_label=>wwv_flow_api.id(135899844550221877)
,p_default_required_label=>wwv_flow_api.id(135900141841221877)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(135986234249605193)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(135901519766221879)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(136504830020324487)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(35308715663782630685)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37901988825383832730)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902005337635845710)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
,p_display_sequence=>10
,p_display_value=>'Contains/Case (uses INSTR)'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902014426684852023)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902015931186853335)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902019337073855057)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902033343653856937)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902035916079858414)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37902047923352860499)
,p_plugin_attribute_id=>wwv_flow_api.id(37901988825383832730)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37903733220778399024)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903745529436401555)
,p_plugin_attribute_id=>wwv_flow_api.id(37903733220778399024)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903756833591402718)
,p_plugin_attribute_id=>wwv_flow_api.id(37903733220778399024)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37903769037878413398)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'bar'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(37903733220778399024)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903913425551495030)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>10
,p_display_value=>'Bar'
,p_return_value=>'bar'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903914730400496405)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903916834209497443)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903918238018498596)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903919342174499779)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903921614254501234)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903922821180503183)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37903923725336504423)
,p_plugin_attribute_id=>wwv_flow_api.id(37903769037878413398)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37904847226365129105)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31758329310657026272)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31758330815158027610)
,p_plugin_attribute_id=>wwv_flow_api.id(31758329310657026272)
,p_display_sequence=>10
,p_display_value=>'Slow'
,p_return_value=>'600'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31758331418275028452)
,p_plugin_attribute_id=>wwv_flow_api.id(31758329310657026272)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31758332021392029320)
,p_plugin_attribute_id=>wwv_flow_api.id(31758329310657026272)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31758332725894030691)
,p_plugin_attribute_id=>wwv_flow_api.id(31758329310657026272)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24389773222921476881)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14739212299155182557)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31191550123371562025)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(24300694610352047683)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300678216969002262)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300680418832012230)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300686012168029194)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300687327059033514)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300688199832035091)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300689711606038538)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300694610352047683)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13673730158768964523)
,p_plugin_attribute_id=>wwv_flow_api.id(24300694610352047683)
,p_display_sequence=>10
,p_display_value=>'Not Enterable'
,p_return_value=>'NOT_ENTERABLE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13673768269850967694)
,p_plugin_attribute_id=>wwv_flow_api.id(24300694610352047683)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13673799078161970108)
,p_plugin_attribute_id=>wwv_flow_api.id(24300694610352047683)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300733925159070817)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24300695621087050735)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(92706167152327011)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(29144674029831633533)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904938030628150540)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904941725668152816)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904943821786154534)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904945818336156141)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904948113807158233)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904953640968160925)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904957134066164108)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37904960426734167482)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
,p_file_name=>'bar.gif'
,p_mime_type=>'image/gif'
,p_file_content=>wwv_flow_api.varchar2_to_blob(wwv_flow_api.g_varchar2_table)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(59166053947674575255)
,p_plugin_id=>wwv_flow_api.id(35308715663782630685)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(84671023218477543)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(135901320438221879)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(135901320438221879)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(96433297242192884)
,p_name=>'Incumplimientos'
,p_template=>wwv_flow_api.id(135896243973221874)
...
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(135897729089221876)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(96433602066193004)
,p_query_column_id=>1
,p_column_alias=>'ITEM'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(96433703113193007)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(96475207430095985)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(135903118572221880)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(135895231492221873)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(135902620258221880)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(135900928259221877)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(135903614120275707)
,p_plug_name=>'Tsupervision'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(135895125433221873)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(127525215103841377)
,p_plug_name=>'Comentario Final'
,p_parent_plug_id=>wwv_flow_api.id(135903614120275707)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(135896920535221874)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(136417138161842726)
,p_name=>'Tabular Form'
,p_parent_plug_id=>wwv_flow_api.id(135903614120275707)
,p_template=>wwv_flow_api.id(135896628066221874)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136419333473842762)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136417432320842746)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136417533422842746)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136417619740842746)
,p_query_column_id=>4
,p_column_alias=>'ITEM'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136417721959842746)
,p_query_column_id=>5
,p_column_alias=>'TIPO'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136417832862842746)
,p_query_column_id=>6
,p_column_alias=>'DESCRIPCION'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136434922983300334)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136450718403070873)
,p_query_column_id=>8
,p_column_alias=>'FECHA'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136450838418070873)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(81170398484211731)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136514544429961416)
...
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136419815665845627)
,p_column_sequence=>1
,p_query_column_name=>'ROWID'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136419918468845627)
,p_column_sequence=>2
,p_query_column_name=>'NMEXAMEN'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136420040371845627)
,p_column_sequence=>3
,p_query_column_name=>'ITEM'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136420144918845627)
,p_column_sequence=>4
,p_query_column_name=>'TIPO'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136420219179845627)
,p_column_sequence=>5
,p_query_column_name=>'DESCRIPCION'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136434829418300330)
,p_column_sequence=>6
,p_query_column_name=>'REPARACION'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136450415211070869)
,p_column_sequence=>7
,p_query_column_name=>'FECHA'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136450533831070869)
,p_column_sequence=>8
,p_query_column_name=>'COMENTARIO'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(81170215560211726)
,p_column_sequence=>9
,p_query_column_name=>'COMENTA'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(136514444797961410)
,p_column_sequence=>10
,p_query_column_name=>'ORDEN'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96434698543212240)
,p_button_sequence=>710
,p_button_plug_id=>wwv_flow_api.id(135903614120275707)
,p_button_name=>'P1_INCUMPLIMIENTOS'
,p_button_static_id=>'P1_INCUMPLIMIENTOS'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(135900328650221877)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96436106639224054)
,p_button_sequence=>720
,p_button_plug_id=>wwv_flow_api.id(96433297242192884)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136427941475032843)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_api.id(127525215103841377)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(82759414894201815)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(128227212627046773)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(135903614120275707)
,p_button_name=>'REGRESAR'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(135900628137221877)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Regresar'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_redirect_url=>'/ords/f?p=370:1:&APP_SESSION.:::::'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(135904038989275709)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(82779011323474859)
,p_branch_name=>'llantas'
,p_branch_action=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:RP:P2_NUMERO,P2_TIPO,P2_UNIDAD:&P1_NMSUPER.,&P1_EVALUACION.,&P1_UNIDAD.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(82759414894201815)
,p_branch_sequence=>2
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(82823391948501862)
,p_branch_name=>'create'
,p_branch_action=>'/ords/f?p=370:1:&APP_SESSION.:::::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(136427941475032843)
,p_branch_sequence=>12
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(126485630079559272)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_prompt=>'Unidad'
...
,p_field_template=>wwv_flow_api.id(135899844550221877)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(126558312372394367)
,p_name=>'P1_NMNOTA'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(127525526288857214)
,p_name=>'P1_COMENTARIO_FIN'
,p_item_sequence=>700
,p_item_plug_id=>wwv_flow_api.id(127525215103841377)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(132175017165223882)
,p_name=>'P1_REMOTO'
,p_item_sequence=>108
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_prompt=>'Remoto'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135904431218275709)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135904625162275710)
,p_name=>'P1_NMSUPER'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135904822689275710)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135905043807275710)
,p_name=>'P1_CDPILOTO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135905216338275710)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135905427133275710)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135905633966275712)
,p_name=>'P1_FECHA'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135905835604275712)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135906035846275712)
,p_name=>'P1_ANUNCIADA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135906237300275712)
,p_name=>'P1_PUNTAJE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(135903614120275707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(135908939447311368)
,p_name=>'cargar_DATOS'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(135909229071311369)
,p_event_id=>wwv_flow_api.id(135908939447311368)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(136417138161842726)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136466638412553935)
,p_name=>'HABILITAR '
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136466931252553941)
,p_event_id=>wwv_flow_api.id(136466638412553935)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136467545816565585)
,p_name=>'DEAHBILITAR'
,p_event_sequence=>30
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136467830688565585)
,p_event_id=>wwv_flow_api.id(136467545816565585)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(126986732023472922)
,p_name=>'DATOS'
,p_event_sequence=>40
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(126987007421472922)
,p_event_id=>wwv_flow_api.id(126986732023472922)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(96435312395216188)
,p_name=>'Mostrar '
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(96434698543212240)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(96435591047216201)
,p_event_id=>wwv_flow_api.id(96435312395216188)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(96433297242192884)
,p_attribute_01=>'N'
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(96447818794376587)
,p_event_id=>wwv_flow_api.id(96435312395216188)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(96436796034230431)
,p_name=>'cerrar'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(96436106639224054)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(96437095441230432)
,p_event_id=>wwv_flow_api.id(96436796034230431)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(135907529390275713)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(82823900208512826)
,p_process_sequence=>10
...
'else 1',
'end  into rango  from (',
'select  (sysdate-Fecha_INGRESO) dias  from empleado@softland where to_number(empleado)=:P1_CDPILOTO);',
'',
...
,p_process_when_button_id=>wwv_flow_api.id(136427941475032843)
);
end;
/
begin
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(84704999494336673)
...
'End;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(82759414894201815)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220110102119'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(82768715166296491)
,p_name=>'llantas'
,p_template=>wwv_flow_api.id(135896628066221874)
,p_display_sequence=>20
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(82769011198296499)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(82769091073296504)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(84899600287409562)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(84102895927264684)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(82769404600296504)
,p_query_column_id=>5
,p_column_alias=>'COMENTARIO'
,p_column_display_sequence=>5
,p_column_heading=>'COMENTARIO'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(84932717104679898)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(135896628066221874)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(82774821278364520)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(82768715166296491)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(82868495970208062)
,p_branch_name=>'go to page'
,p_branch_action=>'/ords/f?p=370:1:&APP_SESSION.:::::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(82774821278364520)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(82772105840325490)
,p_name=>'P2_UNIDAD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(84932717104679898)
,p_prompt=>'Unidad'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(82772300879327799)
,p_name=>'P2_NUMERO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(84932717104679898)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(82821421303457906)
,p_name=>'P2_TIPO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(84932717104679898)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(82777717431410660)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insert'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(82774821278364520)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(84559308503120507)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(85021991768893338)
,p_name=>'rep'
,p_template=>wwv_flow_api.id(135896628066221874)
,p_display_sequence=>10
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(85022293152893349)
,p_query_column_id=>1
,p_column_alias=>'LLANTA'
,p_column_display_sequence=>1
,p_column_heading=>'LLANTA'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(85022401106893349)
,p_query_column_id=>2
,p_column_alias=>'POSICION'
,p_column_display_sequence=>2
,p_column_heading=>'POSICION'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(85022507409893349)
,p_query_column_id=>3
,p_column_alias=>'PROFUNDIDAD'
,p_column_display_sequence=>3
,p_column_heading=>'PROFUNDIDAD'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(85022591267893349)
,p_query_column_id=>4
,p_column_alias=>'PROFUNDIDAD_NUEVA'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(85022695651893349)
,p_query_column_id=>5
,p_column_alias=>'COMENTARIO'
,p_column_display_sequence=>5
,p_column_heading=>'COMENTARIO'
...
,p_step_template=>wwv_flow_api.id(135883534834221863)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(135901816133221879)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(135895742522221873)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(135902127500221880)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(135901816133221879)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135901918928221879)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(135901816133221879)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(135902031370221880)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(135902323689221880)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(135902229482221880)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(135902524838221880)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(135902420816221880)
,p_process_sequence=>10
