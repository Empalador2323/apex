...
prompt APPLICATION 344 - LP_UPDATESERVICES
--
-- Application Export:
--   Application:     344
--   Name:            LP_UPDATESERVICES
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,344)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_UPDATESERVICES')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_344')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'033F4D28688F63C596694C49F1AF6633A1455D468860D03B4CB899B3D917D6BD'
...
,p_authentication_id=>wwv_flow_api.id(23099607467152118)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_UPDATESERVICES'
...
,p_last_upd_yyyymmddhh24miss=>'20210325145022'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(23068210880953390)
,p_name=>'Navigation'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8804026128068146)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8804106658068146)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8804259814068146)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8804424596068146)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8804562525068146)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8804634624068146)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(23047202068953304)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(23102700542185701)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(23065227851953334)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(23066706062953348)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_TRECORRE'
,p_tab_text=>'Trecorre'
,p_tab_step=>1
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(23066409329953345)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23068320597953393)
,p_parent_id=>0
,p_short_name=>'Trecorre'
,p_link=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(23072023864953515)
,p_parent_id=>wwv_flow_api.id(23068320597953393)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23047322259953306)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23047419693953309)
,p_page_template_id=>wwv_flow_api.id(23047322259953306)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23047521363953309)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23047629035953311)
,p_page_template_id=>wwv_flow_api.id(23047521363953309)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23047717186953311)
,p_page_template_id=>wwv_flow_api.id(23047521363953309)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23047800646953311)
,p_page_template_id=>wwv_flow_api.id(23047521363953309)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23047921918953311)
,p_page_template_id=>wwv_flow_api.id(23047521363953309)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048010775953311)
,p_page_template_id=>wwv_flow_api.id(23047521363953309)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23048102940953311)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048226141953311)
,p_page_template_id=>wwv_flow_api.id(23048102940953311)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048314595953311)
,p_page_template_id=>wwv_flow_api.id(23048102940953311)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048430678953311)
,p_page_template_id=>wwv_flow_api.id(23048102940953311)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048521392953311)
,p_page_template_id=>wwv_flow_api.id(23048102940953311)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048606994953311)
,p_page_template_id=>wwv_flow_api.id(23048102940953311)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048704004953311)
,p_page_template_id=>wwv_flow_api.id(23048102940953311)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23048806782953311)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23048919719953311)
,p_page_template_id=>wwv_flow_api.id(23048806782953311)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049032488953311)
,p_page_template_id=>wwv_flow_api.id(23048806782953311)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049119335953311)
,p_page_template_id=>wwv_flow_api.id(23048806782953311)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049205028953311)
,p_page_template_id=>wwv_flow_api.id(23048806782953311)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23049330272953311)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049409493953311)
,p_page_template_id=>wwv_flow_api.id(23049330272953311)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049503182953311)
,p_page_template_id=>wwv_flow_api.id(23049330272953311)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049601678953311)
,p_page_template_id=>wwv_flow_api.id(23049330272953311)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049724113953311)
,p_page_template_id=>wwv_flow_api.id(23049330272953311)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23049828168953311)
,p_page_template_id=>wwv_flow_api.id(23049330272953311)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23049902261953311)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050015451953311)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050127002953311)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050223740953311)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050311820953311)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050406257953311)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050521706953312)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050607164953312)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050721589953312)
,p_page_template_id=>wwv_flow_api.id(23049902261953311)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23050802343953312)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23050928791953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051023991953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051108289953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051216564953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051320825953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051400134953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051529319953312)
,p_page_template_id=>wwv_flow_api.id(23050802343953312)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23051616984953312)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051729415953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051810107953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23051931590953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052004041953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052101685953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052212333953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052321629953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052400736953312)
,p_page_template_id=>wwv_flow_api.id(23051616984953312)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23052527757953312)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052613057953312)
,p_page_template_id=>wwv_flow_api.id(23052527757953312)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052714311953312)
,p_page_template_id=>wwv_flow_api.id(23052527757953312)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052808068953312)
,p_page_template_id=>wwv_flow_api.id(23052527757953312)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23052904332953312)
,p_page_template_id=>wwv_flow_api.id(23052527757953312)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053031162953312)
,p_page_template_id=>wwv_flow_api.id(23052527757953312)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053113146953312)
,p_page_template_id=>wwv_flow_api.id(23052527757953312)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23053227095953312)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053311295953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053406212953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053529283953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053603232953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053707678953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053805053953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23053931707953312)
,p_page_template_id=>wwv_flow_api.id(23053227095953312)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23054023545953312)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054125609953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054217349953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054332430953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054400058953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054525633953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054623047953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054702509953314)
,p_page_template_id=>wwv_flow_api.id(23054023545953312)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23054821797953314)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23054902217953314)
,p_page_template_id=>wwv_flow_api.id(23054821797953314)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23055015368953314)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055119312953314)
,p_page_template_id=>wwv_flow_api.id(23055015368953314)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055218770953314)
,p_page_template_id=>wwv_flow_api.id(23055015368953314)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055327101953314)
,p_page_template_id=>wwv_flow_api.id(23055015368953314)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055406959953314)
,p_page_template_id=>wwv_flow_api.id(23055015368953314)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23055513201953314)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055618909953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055700114953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055830486953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23055905541953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056001615953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056107535953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056230224953314)
,p_page_template_id=>wwv_flow_api.id(23055513201953314)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23056309629953314)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056406346953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056509035953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056616378953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056727677953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056824185953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23056915432953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057018247953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057103580953314)
,p_page_template_id=>wwv_flow_api.id(23056309629953314)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23057203128953315)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057302575953315)
,p_page_template_id=>wwv_flow_api.id(23057203128953315)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057411335953315)
,p_page_template_id=>wwv_flow_api.id(23057203128953315)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057500764953315)
,p_page_template_id=>wwv_flow_api.id(23057203128953315)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057619327953315)
,p_page_template_id=>wwv_flow_api.id(23057203128953315)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057702701953315)
,p_page_template_id=>wwv_flow_api.id(23057203128953315)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23057809911953315)
,p_page_template_id=>wwv_flow_api.id(23057203128953315)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(23057906091953315)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058027540953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058111789953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058208591953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058322330953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058429425953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058523190953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(23058629959953315)
,p_page_template_id=>wwv_flow_api.id(23057906091953315)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(23064112590953323)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(23064215879953325)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(23064324529953325)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(23064417597953325)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(23064520636953325)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(23064605612953325)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23058714012953315)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23058807411953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23058922663953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059027371953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059108737953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059204037953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059325713953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059431009953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059517045953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(23059622157953317)
,p_plug_template_id=>wwv_flow_api.id(23059517045953317)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059725141953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059824184953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23059907380953317)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23060027605953318)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(23060127999953318)
,p_plug_template_id=>wwv_flow_api.id(23060027605953318)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23060203507953318)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23060325263953318)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23060424635953318)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(23060517089953318)
,p_plug_template_id=>wwv_flow_api.id(23060424635953318)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(23060604821953318)
,p_plug_template_id=>wwv_flow_api.id(23060424635953318)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23060705060953318)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(23060826973953318)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062021627953321)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062103813953321)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062203097953321)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062311732953321)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062429888953321)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062531403953321)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062623813953321)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062700313953321)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062821622953323)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23062928694953323)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23063000595953323)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23063123038953323)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23063230346953323)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(23063308955953323)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23060916212953318)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061024239953320)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061118810953320)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061225855953320)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061328747953320)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061409384953321)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061519003953321)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061607295953321)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061728793953321)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061814029953321)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(23061916373953321)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23063400536953323)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23063526093953323)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23063616988953323)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23063725176953323)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23063830472953323)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23063927518953323)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(23064001194953323)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(23064709196953325)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(23064930525953329)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(23064814802953326)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(23065007576953329)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(23052527757953312)
,p_error_template=>wwv_flow_api.id(23048806782953311)
,p_printer_friendly_template=>wwv_flow_api.id(23055015368953314)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(23047322259953306)
,p_default_button_template=>wwv_flow_api.id(23064112590953323)
,p_default_region_template=>wwv_flow_api.id(23060424635953318)
,p_default_chart_template=>wwv_flow_api.id(23060424635953318)
,p_default_form_template=>wwv_flow_api.id(23059517045953317)
,p_default_reportr_template=>wwv_flow_api.id(23060424635953318)
,p_default_tabform_template=>wwv_flow_api.id(23060424635953318)
,p_default_wizard_template=>wwv_flow_api.id(23059517045953317)
,p_default_menur_template=>wwv_flow_api.id(23059027371953317)
,p_default_listr_template=>wwv_flow_api.id(23060424635953318)
,p_default_irr_template=>wwv_flow_api.id(23059907380953317)
,p_default_report_template=>wwv_flow_api.id(23061519003953321)
,p_default_label_template=>wwv_flow_api.id(23063616988953323)
,p_default_menu_template=>wwv_flow_api.id(23064709196953325)
,p_default_calendar_template=>wwv_flow_api.id(23064814802953326)
,p_default_list_template=>wwv_flow_api.id(23063123038953323)
,p_default_option_label=>wwv_flow_api.id(23063616988953323)
,p_default_required_label=>wwv_flow_api.id(23063927518953323)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(23069202590953407)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(23065312739953334)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(23099607467152118)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(23065117718953331)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(23065117718953331)
,p_tab_set=>'TS1'
,p_name=>'Trecorre'
,p_alias=>'HOME'
,p_step_title=>'Trecorre'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Trecorre'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180411210327'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23066816626953351)
,p_plug_name=>'TRECORRE'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(23059907380953317)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(23066912555953353)
,p_name=>'TRECORRE'
...
,p_owner=>'LP'
,p_internal_uid=>23066912555953353
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067023672953370)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067106306953375)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067211328953376)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067317107953378)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067417621953378)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067512234953379)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067612838953381)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067717463953382)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067818931953384)
,p_db_column_name=>'KMCDSERV'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Kmcdserv'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'KMCDSERV'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23067914277953386)
,p_db_column_name=>'KMSVMED'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Kmsvmed'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23068008899953386)
,p_db_column_name=>'KMSVMA'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Kmsvma'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23068128314953387)
,p_db_column_name=>'KMSVSMA'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Kmsvsma'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(23072929455150690)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'230730'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:R_ID:CDCLASAC:CORRACT:KMACTUAL:KMPROXSERV:MENSAJE:NOSER:KMCDSERV:KMSVMED:KMSVMA:KMSVSMA'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23068401596953395)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(23059027371953317)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(23066409329953345)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(23064709196953325)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23071923773953507)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(23066816626953351)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(23064112590953323)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180625114521'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23068710425953398)
,p_plug_name=>'Edit TRECORRE'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(23059517045953317)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23072129651953517)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(23059027371953317)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23068810401953401)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(23068710425953398)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23069000937953401)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23069109064953401)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23068927556953401)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(23069322937953411)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23069410375953479)
,p_name=>'P2_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
...
,p_field_template=>wwv_flow_api.id(23063616988953323)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23069529582953481)
,p_name=>'P2_R_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23069726275953484)
,p_name=>'P2_CDCLASAC'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23069903050953484)
,p_name=>'P2_CORRACT'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23070127411953484)
,p_name=>'P2_KMACTUAL'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23070332168953484)
,p_name=>'P2_KMPROXSERV'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
,p_prompt=>'PROXIMO SERVICIO'
,p_source=>'KMPROXSERV'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23070502812953484)
,p_name=>'P2_MENSAJE'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23070708795953484)
,p_name=>'P2_NOSER'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23070913396953486)
,p_name=>'P2_KMCDSERV'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23071111582953486)
,p_name=>'P2_KMSVMED'
,p_item_sequence=>9
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
,p_prompt=>'SERVICIO MEDIO'
,p_source=>'KMSVMED'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23071302632953486)
,p_name=>'P2_KMSVMA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
,p_prompt=>'SERVICIO MAYOR'
,p_source=>'KMSVMA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23071532684953486)
,p_name=>'P2_KMSVSMA'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(23068710425953398)
,p_use_cache_before_default=>'NO'
,p_prompt=>'SUPER MAYOR'
,p_source=>'KMSVSMA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>30
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23071714815953486)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27428822600379321)
,p_process_sequence=>11
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Update km '
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'update tactivos set recorrido = :P2_KMACTUAL where cdclase=:P2_CDCLASAC and correlativo= :P2_CORRACT;',
'update trecorre set kmactual = :P2_KMACTUAL ,kmproxserv= :P2_KMPROXSERV , kmsvmed= :P2_KMSVMED , kmsvma = :P2_KMSVMA ,kmsvsma = :P2_KMSVSMA where cdclasac = :P2_CDCLASAC and corract =:P2_CORRACT;',
'end;'))
,p_process_error_message=>'error'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(23069000937953401)
,p_process_when_type=>'ALWAYS'
,p_process_success_message=>'update activo'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(23047322259953306)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180411203210'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23065621015953337)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(23059517045953317)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23065927778953343)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(23065621015953337)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23065710452953342)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(23065621015953337)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23065816342953343)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23066118468953345)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23066026590953343)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23066319732953345)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23066215910953345)
,p_process_sequence=>10
