...
,p_default_application_id=>389
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 389 - REPORTE EXISTENCIAS
--
-- Application Export:
--   Application:     389
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,389)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'REPORTE EXISTENCIAS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_389')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'83B80CD0A38FD71B2D3D565356EB4320AA5B12A6A468B1BB8A2510DC590DCF08'
...
,p_authentication_id=>wwv_flow_api.id(95012705947536912)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:REPORTE EXISTENCIAS'
...
,p_last_upd_yyyymmddhh24miss=>'20210325161239'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13044421856089344)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13044577566089344)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13044671438089344)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13044844603089344)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13044929428089344)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13045013152089344)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92293328257410842)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(92311406367410884)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(92311321222410884)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(92312906866410893)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(92312619960410892)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92293417668410848)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92293504214410851)
,p_page_template_id=>wwv_flow_api.id(92293417668410848)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92293602247410853)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92293728516410853)
,p_page_template_id=>wwv_flow_api.id(92293602247410853)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92293830576410853)
,p_page_template_id=>wwv_flow_api.id(92293602247410853)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92293908510410853)
,p_page_template_id=>wwv_flow_api.id(92293602247410853)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294012100410853)
,p_page_template_id=>wwv_flow_api.id(92293602247410853)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294116158410853)
,p_page_template_id=>wwv_flow_api.id(92293602247410853)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92294204184410853)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294319405410853)
,p_page_template_id=>wwv_flow_api.id(92294204184410853)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294416421410853)
,p_page_template_id=>wwv_flow_api.id(92294204184410853)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294504473410853)
,p_page_template_id=>wwv_flow_api.id(92294204184410853)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294629506410853)
,p_page_template_id=>wwv_flow_api.id(92294204184410853)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294715554410853)
,p_page_template_id=>wwv_flow_api.id(92294204184410853)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92294805858410853)
,p_page_template_id=>wwv_flow_api.id(92294204184410853)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92294920876410854)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295020213410854)
,p_page_template_id=>wwv_flow_api.id(92294920876410854)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295131317410854)
,p_page_template_id=>wwv_flow_api.id(92294920876410854)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295232502410854)
,p_page_template_id=>wwv_flow_api.id(92294920876410854)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295313572410854)
,p_page_template_id=>wwv_flow_api.id(92294920876410854)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92295402768410854)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295504195410854)
,p_page_template_id=>wwv_flow_api.id(92295402768410854)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295631326410854)
,p_page_template_id=>wwv_flow_api.id(92295402768410854)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295707118410854)
,p_page_template_id=>wwv_flow_api.id(92295402768410854)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295832109410854)
,p_page_template_id=>wwv_flow_api.id(92295402768410854)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92295926296410854)
,p_page_template_id=>wwv_flow_api.id(92295402768410854)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92296018261410854)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296102058410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296210359410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296311675410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296400334410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296514892410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296630153410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296703232410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92296831025410854)
,p_page_template_id=>wwv_flow_api.id(92296018261410854)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92296915732410854)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297012745410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297132682410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297208410410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297328817410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297416131410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297503646410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297609680410854)
,p_page_template_id=>wwv_flow_api.id(92296915732410854)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92297722161410854)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297816137410854)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92297918704410854)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298005954410854)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298115372410854)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298211402410854)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298314792410856)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298413128410856)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298531889410856)
,p_page_template_id=>wwv_flow_api.id(92297722161410854)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92298608880410856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298712565410856)
,p_page_template_id=>wwv_flow_api.id(92298608880410856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298814167410856)
,p_page_template_id=>wwv_flow_api.id(92298608880410856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92298929777410856)
,p_page_template_id=>wwv_flow_api.id(92298608880410856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299019904410856)
,p_page_template_id=>wwv_flow_api.id(92298608880410856)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299107924410856)
,p_page_template_id=>wwv_flow_api.id(92298608880410856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299220485410856)
,p_page_template_id=>wwv_flow_api.id(92298608880410856)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92299327147410856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299416621410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299524898410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299601023410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299732055410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299811644410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92299913441410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300013896410856)
,p_page_template_id=>wwv_flow_api.id(92299327147410856)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92300125718410856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300214111410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300313031410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300407092410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300502106410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300624971410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300703501410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92300816292410856)
,p_page_template_id=>wwv_flow_api.id(92300125718410856)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92300917841410856)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301021339410856)
,p_page_template_id=>wwv_flow_api.id(92300917841410856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92301127797410856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301229699410856)
,p_page_template_id=>wwv_flow_api.id(92301127797410856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301326104410856)
,p_page_template_id=>wwv_flow_api.id(92301127797410856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301427177410856)
,p_page_template_id=>wwv_flow_api.id(92301127797410856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301508125410856)
,p_page_template_id=>wwv_flow_api.id(92301127797410856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92301618561410856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301705501410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301823530410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92301904004410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302025871410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302126549410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302224970410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302306010410856)
,p_page_template_id=>wwv_flow_api.id(92301618561410856)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92302425499410856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302513056410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302609930410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302713740410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302801293410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92302920697410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303031574410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303116048410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303223938410857)
,p_page_template_id=>wwv_flow_api.id(92302425499410856)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92303303650410857)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303400298410857)
,p_page_template_id=>wwv_flow_api.id(92303303650410857)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303532270410857)
,p_page_template_id=>wwv_flow_api.id(92303303650410857)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303621448410857)
,p_page_template_id=>wwv_flow_api.id(92303303650410857)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303722639410857)
,p_page_template_id=>wwv_flow_api.id(92303303650410857)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303821542410857)
,p_page_template_id=>wwv_flow_api.id(92303303650410857)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92303929103410857)
,p_page_template_id=>wwv_flow_api.id(92303303650410857)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92304004122410857)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304129105410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304226352410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304302922410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304413853410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304515014410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304604363410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92304709421410857)
,p_page_template_id=>wwv_flow_api.id(92304004122410857)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92310224187410876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92310306611410876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92310400716410876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92310516306410876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92310627333410876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92310708035410876)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92304801563410859)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92304923455410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305002613410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305104392410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305216766410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305323122410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305420229410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305531200410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305628303410860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92305726561410860)
,p_plug_template_id=>wwv_flow_api.id(92305628303410860)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305810950410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92305928914410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306022385410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306129290410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92306225230410864)
,p_plug_template_id=>wwv_flow_api.id(92306129290410864)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306326054410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306424665410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306518608410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92306615778410864)
,p_plug_template_id=>wwv_flow_api.id(92306518608410864)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92306726678410864)
,p_plug_template_id=>wwv_flow_api.id(92306518608410864)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306804367410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92306922409410864)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308103791410870)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308213641410871)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308324251410871)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308407835410871)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308521632410871)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308608297410871)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308729631410871)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308812633410871)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92308928966410871)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92309020889410871)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92309107468410871)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92309225121410871)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92309317218410871)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92309423132410871)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307026383410867)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307126079410867)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307228074410867)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307320842410867)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307425729410867)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307519879410867)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307631368410868)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307718800410868)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307807783410868)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92307917807410868)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92308001932410870)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92309526714410873)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92309601091410875)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92309701432410875)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92309820032410875)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92309915480410875)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92310012161410875)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92310108161410875)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(92310829243410876)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(92311000885410882)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(92310917836410879)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(92311100668410882)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(92298608880410856)
,p_error_template=>wwv_flow_api.id(92294920876410854)
,p_printer_friendly_template=>wwv_flow_api.id(92301127797410856)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(92293417668410848)
,p_default_button_template=>wwv_flow_api.id(92310224187410876)
,p_default_region_template=>wwv_flow_api.id(92306518608410864)
,p_default_chart_template=>wwv_flow_api.id(92306518608410864)
,p_default_form_template=>wwv_flow_api.id(92305628303410860)
,p_default_reportr_template=>wwv_flow_api.id(92306518608410864)
,p_default_tabform_template=>wwv_flow_api.id(92306518608410864)
,p_default_wizard_template=>wwv_flow_api.id(92305628303410860)
,p_default_menur_template=>wwv_flow_api.id(92305104392410860)
,p_default_listr_template=>wwv_flow_api.id(92306518608410864)
,p_default_irr_template=>wwv_flow_api.id(92306022385410864)
,p_default_report_template=>wwv_flow_api.id(92307631368410868)
,p_default_label_template=>wwv_flow_api.id(92309701432410875)
,p_default_menu_template=>wwv_flow_api.id(92310829243410876)
,p_default_calendar_template=>wwv_flow_api.id(92310917836410879)
,p_default_list_template=>wwv_flow_api.id(92309225121410871)
,p_default_option_label=>wwv_flow_api.id(92309701432410875)
,p_default_required_label=>wwv_flow_api.id(92310012161410875)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(92311525970410885)
...
/
prompt --application/shared_components/security/authentications/bodega
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(95012705947536912)
,p_name=>'bodega'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(92311215437410884)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(92311215437410884)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20201208163725'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(92313331931418235)
,p_plug_name=>'EXISTENCIAS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92306022385410864)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT a.bodega,a.articulo,d.descripcion, SUM(cantidad)  ,cant_disponible AS disponible , cant_disponible- SUM(cantidad) diferencia ',
'FROM pipasgt.linea_doc_inv A ',
'INNER JOIN pipasgt.existencia_bodega b ON a.articulo=b.articulo AND a.bodega=b.bodega ',
'INNER JOIN pipasgt.articulo d ON a.articulo=d.articulo group by a.articulo,d.descripcion,cant_disponible,A.BODEGA;'))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(92313432682418235)
,p_name=>'EXISTENCIAS'
...
,p_owner=>'1462'
,p_internal_uid=>92313432682418235
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92313606574418281)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92313732419418281)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92313826805418281)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92313917452418281)
,p_db_column_name=>'SUM(CANTIDAD)'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Sum(Cantidad)'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'SUM(CANTIDAD)'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92314022439418282)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'DISPONIBLE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92314119567418282)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'DIFERENCIA'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(92314207474420635)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'923143'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'BODEGA:ARTICULO:DESCRIPCION:SUM(CANTIDAD):DISPONIBLE:DIFERENCIA'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(93821714285075000)
,p_branch_name=>'go'
...
,p_last_upd_yyyymmddhh24miss=>'20200603062811'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(92317916665460481)
,p_plug_name=>'EXISTENCIAS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92306022385410864)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'SELECT a.bodega,a.articulo,d.descripcion, SUM(cantidad)  ,cant_disponible AS disponible , cant_disponible- SUM(cantidad) diferencia FROM linea_doc_inv@softland A INNER JOIN existencia_bodega@softland b ON a.articulo=b.articulo AND a.bodega=b.bodega I'
||'NNER JOIN articulo@softland d ON a.articulo=d.articulo group by a.articulo,d.descripcion,cant_disponible,A.BODEGA;'
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(92318012539460481)
,p_name=>'EXISTENCIAS'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'1462'
,p_internal_uid=>92318012539460481
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92318225939460506)
,p_db_column_name=>'BODEGA'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Bodega'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92318311794460507)
,p_db_column_name=>'ARTICULO'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Articulo'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92318400851460507)
,p_db_column_name=>'DESCRIPCION'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Descripcion'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92318513119460507)
,p_db_column_name=>'SUM(CANTIDAD)'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Sum(Cantidad)'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92318631676460507)
,p_db_column_name=>'DISPONIBLE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Disponible'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(92318712145460507)
,p_db_column_name=>'DIFERENCIA'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Diferencia'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(92318815271460748)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'923189'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'BODEGA:ARTICULO:DESCRIPCION:SUM(CANTIDAD):DISPONIBLE:DIFERENCIA'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(93821907384078159)
,p_branch_name=>'go'
...
,p_step_template=>wwv_flow_api.id(92293417668410848)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200515102207'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(92311821484410889)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92305628303410860)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(92312107176410892)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(92311821484410889)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92310224187410876)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92311913998410889)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(92311821484410889)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(92309701432410875)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92312016497410890)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92312302161410892)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92312221499410892)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92312518617410892)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92312408213410892)
,p_process_sequence=>10
