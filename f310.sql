...
prompt APPLICATION 310 - J_recorrido
--
-- Application Export:
--   Application:     310
--   Name:            J_recorrido
--   Date and Time:   12:29 Wednesday April 20, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,310)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_recorrido')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_310')
...
,p_authentication_id=>wwv_flow_api.id(24968338877563487)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20210329102304'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8749039867054431)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8749159295054431)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8749254475054431)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8749419264054431)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8749503432054432)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8749641312054432)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(24658328618333749)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(24967145865453914)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(24676329803333807)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(24677524080333823)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(24677936229333828)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24658419486333756)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24658517302333760)
,p_page_template_id=>wwv_flow_api.id(24658419486333756)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24658645627333762)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24658728307333762)
,p_page_template_id=>wwv_flow_api.id(24658645627333762)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24658843969333762)
,p_page_template_id=>wwv_flow_api.id(24658645627333762)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24658940937333764)
,p_page_template_id=>wwv_flow_api.id(24658645627333762)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659024931333764)
,p_page_template_id=>wwv_flow_api.id(24658645627333762)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659149288333764)
,p_page_template_id=>wwv_flow_api.id(24658645627333762)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24659227727333764)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659347186333764)
,p_page_template_id=>wwv_flow_api.id(24659227727333764)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659441741333764)
,p_page_template_id=>wwv_flow_api.id(24659227727333764)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659537430333764)
,p_page_template_id=>wwv_flow_api.id(24659227727333764)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659628146333764)
,p_page_template_id=>wwv_flow_api.id(24659227727333764)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659742623333764)
,p_page_template_id=>wwv_flow_api.id(24659227727333764)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24659820914333764)
,p_page_template_id=>wwv_flow_api.id(24659227727333764)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24659949358333764)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660037359333764)
,p_page_template_id=>wwv_flow_api.id(24659949358333764)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660121360333764)
,p_page_template_id=>wwv_flow_api.id(24659949358333764)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660242725333764)
,p_page_template_id=>wwv_flow_api.id(24659949358333764)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660317425333764)
,p_page_template_id=>wwv_flow_api.id(24659949358333764)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24660436985333764)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660517919333764)
,p_page_template_id=>wwv_flow_api.id(24660436985333764)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660642580333764)
,p_page_template_id=>wwv_flow_api.id(24660436985333764)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660740054333764)
,p_page_template_id=>wwv_flow_api.id(24660436985333764)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660845013333764)
,p_page_template_id=>wwv_flow_api.id(24660436985333764)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24660937806333764)
,p_page_template_id=>wwv_flow_api.id(24660436985333764)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24661040961333764)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661137278333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661239093333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661324502333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661442434333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661519707333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661617358333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661737964333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24661836855333764)
,p_page_template_id=>wwv_flow_api.id(24661040961333764)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24661940123333764)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662048315333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662149718333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662228044333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662327387333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662446614333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662521135333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662631535333764)
,p_page_template_id=>wwv_flow_api.id(24661940123333764)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24662746378333765)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662843732333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24662930422333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663032210333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663136794333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663235041333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663333598333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663440035333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663533294333765)
,p_page_template_id=>wwv_flow_api.id(24662746378333765)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24663641213333765)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663740753333767)
,p_page_template_id=>wwv_flow_api.id(24663641213333765)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663838090333767)
,p_page_template_id=>wwv_flow_api.id(24663641213333765)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24663918080333767)
,p_page_template_id=>wwv_flow_api.id(24663641213333765)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664022487333767)
,p_page_template_id=>wwv_flow_api.id(24663641213333765)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664130758333767)
,p_page_template_id=>wwv_flow_api.id(24663641213333765)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664226660333767)
,p_page_template_id=>wwv_flow_api.id(24663641213333765)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24664347986333767)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664421608333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664525253333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664623103333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664736536333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664842897333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24664938295333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665024662333767)
,p_page_template_id=>wwv_flow_api.id(24664347986333767)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24665129636333767)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665243256333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665327603333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665423309333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665527697333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665634080333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665722502333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24665847024333767)
,p_page_template_id=>wwv_flow_api.id(24665129636333767)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24665929012333767)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666047303333767)
,p_page_template_id=>wwv_flow_api.id(24665929012333767)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24666130243333767)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666221672333768)
,p_page_template_id=>wwv_flow_api.id(24666130243333767)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666335295333768)
,p_page_template_id=>wwv_flow_api.id(24666130243333767)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666430084333768)
,p_page_template_id=>wwv_flow_api.id(24666130243333767)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666526860333768)
,p_page_template_id=>wwv_flow_api.id(24666130243333767)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24666617727333768)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666738871333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666843937333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24666927455333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667020629333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667127321333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667246391333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667317796333768)
,p_page_template_id=>wwv_flow_api.id(24666617727333768)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24667418402333768)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667525064333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667624200333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667737013333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667836846333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24667943867333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668018338333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668129454333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668231181333768)
,p_page_template_id=>wwv_flow_api.id(24667418402333768)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24668327268333768)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668423345333768)
,p_page_template_id=>wwv_flow_api.id(24668327268333768)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668517624333768)
,p_page_template_id=>wwv_flow_api.id(24668327268333768)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668618144333768)
,p_page_template_id=>wwv_flow_api.id(24668327268333768)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668721379333768)
,p_page_template_id=>wwv_flow_api.id(24668327268333768)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668822180333768)
,p_page_template_id=>wwv_flow_api.id(24668327268333768)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24668917649333768)
,p_page_template_id=>wwv_flow_api.id(24668327268333768)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(24669029705333768)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669134444333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669240835333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669319837333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669443054333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669546997333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669625104333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(24669745586333768)
,p_page_template_id=>wwv_flow_api.id(24669029705333768)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(24675247610333793)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(24675323677333795)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(24675432291333795)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(24675544934333796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(24675639480333796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(24675731930333798)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24669825073333770)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24669928229333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670046365333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670146144333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670249325333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670327161333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670448941333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670547712333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670633972333778)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24670730424333778)
,p_plug_template_id=>wwv_flow_api.id(24670633972333778)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670839118333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24670946239333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671041672333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671148442333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24671226678333779)
,p_plug_template_id=>wwv_flow_api.id(24671148442333779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671323626333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671434519333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671523508333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24671629213333779)
,p_plug_template_id=>wwv_flow_api.id(24671523508333779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(24671747452333779)
,p_plug_template_id=>wwv_flow_api.id(24671523508333779)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671825083333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(24671921575333779)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673121038333785)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673230247333787)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673318509333787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673424586333787)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673518968333787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673624817333787)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673739251333787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673847122333787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24673920507333787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24674039153333787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24674124027333787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24674233476333789)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24674333455333789)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(24674449543333789)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672039898333781)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672139493333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672240882333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672339082333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672439617333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672527133333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672624154333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672717716333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672819643333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24672936937333784)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(24673034544333784)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24674534019333789)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24674634283333792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24674734445333792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24674849268333792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24674931096333792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24675029016333792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(24675117879333793)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(24675828965333798)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(24676042943333803)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(24675933556333801)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(24676147401333806)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(24663641213333765)
,p_error_template=>wwv_flow_api.id(24659949358333764)
,p_printer_friendly_template=>wwv_flow_api.id(24666130243333767)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(24658419486333756)
,p_default_button_template=>wwv_flow_api.id(24675247610333793)
,p_default_region_template=>wwv_flow_api.id(24671523508333779)
,p_default_chart_template=>wwv_flow_api.id(24671523508333779)
,p_default_form_template=>wwv_flow_api.id(24670633972333778)
,p_default_reportr_template=>wwv_flow_api.id(24671523508333779)
,p_default_tabform_template=>wwv_flow_api.id(24671523508333779)
,p_default_wizard_template=>wwv_flow_api.id(24670633972333778)
,p_default_menur_template=>wwv_flow_api.id(24670146144333778)
,p_default_listr_template=>wwv_flow_api.id(24671523508333779)
,p_default_irr_template=>wwv_flow_api.id(24671041672333779)
,p_default_report_template=>wwv_flow_api.id(24672624154333784)
,p_default_label_template=>wwv_flow_api.id(24674734445333792)
,p_default_menu_template=>wwv_flow_api.id(24675828965333798)
,p_default_calendar_template=>wwv_flow_api.id(24675933556333801)
,p_default_list_template=>wwv_flow_api.id(24674233476333789)
,p_default_option_label=>wwv_flow_api.id(24674734445333792)
,p_default_required_label=>wwv_flow_api.id(24675029016333792)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(24676423417333809)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(24968338877563487)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(24676240118333806)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(24676240118333806)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(14390402677999375)
,p_name=>'Datos'
,p_template=>wwv_flow_api.id(24671523508333779)
...
'From tordenserv a left join empleado b on a.cdasignado=b.empleado  where fecrea between :P1_FECHA_INICIAL and :P1_FECHA_FINAL and cod_falla in(44,43,53,54,55) and cdclase||''-''||correlativo =:P1_UNIDAD order by fecrea desc'))
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(24672624154333784)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14390717231999382)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14390820248999385)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14390918200999385)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14391019101999385)
,p_query_column_id=>4
,p_column_alias=>'MANTENIMIENTO'
,p_column_display_sequence=>4
,p_column_heading=>'MANTENIMIENTO'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14391109542999385)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14391211040999385)
,p_query_column_id=>6
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14391419992004339)
,p_plug_name=>'Suma'
,p_parent_plug_id=>wwv_flow_api.id(14390402677999375)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(24671041672333779)
,p_plug_display_sequence=>35
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
,p_plug_source=>'select fecha,cdclasact,corract,recorrido from (SELECT * FROM TVALES WHERE FECHA BETWEEN :P1_FECHA_INICIAL AND :P1_FECHA_FINAL) where cdclasact||''-''||CORRACT= :P1_UNIDAD ORDER BY FECHA DESC'
...
,p_prn_page_header=>'LAS PIPAS'
,p_prn_page_header_font_color=>'#541DEB'
,p_prn_page_header_font_family=>'Helvetica'
,p_prn_page_header_font_weight=>'bold'
,p_prn_page_header_font_size=>'16'
,p_prn_page_footer=>'LAS PIPAS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(14391527831004339)
,p_name=>'Suma'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14391714163004343)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14391824250004345)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14391920623004345)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14392018710004345)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(14392120685004571)
...
,p_is_default=>'Y'
,p_display_rows=>100
,p_report_columns=>'FECHA:CDCLASACT:CORRACT:RECORRIDO'
,p_sum_columns_on_break=>'RECORRIDO'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24693248517380582)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(24671523508333779)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24693837697396434)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(24693248517380582)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(24675247610333793)
,p_button_image_alt=>'Generar'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24681423513972423)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(24693248517380582)
,p_prompt=>'Unidad'
...
,p_field_template=>wwv_flow_api.id(24674734445333792)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24681647387972459)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24681824252972459)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20171013094005'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24695521270580896)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(24670146144333778)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24697624536742645)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(24697739535742645)
,p_name=>'CHECKLIST'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24697945804742648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24698017564742648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24698149385742648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24698223922742648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24698436225742648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24930642595255398)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24931429169255403)
,p_db_column_name=>'OT'
,p_display_order=>15
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24962617923087017)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24963546988134307)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(24698625360752435)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(24964143850235824)
,p_report_id=>wwv_flow_api.id(24698625360752435)
,p_name=>'marcar'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24965845647416143)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(24697624536742645)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24695822203583559)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(24695521270580896)
,p_prompt=>'Nmorden'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24697132659715443)
,p_name=>'P2_OT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(24695521270580896)
,p_prompt=>'OT'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(24697247823730515)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(24697540182730523)
,p_event_id=>wwv_flow_api.id(24697247823730515)
,p_event_result=>'TRUE'
...
,p_step_template=>wwv_flow_api.id(24658419486333756)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24676746094333814)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(24670633972333778)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24677020340333820)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(24676746094333814)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24676831164333817)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(24676746094333814)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24676943253333820)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24677243178333823)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24677142887333820)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24677446044333823)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(24677324416333823)
,p_process_sequence=>10
