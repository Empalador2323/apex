...
prompt APPLICATION 303 - J_Profundidad
--
-- Application Export:
--   Application:     303
--   Name:            J_Profundidad
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,303)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_Profundidad')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_303')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'2AB769D1F9EA40FAF0BD8B8D5E4932C4628849AAAC8A8578D3AA05C3FACB65F4'
...
,p_authentication_id=>wwv_flow_api.id(14671909656620007)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Profundidad'
...
,p_last_upd_yyyymmddhh24miss=>'20210322135846'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8735750474051524)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8735877174051524)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8735963347051524)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8736172842051524)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8736249586051524)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8736366955051524)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12760917131620121)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12825402346397121)
,p_icon_sequence=>10
,p_icon_subtext=>'Home'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12778923345620134)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(12780125728620135)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(12780511149620135)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12761022576620121)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761125627620121)
,p_page_template_id=>wwv_flow_api.id(12761022576620121)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12761227614620121)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761302685620121)
,p_page_template_id=>wwv_flow_api.id(12761227614620121)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761414463620121)
,p_page_template_id=>wwv_flow_api.id(12761227614620121)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761532721620121)
,p_page_template_id=>wwv_flow_api.id(12761227614620121)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761611199620121)
,p_page_template_id=>wwv_flow_api.id(12761227614620121)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761706279620121)
,p_page_template_id=>wwv_flow_api.id(12761227614620121)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12761823389620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12761911899620123)
,p_page_template_id=>wwv_flow_api.id(12761823389620123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762003165620123)
,p_page_template_id=>wwv_flow_api.id(12761823389620123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762106029620123)
,p_page_template_id=>wwv_flow_api.id(12761823389620123)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762209900620123)
,p_page_template_id=>wwv_flow_api.id(12761823389620123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762303071620123)
,p_page_template_id=>wwv_flow_api.id(12761823389620123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762424799620123)
,p_page_template_id=>wwv_flow_api.id(12761823389620123)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12762514753620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762606669620123)
,p_page_template_id=>wwv_flow_api.id(12762514753620123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762700041620123)
,p_page_template_id=>wwv_flow_api.id(12762514753620123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762828665620123)
,p_page_template_id=>wwv_flow_api.id(12762514753620123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12762922620620123)
,p_page_template_id=>wwv_flow_api.id(12762514753620123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12763013833620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763100706620123)
,p_page_template_id=>wwv_flow_api.id(12763013833620123)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763205559620123)
,p_page_template_id=>wwv_flow_api.id(12763013833620123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763307199620123)
,p_page_template_id=>wwv_flow_api.id(12763013833620123)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763425474620123)
,p_page_template_id=>wwv_flow_api.id(12763013833620123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763527887620123)
,p_page_template_id=>wwv_flow_api.id(12763013833620123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12763609097620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763701675620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763826457620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12763921452620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764010896620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764131807620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764211873620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764310313620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764407208620123)
,p_page_template_id=>wwv_flow_api.id(12763609097620123)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12764510705620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764632132620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764706212620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764827830620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12764924591620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765021044620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765127880620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765209395620123)
,p_page_template_id=>wwv_flow_api.id(12764510705620123)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12765317271620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765432533620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765525157620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765603065620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765727380620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765820712620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12765913360620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766023374620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766118907620123)
,p_page_template_id=>wwv_flow_api.id(12765317271620123)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12766218363620123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766323645620123)
,p_page_template_id=>wwv_flow_api.id(12766218363620123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766408238620123)
,p_page_template_id=>wwv_flow_api.id(12766218363620123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766500294620123)
,p_page_template_id=>wwv_flow_api.id(12766218363620123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766612367620123)
,p_page_template_id=>wwv_flow_api.id(12766218363620123)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766715803620123)
,p_page_template_id=>wwv_flow_api.id(12766218363620123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12766816093620123)
,p_page_template_id=>wwv_flow_api.id(12766218363620123)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12766929680620125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767010698620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767114609620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767216045620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767315152620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767425502620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767526326620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767619597620125)
,p_page_template_id=>wwv_flow_api.id(12766929680620125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12767721690620125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767808120620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12767929269620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768008147620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768110611620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768217646620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768320994620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768411595620125)
,p_page_template_id=>wwv_flow_api.id(12767721690620125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12768518132620125)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768603491620125)
,p_page_template_id=>wwv_flow_api.id(12768518132620125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12768722807620125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768821632620125)
,p_page_template_id=>wwv_flow_api.id(12768722807620125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12768926530620125)
,p_page_template_id=>wwv_flow_api.id(12768722807620125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769007868620125)
,p_page_template_id=>wwv_flow_api.id(12768722807620125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769124178620125)
,p_page_template_id=>wwv_flow_api.id(12768722807620125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12769229514620125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769310219620125)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769404808620125)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769529875620126)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769602968620126)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769700069620126)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769817771620126)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12769928561620126)
,p_page_template_id=>wwv_flow_api.id(12769229514620125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12770026495620126)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770125667620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770227403620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770312925620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770426500620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770508248620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770616575620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770701147620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12770826406620126)
,p_page_template_id=>wwv_flow_api.id(12770026495620126)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12770921039620126)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771024692620126)
,p_page_template_id=>wwv_flow_api.id(12770921039620126)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771125917620126)
,p_page_template_id=>wwv_flow_api.id(12770921039620126)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771225519620126)
,p_page_template_id=>wwv_flow_api.id(12770921039620126)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771306698620126)
,p_page_template_id=>wwv_flow_api.id(12770921039620126)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771401377620126)
,p_page_template_id=>wwv_flow_api.id(12770921039620126)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771508065620126)
,p_page_template_id=>wwv_flow_api.id(12770921039620126)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12771620797620126)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771723963620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771819630620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12771905292620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12772018955620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12772114881620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12772215968620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12772332168620128)
,p_page_template_id=>wwv_flow_api.id(12771620797620126)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12777810967620131)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12777932400620132)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12778027532620132)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12778106474620132)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12778231131620132)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12778312037620132)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12772401029620128)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12772500900620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12772610888620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12772707419620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12772814476620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12772926867620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773009900620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773107720620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773227270620128)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12773307548620129)
,p_plug_template_id=>wwv_flow_api.id(12773227270620128)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773414198620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773507755620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773613994620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773708141620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12773829339620129)
,p_plug_template_id=>wwv_flow_api.id(12773708141620129)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12773906639620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12774006666620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12774132042620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12774209487620129)
,p_plug_template_id=>wwv_flow_api.id(12774132042620129)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12774315411620129)
,p_plug_template_id=>wwv_flow_api.id(12774132042620129)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12774423266620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12774511182620129)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12775700414620129)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12775818003620129)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12775906765620129)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776002979620131)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776124233620131)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776215340620131)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776306457620131)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776422795620131)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776531125620131)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776616225620131)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776720144620131)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776816826620131)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12776900616620131)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12777002572620131)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12774618791620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12774719230620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12774832672620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12774922469620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775023182620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775111583620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775200051620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775316618620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775420140620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775517545620129)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12775607576620129)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777129675620131)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777222354620131)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777317569620131)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777430432620131)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777513935620131)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777611267620131)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12777711125620131)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(12778403728620132)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(12778621112620132)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(12778511893620132)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(12778706605620134)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(12766218363620123)
,p_error_template=>wwv_flow_api.id(12762514753620123)
,p_printer_friendly_template=>wwv_flow_api.id(12768722807620125)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(12761022576620121)
,p_default_button_template=>wwv_flow_api.id(12777810967620131)
,p_default_region_template=>wwv_flow_api.id(12774132042620129)
,p_default_chart_template=>wwv_flow_api.id(12774132042620129)
,p_default_form_template=>wwv_flow_api.id(12773227270620128)
,p_default_reportr_template=>wwv_flow_api.id(12774132042620129)
,p_default_tabform_template=>wwv_flow_api.id(12774132042620129)
,p_default_wizard_template=>wwv_flow_api.id(12773227270620128)
,p_default_menur_template=>wwv_flow_api.id(12772707419620128)
,p_default_listr_template=>wwv_flow_api.id(12774132042620129)
,p_default_irr_template=>wwv_flow_api.id(12773613994620129)
,p_default_report_template=>wwv_flow_api.id(12775200051620129)
,p_default_label_template=>wwv_flow_api.id(12777317569620131)
,p_default_menu_template=>wwv_flow_api.id(12778403728620132)
,p_default_calendar_template=>wwv_flow_api.id(12778511893620132)
,p_default_list_template=>wwv_flow_api.id(12776816826620131)
,p_default_option_label=>wwv_flow_api.id(12777317569620131)
,p_default_required_label=>wwv_flow_api.id(12777611267620131)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12779016769620134)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(14671703471620004)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(14671909656620007)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(12778805147620134)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(12778805147620134)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20180111084123'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12783124143635204)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12773613994620129)
...
'"ESTADO",',
'"CDCLASACT"',
'from "TNEUMATICOS" where estado = ''D'' or estado = ''M'' or estado =''E'';',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(12783303133635204)
,p_name=>'Report 1'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>12783303133635204
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12783428193635212)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12783526661635214)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12783616842635215)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12783715910635217)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12783821219635217)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12783914904635218)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(12786426827635510)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'127865'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:CDMEDIDA:CORRELATIVO:CDDISENO:ESTADO:CDCLASACT'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12792323325382004)
,p_plug_name=>'medida'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12773708141620129)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20171206140618'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12781103481635193)
,p_plug_name=>'Form on TNEUMATICOS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12773227270620128)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12781330346635193)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(12781103481635193)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(12777810967620131)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12781530184635193)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(12781700828635195)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(12784711990635242)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12781910116635195)
,p_name=>'P2_ROWID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(12781103481635193)
...
,p_field_template=>wwv_flow_api.id(12777317569620131)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12782102377635198)
,p_name=>'P2_PROFUNDIDAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(12781103481635193)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Profundidad'
,p_source=>'PROFUNDIDAD'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12782627173635201)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12785831128635250)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TNEUMATICOS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12782818048635201)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TNEUMATICOS'
,p_attribute_02=>'TNEUMATICOS'
,p_attribute_03=>'P2_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'U'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12786003628635251)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TNEUMATICOS'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12783030681635201)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12786225974635251)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_step_template=>wwv_flow_api.id(12761022576620121)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171206101053'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12779322751620134)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12773227270620128)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12779602086620134)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(12779322751620134)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12779420738620134)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12779322751620134)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12779525722620134)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12779822310620134)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12779726245620134)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12780008777620135)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12779902534620135)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(14670619290602625)
);
end;
/
