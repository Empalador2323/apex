...
,p_default_application_id=>342
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 342 - LP_REPORTE_OPERATIVO
--
-- Application Export:
--   Application:     342
--   Name:            LP_REPORTE_OPERATIVO
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,342)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_REPORTE_OPERATIVO')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_342')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'03C0753B7FD45FF5FEB82AA5E2B6A07C3D22C6AB417E39FFE42366236FC92945'
...
,p_authentication_id=>wwv_flow_api.id(25774710877816328)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_REPORTE_OPERATIVO'
...
,p_last_upd_yyyymmddhh24miss=>'20210322115029'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8797148660067270)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8797263186067270)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8797369038067270)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8797523504067270)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8797623645067270)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8797791911067270)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(25679424684637162)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(25803328220617412)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(25697419741637287)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(25698615960637312)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25679506604637175)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25679620005637184)
,p_page_template_id=>wwv_flow_api.id(25679506604637175)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25679723994637187)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25679801117637189)
,p_page_template_id=>wwv_flow_api.id(25679723994637187)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25679902877637189)
,p_page_template_id=>wwv_flow_api.id(25679723994637187)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680016830637189)
,p_page_template_id=>wwv_flow_api.id(25679723994637187)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680127176637189)
,p_page_template_id=>wwv_flow_api.id(25679723994637187)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680225803637189)
,p_page_template_id=>wwv_flow_api.id(25679723994637187)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25680329949637189)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680425395637190)
,p_page_template_id=>wwv_flow_api.id(25680329949637189)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680516166637190)
,p_page_template_id=>wwv_flow_api.id(25680329949637189)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680622963637190)
,p_page_template_id=>wwv_flow_api.id(25680329949637189)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680707980637190)
,p_page_template_id=>wwv_flow_api.id(25680329949637189)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680814082637190)
,p_page_template_id=>wwv_flow_api.id(25680329949637189)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25680912236637190)
,p_page_template_id=>wwv_flow_api.id(25680329949637189)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25681014461637190)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681103074637190)
,p_page_template_id=>wwv_flow_api.id(25681014461637190)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681216782637190)
,p_page_template_id=>wwv_flow_api.id(25681014461637190)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681312639637190)
,p_page_template_id=>wwv_flow_api.id(25681014461637190)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681405891637190)
,p_page_template_id=>wwv_flow_api.id(25681014461637190)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25681500327637190)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681617870637190)
,p_page_template_id=>wwv_flow_api.id(25681500327637190)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681715593637190)
,p_page_template_id=>wwv_flow_api.id(25681500327637190)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681802274637190)
,p_page_template_id=>wwv_flow_api.id(25681500327637190)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25681924848637190)
,p_page_template_id=>wwv_flow_api.id(25681500327637190)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682027700637190)
,p_page_template_id=>wwv_flow_api.id(25681500327637190)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25682117945637192)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682217152637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682311707637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682424032637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682517245637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682620830637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682721805637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682808198637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25682900830637192)
,p_page_template_id=>wwv_flow_api.id(25682117945637192)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25683019232637192)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683108011637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683215260637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683319195637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683412506637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683523479637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683632073637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683731337637192)
,p_page_template_id=>wwv_flow_api.id(25683019232637192)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25683824861637192)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25683910956637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684022922637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684112555637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684220290637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684332220637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684416678637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684512397637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684626741637192)
,p_page_template_id=>wwv_flow_api.id(25683824861637192)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25684710921637192)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684829141637193)
,p_page_template_id=>wwv_flow_api.id(25684710921637192)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25684930662637193)
,p_page_template_id=>wwv_flow_api.id(25684710921637192)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685021254637193)
,p_page_template_id=>wwv_flow_api.id(25684710921637192)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685111809637193)
,p_page_template_id=>wwv_flow_api.id(25684710921637192)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685203884637193)
,p_page_template_id=>wwv_flow_api.id(25684710921637192)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685321709637193)
,p_page_template_id=>wwv_flow_api.id(25684710921637192)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25685429676637193)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685531327637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685604044637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685726076637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685826267637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25685927614637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686019148637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686118755637193)
,p_page_template_id=>wwv_flow_api.id(25685429676637193)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25686221256637195)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686316895637195)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686412643637195)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686530191637195)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686619961637195)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686714014637196)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686800218637196)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25686931036637196)
,p_page_template_id=>wwv_flow_api.id(25686221256637195)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25687012178637196)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687104529637196)
,p_page_template_id=>wwv_flow_api.id(25687012178637196)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25687230897637196)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687305655637196)
,p_page_template_id=>wwv_flow_api.id(25687230897637196)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687403101637196)
,p_page_template_id=>wwv_flow_api.id(25687230897637196)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687521058637196)
,p_page_template_id=>wwv_flow_api.id(25687230897637196)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687624848637196)
,p_page_template_id=>wwv_flow_api.id(25687230897637196)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25687700344637196)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687815129637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25687919758637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688028018637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688114175637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688206278637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688322845637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688418317637198)
,p_page_template_id=>wwv_flow_api.id(25687700344637196)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25688509965637198)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688627760637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688726435637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688820100637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25688911588637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689009402637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689108535637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689222096637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689308066637198)
,p_page_template_id=>wwv_flow_api.id(25688509965637198)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25689419757637198)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689527987637198)
,p_page_template_id=>wwv_flow_api.id(25689419757637198)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689629547637198)
,p_page_template_id=>wwv_flow_api.id(25689419757637198)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689723867637198)
,p_page_template_id=>wwv_flow_api.id(25689419757637198)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689829121637198)
,p_page_template_id=>wwv_flow_api.id(25689419757637198)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25689928300637198)
,p_page_template_id=>wwv_flow_api.id(25689419757637198)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690007871637198)
,p_page_template_id=>wwv_flow_api.id(25689419757637198)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(25690110326637200)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690222314637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690325299637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690415823637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690515914637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690613734637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690730380637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(25690823333637200)
,p_page_template_id=>wwv_flow_api.id(25690110326637200)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(25696314936637248)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(25696424806637251)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(25696520032637251)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(25696620006637251)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(25696725516637253)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(25696804945637253)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25690928121637201)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691025094637214)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691127853637215)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691206907637215)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691310220637215)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691404347637217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691513530637217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691614381637217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691717199637217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(25691808355637217)
,p_plug_template_id=>wwv_flow_api.id(25691717199637217)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25691919808637217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692005471637218)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692129391637218)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692205204637218)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(25692303344637218)
,p_plug_template_id=>wwv_flow_api.id(25692205204637218)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692411882637218)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692510674637218)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692611944637218)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(25692712093637221)
,p_plug_template_id=>wwv_flow_api.id(25692611944637218)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(25692830221637221)
,p_plug_template_id=>wwv_flow_api.id(25692611944637218)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25692926391637221)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(25693021961637221)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694229781637232)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694308576637235)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694400202637237)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694527045637237)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694630717637237)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694726482637237)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694826598637237)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25694925677637237)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25695018590637237)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25695106574637237)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25695200948637237)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25695300948637237)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25695416896637237)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(25695506784637237)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693116279637223)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693227601637229)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693310351637229)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693411774637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693516681637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693630269637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693731867637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693805750637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25693911409637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25694019771637231)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(25694129606637231)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25695608946637237)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25695716268637245)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25695812432637246)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25695910677637246)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25696020895637246)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25696128092637248)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(25696214250637248)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(25696906210637253)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(25697102411637267)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(25697032037637262)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(25697214635637273)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(25684710921637192)
,p_error_template=>wwv_flow_api.id(25681014461637190)
,p_printer_friendly_template=>wwv_flow_api.id(25687230897637196)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(25679506604637175)
,p_default_button_template=>wwv_flow_api.id(25696314936637248)
,p_default_region_template=>wwv_flow_api.id(25692611944637218)
,p_default_chart_template=>wwv_flow_api.id(25692611944637218)
,p_default_form_template=>wwv_flow_api.id(25691717199637217)
,p_default_reportr_template=>wwv_flow_api.id(25692611944637218)
,p_default_tabform_template=>wwv_flow_api.id(25692611944637218)
,p_default_wizard_template=>wwv_flow_api.id(25691717199637217)
,p_default_menur_template=>wwv_flow_api.id(25691206907637215)
,p_default_listr_template=>wwv_flow_api.id(25692611944637218)
,p_default_irr_template=>wwv_flow_api.id(25692129391637218)
,p_default_report_template=>wwv_flow_api.id(25693731867637231)
,p_default_label_template=>wwv_flow_api.id(25695812432637246)
,p_default_menu_template=>wwv_flow_api.id(25696906210637253)
,p_default_calendar_template=>wwv_flow_api.id(25697032037637262)
,p_default_list_template=>wwv_flow_api.id(25695300948637237)
,p_default_option_label=>wwv_flow_api.id(25695812432637246)
,p_default_required_label=>wwv_flow_api.id(25696128092637248)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(25697505949637292)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(25774710877816328)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(25697317530637275)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(25697317530637275)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
'}',
'',
'function xlibJasperDemo_generateUrl(pBaseUrl, pRepName, pRepFormat, pDataSource, pOutFilename, pRepLocale, pRepEncoding, pAdditionalParams,pAdditionalParams2,pAdditionalParams3,pSerie,pContrato){',
'  var url;',
'',
'  url = pBaseUrl;',
...
'  url = url + "&Fecha1=" + pAdditionalParams;',
'  url = url + "&Fecha2=" + pAdditionalParams2;',
' url = url + "&Cliente=" + pAdditionalParams3;',
'    return url;',
'}',
'',
...
'$x(''P2_FECHA_INICIO'').value, $x(''P2_FECHA_FIN'').value,$x(''P2_CDCLIENTE'').value)',
';',
'}',
'',
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190705202153'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28415305409724137)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(25692611944637218)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(28435923014264920)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(28415305409724137)
,p_button_name=>'IMPRIMIR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(25696314936637248)
,p_button_image_alt=>'Imprimir'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28416828476729151)
,p_name=>'P2_FECHA_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
...
,p_field_template=>wwv_flow_api.id(25695812432637246)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28417013492729156)
,p_name=>'P2_FECHA_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28437811422290425)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28438029902290437)
,p_name=>'P2_REP_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_item_default=>'ResumenDiario'
,p_prompt=>'Rep Name'
,p_source=>'static:Reportereparaciones,MovXunidad,ResumenDiario'
,p_source_type=>'STATIC'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:Reportereparaciones,MovXunidad,ResumenDiario'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_cAttributes=>'nowrap'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28438221735290437)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28438422602290437)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28438607428290437)
,p_name=>'P2_OUT_FILE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_prompt=>'Out File'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28438810318290437)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28439003115290437)
,p_name=>'P2_REP_ENCODING'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_item_default=>'UTF-8'
,p_prompt=>'Rep Encoding'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28442612044320601)
,p_name=>'P2_URL'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28442801603320601)
,p_name=>'P2_URLR'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49982122526119703)
,p_name=>'P2_CLIENTE'
,p_item_sequence=>39
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_prompt=>'Cliente'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(59839516989745375)
,p_name=>'P2_CDCLIENTE'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(28415305409724137)
,p_prompt=>'Cdcliente'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(28445427488389245)
,p_name=>'CREAR_URL'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_FECHA_FIN'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(28445721710389251)
,p_event_id=>wwv_flow_api.id(28445427488389245)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(28445920393392651)
,p_event_id=>wwv_flow_api.id(28445427488389245)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(28446226496417346)
,p_name=>'IMPRIMIR'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(28435923014264920)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(28446527406417348)
,p_event_id=>wwv_flow_api.id(28446226496417346)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(28446825329420809)
,p_event_id=>wwv_flow_api.id(28446226496417346)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(59839607554753606)
,p_name=>'asignar_codigo'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_CLIENTE'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(59839930225753615)
,p_event_id=>wwv_flow_api.id(59839607554753606)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P2_CDCLIENTE'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>':p2_cliente'
,p_attribute_07=>'P2_CLIENTE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
'  url = url + "&_repLocale=" + pRepLocale;',
'  url = url + "&_repEncoding=" + pRepEncoding;',
'  url = url + "&_NOMINA=" + pAdditionalParams;',
'',
'    return url;',
'}',
'',
'function xlibJasperDemo_makeDemoUrl(){ ',
'$x(''P4_REPORT_URL'').value=xlibJasperDemo_generateUrl($x(''P4_URLR'').value, $x(''P4_REP_NAME'').value, $x(''P4_REP_FORMAT'').value, $x(''P4_DATA_SOURCE'').value, $x(''P4_OUT_FILE'').value, $x(''P4_REP_LOCALE'').value, $x(''P4_REP_ENCODING'').value,',
'$x(''P4_NOMINA'').value)',
';',
'}',
'',
...
,p_last_upd_yyyymmddhh24miss=>'20200921120348'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(104298114604706707)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(25692611944637218)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(104298330202706710)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(104298114604706707)
,p_button_name=>'IMPRIMIR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(25696314936637248)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104298900561706720)
,p_name=>'P4_REPORT_URL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_prompt=>'Report Url'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104299131561706720)
,p_name=>'P4_REP_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_item_default=>'ResumenDiario'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104299330140706720)
,p_name=>'P4_REP_FORMAT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_item_default=>'pdf'
,p_prompt=>'Rep Format'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104299504866706721)
,p_name=>'P4_DATA_SOURCE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_item_default=>'default'
,p_prompt=>'Data Source'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104299711890706721)
,p_name=>'P4_OUT_FILE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_prompt=>'Out File'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104299904316706721)
,p_name=>'P4_REP_LOCALE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_item_default=>'en_US'
,p_prompt=>'Rep Locale'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104300130347706721)
,p_name=>'P4_REP_ENCODING'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_item_default=>'UTF-8'
,p_prompt=>'Rep Encoding'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104300315162706721)
,p_name=>'P4_URL'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104300511169706721)
,p_name=>'P4_URLR'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104300701695706721)
,p_name=>'P4_CDCLIENTE'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_prompt=>'Cdcliente'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(104304304026726096)
,p_name=>'P4_NOMINA'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(104298114604706707)
,p_prompt=>'Nomina'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(104301528774706723)
,p_name=>'CREAR_URL'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P4_FECHA_FIN'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(104301811097706723)
,p_event_id=>wwv_flow_api.id(104301528774706723)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'select substr(:P4_URL,1,INSTR(:P4_URL,''/'',1,3))||',
'''JasperReportsIntegration/report''',
'INTO :P4_URLR',
'from dual;',
'END;',
''))
,p_attribute_02=>'P4_URL'
,p_attribute_03=>'P4_URLR,P4_REPORT_URL'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(104302020903706725)
,p_event_id=>wwv_flow_api.id(104301528774706723)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P4_REPORT_URL'
,p_attribute_01=>'xlibJasperDemo_makeDemoUrl();'
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(104302111676706725)
,p_name=>'IMPRIMIR'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(104298330202706710)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(104302403882706725)
,p_event_id=>wwv_flow_api.id(104302111676706725)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(104302615437706725)
,p_event_id=>wwv_flow_api.id(104302111676706725)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>'xlibShowUrl($x(''P4_REPORT_URL'').value);'
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(104301103800706723)
,p_name=>'asignar_codigo'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P4_CLIENTE'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(104301418625706723)
,p_event_id=>wwv_flow_api.id(104301103800706723)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P4_CDCLIENTE'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>':P4_NOMINA'
,p_attribute_07=>'P4_NOMINA'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
,p_step_template=>wwv_flow_api.id(25679506604637175)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180522085358'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(25697803363637301)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(25691717199637217)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(25698130974637304)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(25697803363637301)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25697927514637303)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(25697803363637301)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25698016782637304)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25698319748637312)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25698224696637304)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25698508492637312)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25698423773637312)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(25771904808779187)
);
end;
/
