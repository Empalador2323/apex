...
prompt APPLICATION 401 - CONTROL_GPS
--
-- Application Export:
--   Application:     401
--   Name:            CONTROL_GPS
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,401)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'CONTROL_GPS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_401')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'2566D0512F2DC741A6448BA9A61F1D8F77E49EC740298B9F261C409490B847F3'
...
,p_authentication_id=>wwv_flow_api.id(105339000485832592)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:CONTROL_GPS'
...
,p_last_upd_yyyymmddhh24miss=>'20201008091023'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16956745587095688)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16956873866095688)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16956958511095688)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16957112949095688)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16957261279095688)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16957389395095688)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(105320731411832418)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(105478704256281378)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(105338709885832579)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(105346808336913029)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'REGISTRO_GPS'
,p_tab_text=>'REGISTRO_GPS'
,p_tab_step=>2
,p_tab_also_current_for_pages=>'3'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(105353804094960201)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
,p_tab_name=>'REGISTRO_SIM'
,p_tab_text=>'REGISTRO_SIM'
,p_tab_step=>4
,p_tab_also_current_for_pages=>'5'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(105359800462970353)
,p_tab_set=>'TS1'
,p_tab_sequence=>40
,p_tab_name=>'REGISTRO'
,p_tab_text=>'REGISTRO'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(105340108078832662)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(105340509671832698)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105320818534832442)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105320901411832459)
,p_page_template_id=>wwv_flow_api.id(105320818534832442)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105321018285832464)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321112751832465)
,p_page_template_id=>wwv_flow_api.id(105321018285832464)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321215462832465)
,p_page_template_id=>wwv_flow_api.id(105321018285832464)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321304294832465)
,p_page_template_id=>wwv_flow_api.id(105321018285832464)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321407323832465)
,p_page_template_id=>wwv_flow_api.id(105321018285832464)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321525492832465)
,p_page_template_id=>wwv_flow_api.id(105321018285832464)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105321627747832465)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321728972832465)
,p_page_template_id=>wwv_flow_api.id(105321627747832465)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321827468832465)
,p_page_template_id=>wwv_flow_api.id(105321627747832465)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105321929790832465)
,p_page_template_id=>wwv_flow_api.id(105321627747832465)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322015918832465)
,p_page_template_id=>wwv_flow_api.id(105321627747832465)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322102773832465)
,p_page_template_id=>wwv_flow_api.id(105321627747832465)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322203758832465)
,p_page_template_id=>wwv_flow_api.id(105321627747832465)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105322328880832465)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322409181832465)
,p_page_template_id=>wwv_flow_api.id(105322328880832465)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322524239832465)
,p_page_template_id=>wwv_flow_api.id(105322328880832465)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322625071832465)
,p_page_template_id=>wwv_flow_api.id(105322328880832465)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322723729832465)
,p_page_template_id=>wwv_flow_api.id(105322328880832465)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105322830541832465)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105322909840832465)
,p_page_template_id=>wwv_flow_api.id(105322830541832465)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323021347832465)
,p_page_template_id=>wwv_flow_api.id(105322830541832465)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323104869832465)
,p_page_template_id=>wwv_flow_api.id(105322830541832465)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323226616832465)
,p_page_template_id=>wwv_flow_api.id(105322830541832465)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323314292832465)
,p_page_template_id=>wwv_flow_api.id(105322830541832465)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105323414328832467)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323529551832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323626361832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323702841832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323827356832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105323922727832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324015708832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324100184832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324201388832467)
,p_page_template_id=>wwv_flow_api.id(105323414328832467)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105324305367832467)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324414507832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324516997832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324615200832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324728187832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324806583832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105324923369832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325010038832468)
,p_page_template_id=>wwv_flow_api.id(105324305367832467)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105325122745832468)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325212708832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325325470832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325404828832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325527645832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325622840832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325723244832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325802209832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105325918777832468)
,p_page_template_id=>wwv_flow_api.id(105325122745832468)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105326011877832468)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326103746832468)
,p_page_template_id=>wwv_flow_api.id(105326011877832468)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326214429832468)
,p_page_template_id=>wwv_flow_api.id(105326011877832468)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326330684832468)
,p_page_template_id=>wwv_flow_api.id(105326011877832468)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326417428832468)
,p_page_template_id=>wwv_flow_api.id(105326011877832468)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326510072832468)
,p_page_template_id=>wwv_flow_api.id(105326011877832468)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326631968832468)
,p_page_template_id=>wwv_flow_api.id(105326011877832468)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105326727378832468)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326812340832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105326914500832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327003481832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327113083832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327209219832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327329018832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327410376832470)
,p_page_template_id=>wwv_flow_api.id(105326727378832468)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105327505070832470)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327631388832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327718024832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327816485832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105327931376832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328027074832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328113585832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328231506832470)
,p_page_template_id=>wwv_flow_api.id(105327505070832470)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105328304945832471)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328416619832471)
,p_page_template_id=>wwv_flow_api.id(105328304945832471)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105328530825832471)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328603134832471)
,p_page_template_id=>wwv_flow_api.id(105328530825832471)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328730215832471)
,p_page_template_id=>wwv_flow_api.id(105328530825832471)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328825232832471)
,p_page_template_id=>wwv_flow_api.id(105328530825832471)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105328919986832471)
,p_page_template_id=>wwv_flow_api.id(105328530825832471)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105329014427832471)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329110637832471)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329225524832471)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329309781832471)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329403011832471)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329530654832473)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329632179832473)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329723236832473)
,p_page_template_id=>wwv_flow_api.id(105329014427832471)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105329804646832473)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105329920173832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330015949832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330118926832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330206711832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330311240832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330408691832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330528642832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330620887832473)
,p_page_template_id=>wwv_flow_api.id(105329804646832473)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105330719213832473)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330801104832473)
,p_page_template_id=>wwv_flow_api.id(105330719213832473)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105330923497832473)
,p_page_template_id=>wwv_flow_api.id(105330719213832473)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331017665832473)
,p_page_template_id=>wwv_flow_api.id(105330719213832473)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331106188832473)
,p_page_template_id=>wwv_flow_api.id(105330719213832473)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331204891832473)
,p_page_template_id=>wwv_flow_api.id(105330719213832473)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331307166832473)
,p_page_template_id=>wwv_flow_api.id(105330719213832473)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(105331404279832475)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331507550832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331612060832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331732144832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331819758832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105331927429832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105332026493832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(105332115098832475)
,p_page_template_id=>wwv_flow_api.id(105331404279832475)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(105337624602832537)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(105337711042832543)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(105337807362832545)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(105337903032832545)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(105338002203832545)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(105338103181832545)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332201013832476)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332313317832484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332431571832484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332530241832484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332614571832484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332707137832484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332803437832484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105332906543832485)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333021410832485)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(105333129370832485)
,p_plug_template_id=>wwv_flow_api.id(105333021410832485)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333230300832485)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333331983832487)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333429966832487)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333522885832487)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(105333624771832487)
,p_plug_template_id=>wwv_flow_api.id(105333522885832487)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333726824832487)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333801394832487)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105333902923832487)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(105334007136832487)
,p_plug_template_id=>wwv_flow_api.id(105333902923832487)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(105334121886832487)
,p_plug_template_id=>wwv_flow_api.id(105333902923832487)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105334201676832492)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(105334318982832492)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105335521367832509)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105335607514832517)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105335707006832517)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105335820271832517)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105335924959832517)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336028633832517)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336132562832517)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336200300832517)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336324176832517)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336400376832517)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336509118832517)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336609846832517)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336717866832517)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(105336803595832517)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105334420571832496)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105334500390832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105334630207832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105334709497832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105334800847832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105334915081832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105335019458832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105335107055832504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105335205014832506)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105335330716832506)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(105335425160832506)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105336907300832520)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105337011505832526)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105337122944832526)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105337219300832528)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105337306784832535)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105337426206832535)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(105337501974832535)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(105338208980832548)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(105338405748832562)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(105338319325832556)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(105338512176832571)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(105326011877832468)
,p_error_template=>wwv_flow_api.id(105322328880832465)
,p_printer_friendly_template=>wwv_flow_api.id(105328530825832471)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(105320818534832442)
,p_default_button_template=>wwv_flow_api.id(105337624602832537)
,p_default_region_template=>wwv_flow_api.id(105333902923832487)
,p_default_chart_template=>wwv_flow_api.id(105333902923832487)
,p_default_form_template=>wwv_flow_api.id(105333021410832485)
,p_default_reportr_template=>wwv_flow_api.id(105333902923832487)
,p_default_tabform_template=>wwv_flow_api.id(105333902923832487)
,p_default_wizard_template=>wwv_flow_api.id(105333021410832485)
,p_default_menur_template=>wwv_flow_api.id(105332530241832484)
,p_default_listr_template=>wwv_flow_api.id(105333902923832487)
,p_default_irr_template=>wwv_flow_api.id(105333429966832487)
,p_default_report_template=>wwv_flow_api.id(105335019458832504)
,p_default_label_template=>wwv_flow_api.id(105337122944832526)
,p_default_menu_template=>wwv_flow_api.id(105338208980832548)
,p_default_calendar_template=>wwv_flow_api.id(105338319325832556)
,p_default_list_template=>wwv_flow_api.id(105336609846832517)
,p_default_option_label=>wwv_flow_api.id(105337122944832526)
,p_default_required_label=>wwv_flow_api.id(105337426206832535)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(105347711759913054)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(105338813792832589)
,p_name=>'ASIGNACION'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(105338918147832590)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(105339000485832592)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
,p_attribute_03=>'custom_auth'
,p_attribute_05=>'N'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(105338611818832576)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(105338611818832576)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200930083043'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105340627087832709)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105332530241832484)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(105340108078832662)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(105338208980832548)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200929120648'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105351502971913187)
,p_plug_name=>'REGISTRO_GPS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105333429966832487)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(105351726903913189)
,p_name=>'REGISTRO_GPS'
...
,p_owner=>'1462'
,p_internal_uid=>105351726903913189
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105351820594913212)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105351906940913220)
,p_db_column_name=>'ID_GPS'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Id Gps'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105352009152913221)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105352110182913223)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105352231473913225)
,p_db_column_name=>'ESN'
,p_display_order=>5
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105352311962913226)
,p_db_column_name=>'IMEI'
,p_display_order=>6
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(105352724336913376)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1053528'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:ID_GPS:MARCA:TIPO:ESN:IMEI'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105352502938913226)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105351502971913187)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(105337624602832537)
...
,p_user_interface_id=>wwv_flow_api.id(105338611818832576)
,p_tab_set=>'TS1'
,p_name=>'Form on TBL_GPS'
,p_step_title=>'Form on TBL_GPS'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200929153606'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105346925289913029)
,p_plug_name=>'Form on TBL_GPS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105333021410832485)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105347210187913031)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105346925289913029)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105347520828913037)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105347104218913031)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105347320252913031)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(105348425427913057)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105348615377913135)
,p_name=>'P3_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(105346925289913029)
...
,p_field_template=>wwv_flow_api.id(105337122944832526)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105348819812913146)
,p_name=>'P3_ID_GPS'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(105346925289913029)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(105337426206832535)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105349023106913157)
,p_name=>'P3_MARCA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(105346925289913029)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'SELECT ID_MARCA||'' ''||MARCA,MARCA FROM MARCA_GPS'
,p_cSize=>32
,p_cMaxlength=>50
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105349201268913157)
,p_name=>'P3_TIPO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(105346925289913029)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'SELECT ID_MARCA||'' ''||MODELO,MODELO FROM MARCA_GPS'
,p_cSize=>32
,p_cMaxlength=>50
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105349427668913159)
,p_name=>'P3_ESN'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(105346925289913029)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105349609917913159)
,p_name=>'P3_IMEI'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(105346925289913029)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105350504039913160)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TBL_GPS'
,p_attribute_02=>'TBL_GPS'
,p_attribute_03=>'P3_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105350716986913162)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TBL_GPS'
,p_attribute_02=>'TBL_GPS'
,p_attribute_03=>'P3_ROWID'
,p_attribute_04=>'ROWID'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105350919481913162)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(105347320252913031)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200930082840'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105358217085960225)
,p_plug_name=>'REGISTRO_SIM'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105333429966832487)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(105358419312960226)
,p_name=>'REGISTRO_SIM'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">'
,p_owner=>'1462'
,p_internal_uid=>105358419312960226
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105358529990960242)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105358627615960243)
,p_db_column_name=>'ID_SIM'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Id Sim'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'ID_SIM'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105359023148960250)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105475900842237329)
,p_db_column_name=>'TIPO'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105476008597237329)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105476218298244487)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(105389001937815264)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1053891'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:ID_SIM:CODIGO:TIPO:NUMERO:LINEA'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105359215732960250)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105358217085960225)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(105337624602832537)
...
,p_user_interface_id=>wwv_flow_api.id(105338611818832576)
,p_tab_set=>'TS1'
,p_name=>'Form on TBL_SIM'
,p_step_title=>'Form on TBL_SIM'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200929154049'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105353917318960201)
,p_plug_name=>'Form on TBL_SIM'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105333021410832485)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105354231411960204)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105353917318960201)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(105337624602832537)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105354515450960204)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(105353917318960201)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105354113978960204)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(105353917318960201)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105354305262960204)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(105353917318960201)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(105355105892960207)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105355301889960210)
,p_name=>'P5_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105355511196960212)
,p_name=>'P5_ID_SIM'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105355731651960212)
,p_name=>'P5_TIPO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105355904720960214)
,p_name=>'P5_LINEA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105356107804960214)
,p_name=>'P5_PEDIDO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105356328151960215)
,p_name=>'P5_CODIGO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105412414841191270)
,p_name=>'P5_PIN'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_prompt=>'Pin'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105412611175193001)
,p_name=>'P5_PUK'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(105353917318960201)
,p_prompt=>'Puk'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105357208319960220)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TBL_SIM'
,p_attribute_02=>'TBL_SIM'
,p_attribute_03=>'P5_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105357400044960221)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TBL_SIM'
,p_attribute_02=>'TBL_SIM'
,p_attribute_03=>'P5_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105357627535960221)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(105354305262960204)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200929155347'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105364521023970378)
...
'"ID_REGISTRO",',
'"ID_GPS",',
'(select marca from tbl_gps where id_gps=id_gps) as gps,',
'(select tipo from tbl_gps where id_gps=id_gps) as modelo,',
'"ID_SIM",',
'(select codigo from tbl_sim where id_sim=id_sim) as codigo,',
'"ID_UNIDAD",',
'"FECHA_CREACION",',
'"COMENTARIO"',
'from TBL_REGISTRO_GPS ',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(105364727869970378)
,p_name=>'REGISTRO'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">'
,p_owner=>'1462'
,p_internal_uid=>105364727869970378
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105364823712970389)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105364916469970390)
...
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'ID_REGISTRO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105365023466970392)
,p_db_column_name=>'ID_GPS'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Id Gps'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105365112283970392)
,p_db_column_name=>'ID_SIM'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Id Sim'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105365330373970395)
...
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHA_CREACION'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105365417307970396)
...
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'COMENTARIO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105415630726275121)
,p_db_column_name=>'GPS'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Gps'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105415725882275125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105415814795275125)
,p_db_column_name=>'CODIGO'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(105415930315275126)
,p_db_column_name=>'ID_UNIDAD'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Id Unidad'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'ID_UNIDAD'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(105389610249817712)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1053897'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:ID_REGISTRO:FECHA_CREACION:COMENTARIO:GPS:MODELO:CODIGO:ID_UNIDAD'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105365626779970396)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105364521023970378)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(105337624602832537)
...
,p_user_interface_id=>wwv_flow_api.id(105338611818832576)
,p_tab_set=>'TS1'
,p_name=>'Form on TBL_REGISTRO_GPS'
,p_step_title=>'Form on TBL_REGISTRO_GPS'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200930082513'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105359913087970353)
,p_plug_name=>'Form on TBL_REGISTRO_GPS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105333021410832485)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105360213883970356)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105359913087970353)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(105337624602832537)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105360524930970356)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(105359913087970353)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105360120474970356)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(105359913087970353)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105360320174970356)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(105359913087970353)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(105361116677970357)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105361303307970360)
,p_name=>'P7_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(105359913087970353)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105361526088970362)
,p_name=>'P7_ID_REGISTRO'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(105359913087970353)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105361703894970362)
,p_name=>'P7_ID_GPS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(105359913087970353)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select tipo||'' ''||marca,tipo from tbl_gps'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105361920008970362)
,p_name=>'P7_ID_SIM'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(105359913087970353)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select ID_SIM||'' ''||pedido,id_sim from tbl_sim'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105362125532970364)
,p_name=>'P7_ID_UNIDAD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(105359913087970353)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105362317563970364)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105362510831970365)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105363506712970367)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TBL_REGISTRO_GPS'
,p_attribute_02=>'TBL_REGISTRO_GPS'
,p_attribute_03=>'P7_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105363708050970367)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TBL_REGISTRO_GPS'
,p_attribute_02=>'TBL_REGISTRO_GPS'
,p_attribute_03=>'P7_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105363931668970368)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(105360320174970356)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20201008085340'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(105320818534832442)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200929115321'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(105339331525832598)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(105333021410832485)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(105339619642832651)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(105339331525832598)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105339416028832625)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(105339331525832598)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(105339519880832651)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105339823239832662)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105339709204832651)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105340023397832662)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(105339928496832662)
,p_process_sequence=>10
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(106443208889024809)
,p_name=>'test'
,p_url=>'https://www.banguat.gob.gt/variables/ws/TipoCambio.asmx?op=TipoCambioDia'
,p_action=>'REST'
,p_static_parm_04=>'GET'
,p_static_parm_05=>'xml'
,p_static_parm_06=>'/ListBucketResult/Contents'
,p_static_parm_10=>'nvp'
);
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(106443411388024826)
,p_ws_id=>wwv_flow_api.id(106443208889024809)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(106445232641040435)
,p_ws_opers_id=>wwv_flow_api.id(106443411388024826)
,p_name=>'moneda'
,p_input_or_output=>'O'
,p_parm_type=>'string'
,p_path=>'/moneda'
...
/
prompt --application/shared_components/logic/webservices/test2
begin
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(106448314093101942)
,p_name=>'test2'
,p_url=>'https://www.banguat.gob.gt/variables/ws/TipoCambio.asmx?op=TipoCambioDia'
,p_action=>'REST'
,p_static_parm_04=>'GET'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(106448500426101943)
,p_ws_id=>wwv_flow_api.id(106448314093101942)
,p_name=>'doREST'
);
end;
/
