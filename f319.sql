...
,p_default_application_id=>319
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 319 - J_report llantas nuevas
--
-- Application Export:
--   Application:     319
--   Name:            J_report llantas nuevas
--   Date and Time:   12:30 Wednesday April 20, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,319)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_report llantas nuevas')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_319')
...
,p_authentication_id=>wwv_flow_api.id(58211365999867386)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20210325144658'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8757375847056183)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8757468898056183)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8757517972056184)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8757710299056184)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8757830824056184)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8757947116056184)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(57901355740637648)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(58210172987757813)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(57919356925637706)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(57920551202637722)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(57920963351637727)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57901446608637655)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57901544424637659)
,p_page_template_id=>wwv_flow_api.id(57901446608637655)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57901672749637661)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57901755429637661)
,p_page_template_id=>wwv_flow_api.id(57901672749637661)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57901871091637661)
,p_page_template_id=>wwv_flow_api.id(57901672749637661)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57901968059637663)
,p_page_template_id=>wwv_flow_api.id(57901672749637661)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902052053637663)
,p_page_template_id=>wwv_flow_api.id(57901672749637661)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902176410637663)
,p_page_template_id=>wwv_flow_api.id(57901672749637661)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57902254849637663)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902374308637663)
,p_page_template_id=>wwv_flow_api.id(57902254849637663)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902468863637663)
,p_page_template_id=>wwv_flow_api.id(57902254849637663)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902564552637663)
,p_page_template_id=>wwv_flow_api.id(57902254849637663)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902655268637663)
,p_page_template_id=>wwv_flow_api.id(57902254849637663)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902769745637663)
,p_page_template_id=>wwv_flow_api.id(57902254849637663)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57902848036637663)
,p_page_template_id=>wwv_flow_api.id(57902254849637663)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57902976480637663)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903064481637663)
,p_page_template_id=>wwv_flow_api.id(57902976480637663)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903148482637663)
,p_page_template_id=>wwv_flow_api.id(57902976480637663)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903269847637663)
,p_page_template_id=>wwv_flow_api.id(57902976480637663)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903344547637663)
,p_page_template_id=>wwv_flow_api.id(57902976480637663)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57903464107637663)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903545041637663)
,p_page_template_id=>wwv_flow_api.id(57903464107637663)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903669702637663)
,p_page_template_id=>wwv_flow_api.id(57903464107637663)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903767176637663)
,p_page_template_id=>wwv_flow_api.id(57903464107637663)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903872135637663)
,p_page_template_id=>wwv_flow_api.id(57903464107637663)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57903964928637663)
,p_page_template_id=>wwv_flow_api.id(57903464107637663)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57904068083637663)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904164400637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904266215637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904351624637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904469556637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904546829637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904644480637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904765086637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57904863977637663)
,p_page_template_id=>wwv_flow_api.id(57904068083637663)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57904967245637663)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905075437637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905176840637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905255166637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905354509637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905473736637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905548257637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905658657637663)
,p_page_template_id=>wwv_flow_api.id(57904967245637663)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57905773500637664)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905870854637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57905957544637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906059332637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906163916637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906262163637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906360720637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906467157637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906560416637664)
,p_page_template_id=>wwv_flow_api.id(57905773500637664)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57906668335637664)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906767875637666)
,p_page_template_id=>wwv_flow_api.id(57906668335637664)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906865212637666)
,p_page_template_id=>wwv_flow_api.id(57906668335637664)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57906945202637666)
,p_page_template_id=>wwv_flow_api.id(57906668335637664)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(57

...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57917661405637691)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57917761567637691)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57917876390637691)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57917958218637691)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57918056138637691)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57918145001637692)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(57918856087637697)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(57919070065637702)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(57918960678637700)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(57919174523637705)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(57906668335637664)
,p_error_template=>wwv_flow_api.id(57902976480637663)
,p_printer_friendly_template=>wwv_flow_api.id(57909157365637666)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(57901446608637655)
,p_default_button_template=>wwv_flow_api.id(57918274732637692)
,p_default_region_template=>wwv_flow_api.id(57914550630637678)
,p_default_chart_template=>wwv_flow_api.id(57914550630637678)
,p_default_form_template=>wwv_flow_api.id(57913661094637677)
,p_default_reportr_template=>wwv_flow_api.id(57914550630637678)
,p_default_tabform_template=>wwv_flow_api.id(57914550630637678)
,p_default_wizard_template=>wwv_flow_api.id(57913661094637677)
,p_default_menur_template=>wwv_flow_api.id(57913173266637677)
,p_default_listr_template=>wwv_flow_api.id(57914550630637678)
,p_default_irr_template=>wwv_flow_api.id(57914068794637678)
,p_default_report_template=>wwv_flow_api.id(57915651276637683)
,p_default_label_template=>wwv_flow_api.id(57917761567637691)
,p_default_menu_template=>wwv_flow_api.id(57918856087637697)
,p_default_calendar_template=>wwv_flow_api.id(57918960678637700)
,p_default_list_template=>wwv_flow_api.id(57917260598637688)
,p_default_option_label=>wwv_flow_api.id(57917761567637691)
,p_default_required_label=>wwv_flow_api.id(57918056138637691)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(57919450539637708)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(58211365999867386)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(57919267240637705)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(57919267240637705)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190723092921'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47634447114308238)
,p_plug_name=>'Suma'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(57914068794637678)
,p_plug_display_sequence=>35
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select correlativo,cdmedida,',
'Cdclasact ||''-''||corractivo as unidad,',
'estado,posicion,recorrido,profundidad,factcompra,fechaalta,precio, cdbodega',
' from tneumaticos where nueva = 1 and reencauche1 = 0 and reencauche2 = 0 and reencauche3 = 0',
'  and fechabaja is null and estado <> ''E''and precio <> 0 and fechaalta >= :P1_FECHA_INICIAL and fechaalta <= :P1_FECHA_FINAL',
'  and ( cdbodega =(select decode(cdestacion,''01'',''10'', ''20'') from PA_usuarios where lower(usuario) = lower(:APP_USER))',
'  or cdbodega is null)'))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(47634554953308238)
,p_name=>'Suma'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>14391527831004339
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47635045832308244)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33251736036740076)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33251844939740076)
,p_db_column_name=>'CORRELATIVO'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Correlativo'
,p_column_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_CORRELATIVO:#CORRELATIVO#'
,p_column_linktext=>'#CORRELATIVO#'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16650302094395412)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16650402700395414)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'POSICION'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16650531152395414)
,p_db_column_name=>'PROFUNDIDAD'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Profundidad'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'PROFUNDIDAD'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16650614946395414)
,p_db_column_name=>'FACTCOMPRA'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Factcompra'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'FACTCOMPRA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16651421275401648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16651814793419893)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16707226090232037)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(61406722591252607)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(47635147807308470)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'143922'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>1000
,p_report_columns=>'CORRELATIVO:CDMEDIDA:RECORRIDO:ESTADO:UNIDAD:POSICION:PROFUNDIDAD:FACTCOMPRA:FECHAALTA:PRECIO:CDBODEGA'
,p_sort_column_1=>'FECHAALTA'
,p_sort_direction_1=>'DESC'
,p_sort_column_2=>'FECHABAJA'
,p_sort_direction_2=>'ASC'
,p_sum_columns_on_break=>'RECORRIDO:PRECIO'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57936275639684481)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(57914550630637678)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57936864819700333)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(57936275639684481)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(57918274732637692)
,p_button_image_alt=>'Generar'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57924674510276358)
,p_name=>'P1_FECHA_INICIAL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(57936275639684481)
...
,p_field_template=>wwv_flow_api.id(57917761567637691)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57924851375276358)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180117143358'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57938548392884795)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(57913173266637677)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57940651659046544)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(57940766658046544)
,p_name=>'CHECKLIST'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57940972927046547)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57941044687046547)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57941176508046547)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57941251045046547)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57941463348046547)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58173669717559297)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58174456291559302)
,p_db_column_name=>'OT'
,p_display_order=>15
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58205645045390916)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58206574110438206)
,p_db_column_name=>'UNIDAD'
,p_display_order=>17
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(57941652483056334)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(58207170972539723)
,p_report_id=>wwv_flow_api.id(57941652483056334)
,p_name=>'marcar'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(58208872769720042)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(57940651659046544)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57938849325887458)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(57938548392884795)
,p_prompt=>'Nmorden'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57940159782019342)
,p_name=>'P2_OT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(57938548392884795)
,p_prompt=>'OT'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(57940274946034414)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57940567305034422)
,p_event_id=>wwv_flow_api.id(57940274946034414)
,p_event_result=>'TRUE'
...
,p_last_upd_yyyymmddhh24miss=>'20180129101815'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(33266232597866757)
,p_plug_name=>'Detalle'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(57914550630637678)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(33268515207956376)
,p_plug_name=>'Montajes'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(57914068794637678)
,p_plug_display_sequence=>20
...
'   CDMEDIDA as CDMEDIDA,',
'   NUEVA as N,',
'    REENCAUCHE1 as R1,',
'   REENCAUCHE2 as R2,',
'   REENCAUCHE3 as R3,',
' km_desmontaje',
' from TMONTAJES_N where correlativo = :P3_CORRELATIVO'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(33268634400956376)
,p_name=>'Montajes'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'JFAJARDO'
,p_internal_uid=>16623921246641959
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33268821604956392)
,p_db_column_name=>'CORRELATIVO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Correlativo'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33268918795956393)
,p_db_column_name=>'CDMEDIDA'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Cdmedida'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33270434364002007)
,p_db_column_name=>'N'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33270514488002007)
,p_db_column_name=>'R1'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'R1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33270632948002009)
,p_db_column_name=>'R2'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'R2'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(33270719907002009)
,p_db_column_name=>'R3'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'R3'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17432709513675512)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'KM_DESMONTAJE'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(33269416246956695)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'166248'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CORRELATIVO:CDMEDIDA:N:R1:R2:R3:KM_DESMONTAJE:'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(33266528005868156)
,p_name=>'P3_CORRELATIVO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(33266232597866757)
...
,p_step_template=>wwv_flow_api.id(57901446608637655)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57919773216637713)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(57913661094637677)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57920047462637719)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(57919773216637713)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57919858286637716)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(57919773216637713)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57919970375637719)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57920270300637722)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57920170009637719)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57920473166637722)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57920351538637722)
,p_process_sequence=>10
