...
prompt APPLICATION 289 - CHECKLIST MANTENIMIENTO
--
-- Application Export:
--   Application:     289
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,289)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'CHECKLIST MANTENIMIENTO')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'CHECKLIST_MANTENIMIENTO289')
...
,p_authentication_id=>wwv_flow_api.id(10020616484833353)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20211110165138'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(9399216233730729)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116553030955390433)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116553169087390436)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116553273390390436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116553488869390436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116553559380390436)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116553691740390436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(116558354451490476)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(10057807376143987)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(9417213382730745)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(9418700250730746)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(9418406722730746)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(9418808472730746)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9399321298730729)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9399409914730734)
,p_page_template_id=>wwv_flow_api.id(9399321298730729)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9399509767730734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9399618278730734)
,p_page_template_id=>wwv_flow_api.id(9399509767730734)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9399718674730734)
,p_page_template_id=>wwv_flow_api.id(9399509767730734)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9399802831730734)
,p_page_template_id=>wwv_flow_api.id(9399509767730734)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9399900771730734)
,p_page_template_id=>wwv_flow_api.id(9399509767730734)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400018365730734)
,p_page_template_id=>wwv_flow_api.id(9399509767730734)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9400124785730734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400222144730734)
,p_page_template_id=>wwv_flow_api.id(9400124785730734)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400327368730734)
,p_page_template_id=>wwv_flow_api.id(9400124785730734)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400431383730734)
,p_page_template_id=>wwv_flow_api.id(9400124785730734)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400503722730734)
,p_page_template_id=>wwv_flow_api.id(9400124785730734)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400618425730734)
,p_page_template_id=>wwv_flow_api.id(9400124785730734)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400714986730734)
,p_page_template_id=>wwv_flow_api.id(9400124785730734)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9400810575730734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9400909568730734)
,p_page_template_id=>wwv_flow_api.id(9400810575730734)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401019638730734)
,p_page_template_id=>wwv_flow_api.id(9400810575730734)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401120914730734)
,p_page_template_id=>wwv_flow_api.id(9400810575730734)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401227636730734)
,p_page_template_id=>wwv_flow_api.id(9400810575730734)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9401317605730734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401426584730734)
,p_page_template_id=>wwv_flow_api.id(9401317605730734)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401503722730734)
,p_page_template_id=>wwv_flow_api.id(9401317605730734)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401622529730734)
,p_page_template_id=>wwv_flow_api.id(9401317605730734)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401719788730734)
,p_page_template_id=>wwv_flow_api.id(9401317605730734)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9401820291730734)
,p_page_template_id=>wwv_flow_api.id(9401317605730734)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9401920263730734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402031323730734)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402127089730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402214779730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402309560730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402414476730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402530950730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402606719730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402710414730735)
,p_page_template_id=>wwv_flow_api.id(9401920263730734)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9402830015730735)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9402925217730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403017572730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403104812730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403205115730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403309700730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403414198730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403504592730735)
,p_page_template_id=>wwv_flow_api.id(9402830015730735)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9403614372730735)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403711213730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403801803730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9403932194730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404023343730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404110464730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404209705730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404323133730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404405669730735)
,p_page_template_id=>wwv_flow_api.id(9403614372730735)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9404507249730735)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404601626730735)
,p_page_template_id=>wwv_flow_api.id(9404507249730735)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404721915730735)
,p_page_template_id=>wwv_flow_api.id(9404507249730735)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404814939730735)
,p_page_template_id=>wwv_flow_api.id(9404507249730735)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9404914038730735)
,p_page_template_id=>wwv_flow_api.id(9404507249730735)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405020814730735)
,p_page_template_id=>wwv_flow_api.id(9404507249730735)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405110918730735)
,p_page_template_id=>wwv_flow_api.id(9404507249730735)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9405205488730735)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405313772730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405411889730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405506076730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405631879730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405732424730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405822925730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9405921058730735)
,p_page_template_id=>wwv_flow_api.id(9405205488730735)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9406031430730735)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406101697730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406200290730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406309484730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406416143730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406521148730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406610819730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406709451730735)
,p_page_template_id=>wwv_flow_api.id(9406031430730735)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9406809470730735)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9406906999730735)
,p_page_template_id=>wwv_flow_api.id(9406809470730735)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9407005555730737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407110104730737)
,p_page_template_id=>wwv_flow_api.id(9407005555730737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407229987730737)
,p_page_template_id=>wwv_flow_api.id(9407005555730737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407325050730737)
,p_page_template_id=>wwv_flow_api.id(9407005555730737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407425153730737)
,p_page_template_id=>wwv_flow_api.id(9407005555730737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9407526657730737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407614465730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407700027730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407826721730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9407901905730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408015175730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408100496730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408202828730737)
,p_page_template_id=>wwv_flow_api.id(9407526657730737)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9408320644730737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408406861730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408521051730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408631193730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408729035730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408831442730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9408902128730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409008284730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409104092730737)
,p_page_template_id=>wwv_flow_api.id(9408320644730737)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9409215860730737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409325002730737)
,p_page_template_id=>wwv_flow_api.id(9409215860730737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409416063730737)
,p_page_template_id=>wwv_flow_api.id(9409215860730737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409527485730737)
,p_page_template_id=>wwv_flow_api.id(9409215860730737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409623921730737)
,p_page_template_id=>wwv_flow_api.id(9409215860730737)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409713263730737)
,p_page_template_id=>wwv_flow_api.id(9409215860730737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9409826528730737)
,p_page_template_id=>wwv_flow_api.id(9409215860730737)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(9409929170730737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410015389730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410125216730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410224362730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410331302730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410404259730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410509766730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(9410606006730737)
,p_page_template_id=>wwv_flow_api.id(9409929170730737)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(9416115114730743)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(9416210471730743)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(9416318051730743)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(9416414601730743)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(9416516656730743)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(9416604962730743)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9410702582730737)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9410817152730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9410911897730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411017956730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411122436730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411222844730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411328019730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411420277730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411528986730739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9411620331730740)
,p_plug_template_id=>wwv_flow_api.id(9411528986730739)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411705748730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411800300730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9411914076730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9412030437730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9412107606730740)
,p_plug_template_id=>wwv_flow_api.id(9412030437730740)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9412224165730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9412304851730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9412414530730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9412517396730740)
,p_plug_template_id=>wwv_flow_api.id(9412414530730740)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9412628597730740)
,p_plug_template_id=>wwv_flow_api.id(9412414530730740)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9412706999730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9412822424730740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414014745730742)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414102501730742)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414219419730742)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414332203730742)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414426292730742)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414507221730742)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414609346730742)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414700127730742)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414803138730742)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9414932209730742)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9415007585730742)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9415128936730742)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9415202103730742)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(9415310931730742)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9412931318730740)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413023619730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413102845730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413203192730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413310913730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413417063730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413515553730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413606951730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413712188730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413803905730742)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(9413904949730742)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9415414175730743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9415520544730743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9415631014730743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9415708663730743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9415831292730743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9415928305730743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(9416027134730743)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(9416714723730743)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(9416907189730743)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(9416822054730743)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(9417018264730745)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(9404507249730735)
,p_error_template=>wwv_flow_api.id(9400810575730734)
,p_printer_friendly_template=>wwv_flow_api.id(9407005555730737)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(9399321298730729)
,p_default_button_template=>wwv_flow_api.id(9416115114730743)
,p_default_region_template=>wwv_flow_api.id(9412414530730740)
,p_default_chart_template=>wwv_flow_api.id(9412414530730740)
,p_default_form_template=>wwv_flow_api.id(9411528986730739)
,p_default_reportr_template=>wwv_flow_api.id(9412414530730740)
,p_default_tabform_template=>wwv_flow_api.id(9412414530730740)
,p_default_wizard_template=>wwv_flow_api.id(9411528986730739)
,p_default_menur_template=>wwv_flow_api.id(9411017956730739)
,p_default_listr_template=>wwv_flow_api.id(9412414530730740)
,p_default_irr_template=>wwv_flow_api.id(9411914076730740)
,p_default_report_template=>wwv_flow_api.id(9413515553730742)
,p_default_label_template=>wwv_flow_api.id(9415631014730743)
,p_default_menu_template=>wwv_flow_api.id(9416714723730743)
,p_default_calendar_template=>wwv_flow_api.id(9416822054730743)
,p_default_list_template=>wwv_flow_api.id(9415128936730742)
,p_default_option_label=>wwv_flow_api.id(9415631014730743)
,p_default_required_label=>wwv_flow_api.id(9415928305730743)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(9502020714114059)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(9417306230730745)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10020616484833353)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(35289363694097491408)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37882636855698693453)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882653367950706433)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
,p_display_sequence=>10
,p_display_value=>'Contains/Case (uses INSTR)'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882662456999712746)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882663961501714058)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882667367388715780)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882681373968717660)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882683946394719137)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37882695953667721222)
,p_plugin_attribute_id=>wwv_flow_api.id(37882636855698693453)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37884381251093259747)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884393559751262278)
,p_plugin_attribute_id=>wwv_flow_api.id(37884381251093259747)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884404863906263441)
,p_plugin_attribute_id=>wwv_flow_api.id(37884381251093259747)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37884417068193274121)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'bar'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(37884381251093259747)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884561455866355753)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>10
,p_display_value=>'Bar'
,p_return_value=>'bar'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884562760715357128)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884564864524358166)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884566268333359319)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884567372489360502)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884569644569361957)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884570851495363906)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37884571755651365146)
,p_plugin_attribute_id=>wwv_flow_api.id(37884417068193274121)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37885495256679989828)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31738977340971886995)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31738978845472888333)
,p_plugin_attribute_id=>wwv_flow_api.id(31738977340971886995)
,p_display_sequence=>10
,p_display_value=>'Slow'
,p_return_value=>'600'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31738979448589889175)
,p_plugin_attribute_id=>wwv_flow_api.id(31738977340971886995)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31738980051706890043)
,p_plugin_attribute_id=>wwv_flow_api.id(31738977340971886995)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31738980756208891414)
,p_plugin_attribute_id=>wwv_flow_api.id(31738977340971886995)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24370421253236337604)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14719860329470043280)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31172198153686422748)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(24281342640666908406)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281326247283862985)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281328449146872953)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281334042482889917)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281335357373894237)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281336230146895814)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281337741920899261)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281342640666908406)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13654378189083825246)
,p_plugin_attribute_id=>wwv_flow_api.id(24281342640666908406)
,p_display_sequence=>10
,p_display_value=>'Not Enterable'
,p_return_value=>'NOT_ENTERABLE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13654416300165828417)
,p_plugin_attribute_id=>wwv_flow_api.id(24281342640666908406)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13654447108476830831)
,p_plugin_attribute_id=>wwv_flow_api.id(24281342640666908406)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281381955473931540)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24281343651401911458)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(116558215544490476)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(29125322060146494256)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885586060943011263)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885589755983013539)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885591852101015257)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885593848651016864)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885596144122018956)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885601671283021648)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885605164381024831)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37885608457049028205)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
,p_file_name=>'bar.gif'
,p_mime_type=>'image/gif'
,p_file_content=>wwv_flow_api.varchar2_to_blob(wwv_flow_api.g_varchar2_table)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(59146701977989435978)
,p_plugin_id=>wwv_flow_api.id(35289363694097491408)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(9417106902730745)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(9417106902730745)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210915133416'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(9418905036730746)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(9411017956730739)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(9418406722730746)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(9416714723730743)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(9419400584784573)
,p_plug_name=>'Tsupervision'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(9412414530730740)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(9932924626351592)
,p_name=>'Tabular Form'
,p_parent_plug_id=>wwv_flow_api.id(9419400584784573)
,p_template=>wwv_flow_api.id(9412414530730740)
...
':P1_NMORDEN as ORDEN',
'from TCAT_SUPERVISION where nmexamen=decode(:P1_EVALUACION,44,4,43,5,54,10,55,6,53,9,121,20)'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_NMSUPER,P1_EVALUACION,P1_FECHA,P1_COMENTARIO,P1_NMORDEN'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(9413515553730742)
,p_query_num_rows=>50
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9935119938351628)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9933218785351612)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9933319887351612)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9933406205351612)
,p_query_column_id=>4
,p_column_alias=>'ITEM'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9933508424351612)
,p_query_column_id=>5
,p_column_alias=>'TIPO'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9933619327351612)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9950709447809200)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9966504867579739)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(9966624882579739)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(10030330894470282)
...
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9935602130354493)
,p_column_sequence=>1
,p_query_column_name=>'ROWID'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9935704933354493)
,p_column_sequence=>2
,p_query_column_name=>'NMEXAMEN'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9935826836354493)
,p_column_sequence=>3
,p_query_column_name=>'ITEM'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9935931383354493)
,p_column_sequence=>4
,p_query_column_name=>'TIPO'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9936005644354493)
,p_column_sequence=>5
,p_query_column_name=>'DESCRIPCION'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9950615882809196)
,p_column_sequence=>6
,p_query_column_name=>'REPARACION'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9966201675579735)
,p_column_sequence=>7
,p_query_column_name=>'FECHA'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(9966320295579735)
,p_column_sequence=>8
,p_query_column_name=>'COMENTARIO'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_region_rpt_cols(
 p_id=>wwv_flow_api.id(10030231262470276)
,p_column_sequence=>9
,p_query_column_name=>'ORDEN'
,p_display_as=>'TEXT'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(9943727939541709)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(9932924626351592)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(9416115114730743)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(9419825453784575)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(9419400584784573)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(9420019312784575)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(9444326563889293)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9420217682784575)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
...
,p_field_template=>wwv_flow_api.id(9415631014730743)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9420411626784576)
,p_name=>'P1_NMSUPER'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9420609153784576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9420830271784576)
,p_name=>'P1_CDPILOTO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9421002802784576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9421213597784576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9421420430784578)
,p_name=>'P1_FECHA'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9421622068784578)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9421822310784578)
,p_name=>'P1_ANUNCIADA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9422023764784578)
,p_name=>'P1_PUNTAJE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9425714190129710)
,p_name=>'P1_NMORDEN'
,p_is_required=>true
,p_item_sequence=>16
,p_item_plug_id=>wwv_flow_api.id(9419400584784573)
...
'Select cdclase||''-''||correlativo ||''-''|| nmorden ||''-''|| dsrepara,  nmorden',
' from tordenserv   where   cddelegacion=( select decode(cdestacion,''00'',cddelegacion, cdestacion) ',
'from PA_usuarios where lower(usuario) = lower(:APP_USER)) and cod_falla in (43,44,53,54,55,121) and estado=''A'''))
,p_lov_display_null=>'YES'
,p_cSize=>30
,p_cMaxlength=>4000
,p_field_template=>wwv_flow_api.id(9415928305730743)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(9424725911820234)
,p_name=>'cargar_DATOS'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(9425015535820235)
,p_event_id=>wwv_flow_api.id(9424725911820234)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(9932924626351592)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(9982424877062801)
,p_name=>'HABILITAR '
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(9982717717062807)
,p_event_id=>wwv_flow_api.id(9982424877062801)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(9983332281074451)
,p_name=>'DEAHBILITAR'
,p_event_sequence=>30
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(9983617153074451)
,p_event_id=>wwv_flow_api.id(9983332281074451)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(115553325026322932)
,p_name=>'Actualizar'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_NMORDEN'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(115553468074322933)
,p_event_id=>wwv_flow_api.id(115553325026322932)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_EVALUACION'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'Select cod_falla from  tordenserv where nmorden=:p1_nmorden'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9423315854784579)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9423705713784581)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9943126366427734)
...
'',
'select decode(cdestacion,''00'',2,''01'',2,''02'',6) into taller from PA_USUARIOS where lower(usuario) = lower(:APP_USER);',
'',
'select serie into series from PA_USUARIOS where lower(usuario) = lower(:APP_USER);',
'select cdclase into clase from tordenserv where nmorden=apex_application.g_f09(1)  AND  CDDELEGACION=DELEGACION;',
'select correlativo into correlativos from tordenserv where nmorden=apex_application.g_f09(1) AND  CDDELEGACION=DELEGACION;',
...
'',
'insert into tsupervision (nmsuper,cdresponsable, comentario, fecha,Evaluacion, fechacreado, smant,OT,CDESTACION) values(NMSUPERV, empleado, comenta, apex_application.g_f07(1), apex_application.g_f02(1), sysdate(),1, apex_application.g_f09(1),delegaci'
||'on);',
'   FOR i IN 1 .. apex_application.g_f04.COUNT',
'loop',
'insert into tcheklist_det(nmsuper,item,evaluacion,cumple, comentario,ot_relacionada) values (NMSUPERV,apex_application.g_f03(i) ,apex_application.g_f02(i),apex_application.g_f06(i),'''',NULL);',
'if apex_application.g_f06(i) =''M'' then ',
'select  max(nmorden)+1 into numot from tordenserv;',
'',
'insert into tordenserv(cdtiporden,nmorden,fecrea, cdclase,correlativo, dsrepara, estado, cdempresa,serie,cddelegacion, cdempleado, cdautoriza,reportado_por,cod_falla,creado,unidad, tipo_ot,taller)',
'values                (2,numot,sysdate(),clase,correlativos,apex_application.g_f05(i),''A'',''01'',series,delegacion,empleado,empleado,empleado,52,sysdate(),clase||''-''||correlativos,''RP'',taller);',
'',
...
'End;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(9943727939541709)
...
,p_step_template=>wwv_flow_api.id(9399321298730729)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(9417602597730745)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(9411528986730739)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(9417913964730746)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(9417602597730745)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9417705392730745)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(9417602597730745)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(9417817834730746)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9418110153730746)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9418015946730746)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9418311302730746)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9418207280730746)
,p_process_sequence=>10
