...
prompt APPLICATION 308 - Comisiones_dolares
--
-- Application Export:
--   Application:     308
--   Name:            Comisiones_dolares
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,308)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Comisiones_dolares')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_308')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'3B9E2270EF3293B77EAE566BD0BE7952B379D22521FED7F983CC18C950EECE0C'
...
,p_authentication_id=>wwv_flow_api.id(38787901132928471)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Comisiones_dolares'
...
,p_last_upd_yyyymmddhh24miss=>'20190617180227'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8745606425053785)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8745748021053785)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8745888085053785)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8746012407053785)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8746125510053785)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8746283053053785)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(38767613160913825)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(38785615592913948)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(38787124022913987)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(38786800763913978)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(38787222838913987)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38767720315913837)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38767821753913848)
,p_page_template_id=>wwv_flow_api.id(38767720315913837)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38767910017913853)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768009003913853)
,p_page_template_id=>wwv_flow_api.id(38767910017913853)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768114819913853)
,p_page_template_id=>wwv_flow_api.id(38767910017913853)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768217942913853)
,p_page_template_id=>wwv_flow_api.id(38767910017913853)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768316591913853)
,p_page_template_id=>wwv_flow_api.id(38767910017913853)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768408839913853)
,p_page_template_id=>wwv_flow_api.id(38767910017913853)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38768512749913853)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768601520913853)
,p_page_template_id=>wwv_flow_api.id(38768512749913853)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768709143913853)
,p_page_template_id=>wwv_flow_api.id(38768512749913853)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768831341913853)
,p_page_template_id=>wwv_flow_api.id(38768512749913853)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38768925830913853)
,p_page_template_id=>wwv_flow_api.id(38768512749913853)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769009529913853)
,p_page_template_id=>wwv_flow_api.id(38768512749913853)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769128766913853)
,p_page_template_id=>wwv_flow_api.id(38768512749913853)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38769226406913853)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769305106913854)
,p_page_template_id=>wwv_flow_api.id(38769226406913853)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769425074913854)
,p_page_template_id=>wwv_flow_api.id(38769226406913853)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769520020913854)
,p_page_template_id=>wwv_flow_api.id(38769226406913853)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769622162913854)
,p_page_template_id=>wwv_flow_api.id(38769226406913853)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38769715645913854)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769822471913854)
,p_page_template_id=>wwv_flow_api.id(38769715645913854)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38769930365913854)
,p_page_template_id=>wwv_flow_api.id(38769715645913854)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770022943913854)
,p_page_template_id=>wwv_flow_api.id(38769715645913854)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770125252913854)
,p_page_template_id=>wwv_flow_api.id(38769715645913854)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770202475913854)
,p_page_template_id=>wwv_flow_api.id(38769715645913854)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38770314907913856)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770425868913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770514788913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770600180913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770727775913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770815712913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38770919939913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771031801913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771124944913857)
,p_page_template_id=>wwv_flow_api.id(38770314907913856)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38771210789913857)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771325597913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771428457913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771527066913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771619562913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771710834913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771818095913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38771930969913857)
,p_page_template_id=>wwv_flow_api.id(38771210789913857)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38772013432913857)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772100078913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772213828913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772325160913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772404820913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772525272913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772600916913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772722277913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38772808309913857)
,p_page_template_id=>wwv_flow_api.id(38772013432913857)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38772918463913857)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773004948913857)
,p_page_template_id=>wwv_flow_api.id(38772918463913857)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773105095913857)
,p_page_template_id=>wwv_flow_api.id(38772918463913857)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773206727913857)
,p_page_template_id=>wwv_flow_api.id(38772918463913857)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773331106913857)
,p_page_template_id=>wwv_flow_api.id(38772918463913857)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773410851913857)
,p_page_template_id=>wwv_flow_api.id(38772918463913857)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773526692913857)
,p_page_template_id=>wwv_flow_api.id(38772918463913857)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38773627615913857)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773713118913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773810207913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38773900923913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774025985913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774106718913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774212042913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774313673913859)
,p_page_template_id=>wwv_flow_api.id(38773627615913857)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38774406480913859)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774520829913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774632414913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774702858913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774815316913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38774915135913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775029038913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775130893913859)
,p_page_template_id=>wwv_flow_api.id(38774406480913859)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38775209137913859)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775313201913859)
,p_page_template_id=>wwv_flow_api.id(38775209137913859)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38775425662913859)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775530365913859)
,p_page_template_id=>wwv_flow_api.id(38775425662913859)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775617574913859)
,p_page_template_id=>wwv_flow_api.id(38775425662913859)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775720094913859)
,p_page_template_id=>wwv_flow_api.id(38775425662913859)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38775831971913859)
,p_page_template_id=>wwv_flow_api.id(38775425662913859)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38775917229913859)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776016836913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776126067913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776203743913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776312739913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776429425913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776501109913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776606071913860)
,p_page_template_id=>wwv_flow_api.id(38775917229913859)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38776713064913860)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776831132913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38776930849913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777005206913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777101455913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777216578913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777307107913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777408870913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777514244913860)
,p_page_template_id=>wwv_flow_api.id(38776713064913860)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38777601058913860)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777706620913860)
,p_page_template_id=>wwv_flow_api.id(38777601058913860)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777813356913860)
,p_page_template_id=>wwv_flow_api.id(38777601058913860)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38777926167913860)
,p_page_template_id=>wwv_flow_api.id(38777601058913860)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778015036913860)
,p_page_template_id=>wwv_flow_api.id(38777601058913860)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778117549913860)
,p_page_template_id=>wwv_flow_api.id(38777601058913860)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778218533913860)
,p_page_template_id=>wwv_flow_api.id(38777601058913860)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(38778326729913860)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778400144913860)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778516265913860)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778627807913862)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778720342913862)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778823445913862)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38778904250913862)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(38779032025913862)
,p_page_template_id=>wwv_flow_api.id(38778326729913860)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(8746586110053815)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(38784530381913895)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(38784618396913900)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(38784716986913900)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(38784802335913900)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(38784922773913900)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(38785000695913900)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779127042913864)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779230711913870)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779324594913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779425438913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779513129913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779614229913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779730068913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779819935913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38779925121913871)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(38780012475913871)
,p_plug_template_id=>wwv_flow_api.id(38779925121913871)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780115460913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780207376913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780330419913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780430748913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(38780524012913873)
,p_plug_template_id=>wwv_flow_api.id(38780430748913873)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780600068913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780700186913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38780821011913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(38780914672913873)
,p_plug_template_id=>wwv_flow_api.id(38780821011913873)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(38781000908913873)
,p_plug_template_id=>wwv_flow_api.id(38780821011913873)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38781132762913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(38781210011913873)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38782421638913884)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38782525778913889)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38782624395913890)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38782716272913890)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38782820525913890)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38782925401913890)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783015636913890)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783116679913890)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783201971913890)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783305567913890)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783419461913890)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783507966913890)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783618567913890)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(38783704016913890)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781319189913875)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781400460913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781504549913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781622412913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781718701913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781816351913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38781921226913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38782019096913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38782101637913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38782210094913882)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38782309375913882)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38783825885913890)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38783911587913893)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38784016029913893)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38784103987913895)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38784205237913895)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38784308587913895)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(38784429417913895)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(38785111026913900)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(38785312600913915)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(38785206313913906)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(38785404888913921)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(38772918463913857)
,p_error_template=>wwv_flow_api.id(38769226406913853)
,p_printer_friendly_template=>wwv_flow_api.id(38775425662913859)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(38767720315913837)
,p_default_button_template=>wwv_flow_api.id(38784530381913895)
,p_default_region_template=>wwv_flow_api.id(38780821011913873)
,p_default_chart_template=>wwv_flow_api.id(38780821011913873)
,p_default_form_template=>wwv_flow_api.id(38779925121913871)
,p_default_reportr_template=>wwv_flow_api.id(38780821011913873)
,p_default_tabform_template=>wwv_flow_api.id(38780821011913873)
,p_default_wizard_template=>wwv_flow_api.id(38779925121913871)
,p_default_menur_template=>wwv_flow_api.id(38779425438913871)
,p_default_listr_template=>wwv_flow_api.id(38780821011913873)
,p_default_irr_template=>wwv_flow_api.id(38780330419913873)
,p_default_report_template=>wwv_flow_api.id(38781921226913882)
,p_default_label_template=>wwv_flow_api.id(38784016029913893)
,p_default_menu_template=>wwv_flow_api.id(38785111026913900)
,p_default_calendar_template=>wwv_flow_api.id(38785206313913906)
,p_default_list_template=>wwv_flow_api.id(38783507966913890)
,p_default_option_label=>wwv_flow_api.id(38784016029913893)
,p_default_required_label=>wwv_flow_api.id(38784308587913895)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(38785701421913954)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(38787901132928471)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(38785521210913923)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(38785521210913923)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(38787324700913990)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(38779425438913871)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(38786800763913978)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(38785111026913900)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(38788213119936817)
,p_plug_name=>'Comisiones_dolares'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(38780330419913873)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select * from v_boleta_comision where cdorigen =1005 and fecha>=:P1_FECHA_INICIAL and fecha<= :P1_FECHA_FINAL AND OPERADO_dOLARES =0'
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P1_FECHA_FINAL,P1_FECHA_INICIAL'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(38788316000936817)
,p_name=>'Comisiones_dolares'
...
,p_owner=>'LP'
,p_internal_uid=>38788316000936817
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38788506203936845)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38788627057936850)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38788714612936850)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38788826865936850)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38788932038936850)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789019540936850)
,p_db_column_name=>'KMRECORRIDO'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Kmrecorrido'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'KMRECORRIDO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789129656936850)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789232635936851)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789312280936851)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789430318936851)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CDDESTINO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789526389936851)
,p_db_column_name=>'NOMBRE_DESTINO'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Nombre Destino'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'NOMBRE_DESTINO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789605285936851)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789717730936851)
,p_db_column_name=>'COMIORIGINAL'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'Comioriginal'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'COMIORIGINAL'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789823924936853)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38789914535936853)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38790030135936853)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38790109588936853)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38790210186936853)
,p_db_column_name=>'OPERADO_DOLARES'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'Operado Dolares'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'OPERADO_DOLARES'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(38790314504937137)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'387904'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'UNIDAD:CDEMPLEADO:NOMBRE:NMNOTA:COMPLEMENTO:KMRECORRIDO:FECHA:CDORIGEN:DSCLIENTE:CDDESTINO:NOMBRE_DESTINO:SUBTOTAL:COMIORIGINAL:COMISION:TIPO:GALONES:COMISION_EXTRA:OPERADO_DOLARES'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(38790722469939432)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(38780821011913873)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(38791215772952100)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(38790722469939432)
,p_button_name=>'Visualizar'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(8746586110053815)
,p_button_image_alt=>'Visualizar'
,p_button_position=>'BOTTOM'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(38791400092952103)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(38791810165954720)
,p_name=>'P1_FECHA_INICIAL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(38790722469939432)
...
,p_field_template=>wwv_flow_api.id(38784016029913893)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(38792005050954723)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(38794819605011075)
,p_name=>'P1_TIPO_CAMBIO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(38790722469939432)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(38794220269005050)
,p_name=>'Actualizar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(38791215772952100)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(38794500341005054)
,p_event_id=>wwv_flow_api.id(38794220269005050)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(38788213119936817)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(38795627420073348)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Actualiza_comision'
,p_process_sql_clob=>'update  tcomiemp set comision= comision*:P1_TIPO_CAMBIO, comision_extra=0,operado_dolares=1  where nmnota in (select nmnota from v_boleta_comision where cdorigen =1005 and fecha>=:P1_FECHA_INICIAL and fecha<=:P1_FECHA_FINAL   AND OPERADO_dOLARES =0);'
,p_process_error_message=>'Algo Salio mal'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(38791400092952103)
,p_process_success_message=>'Actualizadas las notas '
);
end;
/
...
,p_step_template=>wwv_flow_api.id(38767720315913837)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20181011094547'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(38786014511913959)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(38779925121913871)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(38786308114913973)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(38786014511913959)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(38784530381913895)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(38786102043913965)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(38786014511913959)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(38786218829913971)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(38786532617913978)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(38786418686913975)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(38786702729913978)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(38786624749913978)
,p_process_sequence=>10
