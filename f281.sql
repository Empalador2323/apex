...
prompt APPLICATION 281 - LLANTAS
--
-- Application Export:
--   Application:     281
--   Name:            LLANTAS
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,281)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LLANTAS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_281')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'42B742744543561E67FA17946FE909FC07BB0E835E25742427026ADC75F744FC'
...
,p_authentication_id=>wwv_flow_api.id(10751329025878915)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LLANTAS'
...
,p_last_upd_yyyymmddhh24miss=>'20171129165247'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8701126460041436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8701248544041436)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8701342340041436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8701566429041436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8701645997041436)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8701746522041436)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(10733107193878798)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(10751103370878909)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(10751227754878912)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(10752719570878946)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(10757315583879042)
,p_parent_id=>0
,p_short_name=>'Tneumaticos'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10733225264878812)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10733327589878825)
,p_page_template_id=>wwv_flow_api.id(10733225264878812)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10733420255878826)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10733530654878826)
,p_page_template_id=>wwv_flow_api.id(10733420255878826)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10733603693878826)
,p_page_template_id=>wwv_flow_api.id(10733420255878826)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10733717940878826)
,p_page_template_id=>wwv_flow_api.id(10733420255878826)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10733812335878826)
,p_page_template_id=>wwv_flow_api.id(10733420255878826)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10733929643878826)
,p_page_template_id=>wwv_flow_api.id(10733420255878826)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10734019080878826)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734105994878828)
,p_page_template_id=>wwv_flow_api.id(10734019080878826)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734224435878828)
,p_page_template_id=>wwv_flow_api.id(10734019080878826)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734304325878828)
,p_page_template_id=>wwv_flow_api.id(10734019080878826)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734411758878828)
,p_page_template_id=>wwv_flow_api.id(10734019080878826)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734511970878828)
,p_page_template_id=>wwv_flow_api.id(10734019080878826)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734616078878828)
,p_page_template_id=>wwv_flow_api.id(10734019080878826)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10734714751878828)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734801832878828)
,p_page_template_id=>wwv_flow_api.id(10734714751878828)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10734905720878828)
,p_page_template_id=>wwv_flow_api.id(10734714751878828)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735029325878828)
,p_page_template_id=>wwv_flow_api.id(10734714751878828)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735105239878828)
,p_page_template_id=>wwv_flow_api.id(10734714751878828)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10735207563878828)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735331175878828)
,p_page_template_id=>wwv_flow_api.id(10735207563878828)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735403381878828)
,p_page_template_id=>wwv_flow_api.id(10735207563878828)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735515630878828)
,p_page_template_id=>wwv_flow_api.id(10735207563878828)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735621153878828)
,p_page_template_id=>wwv_flow_api.id(10735207563878828)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735731078878828)
,p_page_template_id=>wwv_flow_api.id(10735207563878828)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10735822930878828)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10735916552878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736012246878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736126340878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736228413878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736331204878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736411367878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736510017878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736631724878829)
,p_page_template_id=>wwv_flow_api.id(10735822930878828)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10736710172878829)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736814216878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10736913648878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737029376878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737123488878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737221204878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737300844878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737401227878829)
,p_page_template_id=>wwv_flow_api.id(10736710172878829)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10737507055878829)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737618682878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737713111878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737806049878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10737920886878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738019622878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738126201878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738208353878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738326893878829)
,p_page_template_id=>wwv_flow_api.id(10737507055878829)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10738402990878829)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738507479878829)
,p_page_template_id=>wwv_flow_api.id(10738402990878829)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738604803878829)
,p_page_template_id=>wwv_flow_api.id(10738402990878829)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738712590878829)
,p_page_template_id=>wwv_flow_api.id(10738402990878829)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738800638878829)
,p_page_template_id=>wwv_flow_api.id(10738402990878829)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10738925843878829)
,p_page_template_id=>wwv_flow_api.id(10738402990878829)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739019108878829)
,p_page_template_id=>wwv_flow_api.id(10738402990878829)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10739125528878829)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739207110878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739319940878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739409423878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739527300878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739626722878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739726486878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10739810830878831)
,p_page_template_id=>wwv_flow_api.id(10739125528878829)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10739916679878831)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740031625878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740115683878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740232625878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740303049878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740414138878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740504466878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740600221878831)
,p_page_template_id=>wwv_flow_api.id(10739916679878831)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10740717539878831)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10740805348878831)
,p_page_template_id=>wwv_flow_api.id(10740717539878831)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10740920560878831)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741015065878832)
,p_page_template_id=>wwv_flow_api.id(10740920560878831)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741105182878832)
,p_page_template_id=>wwv_flow_api.id(10740920560878831)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741213908878832)
,p_page_template_id=>wwv_flow_api.id(10740920560878831)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741331022878832)
,p_page_template_id=>wwv_flow_api.id(10740920560878831)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10741409941878832)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741514859878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741619172878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741730842878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741823356878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10741906078878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742005346878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742112065878832)
,p_page_template_id=>wwv_flow_api.id(10741409941878832)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10742206523878832)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742317039878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742406975878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742508996878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742626194878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742713011878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742821369878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10742905497878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743006234878832)
,p_page_template_id=>wwv_flow_api.id(10742206523878832)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10743128407878832)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743220426878832)
,p_page_template_id=>wwv_flow_api.id(10743128407878832)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743331012878832)
,p_page_template_id=>wwv_flow_api.id(10743128407878832)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743402263878832)
,p_page_template_id=>wwv_flow_api.id(10743128407878832)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743519901878832)
,p_page_template_id=>wwv_flow_api.id(10743128407878832)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743615762878832)
,p_page_template_id=>wwv_flow_api.id(10743128407878832)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743701942878832)
,p_page_template_id=>wwv_flow_api.id(10743128407878832)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10743821185878832)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10743911195878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10744016386878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10744128230878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10744219469878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10744312305878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10744429451878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10744520878878832)
,p_page_template_id=>wwv_flow_api.id(10743821185878832)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10825206306919656)
,p_theme_id=>23
,p_name=>'Login'
,p_internal_name=>'LOGIN'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/no_tabs_left_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10825404292919685)
,p_theme_id=>23
,p_name=>'No Tabs - Left Sidebar'
,p_internal_name=>'NO_TABS_LEFT_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/no_tabs_left_and_right_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10825716318919685)
,p_theme_id=>23
,p_name=>'No Tabs - Left and Right Sidebar'
,p_internal_name=>'NO_TABS_LEFT_AND_RIGHT_SIDEBAR'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10826013337919687)
,p_theme_id=>23
,p_name=>'No Tabs - No Sidebar'
,p_internal_name=>'NO_TABS_NO_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/no_tabs_right_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10826312756919687)
,p_theme_id=>23
,p_name=>'No Tabs - Right Sidebar'
,p_internal_name=>'NO_TABS_RIGHT_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/one_level_tabs_left_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10826621774919687)
,p_theme_id=>23
,p_name=>'One Level Tabs - Left Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_LEFT_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/one_level_tabs_left_and_right_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10826914397919689)
,p_theme_id=>23
,p_name=>'One Level Tabs - Left and Right Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_LEFT_AND_RIGHT_SIDEBAR'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10827208138919689)
,p_theme_id=>23
,p_name=>'One Level Tabs - No Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_NO_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/one_level_tabs_right_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10827530758919689)
,p_theme_id=>23
,p_name=>'One Level Tabs - Right Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_RIGHT_SIDEBAR'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10827817361919690)
,p_theme_id=>23
,p_name=>'Popup'
,p_internal_name=>'POPUP'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10828110231919690)
,p_theme_id=>23
,p_name=>'Printer Friendly'
,p_internal_name=>'PRINTER_FRIENDLY'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/two_level_tabs_left_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10828429113919690)
,p_theme_id=>23
,p_name=>'Two Level Tabs - Left Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_LEFT_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/two_level_tabs_left_and_right_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10828724810919690)
,p_theme_id=>23
,p_name=>'Two Level Tabs - Left and Right Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_LEFT_AND_RIGHT_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/two_level_tabs_no_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10829003485919690)
,p_theme_id=>23
,p_name=>'Two Level Tabs - No Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_NO_SIDEBAR'
,p_is_popup=>false
...
/
prompt --application/shared_components/user_interface/templates/page/two_level_tabs_right_sidebar_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10829309514919692)
,p_theme_id=>23
,p_name=>'Two Level Tabs - Right Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_RIGHT_SIDEBAR'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10846904706928650)
,p_theme_id=>50
,p_name=>'Page'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10847130688928651)
,p_theme_id=>50
,p_name=>'Popup'
,p_internal_name=>'POPUP'
,p_is_popup=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10750015224878870)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10750118102878875)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10750218524878876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10750306354878876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10750408510878876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10750504518878876)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10844829450919745)
,p_template_name=>'Button'
,p_internal_name=>'BUTTON'
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10845000437919750)
...
/
prompt --application/shared_components/user_interface/templates/button/large_button_002
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10845206532919750)
,p_template_name=>'Large Button'
,p_internal_name=>'LARGE_BUTTON'
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10845419480919750)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10854025600928662)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10854206294928664)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10854408160928664)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10744609536878835)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10744731850878843)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10744808838878843)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10744908392878843)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745023351878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745125653878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745200420878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745330633878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745426416878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10745501829878845)
,p_plug_template_id=>wwv_flow_api.id(10745426416878845)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745628313878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745702269878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745822813878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10745927367878845)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10746003716878845)
,p_plug_template_id=>wwv_flow_api.id(10745927367878845)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10746119940878846)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10746218475878846)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10746328707878846)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10746419874878846)
,p_plug_template_id=>wwv_flow_api.id(10746328707878846)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10746530764878846)
,p_plug_template_id=>wwv_flow_api.id(10746328707878846)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10746617805878846)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10746716054878846)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10829611607919695)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uBorderlessRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10829913172919703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10830209229919703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10830518043919703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10830800154919703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10831105555919703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10831404813919704)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10831709767919704)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10832021409919704)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
/
prompt --application/shared_components/user_interface/templates/region/hide_and_show_region_hidden_first
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10832301408919704)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# uHideShowRegion clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
,p_internal_name=>'HIDE_AND_SHOW_REGION_HIDDEN_FIRST'
,p_theme_id=>23
,p_theme_class_id=>1
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10832632471919706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10832913942919706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10833222679919706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10833513620919706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10833804095919706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uNoHeading #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10834123414919706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10834432725919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10834724441919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10835018608919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uRegionNoPadding #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10835332231919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10835629772919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10835926211919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10836204085919707)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10836502930919709)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10847401020928651)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10847726785928651)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10848021120928651)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10848320126928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10848631623928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10848930806928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10849219760928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10849502097928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10849804743928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10850111143928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10850401932928653)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10850714307928654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10851016797928654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10851324291928654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10851619854928654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10851909566928654)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10747914625878853)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748032234878857)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748108023878857)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748202893878857)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748324077878857)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748409372878857)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748504674878857)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748606363878857)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748728530878857)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748831276878857)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10748905446878857)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10749009929878857)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10749132601878857)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10749207771878857)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10839508812919721)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10839819012919732)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10840120550919732)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10840412847919734)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10840719058919734)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li> '
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li> '
,p_list_template_name=>'Horizontal Links List'
,p_internal_name=>'HORIZONTAL_LINKS_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10841023343919734)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="#LIST_STATUS#">',
'      <span>#TEXT#</span>',
'    </li>'))
...
/
prompt --application/shared_components/user_interface/templates/list/page_level_tabs_list_002
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10841312852919734)
,p_list_template_current=>'<li><a href="#LINK#" class="active">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Page Level Tabs List'
,p_internal_name=>'PAGE_LEVEL_TABS_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10841618911919734)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10841913252919734)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10842230517919735)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Tabbed Navigation List'
,p_internal_name=>'TABBED_NAVIGATION_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10842527605919735)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10842813293919735)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Ordered List'
,p_internal_name=>'VERTICAL_ORDERED_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10843101925919740)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Sidebar List'
,p_internal_name=>'VERTICAL_SIDEBAR_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10843410604919740)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List with Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITH_BULLETS'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10843702703919740)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List without Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITHOUT_BULLETS'
...
/
prompt --application/shared_components/user_interface/templates/list/wizard_progress_list_vertical_002
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10844003395919740)
,p_list_template_current=>'<li class="#LIST_STATUS#"><img src="#IMAGE_PREFIX#f_spacer.gif" alt="" /><span>#TEXT#</span></li>'
,p_list_template_noncurrent=>'<li class="#LIST_STATUS#"><img src="#IMAGE_PREFIX#f_spacer.gif" alt="" /><span>#TEXT#</span></li>'
,p_list_template_name=>'Wizard Progress List - Vertical'
,p_internal_name=>'WIZARD_PROGRESS_LIST_VERTICAL'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10852504290928659)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10852801413928659)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10853107623928659)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10853405171928659)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10746804020878848)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10746924431878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747015757878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747101325878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747207341878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747326960878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747429398878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747510117878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747605537878851)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747709777878853)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10747832763878853)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10836801059919710)
,p_row_template_name=>'Borderless Report'
,p_internal_name=>'BORDERLESS_REPORT'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
/
prompt --application/shared_components/user_interface/templates/report/fixed_headers_002
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10837120928919715)
,p_row_template_name=>'Fixed Headers'
,p_internal_name=>'FIXED_HEADERS'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" #COLUMN_WIDTH#>#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10837429115919717)
,p_row_template_name=>'Horizontal Border'
,p_internal_name=>'HORIZONTAL_BORDER'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10837706175919717)
,p_row_template_name=>'One Column Unordered List'
,p_internal_name=>'ONE_COLUMN_UNORDERED_LIST'
,p_row_template1=>'<li>#COLUMN_VALUE#</li>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
/
prompt --application/shared_components/user_interface/templates/report/search_results_report_select_link_text_link_target_detail1_detail2_last_modified_002
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10838006557919717)
,p_row_template_name=>'Search Results Report (SELECT link_text, link_target, detail1, detail2, last_modified)'
,p_internal_name=>'SEARCH_RESULTS_REPORT_SELECT_LINK_TEXT,_LINK_TARGET,_DETAIL1,_DETAIL2,_LAST_MODIFIED'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10838300174919717)
,p_row_template_name=>'Standard'
,p_internal_name=>'STANDARD'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
/
prompt --application/shared_components/user_interface/templates/report/standard_alternative_002
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10838622870919717)
,p_row_template_name=>'Standard - Alternative'
,p_internal_name=>'STANDARD_ALTERNATIVE'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template3=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="uOddRow">#COLUMN_VALUE#</td>'
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10838905382919717)
,p_row_template_name=>'Two Column Portlet'
,p_internal_name=>'TWO_COLUMN_PORTLET'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10839210302919718)
,p_row_template_name=>'Value Attribute Pairs'
,p_internal_name=>'VALUE_ATTRIBUTE_PAIRS'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10852229690928654)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749324942878859)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749432726878868)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749506052878868)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749612905878868)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749715762878868)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749828713878868)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10749920554878868)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10844315048919742)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10844405801919743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10844521026919743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10844630370919743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10844722199919743)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10853707653928659)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10853832471928659)
,p_template_name=>'Optional'
,p_internal_name=>'OPTIONAL'
,p_template_body1=>'<label for="#CURRENT_ITEM_NAME#" id="#LABEL_ID#">'
,p_template_body2=>'</label>'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10853929356928659)
,p_template_name=>'Required'
,p_internal_name=>'REQUIRED'
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(10750623243878878)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(10845601298919750)
,p_name=>'Breadcrumb Menu'
,p_internal_name=>'BREADCRUMB_MENU'
,p_before_first=>'<ul>'
,p_current_page_option=>'<li class="active"><span>#NAME#</span></li> '
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(10845713172919753)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(10854629780928664)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(10750805359878885)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(10846105569919757)
,p_popup_icon=>'#IMAGE_PREFIX#f_spacer.gif'
,p_popup_icon_attr=>'alt="#LIST_OF_VALUES#" title="#LIST_OF_VALUES#" class="uPopupLOVIcon"'
,p_page_name=>'winlov'
,p_page_title=>'Search Dialog'
...
'<link rel="shortcut icon" href="#IMAGE_PREFIX#favicon.ico" type="image/x-icon">  <link rel="stylesheet" href="#IMAGE_PREFIX#themes/theme_23/css/4_1.css" type="text/css" media="all"/>',
'',
'</head>'))
,p_page_body_attr=>'class="uPopUpLOV"'
,p_before_field_text=>'<div class="uActionBar">'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(10854815484928667)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(10750720755878882)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(10845802403919753)
,p_cal_template_name=>'Calendar'
,p_internal_name=>'CALENDAR'
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(10845914446919757)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(10846017750919757)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(10854729336928665)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(10750925040878892)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(10738402990878829)
,p_error_template=>wwv_flow_api.id(10734714751878828)
,p_printer_friendly_template=>wwv_flow_api.id(10740920560878831)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(10733225264878812)
,p_default_button_template=>wwv_flow_api.id(10750015224878870)
,p_default_region_template=>wwv_flow_api.id(10746328707878846)
,p_default_chart_template=>wwv_flow_api.id(10746328707878846)
,p_default_form_template=>wwv_flow_api.id(10745426416878845)
,p_default_reportr_template=>wwv_flow_api.id(10746328707878846)
,p_default_tabform_template=>wwv_flow_api.id(10746328707878846)
,p_default_wizard_template=>wwv_flow_api.id(10745426416878845)
,p_default_menur_template=>wwv_flow_api.id(10744908392878843)
,p_default_listr_template=>wwv_flow_api.id(10746328707878846)
,p_default_irr_template=>wwv_flow_api.id(10745822813878845)
,p_default_report_template=>wwv_flow_api.id(10747429398878851)
,p_default_label_template=>wwv_flow_api.id(10749506052878868)
,p_default_menu_template=>wwv_flow_api.id(10750623243878878)
,p_default_calendar_template=>wwv_flow_api.id(10750720755878882)
,p_default_list_template=>wwv_flow_api.id(10749009929878857)
,p_default_option_label=>wwv_flow_api.id(10749506052878868)
,p_default_required_label=>wwv_flow_api.id(10749828713878868)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(10846301103919764)
,p_theme_id=>23
,p_theme_name=>'Uniframe'
,p_theme_internal_name=>'UNIFRAME'
,p_ui_type_name=>'DESKTOP'
,p_navigation_type=>'T'
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(10827208138919689)
,p_error_template=>wwv_flow_api.id(10826013337919687)
,p_printer_friendly_template=>wwv_flow_api.id(10828110231919690)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(10825206306919656)
,p_default_button_template=>wwv_flow_api.id(10844829450919745)
,p_default_region_template=>wwv_flow_api.id(10834724441919707)
,p_default_chart_template=>wwv_flow_api.id(10831404813919704)
,p_default_form_template=>wwv_flow_api.id(10831709767919704)
,p_default_reportr_template=>wwv_flow_api.id(10834724441919707)
,p_default_tabform_template=>wwv_flow_api.id(10834724441919707)
,p_default_wizard_template=>wwv_flow_api.id(10836204085919707)
,p_default_menur_template=>wwv_flow_api.id(10830209229919703)
,p_default_listr_template=>wwv_flow_api.id(10831105555919703)
,p_default_irr_template=>wwv_flow_api.id(10833513620919706)
,p_default_report_template=>wwv_flow_api.id(10838300174919717)
,p_default_label_template=>wwv_flow_api.id(10844405801919743)
,p_default_menu_template=>wwv_flow_api.id(10845601298919750)
,p_default_calendar_template=>wwv_flow_api.id(10845802403919753)
,p_default_list_template=>wwv_flow_api.id(10843410604919740)
,p_default_option_label=>wwv_flow_api.id(10844521026919743)
,p_default_required_label=>wwv_flow_api.id(10844722199919743)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
,p_file_prefix => nvl(wwv_flow_application_install.get_static_theme_file_prefix(23),'')
,p_css_file_urls=>'#IMAGE_PREFIX#legacy_ui/css/5.0#MIN#.css?v=#APEX_VERSION#'
);
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(10855006512928667)
,p_theme_id=>50
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(10846904706928650)
,p_error_template=>wwv_flow_api.id(10846904706928650)
,p_printer_friendly_template=>wwv_flow_api.id(10846904706928650)
,p_default_button_template=>wwv_flow_api.id(10854408160928664)
,p_default_region_template=>wwv_flow_api.id(10851324291928654)
,p_default_chart_template=>wwv_flow_api.id(10851324291928654)
,p_default_form_template=>wwv_flow_api.id(10851324291928654)
,p_default_reportr_template=>wwv_flow_api.id(10851909566928654)
,p_default_tabform_template=>wwv_flow_api.id(10851324291928654)
,p_default_wizard_template=>wwv_flow_api.id(10851324291928654)
,p_default_irr_template=>wwv_flow_api.id(10851324291928654)
,p_default_report_template=>wwv_flow_api.id(10852229690928654)
,p_default_label_template=>wwv_flow_api.id(10853832471928659)
,p_default_calendar_template=>wwv_flow_api.id(10854729336928665)
,p_default_list_template=>wwv_flow_api.id(10853107623928659)
,p_default_option_label=>wwv_flow_api.id(10853832471928659)
,p_default_header_template=>wwv_flow_api.id(10850714307928654)
,p_default_footer_template=>wwv_flow_api.id(10850111143928653)
,p_default_required_label=>wwv_flow_api.id(10853929356928659)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10751329025878915)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10751426645878918)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10751615778878918)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(10751024350878893)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(10855304539928693)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(10751024350878893)
,p_tab_set=>'TS1'
,p_name=>'Tneumaticos'
,p_step_title=>'Tneumaticos'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Tneumaticos'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10753118418878970)
,p_plug_name=>'TNEUMATICOS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10744808838878843)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(10753212982878973)
,p_name=>'TNEUMATICOS'
...
,p_owner=>'LP'
,p_internal_uid=>10753212982878973
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10753517058878993)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10753626635878995)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10753711136878995)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10753813189878996)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10753922322878998)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754019405879000)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754108994879000)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754211968879001)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754310619879003)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754408540879003)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754502078879009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754629224879009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754707099879010)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754828814879012)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10754904231879014)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755004209879014)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755101808879015)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755232605879017)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755316137879017)
,p_db_column_name=>'ESTADOVT'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Estadovt'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'ESTADOVT'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755403363879018)
,p_db_column_name=>'PTCOMPRA'
,p_display_order=>22
,p_column_identifier=>'V'
,p_column_label=>'Ptcompra'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'PTCOMPRA'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755504919879020)
,p_db_column_name=>'OTCOMPRA'
,p_display_order=>23
,p_column_identifier=>'W'
,p_column_label=>'Otcompra'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'OTCOMPRA'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755617358879021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755724768879021)
,p_db_column_name=>'CORRACTIVO'
,p_display_order=>25
,p_column_identifier=>'Y'
,p_column_label=>'Corractivo'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CORRACTIVO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755829473879023)
,p_db_column_name=>'CDPROVEENV'
,p_display_order=>26
,p_column_identifier=>'Z'
,p_column_label=>'Cdproveenv'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CDPROVEENV'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10755902437879025)
,p_db_column_name=>'FECENVIO'
,p_display_order=>27
,p_column_identifier=>'AA'
,p_column_label=>'Fecenvio'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FECENVIO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756023076879025)
,p_db_column_name=>'FECPROF'
,p_display_order=>28
,p_column_identifier=>'AB'
,p_column_label=>'Fecprof'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756127736879026)
,p_db_column_name=>'CDPROVEE'
,p_display_order=>29
,p_column_identifier=>'AC'
,p_column_label=>'Cdprovee'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CDPROVEE'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756203444879028)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756316166879029)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756419270879029)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756532363879031)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756611870879032)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756729333879034)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756812142879034)
,p_db_column_name=>'CDTRANSACCION'
,p_display_order=>36
,p_column_identifier=>'AJ'
,p_column_label=>'Cdtransaccion'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CDTRANSACCION'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10756928439879035)
,p_db_column_name=>'U_MODIFICA'
,p_display_order=>37
,p_column_identifier=>'AK'
,p_column_label=>'U Modifica'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'U_MODIFICA'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10757012443879037)
,p_db_column_name=>'U_BAJA'
,p_display_order=>38
,p_column_identifier=>'AL'
,p_column_label=>'U Baja'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'U_BAJA'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10757114428879037)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10757230996879039)
,p_db_column_name=>'COD_BAJA'
,p_display_order=>40
,p_column_identifier=>'AN'
,p_column_label=>'Cod Baja'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'COD_BAJA'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(11122431803201467)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(11122529827201468)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(10758832088968471)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'107589'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'DSNEUMATICO:CDMARCA:CDDISENO:ESTADO:TIPOCASCO:NUEVA:REENCAUCHE1:REENCAUCHE2:REENCAUCHE3:PRECIO:FECHAALTA:POSICION:FECHABAJA:RECORRIDO:PROFUNDIDAD:FECENVIO:FECPROF:CDPROVEE:PROFU_INICIAL:CDDELEGACION:MOTBAJA:FECHAMODI:KMSVIDA:SERIEFAC:CDTRANSACCION:CD'
||'MEDIDA:CORRELATIVO'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(10761406751207170)
,p_report_id=>wwv_flow_api.id(10758832088968471)
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(10855304539928693)
,p_name=>'Home'
...
,p_step_template=>wwv_flow_api.id(10846904706928650)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20171023084230'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10859006833928804)
,p_plug_name=>'Home'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10851324291928654)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(10733225264878812)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171018171111'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10751919821878928)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10745426416878845)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(10752231982878942)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(10751919821878928)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(10750015224878870)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10752018000878932)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(10751919821878928)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(10749432726878868)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10752121143878940)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10752427607878945)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10752312449878943)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10752618806878946)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10752521711878946)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(10959704301438106)
);
end;
/
