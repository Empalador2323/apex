...
prompt APPLICATION 353 - LP_TAlleres
--
-- Application Export:
--   Application:     353
--   Name:            LP_TAlleres
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,353)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_TAlleres')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_353')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'AF6729AB28B80916D6E046FA2599745774DEB45316E83CAEF17159AC1472DCFD'
...
,p_authentication_id=>wwv_flow_api.id(31016916611065614)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_TAlleres'
...
,p_last_upd_yyyymmddhh24miss=>'20210325161017'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(31019018669065726)
,p_name=>'Navigation'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8824097087070951)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8824148701070951)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8824258572070951)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8824464269070951)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8824592975070951)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8824675570070951)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(30998703791065456)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(31022020355076004)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(31016730605065603)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(31018204433065646)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31019101192065731)
,p_parent_id=>0
,p_short_name=>'T Usuarios Taller'
,p_link=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31021008181065835)
,p_parent_id=>wwv_flow_api.id(31019101192065731)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30998807231065481)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30998915651065493)
,p_page_template_id=>wwv_flow_api.id(30998807231065481)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30999014897065501)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999102296065503)
,p_page_template_id=>wwv_flow_api.id(30999014897065501)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999220540065503)
,p_page_template_id=>wwv_flow_api.id(30999014897065501)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999325576065503)
,p_page_template_id=>wwv_flow_api.id(30999014897065501)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999432363065503)
,p_page_template_id=>wwv_flow_api.id(30999014897065501)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999529270065503)
,p_page_template_id=>wwv_flow_api.id(30999014897065501)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30999630629065503)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999700939065503)
,p_page_template_id=>wwv_flow_api.id(30999630629065503)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999812934065504)
,p_page_template_id=>wwv_flow_api.id(30999630629065503)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30999930920065504)
,p_page_template_id=>wwv_flow_api.id(30999630629065503)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000018947065504)
,p_page_template_id=>wwv_flow_api.id(30999630629065503)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000101521065504)
,p_page_template_id=>wwv_flow_api.id(30999630629065503)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000214972065504)
,p_page_template_id=>wwv_flow_api.id(30999630629065503)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31000323453065504)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000427393065504)
,p_page_template_id=>wwv_flow_api.id(31000323453065504)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000511745065504)
,p_page_template_id=>wwv_flow_api.id(31000323453065504)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000623540065504)
,p_page_template_id=>wwv_flow_api.id(31000323453065504)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000723682065504)
,p_page_template_id=>wwv_flow_api.id(31000323453065504)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31000813137065506)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31000913771065506)
,p_page_template_id=>wwv_flow_api.id(31000813137065506)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001001088065506)
,p_page_template_id=>wwv_flow_api.id(31000813137065506)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001101201065506)
,p_page_template_id=>wwv_flow_api.id(31000813137065506)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001227330065506)
,p_page_template_id=>wwv_flow_api.id(31000813137065506)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001324314065506)
,p_page_template_id=>wwv_flow_api.id(31000813137065506)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31001413717065506)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001502648065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001612191065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001724507065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001830601065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31001925159065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002001867065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002123469065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002226322065507)
,p_page_template_id=>wwv_flow_api.id(31001413717065506)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31002318910065507)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002421530065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002521068065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002616446065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002721814065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002811378065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31002912217065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003000749065507)
,p_page_template_id=>wwv_flow_api.id(31002318910065507)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31003119855065507)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003220258065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003327596065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003401494065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003527642065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003612546065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003725436065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003807290065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31003915431065507)
,p_page_template_id=>wwv_flow_api.id(31003119855065507)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31004024524065507)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004122477065507)
,p_page_template_id=>wwv_flow_api.id(31004024524065507)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004209954065507)
,p_page_template_id=>wwv_flow_api.id(31004024524065507)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004313361065507)
,p_page_template_id=>wwv_flow_api.id(31004024524065507)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004413883065507)
,p_page_template_id=>wwv_flow_api.id(31004024524065507)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004516604065507)
,p_page_template_id=>wwv_flow_api.id(31004024524065507)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004610463065507)
,p_page_template_id=>wwv_flow_api.id(31004024524065507)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31004719145065507)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004807522065507)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31004923719065507)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005017538065507)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005107200065507)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005222350065509)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005310752065509)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005413274065509)
,p_page_template_id=>wwv_flow_api.id(31004719145065507)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31005525912065509)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005603808065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005714579065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005807661065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31005925645065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006010468065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006132149065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006225337065509)
,p_page_template_id=>wwv_flow_api.id(31005525912065509)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31006326784065509)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006404726065509)
,p_page_template_id=>wwv_flow_api.id(31006326784065509)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31006504368065509)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006615340065509)
,p_page_template_id=>wwv_flow_api.id(31006504368065509)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006708292065509)
,p_page_template_id=>wwv_flow_api.id(31006504368065509)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006802199065509)
,p_page_template_id=>wwv_flow_api.id(31006504368065509)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31006903308065509)
,p_page_template_id=>wwv_flow_api.id(31006504368065509)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31007018721065509)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007127756065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007205387065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007327807065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007427741065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007518933065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007615477065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007708536065512)
,p_page_template_id=>wwv_flow_api.id(31007018721065509)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31007802570065512)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31007907152065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008006582065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008117417065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008203506065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008324754065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008425218065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008504531065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008619903065512)
,p_page_template_id=>wwv_flow_api.id(31007802570065512)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31008708159065514)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008804421065514)
,p_page_template_id=>wwv_flow_api.id(31008708159065514)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31008907670065514)
,p_page_template_id=>wwv_flow_api.id(31008708159065514)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009010865065514)
,p_page_template_id=>wwv_flow_api.id(31008708159065514)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009107315065514)
,p_page_template_id=>wwv_flow_api.id(31008708159065514)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009212341065514)
,p_page_template_id=>wwv_flow_api.id(31008708159065514)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009326584065514)
,p_page_template_id=>wwv_flow_api.id(31008708159065514)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31009401056065514)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009506099065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009600440065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009715573065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009825780065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31009912084065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31010000504065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31010105672065514)
,p_page_template_id=>wwv_flow_api.id(31009401056065514)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31015612370065564)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31015704082065570)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31015829602065570)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31015924063065570)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31016007907065570)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31016106213065570)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010230818065517)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010309162065531)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010432196065532)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010523641065532)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010612712065532)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010705459065532)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010815018065532)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31010915624065532)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011013452065534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31011132165065534)
,p_plug_template_id=>wwv_flow_api.id(31011013452065534)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011227731065534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011332504065534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011425873065534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011530805065534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31011629471065534)
,p_plug_template_id=>wwv_flow_api.id(31011530805065534)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011700095065534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011813561065535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31011908873065535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31012008193065535)
,p_plug_template_id=>wwv_flow_api.id(31011908873065535)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31012119308065535)
,p_plug_template_id=>wwv_flow_api.id(31011908873065535)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31012203266065535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31012308128065535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31013532055065546)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31013630897065553)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31013721266065553)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31013826557065554)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31013902469065554)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014025106065554)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014121633065554)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014222494065554)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014321440065554)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014404338065554)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014514989065554)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014628822065554)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014720321065556)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31014818267065556)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31012431132065540)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31012527930065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31012627611065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31012703328065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31012816031065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31012931284065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31013007207065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31013129376065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31013208542065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31013328329065546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31013405301065546)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31014926523065557)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31015015874065562)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31015131343065562)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31015213261065562)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31015320334065562)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31015432728065562)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31015513068065562)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(31016204669065571)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(31016424319065582)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(31016326978065578)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(31016502567065587)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(31000813137065506)
,p_error_template=>wwv_flow_api.id(31000323453065504)
,p_printer_friendly_template=>wwv_flow_api.id(31006504368065509)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(30998807231065481)
,p_default_button_template=>wwv_flow_api.id(31015612370065564)
,p_default_region_template=>wwv_flow_api.id(31011908873065535)
,p_default_chart_template=>wwv_flow_api.id(31011908873065535)
,p_default_form_template=>wwv_flow_api.id(31011013452065534)
,p_default_reportr_template=>wwv_flow_api.id(31011908873065535)
,p_default_tabform_template=>wwv_flow_api.id(31011908873065535)
,p_default_wizard_template=>wwv_flow_api.id(31011013452065534)
,p_default_menur_template=>wwv_flow_api.id(31010523641065532)
,p_default_listr_template=>wwv_flow_api.id(31011908873065535)
,p_default_irr_template=>wwv_flow_api.id(31011425873065534)
,p_default_report_template=>wwv_flow_api.id(31013007207065546)
,p_default_label_template=>wwv_flow_api.id(31015131343065562)
,p_default_menu_template=>wwv_flow_api.id(31016204669065571)
,p_default_calendar_template=>wwv_flow_api.id(31016326978065578)
,p_default_list_template=>wwv_flow_api.id(31014628822065554)
,p_default_option_label=>wwv_flow_api.id(31015131343065562)
,p_default_required_label=>wwv_flow_api.id(31015432728065562)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(31020009221065751)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31016806282065607)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31016916611065614)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31017115937065614)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(31016623697065590)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(31016623697065590)
,p_name=>'T Usuarios Taller'
,p_alias=>'HOME'
,p_step_title=>'T Usuarios Taller'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'T Usuarios Taller'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180717091944'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31018531764065689)
,p_plug_name=>'T_USUARIOS_TALLER'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31011425873065534)
...
'"USUARIO",',
'"ID_TALLER"',
' from   "T_USUARIOS_TALLER" ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31018621162065689)
,p_name=>'T_USUARIOS_TALLER'
...
,p_owner=>'LP'
,p_internal_uid=>31018621162065689
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31018716335065710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31018829581065718)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31018922264065725)
,p_db_column_name=>'ID_TALLER'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Id Taller'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ID_TALLER'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31021420674068407)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'310215'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:USUARIO:ID_TALLER'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31019211324065735)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31010523641065532)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(31018204433065646)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(31016204669065571)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31020915367065835)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31018531764065689)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31015612370065564)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190424120353'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31019513681065740)
,p_plug_name=>'Edit T_USUARIOS_TALLER'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31011013452065534)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31021108468065839)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31010523641065532)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31754106006004428)
,p_plug_name=>'talleres'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31011425873065534)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select usuario,id, cdestacion, description from t_usuarios_taller a  inner join tbl_taller b on a.id_taller=b.id where usuario= :P2_USUARIO'
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P2_USUARIO'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31754215557004428)
,p_name=>'talleres'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'LP'
,p_internal_uid=>31754215557004428
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31754418147004435)
,p_db_column_name=>'USUARIO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Usuario'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31754509224004439)
,p_db_column_name=>'ID'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31754609225004439)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31755715113019909)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31754816741007560)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'317549'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'USUARIO:ID:CDESTACION:DESCRIPTION:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31019610005065742)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31019513681065740)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31019825199065742)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31019930114065742)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31019724537065742)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31020123011065753)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31020220000065820)
,p_name=>'P2_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(31019513681065740)
...
,p_field_template=>wwv_flow_api.id(31015131343065562)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31020328289065826)
,p_name=>'P2_USUARIO'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(31019513681065740)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31020503381065832)
,p_name=>'P2_ID_TALLER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(31019513681065740)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'select cdestacion ||'' '' || ID || '' ''||description, ID  from tbl_taller '
,p_cSize=>30
,p_cMaxlength=>22
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31755203020013096)
,p_name=>'update'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31755519424013100)
,p_event_id=>wwv_flow_api.id(31755203020013096)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(31754106006004428)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31020724712065832)
,p_process_sequence=>1
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from T_USUARIOS_TALLER'
,p_attribute_02=>'T_USUARIOS_TALLER'
,p_attribute_03=>'P2_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31020817171065832)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of T_USUARIOS_TALLER'
,p_attribute_02=>'T_USUARIOS_TALLER'
,p_attribute_03=>'P2_ROWID'
,p_attribute_04=>'ROWID'
...
,p_step_template=>wwv_flow_api.id(30998807231065481)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180717085000'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31017430583065628)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31011013452065534)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31017726591065643)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31017430583065628)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31017526137065635)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31017430583065628)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31017614153065643)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31017930254065645)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31017827194065645)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31018115615065646)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31018004464065646)
,p_process_sequence=>10
