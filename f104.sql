...
prompt APPLICATION 104 - OT_SUPERVISION
--
-- Application Export:
--   Application:     104
--   Name:            OT_SUPERVISION
--   Date and Time:   09:25 Monday April 18, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'OT_SUPERVISION')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'INOT370104')
...
,p_authentication_id=>wwv_flow_api.id(63097944668980041)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:OT SUPERVISORES'
...
,p_last_upd_yyyymmddhh24miss=>'20220307124106'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(7483097295278862)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(7483122121278862)
...
begin
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(57948534125698127)
,p_name=>'Navigation'
,p_list_status=>'PUBLIC'
);
end;
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12858671122655015)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12858890808655015)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12858923286655015)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12859001188655015)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12859108294655016)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12859221738655016)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(57933441119698085)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(58025447691657933)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(60810635678817099)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(57943444423698092)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(57944632552698094)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(57948638697698127)
,p_parent_id=>0
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(57956533725698133)
,p_parent_id=>wwv_flow_api.id(57948638697698127)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7344105900243260)
,p_theme_id=>101
...
,p_reference_id=>146480124181209839
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7344440557243264)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7344772962243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7345030986243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7345361162243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7345682721243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7345991733243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7346271840243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
,p_name=>'Page Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7346554435243265)
,p_page_template_id=>wwv_flow_api.id(7344105900243260)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7346981038243267)
,p_theme_id=>101
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146482908417209864
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7347292491243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7347518329243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7347855409243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7348183057243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7348449349243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7348775828243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7349000588243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7349374195243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7349664140243268)
,p_page_template_id=>wwv_flow_api.id(7346981038243267)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7350034201243268)
,p_theme_id=>101
,p_name=>'Login'
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146486026718209865
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7350301402243268)
,p_page_template_id=>wwv_flow_api.id(7350034201243268)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7350606978243268)
,p_page_template_id=>wwv_flow_api.id(7350034201243268)
,p_name=>'Body Header'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7350821860243268)
,p_theme_id=>101
,p_name=>'Marquee'
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146486753553209867
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7351153489243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7351419803243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7351713603243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7352019418243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7352313479243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7352688007243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7352947483243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7353287788243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7353572420243270)
,p_page_template_id=>wwv_flow_api.id(7350821860243268)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7353952789243270)
,p_theme_id=>101
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146489915780209871
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7354246977243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7354541774243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7354825127243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7355104468243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7355462047243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7355791663243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7356013669243270)
,p_page_template_id=>wwv_flow_api.id(7353952789243270)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7356407896243270)
,p_theme_id=>101
,p_name=>'Modal Dialog'
...
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146492367432209873
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7356763772243271)
,p_page_template_id=>wwv_flow_api.id(7356407896243270)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7357018516243271)
,p_page_template_id=>wwv_flow_api.id(7356407896243270)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7357301050243271)
,p_page_template_id=>wwv_flow_api.id(7356407896243270)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7357950944243271)
,p_theme_id=>101
,p_name=>'Right Side Column'
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146493844706209874
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7358219306243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7358528286243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7358808471243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7359180938243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7359499136243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7359715376243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7360009241243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7360374566243271)
,p_page_template_id=>wwv_flow_api.id(7357950944243271)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7360792802243271)
,p_theme_id=>101
,p_name=>'Standard'
...
,p_dialog_js_cancel_code=>'apex.navigation.dialog.cancel(#IS_MODAL#);'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146496718553209876
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7361027676243271)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7361302886243271)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Breadcrumb Bar'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7361691617243271)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Inline Dialogs'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7361928661243271)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7362218441243271)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Page Navigation'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7362518153243271)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Page Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7362803933243273)
,p_page_template_id=>wwv_flow_api.id(7360792802243271)
,p_name=>'Before Navigation Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7363286886243273)
,p_theme_id=>101
...
,p_dialog_max_width=>'960'
,p_dialog_browser_frame=>'MODAL'
,p_reference_id=>146499165446209879
,p_translate_this_template=>'N'
);
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7363533690243273)
,p_page_template_id=>wwv_flow_api.id(7363286886243273)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7363862919243273)
,p_page_template_id=>wwv_flow_api.id(7363286886243273)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7364153266243273)
,p_page_template_id=>wwv_flow_api.id(7363286886243273)
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57933530564698085)
,p_theme_id=>24
,p_name=>'Login'
,p_internal_name=>'LOGIN'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57933649438698085)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57933756243698085)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57933827203698085)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57933934913698085)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934055149698085)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934140933698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934245562698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934326375698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934440719698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934526004698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934650398698086)
,p_theme_id=>24
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934752118698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934848713698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57934934264698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57935042241698086)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(57935140596698086)
,p_theme_id=>24
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7442142348243304)
...
,p_reference_id=>146578066302209982
,p_translate_this_template=>'N'
,p_theme_class_id=>5
,p_theme_id=>101
);
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7442364112243304)
...
,p_reference_id=>146578265177209985
,p_translate_this_template=>'N'
,p_theme_class_id=>4
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(57942054708698091)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(57942126889698091)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(57942245756698091)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(57942351159698091)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(57942456188698091)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(57942530893698091)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7364790716243273)
,p_layout=>'TABLE'
...
,p_reference_id=>146500703588209881
,p_translate_this_template=>'N'
,p_template_comment=>'Red Theme'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7365061900243273)
,p_plug_template_id=>wwv_flow_api.id(7364790716243273)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7368493856243276)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146504381861209903
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7368652564243276)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#"> ',
'#PREVIOUS##BODY##SUB_REGIONS##NEXT#',
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146504579745209904
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7368905231243276)
,p_plug_template_id=>wwv_flow_api.id(7368652564243276)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7369267387243276)
,p_plug_template_id=>wwv_flow_api.id(7368652564243276)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7369477121243276)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146505347565209904
,p_translate_this_template=>'N'
,p_template_comment=>'Red Theme'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7369797511243276)
,p_plug_template_id=>wwv_flow_api.id(7369477121243276)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7370050537243276)
,p_plug_template_id=>wwv_flow_api.id(7369477121243276)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7371626648243276)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146507580166209906
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7371910108243278)
,p_plug_template_id=>wwv_flow_api.id(7371626648243276)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7372295135243278)
,p_plug_template_id=>wwv_flow_api.id(7371626648243276)
,p_name=>'Slides'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7378849248243279)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146514826284209912
,p_translate_this_template=>'N'
,p_template_comment=>'Red Theme'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7379130678243279)
,p_plug_template_id=>wwv_flow_api.id(7378849248243279)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7379470906243279)
,p_plug_template_id=>wwv_flow_api.id(7378849248243279)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7383415543243281)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146519399903209915
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7385234263243282)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146521144366209926
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7385508625243282)
,p_plug_template_id=>wwv_flow_api.id(7385234263243282)
,p_name=>'Region Body'
,p_placeholder=>'#BODY#'
,p_has_grid_support=>false
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7386767744243282)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146522667963209926
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7387007115243282)
,p_plug_template_id=>wwv_flow_api.id(7386767744243282)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7388801036243282)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146524806645209931
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7389423160243284)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146525345274209931
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7389703528243284)
,p_plug_template_id=>wwv_flow_api.id(7389423160243284)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7389992475243284)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146525862504209931
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7390222475243284)
,p_plug_template_id=>wwv_flow_api.id(7389992475243284)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7390582735243284)
,p_plug_template_id=>wwv_flow_api.id(7389992475243284)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7396791654243285)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146532729285209937
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7397044776243285)
,p_plug_template_id=>wwv_flow_api.id(7396791654243285)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7397328967243287)
,p_plug_template_id=>wwv_flow_api.id(7396791654243285)
,p_name=>'Tabs'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7399392208243287)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146535291415209938
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7400330566243287)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_default_label_alignment=>'RIGHT'
,p_default_field_alignment=>'LEFT'
,p_reference_id=>146536300023209942
,p_translate_this_template=>'N'
);
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7400690278243287)
,p_plug_template_id=>wwv_flow_api.id(7400330566243287)
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935249512698086)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935326528698086)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935456548698086)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935535193698086)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935630306698086)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935732504698086)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935833336698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57935953146698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936048558698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936137530698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#"> ',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936250131698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936331575698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936452325698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936529624698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936640694698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'    #BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936743913698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936839834698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57936937897698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937038846698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937136134698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937233014698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937342514698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937437096698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937552534698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937644184698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937746006698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937840649698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57937936603698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57938034860698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57938155041698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57938229069698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57938345660698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57938445898698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57938533073698088)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7421048738243295)
...
,p_reference_id=>146557012016209962
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7425048849243296)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_reference_id=>146560986022209968
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7430031202243298)
...
,p_reference_id=>146566011588209970
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7431650532243300)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_reference_id=>146567558755209971
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7434052847243300)
...
,p_reference_id=>146570001846209971
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7435031693243300)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_reference_id=>146571004001209973
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7435481907243301)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
,p_a01_label=>'Badge Value'
,p_a02_label=>'List  Item CSS Classes'
,p_reference_id=>146571421395209974
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7435610909243301)
...
,p_a02_label=>'Disabled True/False'
,p_a04_label=>'Title'
,p_reference_id=>146571577550209974
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7436064613243301)
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>146572006361209976
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7437602491243301)
,p_list_template_current=>'<li data-current="true" data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#ICON_CSS_CLASSES#"><a href="#LINK#" title="#A04#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li data-id="#A01#" data-disabled="#A02#" data-hide="#A03#" data-shortcut="#A05#" data-icon="#ICON_CSS_CLASSES#"><a href="#LINK#" title="#A04#">#TEXT_ESC_SC#</a></li>'
...
,p_reference_id=>146573616357209976
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7438606689243303)
...
,p_reference_id=>146574545537209977
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7440259463243303)
...
,p_list_template_after_rows=>'</ul>'
,p_reference_id=>146576232193209979
);
end;
/
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57939733958698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57939848405698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57939930059698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940032591698089)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940152124698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940232471698089)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940333580698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940436824698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940545032698089)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940644443698089)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940725274698089)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940850024698089)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57940951197698089)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57941029681698089)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57941132088698089)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57941240469698091)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(57941329145698091)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7401624407243287)
...
,p_theme_id=>101
,p_theme_class_id=>14
,p_reference_id=>146537603334209943
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7401890425243289)
...
,p_reference_id=>146537752679209945
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7405873078243290)
...
,p_theme_class_id=>7
,p_preset_template_options=>'t-Cards--animColorFill:t-Cards--3cols:t-Cards--basic'
,p_reference_id=>146541768369209948
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7410616400243290)
...
,p_reference_id=>146546593079209949
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7411433349243292)
...
,p_reference_id=>146547418947209951
,p_translate_this_template=>'N'
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7414085468243293)
...
,p_theme_id=>101
,p_theme_class_id=>1
,p_reference_id=>146550014399209954
,p_translate_this_template=>'N'
,p_row_template_comment=>' (SELECT link_text, link_target, detail1, detail2, last_modified)'
);
end;
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7414277920243293)
...
,p_reference_id=>146550165002209954
,p_translate_this_template=>'N'
);
begin
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7416878846243293)
...
,p_theme_id=>101
,p_theme_class_id=>7
,p_reference_id=>146552780736209956
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7417286992243293)
...
,p_reference_id=>146553214899209956
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7419203687243295)
...
,p_theme_class_id=>7
,p_preset_template_options=>'t-AVPList--leftAligned'
,p_reference_id=>146555217273209957
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57938645743698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57938730355698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57938839185698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57938931750698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939029113698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939150456698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939256068698089)
,p_row_template_name=>'Standard'
,p_internal_name=>'STANDARD'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939337196698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939431806698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939545261698089)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(57939636132698089)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7441469035243303)
...
,p_theme_id=>101
,p_theme_class_id=>13
,p_reference_id=>146577401710209979
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7441516321243303)
...
,p_theme_id=>101
,p_theme_class_id=>3
,p_reference_id=>146577503418209982
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7441632613243303)
...
,p_theme_id=>101
,p_theme_class_id=>3
,p_reference_id=>146577547896209982
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7441726963243303)
...
,p_theme_id=>101
,p_theme_class_id=>3
,p_reference_id=>146577699629209982
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7441814593243303)
...
,p_theme_id=>101
,p_theme_class_id=>4
,p_reference_id=>146577744047209982
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7441993593243304)
...
,p_theme_id=>101
,p_theme_class_id=>4
,p_reference_id=>146577914740209982
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7442037673243304)
...
,p_theme_id=>101
,p_theme_class_id=>4
,p_reference_id=>146577940174209982
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57941453020698091)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57941538223698091)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57941631168698091)
,p_template_name=>'Optional'
,p_internal_name=>'OPTIONAL'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57941748140698091)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57941830357698091)
,p_template_name=>'Required'
,p_internal_name=>'REQUIRED'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(57941931387698091)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(7443026753243304)
,p_name=>'Breadcrumb'
...
,p_theme_id=>101
,p_theme_class_id=>1
,p_reference_id=>146579006850209987
,p_translate_this_template=>'N'
);
end;
/
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(57942632481698091)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(57942745926698091)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(7443291963243306)
,p_page_name=>'winlov'
...
,p_theme_id=>101
,p_theme_class_id=>1
,p_reference_id=>146579205350209991
,p_translate_this_template=>'N'
,p_after_result_set=>'</div>'
);
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(57943149379698091)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(7443181547243304)
...
,p_theme_id=>101
,p_theme_class_id=>1
,p_reference_id=>146579077592209988
);
end;
/
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(57942838149698091)
,p_cal_template_name=>'Calendar'
,p_internal_name=>'CALENDAR'
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(57942925614698091)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(57943037491698091)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(7444420801243307)
,p_theme_id=>101
...
,p_navigation_type=>'L'
,p_nav_bar_type=>'LIST'
,p_reference_id=>146580380773209996
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(7360792802243271)
,p_default_dialog_template=>wwv_flow_api.id(7356407896243270)
,p_error_template=>wwv_flow_api.id(7350034201243268)
,p_printer_friendly_template=>wwv_flow_api.id(7360792802243271)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(7350034201243268)
,p_default_button_template=>wwv_flow_api.id(7442286569243304)
,p_default_region_template=>wwv_flow_api.id(7389992475243284)
,p_default_chart_template=>wwv_flow_api.id(7389992475243284)
,p_default_form_template=>wwv_flow_api.id(7389992475243284)
,p_default_reportr_template=>wwv_flow_api.id(7389992475243284)
,p_default_tabform_template=>wwv_flow_api.id(7389992475243284)
,p_default_wizard_template=>wwv_flow_api.id(7389992475243284)
,p_default_menur_template=>wwv_flow_api.id(7399392208243287)
,p_default_listr_template=>wwv_flow_api.id(7389992475243284)
,p_default_irr_template=>wwv_flow_api.id(7388801036243282)
,p_default_report_template=>wwv_flow_api.id(7414277920243293)
,p_default_label_template=>wwv_flow_api.id(7441726963243303)
,p_default_menu_template=>wwv_flow_api.id(7443026753243304)
,p_default_calendar_template=>wwv_flow_api.id(7443181547243304)
,p_default_list_template=>wwv_flow_api.id(7430031202243298)
,p_default_nav_list_template=>wwv_flow_api.id(7437602491243301)
,p_default_top_nav_list_temp=>wwv_flow_api.id(7437602491243301)
,p_default_side_nav_list_temp=>wwv_flow_api.id(7435610909243301)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(7369477121243276)
,p_default_dialogr_template=>wwv_flow_api.id(7368493856243276)
,p_default_option_label=>wwv_flow_api.id(7441726963243303)
,p_default_required_label=>wwv_flow_api.id(7442037673243304)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
,p_default_navbar_list_template=>wwv_flow_api.id(7435481907243301)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(57943236853698092)
,p_theme_id=>24
,p_theme_name=>'Cloudy'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(57934326375698086)
,p_error_template=>wwv_flow_api.id(57933827203698085)
,p_printer_friendly_template=>wwv_flow_api.id(57934752118698086)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(57933530564698085)
,p_default_button_template=>wwv_flow_api.id(57942054708698091)
,p_default_region_template=>wwv_flow_api.id(57937552534698088)
,p_default_chart_template=>wwv_flow_api.id(57935953146698088)
,p_default_form_template=>wwv_flow_api.id(57936250131698088)
,p_default_reportr_template=>wwv_flow_api.id(57937552534698088)
,p_default_tabform_template=>wwv_flow_api.id(57937552534698088)
,p_default_wizard_template=>wwv_flow_api.id(57938345660698088)
,p_default_menur_template=>wwv_flow_api.id(57935535193698086)
,p_default_listr_template=>wwv_flow_api.id(57935833336698088)
,p_default_irr_template=>wwv_flow_api.id(57936640694698088)
,p_default_report_template=>wwv_flow_api.id(57939256068698089)
,p_default_label_template=>wwv_flow_api.id(57941631168698091)
,p_default_menu_template=>wwv_flow_api.id(57942632481698091)
,p_default_calendar_template=>wwv_flow_api.id(57942838149698091)
,p_default_list_template=>wwv_flow_api.id(57941132088698089)
,p_default_option_label=>wwv_flow_api.id(57941748140698091)
,p_default_required_label=>wwv_flow_api.id(57941931387698091)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(7443440678243306)
,p_theme_id=>101
,p_name=>'Vista'
...
,p_reference_id=>146579407615209993
);
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(7443664594243306)
,p_theme_id=>101
,p_name=>'Vita'
,p_is_current=>true
,p_is_public=>true
...
,p_theme_roller_read_only=>true
,p_reference_id=>146579599655209995
);
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(7443819630243306)
,p_theme_id=>101
,p_name=>'Vita - Dark'
,p_is_current=>false
,p_is_public=>true
...
,p_theme_roller_read_only=>true
,p_reference_id=>146579817188209995
);
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(7444044536243306)
,p_theme_id=>101
,p_name=>'Vita - Red'
,p_is_current=>false
,p_is_public=>true
...
,p_theme_roller_read_only=>true
,p_reference_id=>146580022189209995
);
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(7444208217243306)
,p_theme_id=>101
,p_name=>'Vita - Slate'
,p_is_current=>false
,p_is_public=>true
...
,p_theme_roller_read_only=>true
,p_reference_id=>146580182454209995
);
end;
/
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7365553095243275)
,p_theme_id=>101
,p_name=>'ALERT_TYPE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7365911853243275)
,p_theme_id=>101
,p_name=>'ALERT_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7366582786243275)
,p_theme_id=>101
,p_name=>'ALERT_ICONS'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7366955486243276)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7370378246243276)
,p_theme_id=>101
,p_name=>'STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7370786532243276)
,p_theme_id=>101
,p_name=>'BODY_PADDING'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7372532156243278)
,p_theme_id=>101
,p_name=>'TIMER'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7373394060243278)
,p_theme_id=>101
,p_name=>'BODY_HEIGHT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7374509563243278)
,p_theme_id=>101
,p_name=>'ACCENT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7375762353243278)
,p_theme_id=>101
,p_name=>'HEADER'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7376197113243278)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7378131147243279)
,p_theme_id=>101
,p_name=>'ANIMATION'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7381564940243281)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7383997117243281)
,p_theme_id=>101
,p_name=>'REGION_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7384750436243281)
,p_theme_id=>101
,p_name=>'BODY_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7385837985243282)
,p_theme_id=>101
,p_name=>'DISPLAY_ICON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7387744048243282)
,p_theme_id=>101
,p_name=>'DIALOG_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7397698413243287)
,p_theme_id=>101
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7398041489243287)
,p_theme_id=>101
,p_name=>'TAB_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7398863880243287)
,p_theme_id=>101
,p_name=>'TABS_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7400978064243287)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7402194217243289)
,p_theme_id=>101
,p_name=>'BADGE_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7402595295243289)
,p_theme_id=>101
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>30
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7404537032243289)
,p_theme_id=>101
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7406339338243290)
,p_theme_id=>101
,p_name=>'BODY_TEXT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7408180621243290)
,p_theme_id=>101
,p_name=>'ANIMATION'
,p_display_name=>'Animation'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7408989126243290)
,p_theme_id=>101
,p_name=>'ICONS'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7410973598243292)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7412768840243292)
,p_theme_id=>101
,p_name=>'SIZE'
,p_display_name=>'Size'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7414532446243293)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7415111161243293)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7415511998243293)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7417581211243293)
,p_theme_id=>101
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7421332872243296)
,p_theme_id=>101
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>30
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7422508957243296)
,p_theme_id=>101
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7423725393243296)
,p_theme_id=>101
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>70
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7425595232243296)
,p_theme_id=>101
,p_name=>'BODY_TEXT'
,p_display_name=>'Body Text'
,p_display_sequence=>40
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7427562945243298)
,p_theme_id=>101
,p_name=>'ANIMATION'
,p_display_name=>'Animation'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7428162389243298)
,p_theme_id=>101
,p_name=>'ICONS'
,p_display_name=>'Icons'
,p_display_sequence=>20
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7431133336243298)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7432941993243300)
,p_theme_id=>101
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>1
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7438923475243303)
,p_theme_id=>101
,p_name=>'MOBILE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7439589171243303)
,p_theme_id=>101
,p_name=>'DESKTOP'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7440533537243303)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7442569638243304)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7444668104243309)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7445408173243309)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7448649470243310)
,p_theme_id=>101
,p_name=>'LEFT_MARGIN'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7449401090243310)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7452675992243310)
,p_theme_id=>101
,p_name=>'RIGHT_MARGIN'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7453441101243310)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7456655052243312)
,p_theme_id=>101
,p_name=>'TOP_MARGIN'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7457408136243312)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7460605393243312)
,p_theme_id=>101
,p_name=>'TYPE'
,p_display_name=>'Type'
,p_display_sequence=>20
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7461487152243312)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7462271152243314)
,p_theme_id=>101
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7463063513243314)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7463827030243314)
,p_theme_id=>101
,p_name=>'SPACING_TOP'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7464679917243314)
,p_theme_id=>101
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7465453303243314)
,p_theme_id=>101
,p_name=>'STYLE'
,p_display_name=>'Style'
,p_display_sequence=>30
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7468233024243315)
,p_theme_id=>101
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7471088474243315)
,p_theme_id=>101
,p_name=>'WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7473009753243315)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7473863662243315)
,p_theme_id=>101
,p_name=>'ITEM_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7474602180243317)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7475433220243317)
,p_theme_id=>101
,p_name=>'ITEM_PADDING'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7476682906243317)
,p_theme_id=>101
,p_name=>'ITEM_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7477847029243317)
,p_theme_id=>101
,p_name=>'SIZE'
,p_display_name=>'Size'
,p_display_sequence=>10
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(7478688829243317)
,p_theme_id=>101
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(
,p_name=>'FORMSIZELARGE'
,p_display_name=>'Large'
,p_display_sequence=>10
,p_css_classes=>'t-Form--large'
,p_group_id=>wwv_flow_api.id(7473863662243315)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7475074244243317)
,p_theme_id=>101
,p_name=>'FORMLEFTLABELS'
,p_display_name=>'Left'
,p_display_sequence=>20
,p_css_classes=>'t-Form--leftLabels'
,p_group_id=>wwv_flow_api.id(7474602180243317)
,p_template_types=>'REGION'
,p_help_text=>'Align form labels to left.'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7475822525243317)
,p_theme_id=>101
,p_name=>'FORMREMOVEPADDING'
,p_display_name=>'Remove Padding'
,p_display_sequence=>20
,p_css_classes=>'t-Form--noPadding'
,p_group_id=>wwv_flow_api.id(7475433220243317)
,p_template_types=>'REGION'
,p_help_text=>'Removes padding between items.'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7476229371243317)
,p_theme_id=>101
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7477054390243317)
,p_theme_id=>101
,p_name=>'STRETCH_FORM_FIELDS'
,p_display_name=>'Stretch Form Fields'
,p_display_sequence=>10
,p_css_classes=>'t-Form--stretchInputs'
,p_group_id=>wwv_flow_api.id(7476682906243317)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7477465666243317)
,p_theme_id=>101
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7478242202243317)
,p_theme_id=>101
,p_name=>'LARGE_FIELD'
,p_display_name=>'Large'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--large'
,p_group_id=>wwv_flow_api.id(7477847029243317)
,p_template_types=>'FIELD'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7479044618243317)
,p_theme_id=>101
,p_name=>'POST_TEXT_BLOCK'
,p_display_name=>'Display as Block'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--postTextBlock'
,p_group_id=>wwv_flow_api.id(7478688829243317)
,p_template_types=>'FIELD'
...
begin
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7479831558243318)
,p_theme_id=>101
,p_name=>'PRE_TEXT_BLOCK'
,p_display_name=>'Display as Block'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--preTextBlock'
,p_group_id=>wwv_flow_api.id(7479420851243317)
,p_template_types=>'FIELD'
,p_help_text=>'Displays the Item Pre Text in a block style immediately before the item.'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7480698199243318)
,p_theme_id=>101
,p_name=>'DISPLAY_AS_PILL_BUTTON'
,p_display_name=>'Display as Pill Button'
,p_display_sequence=>10
,p_css_classes=>'t-Form-fieldContainer--radioButtonGroup'
,p_group_id=>wwv_flow_api.id(7480294985243318)
,p_template_types=>'FIELD'
,p_help_text=>'Displays the radio buttons to look like a button set / pill button.  Note that the the radio buttons must all be in the same row for this option to work.'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7481008055243318)
,p_theme_id=>101
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7481496104243318)
,p_theme_id=>101
,p_name=>'X_LARGE_SIZE'
,p_display_name=>'X Large'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(7482299580243318)
,p_theme_id=>101
,p_name=>'HIDE_WHEN_ALL_ROWS_DISPLAYED'
,p_display_name=>'Hide when all rows displayed'
,p_display_sequence=>10
,p_css_classes=>'t-Report--hideNoPagination'
,p_group_id=>wwv_flow_api.id(7481801360243318)
,p_template_types=>'REPORT'
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(57949532758698127)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(57943524267698092)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(63097944668980041)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(35230830891341659419)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37824104052942861464)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824120565194874444)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>10
,p_display_value=>'Contains/Case (uses INSTR)'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824129654243880757)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824131158745882069)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824134564632883791)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824148571212885671)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824151143638887148)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37824163150911889233)
,p_plugin_attribute_id=>wwv_flow_api.id(37824104052942861464)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37825848448337427758)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37825860756995430289)
,p_plugin_attribute_id=>wwv_flow_api.id(37825848448337427758)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37825872061150431452)
,p_plugin_attribute_id=>wwv_flow_api.id(37825848448337427758)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37825884265437442132)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'bar'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(37825848448337427758)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826028653110523764)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>10
,p_display_value=>'Bar'
,p_return_value=>'bar'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826029957959525139)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826032061768526177)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826033465577527330)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826034569733528513)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826036841813529968)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826038048739531917)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37826038952895533157)
,p_plugin_attribute_id=>wwv_flow_api.id(37825884265437442132)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37826962453924157839)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31680444538216055006)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'APPLICATION'
...
,p_is_translatable=>false
,p_lov_type=>'STATIC'
,p_help_text=>unistr('Use this setting to specify the speed at which the modal dialog should perform certain effects such as sizing, resizing, and fading. Selecting \00BFinstant\00BF will essentially disable any effects.')
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31680446042717056344)
,p_plugin_attribute_id=>wwv_flow_api.id(31680444538216055006)
,p_display_sequence=>10
,p_display_value=>'Slow'
,p_return_value=>'600'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31680446645834057186)
,p_plugin_attribute_id=>wwv_flow_api.id(31680444538216055006)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31680447248951058054)
,p_plugin_attribute_id=>wwv_flow_api.id(31680444538216055006)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31680447953453059425)
,p_plugin_attribute_id=>wwv_flow_api.id(31680444538216055006)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24311888450480505615)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14661327526714211291)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31113665350930590759)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(24222809837911076417)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222793444528030996)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
...
,p_max_length=>100
,p_is_translatable=>false
,p_help_text=>unistr('Use this setting to explicitly set the title of the dialog. If no value is supplied then the item\00BFs label will be used.')
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222795646391040964)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
,p_max_length=>7
,p_is_translatable=>false
,p_help_text=>unistr('Use this setting to specify which column should be used for the item\00BFs display value and which column should be used for the item\00BFs return value. The value should be a comma separated pair of numbers where the numbers refer to the column in the LOV q')
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222801239727057928)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222802554618062248)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222803427391063825)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222804939165067272)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222809837911076417)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13595845386327993257)
,p_plugin_attribute_id=>wwv_flow_api.id(24222809837911076417)
,p_display_sequence=>10
,p_display_value=>'Not Enterable'
,p_return_value=>'NOT_ENTERABLE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13595883497409996428)
,p_plugin_attribute_id=>wwv_flow_api.id(24222809837911076417)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13595914305720998842)
,p_plugin_attribute_id=>wwv_flow_api.id(24222809837911076417)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222849152718099551)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24222810848646079469)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(12863460606655513)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(29066789257390662267)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827053258187179274)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827056953227181550)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827059049345183268)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827061045895184875)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827063341366186967)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827068868527189659)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827072361625192842)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37827075654293196216)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
,p_file_name=>'bar.gif'
,p_mime_type=>'image/gif'
,p_file_content=>wwv_flow_api.varchar2_to_blob(wwv_flow_api.g_varchar2_table)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(59088169175233603989)
,p_plugin_id=>wwv_flow_api.id(35230830891341659419)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(57943330597698092)
,p_ui_type_name=>'DESKTOP'
,p_display_name=>'Desktop'
,p_display_seq=>10
...
,p_navigation_list_id=>wwv_flow_api.id(7483097295278862)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(7435610909243301)
,p_nav_list_template_options=>'#DEFAULT#'
,p_include_legacy_javascript=>'PRE18:18'
,p_include_jquery_migrate=>true
,p_nav_bar_type=>'NAVBAR'
,p_nav_bar_list_template_id=>wwv_flow_api.id(7435481907243301)
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(57943330597698092)
,p_tab_set=>'TS1'
,p_name=>'HOME'
,p_alias=>'HOME'
,p_step_title=>'HOME'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57945049293698096)
,p_plug_name=>'TORDENSERV'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7389992475243284)
...
'"CDDELEGACION",',
'"CDEMPLEADO",',
'(Select nombre_pila ||'' '' ||primer_apellido ||'' ''||segundo_apellido from empleado@softland where empleado=cdempleado) empleado,',
'"CDAUTORIZA",',
'(Select nombre_pila ||'' '' ||primer_apellido ||'' ''||segundo_apellido from empleado@softland where empleado=cdautoriza) Autoriza,',
'"HORA_INICIO",',
'"HORA_FIN",',
'"FECHA_CIERRE",',
'"FEC_CIERRE_TALLER",',
'"NUMERO_SALIDA",',
'"REPORTADO_POR",',
'(Select nombre_pila ||'' '' ||primer_apellido ||'' ''||segundo_apellido from empleado@softland where empleado=reportado_por) Reporta,',
'"UBICACION",',
'"COD_FALLA",',
...
'"CREADO",',
'"CDASIGNADO",',
'(Select nombre_pila ||'' '' ||primer_apellido ||'' ''||segundo_apellido from empleado@softland where empleado=CDASIGNADO) as asignado,',
'"FECHA_ASIGNADO",',
'CDCLASE||''-''||CORRELATIVO as unidad,',
'CDCLASE||''-''||CORRELATIVO as unidadfiltro,',
'TALLER,nmsuper,',
'(select nmorden from tordenserv h where h.ot_rel=a.nmorden and cod_cheklist in (1,2,3,11,12,7,8,13,14,15))rel,',
'(Select nombre_pila ||'' '' ||primer_apellido ||'' ''||segundo_apellido from empleado@softland where empleado=cdpiloto ) as piloto,cdpiloto,',
'decode(cod_cheklist,1,''CARGA'',2,''DESCARGA'',3,''MANEJO'',11,''CARGA_CARBON'',12,''DESCARGA CARBON'', 7, ''DIARIO LIMPIO'',8, ''DIARIO CARBON'',13,''MENSUAL CABEZAL'',14,''MENSUAL PIPA'',15,''MENSUAL RIGIDO'',16,''PISTA'',17,''MENSUAL_GONDOLA'' ) as Cheklist',
' from   TORDENSERV A where CDDELEGACION =( select decode(cdestacion,''00'',cddelegacion, cdestacion) from PA_usuarios where lower(usuario) = lower(:APP_USER)) and taller in (17,18) and cdtiporden=8',
' ',
' ',
'  '))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(57945139912698096)
,p_name=>'TORDENSERV'
...
,p_detail_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.::P2_ROWID,P2_UNIDAD,P2_NMORDEN:#ROWID#,#CDCLASE#-#CORRELATIVO#,#NMORDEN#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57945427578698099)
,p_db_column_name=>'NMORDEN'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Nmorden'
,p_column_link=>'/ords/f?p=380:1:&APP_SESSION.::::P1_CDPILOTO,P1_CDRESPONSABLE,P1_UNIDAD,P1_nmnota:#CDPILOTO#,#CDASIGNADO#,#UNIDAD#,#NMORDEN#'
,p_column_linktext=>'#NMORDEN#'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57945524237698100)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57945631184698102)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57945732982698102)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57945847285698103)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57945941593698105)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946045376698105)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946140584698105)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946235466698107)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946324009698107)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946442308698108)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946553468698108)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946650630698110)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946747195698110)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946827269698111)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57946947341698111)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947026163698113)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947154045698113)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947250110698113)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947324405698114)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947445014698114)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947546165698116)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947628377698116)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947745812698117)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947838695698119)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57947942001698119)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57948044877698121)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57948146591698122)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57948248272698122)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57948334001698124)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57958446231924571)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57963152989362122)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57963240725362122)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57990738304477214)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57990838271477219)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57990927271477219)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63963451695654058)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75301742675979507)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75301841456979507)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75693033157671310)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(78993843840432489)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(78993933646432492)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(53127917924688426)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(53127999417688432)
,p_db_column_name=>'CHEKLIST'
,p_display_order=>47
,p_column_identifier=>'AU'
,p_column_label=>'Cheklist'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'CHEKLIST'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55301727069920951)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(59294014250513949)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66831407544408140)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(57956932160698375)
...
,p_is_default=>'Y'
,p_display_rows=>25
,p_report_columns=>'NMORDEN:FECREA:DSREPARA:ESTADO:PILOTO:FECHA_CIERRE:TIPO_ORDEN:CDASIGNADO:ASIGNADO:CHEKLIST:CDPILOTO:REL:NMSUPER:'
,p_sort_column_1=>'FECREA'
,p_sort_direction_1=>'DESC'
,p_break_on=>'UNIDAD:0:0:0:0:0'
,p_break_enabled_on=>'UNIDAD:0:0:0:0:0'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(66831729736412118)
,p_report_id=>wwv_flow_api.id(57956932160698375)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(66831811827412118)
,p_report_id=>wwv_flow_api.id(57956932160698375)
,p_name=>'Trans'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(66831505354412118)
,p_report_id=>wwv_flow_api.id(57956932160698375)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'CHEKLIST'
,p_operator=>'='
,p_expr=>'MENSUAL PIPA'
,p_condition_sql=>'"CHEKLIST" = #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# = ''MENSUAL PIPA''  '
,p_enabled=>'N'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(66831598918412118)
,p_report_id=>wwv_flow_api.id(57956932160698375)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_computation(
 p_id=>wwv_flow_api.id(66831911957412118)
,p_report_id=>wwv_flow_api.id(57956932160698375)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(60788843166276038)
,p_plug_name=>'NUEVA ORDEN DE TRABAJO'
,p_region_name=>'NEW'
,p_parent_plug_id=>wwv_flow_api.id(57945049293698096)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7388801036243282)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57948729812698127)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7399392208243287)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(57944632552698094)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(7443026753243304)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7664649386799113)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(57945049293698096)
,p_button_name=>'Nuevo'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--success:t-Button--stretch'
,p_button_template_id=>wwv_flow_api.id(7442286569243304)
,p_button_image_alt=>'Nuevo'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:RP::'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(60789646260276039)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(58102035673938883)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53090005508460602)
,p_name=>'P1_COD_CHEKLIST'
,p_item_sequence=>370
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53149328860291130)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>380
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60789828744276041)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
,p_field_template=>wwv_flow_api.id(7441726963243303)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60790054307276041)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60790231466276041)
,p_name=>'P1_NMORDEN'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60790440053276042)
,p_name=>'P1_FECREA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60790630460276042)
,p_name=>'P1_CDCLASE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60790844167276044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60791025977276044)
,p_name=>'P1_KMACTUAL'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60791227225276044)
,p_name=>'P1_KMSIGSERV'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60791432281276044)
,p_name=>'P1_DSREPARA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60791624464276047)
,p_name=>'P1_ESTADO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60791852201276047)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60792029995276047)
,p_name=>'P1_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60792228459276047)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60792427269276047)
,p_name=>'P1_NMSOLIC'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60792632880276047)
,p_name=>'P1_SERIE'
,p_is_required=>true
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60792841868276049)
,p_name=>'P1_TIPO_SERV'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60793053492276049)
,p_name=>'P1_NUM_CHECK'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60793243584276049)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60793433850276049)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60793632623276049)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60793848872276049)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60794038575276050)
,p_name=>'P1_HORA_FIN'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60794226341276050)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60794439324276050)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60794645233276050)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60794852819276050)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60795030212276050)
,p_name=>'P1_UBICACION'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60795248431276050)
,p_name=>'P1_COD_FALLA'
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60795437290276052)
,p_name=>'P1_TIPO_OT'
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60795629123276052)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60795848286276052)
,p_name=>'P1_CREADO'
,p_is_required=>true
,p_item_sequence=>310
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60796029464276052)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60796243110276052)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60796453032276052)
,p_name=>'P1_PILOTO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60806840367617478)
,p_name=>'P1_GUIONES'
,p_item_sequence=>350
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63963741331673986)
,p_name=>'P1_TALLER'
,p_item_sequence=>360
,p_item_plug_id=>wwv_flow_api.id(60788843166276038)
,p_prompt=>'Taller'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(64609340632068057)
,p_validation_name=>'P1_TALLER'
,p_validation_sequence=>10
,p_validation=>'P1_TALLER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Ingrese Taller'
,p_associated_item=>wwv_flow_api.id(63963741331673986)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(60806923903630074)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(60807229196630075)
,p_event_id=>wwv_flow_api.id(60806923903630074)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(60805537437510944)
,p_name=>'asignar'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(60805846566510944)
,p_event_id=>wwv_flow_api.id(60805537437510944)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(60807943553676769)
,p_event_id=>wwv_flow_api.id(60805537437510944)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(60824326277051855)
,p_name=>'Serie'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(60824626734051894)
,p_event_id=>wwv_flow_api.id(60824326277051855)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(60825023816098444)
,p_name=>'Delegacion'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(60825337463098444)
,p_event_id=>wwv_flow_api.id(60825023816098444)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53117523417032541)
,p_event_id=>wwv_flow_api.id(60825023816098444)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
'select id into :p1_taller from tbl_taller where description like ''%SUPER%'' and cdestacion =(Select cdestacion from PA_Usuarios  where lower(usuario) = lower(:APP_USER));',
'end;'))
,p_attribute_03=>'P1_TALLER'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53127418812657668)
,p_event_id=>wwv_flow_api.id(60825023816098444)
,p_event_result=>'TRUE'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'Select cod_emp into :P1_CDEMPLEADO  from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'end;'))
,p_attribute_03=>'P1_CDEMPLEADO'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(60800147695276063)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(60800330330276063)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(60800533115276063)
...
'}',
'',
'function xlibJasperDemo_generateUrl(pBaseUrl, pRepName, pRepFormat, pDataSource, pOutFilename, pRepLocale, pRepEncoding, pAdditionalParams,pAdditionalParams2,pSerie,pContrato){',
'  var url;',
'',
'  url = pBaseUrl;',
...
,p_step_template=>wwv_flow_api.id(7360792802243271)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220207083817'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57949043697698127)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57956639964698133)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7399392208243287)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(64440648279579519)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(57949043697698127)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57949149504698127)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(57949043697698127)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57949350349698127)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57949425808698127)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(57949651957698128)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53124603346588821)
,p_name=>'P2_PILOTO'
,p_item_sequence=>172
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Piloto'
,p_source=>'CDPILOTO'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'SELECT empleado||''-'' ||nombre_pila||'' ''||primer_apellido||'' ''||segundo_apellido empleados, TO_NUMBER(empleado) FROM VISTA_EMPLEADOS'
,p_cSize=>30
,p_cMaxlength=>4000
,p_field_template=>wwv_flow_api.id(7441726963243303)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53124822096595343)
,p_name=>'P2_COD_CHECKLIST'
,p_item_sequence=>182
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Cod Checklist'
,p_source=>'COD_CHEKLIST'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:CARGA;1,DESCARGA;2,MANEJO;3,CARGA_CARBON;11,DESCARGA_CARBON;12,DIARIO LIMPIO;7,DIARIO CARBON;8,MENSUAL_CABEZAL;13,MENSUAL_PIPA;14,MENSUAL_RIGIDO;15,PISTA;16,MENSUAL_GONDOLA;17'
,p_lov_cascade_parent_items=>'P2_NMORDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57949754456698128)
,p_name=>'P2_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57949832139698128)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57950024256698128)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57950230472698128)
,p_name=>'P2_FECREA'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57950435508698128)
,p_name=>'P2_CDCLASE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57950639044698128)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57950844069698130)
,p_name=>'P2_KMACTUAL'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57951032914698130)
,p_name=>'P2_KMSIGSERV'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57951246548698130)
,p_name=>'P2_DSREPARA'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57951443670698130)
,p_name=>'P2_ESTADO'
,p_item_sequence=>9
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57951644423698130)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57951833665698130)
,p_name=>'P2_CDEMPRESA'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_item_default=>'01'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57952032490698130)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57952227087698130)
,p_name=>'P2_NMSOLIC'
,p_item_sequence=>13
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57952440870698130)
,p_name=>'P2_SERIE'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_prompt=>'Serie'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57952646270698130)
,p_name=>'P2_TIPO_SERV'
,p_item_sequence=>15
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57952849343698130)
,p_name=>'P2_NUM_CHECK'
,p_item_sequence=>16
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57953040656698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57953235123698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57953444931698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57953638353698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57953832847698132)
,p_name=>'P2_HORA_FIN'
,p_item_sequence=>21
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57954047703698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57954230945698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57954449103698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57954624215698132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57954839979698132)
,p_name=>'P2_UBICACION'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57955054076698132)
,p_name=>'P2_COD_FALLA'
,p_item_sequence=>27
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57955224352698132)
,p_name=>'P2_TIPO_OT'
,p_item_sequence=>28
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57955440709698133)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57955653312698133)
,p_name=>'P2_CREADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57955825036698133)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57956031323698133)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(58119427600322471)
,p_name=>'P2_CLASE'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_prompt=>'Clase'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(58124437938864647)
,p_name=>'P2_LIST'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60713352310147911)
,p_name=>'P2_FLAG'
,p_item_sequence=>0
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_prompt=>'Flag'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64257137573910846)
,p_name=>'P2_UNIDAD'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select proyecto, proyecto as p from proyecto where status=''A''  order by proyecto'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64257756107917363)
,p_name=>'P2_GUIONES'
,p_item_sequence=>52
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_prompt=>'Guiones'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64439343291574930)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64439538740574935)
,p_name=>'P2_REP_NAME'
,p_item_sequence=>72
,p_item_plug_id=>wwv_flow_api.id(57956639964698133)
,p_item_default=>'OT'
,p_prompt=>'Report Url'
,p_source=>'OT'
,p_source_type=>'STATIC'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64439747110574935)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64439936127574936)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64440126462574936)
,p_name=>'P2_OUT_FILE'
,p_item_sequence=>102
,p_item_plug_id=>wwv_flow_api.id(57956639964698133)
,p_prompt=>'Report Url'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64440352998574936)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64440541347574936)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64441744776604647)
,p_name=>'P2_URL'
,p_item_sequence=>132
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_item_default=>'http://lp-bdd:8080/JasperReportsIntegration/report?_repName=OT&_repFormat=PDF&_dataSource=default&_outFilename=&_repLocale=en_US&_repEncoding=UTF-8&OT='
,p_prompt=>'Url'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64441950009604647)
,p_name=>'P2_URLR'
,p_item_sequence=>142
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_prompt=>'Urlr'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(64607525886907796)
,p_name=>'P2_TALLER'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(57949043697698127)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(82777446008127886)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(64607828653952092)
,p_validation_name=>'P2_TALLER'
,p_validation_sequence=>10
,p_validation=>'P2_TALLER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Ingrese Taller'
,p_when_button_pressed=>wwv_flow_api.id(57949350349698127)
,p_associated_item=>wwv_flow_api.id(64607525886907796)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(64257946629924786)
,p_name=>'conteo_guiones'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64258228155924797)
,p_event_id=>wwv_flow_api.id(64257946629924786)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(64258330268938983)
,p_name=>'asignar'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64258632549938983)
,p_event_id=>wwv_flow_api.id(64258330268938983)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64260028478960641)
,p_event_id=>wwv_flow_api.id(64258330268938983)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(64442447165673832)
,p_name=>'URL_REPORTE'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_TALLER'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64442753425673841)
,p_event_id=>wwv_flow_api.id(64442447165673832)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
,p_attribute_03=>'P2_URLR,P2_REPORT_URL'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64509029194473119)
,p_event_id=>wwv_flow_api.id(64442447165673832)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(64443024571686307)
,p_name=>'IMPRIMIR'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(64440648279579519)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64510525546717886)
,p_event_id=>wwv_flow_api.id(64443024571686307)
,p_event_result=>'TRUE'
,p_action_sequence=>5
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64443339263686310)
,p_event_id=>wwv_flow_api.id(64443024571686307)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(64443627893688419)
,p_event_id=>wwv_flow_api.id(64443024571686307)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(84273848786931421)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(84274126864931442)
,p_event_id=>wwv_flow_api.id(84273848786931421)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57956234699698133)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57956351235698133)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TORDENSERV'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220202171002'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7614144421690359)
,p_plug_name=>'CREAR'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7368493856243276)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7614807076690362)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7369477121243276)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7615206678690362)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(7614807076690362)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(7442286569243304)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7614715424690362)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7614695687690362)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(7614807076690362)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7614548571690362)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(7614807076690362)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(9243382118939509)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7617691602690367)
,p_name=>'P3_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7618097002690376)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7618436866690379)
,p_name=>'P3_NMORDEN'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
'select max(to_number(nmorden))+1,max(to_number(nmorden))+1 as nmorden  from tordenserv    where fecrea>to_date(''01/01/2017'',''dd/mm/yyyy'');',
''))
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(7441726963243303)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7618843195690379)
,p_name=>'P3_FECREA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7619206695690379)
,p_name=>'P3_CDCLASE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7619673499690381)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7620052952690381)
,p_name=>'P3_KMACTUAL'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7620402728690381)
,p_name=>'P3_KMSIGSERV'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7620855924690381)
,p_name=>'P3_DSREPARA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Descripcion OT'
,p_source=>'DSREPARA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>60
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7621206930690381)
,p_name=>'P3_ESTADO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7621676445690381)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7622074962690381)
,p_name=>'P3_CDEMPRESA'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7622437747690381)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7622828888690381)
,p_name=>'P3_NMSOLIC'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7623274137690381)
,p_name=>'P3_SERIE'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7623646170690382)
,p_name=>'P3_TIPO_SERV'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7624016879690382)
,p_name=>'P3_NUM_CHECK'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7624438005690382)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7624814226690382)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7625275523690382)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7625609926690382)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7626041971690382)
,p_name=>'P3_HORA_FIN'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7626441001690382)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7626871542690382)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7627287510690384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7627614375690384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7628050446690384)
,p_name=>'P3_UBICACION'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7628496352690384)
,p_name=>'P3_COD_FALLA'
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7628842599690384)
,p_name=>'P3_TIPO_OT'
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7629234216690384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7629683163690384)
,p_name=>'P3_CREADO'
,p_item_sequence=>310
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7630028237690384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7630496540690384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7630811769690384)
,p_name=>'P3_UNIDAD'
,p_item_sequence=>340
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7631285805690384)
,p_name=>'P3_COMENTARIO_CIERRE'
,p_item_sequence=>350
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'COMENTARIO_CIERRE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7631636601690385)
,p_name=>'P3_TALLER'
,p_item_sequence=>360
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7632015765690385)
,p_name=>'P3_COMENT_TERMINA'
,p_item_sequence=>370
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'COMENT_TERMINA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7632447137690385)
,p_name=>'P3_COMENT_ANULA'
,p_item_sequence=>380
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'COMENT_ANULA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7632810267690385)
,p_name=>'P3_FECHA_ANULA'
,p_item_sequence=>390
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'FECHA_ANULA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7633240681690385)
,p_name=>'P3_FECHA_TERMINA'
,p_item_sequence=>400
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'FECHA_TERMINA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7633675452690385)
,p_name=>'P3_CERRADO_POR'
,p_item_sequence=>410
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'CERRADO_POR'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7634003175690387)
,p_name=>'P3_C_BODEGA'
,p_item_sequence=>420
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7634439265690387)
,p_name=>'P3_CDPILOTO'
,p_item_sequence=>81
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7634838281690387)
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:CARGA;1,DESCARGA;2,MANEJO;3,CARGA_CARBON;11,DESCARGA_CARBON;12,DIARIO_LIMPIO;7,DIARIO_CARBOM;8,MENSUAL_CABEZAL;13,MENSUAL_PIPA;14,MENSUAL_RIGIDO;15,PISTA;16,MENSUAL_GONDOLA;17'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(7441726963243303)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7635238174690387)
,p_name=>'P3_NMSUPER'
,p_item_sequence=>450
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7635661939690387)
,p_name=>'P3_OT_REL'
,p_item_sequence=>460
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7636058172690387)
,p_name=>'P3_APROBADO'
,p_item_sequence=>470
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7636454658690389)
,p_name=>'P3_SISTEMA'
,p_item_sequence=>480
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7636862233690389)
,p_name=>'P3_NMNOTA'
,p_item_sequence=>490
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7637260581690389)
,p_name=>'P3_TIEMPO_ASIGNADO'
,p_item_sequence=>500
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_use_cache_before_default=>'NO'
,p_source=>'TIEMPO_ASIGNADO'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7663870926799105)
,p_name=>'P3_GUIONES'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(7614144421690359)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(7615347495690362)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(7615206678690362)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7616144388690365)
,p_event_id=>wwv_flow_api.id(7615347495690362)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(7663446903799101)
,p_name=>'SERIE'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7663558069799102)
,p_event_id=>wwv_flow_api.id(7663446903799101)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(7663623078799103)
,p_name=>'conteo_guiones'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7663770512799104)
,p_event_id=>wwv_flow_api.id(7663623078799103)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(7663986045799106)
,p_name=>'asignar'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P3_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7664059333799107)
,p_event_id=>wwv_flow_api.id(7663986045799106)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'SUBSTR(:p3_UNIDAD, 1, instr(:p3_UNIDAD,''-'',1, :p3_guiones)-1)'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7664197705799108)
,p_event_id=>wwv_flow_api.id(7663986045799106)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'SUBSTR(:p3_UNIDAD, instr( :p3_UNIDAD,''-'',1, :p3_guiones)+1, LENGTH(:p3_UNIDAD)) '
,p_attribute_07=>'P3_GUIONES,P3_UNIDAD'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(7664264162799109)
,p_name=>'delegacion'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7664337849799110)
,p_event_id=>wwv_flow_api.id(7664264162799109)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7664483672799111)
,p_event_id=>wwv_flow_api.id(7664264162799109)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
'select id into :p3_taller from tbl_taller where description like ''%SUPER%'' and cdestacion =(Select cdestacion from PA_Usuarios  where lower(usuario) = lower(:APP_USER));',
'end;'))
,p_attribute_03=>'P3_TALLER'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(7664544883799112)
,p_event_id=>wwv_flow_api.id(7664264162799109)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'Select cod_emp into :P3_CDEMPLEADO  from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'end;'))
,p_attribute_03=>'P3_CDEMPLEADO'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7652732269690395)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TORDENSERV'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7664799879799114)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'INSERTAR'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
'begin ',
'insert into "TORDENSERV" ( "CDTIPORDEN","NMORDEN","FECREA","CDCLASE","CORRELATIVO","KMACTUAL","KMSIGSERV","CDPILOTO","DSREPARA",',
'"ESTADO","OBSERVACIONES","CDEMPRESA","CDSERVICIO","NMSOLIC","SERIE","TIPO_SERV","NUM_CHECK","CDDELEGACION","CDEMPLEADO",',
'"CDAUTORIZA","HORA_INICIO","HORA_FIN","FECHA_CIERRE","FEC_CIERRE_TALLER","NUMERO_SALIDA","REPORTADO_POR","UBICACION",',
'"COD_FALLA","TIPO_OT","ES_SERVICIO","CREADO","CDASIGNADO","FECHA_ASIGNADO","UNIDAD","COMENTARIO_CIERRE","TALLER",',
'"COMENT_TERMINA","COMENT_ANULA","FECHA_ANULA","FECHA_TERMINA","CERRADO_POR","C_BODEGA",',
'"COD_CHEKLIST","NMSUPER","OT_REL","APROBADO","SISTEMA","NMNOTA","TIEMPO_ASIGNADO") ',
'values (:P3_CDTIPORDEN,:P3_NMORDEN,to_date(:P3_FECREA,''DD/MM/YYYY''),:P3_CDCLASE,:P3_CORRELATIVO,:P3_KMACTUAL',
',:P3_KMSIGSERV,:P3_CDPILOTO,:P3_DSREPARA,:P3_ESTADO,:P3_OBSERVACIONES,',
':P3_CDEMPRESA,:P3_CDSERVICIO,:P3_NMSOLIC,:P3_SERIE,:P3_TIPO_SERV,',
':P3_NUM_CHECK,:P3_CDDELEGACION,:P3_CDEMPLEADO,:P3_CDAUTORIZA,',
':P3_HORA_INICIO,:P3_HORA_FIN,:P3_FECHA_CIERRE,:P3_FEC_CIERRE_TALLER,',
':P3_NUMERO_SALIDA,:P3_REPORTADO_POR,:P3_UBICACION,:P3_COD_FALLA,',
':P3_TIPO_OT,:P3_ES_SERVICIO,:P3_CREADO,:P3_CDASIGNADO,',
':P3_FECHA_ASIGNADO,:P3_UNIDAD,:P3_COMENTARIO_CIERRE,:P3_TALLER,',
':P3_COMENT_TERMINA,:P3_COMENT_ANULA,:P3_FECHA_ANULA,:P3_FECHA_TERMINA,',
':P3_CERRADO_POR,:P3_C_BODEGA,:P3_COD_CHEKLIST,:P3_NMSUPER,',
':P3_OT_REL,:P3_APROBADO,:P3_SISTEMA,:P3_NMNOTA,:P3_TIEMPO_ASIGNADO); end;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(7614548571690362)
,p_process_success_message=>'CREADO'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7653524681690395)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7653927063690396)
...
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(7350034201243268)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220120125917'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57943850316698092)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7389992475243284)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57944130847698092)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(57943850316698092)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57943948233698092)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(57943850316698092)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57944033847698092)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57944325603698094)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57944226445698092)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57944541207698094)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(57944454076698094)
,p_process_sequence=>10
