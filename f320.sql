...
prompt APPLICATION 320 - J_CHECK CARBON
--
-- Application Export:
--   Application:     320
--   Name:            J_CHECK CARBON
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,320)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_CHECK CARBON')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_320')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'1587017448541DB35C2C8325C87340FF71E97032B1C10D6815F353769CBA7C68'
...
,p_authentication_id=>wwv_flow_api.id(16819308473667987)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:J_CHECK CARBON'
...
,p_last_upd_yyyymmddhh24miss=>'20180119165600'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8759294044056651)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8759368358056651)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8759457809056651)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8759674692056651)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8759764907056651)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8759823148056651)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16777823454441340)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(16816314536634785)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(16795809341441485)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(16797018591441532)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(16797411682441550)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16777927475441351)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778016300441362)
,p_page_template_id=>wwv_flow_api.id(16777927475441351)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16778119803441367)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778205252441367)
,p_page_template_id=>wwv_flow_api.id(16778119803441367)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778303204441367)
,p_page_template_id=>wwv_flow_api.id(16778119803441367)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778425846441367)
,p_page_template_id=>wwv_flow_api.id(16778119803441367)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778523974441367)
,p_page_template_id=>wwv_flow_api.id(16778119803441367)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778607853441367)
,p_page_template_id=>wwv_flow_api.id(16778119803441367)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16778731334441367)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778819944441367)
,p_page_template_id=>wwv_flow_api.id(16778731334441367)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16778914805441367)
,p_page_template_id=>wwv_flow_api.id(16778731334441367)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779031495441367)
,p_page_template_id=>wwv_flow_api.id(16778731334441367)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779104135441367)
,p_page_template_id=>wwv_flow_api.id(16778731334441367)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779232329441367)
,p_page_template_id=>wwv_flow_api.id(16778731334441367)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779315301441367)
,p_page_template_id=>wwv_flow_api.id(16778731334441367)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16779425416441368)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779515387441368)
,p_page_template_id=>wwv_flow_api.id(16779425416441368)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779620765441368)
,p_page_template_id=>wwv_flow_api.id(16779425416441368)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779704848441368)
,p_page_template_id=>wwv_flow_api.id(16779425416441368)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16779811564441368)
,p_page_template_id=>wwv_flow_api.id(16779425416441368)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16779921296441368)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780009735441368)
,p_page_template_id=>wwv_flow_api.id(16779921296441368)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780112401441368)
,p_page_template_id=>wwv_flow_api.id(16779921296441368)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780220721441368)
,p_page_template_id=>wwv_flow_api.id(16779921296441368)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780312436441368)
,p_page_template_id=>wwv_flow_api.id(16779921296441368)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780422495441368)
,p_page_template_id=>wwv_flow_api.id(16779921296441368)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16780523892441368)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780612048441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780728068441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780814479441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16780926403441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781028989441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781115896441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781203635441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781303759441368)
,p_page_template_id=>wwv_flow_api.id(16780523892441368)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16781408865441370)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781515470441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781619825441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781709500441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781823382441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16781912948441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782003349441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782100816441370)
,p_page_template_id=>wwv_flow_api.id(16781408865441370)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16782206948441370)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782310969441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782428401441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782518141441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782612154441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782721781441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782831220441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16782900780441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16783016560441370)
,p_page_template_id=>wwv_flow_api.id(16782206948441370)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16783103096441370)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16783208586441370)
,p_page_template_id=>wwv_flow_api.id(16783103096441370)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16783319884441370)
,p_page_template_id=>wwv_flow_api.id(16783103096441370)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16
396)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16792226678441396)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16792302023441396)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16792412183441396)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16792527345441396)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794014286441407)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794109490441414)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794200634441414)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794300506441414)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794404208441414)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794519475441414)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16794605189441415)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(16795307768441420)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(16795528317441434)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(16795430651441428)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(16795619432441442)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(16783103096441370)
,p_error_template=>wwv_flow_api.id(16779425416441368)
,p_printer_friendly_template=>wwv_flow_api.id(16785621285441371)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(16777927475441351)
,p_default_button_template=>wwv_flow_api.id(16794704812441415)
,p_default_region_template=>wwv_flow_api.id(16791013534441390)
,p_default_chart_template=>wwv_flow_api.id(16791013534441390)
,p_default_form_template=>wwv_flow_api.id(16790115547441389)
,p_default_reportr_template=>wwv_flow_api.id(16791013534441390)
,p_default_tabform_template=>wwv_flow_api.id(16791013534441390)
,p_default_wizard_template=>wwv_flow_api.id(16790115547441389)
,p_default_menur_template=>wwv_flow_api.id(16789612626441387)
,p_default_listr_template=>wwv_flow_api.id(16791013534441390)
,p_default_irr_template=>wwv_flow_api.id(16790518008441389)
,p_default_report_template=>wwv_flow_api.id(16792112754441396)
,p_default_label_template=>wwv_flow_api.id(16794200634441414)
,p_default_menu_template=>wwv_flow_api.id(16795307768441420)
,p_default_calendar_template=>wwv_flow_api.id(16795430651441428)
,p_default_list_template=>wwv_flow_api.id(16793718908441407)
,p_default_option_label=>wwv_flow_api.id(16794200634441414)
,p_default_required_label=>wwv_flow_api.id(16794519475441414)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(16795907636441492)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(16819308473667987)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(16795713448441443)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(16795713448441443)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180119165410'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16797720277450618)
,p_plug_name=>'CHEKLIST_Carbon'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(16791013534441390)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16798025045450620)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(16797720277450618)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(16794704812441415)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16815303589616051)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(16797720277450618)
,p_button_name=>'GRABA_CHEKLIST'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(16794704812441415)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Graba Cheklist'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(16798115880450621)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16802613162468331)
,p_name=>'P1_DOCUMENTOS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Documentos validos y vigentes, licencia de conducir, carnet de acreditacion, manual del conductor y certificado/licencia del camion'
...
,p_field_template=>wwv_flow_api.id(16794300506441414)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16802808202470620)
,p_name=>'P1_CABINA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Cabina limpia y sin objetos pesados sueltos y objetos no autorizados'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16803004104472478)
,p_name=>'P1_NIVEL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Nivel de combustible'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16803232343474556)
,p_name=>'P1_LIMPIABRISAS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Limpiabrisas funcionando'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16803428462476426)
,p_name=>'P1_LUCES'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Luces del camion (cabezal y cisterna) funcionando atencion a focos de luz rotos'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16803625227477868)
,p_name=>'P1_EXINTORES'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Extintores 2 en la cisterna (minimo de 20 lbs cada uno y 1 en la cabina (minimo de 5 lbs)'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16803821345479643)
,p_name=>'P1_LLANTAS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'llantas: presion de aire,ausencia de cortes o roturas supeeriores a 25mm, profundidad del labrado minimo de 2mm'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16804015953482143)
,p_name=>'P1_ACEITE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'nivel de aceite y de agua del motor'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16804212503483768)
,p_name=>'P1_TENSION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'tension y estado adecuado de la faja del motor'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16804608621485606)
,p_name=>'P1_FRENOS'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'frenos, purgar (sacar) el agua de la camara de aire, funcionando perfectamente.'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16804804739487393)
,p_name=>'P1_VERIFICAREQUIPO'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Verificacion de equipo de descarga: palas, conos, etc'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16805000210489512)
,p_name=>'P1_VERIFICARRESIDUOS'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Verificar residuos ( compuertas y almejas)'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16805229312491150)
,p_name=>'P1_REVISIONCODO'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>unistr('Revisi\00C3\00B3n de codo de escape, flexible de escape, silenciador de escape y punta de escape')
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16805426293492598)
,p_name=>'P1_FUGAS'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Verificacion de fugas o desgaste en mangueras de levante.'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16805621332494921)
,p_name=>'P1_KIT'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Kit-primeros auxilios '
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'Static:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16809929275536834)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Unidad'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select proyecto, nombre from proyecto where status=''A''  order by proyecto'
...
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(16794109490441414)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16810618707541712)
,p_name=>'P1_CONDUCTOR'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Conductor'
...
'select  cod_emp||'' ''|| nombres ||'' ''|| apellidos,cod_emp from empleados where   cod_puesto in(26,2,5,11,38,47,9,18) and status = ''A''  AND COD_SUCURSAL IN ( select decode(cdestacion,''00'',''10'', ''01'',''10'',''02'',''20'') from PA_usuarios where lower(usuario)'
||' = lower(:APP_USER))order by cod_emp ',
''))
,p_lov_display_null=>'YES'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16810812885544365)
,p_name=>'P1_SUPERVISA'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(16797720277450618)
,p_prompt=>'Supervisa'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16814213482604876)
...
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(16794200634441414)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16812520034583012)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insertachek'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'maximo numeric;',
'begin',
'SELECT MAX(NMSUPER)+1 into maximo FROM TCHEKLIST_DET;',
'insert into tsupervision values(maximo,:P1_SUPERVISA,:P1_CONDUCTOR,:P1_COMENTARIO,null,sysdate(),''evaluacion'',''SI'',null,sysdate(),0,null,null,:P1_UNIDAD);',
'insert into TCHEKLIST_DET values (maximo,1,8,decode (:P1_DOCUMENTOS,NULL, ''M'', ''B'') ,null,null);',
'insert into TCHEKLIST_DET values (maximo,2,8,decode (:P1_CABINA, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,3,8,decode (:P1_NIVEL, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,4,8,decode (:P1_LIMPIABRISAS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,5,8,decode (:P1_LUCES, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,6,8,decode (:P1_EXINTORES, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,7,8,decode (:P1_LLANTAS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,8,8,decode (:P1_ACEITE, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,9,8,decode (:P1_TENSION, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,10,8,decode (:P1_FRENOS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,11,8,decode (:P1_VERIFICAREQUIPO, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,12,8,decode (:P1_VERIFICARRESIDUOS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,13,8,decode (:P1_REVISIONCODO, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,14,8,decode (:P1_FUGAS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,15,8,decode (:P1_KIT, NULL, ''M'',''B''),null,null);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(16815303589616051)
);
end;
/
...
,p_step_template=>wwv_flow_api.id(16777927475441351)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180119161731'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16796224012441503)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(16790115547441389)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16796524413441525)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(16796224012441503)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16796309343441510)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16796224012441503)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16796417000441517)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16796716677441532)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16796600486441528)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16796913163441532)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16796809725441532)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(16819008400664746)
);
end;
/
