...
,p_default_application_id=>384
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 384 - Combustible
--
-- Application Export:
--   Application:     384
--   Name:            Combustible
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,384)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_384')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'4BA37011DECC99F19933EC9A1B496C16E25408554B52074F8DD985401FB9FDE9'
...
,p_authentication_id=>wwv_flow_api.id(87753605041602114)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20210325161222'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13032130970087317)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13032234991087317)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13032369518087317)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13032592039087317)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13032697164087317)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13032792352087317)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(87743422536601589)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(91641929697377395)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(87753404151602082)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(87755017795602262)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_COMBUSTIBLE'
,p_tab_text=>'Combustible'
,p_tab_step=>1
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(87754732033602245)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(87755113401602262)
,p_parent_id=>0
,p_short_name=>'Combustible'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87743502324601664)
,p_theme_id=>24
,p_name=>'Login'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87743622828601746)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87743710089601746)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87743827899601746)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87743907235601748)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744023460601748)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744125758601748)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744202663601754)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744327037601754)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744430831601760)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744501693601760)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744623944601760)
,p_theme_id=>24
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744726620601760)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744830407601760)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87744905024601762)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87745021638601764)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(87745111376601775)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89677307849905831)
,p_theme_id=>25
,p_name=>'Login'
,p_internal_name=>'LOGIN'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89677632570905857)
,p_page_template_id=>wwv_flow_api.id(89677307849905831)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89677912182905875)
,p_theme_id=>25
,p_name=>'No Tabs - Left Sidebar'
,p_internal_name=>'NO_TABS_LEFT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89678319972905875)
,p_page_template_id=>wwv_flow_api.id(89677912182905875)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89678727133905876)
,p_page_template_id=>wwv_flow_api.id(89677912182905875)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89679129351905876)
,p_page_template_id=>wwv_flow_api.id(89677912182905875)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89679514543905876)
,p_page_template_id=>wwv_flow_api.id(89677912182905875)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89679931322905876)
,p_page_template_id=>wwv_flow_api.id(89677912182905875)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89680228527905885)
,p_theme_id=>25
,p_name=>'No Tabs - Left and Right Sidebar'
,p_internal_name=>'NO_TABS_LEFT_AND_RIGHT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89680631403905885)
,p_page_template_id=>wwv_flow_api.id(89680228527905885)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89681006854905887)
,p_page_template_id=>wwv_flow_api.id(89680228527905885)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89681400256905887)
,p_page_template_id=>wwv_flow_api.id(89680228527905885)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89681824588905887)
,p_page_template_id=>wwv_flow_api.id(89680228527905885)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89682207881905887)
,p_page_template_id=>wwv_flow_api.id(89680228527905885)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89682605696905887)
,p_page_template_id=>wwv_flow_api.id(89680228527905885)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89682920180905893)
,p_theme_id=>25
,p_name=>'No Tabs - No Sidebar'
,p_internal_name=>'NO_TABS_NO_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89683317044905896)
,p_page_template_id=>wwv_flow_api.id(89682920180905893)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89683603765905898)
,p_page_template_id=>wwv_flow_api.id(89682920180905893)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89684024839905901)
,p_page_template_id=>wwv_flow_api.id(89682920180905893)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89684404084905909)
,p_page_template_id=>wwv_flow_api.id(89682920180905893)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89684701633905909)
,p_theme_id=>25
,p_name=>'No Tabs - Right Sidebar'
,p_internal_name=>'NO_TABS_RIGHT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89685123948905912)
,p_page_template_id=>wwv_flow_api.id(89684701633905909)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89685516378905912)
,p_page_template_id=>wwv_flow_api.id(89684701633905909)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89685917534905912)
,p_page_template_id=>wwv_flow_api.id(89684701633905909)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89686301983905912)
,p_page_template_id=>wwv_flow_api.id(89684701633905909)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89686710217905914)
,p_page_template_id=>wwv_flow_api.id(89684701633905909)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
/
prompt --application/shared_components/user_interface/templates/page/one_level_tabs_content_frame_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89687022575905914)
,p_theme_id=>25
,p_name=>'One Level Tabs - Content Frame'
,p_internal_name=>'ONE_LEVEL_TABS_CONTENT_FRAME'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89687400075905915)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89687828959905915)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89688206735905917)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89688609585905917)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89689018432905917)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89689431902905917)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89689832655905917)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89690210866905918)
,p_page_template_id=>wwv_flow_api.id(89687022575905914)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89690512856905923)
,p_theme_id=>25
,p_name=>'One Level Tabs - Left Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_LEFT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89690925623905923)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89691327965905925)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89691722078905925)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89692118297905925)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89692530438905925)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89692905153905926)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89693324247905926)
,p_page_template_id=>wwv_flow_api.id(89690512856905923)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89693604605905926)
,p_theme_id=>25
,p_name=>'One Level Tabs - Left and Right Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_LEFT_AND_RIGHT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89694026249905928)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89694416200905929)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89694832645905929)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89695228049905929)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89695603293905929)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89696009554905931)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89696429684905931)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89696816568905932)
,p_page_template_id=>wwv_flow_api.id(89693604605905926)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89697114425905932)
,p_theme_id=>25
,p_name=>'One Level Tabs - No Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_NO_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89697509940905934)
,p_page_template_id=>wwv_flow_api.id(89697114425905932)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89697909607905935)
,p_page_template_id=>wwv_flow_api.id(89697114425905932)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89698323395905935)
,p_page_template_id=>wwv_flow_api.id(89697114425905932)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89698712097905935)
,p_page_template_id=>wwv_flow_api.id(89697114425905932)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89699132594905935)
,p_page_template_id=>wwv_flow_api.id(89697114425905932)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89699525802905935)
,p_page_template_id=>wwv_flow_api.id(89697114425905932)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89699828893905937)
,p_theme_id=>25
,p_name=>'One Level Tabs - Right Sidebar'
,p_internal_name=>'ONE_LEVEL_TABS_RIGHT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89700223696905937)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89700606633905939)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89701018040905939)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89701401335905939)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89701830858905940)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89702209085905940)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89702603641905940)
,p_page_template_id=>wwv_flow_api.id(89699828893905937)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
/
prompt --application/shared_components/user_interface/templates/page/one_level_tabs_wizard_page_002
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89702914714905940)
,p_theme_id=>25
,p_name=>'One Level Tabs - Wizard Page'
,p_internal_name=>'ONE_LEVEL_TABS_WIZARD_PAGE'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89703305762905942)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89703705087905942)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89704105421905942)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89704504040905942)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89704928246905942)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89705301687905942)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89705703441905943)
,p_page_template_id=>wwv_flow_api.id(89702914714905940)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89706011791905943)
,p_theme_id=>25
,p_name=>'Popup'
,p_internal_name=>'POPUP'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89706414902905945)
,p_page_template_id=>wwv_flow_api.id(89706011791905943)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89706710254905945)
,p_theme_id=>25
,p_name=>'Printer Friendly'
,p_internal_name=>'PRINTER_FRIENDLY'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89707128032905946)
,p_page_template_id=>wwv_flow_api.id(89706710254905945)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89707522680905948)
,p_page_template_id=>wwv_flow_api.id(89706710254905945)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89707916557905948)
,p_page_template_id=>wwv_flow_api.id(89706710254905945)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89708301055905948)
,p_page_template_id=>wwv_flow_api.id(89706710254905945)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89708607195905953)
,p_theme_id=>25
,p_name=>'Two Level Tabs - Left Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_LEFT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89709003527905954)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89709425236905954)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89709813018905954)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89710229377905954)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89710620424905956)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89711007542905956)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89711411614905956)
,p_page_template_id=>wwv_flow_api.id(89708607195905953)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89711716847905964)
,p_theme_id=>25
,p_name=>'Two Level Tabs - Left and Right Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_LEFT_AND_RIGHT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89712114490905965)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89712507289905965)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89712930691905965)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89713323763905967)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89713719930905967)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89714116747905967)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89714511107905967)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89714914551905968)
,p_page_template_id=>wwv_flow_api.id(89711716847905964)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89715210292905968)
,p_theme_id=>25
,p_name=>'Two Level Tabs - No Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_NO_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89715623629905968)
,p_page_template_id=>wwv_flow_api.id(89715210292905968)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89716007358905968)
,p_page_template_id=>wwv_flow_api.id(89715210292905968)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89716417158905968)
,p_page_template_id=>wwv_flow_api.id(89715210292905968)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89716811859905970)
,p_page_template_id=>wwv_flow_api.id(89715210292905968)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89717219734905970)
,p_page_template_id=>wwv_flow_api.id(89715210292905968)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89717615335905970)
,p_page_template_id=>wwv_flow_api.id(89715210292905968)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(89717900289905970)
,p_theme_id=>25
,p_name=>'Two Level Tabs - Right Sidebar'
,p_internal_name=>'TWO_LEVEL_TABS_RIGHT_SIDEBAR'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89718314309905971)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89718719371905971)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89719129025905973)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89719500845905973)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89719923933905973)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89720313937905973)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(89720716391905973)
,p_page_template_id=>wwv_flow_api.id(89717900289905970)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(87752032223601935)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(87752120575601957)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(87752210366601957)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(87752331349601957)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(87752415104601957)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(87752524018601957)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(89736131012906053)
,p_template_name=>'Button'
,p_internal_name=>'BUTTON'
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(89736319038906059)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(89736500640906059)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(89736706561906059)
,p_template_name=>'Large Button'
,p_internal_name=>'LARGE_BUTTON'
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(89736921888906059)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(89737104272906059)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745219001601785)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745300048601839)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745417424601839)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745515239601839)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745603934601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745718965601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745825145601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87745900222601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746029656601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746118304601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746204754601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746306376601840)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746409615601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746530332601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746616265601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'    #BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746722782601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746809517601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87746922674601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747015617601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747116808601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747206104601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747309916601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747428723601848)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747518218601851)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747629743601851)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747727020601851)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747814533601851)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87747907250601857)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87748009863601857)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87748116797601859)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87748222313601859)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87748327521601859)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87748402151601860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87748527706601860)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89721009778905978)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
/
prompt --application/shared_components/user_interface/templates/region/alert_region_002
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89721306327906007)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion uAlertRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89721529873906009)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uBorderlessRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89721831764906009)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89722111966906009)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89722404474906009)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
/
prompt --application/shared_components/user_interface/templates/region/content_frame_body_container_002
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89722701854906010)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89723021063906010)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#"> ',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89723302549906010)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(89723700768906010)
,p_plug_template_id=>wwv_flow_api.id(89723302549906010)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89724024385906014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89724316218906014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89724622146906014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
/
prompt --application/shared_components/user_interface/templates/region/modal_region_002
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89724926543906014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(89725304806906014)
,p_plug_template_id=>wwv_flow_api.id(89724926543906014)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89725623480906015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uNoHeading #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionContent clearfix">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89725913190906015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89726222198906015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(89726630288906015)
,p_plug_template_id=>wwv_flow_api.id(89726222198906015)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(89727014233906017)
,p_plug_template_id=>wwv_flow_api.id(89726222198906015)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89727317444906017)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uRegionNoPadding #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89727619451906017)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="cWizardButtons cWizardButtonsLeft">',
'#PREVIOUS##CLOSE#',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87749722495601895)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87749819644601907)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87749907421601907)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750011142601907)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750112564601907)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750230040601907)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750306156601907)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750417674601907)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750517094601909)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750600191601910)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750726803601910)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750818660601910)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87750928298601910)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87751022529601910)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87751100175601918)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87751226499601918)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(87751323132601918)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89731230558906034)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89731529367906039)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
'  <a href="#LINK#">',
'    <h3>#TEXT#</h3>',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89731816343906040)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89732114709906040)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li> '
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li> '
,p_list_template_name=>'Horizontal Links List'
,p_internal_name=>'HORIZONTAL_LINKS_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89732425529906040)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="#LIST_STATUS#">',
'      <span>#TEXT#</span>',
'    </li>'))
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89732726779906040)
,p_list_template_current=>'<li><a href="#LINK#" class="active">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Page Level Tabs List'
,p_internal_name=>'PAGE_LEVEL_TABS_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89733006242906042)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Tabbed Navigation List'
,p_internal_name=>'TABBED_NAVIGATION_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89733330093906042)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
/
prompt --application/shared_components/user_interface/templates/list/vertical_list_with_subtext_and_icon_002
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89733601580906042)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
'      <img src="#IMAGE_PREFIX#f_spacer.gif" class="#A02#" alt="#LIST_LABEL#"/>',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89733930690906042)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Ordered List'
,p_internal_name=>'VERTICAL_ORDERED_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89734229515906042)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Sidebar List'
,p_internal_name=>'VERTICAL_SIDEBAR_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89734509117906043)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List with Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITH_BULLETS'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89734826833906043)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List without Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITHOUT_BULLETS'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(89735117607906043)
,p_list_template_current=>'<li class="#LIST_STATUS#"><img src="#IMAGE_PREFIX#f_spacer.gif" alt="" /><span>#TEXT#</span></li>'
,p_list_template_noncurrent=>'<li class="#LIST_STATUS#"><img src="#IMAGE_PREFIX#f_spacer.gif" alt="" /><span>#TEXT#</span></li>'
,p_list_template_name=>'Wizard Progress List - Vertical'
,p_internal_name=>'WIZARD_PROGRESS_LIST_VERTICAL'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87748619511601868)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87748710744601881)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87748818242601881)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87748920558601881)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749028174601881)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749129030601881)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749205747601884)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749308076601885)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749411815601885)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749502990601885)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(87749618558601885)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89727904476906023)
,p_row_template_name=>'Borderless Report'
,p_internal_name=>'BORDERLESS_REPORT'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89728210836906028)
,p_row_template_name=>'Comment Bubbles'
,p_internal_name=>'COMMENT_BUBBLES'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li class="#1#">',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89728512911906029)
,p_row_template_name=>'Fixed Headers'
,p_internal_name=>'FIXED_HEADERS'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" #COLUMN_WIDTH#>#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89728802772906029)
,p_row_template_name=>'Horizontal Border'
,p_internal_name=>'HORIZONTAL_BORDER'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89729125982906029)
,p_row_template_name=>'One Column Unordered List'
,p_internal_name=>'ONE_COLUMN_UNORDERED_LIST'
,p_row_template1=>'<li>#COLUMN_VALUE#</li>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89729411137906029)
,p_row_template_name=>'Search Results Report (SELECT link_text, link_target, detail1, detail2, last_modified)'
,p_internal_name=>'SEARCH_RESULTS_REPORT_SELECT_LINK_TEXT,_LINK_TARGET,_DETAIL1,_DETAIL2,_LAST_MODIFIED'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89729728633906029)
,p_row_template_name=>'Standard'
,p_internal_name=>'STANDARD'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89730029423906031)
,p_row_template_name=>'Standard - Alternative'
,p_internal_name=>'STANDARD_ALTERNATIVE'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template3=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="uOddRow">#COLUMN_VALUE#</td>'
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89730308012906031)
,p_row_template_name=>'Two Column Portlet'
,p_internal_name=>'TWO_COLUMN_PORTLET'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89730632045906031)
,p_row_template_name=>'Value Attribute Pairs'
,p_internal_name=>'VALUE_ATTRIBUTE_PAIRS'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
/
prompt --application/shared_components/user_interface/templates/report/value_attribute_pairs_left_aligned_002
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(89730931221906032)
,p_row_template_name=>'Value Attribute Pairs - Left Aligned'
,p_internal_name=>'VALUE_ATTRIBUTE_PAIRS_LEFT_ALIGNED'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li>',
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(87751413529601918)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(87751512981601929)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(87751620328601929)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(87751701865601929)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(87751815179601931)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(87751901975601931)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89735406429906045)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89735500986906050)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89735627918906050)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89735714096906050)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89735812298906050)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89735911252906050)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(89736028225906050)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(87752604823601964)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(87752717735601981)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(89737326966906059)
,p_name=>'Breadcrumb Menu'
,p_internal_name=>'BREADCRUMB_MENU'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(87753111818602006)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(89737529266906076)
,p_popup_icon=>'#IMAGE_PREFIX#f_spacer.gif'
,p_popup_icon_attr=>'alt="#LIST_OF_VALUES#" title="#LIST_OF_VALUES#" class="uPopupLOVIcon"'
,p_page_name=>'winlov'
,p_page_title=>'Search Dialog'
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(87752823781601987)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(87752922639602003)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(87753030552602004)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(89737424745906068)
,p_cal_template_name=>'Calendar'
,p_internal_name=>'CALENDAR'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(87753211821602026)
,p_theme_id=>24
,p_theme_name=>'Cloudy'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(87744327037601754)
,p_error_template=>wwv_flow_api.id(87743827899601746)
,p_printer_friendly_template=>wwv_flow_api.id(87744726620601760)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(87743502324601664)
,p_default_button_template=>wwv_flow_api.id(87752032223601935)
,p_default_region_template=>wwv_flow_api.id(87747518218601851)
,p_default_chart_template=>wwv_flow_api.id(87745900222601840)
,p_default_form_template=>wwv_flow_api.id(87746204754601840)
,p_default_reportr_template=>wwv_flow_api.id(87747518218601851)
,p_default_tabform_template=>wwv_flow_api.id(87747518218601851)
,p_default_wizard_template=>wwv_flow_api.id(87748327521601859)
,p_default_menur_template=>wwv_flow_api.id(87745515239601839)
,p_default_listr_template=>wwv_flow_api.id(87745825145601840)
,p_default_irr_template=>wwv_flow_api.id(87746616265601848)
,p_default_report_template=>wwv_flow_api.id(87749205747601884)
,p_default_label_template=>wwv_flow_api.id(87751620328601929)
,p_default_menu_template=>wwv_flow_api.id(87752604823601964)
,p_default_calendar_template=>wwv_flow_api.id(87752823781601987)
,p_default_list_template=>wwv_flow_api.id(87751100175601918)
,p_default_option_label=>wwv_flow_api.id(87751701865601929)
,p_default_required_label=>wwv_flow_api.id(87751901975601931)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(89737729213906089)
,p_theme_id=>25
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(89697114425905932)
,p_error_template=>wwv_flow_api.id(89682920180905893)
,p_printer_friendly_template=>wwv_flow_api.id(89706710254905945)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(89677307849905831)
,p_default_button_template=>wwv_flow_api.id(89736131012906053)
,p_default_region_template=>wwv_flow_api.id(89726222198906015)
,p_default_chart_template=>wwv_flow_api.id(89726222198906015)
,p_default_form_template=>wwv_flow_api.id(89723302549906010)
,p_default_reportr_template=>wwv_flow_api.id(89726222198906015)
,p_default_tabform_template=>wwv_flow_api.id(89726222198906015)
,p_default_wizard_template=>wwv_flow_api.id(89723302549906010)
,p_default_menur_template=>wwv_flow_api.id(89721831764906009)
,p_default_listr_template=>wwv_flow_api.id(89726222198906015)
,p_default_irr_template=>wwv_flow_api.id(89724622146906014)
,p_default_report_template=>wwv_flow_api.id(89729728633906029)
,p_default_label_template=>wwv_flow_api.id(89735627918906050)
,p_default_menu_template=>wwv_flow_api.id(89737326966906059)
,p_default_calendar_template=>wwv_flow_api.id(89737424745906068)
,p_default_list_template=>wwv_flow_api.id(89734509117906043)
,p_default_option_label=>wwv_flow_api.id(89735627918906050)
,p_default_required_label=>wwv_flow_api.id(89735911252906050)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(87753532010602107)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(87753605041602114)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(87753326950602031)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(87753326950602031)
,p_tab_set=>'TS1'
,p_name=>'Combustible'
,p_alias=>'HOME'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20200508084640'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(87755219887602276)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(89721831764906009)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(87754732033602245)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(89737326966906059)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(87755401897622703)
,p_plug_name=>'TANCADA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(89723302549906010)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(89660707737697682)
,p_name=>'VALES'
,p_parent_plug_id=>wwv_flow_api.id(87755401897622703)
,p_template=>wwv_flow_api.id(89726222198906015)
...
'select nmvale,fecha, notaviaje, cantdespacha,cddelegacion,cdclasact||''-''||corract unidad from tvales ',
'where nmordenc=:p1_tancada  and operado=0  and origen=''INTERNO'''))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_TANCADA'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(89729728633906029)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(89661119825697739)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(89661200385697739)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(89661320604697739)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(89661427735697739)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(89661509991697739)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(89661614526697739)
,p_query_column_id=>6
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(90140012959546579)
,p_name=>'Galones'
,p_parent_plug_id=>wwv_flow_api.id(87755401897622703)
,p_template=>wwv_flow_api.id(89726222198906015)
...
,p_source_type=>'NATIVE_SQL_REPORT'
,p_query_type=>'SQL'
,p_source=>'select  sum(cantdespacha) from tvales where nmordenc=:P1_TANCADA and operado =0'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_TANCADA'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(89729728633906029)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(90140319521546618)
,p_query_column_id=>1
,p_column_alias=>'SUM(CANTDESPACHA)'
,p_column_display_sequence=>1
,p_column_heading=>'TOTAL GALONES'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(87756702814689184)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(87755401897622703)
,p_button_name=>'P1_ACTUALIZAR'
,p_button_static_id=>'P1_ACTUALIZAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(89736131012906053)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(87758503085783882)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(87755401897622703)
,p_button_name=>'P1_PROCESAR'
,p_button_static_id=>'P1_PROCESAR'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(87755732363640207)
,p_name=>'P1_TANCADA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(87755401897622703)
,p_prompt=>'Tancada'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  distinct(nmordenc) correlativo, nmordenc orden from tvales where operado=0',
'and origen=''INTERNO'' and',
...
,p_field_template=>wwv_flow_api.id(89735500986906050)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(87757323246695043)
,p_name=>'ACTUALIZAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(87756702814689184)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(87757616983695168)
,p_event_id=>wwv_flow_api.id(87757323246695043)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(89660707737697682)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(90139418604520848)
,p_event_id=>wwv_flow_api.id(87757323246695043)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(90140012959546579)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(89017424821204020)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'actualizar_vales '
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare num numeric :=0;',
'existe numeric;',
'nexval number(10);',
'num_paquete varchar(15);',
'cc varchar(25);',
'BODEGA VARCHAR(10);',
'LOCALIZACION VARCHAR(9);',
'',
'begin',
'   FOR i IN 1 .. apex_application.g_f01.COUNT',
'loop',
'--validamos si existe el paquete ',
'',
'select count(*) into existe from paquete_inventario@softland where descripcion=apex_application.g_f06(i);',
'--crea paquete si no existe unidad.',
'if existe=0  then',
'select numero_paquete.nextval into nexval from dual;',
'insert into paquete_inventario@SOFTLAND(paquete_inventario, descripcion, ultimo_usuario, usuario_creador, fecha_ult_acceso) ',
'values (nexval,apex_application.g_f06(i), ''SYSTEM'',''SYSTEM'',sysdate );',
'end if;',
'--guardamos numero de paquete ',
'select paquete_inventario into num_paquete from paquete_inventario@softland where descripcion=apex_application.g_f06(i);',
'--guardamos centro de costo',
'select centro_costo into cc from centro_costo@softland where descripcion=apex_application.g_f06(i);',
'--GUARAMOS BODEGA DEL USUARIO',
'SELECT DECODE  (( select cdestacion from PA_usuarios where lower(usuario) = lower(:APP_USER)), ''01'',''BDS'',''02'',''BDN'')  COD_BOD INTO   BODEGA FROM DUAL;',
'',
'--LOCALIZACION DEL PRODUCTO SEGUN USUARIO',
'SELECT DECODE  (( select cdestacion from PA_usuarios where lower(usuario) = lower(:APP_USER)), ''01'',''24.0'',''02'',''ND'')  LOCALI INTO   LOCALIZACION FROM DUAL;',
'',
'--crear docuemnto_inv encabezado de documento',
'insert into documento_inv@softland(paquete_inventario,documento_inv,consecutivo,fecha_hor_creacion,fecha_documento,seleccionado,usuario,referencia)',
' values(num_paquete,apex_application.g_f01(i),''VALCOMB'',sysdate,sysdate,''N'',''SYSTEM'','' '');',
'--CREA LINEA DE DOCUMENTO DE SALIDA',
'INSERT INTO LINEA_DOC_INV@SOFTLAND( PAQUETE_INVENTARIO,DOCUMENTO_INV, LINEA_DOC_INV, AJUSTE_CONFIG,NIT, ARTICULO, BODEGA, LOCALIZACION, TIPO, SUBTIPO, SUBSUBTIPO, CANTIDAD,CENTRO_COSTO,',
'CUENTA_CONTABLE,costo_total_local,costo_total_dolar,precio_total_local,precio_total_dolar) VALUES (NUM_PAQUETE,apex_application.g_f01(i),1,''~CC~'',''1000000000K'',''37DI001-1'',',
'BODEGA,LOCALIZACION,''C'',''D'',''N'',apex_application.g_f04(i),CC,''6.1.1.01.021'',0,0,0,0);',
'',
'--actualiza de operado y seleccionado',
'UPDATE DOCUMENTO_INV@SOFTLAND SET SELECCIONADO=''S'' ,  APROBADO=''S'',  USUARIO_APRO=''SYSTEM'', FECHA_HORA_APROB= SYSDATE WHERE PAQUETE_INVENTARIO=num_paquete',
'AND DOCUMENTO_INV=apex_application.g_f01(i);',
'',
'--actualizar operado ',
'update tvales set operado= 1 where nmvale=apex_application.g_f01(i);',
'num:=num+1;',
'end loop;',
'',
'',
...
,p_process_when_button_id=>wwv_flow_api.id(87758503085783882)
);
end;
/
...
,p_step_template=>wwv_flow_api.id(89677307849905831)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200320130410'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(87753902127602178)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(89723302549906010)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(87754208818602234)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(87753902127602178)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(87754019846602201)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(87753902127602178)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(87754109967602218)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(87754428467602245)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(87754300938602235)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(87754616206602245)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(87754532693602245)
,p_process_sequence=>10
