...
prompt APPLICATION 315 - J_OTECNOLOGIA
--
-- Application Export:
--   Application:     315
--   Name:            J_OTECNOLOGIA
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,315)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_OTECNOLOGIA')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_315')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'9B41C2FFC92F7D72A30B59620FF9059A96F908185A244F6CFF46EB6E27708DA0'
...
,p_authentication_id=>wwv_flow_api.id(16970818494479720)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:J_OTECNOLOGIA'
...
,p_last_upd_yyyymmddhh24miss=>'20210423085848'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8752266394055064)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8752316878055064)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8752432374055064)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8752692662055064)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8752744344055064)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8752819556055064)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16550007021044521)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(16969731218473812)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(16568012939044657)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(16569520482044682)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'Ingreso'
,p_tab_text=>'Ingreso'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(16590322620422990)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'T_CIERRETEC'
,p_tab_text=>'Cierre Tec'
,p_tab_step=>2
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(16569230767044678)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(16569613781044684)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16550115869044526)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16550211780044542)
,p_page_template_id=>wwv_flow_api.id(16550115869044526)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16550307526044548)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16550414715044548)
,p_page_template_id=>wwv_flow_api.id(16550307526044548)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16550512059044548)
,p_page_template_id=>wwv_flow_api.id(16550307526044548)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16550605774044548)
,p_page_template_id=>wwv_flow_api.id(16550307526044548)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16550710118044548)
,p_page_template_id=>wwv_flow_api.id(16550307526044548)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16550826923044548)
,p_page_template_id=>wwv_flow_api.id(16550307526044548)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16550924559044548)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551013777044548)
,p_page_template_id=>wwv_flow_api.id(16550924559044548)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551111062044548)
,p_page_template_id=>wwv_flow_api.id(16550924559044548)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551206370044548)
,p_page_template_id=>wwv_flow_api.id(16550924559044548)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551315404044548)
,p_page_template_id=>wwv_flow_api.id(16550924559044548)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551401984044548)
,p_page_template_id=>wwv_flow_api.id(16550924559044548)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551513273044548)
,p_page_template_id=>wwv_flow_api.id(16550924559044548)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16551603073044548)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551709022044548)
,p_page_template_id=>wwv_flow_api.id(16551603073044548)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551828459044548)
,p_page_template_id=>wwv_flow_api.id(16551603073044548)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16551906018044548)
,p_page_template_id=>wwv_flow_api.id(16551603073044548)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552025009044548)
,p_page_template_id=>wwv_flow_api.id(16551603073044548)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16552130854044550)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552223080044550)
,p_page_template_id=>wwv_flow_api.id(16552130854044550)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552326959044550)
,p_page_template_id=>wwv_flow_api.id(16552130854044550)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552418928044550)
,p_page_template_id=>wwv_flow_api.id(16552130854044550)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552518133044550)
,p_page_template_id=>wwv_flow_api.id(16552130854044550)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552625279044550)
,p_page_template_id=>wwv_flow_api.id(16552130854044550)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16552709478044551)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552805337044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16552904907044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553014293044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553120463044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553202104044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553315025044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553423131044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553502801044551)
,p_page_template_id=>wwv_flow_api.id(16552709478044551)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16553610062044551)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553730708044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553831415044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16553920976044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554022753044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554127492044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554200626044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554325702044551)
,p_page_template_id=>wwv_flow_api.id(16553610062044551)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16554406024044551)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554517164044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554605668044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554704928044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554806197044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16554923956044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555007069044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555128667044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555204867044551)
,p_page_template_id=>wwv_flow_api.id(16554406024044551)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16555301140044551)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555404181044553)
,p_page_template_id=>wwv_flow_api.id(16555301140044551)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555506399044553)
,p_page_template_id=>wwv_flow_api.id(16555301140044551)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555606722044553)
,p_page_template_id=>wwv_flow_api.id(16555301140044551)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555706522044553)
,p_page_template_id=>wwv_flow_api.id(16555301140044551)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555815382044553)
,p_page_template_id=>wwv_flow_api.id(16555301140044551)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16555907995044553)
,p_page_template_id=>wwv_flow_api.id(16555301140044551)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16556011200044553)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556121375044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556203048044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556316643044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556426714044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556526213044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556608509044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556730246044553)
,p_page_template_id=>wwv_flow_api.id(16556011200044553)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16556807620044553)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16556912885044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557024926044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557102387044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557203733044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557322071044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557404373044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557515022044553)
,p_page_template_id=>wwv_flow_api.id(16556807620044553)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16557609366044553)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557716754044553)
,p_page_template_id=>wwv_flow_api.id(16557609366044553)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16557818588044553)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16557910158044554)
,p_page_template_id=>wwv_flow_api.id(16557818588044553)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558031052044554)
,p_page_template_id=>wwv_flow_api.id(16557818588044553)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558108422044554)
,p_page_template_id=>wwv_flow_api.id(16557818588044553)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558219398044554)
,p_page_template_id=>wwv_flow_api.id(16557818588044553)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16558329754044554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558424771044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558517190044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558604716044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558728932044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558825245044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16558920474044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559003354044554)
,p_page_template_id=>wwv_flow_api.id(16558329754044554)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16559115141044554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559219804044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559328437044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559429179044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559504346044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559620460044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559714867044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559807682044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16559922590044554)
,p_page_template_id=>wwv_flow_api.id(16559115141044554)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16560017780044554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560105558044556)
,p_page_template_id=>wwv_flow_api.id(16560017780044554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560222106044556)
,p_page_template_id=>wwv_flow_api.id(16560017780044554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560304456044556)
,p_page_template_id=>wwv_flow_api.id(16560017780044554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560408030044556)
,p_page_template_id=>wwv_flow_api.id(16560017780044554)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560520066044556)
,p_page_template_id=>wwv_flow_api.id(16560017780044554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560630225044556)
,p_page_template_id=>wwv_flow_api.id(16560017780044554)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(16560713383044556)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560806565044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16560905078044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16561021504044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16561112764044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16561209566044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16561312333044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(16561427901044556)
,p_page_template_id=>wwv_flow_api.id(16560713383044556)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(16566900667044606)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(16567018547044614)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(16567128233044615)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(16567213860044615)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(16567319063044615)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(16567415596044615)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16561506008044557)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16561613706044570)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16561705652044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16561807749044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16561903862044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562023066044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562108781044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562231779044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562314587044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(16562421828044571)
,p_plug_template_id=>wwv_flow_api.id(16562314587044571)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562511365044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562604326044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562706796044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16562805893044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(16562917073044571)
,p_plug_template_id=>wwv_flow_api.id(16562805893044571)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16563004098044571)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16563107791044573)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16563219191044573)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(16563311663044573)
,p_plug_template_id=>wwv_flow_api.id(16563219191044573)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(16563418821044573)
,p_plug_template_id=>wwv_flow_api.id(16563219191044573)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16563525062044573)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16563625685044573)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16564832751044587)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16564912982044598)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565021943044598)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565117646044598)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565231697044598)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565323659044598)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565421386044598)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565519701044598)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565608976044598)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565709702044598)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565829569044598)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16565927762044598)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16566022974044598)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(16566108505044598)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16563705595044575)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16563827069044581)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16563919304044581)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564021580044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564127312044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564220776044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564309857044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564422148044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564525184044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564604252044582)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(16564716620044582)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566223190044598)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566310740044604)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566424293044604)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566522872044604)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566603766044604)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566709861044604)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(16566831378044604)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(16567511861044615)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(16567708825044631)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(16567602774044625)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(16567827642044640)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(16555301140044551)
,p_error_template=>wwv_flow_api.id(16551603073044548)
,p_printer_friendly_template=>wwv_flow_api.id(16557818588044553)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(16550115869044526)
,p_default_button_template=>wwv_flow_api.id(16566900667044606)
,p_default_region_template=>wwv_flow_api.id(16563219191044573)
,p_default_chart_template=>wwv_flow_api.id(16563219191044573)
,p_default_form_template=>wwv_flow_api.id(16562314587044571)
,p_default_reportr_template=>wwv_flow_api.id(16563219191044573)
,p_default_tabform_template=>wwv_flow_api.id(16563219191044573)
,p_default_wizard_template=>wwv_flow_api.id(16562314587044571)
,p_default_menur_template=>wwv_flow_api.id(16561807749044571)
,p_default_listr_template=>wwv_flow_api.id(16563219191044573)
,p_default_irr_template=>wwv_flow_api.id(16562706796044571)
,p_default_report_template=>wwv_flow_api.id(16564309857044582)
,p_default_label_template=>wwv_flow_api.id(16566424293044604)
,p_default_menu_template=>wwv_flow_api.id(16567511861044615)
,p_default_calendar_template=>wwv_flow_api.id(16567602774044625)
,p_default_list_template=>wwv_flow_api.id(16565927762044598)
,p_default_option_label=>wwv_flow_api.id(16566424293044604)
,p_default_required_label=>wwv_flow_api.id(16566709861044604)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(16568108836044662)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(16970818494479720)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(16567919406044642)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(16567919406044642)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16570121130056271)
,p_plug_name=>'ORDEN TECNOLOGIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(16563219191044573)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16580129283189656)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(16570121130056271)
,p_button_name=>'CREAR_OT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(16566900667044606)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16570513361056273)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(16570705927056278)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16570923406056281)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16570121130056271)
...
,p_field_template=>wwv_flow_api.id(16566424293044604)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16571105223056282)
,p_name=>'P1_NUM_OT'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(16570121130056271)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(16566709861044604)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16571327982056282)
...
,p_lov=>'select DEPARTAMENTO||'' ''||DESCRIPCION,DEPARTAMENTO from PIPASGT.DEPARTAMENTO '
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(16566424293044604)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16571512948056282)
,p_name=>'P1_REPORTA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(16570121130056271)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'select empleado||'' ''||nombre_pila||'' ''||primer_apellido||'' ''||segundo_apellido as nombre,empleado from pipasgt.empleado'
,p_cSize=>32
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(16566424293044604)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16571721337056284)
,p_name=>'P1_PROBLEMA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(16570121130056271)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16571924932056284)
,p_name=>'P1_FECPROBLE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(16570121130056271)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Fecha inicio problema'
,p_source=>'FECPROBLE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16572110848056284)
,p_name=>'P1_FECINGRESOSITEMA'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(16570121130056271)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Fecingresositema'
,p_source=>'FECINGRESOSITEMA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16573128856056289)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from J_OTECNOLOGIA'
,p_attribute_02=>'J_OTECNOLOGIA'
,p_attribute_03=>'P1_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16581509291240635)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'InsertOT'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Declare',
'contador numeric;',
'',
'BEGIN',
'select max(num_ot)+1 into contador from j_otecnologia;',
'',
'insert into j_otecnologia values (contador,:P1_DEPARTAMENTO,:P1_REPORTA,:P1_PROBLEMA,:P1_FECPROBLE,sysdate(),''A'',null,null,null);',
'END;'))
,p_process_when_button_id=>wwv_flow_api.id(16580129283189656)
...
,p_last_upd_yyyymmddhh24miss=>'20180117095451'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16588600282415257)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(16562706796044571)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
...
'"FECPROBLE",',
'ESTATUS',
'from "#OWNER#"."J_OTECNOLOGIA" where estado = ''A''',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(16588827326415259)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_NUM_OT:#NUM_OT#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#edit_big.gif"  border="0">'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
,p_owner=>'JFAJARDO'
,p_internal_uid=>16588827326415259
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16588901022415276)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16589016273415282)
,p_db_column_name=>'NUM_OT'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Num Ot'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16589123464415284)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16589211631415284)
...
,p_tz_dependent=>'N'
,p_static_id=>'PROBLEMA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16589326316415285)
,p_db_column_name=>'FECPROBLE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Fecproble'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECPROBLE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16596718379865523)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(16589524463415410)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'165896'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:NUM_OT:DEPARTAMENTO:PROBLEMA:FECPROBLE:ESTATUS'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(16567919406044642)
,p_tab_set=>'TS1'
,p_name=>'Form on J_OTECNOLOGIA'
,p_step_title=>'Form on J_OTECNOLOGIA'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180117095948'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16585901708415223)
,p_plug_name=>'Form on J_OTECNOLOGIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(16562314587044571)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16586310326415223)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(16585901708415223)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(16566900667044606)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16590928366473282)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(16585901708415223)
,p_button_name=>'CIERRE_OT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(16566900667044606)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Cierre OT'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_css_classes=>'PLUS'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(16586521753415226)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16586721369415229)
,p_name=>'P3_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16585901708415223)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16586907527415232)
,p_name=>'P3_NUM_OT'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(16585901708415223)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16587129788415234)
,p_name=>'P3_COMENT_CIERRE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(16585901708415223)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Coment Cierre'
,p_source=>'COMENT_CIERRE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16591121355490146)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Cierre OT'
,p_process_sql_clob=>'UPDATE J_OTECNOLOGIA SET ESTADO = ''C'', COMENT_CIERRE = :P3_COMENT_CIERRE,FECHAFINPRO=SYSDATE() WHERE NUM_OT = :P3_NUM_OT;'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(16590928366473282)
);
end;
/
...
,p_step_template=>wwv_flow_api.id(16550115869044526)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180116174442'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16568401754044668)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(16562314587044571)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16568708012044678)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(16568401754044668)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16568524139044673)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16568401754044668)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16568600421044678)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16568918961044678)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16568806746044678)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16569118787044678)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16569002212044678)
,p_process_sequence=>10
