...
prompt APPLICATION 287 - LP_ASIGNA
--
-- Application Export:
--   Application:     287
--   Name:            LP_ASIGNA
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_ASIGNA')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'LP_ASIGNA')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'69BEE66C5AEEC8106DF1A96606AE915007BB00812DFBF6FC9596C4ED786711A6'
...
,p_authentication_id=>wwv_flow_api.id(10019921241815970)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20220419160305'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(7436127763759193)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8714867389046278)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8714933230046278)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8715021944046278)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8715267854046278)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8715380440046278)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8715453335046278)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(10017928660706128)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(7454118104759254)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(7455612684759264)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_TORDENSERV'
,p_tab_text=>'ASIGNACION'
,p_tab_step=>1
,p_tab_also_current_for_pages=>'5,4'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(7474809757066859)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
,p_tab_name=>'CERRAR'
,p_tab_text=>'CERRAR'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(14643420939815359)
,p_tab_set=>'TS1'
,p_tab_sequence=>40
,p_tab_name=>'T_ANULAOT'
,p_tab_text=>'ANULA OT'
,p_tab_step=>10
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(7455307304759262)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(7459227247759303)
,p_parent_id=>0
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(7465400443915110)
,p_short_name=>'ASIGNAR'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7436209761759198)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7436323378759200)
,p_page_template_id=>wwv_flow_api.id(7436209761759198)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7436401658759201)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7436527606759201)
,p_page_template_id=>wwv_flow_api.id(7436401658759201)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7436628506759201)
,p_page_template_id=>wwv_flow_api.id(7436401658759201)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7436730241759201)
,p_page_template_id=>wwv_flow_api.id(7436401658759201)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7436829471759201)
,p_page_template_id=>wwv_flow_api.id(7436401658759201)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7436928492759201)
,p_page_template_id=>wwv_flow_api.id(7436401658759201)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7437030008759201)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437132462759201)
,p_page_template_id=>wwv_flow_api.id(7437030008759201)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437211534759201)
,p_page_template_id=>wwv_flow_api.id(7437030008759201)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437305156759201)
,p_page_template_id=>wwv_flow_api.id(7437030008759201)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437423008759201)
,p_page_template_id=>wwv_flow_api.id(7437030008759201)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437532252759201)
,p_page_template_id=>wwv_flow_api.id(7437030008759201)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437616079759201)
,p_page_template_id=>wwv_flow_api.id(7437030008759201)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7437724972759201)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437819611759203)
,p_page_template_id=>wwv_flow_api.id(7437724972759201)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7437909188759203)
,p_page_template_id=>wwv_flow_api.id(7437724972759201)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438031416759203)
,p_page_template_id=>wwv_flow_api.id(7437724972759201)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438112370759203)
,p_page_template_id=>wwv_flow_api.id(7437724972759201)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7438219392759203)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438322069759203)
,p_page_template_id=>wwv_flow_api.id(7438219392759203)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438424954759203)
,p_page_template_id=>wwv_flow_api.id(7438219392759203)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438503546759203)
,p_page_template_id=>wwv_flow_api.id(7438219392759203)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438627361759203)
,p_page_template_id=>wwv_flow_api.id(7438219392759203)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438707979759203)
,p_page_template_id=>wwv_flow_api.id(7438219392759203)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7438810994759203)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7438913919759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439026933759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439114830759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439223855759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439300622759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439409286759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439514381759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439607615759203)
,p_page_template_id=>wwv_flow_api.id(7438810994759203)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7439725504759203)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439813019759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7439931995759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440010559759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440119607759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440213352759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440302281759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440407458759203)
,p_page_template_id=>wwv_flow_api.id(7439725504759203)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7440508251759203)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440607989759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440721349759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440832705759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7440901078759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441007820759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441111603759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441212964759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441312974759204)
,p_page_template_id=>wwv_flow_api.id(7440508251759203)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7441417446759204)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441526858759204)
,p_page_template_id=>wwv_flow_api.id(7441417446759204)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441615119759204)
,p_page_template_id=>wwv_flow_api.id(7441417446759204)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441710050759204)
,p_page_template_id=>wwv_flow_api.id(7441417446759204)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441808600759204)
,p_page_template_id=>wwv_flow_api.id(7441417446759204)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7441917104759204)
,p_page_template_id=>wwv_flow_api.id(7441417446759204)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442003281759204)
,p_page_template_id=>wwv_flow_api.id(7441417446759204)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7442117223759204)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442204218759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442318553759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442417224759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442517732759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442614104759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442714269759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7442829881759206)
,p_page_template_id=>wwv_flow_api.id(7442117223759204)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7442912203759206)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443005468759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443105048759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443203023759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443331450759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443409723759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443527367759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443621361759206)
,p_page_template_id=>wwv_flow_api.id(7442912203759206)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7443711858759206)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7443824543759206)
,p_page_template_id=>wwv_flow_api.id(7443711858759206)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7443902688759206)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444008392759206)
,p_page_template_id=>wwv_flow_api.id(7443902688759206)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444115671759206)
,p_page_template_id=>wwv_flow_api.id(7443902688759206)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444209173759206)
,p_page_template_id=>wwv_flow_api.id(7443902688759206)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444306930759206)
,p_page_template_id=>wwv_flow_api.id(7443902688759206)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7444418321759206)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444516904759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444625208759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444725181759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444817568759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7444930111759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445001629759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445109844759206)
,p_page_template_id=>wwv_flow_api.id(7444418321759206)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7445219125759206)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445332107759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445428288759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445528177759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445607556759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445727885759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445801263759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7445906713759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446026367759206)
,p_page_template_id=>wwv_flow_api.id(7445219125759206)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7446105745759206)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446215797759206)
,p_page_template_id=>wwv_flow_api.id(7446105745759206)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446305393759206)
,p_page_template_id=>wwv_flow_api.id(7446105745759206)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446429414759206)
,p_page_template_id=>wwv_flow_api.id(7446105745759206)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446501807759206)
,p_page_template_id=>wwv_flow_api.id(7446105745759206)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446602569759206)
,p_page_template_id=>wwv_flow_api.id(7446105745759206)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446704607759206)
,p_page_template_id=>wwv_flow_api.id(7446105745759206)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(7446831890759206)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7446918913759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7447003000759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7447106916759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7447231485759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7447320102759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7447405328759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(7447526457759207)
,p_page_template_id=>wwv_flow_api.id(7446831890759206)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7453023095759240)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7453110333759243)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7453228075759243)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7453331558759243)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7453422612759243)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(7453511048759243)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7447605910759215)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7447703799759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7447816270759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7447914152759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448014404759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448120457759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448210890759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448312622759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448421304759217)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7448506723759217)
,p_plug_template_id=>wwv_flow_api.id(7448421304759217)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448609505759220)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448731855759220)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448826360759220)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7448917761759223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7449022563759223)
,p_plug_template_id=>wwv_flow_api.id(7448917761759223)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7449105081759223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7449221545759223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7449312905759223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7449414014759223)
,p_plug_template_id=>wwv_flow_api.id(7449312905759223)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7449504028759223)
,p_plug_template_id=>wwv_flow_api.id(7449312905759223)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7449631389759223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7449704652759223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7450907573759235)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451022592759239)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451104195759239)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451205140759239)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451308471759239)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451417270759239)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451516022759239)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451606386759239)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451709031759239)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451814900759239)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7451931050759239)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7452024255759239)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7452111927759239)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(7452207949759239)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7449817323759232)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7449924425759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450018717759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450121088759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450230359759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450312457759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450411128759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450503612759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450619924759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450700096759234)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(7450800716759234)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452319669759239)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452408145759239)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452529194759240)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452628496759240)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452718035759240)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452800779759240)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(7452920778759240)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(7453604944759243)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(7453820281759251)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(7453726097759248)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(7453918528759254)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(7441417446759204)
,p_error_template=>wwv_flow_api.id(7437724972759201)
,p_printer_friendly_template=>wwv_flow_api.id(7443902688759206)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(7436209761759198)
,p_default_button_template=>wwv_flow_api.id(7453023095759240)
,p_default_region_template=>wwv_flow_api.id(7449312905759223)
,p_default_chart_template=>wwv_flow_api.id(7449312905759223)
,p_default_form_template=>wwv_flow_api.id(7448421304759217)
,p_default_reportr_template=>wwv_flow_api.id(7449312905759223)
,p_default_tabform_template=>wwv_flow_api.id(7449312905759223)
,p_default_wizard_template=>wwv_flow_api.id(7448421304759217)
,p_default_menur_template=>wwv_flow_api.id(7447914152759217)
,p_default_listr_template=>wwv_flow_api.id(7449312905759223)
,p_default_irr_template=>wwv_flow_api.id(7448826360759220)
,p_default_report_template=>wwv_flow_api.id(7450411128759234)
,p_default_label_template=>wwv_flow_api.id(7452529194759240)
,p_default_menu_template=>wwv_flow_api.id(7453604944759243)
,p_default_calendar_template=>wwv_flow_api.id(7453726097759248)
,p_default_list_template=>wwv_flow_api.id(7452024255759239)
,p_default_option_label=>wwv_flow_api.id(7452529194759240)
,p_default_required_label=>wwv_flow_api.id(7452800779759240)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(96486506123624450)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(7454203431759256)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10019921241815970)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(7454028746759254)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(7454028746759254)
,p_tab_set=>'TS1'
,p_name=>'Tordenserv'
,p_alias=>'HOME'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210324145411'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7455706093759265)
,p_plug_name=>'TORDENSERV'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448826360759220)
...
' from   "TORDENSERV"',
'   where estado=''A''  and',
'    CDDELEGACION =( select cdestacion from PA_usuarios where lower(usuario) = lower(:APP_USER))  ',
'    and  taller in ( select id_taller from  t_usuarios_taller where lower(usuario) = lower(:APP_USER))  '))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(7455814913759265)
,p_name=>'TORDENSERV'
...
,p_owner=>'LP'
,p_internal_uid=>7455814913759265
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7455912270759267)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456012361759268)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456230983759270)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456313844759271)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456408916759273)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456519469759273)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456619655759275)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456707736759276)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456822430759276)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7456921501759278)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457015703759279)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457105520759279)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457218729759281)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457314009759282)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457409177759282)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457530213759284)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457620630759285)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457714339759285)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457823787759287)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7457904433759287)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458014954759289)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458117329759290)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458202832759292)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458322872759293)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458410656759293)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458505933759295)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458630047759296)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458725027759296)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458829941759298)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7458914890759300)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7459020074759300)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7459130435759301)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7471714770654987)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10885023979461570)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63125706793473001)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(7459614595760646)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'74597'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMORDEN:CDCLASE:CORRELATIVO:DSREPARA:CDASIGNADO:FECHA_ASIGNADO:TALLER'
,p_sort_column_1=>'FECREA'
,p_sort_direction_1=>'DESC'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7459308872759303)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7447914152759217)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(7455307304759262)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(7453604944759243)
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7461722239915084)
,p_plug_name=>'ASIGNAR'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448421304759217)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7465222926915110)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7461903170915084)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(7461722239915084)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(7453023095759240)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7462131105915084)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(7462331547915084)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7462505598915089)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(7461722239915084)
...
,p_field_template=>wwv_flow_api.id(7452529194759240)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7462732267915096)
,p_name=>'P2_NMORDEN'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(7461722239915084)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(7452800779759240)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7462920814915096)
,p_name=>'P2_DSREPARA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(7461722239915084)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7463317511915098)
...
'select nombre, to_number (empleado) empleado from (',
'select  to_number (empleado)||'' ''|| nombre_pila ||'' ''|| primer_apellido||'' ''||segundo_apellido as nombre,empleado ,0 as taller from empleado@softland where Activo = ''S'' ',
' AND ubicacion IN ( select decode(cdestacion,''00'',''LPS'', ''01'',''LPS'', ''02'',''LPN'') from PA_usuarios where lower(usuario) = lower(:APP_USER))',
'union all',
'select empleado||'' ''|| nombre_pila ||'' ''|| primer_apellido||'' ''||segundo_apellido as nombre, empleado, 0 as taller  from empleado@softland where  nombre like''%TALLER%'' and  ubicacion in',
'( select decode(cdestacion,''00'',''LPS'', ''01'',''LPS'', ''02'',''LPN'') from PA_usuarios where lower(usuario) = lower(:APP_USER))  ',
'UNION ALL',
'select empleado||'' ''|| nombre_pila ||'' ''|| primer_apellido||'' ''||segundo_apellido as nombre, empleado, 0 as taller  from rhnys.empleado@softland where ubicacion in',
'( select decode(cdestacion,''00'',''OPSUR'', ''01'',''OPSUR'', ''02'',''OPNOR'') from PA_usuarios where lower(usuario) = lower(:APP_USER)) AND ACTIVO=''S''  ',
'UNION ALL',
'select empleado||'' ''|| nombre_pila ||'' ''|| primer_apellido||'' ''||segundo_apellido as nombre, empleado, 0 as taller  from rhnys.empleado@softland where ubicacion in',
'( select decode(cdestacion,''00'',''OPFI'', ''01'',''OPFI'') from PA_usuarios where lower(usuario) = lower(:APP_USER)) AND ACTIVO=''S''  ',
'union all',
'select empleado||'' ''|| nombre_pila ||'' ''|| primer_apellido||'' ''||segundo_apellido as nombre, empleado, 0 as taller  from rhnys.empleado@softland where ubicacion in',
'( select decode(cdestacion,''00'',''RHNYS'', ''01'',''RHNYS'', ''02'',''RHNYS'') from PA_usuarios where lower(usuario) = lower(:APP_USER)) AND ACTIVO=''S''  ',
'union all',
'select ''99999 EXTERNO'' nombre, ''99999'', 0  as taller from dual',
') ',
'order by empleado ;'))
,p_lov_cascade_parent_items=>'P2_TALLER'
,p_ajax_items_to_submit=>'P2_TALLER'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7463519695915098)
...
,p_source_type=>'DB_COLUMN'
,p_source_post_computation=>'to_char(sysdate,''dd/mm/yyyy hh24:mi'') '
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24108900930614982)
,p_name=>'P2_TALLER'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(7461722239915084)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7464621760915104)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7464805708915104)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7465015770915104)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210322154345'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10512613379217421)
,p_plug_name=>'Cierre de OT'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7449312905759223)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(14783413258084517)
,p_name=>'Repuestos'
,p_template=>wwv_flow_api.id(7449312905759223)
...
'select a.cod_sucursal , f.nom_agencia sucucursal,  G.DESCRIPCION bodega_salida, a.cod_obra, A.REFE, trunc(a.fecha_docto) fecha_mov, c.cod_prod, e.nombre,',
'c.cantidad',
'FROM INV_MOVM a, inv_detm c, productos e, agencias f, bodegas g, bodegas h, tordenserv i, tactivos j,  empleados b, empleados d',
'WHERE ',
'a.cod_doctoi   IN (16)',
'and f.nom_agencia=decode(i.cddelegacion,''01'',''10'',''02'',''20'')',
...
'and a.refe=:P3_NMORDEN',
'order by 1, 3, 5,7, 8, 9'))
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(7450411128759234)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14783703581084521)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14783830807084521)
,p_query_column_id=>2
,p_column_alias=>'SUCUCURSAL'
,p_column_display_sequence=>2
,p_column_heading=>'SUCUCURSAL'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14783929249084521)
,p_query_column_id=>3
,p_column_alias=>'BODEGA_SALIDA'
,p_column_display_sequence=>3
,p_column_heading=>'BODEGA_SALIDA'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14784032384084521)
,p_query_column_id=>4
,p_column_alias=>'COD_OBRA'
,p_column_display_sequence=>4
,p_column_heading=>'COD_OBRA'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14784102481084521)
,p_query_column_id=>5
,p_column_alias=>'REFE'
,p_column_display_sequence=>5
,p_column_heading=>'REFE'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14784209497084521)
,p_query_column_id=>6
,p_column_alias=>'FECHA_MOV'
,p_column_display_sequence=>6
,p_column_heading=>'FECHA_MOV'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14784309948084521)
,p_query_column_id=>7
,p_column_alias=>'COD_PROD'
,p_column_display_sequence=>7
,p_column_heading=>'COD_PROD'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14784400922084521)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14784522286084521)
,p_query_column_id=>9
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23445503869891603)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(10512613379217421)
,p_button_name=>'P3_X'
,p_button_static_id=>'P3_X'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(7453023095759240)
...
'select max(orden) from (',
'select max(1) orden from tordenserv a inner join tsupervision b on a.nmorden =b.ot inner join tcheklist_det c on b.nmsuper=b.nmsuper  where nmorden =111119519',
'union all ',
'select max(1) orden from  tordenserv where cod_falla not in (43,44,53,54,55) and nmorden in (111119519)',
')'))
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(10522921746336409)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(10512613379217421)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(10514500267242053)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(10512613379217421)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10512928974220023)
,p_name=>'P3_NMORDEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(10512613379217421)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10513223151222803)
,p_name=>'P3_ASIGNADO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(10512613379217421)
,p_prompt=>'Asignado'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10513411983222803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14790320697419801)
,p_name=>'P3_NOMBRE'
,p_item_sequence=>21
,p_item_plug_id=>wwv_flow_api.id(10512613379217421)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Nombre'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select nombre_pila || '' '' || primer_apellido',
'|| '' '' || segundo_apellido from pipasgt.empleado where to_number(empleado)=:P3_ASIGNADO'))
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(7452529194759240)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14791104726442379)
,p_name=>'P3_DESCRIPCION'
,p_item_sequence=>22
,p_item_plug_id=>wwv_flow_api.id(10512613379217421)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Descripcion'
,p_source=>'select dsrepara from tordenserv where nmorden =:P3_NMORDEN and cdasignado=:p3_asignado'
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(88343609385572728)
,p_name=>'deshabilitar'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(88343904005572771)
,p_event_id=>wwv_flow_api.id(88343609385572728)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DISABLE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(10514500267242053)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(88344000165579521)
,p_name=>'habilitar'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P3_COMENTARIO'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(88344319493579521)
,p_event_id=>wwv_flow_api.id(88344000165579521)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10514831088250942)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
'',
'update tordenserv set fecha_cierre=sysdate() , estado= ''C'', comentario_cierre =:P3_COMENTARIO ,CERRADO_POR=:APP_USER where nmorden=:P3_NMORDEN and cddelegacion=DELEGA AND TALLER NOT IN (18) ;',
'',
'select cod_falla into falla from tordenserv where nmorden = :P3_NMORDEN and cddelegacion=delega AND TALLER NOT IN (18);',
'',
'IF falla = 43  or falla = 44 or falla = 53 or falla = 54 or falla=55 THEN',
'Select cod_emp into empleado from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'select cdclase into clase from tordenserv where nmorden = :P3_NMORDEN  and cddelegacion=delega;',
'select cdasignado into asigna from tordenserv where nmorden = :P3_NMORDEN  and cddelegacion=delega;',
'select correlativo into corre from tordenserv where nmorden = :P3_NMORDEN  and cddelegacion=delega;',
'',
'select max(num_check)+1 into chek from tbl_encserv;',
'select  recorrido into recorrido from tactivos where cdclase = clase and correlativo = corre  and cddelegacion=delega;',
'select  nvl(max(nmvale),0) into vale from tvales where cdclasact = clase and corract = corre  and cddelegacion=delega;',
'select nvl(max(nmnota),0) into nota from tnotaviaje where cdclaseuni = clase and correlativouni = corre  and cddelegacion=delega;',
'',
'select kms_servicio into kmservicio from tactivos where cdclase = clase and correlativo = corre;',
'',
'INSERT INTO TBL_ENCSERV (cdempresa,num_check,fecha,cdclase,correl,recorrido,realiza,supervisa,kms_sig,ult_nota,ult_vale,serv_aplicado,cddelegacion,norden)',
'values',
'(''01'',chek,sysdate(),clase,corre,recorrido,asigna,empleado,recorrido+kmservicio,nota,vale,falla,delega,:P3_NMORDEN);',
'END IF;',
'',
'if falla = 44 then',
'update trecorre set kmproxserv=kmactual+kmservicio where ',
'cdclasac=clase and corract=corre;',
'end if;',
'',
'if falla = 43 then',
'update trecorre set kmproxserv=kmactual+kmservicio, kmsvmed=kmactual+(kmservicio*4) where ',
'cdclasac=clase and corract=corre;',
'end if;',
'if falla = 53 then',
'update trecorre set kmproxserv=kmactual+kmservicio, kmsvmed=kmactual+(kmservicio*4), kmsvma=kmactual+(kmservicio*16) where ',
'cdclasac=clase and corract=corre;',
'end If;',
'if falla = 54 then',
'update trecorre set kmproxserv=kmactual+kmservicio, kmsvmed=kmactual+(kmservicio*4), kmsvma=kmactual+(kmservicio*16), kmsvsma=kmactual+(kmservicio*32) where ',
'cdclasac=clase and corract=corre;',
'end if;',
'',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(10514500267242053)
,p_process_success_message=>'Nota Cerrada Exitosamente'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10521926286290437)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'redireccion'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'htp.init;',
'owa_util.redirect_url(''f?p=287:6:&APP_SESSION.'');',
'apex_application.stop_apex_engine;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'OT Cerrada con Exito'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20180112110312'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7474920141066860)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select rowid,nmorden,cdclase||''-''||correlativo unidad, dsrepara, cdasignado from tordenserv where estado= ''A'' and cdasignado is not null  and CDDELEGACION =( select decode(cdestacion,''00'',cddelegacion, cdestacion) from PA_usuarios where lower(usuario'
||') = lower(:APP_USER))  and  taller in ( select id_taller from  t_usuarios_taller where lower(usuario) = lower(:APP_USER)) ORDER BY FECHA_ASIGNADO DESC;'
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(7475011818066860)
,p_name=>'Report 1'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_show_calendar=>'N'
,p_download_formats=>'CSV:HTML:EMAIL'
,p_detail_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_NMORDEN,P3_ASIGNADO:#NMORDEN#,#CDASIGNADO#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="" />'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>7475011818066860
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7475201720066876)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Rowid'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7475312772066876)
,p_db_column_name=>'NMORDEN'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmorden'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7475417731066876)
,p_db_column_name=>'DSREPARA'
,p_display_order=>3
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(7475516564066876)
,p_db_column_name=>'CDASIGNADO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Cdasignado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10409508162301420)
,p_db_column_name=>'UNIDAD'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Unidad'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(7475616400067018)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'74757'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMORDEN:UNIDAD:DSREPARA:CDASIGNADO:'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180110154645'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14625615839469939)
,p_plug_name=>'Terminar OT'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448826360759220)
,p_plug_display_sequence=>10
...
,p_query_type=>'SQL'
,p_plug_source=>'select rowid,nmorden,cdclase||''-''||correlativo unidad, dsrepara, cdasignado from tordenserv where estado= ''A'' and cdasignado is not null  and CDDELEGACION =( select decode(cdestacion,''00'',cddelegacion, cdestacion) from PA_usuarios where lower(usuario'
||') = lower(:APP_USER))  and  taller in ( select id_taller from  t_usuarios_taller where lower(usuario) = lower(:APP_USER)) order by fecrea asc;'
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(14625828542469939)
,p_name=>'Terminar OT'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>14625828542469939
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14625909074469948)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14626013038469950)
,p_db_column_name=>'NMORDEN'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmorden'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14626123634469951)
,p_db_column_name=>'DSREPARA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Dsrepara'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14626201880469951)
,p_db_column_name=>'CDASIGNADO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Cdasignado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14628101801490014)
,p_db_column_name=>'UNIDAD'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Unidad'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(14626424607470065)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'146265'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMORDEN:UNIDAD:DSREPARA:CDASIGNADO:'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180110171403'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14623530052469928)
,p_plug_name=>'TERMINA OT'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448421304759217)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14623811709469928)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(14623530052469928)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(7453023095759240)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14630726966641081)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(14623530052469928)
,p_button_name=>'TERMINA_OT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(7453023095759240)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Termina Ot'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(14623906557469929)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14624126394469931)
,p_name=>'P8_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(14623530052469928)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14624305469469932)
,p_name=>'P8_NMORDEN'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(14623530052469928)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14628632338582168)
,p_name=>'P8_ASIGNADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(14623530052469928)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14630003415625928)
,p_name=>'P8_COMENTARIOTERMINA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(14623530052469928)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Comentario termina'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14624712551469935)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TORDENSERV'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14624909644469937)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TORDENSERV'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14631931383661240)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'terminaOT'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Declare',
'clase varchar2(10);',
'corre numeric;',
...
'Select CDESTACION into DELEGA from PA_usuarios  where lower(usuario) = lower(:APP_USER);',
'',
'update tordenserv set fecha_termina=sysdate() , estado= ''T'', COMENT_TERMINA =:P8_COMENTARIOTERMINA where nmorden=:P3_NMORDEN and cddelegacion=DELEGA;',
'',
'select cod_falla into falla from tordenserv where nmorden = :P3_NMORDEN and cddelegacion=delega;',
'',
'IF falla = 43  or falla = 44 THEN',
'Select cod_emp into empleado from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'select cdclase into clase from tordenserv where nmorden = :P3_NMORDEN  and cddelegacion=delega;',
'select cdasignado into asigna from tordenserv where nmorden = :P3_NMORDEN  and cddelegacion=delega;',
'select correlativo into corre from tordenserv where nmorden = :P3_NMORDEN  and cddelegacion=delega;',
...
'',
'select max(num_check)+1 into chek from tbl_encserv;',
'select  max(kmretorno) into recorrido from tvales where cdclasact = clase and corract = corre  and cddelegacion=delega;',
'select  max(nmvale) into vale from tvales where cdclasact = clase and corract = corre  and cddelegacion=delega;',
'select max(nmnota) into nota from tnotaviaje where cdclaseuni = clase and correlativouni = corre  and cddelegacion=delega;',
'',
'select kms_servicio into kmservicio from tactivos where cdclase = clase and correlativo = corre;',
'',
'INSERT INTO TBL_ENCSERV (cdempresa,num_check,fecha,cdclase,correl,recorrido,realiza,supervisa,kms_sig,ult_nota,ult_vale,serv_aplicado,cddelegacion,norden)',
'values',
'(''01'',chek,sysdate(),clase,corre,recorrido,asigna,empleado,recorrido+kmservicio,nota,vale,null,delega,:P3_NMORDEN);',
'END IF;',
'',
'',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(14630726966641081)
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20200812120221'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21579613438736468)
,p_plug_name=>'ANULA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448826360759220)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select nmorden,cdclase||''-''||correlativo unidad, dsrepara, cdasignado from tordenserv where estado= ''A'' and cdasignado is not null  and CDDELEGACION =( select decode(cdestacion,''00'',cddelegacion, cdestacion) from PA_usuarios where lower(usuario) = lo'
||'wer(:APP_USER))  and  taller in ( select id_taller from  t_usuarios_taller where lower(usuario) = lower(:APP_USER)) order by fecrea asc;'
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(21579702545736559)
,p_name=>'ANULA'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'JFAJARDO'
,p_internal_uid=>21579702545736559
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21580019935736600)
,p_db_column_name=>'NMORDEN'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmorden'
,p_column_link=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.::P11_OT,P11_ASIGNADO:#NMORDEN#,#CDASIGNADO#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21580132435736601)
,p_db_column_name=>'UNIDAD'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Unidad'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21580222550736601)
,p_db_column_name=>'DSREPARA'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Dsrepara'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21580309547736601)
,p_db_column_name=>'CDASIGNADO'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Cdasignado'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(21580414477736781)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'215805'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>1000
,p_report_columns=>'NMORDEN:UNIDAD:DSREPARA:CDASIGNADO'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180312175422'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(21582103227771376)
,p_plug_name=>'MOTIVO ANULACION'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7449312905759223)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21583425306796689)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(21582103227771376)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21582926560787598)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(21582103227771376)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(21584116069806220)
,p_branch_name=>'rediccion'
,p_branch_action=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(21582926560787598)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21582417819774973)
,p_name=>'P11_OT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(21582103227771376)
,p_prompt=>'Ot'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21582611349778018)
,p_name=>'P11_ASIGNADO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(21582103227771376)
,p_prompt=>'Asignado'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(21582805095780909)
,p_name=>'P11_MOTIVO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(21582103227771376)
,p_prompt=>'Motivo'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(21583100026789417)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'ANULAOT'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Declare',
'',
'delega varchar2(2);',
...
'Select CDESTACION into DELEGA from PA_usuarios  where lower(usuario) = lower(:APP_USER);',
'',
'update tordenserv set fecha_anula=sysdate() , estado= ''X'', coment_anula =:P11_MOTIVO where nmorden=:P11_OT and cddelegacion=DELEGA;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(21582926560787598)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200717155842'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(96504728158744570)
,p_plug_name=>'APROBADAS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448826360759220)
,p_plug_display_sequence=>10
...
'"CDASIGNADO",',
'"APROBADO"',
'from TORDENSERV WHERE APROBADO = 0 AND ESTADO = ''C'' ',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(96504924111744570)
,p_name=>'APROBADAS'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#edit_big.gif"  border="0">'
,p_owner=>'1462'
,p_internal_uid=>96504924111744570
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505004470744578)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505131504744579)
,p_db_column_name=>'NMORDEN'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmorden'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505207691744581)
,p_db_column_name=>'CDCLASE'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Cdclase'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505317938744582)
,p_db_column_name=>'CORRELATIVO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Correlativo'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505419090744584)
,p_db_column_name=>'DSREPARA'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Dsrepara'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505523098744585)
,p_db_column_name=>'ESTADO'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Estado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505623702744585)
,p_db_column_name=>'CDASIGNADO'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cdasignado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96505700511744587)
...
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'APROBADO'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(96506000841744737)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'965061'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:NMORDEN:CDCLASE:CORRELATIVO:DSREPARA:ESTADO:CDASIGNADO:APROBADO'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(7454028746759254)
,p_tab_set=>'TS1'
,p_name=>'Form on TORDENSERV'
,p_step_title=>'Form on TORDENSERV'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200717140248'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(96501210112744532)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96501430136744537)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(96501210112744532)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(7453023095759240)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96501615034744537)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(96501210112744532)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(96501807133744543)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96502024899744543)
,p_name=>'P15_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(96501210112744532)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96502219696744545)
,p_name=>'P15_NMORDEN'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(96501210112744532)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96502400449744545)
,p_name=>'P15_CORRELATIVO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(96501210112744532)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96502605717744546)
,p_name=>'P15_DSREPARA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(96501210112744532)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96502814148744546)
,p_name=>'P15_ESTADO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(96501210112744532)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96503002366744556)
,p_name=>'P15_APROBADO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(96501210112744532)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(96503802862744557)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TORDENSERV'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(96504009563744560)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TORDENSERV'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(96504203727744560)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_step_template=>wwv_flow_api.id(7436209761759198)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20170908144818'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(7454526659759259)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(7448421304759217)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(7454804731759260)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(7454526659759259)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7454610873759260)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(7454526659759259)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(7454707557759260)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7455006033759262)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7454930190759260)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7455202031759262)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(7455107770759262)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(74320014150011882)
);
end;
/
