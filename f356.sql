...
,p_default_application_id=>356
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 356 - productos
--
-- Application Export:
--   Application:     356
--   Name:            productos
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,356)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_356')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'6B14C4E7CF9E97596AFF74C420103610B99545D6585CA2EC8099E687A046FD39'
...
,p_authentication_id=>wwv_flow_api.id(43048807096092595)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:productos'
...
,p_last_upd_yyyymmddhh24miss=>'20210322115421'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8825812964071212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8825986391071212)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8826029995071212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8826216075071212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8826373036071212)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8826440030071212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(43038512922092426)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(43048527819092592)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(43048600428092593)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(43049917911092629)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(43051313395092678)
,p_parent_id=>0
,p_short_name=>'Page 1'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43038604795092443)
,p_theme_id=>24
,p_name=>'Login'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43038716002092457)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43038800016092459)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43038904874092459)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039015531092459)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039104656092459)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039204976092460)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039330071092460)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039427921092460)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039513681092460)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039615821092460)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039729103092460)
,p_theme_id=>24
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039801904092460)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43039918897092462)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43040007261092464)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43040131171092464)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(43040229316092464)
,p_theme_id=>24
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(43047114061092540)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(43047225662092543)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(43047329552092543)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(43047410398092543)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(43047528785092543)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(43047610040092543)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040308853092465)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040409625092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040518023092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040621992092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040729021092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040828045092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43040908874092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041004104092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041106139092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041208287092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041329430092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041428746092478)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041507054092479)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041624351092479)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041704939092479)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'    #BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041800376092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43041929923092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042027342092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042126807092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042228785092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042314861092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042418865092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042516922092481)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042623313092482)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042723874092482)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042821207092482)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43042925624092482)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043004957092482)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043131993092482)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043219432092484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043323647092484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043408947092484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043500322092484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(43043601329092484)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43044800236092517)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43044908079092528)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045022672092528)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045122217092528)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045205765092529)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045323536092529)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045411604092529)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045516333092529)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045608342092529)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045705294092529)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045820864092529)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43045902342092529)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43046016960092529)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43046118986092529)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43046208349092529)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43046325907092529)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(43046411422092531)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43043730747092492)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43043806833092501)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43043900613092501)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044008173092501)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044131158092501)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044231397092504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044313502092504)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044427350092506)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044527092092506)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044615925092506)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(43044721976092506)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(43046501194092531)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(43046629225092537)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(43046714287092537)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(43046823758092537)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(43046921717092537)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(43047031556092537)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(43047723639092545)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(43047831904092550)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(43048215833092559)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(43047912625092554)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(43048015793092557)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(43048100191092557)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(43048302540092568)
,p_theme_id=>24
,p_theme_name=>'Cloudy'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(43039015531092459)
,p_error_template=>wwv_flow_api.id(43038904874092459)
,p_printer_friendly_template=>wwv_flow_api.id(43039801904092460)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(43038604795092443)
,p_default_button_template=>wwv_flow_api.id(43047114061092540)
,p_default_region_template=>wwv_flow_api.id(43042623313092482)
,p_default_chart_template=>wwv_flow_api.id(43041004104092478)
,p_default_form_template=>wwv_flow_api.id(43041329430092478)
,p_default_reportr_template=>wwv_flow_api.id(43042623313092482)
,p_default_tabform_template=>wwv_flow_api.id(43042623313092482)
,p_default_wizard_template=>wwv_flow_api.id(43043408947092484)
,p_default_menur_template=>wwv_flow_api.id(43040621992092478)
,p_default_listr_template=>wwv_flow_api.id(43040908874092478)
,p_default_irr_template=>wwv_flow_api.id(43041704939092479)
,p_default_report_template=>wwv_flow_api.id(43044313502092504)
,p_default_label_template=>wwv_flow_api.id(43046714287092537)
,p_default_menu_template=>wwv_flow_api.id(43047723639092545)
,p_default_calendar_template=>wwv_flow_api.id(43047912625092554)
,p_default_list_template=>wwv_flow_api.id(43046208349092529)
,p_default_option_label=>wwv_flow_api.id(43046823758092537)
,p_default_required_label=>wwv_flow_api.id(43047031556092537)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(43048727563092595)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(43048807096092595)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(43048425166092570)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(43048425166092570)
,p_name=>'Page 1'
,p_alias=>'HOME'
,p_step_title=>'Page 1'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20181211173506'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(43050206135092637)
,p_plug_name=>'Page 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(43041704939092479)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select b.cod_sucursal,b.num_docto,b.cod_prov, b.nom_cliente,fecha_docto,num_facp,a.cod_prod, c.nombre, a.costo_unit ',
' from inv_detm a inner join inv_movm b on a.num_docto=b.num_docto and a.cod_bodega=b.cod_bodega inner join ',
'productos c on a.cod_prod=c.cod_prod where b.cod_doctoi=2 and num_facp is not null ',
'and cod_sucursal=10 and (c.nombre like ''%''||upper(:P1_FILTRO)||''%'' or a.cod_prod like ''%''||:P1_FILTRO||''%'')  ',
'order by b.num_docto'))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(43050304397092639)
,p_name=>'Page 1'
...
,p_owner=>'LP'
,p_internal_uid=>43050304397092639
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43050416407092660)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43050502128092667)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43050606858092667)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43050718379092668)
...
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'NOM_CLIENTE'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43050814238092670)
,p_db_column_name=>'FECHA_DOCTO'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Fecha Docto'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FECHA_DOCTO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43050926999092670)
,p_db_column_name=>'NUM_FACP'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Num Facp'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'NUM_FACP'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43051009441092671)
...
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'COD_PROD'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43051107472092673)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43051211267092675)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(43051716048096464)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'430518'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'COD_SUCURSAL:NUM_DOCTO:COD_PROV:NOM_CLIENTE:FECHA_DOCTO:NUM_FACP:COD_PROD:NOMBRE:COSTO_UNIT'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(43051415148092681)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(43040621992092478)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(43049917911092629)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(43047723639092545)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(43053622731230918)
,p_plug_name=>'datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(43042623313092482)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43054200876271898)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(43053622731230918)
,p_button_name=>'ENVIAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(43047114061092540)
,p_button_image_alt=>'Enviar'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43054007161234139)
,p_name=>'P1_FILTRO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(43053622731230918)
,p_prompt=>'Filtro'
...
,p_field_template=>wwv_flow_api.id(43046714287092537)
...
,p_step_template=>wwv_flow_api.id(43038604795092443)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20181130122335'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(43049107126092603)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(43041329430092478)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43049422152092620)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(43049107126092603)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43049203105092609)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(43049107126092603)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43049330940092618)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43049604887092629)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43049530648092620)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43049814332092629)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43049717949092629)
,p_process_sequence=>10
