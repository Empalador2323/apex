...
prompt APPLICATION 109 - Menu Lp
--
-- Application Export:
--   Application:     109
--   Name:            Menu Lp
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Menu Lp')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'LPSIG109BK')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt_last_reset=>'20201128075717'
...
,p_authentication_id=>wwv_flow_api.id(61313907480356301)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20201128075717'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(32829236038627678)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(32829328446627678)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(32829376656627678)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(32829608932627678)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(32829742456627678)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(32829847290627678)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(51938373542019101)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(61313397248356300)
,p_name=>'Admin_Only'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(34145689140387423)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(61313305030356295)
,p_icon_sequence=>200
...
wwv_flow_api.create_flow_item(
 p_id=>wwv_flow_api.id(38621911970674034)
,p_name=>'GG_CIA'
,p_scope=>'GLOBAL'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(61315300252356302)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(61315027413356302)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(61315427676356302)
,p_parent_id=>0
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35145577311213891)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35145891714213894)
,p_page_template_id=>wwv_flow_api.id(35145577311213891)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35146201191213895)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35146584893213895)
,p_page_template_id=>wwv_flow_api.id(35146201191213895)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35146990545213895)
,p_page_template_id=>wwv_flow_api.id(35146201191213895)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35147397530213895)
,p_page_template_id=>wwv_flow_api.id(35146201191213895)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35147782135213895)
,p_page_template_id=>wwv_flow_api.id(35146201191213895)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35148181819213897)
,p_page_template_id=>wwv_flow_api.id(35146201191213895)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35148497377213897)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35148888408213897)
,p_page_template_id=>wwv_flow_api.id(35148497377213897)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35149275771213897)
,p_page_template_id=>wwv_flow_api.id(35148497377213897)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35149678443213897)
,p_page_template_id=>wwv_flow_api.id(35148497377213897)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35150079361213897)
,p_page_template_id=>wwv_flow_api.id(35148497377213897)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35150489896213898)
,p_page_template_id=>wwv_flow_api.id(35148497377213897)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35150883579213898)
,p_page_template_id=>wwv_flow_api.id(35148497377213897)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35151181807213898)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35151571849213898)
,p_page_template_id=>wwv_flow_api.id(35151181807213898)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35151980059213898)
,p_page_template_id=>wwv_flow_api.id(35151181807213898)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35152400380213898)
,p_page_template_id=>wwv_flow_api.id(35151181807213898)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35152778363213898)
,p_page_template_id=>wwv_flow_api.id(35151181807213898)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35153075348213900)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35153491797213900)
,p_page_template_id=>wwv_flow_api.id(35153075348213900)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35153879909213900)
,p_page_template_id=>wwv_flow_api.id(35153075348213900)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35154271369213900)
,p_page_template_id=>wwv_flow_api.id(35153075348213900)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35154695252213902)
,p_page_template_id=>wwv_flow_api.id(35153075348213900)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35155097319213902)
,p_page_template_id=>wwv_flow_api.id(35153075348213900)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35155386946213902)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35155777409213902)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35156194932213902)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35156598794213902)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35156995184213903)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35157401051213903)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35157770645213903)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35158190918213903)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35158587013213903)
,p_page_template_id=>wwv_flow_api.id(35155386946213902)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35158890579213903)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35159272178213903)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35159678363213905)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35160098392213905)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35160488193213905)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35160887194213905)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35161295855213905)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35161689710213905)
,p_page_template_id=>wwv_flow_api.id(35158890579213903)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35161981273213908)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35162396051213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35162781553213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35163182425213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35163576715213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35163979403213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35164381137213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35164770996213911)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35165180820213913)
,p_page_template_id=>wwv_flow_api.id(35161981273213908)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35165492819213913)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35165886901213913)
,p_page_template_id=>wwv_flow_api.id(35165492819213913)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35166301784213913)
,p_page_template_id=>wwv_flow_api.id(35165492819213913)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35166671508213913)
,p_page_template_id=>wwv_flow_api.id(35165492819213913)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35167092882213913)
,p_page_template_id=>wwv_flow_api.id(35165492819213913)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35167488974213913)
,p_page_template_id=>wwv_flow_api.id(35165492819213913)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35167899090213914)
,p_page_template_id=>wwv_flow_api.id(35165492819213913)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35168193051213914)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35168599687213914)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35169000944213914)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35169391629213914)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35169778004213914)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35170176450213914)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35170574824213916)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35170998839213916)
,p_page_template_id=>wwv_flow_api.id(35168193051213914)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35171277718213916)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35171679529213916)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35172095491213916)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35172490786213916)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35172872121213916)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35173276232213917)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35173683962213917)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35174088259213917)
,p_page_template_id=>wwv_flow_api.id(35171277718213916)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35174374520213917)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35174782566213917)
,p_page_template_id=>wwv_flow_api.id(35174374520213917)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35175088598213917)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35175490733213919)
,p_page_template_id=>wwv_flow_api.id(35175088598213917)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35175902612213919)
,p_page_template_id=>wwv_flow_api.id(35175088598213917)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35176270481213919)
,p_page_template_id=>wwv_flow_api.id(35175088598213917)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35176675868213919)
,p_page_template_id=>wwv_flow_api.id(35175088598213917)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35176973819213919)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35177383578213919)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35177790430213919)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35178198206213920)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35178587707213920)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35178992546213920)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35179375901213920)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35179778176213920)
,p_page_template_id=>wwv_flow_api.id(35176973819213919)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35180071913213920)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35180479207213920)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35180897652213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35181298489213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35181692733213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35182080635213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35182484419213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35182899411213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35183277237213922)
,p_page_template_id=>wwv_flow_api.id(35180071913213920)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35183578261213923)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35183987884213923)
,p_page_template_id=>wwv_flow_api.id(35183578261213923)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35184375715213923)
,p_page_template_id=>wwv_flow_api.id(35183578261213923)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35184783519213923)
,p_page_template_id=>wwv_flow_api.id(35183578261213923)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35185172259213923)
,p_page_template_id=>wwv_flow_api.id(35183578261213923)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35185593602213923)
,p_page_template_id=>wwv_flow_api.id(35183578261213923)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35185985675213925)
,p_page_template_id=>wwv_flow_api.id(35183578261213923)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(35186278513213927)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35186601239213927)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35186989234213927)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35187384916213928)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35187776845213928)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35188172561213928)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35188577667213928)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(35188980614213928)
,p_page_template_id=>wwv_flow_api.id(35186278513213927)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56716796380018500)
,p_theme_id=>2
,p_name=>'Login'
,p_internal_name=>'LOGIN'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56716980828018512)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56717287713018514)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56717583727018514)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56717878420018514)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56718188601018515)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56718484673018515)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56718789139018516)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56719084127018516)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56719392026018516)
,p_theme_id=>2
,p_name=>'Popup'
,p_internal_name=>'POPUP'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56719668609018516)
,p_theme_id=>2
,p_name=>'Printer Friendly'
,p_internal_name=>'PRINTER_FRIENDLY'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56719967017018516)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56720277389018516)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56720494470018517)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(56720790624018517)
,p_theme_id=>2
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306311850356277)
,p_theme_id=>3
,p_name=>'Login'
,p_internal_name=>'LOGIN'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306405833356278)
,p_theme_id=>3
,p_name=>'No Tabs'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306495926356278)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306603023356278)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306727926356279)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306814181356279)
,p_theme_id=>3
,p_name=>'Popup'
,p_internal_name=>'POPUP'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306927091356279)
,p_theme_id=>3
,p_name=>'Printer Friendly'
,p_internal_name=>'PRINTER_FRIENDLY'
,p_is_popup=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61306998670356279)
,p_theme_id=>3
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61307106523356279)
,p_theme_id=>3
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35204485338213952)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35204699538213952)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35204896748213952)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35205082861213953)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35205278322213953)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(35205473817213953)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(56721082737018517)
,p_template_name=>'Button'
,p_internal_name=>'BUTTON'
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(56721279114018524)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(56721491902018524)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(56721697249018524)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(61312206217356286)
,p_template_name=>'Button'
,p_internal_name=>'BUTTON'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(61312319240356286)
,p_template_name=>'Button, Alternative 1'
,p_internal_name=>'BUTTON,_ALTERNATIVE_1'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(61312396621356287)
,p_template_name=>'Button, Alternative 2'
,p_internal_name=>'BUTTON,_ALTERNATIVE_2'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(61312500114356287)
,p_template_name=>'Button, Alternative 3'
,p_internal_name=>'BUTTON,_ALTERNATIVE_3'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35189291114213930)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35189600550213931)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35189876664213931)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35190196473213931)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35190494575213931)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35190781654213931)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35191084803213933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35191395587213933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35191686855213933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(35192083366213933)
,p_plug_template_id=>wwv_flow_api.id(35191686855213933)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35192376007213933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35192686426213933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35192980802213933)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35193273314213934)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(35193699535213934)
,p_plug_template_id=>wwv_flow_api.id(35193273314213934)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35193973141213934)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35194285457213934)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35194581747213934)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(35194998319213934)
,p_plug_template_id=>wwv_flow_api.id(35194581747213934)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(35195393097213934)
,p_plug_template_id=>wwv_flow_api.id(35194581747213934)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35195694650213936)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(35195978657213936)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56721872671018524)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56722174400018526)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56722469830018526)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56722773418018527)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="bl-top">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56723067338018527)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="bl-top">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56723369519018527)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56723676595018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'</style>',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56723970557018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56724293079018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-blue-top"><div class="rc-blue-top-r">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56724584714018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56724872980018528)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56725177814018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="bl-body">#BODY#</div>',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56725483013018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56725781780018528)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56726093699018529)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-blue-top"><div class="rc-blue-top-r">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56726371269018529)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56726678873018529)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top"><div class="rc-gray-top-r">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56726971164018529)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56727293037018529)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56727568077018530)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56727871436018530)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-blue-top"><div class="rc-blue-top-r">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56728169878018530)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-blue-top"><div class="rc-blue-top-r">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307217305356279)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307307890356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307416819356280)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307526910356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307619750356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307720576356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307823767356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61307908561356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308028062356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308128119356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellpadding="0" cellspacing="0" border="0" summary="" class="t3ListRegionwithIcon" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'<tr>',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308201423356280)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308315479356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308410576356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308497808356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308612737356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table class="apex_finderbar" cellpadding="0" cellspacing="0" border="0" summary="" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'<tbody>',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308698138356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308801654356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61308912901356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61309026024356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61309096041356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61309209378356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61309327210356280)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table class="t3WizardRegion" summary="" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# bgcolor="#cccc99">',
'    <tr class="t3RegionHeader" bgcolor="#cccc99">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35199592908213944)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35199885373213947)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35200174300213947)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35200478337213947)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35200781988213948)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35201086840213948)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35201372893213948)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35201692363213950)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35201996890213950)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35202292512213950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35202579589213950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35202881984213950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35203184517213950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(35203476471213950)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56728475744018530)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56728794397018536)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56729088820018536)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56729389435018537)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56729682068018540)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56729990669018540)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56730276976018540)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56730587234018541)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56730870973018541)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="list-item-current">',
'  <div class="list-item-image"><img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" / ></div>',
'  <div class="list-item-label"><a href="#LINK#" class="current">#TEXT#</a></div>',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56731189084018542)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56731483352018542)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Sidebar List'
,p_internal_name=>'VERTICAL_SIDEBAR_LIST'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56731793375018542)
,p_list_template_current=>'<li class="current">#TEXT#</li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List with Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITH_BULLETS'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56732089616018542)
,p_list_template_current=>'<li class="current">#TEXT#</li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List without Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITHOUT_BULLETS'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56732396968018542)
,p_list_template_current=>'<li class="current">#TEXT#</li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(56732691427018542)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="#LIST_STATUS#">',
'      <span>#TEXT#</span>',
'    </li>'))
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310109197356282)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310221977356282)
,p_list_template_current=>'<li class="dhtmlMenuItem"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li class="dhtmlMenuItem"><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310302015356282)
,p_list_template_current=>'<li><img src="#IMAGE_PREFIX#themes/theme_13/node.gif" align="middle" alt="" /><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><img src="#IMAGE_PREFIX#themes/theme_13/node.gif" align="middle"  alt="" /><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'DHTML Tree'
,p_internal_name=>'DHTML_TREE'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310408148356282)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310521080356282)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310603763356283)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310705021356283)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310810811356283)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61310897577356283)
,p_list_template_current=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311004094356284)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311112219356284)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311215564356284)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311302048356284)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311404035356284)
,p_list_template_current=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List with Bullets'
,p_internal_name=>'VERTICAL_UNORDERED_LIST_WITH_BULLETS'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311525362356284)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(61311596153356284)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35196291509213938)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35196582003213938)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35196896530213938)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35197185078213938)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35197484830213938)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35197801976213938)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35198071488213939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35198381786213939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35198673097213939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35199001998213939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(35199301816213939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56732985884018542)
,p_row_template_name=>'Borderless Report'
,p_internal_name=>'BORDERLESS_REPORT'
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56733485012018544)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56733986479018545)
,p_row_template_name=>'Horizontal Border'
,p_internal_name=>'HORIZONTAL_BORDER'
,p_row_template1=>'<td#ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="data">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56734482650018545)
,p_row_template_name=>'One Column Unordered List'
,p_internal_name=>'ONE_COLUMN_UNORDERED_LIST'
,p_row_template1=>'<li>#COLUMN_VALUE#</li>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56734988470018545)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56735273643018545)
,p_row_template_name=>'Standard'
,p_internal_name=>'STANDARD'
,p_row_template1=>'<td#ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="data">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56735781381018547)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56736299454018548)
,p_row_template_name=>'Two Column Portlet'
,p_internal_name=>'TWO_COLUMN_PORTLET'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(56736596571018548)
,p_row_template_name=>'Value Attribute Pairs'
,p_internal_name=>'VALUE_ATTRIBUTE_PAIRS'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="report-row">',
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61309417380356280)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61309505239356281)
,p_row_template_name=>'Horizontal Border'
,p_internal_name=>'HORIZONTAL_BORDER'
,p_row_template1=>'<td#ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="t3data">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61309624678356281)
,p_row_template_name=>'One Column Unordered List'
,p_internal_name=>'ONE_COLUMN_UNORDERED_LIST'
,p_row_template1=>'<li>#COLUMN_VALUE#</li>'
,p_row_template_before_rows=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61309715277356281)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61309801989356281)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61309909489356281)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(61310020291356282)
,p_row_template_name=>'Value Attribute Pairs'
,p_internal_name=>'VALUE_ATTRIBUTE_PAIRS'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35203787171213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35203880215213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35203985137213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35204097689213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35204191140213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35204285604213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(35204380902213952)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(56736890464018548)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(56736985941018548)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(56737099445018548)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(56737176417018548)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(56737276019018548)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(61311717154356284)
,p_template_name=>'No Label'
,p_internal_name=>'NO_LABEL'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(61311799479356284)
,p_template_name=>'Optional'
,p_internal_name=>'OPTIONAL'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(61311911753356284)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(61312005246356284)
,p_template_name=>'Required'
,p_internal_name=>'REQUIRED'
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(61312122195356286)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(35205688188213953)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(56737376092018548)
,p_name=>'Breadcrumb Menu'
,p_internal_name=>'BREADCRUMB_MENU'
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(56737495355018551)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(61312607210356287)
,p_name=>'Breadcrumbs'
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(61312713531356288)
,p_name=>'Hierarchical Menu'
,p_internal_name=>'HIERARCHICAL_MENU'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(35205878858213956)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(56738167995018554)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(61313102026356289)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(35205784265213955)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(56737568873018551)
,p_cal_template_name=>'Calendar'
,p_internal_name=>'CALENDAR'
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(56737792802018552)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(56737985716018553)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(61312802748356288)
,p_cal_template_name=>'Calendar'
,p_internal_name=>'CALENDAR'
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(61312904213356289)
,p_cal_template_name=>'Calendar, Alternative 1'
,p_internal_name=>'CALENDAR,_ALTERNATIVE_1'
,p_day_of_week_format=>'<th class="t3DayOfWeek">#IDAY#</th>'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(61313017180356289)
,p_cal_template_name=>'Small Calendar'
,p_internal_name=>'SMALL_CALENDAR'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(35206086691213956)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(35153075348213900)
,p_error_template=>wwv_flow_api.id(35151181807213898)
,p_printer_friendly_template=>wwv_flow_api.id(35175088598213917)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(35145577311213891)
,p_default_button_template=>wwv_flow_api.id(35204485338213952)
,p_default_region_template=>wwv_flow_api.id(35194581747213934)
,p_default_chart_template=>wwv_flow_api.id(35194581747213934)
,p_default_form_template=>wwv_flow_api.id(35191686855213933)
,p_default_reportr_template=>wwv_flow_api.id(35194581747213934)
,p_default_tabform_template=>wwv_flow_api.id(35194581747213934)
,p_default_wizard_template=>wwv_flow_api.id(35191686855213933)
,p_default_menur_template=>wwv_flow_api.id(35190196473213931)
,p_default_listr_template=>wwv_flow_api.id(35194581747213934)
,p_default_irr_template=>wwv_flow_api.id(35192980802213933)
,p_default_report_template=>wwv_flow_api.id(35198071488213939)
,p_default_label_template=>wwv_flow_api.id(35203985137213952)
,p_default_menu_template=>wwv_flow_api.id(35205688188213953)
,p_default_calendar_template=>wwv_flow_api.id(35205784265213955)
,p_default_list_template=>wwv_flow_api.id(35202881984213950)
,p_default_option_label=>wwv_flow_api.id(35203985137213952)
,p_default_required_label=>wwv_flow_api.id(35204285604213952)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(56738371162018557)
,p_theme_id=>2
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(56717878420018514)
,p_error_template=>wwv_flow_api.id(56717878420018514)
,p_printer_friendly_template=>wwv_flow_api.id(56719668609018516)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(56716796380018500)
,p_default_button_template=>wwv_flow_api.id(56721082737018517)
,p_default_region_template=>wwv_flow_api.id(56726093699018529)
,p_default_chart_template=>wwv_flow_api.id(56723369519018527)
,p_default_form_template=>wwv_flow_api.id(56723676595018528)
,p_default_reportr_template=>wwv_flow_api.id(56726093699018529)
,p_default_tabform_template=>wwv_flow_api.id(56726093699018529)
,p_default_wizard_template=>wwv_flow_api.id(56727871436018530)
,p_default_menur_template=>wwv_flow_api.id(56722469830018526)
,p_default_listr_template=>wwv_flow_api.id(56724293079018528)
,p_default_irr_template=>wwv_flow_api.id(56725177814018528)
,p_default_report_template=>wwv_flow_api.id(56735273643018545)
,p_default_label_template=>wwv_flow_api.id(56737099445018548)
,p_default_menu_template=>wwv_flow_api.id(56737376092018548)
,p_default_calendar_template=>wwv_flow_api.id(56737568873018551)
,p_default_list_template=>wwv_flow_api.id(56731793375018542)
,p_default_option_label=>wwv_flow_api.id(56737099445018548)
,p_default_required_label=>wwv_flow_api.id(56737276019018548)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(61313199085356292)
,p_theme_id=>3
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(61306405833356278)
,p_error_template=>wwv_flow_api.id(61306311850356277)
,p_printer_friendly_template=>wwv_flow_api.id(61306927091356279)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(61306311850356277)
,p_default_button_template=>wwv_flow_api.id(61312206217356286)
,p_default_region_template=>wwv_flow_api.id(61308698138356280)
,p_default_chart_template=>wwv_flow_api.id(61307720576356280)
,p_default_form_template=>wwv_flow_api.id(61307823767356280)
,p_default_reportr_template=>wwv_flow_api.id(61308698138356280)
,p_default_tabform_template=>wwv_flow_api.id(61308698138356280)
,p_default_wizard_template=>wwv_flow_api.id(61309209378356280)
,p_default_menur_template=>wwv_flow_api.id(61307416819356280)
,p_default_listr_template=>wwv_flow_api.id(61308698138356280)
,p_default_report_template=>wwv_flow_api.id(61309715277356281)
,p_default_label_template=>wwv_flow_api.id(61311911753356284)
,p_default_menu_template=>wwv_flow_api.id(61312607210356287)
,p_default_calendar_template=>wwv_flow_api.id(61312802748356288)
,p_default_list_template=>wwv_flow_api.id(61311404035356284)
,p_default_option_label=>wwv_flow_api.id(61311911753356284)
,p_default_required_label=>wwv_flow_api.id(61312122195356286)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(61313508983356301)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(61313615230356301)
,p_name=>'DATABASE'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(61313707869356301)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(61313824090356301)
,p_name=>'HTML DB'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(61313907480356301)
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(60494218930984184)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60511937173174050)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60512524144179829)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60513141113184648)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(60513717349187254)
,p_plugin_attribute_id=>wwv_flow_api.id(60513141113184648)
,p_display_sequence=>10
,p_display_value=>'true'
,p_return_value=>'true'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(60514120466188173)
,p_plugin_attribute_id=>wwv_flow_api.id(60513141113184648)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60514717134196697)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60515336873202367)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
,p_max_length=>100
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(60513141113184648)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60517932296295698)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60524045745895803)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(60524615748896562)
,p_plugin_attribute_id=>wwv_flow_api.id(60524045745895803)
,p_display_sequence=>10
,p_display_value=>'true'
,p_return_value=>'true'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(60525017825897192)
,p_plugin_attribute_id=>wwv_flow_api.id(60524045745895803)
,p_display_sequence=>20
,p_display_value=>'false'
,p_return_value=>'false'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60526419342907108)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
begin
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(59760190666186465)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(59761193436187271)
,p_plugin_attribute_id=>wwv_flow_api.id(59760190666186465)
,p_display_sequence=>10
,p_display_value=>'ID'
,p_return_value=>'id'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(59770615458458531)
,p_plugin_attribute_id=>wwv_flow_api.id(59760190666186465)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(59761600709189364)
,p_plugin_attribute_id=>wwv_flow_api.id(59760190666186465)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(59762010059192074)
,p_plugin_attribute_id=>wwv_flow_api.id(59760190666186465)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(59762412137192640)
,p_plugin_attribute_id=>wwv_flow_api.id(59760190666186465)
,p_display_sequence=>40
,p_display_value=>'URL'
,p_return_value=>'url'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(60527619819916666)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(32831162507629408)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(60521317246816358)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(61708214817599033)
,p_plugin_id=>wwv_flow_api.id(60494218930984184)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(51938287268019095)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(51938287268019095)
,p_tab_set=>'TS1'
,p_name=>'HOME'
,p_alias=>'HOME'
...
,p_step_template=>wwv_flow_api.id(56718188601018515)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'TRANSPORTE'
,p_last_upd_yyyymmddhh24miss=>'20201127072922'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(56713086084372055)
,p_plug_name=>'LP WEB'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(56721872671018524)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32232098919047589)
...
,p_step_template=>wwv_flow_api.id(56716796380018500)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(57555993835159465)
,p_plug_name=>'LP SIG'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(56726093699018529)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(61314220392356302)
,p_plug_name=>'LP SIG'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(56721872671018524)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(61314504597356302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(57555993835159465)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(56721082737018517)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61314295575356302)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(57555993835159465)
...
,p_field_template=>wwv_flow_api.id(56736985941018548)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61314415456356302)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(61314727207356302)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(61314608100356302)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(61314912304356302)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(61314813786356302)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
