...
,p_default_application_id=>358
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 358 - LP_INCIDENCIA
--
-- Application Export:
--   Application:     358
--   Name:            LP_INCIDENCIA
--   Date and Time:   12:35 Wednesday April 20, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,358)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_INCIDENCIA')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_358')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'7BA97D25B1278FFF9465E11BC2E2B00EA96CC34F93864DE5DFA7D473206BECA1'
...
,p_authentication_id=>wwv_flow_api.id(31722802750876743)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_INCIDENCIA'
...
,p_last_upd_yyyymmddhh24miss=>'20180720085417'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8827753081071546)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8827841476071546)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8827907451071546)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8828157458071546)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8828201575071546)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8828393678071546)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(31704632437876662)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(31722621910876739)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(31723928587876756)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31727217184876889)
,p_parent_id=>0
,p_short_name=>'Incidencia'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31704702344876675)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31704825289876682)
,p_page_template_id=>wwv_flow_api.id(31704702344876675)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31704916994876685)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705010851876687)
,p_page_template_id=>wwv_flow_api.id(31704916994876685)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705110371876687)
,p_page_template_id=>wwv_flow_api.id(31704916994876685)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705213609876687)
,p_page_template_id=>wwv_flow_api.id(31704916994876685)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705300796876687)
,p_page_template_id=>wwv_flow_api.id(31704916994876685)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705428873876687)
,p_page_template_id=>wwv_flow_api.id(31704916994876685)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31705515459876687)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705611978876687)
,p_page_template_id=>wwv_flow_api.id(31705515459876687)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705722500876687)
,p_page_template_id=>wwv_flow_api.id(31705515459876687)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705807923876687)
,p_page_template_id=>wwv_flow_api.id(31705515459876687)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31705910554876687)
,p_page_template_id=>wwv_flow_api.id(31705515459876687)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706004279876687)
,p_page_template_id=>wwv_flow_api.id(31705515459876687)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706132164876687)
,p_page_template_id=>wwv_flow_api.id(31705515459876687)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31706221083876687)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706315503876689)
,p_page_template_id=>wwv_flow_api.id(31706221083876687)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706422244876689)
,p_page_template_id=>wwv_flow_api.id(31706221083876687)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706502671876689)
,p_page_template_id=>wwv_flow_api.id(31706221083876687)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706619434876689)
,p_page_template_id=>wwv_flow_api.id(31706221083876687)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31706701657876689)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706801751876689)
,p_page_template_id=>wwv_flow_api.id(31706701657876689)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31706907968876689)
,p_page_template_id=>wwv_flow_api.id(31706701657876689)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707015692876689)
,p_page_template_id=>wwv_flow_api.id(31706701657876689)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707100607876689)
,p_page_template_id=>wwv_flow_api.id(31706701657876689)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707226261876689)
,p_page_template_id=>wwv_flow_api.id(31706701657876689)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31707311831876689)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707431864876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707527374876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707610186876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707721488876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707818816876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31707921851876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708021309876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708131653876689)
,p_page_template_id=>wwv_flow_api.id(31707311831876689)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31708204758876689)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708328635876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708400116876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708520070876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708625184876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708732607876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708809635876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31708909942876690)
,p_page_template_id=>wwv_flow_api.id(31708204758876689)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31709025725876690)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709130869876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709203035876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709301609876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709411352876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709520508876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709613168876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709718203876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31709810796876690)
,p_page_template_id=>wwv_flow_api.id(31709025725876690)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31709924070876690)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710013483876692)
,p_page_template_id=>wwv_flow_api.id(31709924070876690)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710102131876692)
,p_page_template_id=>wwv_flow_api.id(31709924070876690)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710231320876692)
,p_page_template_id=>wwv_flow_api.id(31709924070876690)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710328819876692)
,p_page_template_id=>wwv_flow_api.id(31709924070876690)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710426801876692)
,p_page_template_id=>wwv_flow_api.id(31709924070876690)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710503705876692)
,p_page_template_id=>wwv_flow_api.id(31709924070876690)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31710631461876692)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710727180876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710826292876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31710905557876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711021333876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711101695876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711208536876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711320777876692)
,p_page_template_id=>wwv_flow_api.id(31710631461876692)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31711423214876692)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711509114876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711612392876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711705008876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711801991876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31711910346876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712004793876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712123831876692)
,p_page_template_id=>wwv_flow_api.id(31711423214876692)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31712222483876692)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712326868876692)
,p_page_template_id=>wwv_flow_api.id(31712222483876692)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31712429791876692)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712519068876693)
,p_page_template_id=>wwv_flow_api.id(31712429791876692)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712622315876693)
,p_page_template_id=>wwv_flow_api.id(31712429791876692)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712708180876693)
,p_page_template_id=>wwv_flow_api.id(31712429791876692)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31712817679876693)
,p_page_template_id=>wwv_flow_api.id(31712429791876692)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31712908549876693)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713014432876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713123669876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713210964876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713330211876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713409601876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713532401876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713607414876693)
,p_page_template_id=>wwv_flow_api.id(31712908549876693)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31713709703876693)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713814249876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31713908043876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714013096876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714109252876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714216589876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714300106876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714429937876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714521158876693)
,p_page_template_id=>wwv_flow_api.id(31713709703876693)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31714621444876693)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714723991876693)
,p_page_template_id=>wwv_flow_api.id(31714621444876693)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714813660876693)
,p_page_template_id=>wwv_flow_api.id(31714621444876693)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31714925810876693)
,p_page_template_id=>wwv_flow_api.id(31714621444876693)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715013976876693)
,p_page_template_id=>wwv_flow_api.id(31714621444876693)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715116378876693)
,p_page_template_id=>wwv_flow_api.id(31714621444876693)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715218147876693)
,p_page_template_id=>wwv_flow_api.id(31714621444876693)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31715301888876696)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715411020876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715510576876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715605017876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715718805876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715814701876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31715914736876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31716026008876696)
,p_page_template_id=>wwv_flow_api.id(31715301888876696)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31721500139876721)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31721615315876725)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31721728390876725)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31721803464876725)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31721914815876725)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31722020372876725)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716100772876698)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716227038876703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716309663876703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716427562876703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716513414876703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716605726876703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716707889876703)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716817979876704)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31716906968876704)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31717018141876704)
,p_plug_template_id=>wwv_flow_api.id(31716906968876704)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717100931876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717210367876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717330837876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717414975876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31717531285876706)
,p_plug_template_id=>wwv_flow_api.id(31717414975876706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717623007876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717717365876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31717804848876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31717919500876706)
,p_plug_template_id=>wwv_flow_api.id(31717804848876706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31718009130876706)
,p_plug_template_id=>wwv_flow_api.id(31717804848876706)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31718118533876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31718218536876706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31719429949876714)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31719529148876717)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31719607558876717)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31719700950876717)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31719810377876717)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31719906091876718)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720002904876718)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720118724876718)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720200152876718)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720309163876718)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720401553876718)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720532737876718)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720627908876718)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31720732632876718)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718308839876709)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718430457876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718526215876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718621568876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718731905876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718822243876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31718930316876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31719015798876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31719132360876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31719221219876712)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31719302480876712)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31720816380876718)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31720907277876720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31721029001876720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31721112527876720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31721213225876720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31721314464876721)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31721406866876721)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(31722114490876725)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(31722309204876731)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(31722221149876728)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(31722411975876735)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(31706701657876689)
,p_error_template=>wwv_flow_api.id(31706221083876687)
,p_printer_friendly_template=>wwv_flow_api.id(31712429791876692)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(31704702344876675)
,p_default_button_template=>wwv_flow_api.id(31721500139876721)
,p_default_region_template=>wwv_flow_api.id(31717804848876706)
,p_default_chart_template=>wwv_flow_api.id(31717804848876706)
,p_default_form_template=>wwv_flow_api.id(31716906968876704)
,p_default_reportr_template=>wwv_flow_api.id(31717804848876706)
,p_default_tabform_template=>wwv_flow_api.id(31717804848876706)
,p_default_wizard_template=>wwv_flow_api.id(31716906968876704)
,p_default_menur_template=>wwv_flow_api.id(31716427562876703)
,p_default_listr_template=>wwv_flow_api.id(31717804848876706)
,p_default_irr_template=>wwv_flow_api.id(31717330837876706)
,p_default_report_template=>wwv_flow_api.id(31718930316876712)
,p_default_label_template=>wwv_flow_api.id(31721029001876720)
,p_default_menu_template=>wwv_flow_api.id(31722114490876725)
,p_default_calendar_template=>wwv_flow_api.id(31722221149876728)
,p_default_list_template=>wwv_flow_api.id(31720532737876718)
,p_default_option_label=>wwv_flow_api.id(31721029001876720)
,p_default_required_label=>wwv_flow_api.id(31721314464876721)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(31724724188876831)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31722703268876743)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31722802750876743)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(31722501826876737)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(31722501826876737)
,p_name=>'Incidencia'
,p_step_title=>'Incidencia'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31724203047876826)
,p_plug_name=>'INCIDENCIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31716906968876704)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31727326297876890)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31716427562876703)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(31723928587876756)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(31722114490876725)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31809608139176970)
,p_plug_name=>'Nueva incidencia'
,p_region_name=>'NEW'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31717414975876706)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31818524079257251)
,p_plug_name=>'incidencias'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31717330837876706)
,p_plug_display_sequence=>30
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select * from tdet_incidencia where id_incidencia=:P1_ID'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31818614541257251)
,p_name=>'incidencias'
...
,p_owner=>'LP'
,p_internal_uid=>31818614541257251
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31818819874257278)
,p_db_column_name=>'ID_INCIDENCIA'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id Incidencia'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ID_INCIDENCIA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31818906751257282)
,p_db_column_name=>'ID_DET_INCIDENCIA'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Id Det Incidencia'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ID_DET_INCIDENCIA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31819031891257282)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31819112621257282)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31819231340257282)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31823919801322298)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'318240'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ID_INCIDENCIA:ID_DET_INCIDENCIA:FECHA:DES_SEGUIMIENTO:USUARIO'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31777923367387976)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31724203047876826)
,p_button_name=>'P1_INCIDENCIA'
,p_button_static_id=>'P1_INCIDENCIA'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31721803464876725)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Incidencia'
,p_button_position=>'BODY'
,p_button_alignment=>'LEFT'
,p_button_condition=>'Select 1 from incidencia where id=:P1_ID'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31820115206264178)
,p_button_sequence=>90
,p_button_plug_id=>wwv_flow_api.id(31809608139176970)
,p_button_name=>'P1_AGREGAR'
,p_button_static_id=>'P1_AGREGAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31721803464876725)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31724325081876829)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31724203047876826)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31721500139876721)
,p_button_image_alt=>'Cancel'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31724509052876829)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31724603948876829)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31724203047876826)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31724416816876829)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31724804682876831)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31724918837876835)
,p_name=>'P1_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
...
,p_field_template=>wwv_flow_api.id(31721029001876720)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31725021756876842)
,p_name=>'P1_FECHA'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31725213060876848)
,p_name=>'P1_USUARIO'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31725427323876853)
,p_name=>'P1_COD_EMP'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'select cod_emp||'' ''|| nombres ||'' ''|| apellidos , cod_emp from empleados where fec_salida is null '
,p_cSize=>30
,p_cMaxlength=>100
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31725632542876857)
,p_name=>'P1_CDCLASE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31725819072876862)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31726008619876867)
,p_name=>'P1_CDESTACION'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Cdestacion'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31726213090876871)
,p_name=>'P1_KM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31726430843876876)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31726610246876881)
,p_name=>'P1_TIPO_REPORTE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select descripcion, id  from t_tip_reporte'
,p_cSize=>30
,p_cMaxlength=>22
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31726811079876885)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31766917288261985)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_prompt=>'Unidad'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31767227412272457)
,p_name=>'P1_GUIONES'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31724203047876826)
,p_prompt=>'Guiones'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31813411127213287)
,p_name=>'P1_ID_INCIDENCIAFK'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31809608139176970)
,p_prompt=>'Id Incidenciafk'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31813614103213287)
,p_name=>'P1_DET_INCIDENCIA'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(31809608139176970)
,p_prompt=>'Det Incidencia'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31813830224213287)
,p_name=>'P1_DATE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(31809608139176970)
,p_prompt=>'Date'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31814002673213287)
,p_name=>'P1_DES_SEGUIMIENTO'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(31809608139176970)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31767305304278668)
,p_name=>'guiones '
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31767626854278701)
,p_event_id=>wwv_flow_api.id(31767305304278668)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>'select cantidad into :p1_guiones from proyecto  where proyecto=:p1_unidad;'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31767924612303128)
,p_name=>'asignar'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31768228205303128)
,p_event_id=>wwv_flow_api.id(31767924612303128)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31768413800309190)
,p_event_id=>wwv_flow_api.id(31767924612303128)
,p_event_result=>'TRUE'
...
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'SUBSTR(:p1_UNIDAD, instr( :p1_UNIDAD,''-'',1, :p1_guiones)+1, LENGTH(:p1_UNIDAD)) '
,p_attribute_07=>'P1_UNIDAD,P1_GUIONES'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31816030265230710)
,p_name=>'agregar seguimiento'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31777923367387976)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31816329641230718)
,p_event_id=>wwv_flow_api.id(31816030265230710)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31822709281309751)
,p_name=>'insert_incidencia'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31820115206264178)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31823004045309751)
,p_event_id=>wwv_flow_api.id(31822709281309751)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
'maxi numeric;',
'begin ',
'select max(id_det_incidencia)+1 into maximo  from tdet_incidencia where id_incidencia= :P1_ID;',
'',
'insert into tdet_incidencia(id_incidencia,id_det_incidencia,fecha, des_seguimiento,usuario )values (:p1_id,maximo,sysdate,:P1_DES_SEGUIMIENTO,:APP_USER);',
'end;'))
,p_attribute_02=>'P1_ID,P1_DES_SEGUIMIENTO'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31823426352312600)
,p_event_id=>wwv_flow_api.id(31822709281309751)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
,p_affected_region_id=>wwv_flow_api.id(31818524079257251)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31823621608314735)
,p_event_id=>wwv_flow_api.id(31822709281309751)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31823806080321942)
,p_event_id=>wwv_flow_api.id(31822709281309751)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_DES_SEGUIMIENTO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31727017126876887)
,p_process_sequence=>1
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from INCIDENCIA'
,p_attribute_02=>'INCIDENCIA'
,p_attribute_03=>'P1_ID'
,p_attribute_04=>'ID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31727132325876887)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of INCIDENCIA'
,p_attribute_02=>'INCIDENCIA'
,p_attribute_03=>'P1_ID'
,p_attribute_04=>'ID'
...
,p_step_template=>wwv_flow_api.id(31704702344876675)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180719121325'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31723101014876746)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31716906968876704)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31723400243876754)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31723101014876746)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31723230501876751)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31723101014876746)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31723315972876751)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31723612086876756)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31723508412876754)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31723802292876756)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31723707071876756)
,p_process_sequence=>10
