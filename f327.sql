...
,p_default_application_id=>327
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 327 - reportereencauche
--
-- Application Export:
--   Application:     327
--   Name:            reportereencauche
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,327)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'reportereencauche')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_327')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'687F45B1EED6C852714603F93EA9921241F4EB888A323E7771697E7398282F52'
...
,p_authentication_id=>wwv_flow_api.id(20344600392942759)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:reportereencauche'
...
,p_last_upd_yyyymmddhh24miss=>'20210325144812'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8771041399060357)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8771167815060357)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8771282221060357)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8771476836060357)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8771545406060357)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8771697650060357)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(20319416550893459)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(20345913042028089)
,p_icon_sequence=>10
,p_icon_subtext=>'HOME'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(20337424920893620)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(20338900415893667)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(20338627122893657)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(20339005796893667)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20319506114893473)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20319623093893495)
,p_page_template_id=>wwv_flow_api.id(20319506114893473)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20319705626893501)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20319803076893503)
,p_page_template_id=>wwv_flow_api.id(20319705626893501)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20319910810893503)
,p_page_template_id=>wwv_flow_api.id(20319705626893501)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320017791893503)
,p_page_template_id=>wwv_flow_api.id(20319705626893501)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320128223893503)
,p_page_template_id=>wwv_flow_api.id(20319705626893501)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320203978893503)
,p_page_template_id=>wwv_flow_api.id(20319705626893501)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20320326745893503)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320418368893503)
,p_page_template_id=>wwv_flow_api.id(20320326745893503)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320517180893503)
,p_page_template_id=>wwv_flow_api.id(20320326745893503)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320623911893503)
,p_page_template_id=>wwv_flow_api.id(20320326745893503)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320700911893503)
,p_page_template_id=>wwv_flow_api.id(20320326745893503)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320801388893503)
,p_page_template_id=>wwv_flow_api.id(20320326745893503)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20320923951893503)
,p_page_template_id=>wwv_flow_api.id(20320326745893503)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20321006155893503)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321127503893503)
,p_page_template_id=>wwv_flow_api.id(20321006155893503)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321224047893503)
,p_page_template_id=>wwv_flow_api.id(20321006155893503)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321304426893503)
,p_page_template_id=>wwv_flow_api.id(20321006155893503)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321419430893503)
,p_page_template_id=>wwv_flow_api.id(20321006155893503)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20321511003893503)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321623432893503)
,p_page_template_id=>wwv_flow_api.id(20321511003893503)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321727960893503)
,p_page_template_id=>wwv_flow_api.id(20321511003893503)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321809310893503)
,p_page_template_id=>wwv_flow_api.id(20321511003893503)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20321910284893503)
,p_page_template_id=>wwv_flow_api.id(20321511003893503)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322025703893503)
,p_page_template_id=>wwv_flow_api.id(20321511003893503)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20322128241893504)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322206162893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322305254893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322426886893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322508347893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322626702893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322706587893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322803013893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20322923169893504)
,p_page_template_id=>wwv_flow_api.id(20322128241893504)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20323004047893504)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323103742893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323232201893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323332344893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323431928893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323516459893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323603350893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323728207893504)
,p_page_template_id=>wwv_flow_api.id(20323004047893504)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20323812756893504)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20323907061893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324008171893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324107639893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324211022893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324317072893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324406494893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324528468893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324608494893506)
,p_page_template_id=>wwv_flow_api.id(20323812756893504)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20324723328893506)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324825400893506)
,p_page_template_id=>wwv_flow_api.id(20324723328893506)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20324917602893506)
,p_page_template_id=>wwv_flow_api.id(20324723328893506)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325002262893506)
,p_page_template_id=>wwv_flow_api.id(20324723328893506)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325108161893506)
,p_page_template_id=>wwv_flow_api.id(20324723328893506)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325206419893506)
,p_page_template_id=>wwv_flow_api.id(20324723328893506)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325330315893506)
,p_page_template_id=>wwv_flow_api.id(20324723328893506)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20325426812893506)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325500984893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325604274893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325705255893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325825385893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20325928794893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326015265893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326109524893506)
,p_page_template_id=>wwv_flow_api.id(20325426812893506)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20326203763893506)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326327835893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326407693893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326518393893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326631287893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326714393893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326822246893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20326927381893506)
,p_page_template_id=>wwv_flow_api.id(20326203763893506)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20327030745893506)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327109897893507)
,p_page_template_id=>wwv_flow_api.id(20327030745893506)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20327230003893507)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327300046893507)
,p_page_template_id=>wwv_flow_api.id(20327230003893507)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327403263893507)
,p_page_template_id=>wwv_flow_api.id(20327230003893507)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327518306893507)
,p_page_template_id=>wwv_flow_api.id(20327230003893507)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327605813893507)
,p_page_template_id=>wwv_flow_api.id(20327230003893507)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20327723190893507)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327807244893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20327909705893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328003008893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328109024893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328213210893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328311485893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328431829893509)
,p_page_template_id=>wwv_flow_api.id(20327723190893507)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20328504099893509)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328602170893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328731652893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328819076893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20328918573893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329003375893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329113941893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329211777893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329309644893509)
,p_page_template_id=>wwv_flow_api.id(20328504099893509)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20329413096893509)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329508039893509)
,p_page_template_id=>wwv_flow_api.id(20329413096893509)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329617669893509)
,p_page_template_id=>wwv_flow_api.id(20329413096893509)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329714041893509)
,p_page_template_id=>wwv_flow_api.id(20329413096893509)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329814590893509)
,p_page_template_id=>wwv_flow_api.id(20329413096893509)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20329900921893509)
,p_page_template_id=>wwv_flow_api.id(20329413096893509)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330005736893509)
,p_page_template_id=>wwv_flow_api.id(20329413096893509)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20330114854893509)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330208110893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330318595893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330416636893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330529097893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330608984893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330709789893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20330821549893510)
,p_page_template_id=>wwv_flow_api.id(20330114854893509)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20336305652893568)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20336432612893575)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20336525959893575)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20336629863893575)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20336721674893575)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20336812020893576)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20330901289893515)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331020919893534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331122575893534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331203542893534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331322217893534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331408098893534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331521624893534)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331631078893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331732178893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20331804292893535)
,p_plug_template_id=>wwv_flow_api.id(20331732178893535)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20331920930893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332011315893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332119397893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332222104893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20332310758893535)
,p_plug_template_id=>wwv_flow_api.id(20332222104893535)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332406942893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332503969893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332631656893535)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20332725979893535)
,p_plug_template_id=>wwv_flow_api.id(20332631656893535)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20332817769893537)
,p_plug_template_id=>wwv_flow_api.id(20332631656893535)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20332931601893537)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20333032262893537)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334210729893546)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334308904893557)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334422068893557)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334529045893557)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334623528893557)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334716395893557)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334828540893557)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20334901552893559)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20335028434893559)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20335116394893559)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20335232632893559)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20335328998893559)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20335417052893559)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20335511652893559)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333131173893537)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333212501893545)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333324570893545)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333427659893545)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333502396893546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333629439893546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333709059893546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333826639893546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20333912090893546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20334017405893546)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20334109253893546)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20335612079893560)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20335706730893567)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20335815017893567)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20335925040893567)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20336009711893567)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20336102488893567)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20336208775893567)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(20336902674893576)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(20337122223893589)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(20337027037893584)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(20337219549893598)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(20324723328893506)
,p_error_template=>wwv_flow_api.id(20321006155893503)
,p_printer_friendly_template=>wwv_flow_api.id(20327230003893507)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(20319506114893473)
,p_default_button_template=>wwv_flow_api.id(20336305652893568)
,p_default_region_template=>wwv_flow_api.id(20332631656893535)
,p_default_chart_template=>wwv_flow_api.id(20332631656893535)
,p_default_form_template=>wwv_flow_api.id(20331732178893535)
,p_default_reportr_template=>wwv_flow_api.id(20332631656893535)
,p_default_tabform_template=>wwv_flow_api.id(20332631656893535)
,p_default_wizard_template=>wwv_flow_api.id(20331732178893535)
,p_default_menur_template=>wwv_flow_api.id(20331203542893534)
,p_default_listr_template=>wwv_flow_api.id(20332631656893535)
,p_default_irr_template=>wwv_flow_api.id(20332119397893535)
,p_default_report_template=>wwv_flow_api.id(20333709059893546)
,p_default_label_template=>wwv_flow_api.id(20335815017893567)
,p_default_menu_template=>wwv_flow_api.id(20336902674893576)
,p_default_calendar_template=>wwv_flow_api.id(20337027037893584)
,p_default_list_template=>wwv_flow_api.id(20335328998893559)
,p_default_option_label=>wwv_flow_api.id(20335815017893567)
,p_default_required_label=>wwv_flow_api.id(20336102488893567)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(20337506798893626)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(20344600392942759)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(20337329057893600)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(20337329057893600)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20181005164316'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20339618176899678)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20332631656893535)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20340309995906757)
,p_plug_name=>'Resultado'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20332119397893535)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select A.cdmedida ||''-''|| A.correlativo as llanta, A.nueva as N,A.reencauche1 as R1,A.reencauche2 as R2,A.reencauche3 as R3,costo,fecharecibe,seriefact,factura, B.CDCLASACT||''-''|| B.CORRACTIVO as unidad',
' from trecepcion_n A  INNER JOIN TNEUMATICOS B ON A.CDMEDIDA=B.CDMEDIDA AND A.CORRELATIVO=B.CORRELATIVO where fecharecibe >= :P1_INICIO and fecharecibe <= :P1_FIN  and estado not in (''I'',''B'') ORDER BY FECHARECIBE DESC'))
...
,p_prn_page_header=>'LLANTAS REENCAUCHADAS'
,p_prn_page_header_font_color=>'#1B00B3'
,p_prn_page_header_font_family=>'Helvetica'
,p_prn_page_header_font_weight=>'bold'
,p_prn_page_header_font_size=>'18'
,p_prn_page_footer=>'LAS PIPAS S.A.'
,p_prn_page_footer_font_color=>'#1B00B3'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(20340412494906757)
,p_name=>'Resultado'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>20340412494906757
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20341209906906792)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20341321546906792)
,p_db_column_name=>'FECHARECIBE'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Fecharecibe'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHARECIBE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20342320461918246)
,p_db_column_name=>'N'
,p_display_order=>9
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20342431690918248)
,p_db_column_name=>'R1'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20342500666918248)
,p_db_column_name=>'R2'
,p_display_order=>11
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20342632538918248)
,p_db_column_name=>'R3'
,p_display_order=>12
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21208020903287504)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21210409146429757)
,p_db_column_name=>'SERIEFACT'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'Seriefact'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'SERIEFACT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21210508080429757)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(36490312502953990)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(20341520731909879)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'203416'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100
,p_report_columns=>'LLANTA:N:R1:R2:R3:COSTO:FECHARECIBE:SERIEFACT:FACTURA:UNIDAD:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20341929735912432)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(20339618176899678)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20336305652893568)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20339923708901501)
,p_name=>'P1_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20339618176899678)
,p_prompt=>'Inicio'
...
,p_field_template=>wwv_flow_api.id(20335815017893567)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20340119395903526)
,p_name=>'P1_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(20339618176899678)
,p_prompt=>'Fin'
...
,p_step_template=>wwv_flow_api.id(20319506114893473)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180220132612'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20337802914893640)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20331732178893535)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20338129620893654)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(20337802914893640)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20337915596893645)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20337802914893640)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20338012754893650)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20338325685893657)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20338225819893656)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20338520521893657)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20338416906893657)
,p_process_sequence=>10
