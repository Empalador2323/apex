...
,p_default_application_id=>383
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 383 - MANTENIMIENTO_GPS
--
-- Application Export:
--   Application:     383
--   Name:            MANTENIMIENTO_GPS
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,383)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'MANTENIMIENTO_GPS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_383')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'56F658B27CAFEFE78FB6948E727F00415C0FE8AB4A5C1F958443F864D5DA89F0'
...
,p_authentication_id=>wwv_flow_api.id(86772401605520151)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:MANTENIMIENTO_GPS'
...
,p_last_upd_yyyymmddhh24miss=>'20200930083528'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13029908865086955)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13030055866086955)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13030168552086955)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13030375753086955)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13030453394086955)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13030599384086955)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(86754215627520117)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(105479028613285265)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(86772220118520146)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(86774025207520221)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_MANTENIMIENTO_GPS'
,p_tab_text=>'Mantenimiento Gps'
,p_tab_step=>1
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(86773720172520153)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(86775709519520256)
,p_parent_id=>0
,p_short_name=>'Mantenimiento Gps'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86754311008520118)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86754413953520120)
,p_page_template_id=>wwv_flow_api.id(86754311008520118)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86754523331520121)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86754622617520121)
,p_page_template_id=>wwv_flow_api.id(86754523331520121)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86754718682520121)
,p_page_template_id=>wwv_flow_api.id(86754523331520121)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86754816238520121)
,p_page_template_id=>wwv_flow_api.id(86754523331520121)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86754907419520121)
,p_page_template_id=>wwv_flow_api.id(86754523331520121)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755014524520121)
,p_page_template_id=>wwv_flow_api.id(86754523331520121)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86755102475520121)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755201520520123)
,p_page_template_id=>wwv_flow_api.id(86755102475520121)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755302306520123)
,p_page_template_id=>wwv_flow_api.id(86755102475520121)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755425867520123)
,p_page_template_id=>wwv_flow_api.id(86755102475520121)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755525362520123)
,p_page_template_id=>wwv_flow_api.id(86755102475520121)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755625979520123)
,p_page_template_id=>wwv_flow_api.id(86755102475520121)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755729267520123)
,p_page_template_id=>wwv_flow_api.id(86755102475520121)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86755810801520123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86755932744520123)
,p_page_template_id=>wwv_flow_api.id(86755810801520123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756025493520123)
,p_page_template_id=>wwv_flow_api.id(86755810801520123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756101712520123)
,p_page_template_id=>wwv_flow_api.id(86755810801520123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756223922520123)
,p_page_template_id=>wwv_flow_api.id(86755810801520123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86756315884520123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756417453520123)
,p_page_template_id=>wwv_flow_api.id(86756315884520123)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756503474520123)
,p_page_template_id=>wwv_flow_api.id(86756315884520123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756604578520123)
,p_page_template_id=>wwv_flow_api.id(86756315884520123)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756702353520123)
,p_page_template_id=>wwv_flow_api.id(86756315884520123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86756814139520123)
,p_page_template_id=>wwv_flow_api.id(86756315884520123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86756924943520123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757023842520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757124006520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757223450520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757303915520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757401886520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757500037520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757604898520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757718562520123)
,p_page_template_id=>wwv_flow_api.id(86756924943520123)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86757817028520123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86757913312520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758025610520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758104820520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758217606520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758300009520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758425468520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758525265520123)
,p_page_template_id=>wwv_flow_api.id(86757817028520123)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86758625171520123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758718913520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758825978520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86758903015520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759000593520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759122084520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759228144520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759313258520123)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759402846520125)
,p_page_template_id=>wwv_flow_api.id(86758625171520123)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86759531090520125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759607962520125)
,p_page_template_id=>wwv_flow_api.id(86759531090520125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759713187520125)
,p_page_template_id=>wwv_flow_api.id(86759531090520125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759808648520125)
,p_page_template_id=>wwv_flow_api.id(86759531090520125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86759900992520125)
,p_page_template_id=>wwv_flow_api.id(86759531090520125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760008473520125)
,p_page_template_id=>wwv_flow_api.id(86759531090520125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760104636520125)
,p_page_template_id=>wwv_flow_api.id(86759531090520125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86760222731520125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760314112520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760416081520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760501706520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760610762520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760720238520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760813318520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86760911259520125)
,p_page_template_id=>wwv_flow_api.id(86760222731520125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86761022543520125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761127452520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761226807520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761321154520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761404743520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761525760520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761605561520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761707489520126)
,p_page_template_id=>wwv_flow_api.id(86761022543520125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86761831225520126)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86761923420520128)
,p_page_template_id=>wwv_flow_api.id(86761831225520126)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86762003736520128)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762121271520128)
,p_page_template_id=>wwv_flow_api.id(86762003736520128)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762224262520128)
,p_page_template_id=>wwv_flow_api.id(86762003736520128)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762302447520128)
,p_page_template_id=>wwv_flow_api.id(86762003736520128)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762411434520128)
,p_page_template_id=>wwv_flow_api.id(86762003736520128)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86762505322520128)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762622375520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762709338520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762806005520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86762924437520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763002529520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763123668520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763226179520129)
,p_page_template_id=>wwv_flow_api.id(86762505322520128)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86763302549520129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763417548520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763517202520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763622276520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763710352520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763816902520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86763910001520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764005732520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764100552520129)
,p_page_template_id=>wwv_flow_api.id(86763302549520129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86764213427520129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764311910520129)
,p_page_template_id=>wwv_flow_api.id(86764213427520129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764421805520129)
,p_page_template_id=>wwv_flow_api.id(86764213427520129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764501407520129)
,p_page_template_id=>wwv_flow_api.id(86764213427520129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764629687520129)
,p_page_template_id=>wwv_flow_api.id(86764213427520129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764716328520129)
,p_page_template_id=>wwv_flow_api.id(86764213427520129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86764809951520129)
,p_page_template_id=>wwv_flow_api.id(86764213427520129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(86764926186520129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765027765520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765100188520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765225997520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765321082520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765409864520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765531521520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(86765605882520131)
,p_page_template_id=>wwv_flow_api.id(86764926186520129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(86771112075520143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(86771221186520143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(86771328197520143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(86771401998520143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(86771507559520143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(86771613277520143)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86765726696520132)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86765801987520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86765912540520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766003829520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766123681520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766209765520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766311590520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766419186520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766530867520132)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(86766619168520132)
,p_plug_template_id=>wwv_flow_api.id(86766530867520132)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766723764520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766817130520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86766924759520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86767000076520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(86767115240520134)
,p_plug_template_id=>wwv_flow_api.id(86767000076520134)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86767211124520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86767319358520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86767418213520134)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(86767508630520134)
,p_plug_template_id=>wwv_flow_api.id(86767418213520134)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(86767625892520135)
,p_plug_template_id=>wwv_flow_api.id(86767418213520134)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86767706272520135)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86767820237520135)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769013738520137)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769129904520137)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769206994520137)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769314783520137)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769426252520137)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769513485520137)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769601885520137)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769704493520137)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769827198520137)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86769917119520137)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86770021819520137)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86770124468520137)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86770210706520137)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(86770325545520137)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86767915833520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768005412520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768128515520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768220030520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768301655520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768408977520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768522441520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768621647520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768712370520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768806169520135)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(86768928893520135)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86770422639520139)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86770503320520139)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86770621408520139)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86770719621520139)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86770802133520140)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86770915552520140)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(86771007618520142)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(86771729979520143)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(86771921114520145)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(86771830675520145)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(86772003902520146)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(86759531090520125)
,p_error_template=>wwv_flow_api.id(86755810801520123)
,p_printer_friendly_template=>wwv_flow_api.id(86762003736520128)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(86754311008520118)
,p_default_button_template=>wwv_flow_api.id(86771112075520143)
,p_default_region_template=>wwv_flow_api.id(86767418213520134)
,p_default_chart_template=>wwv_flow_api.id(86767418213520134)
,p_default_form_template=>wwv_flow_api.id(86766530867520132)
,p_default_reportr_template=>wwv_flow_api.id(86767418213520134)
,p_default_tabform_template=>wwv_flow_api.id(86767418213520134)
,p_default_wizard_template=>wwv_flow_api.id(86766530867520132)
,p_default_menur_template=>wwv_flow_api.id(86766003829520132)
,p_default_listr_template=>wwv_flow_api.id(86767418213520134)
,p_default_irr_template=>wwv_flow_api.id(86766924759520134)
,p_default_report_template=>wwv_flow_api.id(86768522441520135)
,p_default_label_template=>wwv_flow_api.id(86770621408520139)
,p_default_menu_template=>wwv_flow_api.id(86771729979520143)
,p_default_calendar_template=>wwv_flow_api.id(86771830675520145)
,p_default_list_template=>wwv_flow_api.id(86770124468520137)
,p_default_option_label=>wwv_flow_api.id(86770621408520139)
,p_default_required_label=>wwv_flow_api.id(86770915552520140)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(86774621915520240)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(86772310702520151)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(86772401605520151)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(86772620238520151)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(86772129985520146)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(86772129985520146)
,p_tab_set=>'TS1'
,p_name=>'Mantenimiento Gps'
,p_alias=>'HOME'
,p_step_title=>'Mantenimiento Gps'
...
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200311113009'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86774126453520231)
,p_plug_name=>'MANTENIMIENTO_GPS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(86766530867520132)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86775830626520256)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(86766003829520132)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(86773720172520153)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(86771729979520143)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86774228174520232)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(86774126453520231)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(86771112075520143)
,p_button_image_alt=>'Cancel'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86774507207520232)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(86774723234520243)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86774814505520250)
,p_name=>'P1_CORRELATIVO'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(86774126453520231)
...
,p_field_template=>wwv_flow_api.id(86770621408520139)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86774900202520250)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(86774126453520231)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86775316299520254)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86775528111520254)
,p_process_sequence=>1
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from MANTENIMIENTO_GPS'
,p_attribute_02=>'MANTENIMIENTO_GPS'
,p_attribute_03=>'P1_CORRELATIVO'
,p_attribute_04=>'CORRELATIVO'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86784327844901681)
...
'BEGIN',
'INSERT INTO MANTENIMIENTO_GPS (CORRELATIVO,UNIDAD,COMENTARIO) VALUES (MANT_GPS.NEXTVAL,:P1_UNIDAD,:P1_COMENTARIO);',
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(86774507207520232)
);
end;
/
...
,p_step_template=>wwv_flow_api.id(86754311008520118)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200309151802'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86772903196520153)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(86766530867520132)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86773205296520153)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(86772903196520153)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86773029981520153)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(86772903196520153)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86773106185520153)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86773406033520153)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86773306434520153)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86773630348520153)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86773506958520153)
,p_process_sequence=>10
