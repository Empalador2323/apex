...
,p_default_application_id=>345
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 345 - LP_Reporte_KM update
--
-- Application Export:
--   Application:     345
--   Name:            LP_Reporte_KM update
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,345)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_Reporte_KM update')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_310345')
...
,p_authentication_id=>wwv_flow_api.id(48062650732622446)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20210325145040'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8806718784068536)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8806801854068536)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8806947766068536)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8807183767068536)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8807212074068536)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8807326459068536)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(47752640473392708)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(48061457720512873)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(47770641658392766)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(47771835935392782)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(47772248084392787)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47752731341392715)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47752829157392719)
,p_page_template_id=>wwv_flow_api.id(47752731341392715)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47752957482392721)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753040162392721)
,p_page_template_id=>wwv_flow_api.id(47752957482392721)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753155824392721)
,p_page_template_id=>wwv_flow_api.id(47752957482392721)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753252792392723)
,p_page_template_id=>wwv_flow_api.id(47752957482392721)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753336786392723)
,p_page_template_id=>wwv_flow_api.id(47752957482392721)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753461143392723)
,p_page_template_id=>wwv_flow_api.id(47752957482392721)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47753539582392723)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753659041392723)
,p_page_template_id=>wwv_flow_api.id(47753539582392723)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753753596392723)
,p_page_template_id=>wwv_flow_api.id(47753539582392723)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753849285392723)
,p_page_template_id=>wwv_flow_api.id(47753539582392723)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47753940001392723)
,p_page_template_id=>wwv_flow_api.id(47753539582392723)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754054478392723)
,p_page_template_id=>wwv_flow_api.id(47753539582392723)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754132769392723)
,p_page_template_id=>wwv_flow_api.id(47753539582392723)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47754261213392723)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754349214392723)
,p_page_template_id=>wwv_flow_api.id(47754261213392723)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754433215392723)
,p_page_template_id=>wwv_flow_api.id(47754261213392723)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754554580392723)
,p_page_template_id=>wwv_flow_api.id(47754261213392723)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754629280392723)
,p_page_template_id=>wwv_flow_api.id(47754261213392723)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47754748840392723)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754829774392723)
,p_page_template_id=>wwv_flow_api.id(47754748840392723)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47754954435392723)
,p_page_template_id=>wwv_flow_api.id(47754748840392723)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755051909392723)
,p_page_template_id=>wwv_flow_api.id(47754748840392723)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755156868392723)
,p_page_template_id=>wwv_flow_api.id(47754748840392723)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755249661392723)
,p_page_template_id=>wwv_flow_api.id(47754748840392723)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47755352816392723)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755449133392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755550948392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755636357392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755754289392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755831562392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47755929213392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756049819392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756148710392723)
,p_page_template_id=>wwv_flow_api.id(47755352816392723)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47756251978392723)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756360170392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756461573392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756539899392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756639242392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756758469392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756832990392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47756943390392723)
,p_page_template_id=>wwv_flow_api.id(47756251978392723)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47757058233392724)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757155587392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757242277392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757344065392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757448649392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757546896392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757645453392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757751890392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47757845149392724)
,p_page_template_id=>wwv_flow_api.id(47757058233392724)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47757953068392724)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758052608392726)
,p_page_template_id=>wwv_flow_api.id(47757953068392724)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758149945392726)
,p_page_template_id=>wwv_flow_api.id(47757953068392724)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758229935392726)
,p_page_template_id=>wwv_flow_api.id(47757953068392724)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758334342392726)
,p_page_template_id=>wwv_flow_api.id(47757953068392724)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758442613392726)
,p_page_template_id=>wwv_flow_api.id(47757953068392724)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758538515392726)
,p_page_template_id=>wwv_flow_api.id(47757953068392724)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47758659841392726)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758733463392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758837108392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47758934958392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759048391392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759154752392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759250150392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759336517392726)
,p_page_template_id=>wwv_flow_api.id(47758659841392726)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47759441491392726)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759555111392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759639458392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759735164392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759839552392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47759945935392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760034357392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760158879392726)
,p_page_template_id=>wwv_flow_api.id(47759441491392726)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47760240867392726)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760359158392726)
,p_page_template_id=>wwv_flow_api.id(47760240867392726)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47760442098392726)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760533527392727)
,p_page_template_id=>wwv_flow_api.id(47760442098392726)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760647150392727)
,p_page_template_id=>wwv_flow_api.id(47760442098392726)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760741939392727)
,p_page_template_id=>wwv_flow_api.id(47760442098392726)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47760838715392727)
,p_page_template_id=>wwv_flow_api.id(47760442098392726)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47760929582392727)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761050726392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761155792392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761239310392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761332484392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761439176392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761558246392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761629651392727)
,p_page_template_id=>wwv_flow_api.id(47760929582392727)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47761730257392727)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761836919392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47761936055392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762048868392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762148701392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762255722392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762330193392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762441309392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762543036392727)
,p_page_template_id=>wwv_flow_api.id(47761730257392727)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47762639123392727)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762735200392727)
,p_page_template_id=>wwv_flow_api.id(47762639123392727)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762829479392727)
,p_page_template_id=>wwv_flow_api.id(47762639123392727)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47762929999392727)
,p_page_template_id=>wwv_flow_api.id(47762639123392727)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763033234392727)
,p_page_template_id=>wwv_flow_api.id(47762639123392727)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763134035392727)
,p_page_template_id=>wwv_flow_api.id(47762639123392727)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763229504392727)
,p_page_template_id=>wwv_flow_api.id(47762639123392727)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47763341560392727)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763446299392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763552690392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763631692392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763754909392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763858852392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47763936959392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47764057441392727)
,p_page_template_id=>wwv_flow_api.id(47763341560392727)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(47769559465392752)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(47769635532392754)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(47769744146392754)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(47769856789392755)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(47769951335392755)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(47770043785392757)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764136928392729)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764240084392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764358220392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764457999392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764561180392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764639016392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764760796392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764859567392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47764945827392737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(47765042279392737)
,p_plug_template_id=>wwv_flow_api.id(47764945827392737)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765150973392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765258094392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765353527392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765460297392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(47765538533392738)
,p_plug_template_id=>wwv_flow_api.id(47765460297392738)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765635481392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765746374392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47765835363392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(47765941068392738)
,p_plug_template_id=>wwv_flow_api.id(47765835363392738)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(47766059307392738)
,p_plug_template_id=>wwv_flow_api.id(47765835363392738)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47766136938392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47766233430392738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47767432893392744)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47767542102392746)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47767630364392746)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47767736441392746)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47767830823392746)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47767936672392746)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768051106392746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768158977392746)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768232362392746)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768351008392746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768435882392746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768545331392748)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768645310392748)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(47768761398392748)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766351753392740)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766451348392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766552737392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766650937392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766751472392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766838988392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47766936009392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47767029571392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47767131498392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47767248792392743)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(47767346399392743)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47768845874392748)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47768946138392751)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47769046300392751)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47769161123392751)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47769242951392751)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47769340871392751)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(47769429734392752)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(47770140820392757)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(47770354798392762)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(47770245411392760)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(47770459256392765)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(47757953068392724)
,p_error_template=>wwv_flow_api.id(47754261213392723)
,p_printer_friendly_template=>wwv_flow_api.id(47760442098392726)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(47752731341392715)
,p_default_button_template=>wwv_flow_api.id(47769559465392752)
,p_default_region_template=>wwv_flow_api.id(47765835363392738)
,p_default_chart_template=>wwv_flow_api.id(47765835363392738)
,p_default_form_template=>wwv_flow_api.id(47764945827392737)
,p_default_reportr_template=>wwv_flow_api.id(47765835363392738)
,p_default_tabform_template=>wwv_flow_api.id(47765835363392738)
,p_default_wizard_template=>wwv_flow_api.id(47764945827392737)
,p_default_menur_template=>wwv_flow_api.id(47764457999392737)
,p_default_listr_template=>wwv_flow_api.id(47765835363392738)
,p_default_irr_template=>wwv_flow_api.id(47765353527392738)
,p_default_report_template=>wwv_flow_api.id(47766936009392743)
,p_default_label_template=>wwv_flow_api.id(47769046300392751)
,p_default_menu_template=>wwv_flow_api.id(47770140820392757)
,p_default_calendar_template=>wwv_flow_api.id(47770245411392760)
,p_default_list_template=>wwv_flow_api.id(47768545331392748)
,p_default_option_label=>wwv_flow_api.id(47769046300392751)
,p_default_required_label=>wwv_flow_api.id(47769340871392751)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(47770735272392768)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(48062650732622446)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(47770551973392765)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(47770551973392765)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190917124750'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(29150800104306248)
,p_plug_name=>'update'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47765835363392738)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(37484714533058334)
,p_name=>'Datos'
,p_template=>wwv_flow_api.id(47765835363392738)
...
'select * from (',
'select sum (recorrido), cdclasact, corract,''km actual'' from tvales where cdclasact||''-''||corract=:P1_UNIDAD   group by cdclasact, corract',
'union all',
'select sum (recorrido), cdclasact, corract,''km hasta ultio servicio'' from tvales where cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract',
'union all',
'select sum (recorrido), cdclasact, corract, ''km recorrido'' from tvales where  cdclasact||''-''||corract=:P1_UNIDAD   and fecha>=:P1_FECHA_INICIAL group by cdclasact, corract',
'union all ',
'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad), cdclasact, corract,''1er menor'' from tvales where  cdclasact||''-''||corract=:P1_UNIDAD   and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract',
'union all ',
'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*2, cdclasact, corract,''2er menor'' from tvales where   cdclasact||''-''||corract=:P1_UNIDAD   and fecha<=:P1_FECHA_INICIAL group by cdclasact, corrac'
||'t',
'union all ',
'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*3, cdclasact, corract,''3er menor'' from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract',
'union all ',
'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*4, cdclasact, corract,''medio'' from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract',
'union all ',
'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*16, cdclasact, corract,''mayor'' from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract',
'union all ',
'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*32, cdclasact, corract,''Super mayor'' from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corra'
||'ct',
'union all ',
'select kms_servicio , cdclase, correlativo, ''SERVICIOS'' from tactivos where  cdclase||''-''||correlativo=:P1_UNIDAD  group by cdclase, correlativo, kms_servicio',
')',
'',
''))
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(47766936009392743)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(23096514634088050)
,p_query_column_id=>1
,p_column_alias=>'SUM(RECORRIDO)'
,p_column_display_sequence=>1
,p_column_heading=>'Sum(Recorrido)'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(23096624536088051)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(23096731721088053)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(23167014997822767)
,p_query_column_id=>4
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47787560372439541)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47788149552455393)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(47787560372439541)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47769559465392752)
,p_button_image_alt=>'Generar'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(29152708200317978)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(29150800104306248)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(29159505140421189)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29151318573314485)
,p_name=>'P1_CDCLASACT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Cdclasact'
...
,p_field_template=>wwv_flow_api.id(47769046300392751)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29151530288314493)
,p_name=>'P1_CORRACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Corract'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29151731509314493)
,p_name=>'P1_KMACTUAL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Kmactual'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29151924680314493)
,p_name=>'P1_KMPROXSERV'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Kmproxserv'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29152120012314493)
,p_name=>'P1_KMSVMED'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Kmsvmed'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29152313309314493)
,p_name=>'P1_KMSVMA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Kmsvma'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29152514907314495)
,p_name=>'P1_KMSVSMA'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(29150800104306248)
,p_prompt=>'Kmsvsma'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47775735369031382)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47787560372439541)
,p_prompt=>'Unidad'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47775959243031418)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47776136108031418)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(29159704924430596)
,p_name=>'llenar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(29159505140421189)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29160014758430606)
,p_event_id=>wwv_flow_api.id(29159704924430596)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_KMACTUAL'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select sum (recorrido) from tvales where cdclasact||''-''||corract=:P1_UNIDAD  '
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29160310267455103)
,p_event_id=>wwv_flow_api.id(29159704924430596)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_KMSVMED'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*4 from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract'
,p_attribute_07=>'P1_FECHA_INICIAL,P1_UNIDAD'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29160530311461007)
,p_event_id=>wwv_flow_api.id(29159704924430596)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_KMSVMA'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*16 from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract'
,p_attribute_07=>'P1_FECHA_INICIAL,P1_UNIDAD'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29160720391465571)
,p_event_id=>wwv_flow_api.id(29159704924430596)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_KMSVSMA'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select sum (recorrido)+(select kms_servicio from tactivos  where cdclase||''-''||correlativo =:P1_unidad)*32 from tvales where  cdclasact||''-''||corract=:P1_UNIDAD  and fecha<=:P1_FECHA_INICIAL group by cdclasact, corract'
,p_attribute_07=>'P1_FECHA_INICIAL,P1_UNIDAD'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(29153714350338706)
...
'begin',
'update tactivos set recorrido = :P1_KMACTUAL where cdclase||''-''|| correlativo= :P1_UNIDAD;',
'update trecorre set kmactual = :P1_KMACTUAL,kmproxserv= :P1_KMPROXSERV, kmsvmed= :P1_KMSVMED, kmsvma = :P1_KMSVMA,kmsvsma = :P1_KMSVSMA where cdclasac||''-''||corract =:P1_UNIDAD;',
'end;'))
,p_process_error_message=>'error'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(29152708200317978)
,p_process_success_message=>'succes'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(29164632254561542)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47789833125639855)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47764457999392737)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47791936391801604)
,p_plug_name=>'CHECKLIST'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47765353527392738)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(47792051390801604)
,p_name=>'CHECKLIST'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47792257659801607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47792329419801607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47792461240801607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47792535777801607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47792748080801607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(48024954450314357)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(48025741024314362)
,p_db_column_name=>'OT'
,p_display_order=>15
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(48056929778145976)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(48057858843193266)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(47792937215811394)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(48058455705294783)
,p_report_id=>wwv_flow_api.id(47792937215811394)
,p_name=>'marcar'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(48060157502475102)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(47791936391801604)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47790134058642518)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47789833125639855)
,p_prompt=>'Nmorden'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47791444514774402)
,p_name=>'P2_OT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(47789833125639855)
,p_prompt=>'OT'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47791559678789474)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47791852037789482)
,p_event_id=>wwv_flow_api.id(47791559678789474)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
,p_step_template=>wwv_flow_api.id(47752731341392715)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47771057949392773)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47764945827392737)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47771332195392779)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(47771057949392773)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47771143019392776)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(47771057949392773)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47771255108392779)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47771555033392782)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47771454742392779)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47771757899392782)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47771636271392782)
,p_process_sequence=>10
