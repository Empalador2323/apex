...
,p_default_application_id=>365
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 365 - 365
--
-- Application Export:
--   Application:     365
--   Name:            365
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,365)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_365')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'3434F2D7D54A0099089523BDEEE644363E974F3558B9ACBF1EDF35E1E1CD517F'
...
,p_authentication_id=>wwv_flow_api.id(42267310478671254)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20181126181723'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8838848612073755)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8838986307073755)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8839067873073755)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8839238912073755)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8839320116073755)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8839467305073755)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(42249102457671123)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(42267109477671242)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(42268926123671265)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_PAGE_1'
,p_tab_text=>'Page 1'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(42268615549671262)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(42269025009671267)
,p_parent_id=>0
,p_short_name=>'Page 1'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42249212337671137)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42249328232671143)
,p_page_template_id=>wwv_flow_api.id(42249212337671137)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42249404436671151)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42249514103671151)
,p_page_template_id=>wwv_flow_api.id(42249404436671151)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42249617290671151)
,p_page_template_id=>wwv_flow_api.id(42249404436671151)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42249709173671151)
,p_page_template_id=>wwv_flow_api.id(42249404436671151)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42249804326671151)
,p_page_template_id=>wwv_flow_api.id(42249404436671151)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42249931942671151)
,p_page_template_id=>wwv_flow_api.id(42249404436671151)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42250032505671151)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250123774671151)
,p_page_template_id=>wwv_flow_api.id(42250032505671151)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250230217671151)
,p_page_template_id=>wwv_flow_api.id(42250032505671151)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250303985671151)
,p_page_template_id=>wwv_flow_api.id(42250032505671151)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250430924671151)
,p_page_template_id=>wwv_flow_api.id(42250032505671151)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250506389671151)
,p_page_template_id=>wwv_flow_api.id(42250032505671151)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250630565671151)
,p_page_template_id=>wwv_flow_api.id(42250032505671151)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42250712378671151)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250831385671153)
,p_page_template_id=>wwv_flow_api.id(42250712378671151)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42250923736671153)
,p_page_template_id=>wwv_flow_api.id(42250712378671151)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251017526671153)
,p_page_template_id=>wwv_flow_api.id(42250712378671151)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251120339671153)
,p_page_template_id=>wwv_flow_api.id(42250712378671151)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42251208679671153)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251323916671153)
,p_page_template_id=>wwv_flow_api.id(42251208679671153)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251405340671153)
,p_page_template_id=>wwv_flow_api.id(42251208679671153)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251524411671153)
,p_page_template_id=>wwv_flow_api.id(42251208679671153)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251618716671153)
,p_page_template_id=>wwv_flow_api.id(42251208679671153)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251708666671153)
,p_page_template_id=>wwv_flow_api.id(42251208679671153)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42251832222671153)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42251912986671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252017577671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252105226671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252214911671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252300414671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252416501671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252517022671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252620550671153)
,p_page_template_id=>wwv_flow_api.id(42251832222671153)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42252729176671157)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252818824671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42252917682671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253016904671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253116210671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253220473671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253303729671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253413305671157)
,p_page_template_id=>wwv_flow_api.id(42252729176671157)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42253524019671157)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253611546671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253706650671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253813746671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42253913429671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254031201671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254114131671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254206405671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254319076671157)
,p_page_template_id=>wwv_flow_api.id(42253524019671157)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42254416794671157)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254528845671157)
,p_page_template_id=>wwv_flow_api.id(42254416794671157)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254600831671157)
,p_page_template_id=>wwv_flow_api.id(42254416794671157)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254701115671157)
,p_page_template_id=>wwv_flow_api.id(42254416794671157)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254823755671157)
,p_page_template_id=>wwv_flow_api.id(42254416794671157)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42254917978671157)
,p_page_template_id=>wwv_flow_api.id(42254416794671157)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255009404671157)
,p_page_template_id=>wwv_flow_api.id(42254416794671157)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42255119291671157)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255200104671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255314635671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255417073671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255515660671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255619768671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255726030671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42255832566671159)
,p_page_template_id=>wwv_flow_api.id(42255119291671157)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42255915927671159)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256027527671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256109574671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256202962671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256302916671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256432525671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256530540671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256612492671159)
,p_page_template_id=>wwv_flow_api.id(42255915927671159)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42256710001671168)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42256832542671168)
,p_page_template_id=>wwv_flow_api.id(42256710001671168)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42256910437671168)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257023150671170)
,p_page_template_id=>wwv_flow_api.id(42256910437671168)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257115699671170)
,p_page_template_id=>wwv_flow_api.id(42256910437671168)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257216148671170)
,p_page_template_id=>wwv_flow_api.id(42256910437671168)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257331748671170)
,p_page_template_id=>wwv_flow_api.id(42256910437671168)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42257403996671170)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257523408671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257613050671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257718339671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257801622671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42257905789671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258015482671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258119325671170)
,p_page_template_id=>wwv_flow_api.id(42257403996671170)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42258215626671170)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258332244671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258403081671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258514031671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258618014671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258729625671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258825169671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42258907054671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259013115671171)
,p_page_template_id=>wwv_flow_api.id(42258215626671170)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42259118894671181)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259215838671181)
,p_page_template_id=>wwv_flow_api.id(42259118894671181)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259319211671181)
,p_page_template_id=>wwv_flow_api.id(42259118894671181)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259418205671181)
,p_page_template_id=>wwv_flow_api.id(42259118894671181)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259515732671181)
,p_page_template_id=>wwv_flow_api.id(42259118894671181)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259616653671181)
,p_page_template_id=>wwv_flow_api.id(42259118894671181)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259722469671181)
,p_page_template_id=>wwv_flow_api.id(42259118894671181)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42259825242671181)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42259911844671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42260023602671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42260114479671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42260220529671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42260311373671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42260402057671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42260518659671181)
,p_page_template_id=>wwv_flow_api.id(42259825242671181)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42266017713671218)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42266101751671223)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42266204490671223)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42266326216671223)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42266408423671223)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42266527645671223)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42260624405671184)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42260714895671192)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42260807263671192)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42260908837671192)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261031162671192)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261123704671192)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261203841671192)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261303163671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261407903671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42261522398671193)
,p_plug_template_id=>wwv_flow_api.id(42261407903671193)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261609957671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261731372671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261829148671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42261912478671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42262028567671193)
,p_plug_template_id=>wwv_flow_api.id(42261912478671193)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42262123512671193)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42262217774671195)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42262322195671195)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42262430951671195)
,p_plug_template_id=>wwv_flow_api.id(42262322195671195)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42262512344671195)
,p_plug_template_id=>wwv_flow_api.id(42262322195671195)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42262621056671195)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42262701529671195)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42263912985671206)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264018465671209)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264113707671209)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264215619671209)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264328870671209)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264424376671209)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264506029671209)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264626196671209)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264730962671209)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264813396671209)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42264926012671209)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42265030150671209)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42265121426671209)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42265218660671210)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42262811985671196)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42262909398671200)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263000892671201)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263119043671204)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263221933671204)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263312431671204)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263401426671206)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263514139671206)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263630360671206)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263728550671206)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42263800840671206)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265321060671210)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265421223671218)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265515071671218)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265630969671218)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265717189671218)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265803732671218)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42265926989671218)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(42266627946671223)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(42266804248671229)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(42266726420671225)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(42266930119671237)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(42254416794671157)
,p_error_template=>wwv_flow_api.id(42250712378671151)
,p_printer_friendly_template=>wwv_flow_api.id(42256910437671168)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(42249212337671137)
,p_default_button_template=>wwv_flow_api.id(42266017713671218)
,p_default_region_template=>wwv_flow_api.id(42262322195671195)
,p_default_chart_template=>wwv_flow_api.id(42262322195671195)
,p_default_form_template=>wwv_flow_api.id(42261407903671193)
,p_default_reportr_template=>wwv_flow_api.id(42262322195671195)
,p_default_tabform_template=>wwv_flow_api.id(42262322195671195)
,p_default_wizard_template=>wwv_flow_api.id(42261407903671193)
,p_default_menur_template=>wwv_flow_api.id(42260908837671192)
,p_default_listr_template=>wwv_flow_api.id(42262322195671195)
,p_default_irr_template=>wwv_flow_api.id(42261829148671193)
,p_default_report_template=>wwv_flow_api.id(42263401426671206)
,p_default_label_template=>wwv_flow_api.id(42265515071671218)
,p_default_menu_template=>wwv_flow_api.id(42266627946671223)
,p_default_calendar_template=>wwv_flow_api.id(42266726420671225)
,p_default_list_template=>wwv_flow_api.id(42265030150671209)
,p_default_option_label=>wwv_flow_api.id(42265515071671218)
,p_default_required_label=>wwv_flow_api.id(42265803732671218)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(42267209369671250)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(42267310478671254)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(42267516797671254)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(42267014988671239)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(42267014988671239)
,p_tab_set=>'TS1'
,p_name=>'Page 1'
,p_alias=>'HOME'
,p_step_title=>'Page 1'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42269116454671268)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42260908837671192)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(42268615549671262)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(42266627946671223)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42296706593502857)
,p_plug_name=>'Galones/Entregas'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42262322195671195)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42703101675655309)
,p_plug_name=>'365'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42261829148671193)
,p_plug_display_sequence=>40
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select * from ( ',
' select  pilotodes codigo, nombres||'' '' || apellidos nombre, cod_sucursal estacion ,nom_seccion seccion ,status status, galones galones, 0 km, 0 horas,0 fuleos,',
'   EXTRACT(MONTH FROM fechasale) mes,sysdate-fec_ingreso Tiempo',
'  from tnotaviaje a inner join empleados b on a.pilotodes=b.cod_emp inner join tdetnota c on a.nmnota=c.nmnota ',
'  inner join secciones c on b.cod_seccion =c.cod_seccion',
'  where',
' extract (YEAR FROM FECHASALE) = 2018 and cod_puesto=12 and Status=''A'' and sysdate-fec_ingreso>=365',
'  union all    ',
'    select pilotodes codigo, nombres||'' '' || apellidos nombre,cod_sucursal estacion, nom_seccion seccion ,status status, 0 galones,recorrido km, 0 horas,0 fuleos,',
'  EXTRACT(MONTH FROM fechasale) mes , sysdate-fec_ingreso tiempo',
'  from ',
' tnotaviaje a',
' inner join tvales b on a.nmnota=b.notaviaje ',
' inner join empleados c on a.pilotodes=c.Cod_emp',
'  inner join secciones d on c.cod_seccion =d.cod_seccion ',
' where extract (YEAR FROM FECHASALE) = 2018 and cod_puesto=12 and Status=''A''  and sysdate-fec_ingreso>=365',
'   union all',
' select  pilotodes codigo, nombres||'' '' || apellidos nombre, cod_sucursal estacion ,nom_seccion seccion ,status status,0 galones, 0 km, (hora_FIN-hora_salida)*24 horas,0 fuleos,',
'   EXTRACT(MONTH FROM fechasale) mes, sysdate-fec_ingreso tiempo',
'  from tnotaviaje a inner join empleados b on a.pilotodes=b.cod_emp ',
'  inner join secciones c on b.cod_seccion =c.cod_seccion',
'  where',
' extract (YEAR FROM FECHASALE) = 2018 and cod_puesto=12 and Status=''A'' and sysdate-fec_ingreso>=365',
' union all ',
' select  cdrecibe codigo, nombres||'' '' || apellidos nombre, cod_sucursal estacion ,nom_seccion seccion ,status status,0 galones, 0 km, 0 horas, (case when  rendimiento_real< rendimiento_estimado then  1 else 0 end) fuleos, ',
'   EXTRACT(MONTH FROM a.fecha) mes  ,  sysdate-fec_ingreso tiempo',
'  from tvales a inner join empleados b on a.cdrecibe=b.cod_emp ',
'  inner join secciones c on b.cod_seccion =c.cod_seccion',
'  where',
' extract (YEAR FROM a.fecha) = 2018 and cod_puesto=12  ',
' )',
'pivot (',
'sum(galones) galones, sum(km) km , sum(horas)horas , sum(fuleos) fuleos',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(42703213069655309)
,p_name=>'365'
...
,p_owner=>'LP'
,p_internal_uid=>42703213069655309
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42703422390655335)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42703516757655337)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42703621187655337)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42703727882655337)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42703822334655337)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42703916061655337)
,p_db_column_name=>'TIEMPO'
,p_display_order=>6
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704007424655337)
,p_db_column_name=>'ENERO_GALONES'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Enero Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ENERO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704117806655337)
,p_db_column_name=>'ENERO_KM'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Enero Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ENERO_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704201995655337)
,p_db_column_name=>'ENERO_HORAS'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Enero Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ENERO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704329104655337)
,p_db_column_name=>'ENERO_FULEOS'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Enero Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ENERO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704420414655337)
,p_db_column_name=>'FEBRERO_GALONES'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Febrero Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FEBRERO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704510602655339)
,p_db_column_name=>'FEBRERO_KM'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Febrero Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FEBRERO_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704626840655339)
,p_db_column_name=>'FEBRERO_HORAS'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'Febrero Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FEBRERO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704728759655339)
,p_db_column_name=>'FEBRERO_FULEOS'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'Febrero Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FEBRERO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704828224655339)
,p_db_column_name=>'MARZO_GALONES'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'Marzo Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MARZO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42704916354655339)
,p_db_column_name=>'MARZO_KM'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Marzo Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MARZO_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705021956655339)
,p_db_column_name=>'MARZO_HORAS'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'Marzo Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MARZO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705101803655339)
,p_db_column_name=>'MARZO_FULEOS'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'Marzo Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MARZO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705229974655339)
,p_db_column_name=>'ABRIL_GALONES'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Abril Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ABRIL_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705307684655339)
,p_db_column_name=>'ABRIL_KM'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Abril Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ABRIL_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705415789655339)
,p_db_column_name=>'ABRIL_HORAS'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Abril Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ABRIL_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705524124655339)
,p_db_column_name=>'ABRIL_FULEOS'
,p_display_order=>22
,p_column_identifier=>'V'
,p_column_label=>'Abril Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'ABRIL_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705621844655340)
,p_db_column_name=>'MAYO_GALONES'
,p_display_order=>23
,p_column_identifier=>'W'
,p_column_label=>'Mayo Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MAYO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705704597655340)
,p_db_column_name=>'MAYO_KM'
,p_display_order=>24
,p_column_identifier=>'X'
,p_column_label=>'Mayo Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705810444655340)
,p_db_column_name=>'MAYO_HORAS'
,p_display_order=>25
,p_column_identifier=>'Y'
,p_column_label=>'Mayo Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MAYO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42705907806655340)
,p_db_column_name=>'MAYO_FULEOS'
,p_display_order=>26
,p_column_identifier=>'Z'
,p_column_label=>'Mayo Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'MAYO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706004879655340)
,p_db_column_name=>'JUNIO_GALONES'
,p_display_order=>27
,p_column_identifier=>'AA'
,p_column_label=>'Junio Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JUNIO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706115004655340)
,p_db_column_name=>'JUNIO_KM'
,p_display_order=>28
,p_column_identifier=>'AB'
,p_column_label=>'Junio Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JUNIO_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706201809655340)
,p_db_column_name=>'JUNIO_HORAS'
,p_display_order=>29
,p_column_identifier=>'AC'
,p_column_label=>'Junio Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JUNIO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706316085655340)
,p_db_column_name=>'JUNIO_FULEOS'
,p_display_order=>30
,p_column_identifier=>'AD'
,p_column_label=>'Junio Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JUNIO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706408984655340)
,p_db_column_name=>'JULIO_GALONES'
,p_display_order=>31
,p_column_identifier=>'AE'
,p_column_label=>'Julio Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JULIO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706514222655340)
,p_db_column_name=>'JULIO_KM'
,p_display_order=>32
,p_column_identifier=>'AF'
,p_column_label=>'Julio Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JULIO_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706601023655342)
,p_db_column_name=>'JULIO_HORAS'
,p_display_order=>33
,p_column_identifier=>'AG'
,p_column_label=>'Julio Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JULIO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706726946655342)
,p_db_column_name=>'JULIO_FULEOS'
,p_display_order=>34
,p_column_identifier=>'AH'
,p_column_label=>'Julio Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'JULIO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706825596655342)
,p_db_column_name=>'AGOSTO_GALONES'
,p_display_order=>35
,p_column_identifier=>'AI'
,p_column_label=>'Agosto Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'AGOSTO_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42706932058655342)
,p_db_column_name=>'AGOSTO_KM'
,p_display_order=>36
,p_column_identifier=>'AJ'
,p_column_label=>'Agosto Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'AGOSTO_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707023497655343)
,p_db_column_name=>'AGOSTO_HORAS'
,p_display_order=>37
,p_column_identifier=>'AK'
,p_column_label=>'Agosto Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'AGOSTO_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707108589655343)
,p_db_column_name=>'AGOSTO_FULEOS'
,p_display_order=>38
,p_column_identifier=>'AL'
,p_column_label=>'Agosto Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'AGOSTO_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707220028655343)
,p_db_column_name=>'SEPTIEMBRE_GALONES'
,p_display_order=>39
,p_column_identifier=>'AM'
,p_column_label=>'Septiembre Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'SEPTIEMBRE_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707306486655343)
,p_db_column_name=>'SEPTIEMBRE_KM'
,p_display_order=>40
,p_column_identifier=>'AN'
,p_column_label=>'Septiembre Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'SEPTIEMBRE_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707428078655343)
,p_db_column_name=>'SEPTIEMBRE_HORAS'
,p_display_order=>41
,p_column_identifier=>'AO'
,p_column_label=>'Septiembre Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'SEPTIEMBRE_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707506741655343)
,p_db_column_name=>'SEPTIEMBRE_FULEOS'
,p_display_order=>42
,p_column_identifier=>'AP'
,p_column_label=>'Septiembre Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'SEPTIEMBRE_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707614281655343)
,p_db_column_name=>'OCTUBRE_GALONES'
,p_display_order=>43
,p_column_identifier=>'AQ'
,p_column_label=>'Octubre Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'OCTUBRE_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707729577655343)
,p_db_column_name=>'OCTUBRE_KM'
,p_display_order=>44
,p_column_identifier=>'AR'
,p_column_label=>'Octubre Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'OCTUBRE_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707801938655343)
,p_db_column_name=>'OCTUBRE_HORAS'
,p_display_order=>45
,p_column_identifier=>'AS'
,p_column_label=>'Octubre Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'OCTUBRE_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42707925687655343)
,p_db_column_name=>'OCTUBRE_FULEOS'
,p_display_order=>46
,p_column_identifier=>'AT'
,p_column_label=>'Octubre Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'OCTUBRE_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708018116655343)
,p_db_column_name=>'NOVIEMBRE_GALONES'
,p_display_order=>47
,p_column_identifier=>'AU'
,p_column_label=>'Noviembre Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'NOVIEMBRE_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708122105655345)
,p_db_column_name=>'NOVIEMBRE_KM'
,p_display_order=>48
,p_column_identifier=>'AV'
,p_column_label=>'Noviembre Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'NOVIEMBRE_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708209950655345)
,p_db_column_name=>'NOVIEMBRE_HORAS'
,p_display_order=>49
,p_column_identifier=>'AW'
,p_column_label=>'Noviembre Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'NOVIEMBRE_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708325595655345)
,p_db_column_name=>'NOVIEMBRE_FULEOS'
,p_display_order=>50
,p_column_identifier=>'AX'
,p_column_label=>'Noviembre Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'NOVIEMBRE_FULEOS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708428531655345)
,p_db_column_name=>'DICIEMBRE_GALONES'
,p_display_order=>51
,p_column_identifier=>'AY'
,p_column_label=>'Diciembre Galones'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'DICIEMBRE_GALONES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708519544655345)
,p_db_column_name=>'DICIEMBRE_KM'
,p_display_order=>52
,p_column_identifier=>'AZ'
,p_column_label=>'Diciembre Km'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'DICIEMBRE_KM'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708610905655345)
,p_db_column_name=>'DICIEMBRE_HORAS'
,p_display_order=>53
,p_column_identifier=>'BA'
,p_column_label=>'Diciembre Horas'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'DICIEMBRE_HORAS'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42708714628655345)
,p_db_column_name=>'DICIEMBRE_FULEOS'
,p_display_order=>54
,p_column_identifier=>'BB'
,p_column_label=>'Diciembre Fuleos'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'DICIEMBRE_FULEOS'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(42708802367655523)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'427089'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CODIGO:NOMBRE:ESTACION:SECCION:STATUS:TIEMPO:ENERO_GALONES:ENERO_KM:ENERO_HORAS:ENERO_FULEOS:FEBRERO_GALONES:FEBRERO_KM:FEBRERO_HORAS:FEBRERO_FULEOS:MARZO_GALONES:MARZO_KM:MARZO_HORAS:MARZO_FULEOS:ABRIL_GALONES:ABRIL_KM:ABRIL_HORAS:ABRIL_FULEOS:MAYO_'
||'GALONES:MAYO_KM:MAYO_HORAS:MAYO_FULEOS:JUNIO_GALONES:JUNIO_KM:JUNIO_HORAS:JUNIO_FULEOS:JULIO_GALONES:JULIO_KM:JULIO_HORAS:JULIO_FULEOS:AGOSTO_GALONES:AGOSTO_KM:AGOSTO_HORAS:AGOSTO_FULEOS:SEPTIEMBRE_GALONES:SEPTIEMBRE_KM:SEPTIEMBRE_HORAS:SEPTIEMBRE_FU'
||'LEOS:OCTUBRE_GALONES:OCTUBRE_KM:OCTUBRE_HORAS:OCTUBRE_FULEOS:NOVIEMBRE_GALONES:NOVIEMBRE_KM:NOVIEMBRE_HORAS:NOVIEMBRE_FULEOS:DICIEMBRE_GALONES:DICIEMBRE_KM:DICIEMBRE_HORAS:DICIEMBRE_FULEOS'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(42249212337671137)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20181120112511'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42267829569671257)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42261407903671193)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(42268119767671259)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(42267829569671257)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(42266017713671218)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42267905958671257)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(42267829569671257)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(42265515071671218)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42268015279671257)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42268304111671260)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42268201714671259)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42268524200671262)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42268409743671260)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(42381613936997853)
);
end;
/
