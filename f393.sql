...
,p_default_application_id=>393
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 393 - ASIGNACIONES
--
-- Application Export:
--   Application:     393
--   Name:            ASIGNACIONES
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,393)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'ASIGNACIONES')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_393')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'3CC5C6B92D529DCAAB9EE00413D335FCBE26062268363A84152F7119CBDD63EF'
...
,p_authentication_id=>wwv_flow_api.id(95260216740581896)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:ASIGNACIONES'
...
,p_last_upd_yyyymmddhh24miss=>'20210325160807'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13051846743091080)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13051915144091080)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13052058755091080)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13052251951091080)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13052337432091080)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13052484684091080)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(92491917319658695)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(93808615941012725)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(92509914672658821)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(95270609307668642)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'Mantenimiento Unidades'
,p_tab_text=>'Mantenimiento_Unidades'
,p_tab_step=>13
,p_tab_also_current_for_pages=>'14'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(96431523321707485)
,p_tab_set=>'TS1'
,p_tab_sequence=>40
,p_tab_name=>'Asigna_Flota'
,p_tab_text=>'Asigna_Flota'
,p_tab_step=>3
,p_tab_also_current_for_pages=>'4'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(95344820785537793)
,p_tab_set=>'TS1'
,p_tab_sequence=>50
,p_tab_name=>'Panel De Control'
,p_tab_text=>'Panel_De_Control'
,p_tab_step=>24
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(92511128435658889)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92492011458658714)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492110707658725)
,p_page_template_id=>wwv_flow_api.id(92492011458658714)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92492210776658734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492315578658734)
,p_page_template_id=>wwv_flow_api.id(92492210776658734)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492415870658734)
,p_page_template_id=>wwv_flow_api.id(92492210776658734)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492532446658734)
,p_page_template_id=>wwv_flow_api.id(92492210776658734)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492622346658734)
,p_page_template_id=>wwv_flow_api.id(92492210776658734)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492722196658734)
,p_page_template_id=>wwv_flow_api.id(92492210776658734)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92492808876658734)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92492919735658735)
,p_page_template_id=>wwv_flow_api.id(92492808876658734)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493011563658735)
,p_page_template_id=>wwv_flow_api.id(92492808876658734)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493116131658735)
,p_page_template_id=>wwv_flow_api.id(92492808876658734)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493215437658735)
,p_page_template_id=>wwv_flow_api.id(92492808876658734)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493329473658735)
,p_page_template_id=>wwv_flow_api.id(92492808876658734)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493416822658735)
,p_page_template_id=>wwv_flow_api.id(92492808876658734)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92493530025658735)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493602399658737)
,p_page_template_id=>wwv_flow_api.id(92493530025658735)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493730989658737)
,p_page_template_id=>wwv_flow_api.id(92493530025658735)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493828859658737)
,p_page_template_id=>wwv_flow_api.id(92493530025658735)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92493919267658737)
,p_page_template_id=>wwv_flow_api.id(92493530025658735)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92494027227658737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494108486658737)
,p_page_template_id=>wwv_flow_api.id(92494027227658737)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494207416658737)
,p_page_template_id=>wwv_flow_api.id(92494027227658737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494326548658737)
,p_page_template_id=>wwv_flow_api.id(92494027227658737)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494424043658737)
,p_page_template_id=>wwv_flow_api.id(92494027227658737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494510303658737)
,p_page_template_id=>wwv_flow_api.id(92494027227658737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92494628279658737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494714199658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494804208658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92494916986658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495002602658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495130916658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495223220658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495308090658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495432453658737)
,p_page_template_id=>wwv_flow_api.id(92494628279658737)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92495519650658737)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495603052658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495701387658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495825309658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92495931566658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496006898658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496118415658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496224639658739)
,p_page_template_id=>wwv_flow_api.id(92495519650658737)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92496321770658739)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496406848658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496512204658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496610386658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496724490658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496803632658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92496906005658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497003887658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497114459658739)
,p_page_template_id=>wwv_flow_api.id(92496321770658739)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92497230450658739)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497320118658739)
,p_page_template_id=>wwv_flow_api.id(92497230450658739)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497417472658739)
,p_page_template_id=>wwv_flow_api.id(92497230450658739)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497522836658739)
,p_page_template_id=>wwv_flow_api.id(92497230450658739)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497615310658739)
,p_page_template_id=>wwv_flow_api.id(92497230450658739)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497702883658739)
,p_page_template_id=>wwv_flow_api.id(92497230450658739)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92497827928658739)
,p_page_template_id=>wwv_flow_api.id(92497230450658739)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92497911010658739)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498016924658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498131043658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498205587658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498305070658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498422145658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498512504658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498614383658740)
,p_page_template_id=>wwv_flow_api.id(92497911010658739)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92498727089658740)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498816619658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92498908691658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499021417658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499131067658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499208143658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499316278658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499421211658740)
,p_page_template_id=>wwv_flow_api.id(92498727089658740)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92499502271658740)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499626274658740)
,p_page_template_id=>wwv_flow_api.id(92499502271658740)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92499730601658740)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499814869658740)
,p_page_template_id=>wwv_flow_api.id(92499730601658740)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92499901859658740)
,p_page_template_id=>wwv_flow_api.id(92499730601658740)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500007062658740)
,p_page_template_id=>wwv_flow_api.id(92499730601658740)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500116960658740)
,p_page_template_id=>wwv_flow_api.id(92499730601658740)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92500223355658740)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500320583658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500412439658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500522284658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500602783658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500713299658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500804997658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92500920610658742)
,p_page_template_id=>wwv_flow_api.id(92500223355658740)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92501004767658742)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501110854658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501220914658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501319753658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501423744658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501525692658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501627295658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501722631658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92501805387658742)
,p_page_template_id=>wwv_flow_api.id(92501004767658742)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92501908224658742)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502011763658742)
,p_page_template_id=>wwv_flow_api.id(92501908224658742)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502110158658742)
,p_page_template_id=>wwv_flow_api.id(92501908224658742)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502215080658742)
,p_page_template_id=>wwv_flow_api.id(92501908224658742)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502329042658742)
,p_page_template_id=>wwv_flow_api.id(92501908224658742)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502416573658742)
,p_page_template_id=>wwv_flow_api.id(92501908224658742)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502530690658742)
,p_page_template_id=>wwv_flow_api.id(92501908224658742)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(92502624761658742)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502726522658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502809707658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92502905902658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92503005242658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92503115789658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92503226122658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(92503326184658742)
,p_page_template_id=>wwv_flow_api.id(92502624761658742)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92508814503658793)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92508911726658800)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92509016665658800)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92509111807658800)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92509231377658800)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(92509317013658800)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92503411670658748)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92503500286658759)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92503612864658759)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92503724546658759)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92503831756658759)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92503923177658759)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504007815658759)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504128114658760)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504205314658760)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92504325788658760)
,p_plug_template_id=>wwv_flow_api.id(92504205314658760)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504420268658764)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504507268658764)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504614121658764)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504715879658767)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92504813703658767)
,p_plug_template_id=>wwv_flow_api.id(92504715879658767)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92504929982658767)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92505002067658767)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92505116326658767)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92505214332658767)
,p_plug_template_id=>wwv_flow_api.id(92505116326658767)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(92505303572658767)
,p_plug_template_id=>wwv_flow_api.id(92505116326658767)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92505407633658767)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(92505502092658768)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92506731929658779)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92506810982658785)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92506912910658785)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507005887658787)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507113197658787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507227213658787)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507315629658787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507423867658787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507519740658787)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507624192658787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507726956658787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507828999658787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92507930823658787)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(92508010673658787)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92505624882658771)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92505706317658776)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92505806545658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92505916977658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506029331658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506132405658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506218934658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506322655658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506430212658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506521604658778)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(92506604856658778)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508118901658789)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508214334658792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508323772658792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508422525658792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508528701658792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508630108658792)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(92508726144658793)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(92509424771658800)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(92509610236658809)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(92509512626658807)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(92509716748658817)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(92497230450658739)
,p_error_template=>wwv_flow_api.id(92493530025658735)
,p_printer_friendly_template=>wwv_flow_api.id(92499730601658740)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(92492011458658714)
,p_default_button_template=>wwv_flow_api.id(92508814503658793)
,p_default_region_template=>wwv_flow_api.id(92505116326658767)
,p_default_chart_template=>wwv_flow_api.id(92505116326658767)
,p_default_form_template=>wwv_flow_api.id(92504205314658760)
,p_default_reportr_template=>wwv_flow_api.id(92505116326658767)
,p_default_tabform_template=>wwv_flow_api.id(92505116326658767)
,p_default_wizard_template=>wwv_flow_api.id(92504205314658760)
,p_default_menur_template=>wwv_flow_api.id(92503724546658759)
,p_default_listr_template=>wwv_flow_api.id(92505116326658767)
,p_default_irr_template=>wwv_flow_api.id(92504614121658764)
,p_default_report_template=>wwv_flow_api.id(92506218934658778)
,p_default_label_template=>wwv_flow_api.id(92508323772658792)
,p_default_menu_template=>wwv_flow_api.id(92509424771658800)
,p_default_calendar_template=>wwv_flow_api.id(92509512626658807)
,p_default_list_template=>wwv_flow_api.id(92507828999658787)
,p_default_option_label=>wwv_flow_api.id(92508323772658792)
,p_default_required_label=>wwv_flow_api.id(92508630108658792)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(92522530720005351)
...
begin
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(95250618574380370)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(92510023937658826)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(95014612786609748)
,p_name=>'ASIGNACION'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(95260216740581896)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
,p_attribute_03=>'custom_auth'
,p_attribute_05=>'N'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(92509819482658820)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_tab_set=>'TS1'
,p_name=>'Asignacion_Super'
,p_alias=>'HOME'
,p_step_title=>'Asignacion_Super'
...
,p_last_upd_yyyymmddhh24miss=>'20200623083940'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95329017780308262)
,p_plug_name=>'Asignacion_Super'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504614121658764)
...
'"COD_NUM",',
'"COD_SUPERVISOR",',
'(SELECT NOMBRE FROM EMPLEADO@SOFTLAND WHERE COD_SUPERVISOR=EMPLEADO) AS Supervisor,',
'"COD_PILOTO",',
'(SELECT NOMBRE FROM EMPLEADO@SOFTLAND WHERE COD_PILOTO=EMPLEADO) AS Piloto',
'from ASIGNA_PILOTO_SUPER order by "COD_NUM"'))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(95329227983308264)
,p_name=>'Asignacion_Super'
...
,p_owner=>'1462'
,p_internal_uid=>95329227983308264
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95329314359308275)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95329427515308278)
...
,p_tz_dependent=>'N'
,p_static_id=>'COD_SUPERVISOR'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95329515783308278)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95330910108314242)
,p_db_column_name=>'COD_NUM'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Cod Num'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95331015476314242)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95331112447314243)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(95329918152308439)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'953300'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'COD_NUM:COD_SUPERVISOR:SUPERVISOR:COD_PILOTO:PILOTO:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95329726013308279)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(95329017780308262)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_tab_set=>'TS1'
,p_name=>'Form on ASIGNA_PILOTO_SUPER'
,p_step_title=>'Form on ASIGNA_PILOTO_SUPER'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20201021112216'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95325816128308254)
,p_plug_name=>'Form on ASIGNA_PILOTO_SUPER'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504205314658760)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95326125387308254)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(95325816128308254)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95326422670308256)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95326028237308254)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95326228512308254)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(95327002208308256)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95327217605308257)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(95325816128308254)
...
,p_field_template=>wwv_flow_api.id(92508323772658792)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95327414693308259)
,p_name=>'P2_COD_SUPERVISOR'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(95325816128308254)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Supervisor'
...
'select a.empleado||''-''||a.nombre,a.empleado from empleado@softland a',
'left join ASIGNA_PILOTO_SUPER b on EMPLEADO= cod_piloto where cod_piloto is null',
'and a.estado_empleado = ''ACT'' AND a.puesto = ''34''',
'order by a.empleado'))
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95327622358308259)
,p_name=>'P2_COD_PILOTO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(95325816128308254)
,p_use_cache_before_default=>'NO'
,p_prompt=>'piloto'
...
'select a.empleado||''-''||a.nombre,a.empleado  from empleado@softland a',
'left join ASIGNA_PILOTO_SUPER b on EMPLEADO= cod_piloto where cod_piloto is null',
'and a.estado_empleado = ''ACT'' AND a.puesto = ''12'' ',
'order by a.empleado'))
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107995506003879546)
,p_name=>'P2_CONTROL'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(95325816128308254)
,p_prompt=>'Control'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95328024306308259)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95328216464308259)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95328405559308260)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(95326228512308254)
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_tab_set=>'TS1'
,p_name=>'Asignacion_Flota'
,p_step_title=>'Asignacion_Flota'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200706083701'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(96435314433707603)
,p_plug_name=>'Asignacion_Flota'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504614121658764)
,p_plug_display_sequence=>10
...
'"UNIDAD",',
'"FLOTA"',
'from "#OWNER#"."ASIGNA_FLOTA" ',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(96435522514707604)
,p_name=>'Asignacion_Flota'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_owner=>'1462'
,p_internal_uid=>96435522514707604
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96435631302707623)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96435712181707626)
,p_db_column_name=>'ID_FLOTA'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Id Flota'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'ID_FLOTA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96435817520707628)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(96435922298707629)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(96436327106707795)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'964364'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:ID_FLOTA:UNIDAD:FLOTA'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96436130193707629)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(96435314433707603)
,p_button_name=>'Create'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_tab_set=>'TS1'
,p_name=>'Form on ASIGNA_FLOTA'
,p_step_title=>'Form on ASIGNA_FLOTA'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200706083858'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(96431620128707487)
,p_plug_name=>'Form on ASIGNA_FLOTA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504205314658760)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96431910565707490)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(96431620128707487)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96432223949707490)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(96431620128707487)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96431819896707490)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(96431620128707487)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(96432000624707490)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(96431620128707487)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(96432801570707495)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96433001198707565)
,p_name=>'P4_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(96431620128707487)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96433425562707582)
,p_name=>'P4_UNIDAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(96431620128707487)
,p_use_cache_before_default=>'NO'
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select A.PROYECTO,A.NOMBRE from PROYECTO A ',
'WHERE A.STATUS= ''A'' and A.conf_llantas is not null'))
,p_cSize=>32
,p_cMaxlength=>20
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(96433602651707582)
,p_name=>'P4_FLOTA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(96431620128707487)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(96434313427707584)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from ASIGNA_FLOTA'
,p_attribute_02=>'ASIGNA_FLOTA'
,p_attribute_03=>'P4_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(96434528299707587)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of ASIGNA_FLOTA'
,p_attribute_02=>'ASIGNA_FLOTA'
,p_attribute_03=>'P4_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(96434723965707587)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(96432000624707490)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200622151432'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95340306797354479)
,p_button_sequence=>30
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20201026100655'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(108555721524629356)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select notas from empleado_concepto@softland'
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(108555814711629356)
,p_name=>'Report 1'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'1462'
,p_internal_uid=>108555814711629356
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(108556027385629504)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(108556113688629656)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1085562'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NOTAS'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_tab_set=>'TS1'
,p_name=>'Form on ASIGNA_UNIDAD_FLOTA'
,p_step_title=>'Form on ASIGNA_UNIDAD_FLOTA'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200622151500'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95336428349354445)
,p_plug_name=>'Form on ASIGNA_UNIDAD_FLOTA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504205314658760)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95336702507354446)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(95336428349354445)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95337017301354446)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(95336428349354445)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95336607823354446)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(95336428349354445)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95336832386354446)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(95336428349354445)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(95337631760354450)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95337828826354453)
,p_name=>'P8_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(95336428349354445)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95338020419354453)
,p_name=>'P8_COD_PILOTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(95336428349354445)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Cod Piloto'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95338216020354454)
,p_name=>'P8_FLOTA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(95336428349354445)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95338619663354454)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from ASIGNA_UNIDAD_FLOTA'
,p_attribute_02=>'ASIGNA_UNIDAD_FLOTA'
,p_attribute_03=>'P8_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95338805787354460)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of ASIGNA_UNIDAD_FLOTA'
,p_attribute_02=>'ASIGNA_UNIDAD_FLOTA'
,p_attribute_03=>'P8_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95339018151354460)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(95336832386354446)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>12
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_name=>'Form on ASIGNA_PILOTO_UNIDAD'
,p_step_title=>'Form on ASIGNA_PILOTO_UNIDAD'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20200622101322'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95262911079627543)
,p_plug_name=>'Form on ASIGNA_PILOTO_UNIDAD'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504205314658760)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95263125314627545)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(95262911079627543)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95263312267627546)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(95262911079627543)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(95263530798627551)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95263713476627556)
,p_name=>'P12_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(95262911079627543)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95263905059627573)
,p_name=>'P12_COD_PILOTO'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(95262911079627543)
,p_use_cache_before_default=>'NO'
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(92508630108658792)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95264128243627579)
,p_name=>'P12_UNIDAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(95262911079627543)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95264301395627579)
,p_name=>'P12_COMPLEMENTO1'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(95262911079627543)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Complemento1'
,p_source=>'COMPLEMENTO1'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>32
,p_cMaxlength=>20
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95264522221627579)
,p_name=>'P12_COMPLEMENTO2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(95262911079627543)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Complemento2'
,p_source=>'COMPLEMENTO2'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>32
,p_cMaxlength=>20
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95265307204627584)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from ASIGNA_PILOTO_UNIDAD'
,p_attribute_02=>'ASIGNA_PILOTO_UNIDAD'
,p_attribute_03=>'P12_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95265531774627585)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of ASIGNA_PILOTO_UNIDAD'
,p_attribute_02=>'ASIGNA_PILOTO_UNIDAD'
,p_attribute_03=>'P12_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'U'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95265725512627585)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_user_interface_id=>wwv_flow_api.id(92509819482658820)
,p_tab_set=>'TS1'
,p_name=>'Mantenimiento Unidades'
,p_step_title=>'Mantenimiento Unidades'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20201026154457'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95274708010668682)
,p_plug_name=>'Mantenimiento Unidades'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504614121658764)
,p_plug_display_sequence=>10
...
'"COD_SUPERVISOR",',
'(SELECT NOMBRE FROM EMPLEADO@SOFTLAND WHERE COD_SUPERVISOR=EMPLEADO) AS Supervisor',
'from "#OWNER#"."ASIGNA_PILOTO_UNIDAD" '))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(95274919886668687)
,p_name=>'Mantenimiento Unidades'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#ed-item.gif"  border="0">'
,p_owner=>'1462'
,p_internal_uid=>95274919886668687
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95275001644668698)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95275124845668701)
,p_db_column_name=>'COD_PILOTO'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Cod Piloto'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95275223845668703)
,p_db_column_name=>'UNIDAD'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Unidad'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95275309276668704)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95275407703668706)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95292932452878443)
,p_db_column_name=>'PILOTO'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Piloto'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(108612825301639378)
,p_db_column_name=>'COD_SUPERVISOR'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(108614418388657759)
,p_db_column_name=>'SUPERVISOR'
,p_display_order=>8
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(95275831406668895)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'952759'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'COD_PILOTO:PILOTO:UNIDAD:COMPLEMENTO1:COMPLEMENTO2:COD_SUPERVISOR:SUPERVISOR'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95275601890668706)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(95274708010668682)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20201026173555'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95270727541668642)
,p_plug_name=>'Form on ASIGNA_PILOTO_UNIDAD'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504205314658760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95271026372668645)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(95270727541668642)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(92508814503658793)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95271302521668645)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(95270727541668642)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95270904713668645)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(95270727541668642)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95271116675668645)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(95270727541668642)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(95271910158668657)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95272102877668659)
,p_name=>'P14_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95272300261668662)
,p_name=>'P14_COD_PILOTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Cod Piloto'
...
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select a.empleado||''-''||a.nombre,a.empleado from empleado@softland a',
'left join ASIGNA_PILOTO_UNIDAD b on a.EMPLEADO= b.cod_piloto where cod_piloto is null',
'and a.estado_empleado = ''ACT'' and a.puesto =''12'' order by a.empleado '))
,p_lov_display_null=>'YES'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95272508681668662)
,p_name=>'P14_UNIDAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_use_cache_before_default=>'NO'
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  a.unidad, descripcion from (',
'  Select  cdclase||''-''||correlativo unidad,cdclase||''-''||correlativo descripcion from  tactivos where fechabaja is null and  vehiculo=''S'' and tipoactivo in(1) and Spot=''N''',
'  union all ',
'  Select  cdclase||''-''||correlativo unidad,cdclase||''-''||correlativo descripcion  from  tactivos where fechabaja is null and  vehiculo=''S'' and tipoactivo in(5) and Spot=''N'') a',
'left JOIN ASIGNA_PILOTO_UNIDAD B ON A.unidad=B.UNIDAD ',
'LEFT JOIN ASIGNA_PILOTO_UNIDAD C ON A.unidad=C.COMPLEMENTO1',
'LEFT JOIN ASIGNA_PILOTO_UNIDAD D ON A.unidad=D.COMPLEMENTO2',
'WHERE B.unidad is null AND C.COMPLEMENTO1 IS NULL AND D.COMPLEMENTO2 IS NULL'))
,p_lov_display_null=>'YES'
,p_cSize=>32
,p_cMaxlength=>20
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95272731368668664)
,p_name=>'P14_COMPLEMENTO1'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Complemento1'
...
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  a.unidad, descripcion from (',
'  Select  cdclase||''-''||correlativo unidad,cdclase||''-''||correlativo descripcion from  tactivos where fechabaja is null and  vehiculo=''S'' and tipoactivo in(2) and Spot=''N''',
'  union all ',
'  Select  cdclase||''-''||correlativo unidad,cdclase||''-''||correlativo descripcion  from  tactivos where fechabaja is null and  vehiculo=''S'' and tipoactivo in(3) and Spot=''N'') a',
'left JOIN ASIGNA_PILOTO_UNIDAD B ON A.unidad=B.UNIDAD ',
'LEFT JOIN ASIGNA_PILOTO_UNIDAD C ON A.unidad=C.COMPLEMENTO1',
'LEFT JOIN ASIGNA_PILOTO_UNIDAD D ON A.unidad=D.COMPLEMENTO2',
'WHERE B.unidad is null AND C.COMPLEMENTO1 IS NULL AND D.COMPLEMENTO2 IS NULL'))
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95272901539668664)
,p_name=>'P14_COMPLEMENTO2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Complemento2'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(108614930668667235)
,p_name=>'P14_COD_SUPERVISOR'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(108616123107685925)
,p_name=>'P14_CONTROL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(95270727541668642)
,p_prompt=>'Control'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95273711785668665)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from ASIGNA_PILOTO_UNIDAD'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95273911605668667)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of ASIGNA_PILOTO_UNIDAD'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95274107870668679)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(95271116675668645)
);
end;
/
...
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Panel De Control'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20200706083602'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(95344931346537795)
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select b.cod_supervisor,d.nombre supervisor,a.cod_piloto,c.nombre piloto,a.unidad,a.complemento1,a.complemento2,e.flota from asigna_piloto_unidad a',
'inner join asigna_piloto_super b on a.cod_piloto=b.cod_piloto',
'inner join empleado@softland c on a.cod_piloto=c.empleado',
'inner join empleado@softland d on b.cod_supervisor=d.empleado',
'inner join asigna_flota e on a.unidad = e.unidad;'))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(95345020542537795)
,p_name=>'Panel De Control'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'1462'
,p_internal_uid=>95345020542537795
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345230631537804)
,p_db_column_name=>'COD_SUPERVISOR'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Cod Supervisor'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345314124537804)
,p_db_column_name=>'SUPERVISOR'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Supervisor'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345405783537806)
,p_db_column_name=>'COD_PILOTO'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Cod Piloto'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345507433537806)
,p_db_column_name=>'PILOTO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Piloto'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345621279537806)
,p_db_column_name=>'UNIDAD'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Unidad'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345715105537806)
,p_db_column_name=>'COMPLEMENTO1'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Complemento1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345823688537806)
,p_db_column_name=>'COMPLEMENTO2'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Complemento2'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(95345906860537806)
,p_db_column_name=>'FLOTA'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Flota'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(95346026491537948)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'953461'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'COD_SUPERVISOR:SUPERVISOR:COD_PILOTO:PILOTO:UNIDAD:COMPLEMENTO1:COMPLEMENTO2:FLOTA'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(92492011458658714)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200519094446'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(92510310648658856)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(92504205314658760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(92510602498658884)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(92510310648658856)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92510422607658868)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(92510310648658856)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92510531754658881)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92510814247658889)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92510706813658885)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92511019281658889)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92510923097658889)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(95344211815524285)
);
end;
/
