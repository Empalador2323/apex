...
,p_default_application_id=>321
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 321 - j_clientes
--
-- Application Export:
--   Application:     321
--   Name:            j_clientes
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,321)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'j_clientes')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_321')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'380188CE990350B7D08B2322B09F3F6BF5E8659E74DBBEF9B5D2186623557F80'
...
,p_authentication_id=>wwv_flow_api.id(17430920321640151)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:j_clientes'
...
,p_last_upd_yyyymmddhh24miss=>'20210325145145'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8760681140057359)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8760781233057359)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8760876018057359)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8761080960057359)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8761114709057359)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8761275535057359)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17374114716271907)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17427720789594271)
,p_icon_sequence=>10
,p_icon_subtext=>'Home'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17392131438272051)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(17393331166272076)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(17393700654272082)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17374222304271914)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17374314408271923)
,p_page_template_id=>wwv_flow_api.id(17374222304271914)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17374432721271929)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17374516021271929)
,p_page_template_id=>wwv_flow_api.id(17374432721271929)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17374606955271929)
,p_page_template_id=>wwv_flow_api.id(17374432721271929)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17374716758271929)
,p_page_template_id=>wwv_flow_api.id(17374432721271929)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17374803648271929)
,p_page_template_id=>wwv_flow_api.id(17374432721271929)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17374927998271929)
,p_page_template_id=>wwv_flow_api.id(17374432721271929)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17375021956271929)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375121759271929)
,p_page_template_id=>wwv_flow_api.id(17375021956271929)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375207911271929)
,p_page_template_id=>wwv_flow_api.id(17375021956271929)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375303556271929)
,p_page_template_id=>wwv_flow_api.id(17375021956271929)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375411867271929)
,p_page_template_id=>wwv_flow_api.id(17375021956271929)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375502013271929)
,p_page_template_id=>wwv_flow_api.id(17375021956271929)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375623405271929)
,p_page_template_id=>wwv_flow_api.id(17375021956271929)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17375711163271929)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375832108271931)
,p_page_template_id=>wwv_flow_api.id(17375711163271929)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17375921011271931)
,p_page_template_id=>wwv_flow_api.id(17375711163271929)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376016355271931)
,p_page_template_id=>wwv_flow_api.id(17375711163271929)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376116757271931)
,p_page_template_id=>wwv_flow_api.id(17375711163271929)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17376230282271931)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376324039271931)
,p_page_template_id=>wwv_flow_api.id(17376230282271931)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376418996271931)
,p_page_template_id=>wwv_flow_api.id(17376230282271931)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376529502271931)
,p_page_template_id=>wwv_flow_api.id(17376230282271931)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376603886271931)
,p_page_template_id=>wwv_flow_api.id(17376230282271931)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376714949271931)
,p_page_template_id=>wwv_flow_api.id(17376230282271931)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17376813769271931)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17376920539271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377021375271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377103345271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377203963271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377323299271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377403172271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377507915271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377611710271931)
,p_page_template_id=>wwv_flow_api.id(17376813769271931)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17377721150271932)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377827528271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17377924745271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378022796271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378130940271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378209261271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378316944271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378412432271932)
,p_page_template_id=>wwv_flow_api.id(17377721150271932)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17378520983271932)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378607796271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378731060271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378805909271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17378906507271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379012523271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379105073271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379213357271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379326646271934)
,p_page_template_id=>wwv_flow_api.id(17378520983271932)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17379403159271934)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379528809271934)
,p_page_template_id=>wwv_flow_api.id(17379403159271934)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379621925271934)
,p_page_template_id=>wwv_flow_api.id(17379403159271934)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379718316271934)
,p_page_template_id=>wwv_flow_api.id(17379403159271934)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379817860271934)
,p_page_template_id=>wwv_flow_api.id(17379403159271934)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17379931744271934)
,p_page_template_id=>wwv_flow_api.id(17379403159271934)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380015657271934)
,p_page_template_id=>wwv_flow_api.id(17379403159271934)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17380111965271934)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380210955271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380319477271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380409780271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380509162271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380619491271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380730467271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17380804155271934)
,p_page_template_id=>wwv_flow_api.id(17380111965271934)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17380932548271934)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381027244271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381116792271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381206426271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381303047271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381412599271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381500180271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381629630271935)
,p_page_template_id=>wwv_flow_api.id(17380932548271934)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17381700374271935)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17381827737271935)
,p_page_template_id=>wwv_flow_api.id(17381700374271935)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17381918949271935)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382018197271935)
,p_page_template_id=>wwv_flow_api.id(17381918949271935)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382104695271935)
,p_page_template_id=>wwv_flow_api.id(17381918949271935)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382209073271935)
,p_page_template_id=>wwv_flow_api.id(17381918949271935)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382320480271935)
,p_page_template_id=>wwv_flow_api.id(17381918949271935)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17382400307271935)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382503152271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382618359271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382701315271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382827333271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17382917859271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383024584271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383125194271935)
,p_page_template_id=>wwv_flow_api.id(17382400307271935)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17383201723271935)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383321575271935)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383424368271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383527920271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383602609271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383718568271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383804215271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17383922408271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384030879271937)
,p_page_template_id=>wwv_flow_api.id(17383201723271935)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17384127489271939)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384218030271939)
,p_page_template_id=>wwv_flow_api.id(17384127489271939)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384322971271939)
,p_page_template_id=>wwv_flow_api.id(17384127489271939)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384412354271939)
,p_page_template_id=>wwv_flow_api.id(17384127489271939)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384514391271939)
,p_page_template_id=>wwv_flow_api.id(17384127489271939)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384614331271939)
,p_page_template_id=>wwv_flow_api.id(17384127489271939)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384707299271939)
,p_page_template_id=>wwv_flow_api.id(17384127489271939)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17384829386271940)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17384904249271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17385014242271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17385121607271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17385213893271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17385325878271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17385412567271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17385526521271940)
,p_page_template_id=>wwv_flow_api.id(17384829386271940)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17391029455272006)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17391132736272012)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17391200471272012)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17391325260272012)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17391422723272012)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17391509249272012)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17385619019271942)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17385720317271951)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17385806402271951)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17385915149271951)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386007531271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386122939271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386215122271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386300924271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386411990271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17386528434271953)
,p_plug_template_id=>wwv_flow_api.id(17386411990271953)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386604677271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386713432271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386830794271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17386912790271953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17387006005271956)
,p_plug_template_id=>wwv_flow_api.id(17386912790271953)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17387127505271956)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17387223618271956)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17387312940271956)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17387412839271956)
,p_plug_template_id=>wwv_flow_api.id(17387312940271956)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17387529321271956)
,p_plug_template_id=>wwv_flow_api.id(17387312940271956)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17387625692271956)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17387717285271956)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17388918037271978)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389029903271985)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389101567271996)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389225967271998)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389308909271998)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389430713271998)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389502443271998)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389630162271998)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389708532271998)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389827042271998)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17389915047271998)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17390004439271998)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17390131946271998)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17390225399271998)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17387814224271957)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17387913716271976)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388023562271976)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388126520271976)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388209193271976)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388318163271978)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388404989271978)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388505216271978)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388631220271978)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388720370271978)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17388822222271978)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390329112271998)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390421628272006)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390525566272006)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390625646272006)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390710620272006)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390824384272006)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17390910121272006)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(17391629077272012)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(17391825121272028)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(17391722253272021)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(17391904323272035)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(17379403159271934)
,p_error_template=>wwv_flow_api.id(17375711163271929)
,p_printer_friendly_template=>wwv_flow_api.id(17381918949271935)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(17374222304271914)
,p_default_button_template=>wwv_flow_api.id(17391029455272006)
,p_default_region_template=>wwv_flow_api.id(17387312940271956)
,p_default_chart_template=>wwv_flow_api.id(17387312940271956)
,p_default_form_template=>wwv_flow_api.id(17386411990271953)
,p_default_reportr_template=>wwv_flow_api.id(17387312940271956)
,p_default_tabform_template=>wwv_flow_api.id(17387312940271956)
,p_default_wizard_template=>wwv_flow_api.id(17386411990271953)
,p_default_menur_template=>wwv_flow_api.id(17385915149271951)
,p_default_listr_template=>wwv_flow_api.id(17387312940271956)
,p_default_irr_template=>wwv_flow_api.id(17386830794271953)
,p_default_report_template=>wwv_flow_api.id(17388404989271978)
,p_default_label_template=>wwv_flow_api.id(17390525566272006)
,p_default_menu_template=>wwv_flow_api.id(17391629077272012)
,p_default_calendar_template=>wwv_flow_api.id(17391722253272021)
,p_default_list_template=>wwv_flow_api.id(17390004439271998)
,p_default_option_label=>wwv_flow_api.id(17390525566272006)
,p_default_required_label=>wwv_flow_api.id(17390824384272006)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17392221431272054)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17430920321640151)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(17392004629272037)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(17392004629272037)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20201204113248'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17395529903285343)
,p_plug_name=>'Nuevos Clientes'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17387312940271956)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17395921202285350)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(17395529903285343)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(17391029455272006)
,p_button_image_alt=>'Cancel'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_redirect_url=>'f?p=LPSIG:home:&SESSION.::&DEBUG.'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17415401562381250)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17396111041285359)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17396724005285443)
,p_name=>'P1_DSCLIENTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
...
,p_grid_column=>5
,p_field_template=>wwv_flow_api.id(17390525566272006)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17396905472285445)
,p_name=>'P1_DIRECCION'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17397120657285445)
,p_name=>'P1_TELEFONO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17397330432285445)
,p_name=>'P1_CONTACTO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17397503788285445)
,p_name=>'P1_PAIS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
,p_lov=>'static: GUATEMALA, EL SALVADOR, HONDURAS, NICARAGUA'
,p_cSize=>32
,p_cMaxlength=>50
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17397711107285445)
,p_name=>'P1_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT DSEMPRESA,CDEMPRESA FROM TEMPRESAS'
,p_cSize=>32
,p_cMaxlength=>2
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(17390824384272006)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17397906164285446)
,p_name=>'P1_CDZONA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17398103864285446)
,p_name=>'P1_CDTIPCLIENTE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17398307751285446)
,p_name=>'P1_TARIFA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17398508370285446)
,p_name=>'P1_CDCLIENTEP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Cdclientep'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select dscliente, cdcliente from tclientes where cdtipcliente = 1'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17398710813285448)
,p_name=>'P1_CDZONATAR'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select cdzonatar||'' ''||dszonatar a,cdzonatar from tzonatar order by cdzonatar asc'
,p_cHeight=>1
,p_colspan=>5
,p_field_template=>wwv_flow_api.id(17390525566272006)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17399311049285448)
,p_name=>'P1_TIEMPO_PREVISTO'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17399518250285448)
,p_name=>'P1_DISTANCIA'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17399706308285448)
,p_name=>'P1_NOMBRE_CORTO'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17399905974285450)
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select dsdelegacion, cddelegacion from tdelegaciones'
,p_cSize=>32
,p_cMaxlength=>2
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17400101656285450)
,p_name=>'P1_NIT'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17400304746285450)
,p_name=>'P1_RESTRICCION'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17400507736285451)
,p_name=>'P1_ACCESO'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17400707531285451)
,p_name=>'P1_ACCESORIOS'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Accesorios'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17401919949285453)
,p_name=>'P1_COSTOSEGURO'
,p_is_required=>true
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18057620337374434)
,p_name=>'P1_CODIGOCLIENTE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17395529903285343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17416120955386784)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insertacliente'
...
'insert into tclientes (cdcliente,dscliente,direccion,telefono,contacto,pais,cdempresa,cdzona,cdtipcliente,tarifa,cdclientep,cdzonatar,hoini,hofin,tiempo_previsto,distancia,nombre_corto,cddelegacion,nit,restriccion,acceso,accesorios,usrgrab,usrmodif,c'
||'onsumo_articulado,consumo_rigido,fecha_modi,costoseguro)',
'values',
'(:P1_CODIGOCLIENTE,:P1_DSCLIENTE,:P1_DIRECCION,:P1_TELEFONO,:P1_CONTACTO,:P1_PAIS,:P1_CDEMPRESA,:P1_CDZONA,:P1_CDTIPCLIENTE,:P1_TARIFA,:P1_CDCLIENTEP,:P1_CDZONATAR,:P1_HOINI,:P1_HOFIN,:P1_TIEMPO_PREVISTO,:P1_DISTANCIA,:P1_NOMBRE_CORTO,:P1_CDDELEGACIO'
||'N,:P1_NIT,:P1_RESTRICCION,:P1_ACCESO,:P1_ACCESORIOS,empleado,null,0,0,sysdate(),:P1_COSTOSEGURO);',
'',
'end;'))
...
,p_step_template=>wwv_flow_api.id(17374222304271914)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180129090917'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17392529968272064)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17386411990271953)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17392816391272073)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(17392529968272064)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17392631701272070)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17392529968272064)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17392712850272073)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17393003808272076)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17392900327272073)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17393223089272076)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17393127763272076)
,p_process_sequence=>10
