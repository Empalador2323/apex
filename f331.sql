...
prompt APPLICATION 331 - reportekm
--
-- Application Export:
--   Application:     331
--   Name:            reportekm
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,331)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'reportekm')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_331')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'B08B0AEAB0519E65306120487464ABB19CA8D5605FAD8D39B7D8FF08E3142EB0'
...
,p_authentication_id=>wwv_flow_api.id(20371807237850823)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:reportekm'
...
,p_last_upd_yyyymmddhh24miss=>'20180220162944'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8777249593062176)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8777324193062176)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8777459159062178)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8777689090062178)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8777732962062178)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8777837168062178)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(20353726972850618)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(20371718689850821)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(20373211772850873)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(20372910586850850)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(20373311425850887)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20353811843850631)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20353914730850646)
,p_page_template_id=>wwv_flow_api.id(20353811843850631)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20354003686850671)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354105524850673)
,p_page_template_id=>wwv_flow_api.id(20354003686850671)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354202766850673)
,p_page_template_id=>wwv_flow_api.id(20354003686850671)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354322765850673)
,p_page_template_id=>wwv_flow_api.id(20354003686850671)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354429328850673)
,p_page_template_id=>wwv_flow_api.id(20354003686850671)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354511654850673)
,p_page_template_id=>wwv_flow_api.id(20354003686850671)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20354615324850673)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354721097850673)
,p_page_template_id=>wwv_flow_api.id(20354615324850673)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354811967850673)
,p_page_template_id=>wwv_flow_api.id(20354615324850673)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20354932141850673)
,p_page_template_id=>wwv_flow_api.id(20354615324850673)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355004257850673)
,p_page_template_id=>wwv_flow_api.id(20354615324850673)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355124095850673)
,p_page_template_id=>wwv_flow_api.id(20354615324850673)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355230009850673)
,p_page_template_id=>wwv_flow_api.id(20354615324850673)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20355308884850673)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355423732850675)
,p_page_template_id=>wwv_flow_api.id(20355308884850673)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355504882850675)
,p_page_template_id=>wwv_flow_api.id(20355308884850673)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355628722850675)
,p_page_template_id=>wwv_flow_api.id(20355308884850673)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355722437850675)
,p_page_template_id=>wwv_flow_api.id(20355308884850673)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20355819699850675)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20355900175850675)
,p_page_template_id=>wwv_flow_api.id(20355819699850675)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356013255850675)
,p_page_template_id=>wwv_flow_api.id(20355819699850675)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356121972850675)
,p_page_template_id=>wwv_flow_api.id(20355819699850675)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356228058850675)
,p_page_template_id=>wwv_flow_api.id(20355819699850675)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356331388850675)
,p_page_template_id=>wwv_flow_api.id(20355819699850675)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20356405945850675)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356505869850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356607583850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356700706850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356820843850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20356900636850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357027472850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357132157850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357229854850676)
,p_page_template_id=>wwv_flow_api.id(20356405945850675)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20357321468850676)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357405680850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357507363850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357609579850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357717506850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357812814850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20357911187850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358010497850679)
,p_page_template_id=>wwv_flow_api.id(20357321468850676)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20358117865850679)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358210087850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358310977850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358409888850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358522753850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358603326850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358725854850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358814422850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20358919572850681)
,p_page_template_id=>wwv_flow_api.id(20358117865850679)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20359005818850681)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359127276850681)
,p_page_template_id=>wwv_flow_api.id(20359005818850681)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359209977850681)
,p_page_template_id=>wwv_flow_api.id(20359005818850681)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359328793850681)
,p_page_template_id=>wwv_flow_api.id(20359005818850681)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359405568850681)
,p_page_template_id=>wwv_flow_api.id(20359005818850681)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359508099850681)
,p_page_template_id=>wwv_flow_api.id(20359005818850681)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359628006850681)
,p_page_template_id=>wwv_flow_api.id(20359005818850681)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20359702428850681)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359817873850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20359918429850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360024312850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360104173850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360225573850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360315689850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360403403850681)
,p_page_template_id=>wwv_flow_api.id(20359702428850681)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20360502536850681)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360618953850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360715277850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360818738850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20360900932850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361003190850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361128829850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361223286850681)
,p_page_template_id=>wwv_flow_api.id(20360502536850681)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20361332672850681)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361421491850682)
,p_page_template_id=>wwv_flow_api.id(20361332672850681)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20361514299850682)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361619922850682)
,p_page_template_id=>wwv_flow_api.id(20361514299850682)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361723915850682)
,p_page_template_id=>wwv_flow_api.id(20361514299850682)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361829036850682)
,p_page_template_id=>wwv_flow_api.id(20361514299850682)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20361913007850682)
,p_page_template_id=>wwv_flow_api.id(20361514299850682)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20362027308850682)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362102803850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362226324850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362309737850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362415892850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362502480850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362624888850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362718708850684)
,p_page_template_id=>wwv_flow_api.id(20362027308850682)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20362817794850684)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20362905137850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363024612850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363129822850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363208140850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363328455850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363401595850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363523077850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363623783850684)
,p_page_template_id=>wwv_flow_api.id(20362817794850684)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20363713456850684)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363820241850684)
,p_page_template_id=>wwv_flow_api.id(20363713456850684)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20363913251850684)
,p_page_template_id=>wwv_flow_api.id(20363713456850684)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364018655850684)
,p_page_template_id=>wwv_flow_api.id(20363713456850684)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364108358850684)
,p_page_template_id=>wwv_flow_api.id(20363713456850684)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364209804850684)
,p_page_template_id=>wwv_flow_api.id(20363713456850684)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364305052850684)
,p_page_template_id=>wwv_flow_api.id(20363713456850684)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20364419992850689)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364512521850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364607164850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364717448850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364819142850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20364907850850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20365012855850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20365124604850689)
,p_page_template_id=>wwv_flow_api.id(20364419992850689)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(8778191269062204)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20370618724850781)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20370721248850790)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20370816831850790)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20370901329850790)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20371006502850790)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20371111029850790)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365230123850700)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365300506850723)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365432761850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365504926850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365611792850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365710450850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365809530850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20365911144850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366021255850725)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20366128292850726)
,p_plug_template_id=>wwv_flow_api.id(20366021255850725)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366219537850729)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366326972850729)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366432223850729)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366508033850731)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20366613448850731)
,p_plug_template_id=>wwv_flow_api.id(20366508033850731)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366714793850731)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366815336850731)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20366913484850731)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20367000513850731)
,p_plug_template_id=>wwv_flow_api.id(20366913484850731)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20367118204850731)
,p_plug_template_id=>wwv_flow_api.id(20366913484850731)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20367209064850731)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20367329887850731)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20368501121850754)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20368622753850765)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20368722082850765)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20368816357850765)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20368931032850765)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369011007850765)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369132663850765)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369207531850765)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369313485850765)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369407695850765)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369519376850765)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369630505850765)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369717749850765)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20369817670850767)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20367420169850737)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20367502987850746)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20367624542850746)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20367717276850748)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20367814650850751)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20367921214850751)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20368004470850751)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20368112023850751)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20368227542850751)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20368321630850751)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20368407116850751)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20369917870850770)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20370022215850778)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20370120244850778)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20370229584850778)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20370331697850778)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20370427590850778)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20370532071850778)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(20371210712850790)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(20371411713850806)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(20371317576850795)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(20371531628850818)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(20359005818850681)
,p_error_template=>wwv_flow_api.id(20355308884850673)
,p_printer_friendly_template=>wwv_flow_api.id(20361514299850682)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(20353811843850631)
,p_default_button_template=>wwv_flow_api.id(20370618724850781)
,p_default_region_template=>wwv_flow_api.id(20366913484850731)
,p_default_chart_template=>wwv_flow_api.id(20366913484850731)
,p_default_form_template=>wwv_flow_api.id(20366021255850725)
,p_default_reportr_template=>wwv_flow_api.id(20366913484850731)
,p_default_tabform_template=>wwv_flow_api.id(20366913484850731)
,p_default_wizard_template=>wwv_flow_api.id(20366021255850725)
,p_default_menur_template=>wwv_flow_api.id(20365504926850725)
,p_default_listr_template=>wwv_flow_api.id(20366913484850731)
,p_default_irr_template=>wwv_flow_api.id(20366432223850729)
,p_default_report_template=>wwv_flow_api.id(20368004470850751)
,p_default_label_template=>wwv_flow_api.id(20370120244850778)
,p_default_menu_template=>wwv_flow_api.id(20371210712850790)
,p_default_calendar_template=>wwv_flow_api.id(20371317576850795)
,p_default_list_template=>wwv_flow_api.id(20369630505850765)
,p_default_option_label=>wwv_flow_api.id(20370120244850778)
,p_default_required_label=>wwv_flow_api.id(20370427590850778)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(20371807237850823)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(20371629575850821)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(20371629575850821)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20373811669853418)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20366913484850731)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20374601758859989)
,p_plug_name=>'Resultados'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20366432223850729)
,p_plug_display_sequence=>30
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select correlativo, cdmedida,fechamontaje,tipomovimiento from tmontajes_n where tipomovimiento = ''D'' AND fechamontaje >= :P1_INICIO and fechamontaje<= :P1_FIN'
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(20374720988859989)
,p_name=>'Resultados'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>20374720988859989
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20374932290859996)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20375024876859998)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20375102999859998)
...
,p_tz_dependent=>'N'
,p_static_id=>'TIPOMOVIMIENTO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(20376003292883454)
...
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHAMONTAJE'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(20375515610863965)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'203756'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100
,p_report_columns=>'CORRELATIVO:CDMEDIDA:TIPOMOVIMIENTO:FECHAMONTAJE:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20375314917863801)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(20373811669853418)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(8778191269062204)
,p_button_image_alt=>'Generar'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20374131124855309)
,p_name=>'P1_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20373811669853418)
,p_prompt=>'Inicio'
...
,p_field_template=>wwv_flow_api.id(20370120244850778)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20374427027857234)
,p_name=>'P1_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(20373811669853418)
,p_prompt=>'Fin'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180220162919'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(20353811843850631)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180220160544'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20372119000850834)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20366021255850725)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20372400039850840)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(20372119000850834)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20370618724850781)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20372212222850840)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20372119000850834)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20372300472850840)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20372607446850850)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20372526212850840)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20372807585850850)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20372701169850850)
,p_process_sequence=>10
