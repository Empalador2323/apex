...
prompt APPLICATION 156 - Registro_Vales_Norte
--
-- Application Export:
--   Application:     156
--   Name:            Registro_Vales_Norte
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,156)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Registro_Vales_Norte')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_405147148156')
...
,p_authentication_id=>wwv_flow_api.id(369530163978479768)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20220307120858'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(262249928285477485)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(262250029405477485)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(262250207746477485)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(262250357166477485)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(262250470274477485)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(262250525696477485)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(369511865229479637)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(369714654721485506)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(369529853777479768)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(369531763043479770)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(370463445668526545)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(369531435644479770)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(369531852537479770)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369511945554479637)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512036610479637)
,p_page_template_id=>wwv_flow_api.id(369511945554479637)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369512157289479642)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512244310479642)
,p_page_template_id=>wwv_flow_api.id(369512157289479642)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512361337479642)
,p_page_template_id=>wwv_flow_api.id(369512157289479642)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512447166479642)
,p_page_template_id=>wwv_flow_api.id(369512157289479642)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512554668479642)
,p_page_template_id=>wwv_flow_api.id(369512157289479642)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512650080479642)
,p_page_template_id=>wwv_flow_api.id(369512157289479642)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369512737689479642)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512865950479642)
,p_page_template_id=>wwv_flow_api.id(369512737689479642)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369512937832479642)
,p_page_template_id=>wwv_flow_api.id(369512737689479642)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513049660479642)
,p_page_template_id=>wwv_flow_api.id(369512737689479642)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513165187479642)
,p_page_template_id=>wwv_flow_api.id(369512737689479642)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513258083479642)
,p_page_template_id=>wwv_flow_api.id(369512737689479642)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513361213479642)
,p_page_template_id=>wwv_flow_api.id(369512737689479642)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369513456565479642)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513562620479642)
,p_page_template_id=>wwv_flow_api.id(369513456565479642)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513655528479642)
,p_page_template_id=>wwv_flow_api.id(369513456565479642)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513751737479642)
,p_page_template_id=>wwv_flow_api.id(369513456565479642)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369513837218479642)
,p_page_template_id=>wwv_flow_api.id(369513456565479642)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369513942273479642)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514046608479642)
,p_page_template_id=>wwv_flow_api.id(369513942273479642)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514141879479642)
,p_page_template_id=>wwv_flow_api.id(369513942273479642)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514242284479642)
,p_page_template_id=>wwv_flow_api.id(369513942273479642)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514336066479642)
,p_page_template_id=>wwv_flow_api.id(369513942273479642)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514444781479642)
,p_page_template_id=>wwv_flow_api.id(369513942273479642)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369514540535479682)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514649818479682)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514750169479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514861234479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369514948607479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515039397479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515138891479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515249883479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515354417479684)
,p_page_template_id=>wwv_flow_api.id(369514540535479682)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369515446328479684)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515536065479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515640859479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515757102479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515859784479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369515941511479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516039558479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516151402479684)
,p_page_template_id=>wwv_flow_api.id(369515446328479684)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369516238229479684)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516362950479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516438399479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516554768479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516637054479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516742014479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516846052479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369516944664479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517033675479684)
,p_page_template_id=>wwv_flow_api.id(369516238229479684)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369517164743479684)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517255289479684)
,p_page_template_id=>wwv_flow_api.id(369517164743479684)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517350823479684)
,p_page_template_id=>wwv_flow_api.id(369517164743479684)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517434807479684)
,p_page_template_id=>wwv_flow_api.id(369517164743479684)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517560904479684)
,p_page_template_id=>wwv_flow_api.id(369517164743479684)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517650835479684)
,p_page_template_id=>wwv_flow_api.id(369517164743479684)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517740967479684)
,p_page_template_id=>wwv_flow_api.id(369517164743479684)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369517851197479706)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369517947896479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518043909479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518141351479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518265764479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518358036479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518438223479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518565108479706)
,p_page_template_id=>wwv_flow_api.id(369517851197479706)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369518639182479706)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518751329479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518845190479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369518960377479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519046077479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519133860479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519253119479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519341012479707)
,p_page_template_id=>wwv_flow_api.id(369518639182479706)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369519461606479707)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519561310479707)
,p_page_template_id=>wwv_flow_api.id(369519461606479707)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369519635391479707)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519754810479707)
,p_page_template_id=>wwv_flow_api.id(369519635391479707)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519848635479707)
,p_page_template_id=>wwv_flow_api.id(369519635391479707)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369519952845479707)
,p_page_template_id=>wwv_flow_api.id(369519635391479707)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520066215479707)
,p_page_template_id=>wwv_flow_api.id(369519635391479707)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369520153741479707)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520261875479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520345120479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520439132479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520542012479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520636188479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520758009479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369520839925479707)
,p_page_template_id=>wwv_flow_api.id(369520153741479707)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369520942170479718)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521056740479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521137961479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521249897479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521358466479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521457316479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521533607479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521663927479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521736426479718)
,p_page_template_id=>wwv_flow_api.id(369520942170479718)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369521839405479731)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369521953745479731)
,p_page_template_id=>wwv_flow_api.id(369521839405479731)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522052951479731)
,p_page_template_id=>wwv_flow_api.id(369521839405479731)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522163397479731)
,p_page_template_id=>wwv_flow_api.id(369521839405479731)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522253272479731)
,p_page_template_id=>wwv_flow_api.id(369521839405479731)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522357223479731)
,p_page_template_id=>wwv_flow_api.id(369521839405479731)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522436065479731)
,p_page_template_id=>wwv_flow_api.id(369521839405479731)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(369522555359479731)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522650568479731)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522749125479731)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522852348479732)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369522959476479732)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369523062146479732)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369523144673479732)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(369523235465479732)
,p_page_template_id=>wwv_flow_api.id(369522555359479731)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(369528764866479760)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(369528834368479760)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(369528942773479760)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(369529046686479760)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(369529156060479765)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(369529257929479765)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523357265479732)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523456945479732)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523539076479732)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523636497479742)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523737390479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523833907479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369523939661479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524044397479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524142154479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(369524263271479743)
,p_plug_template_id=>wwv_flow_api.id(369524142154479743)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524336355479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524446132479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524539208479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524642746479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(369524765178479743)
,p_plug_template_id=>wwv_flow_api.id(369524642746479743)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524834666479743)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369524943433479746)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369525064560479746)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(369525144201479746)
,p_plug_template_id=>wwv_flow_api.id(369525064560479746)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(369525249766479746)
,p_plug_template_id=>wwv_flow_api.id(369525064560479746)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369525345611479746)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(369525444784479746)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369526653341479750)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369526758253479751)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369526845808479751)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369526939445479751)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527065619479751)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527156027479751)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527240273479751)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527335854479751)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527435871479751)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527547807479751)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527657920479757)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527734449479757)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527835393479757)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(369527960838479757)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369525560905479746)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369525658116479746)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369525741762479746)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369525835219479748)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369525936754479748)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369526052620479748)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369526147445479748)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369526265838479748)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369526337713479750)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369526446307479750)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(369526563227479750)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528063935479757)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528159819479757)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528234925479757)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528345088479760)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528446859479760)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528565314479760)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(369528634206479760)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(369529343477479765)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(369529557303479767)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(369529465365479765)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(369529636619479767)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(369517164743479684)
,p_error_template=>wwv_flow_api.id(369513456565479642)
,p_printer_friendly_template=>wwv_flow_api.id(369519635391479707)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(369511945554479637)
,p_default_button_template=>wwv_flow_api.id(369528764866479760)
,p_default_region_template=>wwv_flow_api.id(369525064560479746)
,p_default_chart_template=>wwv_flow_api.id(369525064560479746)
,p_default_form_template=>wwv_flow_api.id(369524142154479743)
,p_default_reportr_template=>wwv_flow_api.id(369525064560479746)
,p_default_tabform_template=>wwv_flow_api.id(369525064560479746)
,p_default_wizard_template=>wwv_flow_api.id(369524142154479743)
,p_default_menur_template=>wwv_flow_api.id(369523636497479742)
,p_default_listr_template=>wwv_flow_api.id(369525064560479746)
,p_default_irr_template=>wwv_flow_api.id(369524539208479743)
,p_default_report_template=>wwv_flow_api.id(369526147445479748)
,p_default_label_template=>wwv_flow_api.id(369528234925479757)
,p_default_menu_template=>wwv_flow_api.id(369529343477479765)
,p_default_calendar_template=>wwv_flow_api.id(369529465365479765)
,p_default_list_template=>wwv_flow_api.id(369527734449479757)
,p_default_option_label=>wwv_flow_api.id(369528234925479757)
,p_default_required_label=>wwv_flow_api.id(369528565314479760)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(262270110305014424)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(369529937490479768)
,p_name=>'ASIGNACION'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(369530058322479768)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(369530163978479768)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
,p_attribute_03=>'custom_auth'
,p_attribute_05=>'N'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(369530364093479768)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(369529743779479767)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(369529743779479767)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(369531961418479771)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369523636497479742)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(369531435644479770)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(369529343477479765)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(369583741238850637)
,p_plug_name=>'INGRESO_INTERNO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369525064560479746)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(370114341388124485)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(369583741238850637)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369525064560479746)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(370446441295230787)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(370451857796301726)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(369584044378850657)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(369583741238850637)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(369528764866479760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(369584262786850657)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(369583940561850657)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(369584544735850662)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(118964944324145625)
,p_name=>'P1_RENDIMIENTO_REAL'
,p_is_required=>true
,p_item_sequence=>126
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
...
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(369528234925479757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(118965229998145628)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(128311977574822527)
,p_name=>'P1_GRABA'
,p_item_sequence=>66
,p_item_plug_id=>wwv_flow_api.id(370451857796301726)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(183059056027354154)
,p_name=>'P1_GALVIAJE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(370446441295230787)
,p_prompt=>'Galviaje'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(188392500932475652)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369584742995850667)
,p_name=>'P1_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(369583741238850637)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369584943843850675)
,p_name=>'P1_NMVALE'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(370451857796301726)
...
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(369528565314479760)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369585140628850676)
,p_name=>'P1_FECHA'
,p_item_sequence=>23
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369585352248850676)
,p_name=>'P1_NOTAVIAJE'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(370451857796301726)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369585547743850676)
,p_name=>'P1_CDCLASACT'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369585749479850681)
,p_name=>'P1_CORRACT'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369585948838850682)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369586565089850687)
,p_name=>'P1_CDTIPCOMB'
,p_item_sequence=>12
,p_item_plug_id=>wwv_flow_api.id(370446441295230787)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369586748494850689)
,p_name=>'P1_NMBOMBA'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(370451857796301726)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369586938187850689)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369587146615850690)
,p_name=>'P1_NMORDENC'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(370446441295230787)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369587546946850690)
,p_name=>'P1_KMRETORNO'
,p_item_sequence=>4.5
,p_item_plug_id=>wwv_flow_api.id(370451857796301726)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369587948877850692)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369588152090850693)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369588349211850693)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369650858488444929)
,p_name=>'P1_CDRECIBE'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_prompt=>'Piloto'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369687146014468740)
,p_name=>'P1_CDEMPRESA'
,p_item_sequence=>36
,p_item_plug_id=>wwv_flow_api.id(369583741238850637)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370223543300398045)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370381257941135421)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370396458963469220)
,p_name=>'P1_KM_GLN'
,p_item_sequence=>66
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_prompt=>'Km/Gln'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370396648180474225)
,p_name=>'P1_DISTANCIA'
,p_item_sequence=>76
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_prompt=>'Distancia'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371356747489368976)
,p_name=>'P1_KMSALE'
,p_item_sequence=>75
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371363934488450868)
,p_name=>'P1_RECORRIDO'
,p_item_sequence=>86
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371476557057917081)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371477858123931848)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(373047252732755667)
,p_name=>'P1_ESTADO'
,p_item_sequence=>106
,p_item_plug_id=>wwv_flow_api.id(370114341388124485)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(93395339491613637)
,p_validation_name=>'kilometraje'
,p_validation_sequence=>10
,p_validation=>' :p1_recorrido<2000'
,p_validation_type=>'PLSQL_EXPRESSION'
,p_error_message=>'REVISE KILOMETRAJE'
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(183059127181354155)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(93395470191613638)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(93395582655613639)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(371364453008461439)
,p_name=>'recorre'
,p_event_sequence=>5
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371364748346461443)
,p_event_id=>wwv_flow_api.id(371364453008461439)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(373051560596823600)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(373051845469823609)
,p_event_id=>wwv_flow_api.id(373051560596823600)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
,p_attribute_07=>'P1_KM_GLN,P1_RECORRIDO'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(370115137625151876)
,p_name=>'cargar datos'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370115436869151912)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370119646903290298)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370120747753305160)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
begin
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370133551935728639)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370164338137056906)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370169048846143131)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370240246108186871)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370423436187905229)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(370424354722911870)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371484555246024360)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371485264723035125)
,p_event_id=>wwv_flow_api.id(370115137625151876)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(118965043744145626)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(118965156283145627)
,p_event_id=>wwv_flow_api.id(118965043744145626)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369590742752850698)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369590942912850701)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(372568852834092881)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(369583940561850657)
,p_process_success_message=>'ACTUALIZADO'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(390566254760962509)
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'doc_inv(''VALN'',:p1_nmvale,''VALCOMB'',sysdate,sysdate,''N'',''SYSTEM'','' '');',
'commit;',
'doc_inv_linea(''37DI001-1'',''BDN'',''12'',''C'',''D'',''N'',:P1_CANTDESPACHA,0,0,0,0,:P1_CENTRO_COSTO,''~CC~'',''6.1.1.01.021'',''11600000K'',''VALN'',:P1_NMVALE,1,0,0);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(369583940561850657)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(93395690204613640)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369591161102850701)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20211130144947'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(370480041125318828)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(370562145466851576)
,p_plug_name=>'NUEVO VALE'
,p_parent_plug_id=>wwv_flow_api.id(370480041125318828)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369525064560479746)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(370563363605866239)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(370480041125318828)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(370480436304318840)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(370480041125318828)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(369528764866479760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(370480237794318839)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(370480041125318828)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(370480652406318853)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(128312020573822528)
,p_name=>'P2_GRABA'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
,p_use_cache_before_default=>'NO'
,p_item_default=>'(:APP_USER)'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Graba'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(188392361665475650)
,p_name=>'P2_ORIGEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370480850516318940)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(370480041125318828)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370481039016318957)
,p_name=>'P2_NMVALE'
,p_is_required=>true
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370481263528318965)
,p_name=>'P2_FECHA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(370563363605866239)
,p_use_cache_before_default=>'NO'
,p_item_default=>'SYSDATE'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Fecha'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370481446795318965)
,p_name=>'P2_NOTAVIAJE'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370481657970318965)
,p_name=>'P2_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(370563363605866239)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370481854870318967)
,p_name=>'P2_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(370563363605866239)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370482251399318967)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370482463899318967)
,p_name=>'P2_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(370480041125318828)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370482659705318968)
,p_name=>'P2_CDTIPCOMB'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(370480041125318828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370482842906318968)
,p_name=>'P2_NMBOMBA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(370480041125318828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370483061316318968)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370483250435318970)
,p_name=>'P2_NMORDENC'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(370480041125318828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370483444246318970)
,p_name=>'P2_KMSALE'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(370563363605866239)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370483645047318970)
,p_name=>'P2_KMRETORNO'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370483860815318971)
,p_name=>'P2_RECORRIDO'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(370563363605866239)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370484053998318971)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370484264609318971)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370484437625318971)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370484666216318973)
,p_name=>'P2_NOBOMBA'
,p_is_required=>true
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370484861752318975)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370485049671318975)
,p_name=>'P2_NOFACTURA'
,p_is_required=>true
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370506864274685181)
,p_name=>'P2_CDRECIBE'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(370563363605866239)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(370579860121349703)
,p_name=>'P2_TOTAL'
,p_item_sequence=>71
,p_item_plug_id=>wwv_flow_api.id(370562145466851576)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371190441558584681)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371482063681990048)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371482349879996387)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(371190953655614917)
,p_name=>'galon'
,p_event_sequence=>4
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371191244703614931)
,p_event_id=>wwv_flow_api.id(371190953655614917)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(371034563999270426)
,p_name=>'Precio'
,p_event_sequence=>5
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371034845175270429)
,p_event_id=>wwv_flow_api.id(371034563999270426)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(371020650681030028)
,p_name=>'INGRESO_EXTERNO'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371020935391030043)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371028060470164073)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371028352274167948)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371028635237175817)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371029050968183709)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371485752215040875)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371486040785046229)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371486762338051376)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(371486946164058921)
,p_event_id=>wwv_flow_api.id(371020650681030028)
,p_event_result=>'TRUE'
,p_action_sequence=>100
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(185572070038317167)
,p_name=>'recorre'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_KMRETORNO'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(185572107365317168)
,p_event_id=>wwv_flow_api.id(185572070038317167)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(370487533553318987)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(370487760010319007)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(371434438647971226)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'km'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(370480237794318839)
);
end;
/
begin
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(370487949503319007)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210608095558'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(262277056334014518)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369524539208479743)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262277427541014518)
,p_name=>'Report 1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262277579654014560)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262277834782014635)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262278266052014637)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262278674705014638)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262279104652014640)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262279478129014641)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262279867997014643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262280303708014644)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262280675098014646)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262280951189014652)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262281359269014652)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262281777283014655)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262282652572015080)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(371621339190602354)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(371621555594602354)
,p_name=>'ANULAR VALE'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371621643399602365)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371621764064602367)
,p_db_column_name=>'NMVALE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmvale'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371621847963602368)
,p_db_column_name=>'FECHA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371621937507602370)
,p_db_column_name=>'NOTAVIAJE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Notaviaje'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622239321602375)
,p_db_column_name=>'CANTDESPACHA'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cantdespacha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622349548602376)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622448291602378)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622539368602379)
,p_db_column_name=>'CDTIPCOMB'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Cdtipcomb'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622664925602381)
,p_db_column_name=>'NMBOMBA'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Nmbomba'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622735540602382)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622845310602384)
,p_db_column_name=>'NMORDENC'
,p_display_order=>13
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371622940784602387)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371623045392602389)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371623137193602390)
,p_db_column_name=>'RECORRIDO'
,p_display_order=>16
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371623564355602400)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371623653275602401)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371695340318273989)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(371695461537273989)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(371623846760602604)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210608143841'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(262268903531014409)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369524142154479743)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262269390704014412)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(262268903531014409)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(369528764866479760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262269578904014412)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(262268903531014409)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(262271442769014435)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262271899382014437)
,p_name=>'P6_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(262268903531014409)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262272255007014457)
,p_name=>'P6_NMVALE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(262268903531014409)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262272541927014479)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262272929494014482)
,p_name=>'P6_NMBOMBA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(262268903531014409)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262273337134014484)
,p_name=>'P6_NMORDENC'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(262268903531014409)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(262275387684014485)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(259496570365751161)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(262269390704014412)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(262275783098014491)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(262276122540014491)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210608082206'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(371619037659602320)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369524142154479743)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(371619242960602323)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(371619037659602320)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(369528764866479760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(371619447203602323)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(371619037659602320)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(371619659080602325)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371619853106602328)
,p_name=>'P7_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371620035349602332)
,p_name=>'P7_NMVALE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(371620253791602339)
,p_name=>'P7_ESTADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(372333454719146515)
,p_name=>'P7_RECORRIDO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(372333938976153750)
,p_name=>'P7_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(372334165489156710)
,p_name=>'P7_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(372335164614172237)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(372335459223174826)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(373637155360585403)
,p_name=>'P7_KMRETORNO'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(371619037659602320)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(371620865757602342)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(371621037439602342)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(372336039438184515)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'KM'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(371619242960602323)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(390584641409559367)
,p_process_sequence=>36
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(371621244819602342)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'EXTRAS'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20210831123437'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(464790838906146663)
,p_plug_name=>'INGRESO_INTERNO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369525064560479746)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(465321439055420511)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(464790838906146663)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369525064560479746)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(465653538962526813)
,p_plug_name=>'DATOS COMBUSTIBLE'
,p_parent_plug_id=>wwv_flow_api.id(464790838906146663)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(465658955463597752)
,p_plug_name=>'NUEVO VALE'
,p_parent_plug_id=>wwv_flow_api.id(464790838906146663)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95208950081296084)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(464790838906146663)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(369528764866479760)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95209352408296090)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(464790838906146663)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95209613018296090)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(464790838906146663)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(95232689379296170)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95210074569296090)
,p_name=>'P8_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(464790838906146663)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95210432346296097)
,p_name=>'P8_CDEMPRESA'
,p_item_sequence=>36
,p_item_plug_id=>wwv_flow_api.id(464790838906146663)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95211170714296098)
,p_name=>'P8_CDCLASACT'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Unidad'
,p_source=>'CDCLASACT'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT CDCLASEUNI, CDCLASEUNI AS CLASE FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'N'
,p_cSize=>32
,p_cMaxlength=>15
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95211596095296100)
,p_name=>'P8_CORRACT'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT correlativouni AS CLASE,correlativouni FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95211983456296100)
,p_name=>'P8_CDCLASE_COMP'
,p_item_sequence=>9
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Complemento'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT CDCLASECOMP AS CDCOMPLEMENTO,CDCLASECOMP FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>32
,p_cMaxlength=>15
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95212322266296100)
,p_name=>'P8_CORRELCOMP'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
,p_source=>'CORRELCOMP'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT CORRELATIVOCOMP,CORRELATIVOCOMP AS COCOMPLEMENTO FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95212705864296101)
,p_name=>'P8_CDCLASECOMP2'
,p_item_sequence=>13
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_prompt=>'Complemento 2'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>' SELECT CDCLASECOMP2, CDCLASECOMP2 AS CLASE FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95213155704296101)
,p_name=>'P8_CORRELATIVOCOMP2'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
' SELECT CORRELATIVOCOMP2, CORRELATIVOCOMP2 AS CORRACT FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE',
'    '))
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95213531036296109)
,p_name=>'P8_FECHA'
,p_item_sequence=>23
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95213940331296109)
,p_name=>'P8_CDDELEGACION'
,p_item_sequence=>24
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Ubicacion'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT CDDELEGACION, CDDELEGACION UBICACION FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>32
,p_cMaxlength=>2
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95214305189296111)
,p_name=>'P8_OBSERVACIONES'
,p_item_sequence=>25
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Observaciones'
...
'       INNER JOIN TCLIENTES B ON A.CDORIGEN = B.CDCLIENTE ',
'       INNER JOIN TCLIENTES C ON A.CDDESTINO = C.CDCLIENTE ',
'       INNER JOIN TZONATAR D ON C.CDZONATAR = D.CDZONATAR INNER JOIN EMPLEADO@softland E ON A.PILOTODES = E.EMPleado WHERE NMNOTA =:P8_NOTAVIAJE'))
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>60
,p_cMaxlength=>1000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95214725242296111)
,p_name=>'P8_CDRECIBE'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_prompt=>'Piloto'
...
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select TO_NUMBER(b.empleado),TO_NUMBER(b.empleado) nombre from tnotaviaje a ',
'inner join empleado@softland b on a.pilotodes = b.empleado where nmnota = :P8_NOTAVIAJE '))
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95215195604296112)
,p_name=>'P8_KM_GLN'
,p_item_sequence=>66
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_prompt=>'Km/Gln'
...
' INNER JOIN TZONATAR D ON C.CDZONATAR = D.CDZONATAR',
'  INNER JOIN EMPLEADO@softland E ON A.PILOTODES = E.EMPleado',
'  inner join tactivos e on a.cdclaseuni = e.cdclase and a.correlativouni = e.correlativo  where a.nmnota = :P8_NOTAVIAJE'))
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95215583694296112)
,p_name=>'P8_KMSALE'
,p_item_sequence=>75
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
...
'WHERE NMVALE = (SELECT MAX(NMVALE) NMVALE FROM TVALES WHERE ',
'creado =  (select MAX(creado) creado from tvales where ',
'cdclasact =:P8_CDCLASACT AND CORRACT =:P8_CORRACT ) AND cdclasact =:P8_CDCLASACT AND CORRACT =:P8_CORRACT) AND',
' creado = (SELECT MAX(creado) NMVALE FROM TVALES WHERE creado =  (select MAX(creado) FECHA from tvales where cdclasact =:P8_CDCLASACT AND CORRACT =:P8_CORRACT)',
' AND cdclasact =:P8_CDCLASACT AND CORRACT = :P8_CORRACT )  group by  cddelegacion ,nmvale',
' '))
,p_lov_cascade_parent_items=>'P8_CDCLASACT,P8_CORRACT'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(369528234925479757)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95215975333296115)
,p_name=>'P8_DISTANCIA'
,p_item_sequence=>76
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_prompt=>'Distancia'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95216313671296115)
,p_name=>'P8_RECORRIDO'
,p_item_sequence=>86
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95216756607296115)
,p_name=>'P8_CENTRO_COSTO'
,p_item_sequence=>96
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_prompt=>'Centro Costo'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select centro_costo,centro_costo as centro from centro_costo  WHERE DESCRIPCION=:P8_CDCLASACT||''-''||:P8_CORRACT'
,p_lov_cascade_parent_items=>'P8_CDCLASACT,P8_CORRACT'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(369528234925479757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95217199701296115)
,p_name=>'P8_ESTADO'
,p_item_sequence=>106
,p_item_plug_id=>wwv_flow_api.id(465321439055420511)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95217833320296117)
,p_name=>'P8_GALVIAJE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(465653538962526813)
,p_prompt=>'Galviaje'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>' select nvl(galvale,0),nvl(galvale,0) galones_vale from tnotaviaje where nmnota = :P8_NOTAVIAJE'
,p_lov_cascade_parent_items=>'P8_NOTAVIAJE'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(369528234925479757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95218201938296117)
,p_name=>'P8_NMORDENC'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(465653538962526813)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT NMORDENC,NMORDENC TANCADA FROM TCOMPRACOMB WHERE  NOBOMBA =:P8_NMBOMBA and estadoorden=''A'''
,p_lov_cascade_parent_items=>'P8_NMBOMBA'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95218652351296118)
,p_name=>'P8_CDTIPCOMB'
,p_item_sequence=>12
,p_item_plug_id=>wwv_flow_api.id(465653538962526813)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT CDTIPCOMB,CDTIPCOMB TIPO FROM TCOMPRACOMB WHERE  NOBOMBA =:P8_NMBOMBA and estadoorden=''A'''
,p_lov_cascade_parent_items=>'P8_NMBOMBA'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95219034663296118)
,p_name=>'P8_EXISTENCIA'
,p_item_sequence=>46
,p_item_plug_id=>wwv_flow_api.id(465653538962526813)
,p_prompt=>'Existencia'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select A.EXISTENCIA - NVL(SUM(B.CANTDESPACHA),0) EXISTENCIA,A.EXISTENCIA - NVL(SUM(B.CANTDESPACHA),0) from tCOMPRACOMB A',
' LEFT OUTER JOIN TVALES  B ON A.NMORDENC = B.NMORDENC AND A.CDDELEGACION = B.CDDELEGACION WHERE   ESTADOORDEN = ''A'' and a.nobomba =  :P8_NMBOMBA GROUP BY A.NMORDENC,A.EXISTENCIA'))
,p_lov_cascade_parent_items=>'P8_NMBOMBA'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95219773148296120)
,p_name=>'P8_NMBOMBA'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(465658955463597752)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Numero de Bomba'
,p_source=>'NMBOMBA'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95220114665296120)
,p_name=>'P8_NOTAVIAJE'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(465658955463597752)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95220570490296120)
,p_name=>'P8_NMVALE'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(465658955463597752)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95220908839296120)
,p_name=>'P8_KMRETORNO'
,p_item_sequence=>4.5
,p_item_plug_id=>wwv_flow_api.id(465658955463597752)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95221372712296122)
,p_name=>'P8_CANTDESPACHA'
,p_is_required=>true
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(465658955463597752)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95221769567296122)
,p_name=>'P8_ESTIMADO_RUTA'
,p_item_sequence=>56
,p_item_plug_id=>wwv_flow_api.id(465658955463597752)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(95222534268296148)
,p_validation_name=>'NULO'
,p_validation_sequence=>20
,p_validation=>'P8_GALVIAJE'
,p_validation2=>'0'
,p_validation_type=>'ITEM_IN_VALIDATION_EQ_STRING2'
,p_error_message=>'YA EXISTE UN VALE RELACIONADA CON ESTA NOTA'
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(95224803825296156)
,p_name=>'recorre'
,p_event_sequence=>5
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P8_KMRETORNO'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95225372704296159)
,p_event_id=>wwv_flow_api.id(95224803825296156)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_RECORRIDO'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select :P8_KMRETORNO - :P8_KMSALE from dual '
,p_attribute_07=>'P8_KMRETORNO,P8_KMSALE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(95225741004296162)
,p_name=>'ESTIMADO_RUTA'
,p_event_sequence=>6
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P8_DISTANCIA'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95226269689296162)
,p_event_id=>wwv_flow_api.id(95225741004296162)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_ESTIMADO_RUTA'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select round(:P8_DISTANCIA / :P8_KM_GLN,2) from dual'
,p_attribute_07=>'P8_DISTANCIA,P8_KM_GLN'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(95226644618296162)
,p_name=>'cargar datos'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P8_NOTAVIAJE'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95227170738296162)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CDCLASACT'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT CDCLASEUNI, CDCLASEUNI AS CLASE FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_attribute_07=>'P8_NOTAVIAJE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95227685013296164)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CORRACT'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT correlativouni AS CLASE FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_attribute_07=>'P8_NOTAVIAJE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95228191906296164)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_OBSERVACIONES'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT ''DE '' || NVL(B.NOMBRE_CORTO,B.DSCLIENTE)  || '' A '' || D.DSZONATAR  || ''  CLIENTE  '' || C.DSCLIENTE || '' DISTANCIA '' || NVL(C.DISTANCIA,0) || '' KMS'',''DE '' || NVL(B.NOMBRE_CORTO,B.DSCLIENTE)  || '' A '' || D.DSZONATAR  || ''  CLIENTE  '' || C.DSCLIE'
||'NTE || '' DISTANCIA '' || NVL(C.DISTANCIA,0) || '' KMS'' VIAJE',
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95228606969296164)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CDCLASE_COMP'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT CDCLASECOMP AS CDCOMPLEMENTO FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_attribute_07=>'P8_NOTAVIAJE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95229112992296165)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CDTIPCOMB'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT CDTIPCOMB,CDTIPCOMB TIPO FROM TCOMPRACOMB WHERE  NOBOMBA =:P8_NMBOMBA and estadoorden=''A'''
,p_attribute_07=>'P8_NMBOMBA'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95229671785296165)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CDRECIBE'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select TO_NUMBER(b.empleado) from tnotaviaje a ',
'inner join empleado@softland b on a.pilotodes = b.empleado where nmnota = :P8_NOTAVIAJE '))
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95230184903296165)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_EXISTENCIA'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select A.EXISTENCIA - NVL(SUM(B.CANTDESPACHA),0) EXISTENCIA from tCOMPRACOMB A',
' LEFT OUTER JOIN TVALES  B ON A.NMORDENC = B.NMORDENC AND A.CDDELEGACION = B.CDDELEGACION WHERE   ESTADOORDEN = ''A'' and a.nobomba =  :P8_NMBOMBA GROUP BY A.NMORDENC,A.EXISTENCIA'))
...
begin
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95230669310296165)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>100
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95231132844296167)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>110
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_DISTANCIA'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  SELECT ',
'decode(nvl(C.DISTANCIA,0),0,1,c.distancia) distancia  FROM TNOTAVIAJE A ',
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95231676295296167)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>130
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CDCLASECOMP2'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT CDCLASECOMP2, CDCLASECOMP2 AS CLASE FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_attribute_07=>'P8_NOTAVIAJE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(95232192984296167)
,p_event_id=>wwv_flow_api.id(95226644618296162)
,p_event_result=>'TRUE'
,p_action_sequence=>140
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P8_CORRELATIVOCOMP2'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT CORRELATIVOCOMP2, CORRELATIVOCOMP2 AS CORRACT FROM TNOTAVIAJE WHERE NMNOTA = :P8_NOTAVIAJE'
,p_attribute_07=>'P8_NOTAVIAJE'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95222801719296153)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95223290086296154)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95224095691296154)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'km'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'actualizakm(:P8_RECORRIDO,:P8_CDCLASACT||''-''||:P8_CORRACT,:P8_CDCLASE_COMP||''-''||:P8_CORRELCOMP,:P8_cdclasecomp2||''-''||:P8_correlativocomp2);',
'end;'))
,p_process_error_message=>'ERROR AL ACTUALIZAR'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(95209613018296090)
,p_process_success_message=>'ACTUALIZADO'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95224413161296156)
,p_process_sequence=>36
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'AGREGAR LINEA EN PAQUETE'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'doc_inv(''VALN'',:p8_nmvale,''VALCOMB'',sysdate,sysdate,''N'',''SYSTEM'','' '');',
'commit;',
'doc_inv_linea(''37DI001-1'',''BDN'',''ND'',''C'',''D'',''N'',:P8_CANTDESPACHA,0,0,0,0,:P8_CENTRO_COSTO,''~CC~'',''6.1.1.01.021'',''11600000K'',''VALN'',:P8_NMVALE,1,0,0);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(95209613018296090)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95223650919296154)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(369511945554479637)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(369530638948479768)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(369524142154479743)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(369530942838479770)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(369530638948479768)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369530765782479770)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(369530638948479768)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(369530837859479770)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369531164867479770)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369531065998479770)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369531356200479770)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(369531245072479770)
,p_process_sequence=>10
