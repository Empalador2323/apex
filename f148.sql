...
prompt APPLICATION 148 - Registro_Vales_Fuleadores
--
-- Application Export:
--   Application:     148
--   Name:            Registro_Vales_Fuleadores
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Registro_Vales_Fuleadores')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_405147148')
...
,p_authentication_id=>wwv_flow_api.id(274530778133617731)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20220316150900'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(167250542440615448)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(167250643560615448)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(167250821901615448)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(167250971321615448)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(167251084429615448)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(167251139851615448)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(274512479384617600)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(274715268876623469)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(274530467932617731)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(274532377198617733)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(275464059823664508)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(16171287328760096)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
,p_tab_name=>'T_LISTADODEVALES'
,p_tab_text=>'LISTADO DE VALES'
,p_tab_step=>8
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(274532049799617733)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(274532466692617733)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274512559709617600)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274512650765617600)
,p_page_template_id=>wwv_flow_api.id(274512559709617600)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274512771444617605)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274512858465617605)
,p_page_template_id=>wwv_flow_api.id(274512771444617605)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274512975492617605)
,p_page_template_id=>wwv_flow_api.id(274512771444617605)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513061321617605)
,p_page_template_id=>wwv_flow_api.id(274512771444617605)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513168823617605)
,p_page_template_id=>wwv_flow_api.id(274512771444617605)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513264235617605)
,p_page_template_id=>wwv_flow_api.id(274512771444617605)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274513351844617605)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513480105617605)
,p_page_template_id=>wwv_flow_api.id(274513351844617605)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513551987617605)
,p_page_template_id=>wwv_flow_api.id(274513351844617605)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513663815617605)
,p_page_template_id=>wwv_flow_api.id(274513351844617605)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513779342617605)
,p_page_template_id=>wwv_flow_api.id(274513351844617605)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513872238617605)
,p_page_template_id=>wwv_flow_api.id(274513351844617605)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274513975368617605)
,p_page_template_id=>wwv_flow_api.id(274513351844617605)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274514070720617605)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514176775617605)
,p_page_template_id=>wwv_flow_api.id(274514070720617605)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514269683617605)
,p_page_template_id=>wwv_flow_api.id(274514070720617605)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514365892617605)
,p_page_template_id=>wwv_flow_api.id(274514070720617605)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514451373617605)
,p_page_template_id=>wwv_flow_api.id(274514070720617605)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274514556428617605)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514660763617605)
,p_page_template_id=>wwv_flow_api.id(274514556428617605)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514756034617605)
,p_page_template_id=>wwv_flow_api.id(274514556428617605)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514856439617605)
,p_page_template_id=>wwv_flow_api.id(274514556428617605)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274514950221617605)
,p_page_template_id=>wwv_flow_api.id(274514556428617605)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515058936617605)
,p_page_template_id=>wwv_flow_api.id(274514556428617605)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274515154690617645)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515263973617645)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515364324617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515475389617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515562762617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515653552617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515753046617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515864038617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274515968572617647)
,p_page_template_id=>wwv_flow_api.id(274515154690617645)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274516060483617647)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516150220617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516255014617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516371257617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516473939617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516555666617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516653713617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516765557617647)
,p_page_template_id=>wwv_flow_api.id(274516060483617647)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274516852384617647)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274516977105617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517052554617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517168923617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517251209617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517356169617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517460207617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517558819617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517647830617647)
,p_page_template_id=>wwv_flow_api.id(274516852384617647)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274517778898617647)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517869444617647)
,p_page_template_id=>wwv_flow_api.id(274517778898617647)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274517964978617647)
,p_page_template_id=>wwv_flow_api.id(274517778898617647)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518048962617647)
,p_page_template_id=>wwv_flow_api.id(274517778898617647)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518175059617647)
,p_page_template_id=>wwv_flow_api.id(274517778898617647)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518264990617647)
,p_page_template_id=>wwv_flow_api.id(274517778898617647)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518355122617647)
,p_page_template_id=>wwv_flow_api.id(274517778898617647)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274518465352617669)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518562051617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518658064617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518755506617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518879919617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274518972191617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519052378617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519179263617669)
,p_page_template_id=>wwv_flow_api.id(274518465352617669)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274519253337617669)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519365484617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519459345617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519574532617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519660232617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519748015617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519867274617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274519955167617670)
,p_page_template_id=>wwv_flow_api.id(274519253337617669)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274520075761617670)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520175465617670)
,p_page_template_id=>wwv_flow_api.id(274520075761617670)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274520249546617670)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520368965617670)
,p_page_template_id=>wwv_flow_api.id(274520249546617670)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520462790617670)
,p_page_template_id=>wwv_flow_api.id(274520249546617670)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520567000617670)
,p_page_template_id=>wwv_flow_api.id(274520249546617670)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520680370617670)
,p_page_template_id=>wwv_flow_api.id(274520249546617670)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274520767896617670)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520876030617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274520959275617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521053287617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521156167617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521250343617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521372164617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521454080617670)
,p_page_template_id=>wwv_flow_api.id(274520767896617670)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274521556325617681)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521670895617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521752116617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521864052617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274521972621617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522071471617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522147762617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522278082617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522350581617681)
,p_page_template_id=>wwv_flow_api.id(274521556325617681)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274522453560617694)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522567900617694)
,p_page_template_id=>wwv_flow_api.id(274522453560617694)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522667106617694)
,p_page_template_id=>wwv_flow_api.id(274522453560617694)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522777552617694)
,p_page_template_id=>wwv_flow_api.id(274522453560617694)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522867427617694)
,p_page_template_id=>wwv_flow_api.id(274522453560617694)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274522971378617694)
,p_page_template_id=>wwv_flow_api.id(274522453560617694)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523050220617694)
,p_page_template_id=>wwv_flow_api.id(274522453560617694)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(274523169514617694)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523264723617694)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523363280617694)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523466503617695)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523573631617695)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523676301617695)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523758828617695)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(274523849620617695)
,p_page_template_id=>wwv_flow_api.id(274523169514617694)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(274529379021617723)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(274529448523617723)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(274529556928617723)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(274529660841617723)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(274529770215617728)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(274529872084617728)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274523971420617695)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524071100617695)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524153231617695)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524250652617705)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524351545617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524448062617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524553816617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524658552617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524756309617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(274524877426617706)
,p_plug_template_id=>wwv_flow_api.id(274524756309617706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274524950510617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525060287617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525153363617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525256901617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(274525379333617706)
,p_plug_template_id=>wwv_flow_api.id(274525256901617706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525448821617706)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525557588617709)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525678715617709)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(274525758356617709)
,p_plug_template_id=>wwv_flow_api.id(274525678715617709)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(274525863921617709)
,p_plug_template_id=>wwv_flow_api.id(274525678715617709)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274525959766617709)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(274526058939617709)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527267496617713)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527372408617714)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527459963617714)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527553600617714)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527679774617714)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527770182617714)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527854428617714)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274527950009617714)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274528050026617714)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274528161962617714)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274528272075617720)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274528348604617720)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274528449548617720)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(274528574993617720)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526175060617709)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526272271617709)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526355917617709)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526449374617711)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526550909617711)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526666775617711)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526761600617711)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526879993617711)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274526951868617713)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274527060462617713)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(274527177382617713)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274528678090617720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274528773974617720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274528849080617720)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274528959243617723)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274529061014617723)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274529179469617723)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(274529248361617723)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(274529957632617728)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(274530171458617730)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(274530079520617728)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(274530250774617730)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(274517778898617647)
,p_error_template=>wwv_flow_api.id(274514070720617605)
,p_printer_friendly_template=>wwv_flow_api.id(274520249546617670)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(274512559709617600)
,p_default_button_template=>wwv_flow_api.id(274529379021617723)
,p_default_region_template=>wwv_flow_api.id(274525678715617709)
,p_default_chart_template=>wwv_flow_api.id(274525678715617709)
,p_default_form_template=>wwv_flow_api.id(274524756309617706)
,p_default_reportr_template=>wwv_flow_api.id(274525678715617709)
,p_default_tabform_template=>wwv_flow_api.id(274525678715617709)
,p_default_wizard_template=>wwv_flow_api.id(274524756309617706)
,p_default_menur_template=>wwv_flow_api.id(274524250652617705)
,p_default_listr_template=>wwv_flow_api.id(274525678715617709)
,p_default_irr_template=>wwv_flow_api.id(274525153363617706)
,p_default_report_template=>wwv_flow_api.id(274526761600617711)
,p_default_label_template=>wwv_flow_api.id(274528849080617720)
,p_default_menu_template=>wwv_flow_api.id(274529957632617728)
,p_default_calendar_template=>wwv_flow_api.id(274530079520617728)
,p_default_list_template=>wwv_flow_api.id(274528348604617720)
,p_default_option_label=>wwv_flow_api.id(274528849080617720)
,p_default_required_label=>wwv_flow_api.id(274529179469617723)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(167270724460152387)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(274530551645617731)
,p_name=>'ASIGNACION'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(274530672477617731)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(274530778133617731)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
,p_attribute_03=>'custom_auth'
,p_attribute_05=>'N'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(274530978248617731)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(274530357934617730)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(274530357934617730)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220315163933'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(274532575573617734)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274524250652617705)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(274532049799617733)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(274529957632617728)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(274584355393988600)
,p_plug_name=>'INGRESO_INTERNO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274525678715617709)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(275114955543262448)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(274584355393988600)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274525678715617709)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(275447055450368750)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(275452471951439689)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(274584658533988620)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(274584355393988600)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(274529379021617723)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(274584876941988620)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(274584554716988620)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(274585158890988625)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(88059670182492117)
,p_name=>'P1_GALVIAJE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(275447055450368750)
,p_prompt=>'Galviaje'
...
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(274528849080617720)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(93393115087613615)
,p_name=>'P1_CENTRO_COSTO'
,p_item_sequence=>96
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(118965874032145634)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(118965942435145635)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(128311762874822525)
,p_name=>'P1_GRABA'
,p_item_sequence=>66
,p_item_plug_id=>wwv_flow_api.id(275452471951439689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274585357150988630)
,p_name=>'P1_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(274584355393988600)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274585557998988638)
,p_name=>'P1_NMVALE'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(275452471951439689)
...
,p_field_template=>wwv_flow_api.id(274529179469617723)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274585754783988639)
,p_name=>'P1_FECHA'
,p_item_sequence=>23
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274585966403988639)
,p_name=>'P1_NOTAVIAJE'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(275452471951439689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274586161898988639)
,p_name=>'P1_CDCLASACT'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274586363634988644)
,p_name=>'P1_CORRACT'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274586562993988645)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274587179244988650)
,p_name=>'P1_CDTIPCOMB'
,p_item_sequence=>12
,p_item_plug_id=>wwv_flow_api.id(275447055450368750)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274587362649988652)
,p_name=>'P1_NMBOMBA'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(275452471951439689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274587552342988652)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274587760770988653)
,p_name=>'P1_NMORDENC'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(275447055450368750)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274588161101988653)
,p_name=>'P1_KMRETORNO'
,p_item_sequence=>4.5
,p_item_plug_id=>wwv_flow_api.id(275452471951439689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274588563032988655)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274588766245988656)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274588963366988656)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274651472643582892)
,p_name=>'P1_CDRECIBE'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_prompt=>'Piloto'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274687760169606703)
,p_name=>'P1_CDEMPRESA'
,p_item_sequence=>36
,p_item_plug_id=>wwv_flow_api.id(274584355393988600)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275224157455536008)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275381872096273384)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275397073118607183)
,p_name=>'P1_KM_GLN'
,p_item_sequence=>66
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_prompt=>'Km/Gln'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275397262335612188)
,p_name=>'P1_DISTANCIA'
,p_item_sequence=>76
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_prompt=>'Distancia'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276357361644506939)
,p_name=>'P1_KMSALE'
,p_item_sequence=>75
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276364548643588831)
,p_name=>'P1_RECORRIDO'
,p_item_sequence=>86
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276477171213055044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276478472279069811)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(278047866887893630)
,p_name=>'P1_ESTADO'
,p_item_sequence=>106
,p_item_plug_id=>wwv_flow_api.id(275114955543262448)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(93394902683613633)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(88059741336492118)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(93395020508613634)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(93395134193613635)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(276365067163599402)
,p_name=>'recorre'
,p_event_sequence=>5
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276365362501599406)
,p_event_id=>wwv_flow_api.id(276365067163599402)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(278052174751961563)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(278052459624961572)
,p_event_id=>wwv_flow_api.id(278052174751961563)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(275115751780289839)
,p_name=>'cargar datos'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275116051024289875)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275120261058428261)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275121361908443123)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
begin
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275134166090866602)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275164952292194869)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275169663001281094)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275240860263324834)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275424050343043192)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(275424968878049833)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276485169401162323)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276485878878173088)
,p_event_id=>wwv_flow_api.id(275115751780289839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(118966040247145636)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(118966175098145637)
,p_event_id=>wwv_flow_api.id(118966040247145636)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274591356907988661)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274591557067988664)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(277569466989230844)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(274584554716988620)
,p_process_success_message=>'ACTUALIZADO'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(295566868916100472)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(93395237484613636)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274591775257988664)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220301080708'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(275480655280456791)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(275562759621989539)
,p_plug_name=>'NUEVO VALE'
,p_parent_plug_id=>wwv_flow_api.id(275480655280456791)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274525678715617709)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(275563977761004202)
,p_plug_name=>'DATOS VALE'
,p_parent_plug_id=>wwv_flow_api.id(275480655280456791)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(275481050459456803)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(275480655280456791)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(274529379021617723)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(275480851949456802)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(275480655280456791)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(275481266561456816)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(93392975820613613)
,p_name=>'P2_ORIGEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(128311816714822526)
,p_name=>'P2_GRABA'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275481464671456903)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(275480655280456791)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275481653171456920)
,p_name=>'P2_NMVALE'
,p_is_required=>true
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275481877683456928)
,p_name=>'P2_FECHA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(275563977761004202)
,p_use_cache_before_default=>'NO'
,p_item_default=>'SYSDATE'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Fecha'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275482060950456928)
,p_name=>'P2_NOTAVIAJE'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275482272125456928)
,p_name=>'P2_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(275563977761004202)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275482469025456930)
,p_name=>'P2_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(275563977761004202)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275482865554456930)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275483078054456930)
,p_name=>'P2_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(275480655280456791)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275483273860456931)
,p_name=>'P2_CDTIPCOMB'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(275480655280456791)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275483457061456931)
,p_name=>'P2_NMBOMBA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(275480655280456791)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275483675471456931)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275483864590456933)
,p_name=>'P2_NMORDENC'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(275480655280456791)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275484058401456933)
,p_name=>'P2_KMSALE'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(275563977761004202)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275484259202456933)
,p_name=>'P2_KMRETORNO'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275484474970456934)
,p_name=>'P2_RECORRIDO'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(275563977761004202)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275484668153456934)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275484878764456934)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275485051780456934)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275485280371456936)
,p_name=>'P2_NOBOMBA'
,p_is_required=>true
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275485475907456938)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275485663826456938)
,p_name=>'P2_NOFACTURA'
,p_is_required=>true
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275507478429823144)
,p_name=>'P2_CDRECIBE'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(275563977761004202)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(275580474276487666)
,p_name=>'P2_TOTAL'
,p_item_sequence=>71
,p_item_plug_id=>wwv_flow_api.id(275562759621989539)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276191055713722644)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276482677837128011)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276482964035134350)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(276191567810752880)
,p_name=>'galon'
,p_event_sequence=>4
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276191858858752894)
,p_event_id=>wwv_flow_api.id(276191567810752880)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(276035178154408389)
,p_name=>'Precio'
,p_event_sequence=>5
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276035459330408392)
,p_event_id=>wwv_flow_api.id(276035178154408389)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(276021264836167991)
,p_name=>'INGRESO_EXTERNO'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276021549546168006)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276028674625302036)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276028966429305911)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276029249392313780)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276029665123321672)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>60
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276486366370178838)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>70
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276486654940184192)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>80
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276487376493189339)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(276487560319196884)
,p_event_id=>wwv_flow_api.id(276021264836167991)
,p_event_result=>'TRUE'
,p_action_sequence=>100
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(90572684193455130)
,p_name=>'recorre'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_KMRETORNO'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(90572721520455131)
,p_event_id=>wwv_flow_api.id(90572684193455130)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(275488147708456950)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(275488374165456970)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(276435052803109189)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'km'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(275480851949456802)
);
end;
/
begin
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(275488563658456970)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(167277670489152481)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274525153363617706)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(167278041696152481)
,p_name=>'Report 1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167278193809152523)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167278448937152598)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167278880207152600)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167279288860152601)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167279718807152603)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167280092284152604)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167280482152152606)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167280917863152607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167281289253152609)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167281565344152615)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167281973424152615)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(167282391438152618)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(167283266727153043)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(276621953345740317)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(276622169749740317)
,p_name=>'ANULAR VALE'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276622257554740328)
,p_db_column_name=>'ROWID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ROWID'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276622378219740330)
,p_db_column_name=>'NMVALE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nmvale'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276622462118740331)
,p_db_column_name=>'FECHA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276622551662740333)
,p_db_column_name=>'NOTAVIAJE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Notaviaje'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276622853476740338)
,p_db_column_name=>'CANTDESPACHA'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cantdespacha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276622963703740339)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623062446740341)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623153523740342)
,p_db_column_name=>'CDTIPCOMB'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Cdtipcomb'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623279080740344)
,p_db_column_name=>'NMBOMBA'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Nmbomba'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623349695740345)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623459465740347)
,p_db_column_name=>'NMORDENC'
,p_display_order=>13
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623554939740350)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623659547740352)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276623751348740353)
,p_db_column_name=>'RECORRIDO'
,p_display_order=>16
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276624178510740363)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276624267430740364)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276695954473411952)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(276696075692411952)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(276624460915740567)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(167269517686152372)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274524756309617706)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(167270004859152375)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(167269517686152372)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(274529379021617723)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(167270193059152375)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(167269517686152372)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(167272056924152398)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(167272513537152400)
,p_name=>'P6_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(167269517686152372)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(167272869162152420)
,p_name=>'P6_NMVALE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(167269517686152372)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(167273156082152442)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(167273543649152445)
,p_name=>'P6_NMBOMBA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(167269517686152372)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(167273951289152447)
,p_name=>'P6_NMORDENC'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(167269517686152372)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(167276001839152448)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(164497184520889124)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(167270004859152375)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(167276397253152454)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(167276736695152454)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(276619651814740283)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274524756309617706)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(276619857115740286)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(276619651814740283)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(274529379021617723)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(276620061358740286)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(276619651814740283)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(276620273235740288)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276620467261740291)
,p_name=>'P7_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276620649504740295)
,p_name=>'P7_NMVALE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(276620867946740302)
,p_name=>'P7_ESTADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(277334068874284478)
,p_name=>'P7_RECORRIDO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(277334553131291713)
,p_name=>'P7_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(277334779644294673)
,p_name=>'P7_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(277335778769310200)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(277336073378312789)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(278637769515723366)
,p_name=>'P7_KMRETORNO'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(276619651814740283)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(276621479912740305)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(276621651594740305)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TVALES'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(277336653593322478)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'KM'
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(276619857115740286)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(295585255564697330)
,p_process_sequence=>36
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(276621858974740305)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_user_interface_id=>wwv_flow_api.id(274530357934617730)
,p_tab_set=>'TS1'
,p_name=>'Listado De Vales'
,p_step_title=>'Listado De Vales'
,p_step_sub_title=>'Listado De Vales'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220316150838'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(101502461400075556)
,p_plug_name=>'FILTROS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(103296456834604363)
,p_plug_name=>'Listado De Vales'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274523971420617695)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--listado de vales',
'/*select a.nmvale,a.auditado,a.recorrido,a.notaviaje,a.cddelegacion as delegacion,',
'a.cantdespacha as galones,a.nmordenc as tancada,a.fecha,a.origen,a.kmsale as km_salida,a.kmretorno as km_retorno,a.cdclasact||''-''||a.corract as unidad,',
'b.pilotodes as piloto,c.nombre_pila||'' ''||c.primer_apellido||'' ''||c.segundo_apellido as nombre,',
'a.rendimiento_real,a.rendimiento_estimado,decode(origen,''INTERNO'',''19.6120'',a.precio_galon) as precio_GALON, cantdespacha*CASE WHEN ORIGEN =''INTERNO'' THEN 19.6120',
'   ELSE PRECIO_GALON END AS SUBTOTAL',
' from tvales a ',
' inner join tnotaviaje b on a.notaviaje=b.nmnota',
' inner join empleado c on b.pilotodes=to_number(c.empleado)',
' WHERE a.fecha>=to_date(:fecha1,''dd/mm/yyyy'') and a.fecha <=to_date(:fecha2,''dd/mm/yyyy'') and a.cddelegacion=:delegacion',
' order by a.nmvale asc*/',
' --listado de vales',
'select a.nmvale,a.auditado,a.recorrido,a.notaviaje,a.cddelegacion as delegacion,',
'a.cantdespacha as galones,a.nmordenc as tancada,a.fecha,a.origen,a.kmsale as km_salida,a.kmretorno as km_retorno,a.cdclasact||''-''||a.corract as unidad,b.pilotodes as piloto,',
'c.nombre_pila||'' ''||c.primer_apellido||'' ''||c.segundo_apellido as nombre,',
'prcconsumo as rendimiento_real,a.recorrido/a.cantdespacha as rendimiento_estimado,decode(origen,''INTERNO'',''19.6120'',a.precio_galon) as precio_GALON, cantdespacha*CASE WHEN ORIGEN =''INTERNO'' THEN 19.6120',
'   ELSE PRECIO_GALON END AS SUBTOTAL',
' from tvales a ',
' inner join tnotaviaje b on a.notaviaje=b.nmnota',
'inner join vista_empleados c on b.pilotodes=to_number(c.empleado)',
' inner join tactivos d on  A.cdclasact||''-''||A.corract=d.CDCLASE||''-''||d.CORRELATIVO',
' WHERE a.fecha>=to_date(:fecha1,''dd/mm/yyyy'') and a.fecha <=to_date(:fecha2,''dd/mm/yyyy'') and a.cddelegacion=:delegacion',
' order by a.nmvale asc'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'FECHA1,FECHA2,DELEGACION'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(103296553806604363)
,p_name=>'Listado De Vales'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'LP'
,p_internal_uid=>103296553806604363
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16152804192721064)
,p_db_column_name=>'NMVALE'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Nmvale'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16153239285721064)
,p_db_column_name=>'AUDITADO'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Auditado'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16153676752721064)
,p_db_column_name=>'RECORRIDO'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Recorrido'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16154033568721064)
,p_db_column_name=>'NOTAVIAJE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Notaviaje'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16154499089721064)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16154880966721064)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16155247622721064)
,p_db_column_name=>'TANCADA'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Tancada'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16155610026721064)
,p_db_column_name=>'FECHA'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16156004090721064)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16156497774721064)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16156823903721065)
,p_db_column_name=>'KM_RETORNO'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Km Retorno'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16157243509721065)
,p_db_column_name=>'UNIDAD'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Unidad'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16157650314721065)
,p_db_column_name=>'RENDIMIENTO_REAL'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'Rendimiento Real'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16158037454721065)
,p_db_column_name=>'RENDIMIENTO_ESTIMADO'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Rendimiento Estimado'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16158480043721065)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16158859703721065)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16152042566721057)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16152458495721062)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(103316852599607113)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'161592'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'NMVALE:AUDITADO:RECORRIDO:NOTAVIAJE:DELEGACION:PILOTO:NOMBRE:GALONES:TANCADA:FECHA:ORIGEN:KM_SALIDA:KM_RETORNO:UNIDAD:RENDIMIENTO_REAL:RENDIMIENTO_ESTIMADO:PRECIO_GALON:SUBTOTAL:'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(16170789373757906)
,p_report_id=>wwv_flow_api.id(103316852599607113)
,p_name=>'AUDITADO'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'AUDITADO'
,p_operator=>'='
,p_expr=>'NO'
,p_condition_sql=>' (case when ("AUDITADO" = #APXWS_EXPR#) then #APXWS_HL_ID# end) '
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16150193997721045)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(101502461400075556)
,p_button_name=>'BUSCAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--large:t-Button--primary:t-Button--stretch:t-Button--gapTop'
,p_button_template_id=>wwv_flow_api.id(274529379021617723)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16160459782721070)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(103296456834604363)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16150530777721048)
,p_name=>'FECHA1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(101502461400075556)
,p_prompt=>'Fecha Inicio'
,p_format_mask=>'dd/mm/yyyy'
,p_display_as=>'NATIVE_DATE_PICKER'
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(274528678090617720)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_04=>'button'
,p_attribute_05=>'N'
,p_attribute_07=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16150992082721053)
,p_name=>'FECHA2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(101502461400075556)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16151320721721053)
,p_name=>'DELEGACION'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(101502461400075556)
,p_prompt=>'Delegacion'
...
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(274512559709617600)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(274531253103617731)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(274524756309617706)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(274531556993617733)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(274531253103617731)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274531379937617733)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(274531253103617731)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(274531452014617733)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274531779022617733)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274531680153617733)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274531970355617733)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(274531859227617733)
,p_process_sequence=>10
