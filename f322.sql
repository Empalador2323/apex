...
,p_default_application_id=>322
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 322 - j_verclientes
--
-- Application Export:
--   Application:     322
--   Name:            j_verclientes
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,322)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'j_verclientes')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_322')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'87CA41FF2626721639928B4B3C3260FA3000C6532F57569922224298DB2323C3'
...
,p_authentication_id=>wwv_flow_api.id(17489110005131104)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:j_verclientes'
...
,p_last_upd_yyyymmddhh24miss=>'20210325145201'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8762087709057869)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8762161066057869)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8762229457057869)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8762446409057869)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8762592795057869)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8762639380057869)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17441423798860828)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17488820357126282)
,p_icon_sequence=>10
,p_icon_subtext=>'HOME'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17459420797860882)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(17460923713860892)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(17460615962860890)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(17461012721860893)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17441531250860831)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17441610003860837)
,p_page_template_id=>wwv_flow_api.id(17441531250860831)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17441708186860842)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17441818451860842)
,p_page_template_id=>wwv_flow_api.id(17441708186860842)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17441930266860842)
,p_page_template_id=>wwv_flow_api.id(17441708186860842)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442028330860842)
,p_page_template_id=>wwv_flow_api.id(17441708186860842)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442125153860842)
,p_page_template_id=>wwv_flow_api.id(17441708186860842)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442205569860842)
,p_page_template_id=>wwv_flow_api.id(17441708186860842)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17442328598860842)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442400887860842)
,p_page_template_id=>wwv_flow_api.id(17442328598860842)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442509972860842)
,p_page_template_id=>wwv_flow_api.id(17442328598860842)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442620254860842)
,p_page_template_id=>wwv_flow_api.id(17442328598860842)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442716739860842)
,p_page_template_id=>wwv_flow_api.id(17442328598860842)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442807572860842)
,p_page_template_id=>wwv_flow_api.id(17442328598860842)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17442908083860842)
,p_page_template_id=>wwv_flow_api.id(17442328598860842)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17443004041860842)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443111817860842)
,p_page_template_id=>wwv_flow_api.id(17443004041860842)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443202392860842)
,p_page_template_id=>wwv_flow_api.id(17443004041860842)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443309727860842)
,p_page_template_id=>wwv_flow_api.id(17443004041860842)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443403440860842)
,p_page_template_id=>wwv_flow_api.id(17443004041860842)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17443506396860842)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443601671860842)
,p_page_template_id=>wwv_flow_api.id(17443506396860842)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443722683860842)
,p_page_template_id=>wwv_flow_api.id(17443506396860842)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443829077860842)
,p_page_template_id=>wwv_flow_api.id(17443506396860842)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17443917428860842)
,p_page_template_id=>wwv_flow_api.id(17443506396860842)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444010169860842)
,p_page_template_id=>wwv_flow_api.id(17443506396860842)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17444117315860842)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444229088860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444329544860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444415880860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444505068860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444620778860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444703697860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444807422860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17444903613860842)
,p_page_template_id=>wwv_flow_api.id(17444117315860842)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17445014984860843)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445107453860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445217085860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445318701860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445406551860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445515377860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445612400860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445725310860843)
,p_page_template_id=>wwv_flow_api.id(17445014984860843)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17445825800860843)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17445925636860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446032498860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446112601860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446200107860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446308472860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446431678860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446509739860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446610304860845)
,p_page_template_id=>wwv_flow_api.id(17445825800860843)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17446705018860845)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446823063860845)
,p_page_template_id=>wwv_flow_api.id(17446705018860845)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17446926015860845)
,p_page_template_id=>wwv_flow_api.id(17446705018860845)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447002875860845)
,p_page_template_id=>wwv_flow_api.id(17446705018860845)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447123165860845)
,p_page_template_id=>wwv_flow_api.id(17446705018860845)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447217528860845)
,p_page_template_id=>wwv_flow_api.id(17446705018860845)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447318940860845)
,p_page_template_id=>wwv_flow_api.id(17446705018860845)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17447401432860845)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447516179860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447623102860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447720353860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447809504860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17447916781860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448026004860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448109919860845)
,p_page_template_id=>wwv_flow_api.id(17447401432860845)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17448225530860846)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448324244860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448421919860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448526519860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448617460860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448712136860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448818667860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17448908597860846)
,p_page_template_id=>wwv_flow_api.id(17448225530860846)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17449015699860846)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449114711860846)
,p_page_template_id=>wwv_flow_api.id(17449015699860846)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17449213334860846)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449317803860846)
,p_page_template_id=>wwv_flow_api.id(17449213334860846)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449407962860846)
,p_page_template_id=>wwv_flow_api.id(17449213334860846)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449504224860846)
,p_page_template_id=>wwv_flow_api.id(17449213334860846)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449628859860846)
,p_page_template_id=>wwv_flow_api.id(17449213334860846)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17449709329860846)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449824152860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17449908681860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450016546860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450132637860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450229301860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450318463860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450404389860846)
,p_page_template_id=>wwv_flow_api.id(17449709329860846)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17450525982860846)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450612669860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450700269860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450802789860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17450922911860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451022126860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451125567860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451214767860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451332409860846)
,p_page_template_id=>wwv_flow_api.id(17450525982860846)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17451407614860846)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451512793860848)
,p_page_template_id=>wwv_flow_api.id(17451407614860846)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451622697860848)
,p_page_template_id=>wwv_flow_api.id(17451407614860846)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451717687860848)
,p_page_template_id=>wwv_flow_api.id(17451407614860846)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451809264860848)
,p_page_template_id=>wwv_flow_api.id(17451407614860846)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17451907986860848)
,p_page_template_id=>wwv_flow_api.id(17451407614860846)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452003777860848)
,p_page_template_id=>wwv_flow_api.id(17451407614860846)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17452121713860848)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452229657860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452311605860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452410071860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452512482860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452627501860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452714042860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17452804905860848)
,p_page_template_id=>wwv_flow_api.id(17452121713860848)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17458328162860871)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17458407642860875)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17458525529860875)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17458615152860875)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17458701170860875)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(17458809616860875)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17452920460860850)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453027599860851)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453101249860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453215743860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453310093860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453430681860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453503184860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453600409860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453725058860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17453812904860853)
,p_plug_template_id=>wwv_flow_api.id(17453725058860853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17453912014860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454019542860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454116380860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454226284860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17454306623860853)
,p_plug_template_id=>wwv_flow_api.id(17454226284860853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454413861860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454524161860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454601710860853)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17454708674860854)
,p_plug_template_id=>wwv_flow_api.id(17454601710860853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(17454808497860854)
,p_plug_template_id=>wwv_flow_api.id(17454601710860853)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17454923750860854)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(17455019490860854)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456220670860859)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456304473860865)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456430728860865)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456521160860865)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456628672860865)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456731465860865)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456828074860865)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17456916095860865)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17457002417860865)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17457121197860865)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17457216103860865)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17457301331860865)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17457423411860867)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(17457523557860867)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455113544860854)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455210184860857)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455308778860857)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455426479860857)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455516310860859)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455626381860859)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455715125860859)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455826877860859)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17455908862860859)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17456029151860859)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(17456102865860859)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17457623504860867)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17457717106860871)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17457800162860871)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17457919815860871)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17458010384860871)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17458107643860871)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(17458221155860871)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(17458908380860875)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(17459113891860879)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(17459008033860876)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(17459232692860881)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(17446705018860845)
,p_error_template=>wwv_flow_api.id(17443004041860842)
,p_printer_friendly_template=>wwv_flow_api.id(17449213334860846)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(17441531250860831)
,p_default_button_template=>wwv_flow_api.id(17458328162860871)
,p_default_region_template=>wwv_flow_api.id(17454601710860853)
,p_default_chart_template=>wwv_flow_api.id(17454601710860853)
,p_default_form_template=>wwv_flow_api.id(17453725058860853)
,p_default_reportr_template=>wwv_flow_api.id(17454601710860853)
,p_default_tabform_template=>wwv_flow_api.id(17454601710860853)
,p_default_wizard_template=>wwv_flow_api.id(17453725058860853)
,p_default_menur_template=>wwv_flow_api.id(17453215743860853)
,p_default_listr_template=>wwv_flow_api.id(17454601710860853)
,p_default_irr_template=>wwv_flow_api.id(17454116380860853)
,p_default_report_template=>wwv_flow_api.id(17455715125860859)
,p_default_label_template=>wwv_flow_api.id(17457800162860871)
,p_default_menu_template=>wwv_flow_api.id(17458908380860875)
,p_default_calendar_template=>wwv_flow_api.id(17459008033860876)
,p_default_list_template=>wwv_flow_api.id(17457301331860865)
,p_default_option_label=>wwv_flow_api.id(17457800162860871)
,p_default_required_label=>wwv_flow_api.id(17458107643860871)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17459512459860882)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17489110005131104)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(17459327898860882)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(17459327898860882)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20180129113622'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17472431706882290)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17454116380860853)
...
'"DSCLIENTE",',
'"DIRECCION"',
'from "#OWNER#"."TCLIENTES" ',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(17472611370882292)
,p_name=>'Report 1'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>17472611370882292
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17472717409882304)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17472816252882309)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17472930053882310)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17473030074882310)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(17473201926882817)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'174733'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:CDCLIENTE:DSCLIENTE:DIRECCION'
,p_sort_column_1=>'CDCLIENTE'
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(17459327898860882)
,p_name=>'Form on TCLIENTES'
,p_step_title=>'Form on TCLIENTES'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180209161836'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17462311566882242)
,p_plug_name=>'Actualizar Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17453725058860853)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17462519870882242)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(17462311566882242)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(17458328162860871)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17462729761882242)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17462905681882243)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17463104797882250)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
...
,p_field_template=>wwv_flow_api.id(17457800162860871)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17463313197882251)
,p_name=>'P2_CDCLIENTE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(17458107643860871)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17463520600882251)
,p_name=>'P2_DSCLIENTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17463713363882251)
,p_name=>'P2_DIRECCION'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17463907725882251)
,p_name=>'P2_TELEFONO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17464117198882253)
,p_name=>'P2_CONTACTO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17464318838882253)
,p_name=>'P2_PAIS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17464516206882253)
,p_name=>'P2_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17464716072882253)
,p_name=>'P2_CDZONA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17464913732882254)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17465121200882254)
,p_name=>'P2_TARIFA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17465323359882254)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17465521388882259)
,p_name=>'P2_CDZONATAR'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17466117812882259)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17466304777882264)
,p_name=>'P2_DISTANCIA'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17466527002882264)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17466704388882264)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17466910546882264)
,p_name=>'P2_NIT'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17467116643882264)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17467312673882265)
,p_name=>'P2_ACCESO'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(17462311566882242)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17467506633882265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17468717801882267)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17471918397882271)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17472127306882273)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17472317844882273)
...
,p_step_template=>wwv_flow_api.id(17441531250860831)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180129104725'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17459813185860885)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17453725058860853)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17460112334860889)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(17459813185860885)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17459915106860887)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17459813185860885)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17460004402860889)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17460302723860889)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17460231663860889)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17460508025860890)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17460409970860890)
,p_process_sequence=>10
