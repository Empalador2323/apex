...
,p_default_application_id=>370
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 370 - OT_SUPERVISION
--
-- Application Export:
--   Application:     370
--   Name:            OT_SUPERVISION
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,370)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'INOT370')
...
,p_authentication_id=>wwv_flow_api.id(55761047678747746)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20220119111918'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(50611637135465832)
,p_name=>'Navigation'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5521774132422720)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5521993818422720)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5522026296422720)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5522104198422720)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5522211304422721)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(5522324748422721)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(50596544129465790)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(50688550701425638)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(53473738688584804)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(50606547433465797)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(50608047883465799)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_TORDENSERV'
,p_tab_text=>'Tordenserv'
,p_tab_step=>1
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(50607735562465799)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(50611741707465832)
,p_parent_id=>0
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(50619636735465838)
,p_parent_id=>wwv_flow_api.id(50611741707465832)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50596633574465790)
,p_theme_id=>24
,p_name=>'Login'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50596752448465790)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50596859253465790)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50596930213465790)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597037923465790)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597158159465790)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597243943465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597348572465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597429385465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597543729465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597629014465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597753408465791)
,p_theme_id=>24
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597855128465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50597951723465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50598037274465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50598145251465791)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(50598243606465791)
,p_theme_id=>24
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(50605157718465796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(50605229899465796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(50605348766465796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(50605454169465796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(50605559198465796)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(50605633903465796)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598352522465791)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598429538465791)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598559558465791)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598638203465791)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598733316465791)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598835514465791)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50598936346465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599056156465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599151568465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599240540465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599353141465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599434585465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599555335465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599632634465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599743704465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'    #BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599846923465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50599942844465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600040907465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600141856465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600239144465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600336024465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600445524465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600540106465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600655544465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600747194465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600849016465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50600943659465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601039613465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601137870465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601258051465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601332079465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601448670465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601548908465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(50601636083465793)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50602836968465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50602951415465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603033069465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603135601465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603255134465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603335481465794)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603436590465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603539834465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603648042465794)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603747453465794)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603828284465794)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50603953034465794)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50604054207465794)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50604132691465794)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50604235098465794)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50604343479465796)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(50604432155465796)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50601748753465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50601833365465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50601942195465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602034760465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602132123465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602253466465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602359078465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602440206465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602534816465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602648271465794)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(50602739142465794)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(50604556030465796)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(50604641233465796)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(50604734178465796)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(50604851150465796)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(50604933367465796)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(50605034397465796)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(50605735491465796)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(50605848936465796)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(50606252389465796)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(50605941159465796)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(50606028624465796)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(50606140501465796)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(50606339863465797)
,p_theme_id=>24
,p_theme_name=>'Cloudy'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(50597429385465791)
,p_error_template=>wwv_flow_api.id(50596930213465790)
,p_printer_friendly_template=>wwv_flow_api.id(50597855128465791)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(50596633574465790)
,p_default_button_template=>wwv_flow_api.id(50605157718465796)
,p_default_region_template=>wwv_flow_api.id(50600655544465793)
,p_default_chart_template=>wwv_flow_api.id(50599056156465793)
,p_default_form_template=>wwv_flow_api.id(50599353141465793)
,p_default_reportr_template=>wwv_flow_api.id(50600655544465793)
,p_default_tabform_template=>wwv_flow_api.id(50600655544465793)
,p_default_wizard_template=>wwv_flow_api.id(50601448670465793)
,p_default_menur_template=>wwv_flow_api.id(50598638203465791)
,p_default_listr_template=>wwv_flow_api.id(50598936346465793)
,p_default_irr_template=>wwv_flow_api.id(50599743704465793)
,p_default_report_template=>wwv_flow_api.id(50602359078465794)
,p_default_label_template=>wwv_flow_api.id(50604734178465796)
,p_default_menu_template=>wwv_flow_api.id(50605735491465796)
,p_default_calendar_template=>wwv_flow_api.id(50605941159465796)
,p_default_list_template=>wwv_flow_api.id(50604235098465794)
,p_default_option_label=>wwv_flow_api.id(50604851150465796)
,p_default_required_label=>wwv_flow_api.id(50605034397465796)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(50612635768465832)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(50606627277465797)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(55761047678747746)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(35223493994351427124)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37816767155952629169)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816783668204642149)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
,p_display_sequence=>10
,p_display_value=>'Contains/Case (uses INSTR)'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816792757253648462)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816794261755649774)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816797667642651496)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816811674222653376)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816814246648654853)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37816826253921656938)
,p_plugin_attribute_id=>wwv_flow_api.id(37816767155952629169)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37818511551347195463)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818523860005197994)
,p_plugin_attribute_id=>wwv_flow_api.id(37818511551347195463)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818535164160199157)
,p_plugin_attribute_id=>wwv_flow_api.id(37818511551347195463)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37818547368447209837)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'bar'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(37818511551347195463)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818691756120291469)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>10
,p_display_value=>'Bar'
,p_return_value=>'bar'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818693060969292844)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818695164778293882)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818696568587295035)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818697672743296218)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818699944823297673)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818701151749299622)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37818702055905300862)
,p_plugin_attribute_id=>wwv_flow_api.id(37818547368447209837)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37819625556933925544)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31673107641225822711)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31673109145726824049)
,p_plugin_attribute_id=>wwv_flow_api.id(31673107641225822711)
,p_display_sequence=>10
,p_display_value=>'Slow'
,p_return_value=>'600'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31673109748843824891)
,p_plugin_attribute_id=>wwv_flow_api.id(31673107641225822711)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31673110351960825759)
,p_plugin_attribute_id=>wwv_flow_api.id(31673107641225822711)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31673111056462827130)
,p_plugin_attribute_id=>wwv_flow_api.id(31673107641225822711)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24304551553490273320)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14653990629723978996)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31106328453940358464)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(24215472940920844122)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215456547537798701)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215458749400808669)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215464342736825633)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215465657627829953)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215466530400831530)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215468042174834977)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215472940920844122)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13588508489337760962)
,p_plugin_attribute_id=>wwv_flow_api.id(24215472940920844122)
,p_display_sequence=>10
,p_display_value=>'Not Enterable'
,p_return_value=>'NOT_ENTERABLE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13588546600419764133)
,p_plugin_attribute_id=>wwv_flow_api.id(24215472940920844122)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13588577408730766547)
,p_plugin_attribute_id=>wwv_flow_api.id(24215472940920844122)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215512255727867256)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24215473951655847174)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(5526563616423218)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(29059452360400429972)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819716361196946979)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819720056236949255)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819722152354950973)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819724148904952580)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819726444375954672)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819731971536957364)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819735464634960547)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37819738757302963921)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
,p_file_name=>'bar.gif'
,p_mime_type=>'image/gif'
,p_file_content=>wwv_flow_api.varchar2_to_blob(wwv_flow_api.g_varchar2_table)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(59080832278243371694)
,p_plugin_id=>wwv_flow_api.id(35223493994351427124)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(50606433607465797)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(50606433607465797)
,p_tab_set=>'TS1'
,p_name=>'HOME'
,p_alias=>'HOME'
,p_step_title=>'HOME'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50608152303465801)
,p_plug_name=>'TORDENSERV'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(50599743704465793)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(50608242922465801)
,p_name=>'TORDENSERV'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50608530588465804)
,p_db_column_name=>'NMORDEN'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Nmorden'
,p_column_link=>'/ords/f?p=380:1:&APP_SESSION.::::P1_CDPILOTO,P1_CDRESPONSABLE,P1_UNIDAD,P1_nmnota,p1_comentario:#CDPILOTO#,#CDASIGNADO#,#UNIDAD#,#NMORDEN#,#DSREPARA#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50608627247465805)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50608734194465807)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50608835992465807)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50608950295465808)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609044603465810)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609148386465810)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609243594465810)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609338476465812)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609427019465812)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609545318465813)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609656478465813)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609753640465815)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609850205465815)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50609930279465816)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610050351465816)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610129173465818)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610257055465818)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610353120465818)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610427415465819)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610548024465819)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610649175465821)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610731387465821)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610848822465822)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50610941705465824)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50611045011465824)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50611147887465826)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50611249601465827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50611351282465827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50611437011465829)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50621549241692276)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50626255999129827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50626343735129827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50653841314244919)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50653941281244924)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(50654030281244924)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(56626554705421763)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(67964845685747212)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(67964944466747212)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(68356136167439015)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(71656946850200194)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(71657036656200197)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45791020934456131)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(45791102427456137)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47964830079688656)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(51957117260281654)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(59494510554175845)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(50620035170466080)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(59494832746179823)
,p_report_id=>wwv_flow_api.id(50620035170466080)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(59494914837179823)
,p_report_id=>wwv_flow_api.id(50620035170466080)
,p_name=>'Trans'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(59494608364179823)
,p_report_id=>wwv_flow_api.id(50620035170466080)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(59494701928179823)
,p_report_id=>wwv_flow_api.id(50620035170466080)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_computation(
 p_id=>wwv_flow_api.id(59495014967179823)
,p_report_id=>wwv_flow_api.id(50620035170466080)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(53451946176043743)
,p_plug_name=>'NUEVA ORDEN DE TRABAJO'
,p_region_name=>'NEW'
,p_parent_plug_id=>wwv_flow_api.id(50608152303465801)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(50599942844465793)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50611832822465832)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(50598638203465791)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(50607735562465799)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(50605735491465796)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(50619543993465838)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(50608152303465801)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(50605157718465796)
,p_button_image_alt=>'Create'
,p_button_position=>'LEFT_OF_TITLE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53452252802043744)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(53451946176043743)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(50605157718465796)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53452430319043744)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(53451946176043743)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53452133254043744)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(53463842282061582)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(53452749270043744)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(50765138683706588)
,p_branch_name=>'nmorden'
,p_branch_action=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(50619543993465838)
,p_branch_sequence=>10
,p_branch_condition_type=>'SQL_EXPRESSION'
,p_branch_condition=>'select max(nmorden) into :P2_NMORDEN from tordenserv'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45753108518228307)
,p_name=>'P1_COD_CHEKLIST'
,p_item_sequence=>370
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
...
,p_field_template=>wwv_flow_api.id(50604734178465796)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45812431870058835)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>380
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53452931754043746)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53453157317043746)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(50604851150465796)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53453334476043746)
,p_name=>'P1_NMORDEN'
,p_is_required=>true
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(50605034397465796)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53453543063043747)
,p_name=>'P1_FECREA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53453733470043747)
,p_name=>'P1_CDCLASE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53453947177043749)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53454128987043749)
,p_name=>'P1_KMACTUAL'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53454330235043749)
,p_name=>'P1_KMSIGSERV'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53454535291043749)
,p_name=>'P1_DSREPARA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53454727474043752)
,p_name=>'P1_ESTADO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53454955211043752)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53455133005043752)
,p_name=>'P1_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53455331469043752)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53455530279043752)
,p_name=>'P1_NMSOLIC'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53455735890043752)
,p_name=>'P1_SERIE'
,p_is_required=>true
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53455944878043754)
,p_name=>'P1_TIPO_SERV'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53456156502043754)
,p_name=>'P1_NUM_CHECK'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53456346594043754)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53456536860043754)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53456735633043754)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53456951882043754)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53457141585043755)
,p_name=>'P1_HORA_FIN'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53457329351043755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53457542334043755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53457748243043755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53457955829043755)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53458133222043755)
,p_name=>'P1_UBICACION'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53458351441043755)
,p_name=>'P1_COD_FALLA'
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53458540300043757)
,p_name=>'P1_TIPO_OT'
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53458732133043757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53458951296043757)
,p_name=>'P1_CREADO'
,p_is_required=>true
,p_item_sequence=>310
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53459132474043757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53459346120043757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53459556042043757)
,p_name=>'P1_PILOTO'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
...
'select empleados, empleado from vista_empleados',
''))
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53469943377385183)
,p_name=>'P1_GUIONES'
,p_item_sequence=>350
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(56626844341441691)
,p_name=>'P1_TALLER'
,p_item_sequence=>360
,p_item_plug_id=>wwv_flow_api.id(53451946176043743)
,p_prompt=>'Taller'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(57272443641835762)
,p_validation_name=>'P1_TALLER'
,p_validation_sequence=>10
,p_validation=>'P1_TALLER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Ingrese Taller'
,p_when_button_pressed=>wwv_flow_api.id(53452133254043744)
,p_associated_item=>wwv_flow_api.id(56626844341441691)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53464156958075305)
,p_name=>'crear_nota'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(53463842282061582)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53464449858075307)
,p_event_id=>wwv_flow_api.id(53464156958075305)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53467254721188179)
,p_name=>'Cerrar_Modal'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(53452430319043744)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53467555953188179)
,p_event_id=>wwv_flow_api.id(53467254721188179)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53470026913397779)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53470332206397780)
,p_event_id=>wwv_flow_api.id(53470026913397779)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53468640447278649)
,p_name=>'asignar'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53468949576278649)
,p_event_id=>wwv_flow_api.id(53468640447278649)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53471046563444474)
,p_event_id=>wwv_flow_api.id(53468640447278649)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53487429286819560)
,p_name=>'Serie'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53487729743819599)
,p_event_id=>wwv_flow_api.id(53487429286819560)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53488126825866149)
,p_name=>'Delegacion'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53488440472866149)
,p_event_id=>wwv_flow_api.id(53488126825866149)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(45780626426800246)
,p_event_id=>wwv_flow_api.id(53488126825866149)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(45790521822425373)
,p_event_id=>wwv_flow_api.id(53488126825866149)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(53488747912919569)
,p_name=>'Numero_Orden'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(53463842282061582)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(53489033922919569)
,p_event_id=>wwv_flow_api.id(53488747912919569)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
'select max(nmorden)+1 into :P1_NMORDEN from tordenserv    where fecrea>''01/01/2017'';',
'end;'))
,p_attribute_02=>'P1_CDDELEGACION'
,p_attribute_03=>'P1_NMORDEN'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(53463250705043768)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(53463433340043768)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(53463636125043768)
...
,p_step_template=>wwv_flow_api.id(50596859253465790)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220118085206'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50612146707465832)
,p_plug_name=>'Orden de Trabajo'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(50599353141465793)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50619742974465838)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(50598638203465791)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(57103751289347224)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(50612146707465832)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(50612252514465832)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(50612146707465832)
,p_button_name=>'CANCEL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(50612453359465832)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(50612146707465832)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(50612528818465832)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(50612146707465832)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(50612754967465833)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45787706356356526)
,p_name=>'P2_PILOTO'
,p_item_sequence=>172
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Piloto'
,p_source=>'CDPILOTO'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select  empleado||''-'' ||nombre_pila||'' ''||primer_apellido||'' ''||segundo_apellido empleados, empleado from empleado@softland where estado_empleado=''ACT'' '
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45787925106363048)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50612857466465833)
,p_name=>'P2_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50612935149465833)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50613127266465833)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50613333482465833)
,p_name=>'P2_FECREA'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50613538518465833)
,p_name=>'P2_CDCLASE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50613742054465833)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50613947079465835)
,p_name=>'P2_KMACTUAL'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50614135924465835)
,p_name=>'P2_KMSIGSERV'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50614349558465835)
,p_name=>'P2_DSREPARA'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50614546680465835)
,p_name=>'P2_ESTADO'
,p_item_sequence=>9
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50614747433465835)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50614936675465835)
,p_name=>'P2_CDEMPRESA'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_item_default=>'01'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50615135500465835)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50615330097465835)
,p_name=>'P2_NMSOLIC'
,p_item_sequence=>13
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50615543880465835)
,p_name=>'P2_SERIE'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_prompt=>'Serie'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50615749280465835)
,p_name=>'P2_TIPO_SERV'
,p_item_sequence=>15
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50615952353465835)
,p_name=>'P2_NUM_CHECK'
,p_item_sequence=>16
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50616143666465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50616338133465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50616547941465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50616741363465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50616935857465837)
,p_name=>'P2_HORA_FIN'
,p_item_sequence=>21
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50617150713465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50617333955465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50617552113465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50617727225465837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50617942989465837)
,p_name=>'P2_UBICACION'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50618157086465837)
,p_name=>'P2_COD_FALLA'
,p_item_sequence=>27
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50618327362465837)
,p_name=>'P2_TIPO_OT'
,p_item_sequence=>28
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50618543719465838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50618756322465838)
,p_name=>'P2_CREADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50618928046465838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50619134333465838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50782530610090176)
,p_name=>'P2_CLASE'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_prompt=>'Clase'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50787540948632352)
,p_name=>'P2_LIST'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(53376455319915616)
,p_name=>'P2_FLAG'
,p_item_sequence=>0
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_prompt=>'Flag'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(56920240583678551)
,p_name=>'P2_UNIDAD'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
...
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(50604933367465796)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'NOT_ENTERABLE'
,p_attribute_02=>'FIRST_ROWSET'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(56920859117685068)
,p_name=>'P2_GUIONES'
,p_item_sequence=>52
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_prompt=>'Guiones'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57102446301342635)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57102641750342640)
,p_name=>'P2_REP_NAME'
,p_item_sequence=>72
,p_item_plug_id=>wwv_flow_api.id(50619742974465838)
,p_item_default=>'OT'
,p_prompt=>'Report Url'
,p_source=>'OT'
,p_source_type=>'STATIC'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57102850120342640)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57103039137342641)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57103229472342641)
,p_name=>'P2_OUT_FILE'
,p_item_sequence=>102
,p_item_plug_id=>wwv_flow_api.id(50619742974465838)
,p_prompt=>'Report Url'
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57103456008342641)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57103644357342641)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57104847786372352)
,p_name=>'P2_URL'
,p_item_sequence=>132
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57105053019372352)
,p_name=>'P2_URLR'
,p_item_sequence=>142
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_prompt=>'Urlr'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(57270628896675501)
,p_name=>'P2_TALLER'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(50612146707465832)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75440549017895591)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(57270931663719797)
,p_validation_name=>'P2_TALLER'
,p_validation_sequence=>10
,p_validation=>'P2_TALLER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Ingrese Taller'
,p_when_button_pressed=>wwv_flow_api.id(50612453359465832)
,p_associated_item=>wwv_flow_api.id(57270628896675501)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(56921049639692491)
,p_name=>'conteo_guiones'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(56921331165692502)
,p_event_id=>wwv_flow_api.id(56921049639692491)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(56921433278706688)
,p_name=>'asignar'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(56921735559706688)
,p_event_id=>wwv_flow_api.id(56921433278706688)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(56923131488728346)
,p_event_id=>wwv_flow_api.id(56921433278706688)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(57105550175441537)
,p_name=>'URL_REPORTE'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57105856435441546)
,p_event_id=>wwv_flow_api.id(57105550175441537)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57172132204240824)
,p_event_id=>wwv_flow_api.id(57105550175441537)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(57106127581454012)
,p_name=>'IMPRIMIR'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(57103751289347224)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57173628556485591)
,p_event_id=>wwv_flow_api.id(57106127581454012)
,p_event_result=>'TRUE'
,p_action_sequence=>5
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57106442273454015)
,p_event_id=>wwv_flow_api.id(57106127581454012)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(57106730903456124)
,p_event_id=>wwv_flow_api.id(57106127581454012)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(76936951796699126)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(76937229874699147)
,p_event_id=>wwv_flow_api.id(76936951796699126)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(50619337709465838)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(50619454245465838)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TORDENSERV'
...
,p_step_template=>wwv_flow_api.id(50596633574465790)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20170825144749'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(50606953326465797)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(50599353141465793)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(50607233857465797)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(50606953326465797)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50607051243465797)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(50606953326465797)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(50607136857465797)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(50607428613465799)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(50607329455465797)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(50607644217465799)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(50607557086465799)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(46832403032716223)
);
end;
/
