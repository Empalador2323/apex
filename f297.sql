...
prompt APPLICATION 297 - Llantas nuevas ingreso
--
-- Application Export:
--   Application:     297
--   Name:            Llantas nuevas ingreso
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,297)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Llantas nuevas ingreso')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_297')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'5C36CF3B44FD90BAC97433072A318E2DF1F45BE6562DFF71D14664BFA5EC42A1'
...
,p_authentication_id=>wwv_flow_api.id(12630223543351900)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Llantas nuevas ingreso'
...
,p_last_upd_yyyymmddhh24miss=>'20210322135549'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8725508462048791)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8725670572048791)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8725729417048791)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8725919463048791)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8726071549048791)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8726130372048791)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12272907478080998)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12629830660348643)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12290917811081184)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(12292106971081217)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(12292517890081225)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12273028269081012)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273119325081021)
,p_page_template_id=>wwv_flow_api.id(12273028269081012)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12273227353081029)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273317898081031)
,p_page_template_id=>wwv_flow_api.id(12273227353081029)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273405681081031)
,p_page_template_id=>wwv_flow_api.id(12273227353081029)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273506071081031)
,p_page_template_id=>wwv_flow_api.id(12273227353081029)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273622395081031)
,p_page_template_id=>wwv_flow_api.id(12273227353081029)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273720051081031)
,p_page_template_id=>wwv_flow_api.id(12273227353081029)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12273826090081031)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12273915620081031)
,p_page_template_id=>wwv_flow_api.id(12273826090081031)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274006179081031)
,p_page_template_id=>wwv_flow_api.id(12273826090081031)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274119751081031)
,p_page_template_id=>wwv_flow_api.id(12273826090081031)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274206047081031)
,p_page_template_id=>wwv_flow_api.id(12273826090081031)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274302294081031)
,p_page_template_id=>wwv_flow_api.id(12273826090081031)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274417911081031)
,p_page_template_id=>wwv_flow_api.id(12273826090081031)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12274502009081031)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274615365081031)
,p_page_template_id=>wwv_flow_api.id(12274502009081031)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274721166081032)
,p_page_template_id=>wwv_flow_api.id(12274502009081031)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274821271081032)
,p_page_template_id=>wwv_flow_api.id(12274502009081031)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12274902962081032)
,p_page_template_id=>wwv_flow_api.id(12274502009081031)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12275011948081032)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275128673081032)
,p_page_template_id=>wwv_flow_api.id(12275011948081032)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275220844081032)
,p_page_template_id=>wwv_flow_api.id(12275011948081032)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275332118081032)
,p_page_template_id=>wwv_flow_api.id(12275011948081032)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275431335081032)
,p_page_template_id=>wwv_flow_api.id(12275011948081032)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275526573081032)
,p_page_template_id=>wwv_flow_api.id(12275011948081032)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12275626547081032)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275732276081032)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275814849081032)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12275923957081034)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276008394081034)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276115406081034)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276216669081034)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276329284081034)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276400313081034)
,p_page_template_id=>wwv_flow_api.id(12275626547081032)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12276504780081040)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276606510081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276705856081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276803844081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12276919931081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277008217081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277102732081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277214256081040)
,p_page_template_id=>wwv_flow_api.id(12276504780081040)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12277329674081040)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277420327081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277501284081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277616531081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277711431081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277800175081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12277917044081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278011617081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278109334081040)
,p_page_template_id=>wwv_flow_api.id(12277329674081040)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12278212931081040)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278329848081042)
,p_page_template_id=>wwv_flow_api.id(12278212931081040)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278418676081042)
,p_page_template_id=>wwv_flow_api.id(12278212931081040)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278501682081042)
,p_page_template_id=>wwv_flow_api.id(12278212931081040)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278607962081042)
,p_page_template_id=>wwv_flow_api.id(12278212931081040)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278719770081042)
,p_page_template_id=>wwv_flow_api.id(12278212931081040)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12278815451081042)
,p_page_template_id=>wwv_flow_api.id(12278212931081040)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12278927272081042)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279012030081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279109512081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279224615081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279320720081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279405110081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279530325081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279613297081042)
,p_page_template_id=>wwv_flow_api.id(12278927272081042)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12279702927081042)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279806198081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12279910419081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280010288081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280111242081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280228102081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280327214081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280409786081042)
,p_page_template_id=>wwv_flow_api.id(12279702927081042)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12280522284081051)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280602608081051)
,p_page_template_id=>wwv_flow_api.id(12280522284081051)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12280704906081051)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280800663081051)
,p_page_template_id=>wwv_flow_api.id(12280704906081051)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12280905627081051)
,p_page_template_id=>wwv_flow_api.id(12280704906081051)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281023149081051)
,p_page_template_id=>wwv_flow_api.id(12280704906081051)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281119584081051)
,p_page_template_id=>wwv_flow_api.id(12280704906081051)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12281217806081051)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281300854081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281423314081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281531222081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281630186081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281728530081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281824759081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12281908189081054)
,p_page_template_id=>wwv_flow_api.id(12281217806081051)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12282021005081054)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282122486081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282207336081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282317264081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282409016081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282519956081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282610703081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282732362081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12282805913081054)
,p_page_template_id=>wwv_flow_api.id(12282021005081054)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12282910538081054)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283011745081054)
,p_page_template_id=>wwv_flow_api.id(12282910538081054)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283118024081054)
,p_page_template_id=>wwv_flow_api.id(12282910538081054)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283219350081054)
,p_page_template_id=>wwv_flow_api.id(12282910538081054)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283308185081054)
,p_page_template_id=>wwv_flow_api.id(12282910538081054)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283423240081054)
,p_page_template_id=>wwv_flow_api.id(12282910538081054)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283508096081054)
,p_page_template_id=>wwv_flow_api.id(12282910538081054)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12283630937081054)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283709348081054)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283823633081054)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12283914753081056)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12284026012081056)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12284108268081056)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12284232279081056)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12284312588081056)
,p_page_template_id=>wwv_flow_api.id(12283630937081054)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(8726471566048801)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12289813872081134)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12289907738081142)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12290029368081143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12290106746081143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12290219456081143)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12290311359081143)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12284404534081075)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12284527435081090)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12284605551081090)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12284729521081090)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12284817127081090)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12284906542081090)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285032021081092)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285132206081092)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285224544081092)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12285332247081092)
,p_plug_template_id=>wwv_flow_api.id(12285224544081092)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285410583081093)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285530884081093)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285617814081093)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285731154081096)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12285810624081096)
,p_plug_template_id=>wwv_flow_api.id(12285731154081096)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12285925851081096)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12286000713081096)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12286130934081098)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12286206599081098)
,p_plug_template_id=>wwv_flow_api.id(12286130934081098)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12286323864081098)
,p_plug_template_id=>wwv_flow_api.id(12286130934081098)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12286409679081098)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12286513696081098)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12287713036081117)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12287829620081123)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12287918403081123)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288007810081123)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288114942081123)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288205646081123)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288314435081123)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288424813081123)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288510466081123)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288608035081123)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288730972081123)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288809945081123)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12288928321081123)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12289007649081123)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12286622265081106)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12286708796081114)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12286802214081114)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12286907756081114)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287032292081114)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287129344081114)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287218234081115)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287331764081115)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287401157081115)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287525935081115)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12287619443081115)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289114559081125)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289204888081132)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289307020081132)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289416193081132)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289520058081132)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289626483081132)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12289719447081132)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(12290402311081145)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(12290627280081154)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(12290511721081150)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(12290704513081164)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(12278212931081040)
,p_error_template=>wwv_flow_api.id(12274502009081031)
,p_printer_friendly_template=>wwv_flow_api.id(12280704906081051)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(12273028269081012)
,p_default_button_template=>wwv_flow_api.id(12289813872081134)
,p_default_region_template=>wwv_flow_api.id(12286130934081098)
,p_default_chart_template=>wwv_flow_api.id(12286130934081098)
,p_default_form_template=>wwv_flow_api.id(12285224544081092)
,p_default_reportr_template=>wwv_flow_api.id(12286130934081098)
,p_default_tabform_template=>wwv_flow_api.id(12286130934081098)
,p_default_wizard_template=>wwv_flow_api.id(12285224544081092)
,p_default_menur_template=>wwv_flow_api.id(12284729521081090)
,p_default_listr_template=>wwv_flow_api.id(12286130934081098)
,p_default_irr_template=>wwv_flow_api.id(12285617814081093)
,p_default_report_template=>wwv_flow_api.id(12287218234081115)
,p_default_label_template=>wwv_flow_api.id(12289307020081132)
,p_default_menu_template=>wwv_flow_api.id(12290402311081145)
,p_default_calendar_template=>wwv_flow_api.id(12290511721081150)
,p_default_list_template=>wwv_flow_api.id(12288809945081123)
,p_default_option_label=>wwv_flow_api.id(12289307020081132)
,p_default_required_label=>wwv_flow_api.id(12289626483081132)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12291010872081189)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12630223543351900)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(12290829274081165)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(12290829274081165)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20201201113129'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12294304172155506)
,p_plug_name=>'Llantas'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12286130934081098)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12319002699624685)
,p_plug_name=>'numero'
,p_parent_plug_id=>wwv_flow_api.id(12294304172155506)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12285731154081096)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12308528140468117)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(12294304172155506)
,p_button_name=>'NUEVALLANTA'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(8726471566048801)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(12632725866411648)
,p_branch_name=>'CREADAS'
,p_branch_action=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.::P2_CANTIDAD,P2_MAXIMO:&P1_CANTIDAD.,&P1_MAXIMOACTUAL.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(12308528140468117)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12294730349159645)
,p_name=>'P1_CDMEDIDA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Medida'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select dsmedida, cdmedida from tmedidas'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(12289307020081132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12305604165341731)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12305818817350193)
,p_name=>'P1_MARCA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Marca'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'Select dsmarca,cdmarca from tmarcasn'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12306024196362868)
,p_name=>'P1_DISENO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>unistr('Dise\00F1o')
,p_display_as=>'NATIVE_POPUP_LOV'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12306802390403323)
,p_name=>'P1_PROFUNDIDAD'
,p_is_required=>true
,p_item_sequence=>98
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12307913986458775)
,p_name=>'P1_DELEGACION'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Delegacion'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select dsdelegacion, cddelegacion from tdelegaciones where cddelegacion=1 or cddelegacion=2'
,p_lov_display_null=>'YES'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12308107732461653)
,p_name=>'P1_COSTO'
,p_item_sequence=>98
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Costo'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12598412199537018)
,p_name=>'P1_CANTIDAD'
,p_item_sequence=>99
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Cantidad'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12639327091760537)
,p_name=>'P1_MAXIMOACTUAL'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Maximo actual'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
,p_field_template=>wwv_flow_api.id(12289307020081132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13359314520722053)
,p_name=>'P1_NOFAC'
,p_item_sequence=>101
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'No. Factura'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13360220065795443)
,p_name=>'P1_SERIEFAC'
,p_item_sequence=>102
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13367731091081889)
,p_name=>'P1_BODEGA'
,p_item_sequence=>105
,p_item_plug_id=>wwv_flow_api.id(12294304172155506)
,p_prompt=>'Bodega'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select dsbodega,cdbodega from tbodegas'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(12641709871837762)
,p_name=>'maximo'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_CANTIDAD'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(12642026289837768)
,p_event_id=>wwv_flow_api.id(12641709871837762)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_MAXIMOACTUAL'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'SELECT MAX(CORRELATIVO), MAX(CORRELATIVO) A FROM TNEUMATICOS WHERE FECHAALTA>=''01/01/2017'''
,p_attribute_07=>'P1_MAXIMOACTUAL'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12309707539500042)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'insertallanta'
...
'',
'',
'WHILE (i <= :P1_CANTIDAD) LOOP',
' select max(correlativo)+1 into correla from tneumaticos where fechaalta >= ''01/01/2017'';',
'insert into tneumaticos (cdmedida,correlativo,dsneumatico,cdmarca,cddiseno,estado,nueva,reencauche1,reencauche2,reencauche3,precio,fechaalta,',
'recorrido,profu_inicial,profundidad,cdempresa,cddelegacion,u_modifica,factcompra,seriefac,cdbodega)',
' VALUES',
'(:P1_CDMEDIDA,correla,:P1_DESCRIPCION,:P1_MARCA,:P1_DISENO,''D'',1,0,0,0,:P1_COSTO,sysdate(),0,:P1_PROFUNDIDAD,:P1_PROFUNDIDAD,''01'',:P1_DELEGACION,empleado,:P1_NOFAC,:P1_SERIEFAC,:P1_BODEGA);',
'i:=i+1;',
'END LOOP;',
'',
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(12308528140468117)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12647605051063425)
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(12290829274081165)
,p_name=>'LLANTAS CREADAS'
,p_alias=>'LLANTAS_CREADAS'
,p_step_title=>'LLANTAS CREADAS'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_last_upd_yyyymmddhh24miss=>'20171205095230'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(12634214336536242)
,p_name=>'Codigos llantas nuevos'
,p_template=>wwv_flow_api.id(12286130934081098)
...
'SELECT CORRELATIVO FROM TNEUMATICOS WHERE CORRELATIVO >:P2_MAXIMO',
'   AND CORRELATIVO <= :P2_MAXIMO+:P2_CANTIDAD'))
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(12287218234081115)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12634531056536270)
,p_query_column_id=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12632025016396865)
,p_name=>'P2_MAXIMO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12634214336536242)
,p_prompt=>'Maximo'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12632221349398534)
,p_name=>'P2_CANTIDAD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(12634214336536242)
,p_prompt=>'Cantidad'
...
,p_step_template=>wwv_flow_api.id(12273028269081012)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171130081423'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12291323385081198)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12285224544081092)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12291605195081215)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(12291323385081198)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(12289813872081134)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12291412665081206)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12291323385081198)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12291521878081212)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12291827941081217)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12291714481081215)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12292010904081217)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12291927825081217)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
