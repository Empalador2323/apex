...
,p_default_application_id=>409
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 409 - Reporte Checklist LLantas
--
-- Application Export:
--   Application:     409
--   Name:            Reporte Checklist LLantas
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,409)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Reporte Checklist LLantas')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_409409')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'8BDF17DBA92AD93BEB06A7CC8AFF537D55188AE1ABCBFFDAFE2CE3F5B80B4E09'
...
,p_authentication_id=>wwv_flow_api.id(121926531641791023)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Reporte Checklist LLantas'
...
,p_last_upd_yyyymmddhh24miss=>'20210211155657'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4996191874055210)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4996399747055210)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4996408956055210)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4996527793055212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4996641781055212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4996782235055212)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(121908400567790843)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(121926407848791018)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(121928522523791059)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_CHECKLIST'
,p_tab_text=>'Checklist'
,p_tab_step=>1
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(121928217100791051)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(121929309440791089)
,p_parent_id=>0
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121908505178790865)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121908630168790879)
,p_page_template_id=>wwv_flow_api.id(121908505178790865)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121908700759790885)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121908801087790887)
,p_page_template_id=>wwv_flow_api.id(121908700759790885)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121908907647790887)
,p_page_template_id=>wwv_flow_api.id(121908700759790885)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909030806790887)
,p_page_template_id=>wwv_flow_api.id(121908700759790885)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909110836790887)
,p_page_template_id=>wwv_flow_api.id(121908700759790885)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909223301790887)
,p_page_template_id=>wwv_flow_api.id(121908700759790885)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121909313205790887)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909405815790887)
,p_page_template_id=>wwv_flow_api.id(121909313205790887)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909504044790889)
,p_page_template_id=>wwv_flow_api.id(121909313205790887)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909630321790889)
,p_page_template_id=>wwv_flow_api.id(121909313205790887)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909716616790889)
,p_page_template_id=>wwv_flow_api.id(121909313205790887)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909818134790889)
,p_page_template_id=>wwv_flow_api.id(121909313205790887)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121909904504790889)
,p_page_template_id=>wwv_flow_api.id(121909313205790887)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121910005289790889)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910121696790889)
,p_page_template_id=>wwv_flow_api.id(121910005289790889)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910220413790890)
,p_page_template_id=>wwv_flow_api.id(121910005289790889)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910316954790890)
,p_page_template_id=>wwv_flow_api.id(121910005289790889)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910419013790890)
,p_page_template_id=>wwv_flow_api.id(121910005289790889)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121910507626790890)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910629699790892)
,p_page_template_id=>wwv_flow_api.id(121910507626790890)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910713702790892)
,p_page_template_id=>wwv_flow_api.id(121910507626790890)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910807632790892)
,p_page_template_id=>wwv_flow_api.id(121910507626790890)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121910925382790892)
,p_page_template_id=>wwv_flow_api.id(121910507626790890)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911021861790892)
,p_page_template_id=>wwv_flow_api.id(121910507626790890)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121911110226790892)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911221119790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911317745790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911419876790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911527680790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911615925790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911721334790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911814494790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121911919114790893)
,p_page_template_id=>wwv_flow_api.id(121911110226790892)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121912018103790893)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912116433790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912227568790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912316429790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912425131790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912517539790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912622091790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912717816790893)
,p_page_template_id=>wwv_flow_api.id(121912018103790893)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121912814039790896)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121912930845790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913002004790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913103766790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913213848790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913312806790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913405826790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913527386790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913620130790896)
,p_page_template_id=>wwv_flow_api.id(121912814039790896)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121913713103790898)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913809459790898)
,p_page_template_id=>wwv_flow_api.id(121913713103790898)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121913913451790898)
,p_page_template_id=>wwv_flow_api.id(121913713103790898)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914004599790898)
,p_page_template_id=>wwv_flow_api.id(121913713103790898)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914113529790898)
,p_page_template_id=>wwv_flow_api.id(121913713103790898)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914232078790898)
,p_page_template_id=>wwv_flow_api.id(121913713103790898)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914331120790898)
,p_page_template_id=>wwv_flow_api.id(121913713103790898)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121914426921790900)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914506565790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914601695790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914719389790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914813523790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121914921789790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915001967790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915125118790900)
,p_page_template_id=>wwv_flow_api.id(121914426921790900)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121915229782790900)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915321280790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915430883790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915531011790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915620561790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915727539790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915823959790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121915907405790900)
,p_page_template_id=>wwv_flow_api.id(121915229782790900)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121916009315790900)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916111846790900)
,p_page_template_id=>wwv_flow_api.id(121916009315790900)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121916226235790900)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916318904790900)
,p_page_template_id=>wwv_flow_api.id(121916226235790900)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916425636790900)
,p_page_template_id=>wwv_flow_api.id(121916226235790900)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916504900790900)
,p_page_template_id=>wwv_flow_api.id(121916226235790900)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916620525790901)
,p_page_template_id=>wwv_flow_api.id(121916226235790900)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121916703913790901)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916830561790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121916923199790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917017111790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917108377790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917227032790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917310842790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917410636790901)
,p_page_template_id=>wwv_flow_api.id(121916703913790901)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121917500258790901)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917602229790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917712825790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917816158790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121917913290790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918020235790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918125830790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918219522790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918308685790901)
,p_page_template_id=>wwv_flow_api.id(121917500258790901)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121918413460790903)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918504742790903)
,p_page_template_id=>wwv_flow_api.id(121918413460790903)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918621223790903)
,p_page_template_id=>wwv_flow_api.id(121918413460790903)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918706735790903)
,p_page_template_id=>wwv_flow_api.id(121918413460790903)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918817261790903)
,p_page_template_id=>wwv_flow_api.id(121918413460790903)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121918927931790903)
,p_page_template_id=>wwv_flow_api.id(121918413460790903)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919008915790903)
,p_page_template_id=>wwv_flow_api.id(121918413460790903)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(121919108035790903)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919202957790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919318202790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919404992790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919526901790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919620933790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919705488790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(121919824374790904)
,p_page_template_id=>wwv_flow_api.id(121919108035790903)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(121925317655790956)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(121925401021790960)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(121925524591790960)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(121925607321790960)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(121925710568790962)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(121925808073790962)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121919918878790907)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920005629790920)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920100496790921)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920223401790921)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920324873790923)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920419629790923)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920506656790923)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920602645790923)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920718913790923)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(121920826522790923)
,p_plug_template_id=>wwv_flow_api.id(121920718913790923)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121920925989790925)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921016856790925)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921111454790925)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921202515790925)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(121921329195790926)
,p_plug_template_id=>wwv_flow_api.id(121921202515790925)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921425488790926)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921526287790926)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921600747790926)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(121921707737790926)
,p_plug_template_id=>wwv_flow_api.id(121921600747790926)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(121921825141790926)
,p_plug_template_id=>wwv_flow_api.id(121921600747790926)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121921911465790926)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(121922028024790926)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923220461790942)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923331484790950)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923412385790950)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923508435790950)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923630508790950)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923732291790950)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923817379790950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121923925540790950)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121924004177790950)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121924128353790950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121924203462790950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121924300593790950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121924430244790950)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(121924504067790950)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922112661790929)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922204152790937)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922323185790937)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922403276790937)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922503027790937)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922629597790937)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922722150790939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922817907790939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121922931300790939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121923006934790939)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(121923114578790939)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121924607888790951)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121924704347790954)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121924811985790954)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121924931251790954)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121925016964790956)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121925132168790956)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(121925205226790956)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(121925916451790964)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(121926109974790992)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(121926007077790981)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(121926220228791003)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(121913713103790898)
,p_error_template=>wwv_flow_api.id(121910005289790889)
,p_printer_friendly_template=>wwv_flow_api.id(121916226235790900)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(121908505178790865)
,p_default_button_template=>wwv_flow_api.id(121925317655790956)
,p_default_region_template=>wwv_flow_api.id(121921600747790926)
,p_default_chart_template=>wwv_flow_api.id(121921600747790926)
,p_default_form_template=>wwv_flow_api.id(121920718913790923)
,p_default_reportr_template=>wwv_flow_api.id(121921600747790926)
,p_default_tabform_template=>wwv_flow_api.id(121921600747790926)
,p_default_wizard_template=>wwv_flow_api.id(121920718913790923)
,p_default_menur_template=>wwv_flow_api.id(121920223401790921)
,p_default_listr_template=>wwv_flow_api.id(121921600747790926)
,p_default_irr_template=>wwv_flow_api.id(121921111454790925)
,p_default_report_template=>wwv_flow_api.id(121922722150790939)
,p_default_label_template=>wwv_flow_api.id(121924811985790954)
,p_default_menu_template=>wwv_flow_api.id(121925916451790964)
,p_default_calendar_template=>wwv_flow_api.id(121926007077790981)
,p_default_list_template=>wwv_flow_api.id(121924300593790950)
,p_default_option_label=>wwv_flow_api.id(121924811985790954)
,p_default_required_label=>wwv_flow_api.id(121925132168790956)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(121926531641791023)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(121926614198791026)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(121926720270791028)
,p_name=>'DATABASE'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(121926814607791028)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(121926929979791028)
,p_name=>'HTML DB'
,p_scheme_type=>'NATIVE_APEX_ACCOUNTS'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(121927125156791028)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(121926332637791004)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(121926332637791004)
,p_tab_set=>'TS1'
,p_name=>'Checklist'
,p_alias=>'HOME'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(121928620571791060)
,p_plug_name=>'Checklist'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(121921111454790925)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select nmorden,fecrea,cdclase||''-''||correlativo unidad , dsrepara , cddelegacion  from tordenserv where nmorden in (select nmsuper from tchecklist_neu)'
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(121928717783791062)
,p_name=>'Checklist'
...
,p_owner=>'LP'
,p_internal_uid=>121928717783791062
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121928800876791076)
,p_db_column_name=>'NMORDEN'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Nmorden'
,p_column_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.::P2_NMSUPER:#NMORDEN#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121928912369791081)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121929025597791082)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121929106243791084)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121929216852791085)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(121931520603806396)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1219316'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMORDEN:FECREA:UNIDAD:DSREPARA:CDDELEGACION'
,p_sort_column_1=>'FECREA'
,p_sort_direction_1=>'DESC'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(121929414904791090)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(121920223401790921)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(121928217100791051)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(121925916451790964)
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20210204122627'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(121929908295796385)
,p_plug_name=>'detalle'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(121921111454790925)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'Select * from   tchecklist_neu  where nmsuper = :P2_nmsuper'
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P2_NMSUPER'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(121930032029796385)
,p_name=>'detalle'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'LP'
,p_internal_uid=>121930032029796385
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121930230796796392)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121930304147796392)
,p_db_column_name=>'COD_NEUMATICO'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Cod Neumatico'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'COD_NEUMATICO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121930406405796392)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121930510027796392)
,p_db_column_name=>'PROF_INICIAL'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Prof Inicial'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'PROF_INICIAL'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121930629664796392)
,p_db_column_name=>'PROF_FINAL'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Prof Final'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'PROF_FINAL'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(121930729332796392)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(121931119910806142)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1219312'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMSUPER:COD_NEUMATICO:POSICION:PROF_INICIAL:PROF_FINAL:COMENTARIO'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(121930903694798653)
,p_name=>'P2_NMSUPER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(121929908295796385)
,p_prompt=>'Nmsuper'
...
,p_field_template=>wwv_flow_api.id(121924811985790954)
...
,p_step_template=>wwv_flow_api.id(121908505178790865)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20210204122339'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(121927421726791034)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(121920718913790923)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(121927730151791048)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(121927421726791034)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(121925317655790956)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(121927517597791040)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(121927421726791034)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(121927614581791046)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(121927901386791051)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(121927817210791048)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(121928103562791051)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(121928023488791051)
,p_process_sequence=>10
