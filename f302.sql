...
,p_default_application_id=>302
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 302 - J_Reparaciones Fast
--
-- Application Export:
--   Application:     302
--   Name:            J_Reparaciones Fast
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,302)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_Reparaciones Fast')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_302')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'44466E15AA95C6CDE5B44C8B52456344648C433D11E3389E47C197E40251D08E'
...
,p_authentication_id=>wwv_flow_api.id(12251730533135164)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Reparaciones Fast'
...
,p_last_upd_yyyymmddhh24miss=>'20210322135156'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8734001623051136)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8734166005051138)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8734252885051138)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8734415327051138)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8734577407051138)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8734641416051138)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12172800811187660)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12255107623206551)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12190819320187681)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(12192001973187682)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(12192422226187682)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12172909534187660)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173011352187662)
,p_page_template_id=>wwv_flow_api.id(12172909534187660)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12173103900187662)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173213790187664)
,p_page_template_id=>wwv_flow_api.id(12173103900187662)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173317867187664)
,p_page_template_id=>wwv_flow_api.id(12173103900187662)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173430812187664)
,p_page_template_id=>wwv_flow_api.id(12173103900187662)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173513542187664)
,p_page_template_id=>wwv_flow_api.id(12173103900187662)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173621320187664)
,p_page_template_id=>wwv_flow_api.id(12173103900187662)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12173723228187664)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173820259187664)
,p_page_template_id=>wwv_flow_api.id(12173723228187664)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12173909094187664)
,p_page_template_id=>wwv_flow_api.id(12173723228187664)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174011026187664)
,p_page_template_id=>wwv_flow_api.id(12173723228187664)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174103692187664)
,p_page_template_id=>wwv_flow_api.id(12173723228187664)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174229138187664)
,p_page_template_id=>wwv_flow_api.id(12173723228187664)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174330169187664)
,p_page_template_id=>wwv_flow_api.id(12173723228187664)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12174406716187664)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174527346187664)
,p_page_template_id=>wwv_flow_api.id(12174406716187664)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174607629187664)
,p_page_template_id=>wwv_flow_api.id(12174406716187664)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174715917187664)
,p_page_template_id=>wwv_flow_api.id(12174406716187664)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12174825587187664)
,p_page_template_id=>wwv_flow_api.id(12174406716187664)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12174925529187667)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175029465187667)
,p_page_template_id=>wwv_flow_api.id(12174925529187667)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175108888187667)
,p_page_template_id=>wwv_flow_api.id(12174925529187667)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175206293187667)
,p_page_template_id=>wwv_flow_api.id(12174925529187667)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175321564187667)
,p_page_template_id=>wwv_flow_api.id(12174925529187667)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175414097187667)
,p_page_template_id=>wwv_flow_api.id(12174925529187667)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12175504923187667)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175614083187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175702948187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175816205187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12175921463187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176029734187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176117605187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176204303187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176322831187667)
,p_page_template_id=>wwv_flow_api.id(12175504923187667)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12176421700187667)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176509847187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176632624187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176712736187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176801413187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12176909426187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177022922187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177130845187667)
,p_page_template_id=>wwv_flow_api.id(12176421700187667)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12177207488187670)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177325485187670)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177427623187670)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177503246187671)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177613708187671)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177729399187671)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177827114187671)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12177902826187671)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178001412187671)
,p_page_template_id=>wwv_flow_api.id(12177207488187670)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12178100917187671)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178201532187671)
,p_page_template_id=>wwv_flow_api.id(12178100917187671)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178317428187671)
,p_page_template_id=>wwv_flow_api.id(12178100917187671)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178427354187671)
,p_page_template_id=>wwv_flow_api.id(12178100917187671)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178528382187671)
,p_page_template_id=>wwv_flow_api.id(12178100917187671)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178617977187671)
,p_page_template_id=>wwv_flow_api.id(12178100917187671)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178711187187671)
,p_page_template_id=>wwv_flow_api.id(12178100917187671)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12178803359187671)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12178911445187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179024924187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179132277187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179201872187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179305638187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179412264187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179505573187671)
,p_page_template_id=>wwv_flow_api.id(12178803359187671)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12179617317187671)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179703555187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179832153187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12179912043187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180030103187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180128159187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180218186187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180305252187671)
,p_page_template_id=>wwv_flow_api.id(12179617317187671)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12180424112187671)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180521099187671)
,p_page_template_id=>wwv_flow_api.id(12180424112187671)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12180612199187671)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180728930187671)
,p_page_template_id=>wwv_flow_api.id(12180612199187671)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180818071187671)
,p_page_template_id=>wwv_flow_api.id(12180612199187671)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12180908336187671)
,p_page_template_id=>wwv_flow_api.id(12180612199187671)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181015318187671)
,p_page_template_id=>wwv_flow_api.id(12180612199187671)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12181117063187671)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181223771187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181325966187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181407009187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181511068187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181624319187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181726388187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12181804135187673)
,p_page_template_id=>wwv_flow_api.id(12181117063187671)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12181906615187673)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182016455187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182101375187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182215620187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182302478187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182413506187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182517910187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182626877187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182721046187673)
,p_page_template_id=>wwv_flow_api.id(12181906615187673)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12182820249187675)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12182910118187675)
,p_page_template_id=>wwv_flow_api.id(12182820249187675)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183000688187675)
,p_page_template_id=>wwv_flow_api.id(12182820249187675)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183117535187675)
,p_page_template_id=>wwv_flow_api.id(12182820249187675)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183207318187675)
,p_page_template_id=>wwv_flow_api.id(12182820249187675)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183306203187675)
,p_page_template_id=>wwv_flow_api.id(12182820249187675)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183428667187675)
,p_page_template_id=>wwv_flow_api.id(12182820249187675)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12183504564187675)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183627512187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183711135187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183830188187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12183914222187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12184010101187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12184127383187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12184217641187675)
,p_page_template_id=>wwv_flow_api.id(12183504564187675)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(8735174806051155)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12189731679187679)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12189802449187679)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12189923852187679)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12190030065187679)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12190100553187679)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12190224929187679)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184327705187675)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184430865187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184524250187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184629985187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184718923187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184804127187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12184910452187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185032562187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185112768187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12185220500187675)
,p_plug_template_id=>wwv_flow_api.id(12185112768187675)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185320475187675)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185432027187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185509562187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185614484187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12185705520187676)
,p_plug_template_id=>wwv_flow_api.id(12185614484187676)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185816229187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12185904024187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12186018359187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12186129401187676)
,p_plug_template_id=>wwv_flow_api.id(12186018359187676)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12186200653187676)
,p_plug_template_id=>wwv_flow_api.id(12186018359187676)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12186315829187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12186414235187676)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12187627453187676)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12187706386187678)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12187814610187678)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12187917878187678)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188023887187678)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188113335187678)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188208626187678)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188315365187678)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188416414187678)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188506913187678)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188612411187678)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188713266187678)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188804829187678)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12188922986187678)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12186506525187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12186620662187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12186732420187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12186818096187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12186904929187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12187023437187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12187110505187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12187230272187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12187323810187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12187423163187676)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12187500762187676)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189023160187678)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189117285187678)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189200535187678)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189317236187678)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189421769187678)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189506852187678)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12189618366187679)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(12190316939187679)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(12190505546187679)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(12190405389187679)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(12190630181187679)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(12178100917187671)
,p_error_template=>wwv_flow_api.id(12174406716187664)
,p_printer_friendly_template=>wwv_flow_api.id(12180612199187671)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(12172909534187660)
,p_default_button_template=>wwv_flow_api.id(12189731679187679)
,p_default_region_template=>wwv_flow_api.id(12186018359187676)
,p_default_chart_template=>wwv_flow_api.id(12186018359187676)
,p_default_form_template=>wwv_flow_api.id(12185112768187675)
,p_default_reportr_template=>wwv_flow_api.id(12186018359187676)
,p_default_tabform_template=>wwv_flow_api.id(12186018359187676)
,p_default_wizard_template=>wwv_flow_api.id(12185112768187675)
,p_default_menur_template=>wwv_flow_api.id(12184629985187675)
,p_default_listr_template=>wwv_flow_api.id(12186018359187676)
,p_default_irr_template=>wwv_flow_api.id(12185509562187676)
,p_default_report_template=>wwv_flow_api.id(12187110505187676)
,p_default_label_template=>wwv_flow_api.id(12189200535187678)
,p_default_menu_template=>wwv_flow_api.id(12190316939187679)
,p_default_calendar_template=>wwv_flow_api.id(12190405389187679)
,p_default_list_template=>wwv_flow_api.id(12188713266187678)
,p_default_option_label=>wwv_flow_api.id(12189200535187678)
,p_default_required_label=>wwv_flow_api.id(12189506852187678)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12190904494187681)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12251730533135164)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(12190730241187681)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(12190730241187681)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20180129120954'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12196505768201701)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12185509562187676)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(12196707742201701)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.::P2_ROWID,P2_CDMEDIDA,P2_CORRELATIVO:#ROWID#,#CDMEDIDA#,#CORRELATIVO#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
,p_owner=>'JFAJARDO'
,p_internal_uid=>12196707742201701
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12196820423201709)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12196914315201710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12197022397201712)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12197128089201714)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12197232564201715)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12197308816201715)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12197414035201717)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12197509423201718)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(12197920501201843)
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ROWID:CDMEDIDA:CORRELATIVO:ESTADO:NUEVA:REENCAUCHE1:REENCAUCHE2:REENCAUCHE3'
);
end;
/
...
,p_last_upd_yyyymmddhh24miss=>'20201201113008'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12193000944201689)
,p_plug_name=>'Reparaciones'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12185112768187675)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12193425499201689)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(12193000944201689)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(12189731679187679)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12200318348295846)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(12193000944201689)
,p_button_name=>unistr('GUARDAR_REPARACi\00D3N')
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(8735174806051155)
,p_button_image_alt=>unistr('Guardar Reparaci\00F3n')
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(23859723595380239)
,p_branch_name=>'home'
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(12200318348295846)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12193814394201690)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12193000944201689)
...
,p_field_template=>wwv_flow_api.id(12189200535187678)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12194025290201692)
,p_name=>'P2_CDMEDIDA'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(12193000944201689)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(12189506852187678)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12194230105201692)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12194431480201693)
,p_name=>'P2_NUEVA'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(12193000944201689)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12194628650201693)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12194831217201693)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12195026625201693)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12199329112252026)
,p_name=>'P2_MOTIVO'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(12193000944201689)
,p_prompt=>'Motivo'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12199522642255048)
,p_name=>'P2_NUMEROOT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(12193000944201689)
,p_prompt=>'Numero de OT'
,p_display_as=>'NATIVE_POPUP_LOV'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12199730393266660)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12200824413335420)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Reparation Fast'
...
'empresa varchar2(2);',
'BEGIN',
'select cdestacion into empresa from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'select cod_emp into empleado from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'select nueva into nev from tneumaticos where correlativo = :P2_CORRELATIVO and cdmedida = :P2_CDMEDIDA and estado = ''M'';',
'select reencauche1 into r1 from tneumaticos where correlativo = :P2_CORRELATIVO and cdmedida = :P2_CDMEDIDA and estado = ''M'';',
'select reencauche2 into r2 from tneumaticos where correlativo = :P2_CORRELATIVO and cdmedida = :P2_CDMEDIDA and estado = ''M'';',
'select reencauche3 into r3 from tneumaticos where correlativo = :P2_CORRELATIVO and cdmedida = :P2_CDMEDIDA and estado = ''M'';',
'INSERT INTO treparaneum (cdmedida,correlativo,nueva,reencauche1,reencauche2,reencauche3,fecha,cdmotivo,nmdocto,user_m,cdempresa) VALUES (:P2_CDMEDIDA,:P2_CORRELATIVO,nev,r1,r2,r3,sysdate,:P2_MOTIVO,:P2_NUMEROOT,empleado,empresa);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(12200318348295846)
,p_process_success_message=>unistr('Reparaci\00C3\00B3n Guardada')
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23861411299505568)
...
,p_step_template=>wwv_flow_api.id(12172909534187660)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171128120528'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12191227050187681)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12185112768187675)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12191529823187682)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(12191227050187681)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12191307381187681)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12191227050187681)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12191410751187682)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12191718664187682)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12191606140187682)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12191919404187682)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12191818939187682)
,p_process_sequence=>10
