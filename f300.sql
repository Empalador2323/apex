...
prompt APPLICATION 300 - RecepciÃ³n Repaciones
--
-- Application Export:
--   Application:     300
--   Name:            RecepciÃ³n Repaciones
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'RecepciÃ³n Repaciones')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_300')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'20A4E883A793A789A205F139DB61B815E60C6546861933A582E6FDE8DF454A6F'
...
,p_authentication_id=>wwv_flow_api.id(12252011555143984)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:RECEPCION DE LLANTAS'
...
,p_last_upd_yyyymmddhh24miss=>'20210329162553'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8730500764050565)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8730645359050565)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8730727355050565)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8730938315050565)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8731099057050565)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8731103408050565)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(12143021832833995)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12254325308198326)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(12161027013834010)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(12162224225834015)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(12162627715834015)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12143100455833996)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12143228387833996)
,p_page_template_id=>wwv_flow_api.id(12143100455833996)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12143302193833996)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12143413933833998)
,p_page_template_id=>wwv_flow_api.id(12143302193833996)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12143511361833998)
,p_page_template_id=>wwv_flow_api.id(12143302193833996)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12143610224833998)
,p_page_template_id=>wwv_flow_api.id(12143302193833996)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12143723629833998)
,p_page_template_id=>wwv_flow_api.id(12143302193833996)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12143816112833998)
,p_page_template_id=>wwv_flow_api.id(12143302193833996)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12143905801833998)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144019908833998)
,p_page_template_id=>wwv_flow_api.id(12143905801833998)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144103883833998)
,p_page_template_id=>wwv_flow_api.id(12143905801833998)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144229909833998)
,p_page_template_id=>wwv_flow_api.id(12143905801833998)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144310014833998)
,p_page_template_id=>wwv_flow_api.id(12143905801833998)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144417771833998)
,p_page_template_id=>wwv_flow_api.id(12143905801833998)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144528188833998)
,p_page_template_id=>wwv_flow_api.id(12143905801833998)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12144626318833998)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144730218833998)
,p_page_template_id=>wwv_flow_api.id(12144626318833998)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144817893833998)
,p_page_template_id=>wwv_flow_api.id(12144626318833998)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12144930548833998)
,p_page_template_id=>wwv_flow_api.id(12144626318833998)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145016025833998)
,p_page_template_id=>wwv_flow_api.id(12144626318833998)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12145108843833998)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145207076833998)
,p_page_template_id=>wwv_flow_api.id(12145108843833998)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145306907833998)
,p_page_template_id=>wwv_flow_api.id(12145108843833998)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145403227833998)
,p_page_template_id=>wwv_flow_api.id(12145108843833998)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145500476833998)
,p_page_template_id=>wwv_flow_api.id(12145108843833998)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145606985833998)
,p_page_template_id=>wwv_flow_api.id(12145108843833998)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12145717433833998)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145802238833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12145905353833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146008092833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146113755833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146217544833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146328691833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146411977833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146502155833998)
,p_page_template_id=>wwv_flow_api.id(12145717433833998)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12146602684833998)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146700320833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146808930833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12146921455833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147026293833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147124615833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147229073833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147320640833998)
,p_page_template_id=>wwv_flow_api.id(12146602684833998)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12147405313833998)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147505339833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147628445833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147732462833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147820156833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12147900149833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148010400833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148107153833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148214766833998)
,p_page_template_id=>wwv_flow_api.id(12147405313833998)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12148321702834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148412679834000)
,p_page_template_id=>wwv_flow_api.id(12148321702834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148530195834000)
,p_page_template_id=>wwv_flow_api.id(12148321702834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148627430834000)
,p_page_template_id=>wwv_flow_api.id(12148321702834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148717500834000)
,p_page_template_id=>wwv_flow_api.id(12148321702834000)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148800074834000)
,p_page_template_id=>wwv_flow_api.id(12148321702834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12148926108834000)
,p_page_template_id=>wwv_flow_api.id(12148321702834000)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12149017430834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149123381834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149213933834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149332671834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149407410834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149510370834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149628600834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149716450834000)
,p_page_template_id=>wwv_flow_api.id(12149017430834000)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12149832516834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12149909629834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150029874834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150119155834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150226387834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150302447834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150427748834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150531657834000)
,p_page_template_id=>wwv_flow_api.id(12149832516834000)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12150619765834000)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150728923834000)
,p_page_template_id=>wwv_flow_api.id(12150619765834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12150826956834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12150924760834000)
,p_page_template_id=>wwv_flow_api.id(12150826956834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151028144834000)
,p_page_template_id=>wwv_flow_api.id(12150826956834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151102318834000)
,p_page_template_id=>wwv_flow_api.id(12150826956834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151228063834000)
,p_page_template_id=>wwv_flow_api.id(12150826956834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12151325081834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151404248834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151510378834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151617092834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151709753834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151818148834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12151900785834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152016397834000)
,p_page_template_id=>wwv_flow_api.id(12151325081834000)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12152132608834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152225042834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152325263834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152423736834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152527877834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152606078834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152705036834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152810534834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12152931728834000)
,p_page_template_id=>wwv_flow_api.id(12152132608834000)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12153006078834000)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153128304834001)
,p_page_template_id=>wwv_flow_api.id(12153006078834000)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153202906834001)
,p_page_template_id=>wwv_flow_api.id(12153006078834000)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153305552834001)
,p_page_template_id=>wwv_flow_api.id(12153006078834000)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153401601834001)
,p_page_template_id=>wwv_flow_api.id(12153006078834000)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153511382834001)
,p_page_template_id=>wwv_flow_api.id(12153006078834000)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153623221834001)
,p_page_template_id=>wwv_flow_api.id(12153006078834000)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(12153701310834001)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153807911834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12153929078834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12154014064834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12154116689834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12154230627834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12154314862834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(12154413914834001)
,p_page_template_id=>wwv_flow_api.id(12153701310834001)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(8731617331050604)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12159922824834007)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12160010160834007)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12160131404834007)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12160205355834007)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12160303232834007)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(12160415478834007)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12154518243834001)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12154608463834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12154705361834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12154818260834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12154904547834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155008207834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155122930834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155224842834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155330492834001)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12155431914834001)
,p_plug_template_id=>wwv_flow_api.id(12155330492834001)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155517170834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155624435834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155731974834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12155825125834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12155907720834003)
,p_plug_template_id=>wwv_flow_api.id(12155825125834003)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12156009868834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12156127468834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12156203169834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12156330000834003)
,p_plug_template_id=>wwv_flow_api.id(12156203169834003)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(12156426832834003)
,p_plug_template_id=>wwv_flow_api.id(12156203169834003)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12156511453834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(12156632375834003)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12157831948834004)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12157921776834006)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158019246834006)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158117226834006)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158227358834006)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158326488834006)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158415800834006)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158506153834006)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158625429834006)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158722676834007)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158808087834007)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12158921242834007)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12159007518834007)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(12159114478834007)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12156726231834003)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12156811515834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12156917879834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157016017834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157104293834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157228417834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157329072834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157404876834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157516940834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157630793834004)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(12157711687834004)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159201889834007)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159308750834007)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159418597834007)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159505781834007)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159608973834007)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159711348834007)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(12159832237834007)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(12160526415834007)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(12160721505834009)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(12160623395834009)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(12160831972834010)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(12148321702834000)
,p_error_template=>wwv_flow_api.id(12144626318833998)
,p_printer_friendly_template=>wwv_flow_api.id(12150826956834000)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(12143100455833996)
,p_default_button_template=>wwv_flow_api.id(12159922824834007)
,p_default_region_template=>wwv_flow_api.id(12156203169834003)
,p_default_chart_template=>wwv_flow_api.id(12156203169834003)
,p_default_form_template=>wwv_flow_api.id(12155330492834001)
,p_default_reportr_template=>wwv_flow_api.id(12156203169834003)
,p_default_tabform_template=>wwv_flow_api.id(12156203169834003)
,p_default_wizard_template=>wwv_flow_api.id(12155330492834001)
,p_default_menur_template=>wwv_flow_api.id(12154818260834001)
,p_default_listr_template=>wwv_flow_api.id(12156203169834003)
,p_default_irr_template=>wwv_flow_api.id(12155731974834003)
,p_default_report_template=>wwv_flow_api.id(12157329072834004)
,p_default_label_template=>wwv_flow_api.id(12159418597834007)
,p_default_menu_template=>wwv_flow_api.id(12160526415834007)
,p_default_calendar_template=>wwv_flow_api.id(12160623395834009)
,p_default_list_template=>wwv_flow_api.id(12158921242834007)
,p_default_option_label=>wwv_flow_api.id(12159418597834007)
,p_default_required_label=>wwv_flow_api.id(12159711348834007)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12161126626834010)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(12252011555143984)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(12160923293834010)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(12160923293834010)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20171227120957'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12166721685860737)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12155731974834003)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(12166926310860737)
,p_name=>'Report 1'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>12166926310860737
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167125388860751)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167213074860753)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167309904860754)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167418770860756)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167523293860756)
...
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'REENCAUCHE1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167612057860757)
...
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'REENCAUCHE2'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167729078860759)
...
,p_column_type=>'NUMBER'
,p_tz_dependent=>'N'
,p_static_id=>'REENCAUCHE3'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(12167819945860760)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(12168220978861401)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'121683'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CDMEDIDA:CORRELATIVO:ESTADO:NUEVA:REENCAUCHE1:REENCAUCHE2:REENCAUCHE3:PROFUNDIDAD'
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(12160923293834010)
,p_name=>'Form on TNEUMATICOS'
,p_step_title=>'Form on TNEUMATICOS'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12163213564860690)
,p_plug_name=>'Recepcion'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12155330492834001)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12163608128860690)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(12163213564860690)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(12159922824834007)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12170025059957139)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(12163213564860690)
,p_button_name=>unistr('ACEPTAR_RECEPCI\00C3\0093N')
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(8731617331050604)
,p_button_image_alt=>'Aceptar Recepcion'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(12163811583860692)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12164014231860725)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
...
,p_field_template=>wwv_flow_api.id(12159418597834007)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12164214643860726)
,p_name=>'P2_CDMEDIDA'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(12159711348834007)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12164423406860726)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12164615941860728)
,p_name=>'P2_NUEVA'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12164832003860728)
,p_name=>'P2_REENCAUCHE1'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Reencauche1'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12165004958860728)
,p_name=>'P2_REENCAUCHE2'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Reencauche2'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12165220997860729)
,p_name=>'P2_REENCAUCHE3'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Reencauche3'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12169302882899585)
,p_name=>'P2_PROFUNDIDAD'
,p_item_sequence=>58
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_prompt=>'Profundidad de vuelta'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12169620338906617)
,p_name=>'P2_COSTO'
,p_item_sequence=>51
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_prompt=>unistr('Costo de la reparaci\00C3\00B3n')
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12169816241908606)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12610930429713715)
,p_name=>'P2_BODEGA'
,p_item_sequence=>53
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_prompt=>'Bodega'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12611121587717809)
,p_name=>unistr('P2_DISE\00D1O')
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_prompt=>unistr('Dise\00C3\00B1o')
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select dsdiseno,cddiseno from tdisenos'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(12159418597834007)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12944315749186392)
,p_name=>'P2_SERIEFACT'
,p_item_sequence=>45
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_prompt=>'Seriefact'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12944529539195128)
,p_name=>'P2_NUMEROFACT'
,p_item_sequence=>46
,p_item_plug_id=>wwv_flow_api.id(12163213564860690)
,p_prompt=>'Numerofact'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12170225190966620)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'RecepcionLlantas'
...
'r3 numeric;',
'BEGIN',
'select nueva into n from tneumaticos where correlativo = :P2_CORRELATIVO AND cdmedida=:P2_CDMEDIDA and estado =''E'';',
'select reencauche1 into r1 from tneumaticos where correlativo = :P2_CORRELATIVO AND cdmedida=:P2_CDMEDIDA and estado =''E'';',
'select reencauche2 into r2 from tneumaticos where correlativo = :P2_CORRELATIVO AND cdmedida=:P2_CDMEDIDA and estado =''E'';',
'select reencauche3 into r3 from tneumaticos where correlativo = :P2_CORRELATIVO AND cdmedida=:P2_CDMEDIDA and estado =''E'';',
'',
'IF r2=1 THEN',
'r3:=1;',
'ELSE',
...
'',
'INSERT INTO trecepcion_n (cdmedida,correlativo,nueva,reencauche1,reencauche2,reencauche3,costo,fecharecibe,observaciones,profundidad,user_m,nmenvio,seriefact,factura,cdempresa) ',
'values(:P2_CDMEDIDA,:P2_CORRELATIVO,n,r1,r2,r3,:P2_COSTO,sysdate(),:P2_OBSERVACIONES,:P2_PROFUNDIDAD,empleado,1,:P2_SERIEFACT,:P2_NUMEROFACT,''01'');',
'',
'UPDATE tneumaticos set estado = ''D'', cdbodega = 1, reencauche1=r1,reencauche2=r2,reencauche3=r3, fechamodi=sysdate() where cdmedida = :P2_CDMEDIDA and correlativo = :P2_CORRELATIVO and estado=''E'';',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(12170025059957139)
,p_process_success_message=>'Registro con exito'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(12143100455833996)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171128110632'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12161403978834012)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(12155330492834001)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(12161704349834014)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(12161403978834012)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12161520570834014)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(12161403978834012)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12161601169834014)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12161917229834015)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12161806283834015)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12162113946834015)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(12162004636834015)
,p_process_sequence=>10
