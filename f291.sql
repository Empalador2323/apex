...
prompt APPLICATION 291 - J_Checklistdiario Limpios
--
-- Application Export:
--   Application:     291
--   Name:            J_Checklistdiario Limpios
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,291)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_Checklistdiario Limpios')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_291')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'6102C47D45E38256C7C35BBAB1C52211A5E2807CAB7B1E2FACDE6A8709589245'
...
,p_authentication_id=>wwv_flow_api.id(16751017973262926)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Checklist diario'
...
,p_last_upd_yyyymmddhh24miss=>'20190103214104'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8719581762047681)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8719608563047681)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8719716227047681)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8719987835047681)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8720083050047681)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8720134887047681)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13631821455933057)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(16758516629856065)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(13649815995933248)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(13651005208933278)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(13651414295933285)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13631930635933070)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632002326933079)
,p_page_template_id=>wwv_flow_api.id(13631930635933070)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13632112536933082)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632216834933082)
,p_page_template_id=>wwv_flow_api.id(13632112536933082)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632330902933084)
,p_page_template_id=>wwv_flow_api.id(13632112536933082)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632408440933084)
,p_page_template_id=>wwv_flow_api.id(13632112536933082)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632513326933084)
,p_page_template_id=>wwv_flow_api.id(13632112536933082)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632624414933084)
,p_page_template_id=>wwv_flow_api.id(13632112536933082)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13632707940933084)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632820415933084)
,p_page_template_id=>wwv_flow_api.id(13632707940933084)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13632922498933084)
,p_page_template_id=>wwv_flow_api.id(13632707940933084)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633003173933084)
,p_page_template_id=>wwv_flow_api.id(13632707940933084)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633124936933084)
,p_page_template_id=>wwv_flow_api.id(13632707940933084)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633231260933084)
,p_page_template_id=>wwv_flow_api.id(13632707940933084)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633313446933084)
,p_page_template_id=>wwv_flow_api.id(13632707940933084)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13633420192933084)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633515497933085)
,p_page_template_id=>wwv_flow_api.id(13633420192933084)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633600413933085)
,p_page_template_id=>wwv_flow_api.id(13633420192933084)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633702293933085)
,p_page_template_id=>wwv_flow_api.id(13633420192933084)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13633817815933085)
,p_page_template_id=>wwv_flow_api.id(13633420192933084)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13633911923933085)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634018246933085)
,p_page_template_id=>wwv_flow_api.id(13633911923933085)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634119797933085)
,p_page_template_id=>wwv_flow_api.id(13633911923933085)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634206609933085)
,p_page_template_id=>wwv_flow_api.id(13633911923933085)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634302846933085)
,p_page_template_id=>wwv_flow_api.id(13633911923933085)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634429550933085)
,p_page_template_id=>wwv_flow_api.id(13633911923933085)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13634507052933085)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634619533933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634713150933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634832476933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13634906663933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635031105933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635132396933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635214626933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635321703933085)
,p_page_template_id=>wwv_flow_api.id(13634507052933085)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13635428945933085)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635524213933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635618489933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635712461933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635815507933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13635903330933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636023901933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636125862933085)
,p_page_template_id=>wwv_flow_api.id(13635428945933085)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13636229058933085)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636319496933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636406955933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636510074933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636627264933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636702193933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636826873933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13636930065933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637017361933087)
,p_page_template_id=>wwv_flow_api.id(13636229058933085)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13637126281933087)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637212150933087)
,p_page_template_id=>wwv_flow_api.id(13637126281933087)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637310663933087)
,p_page_template_id=>wwv_flow_api.id(13637126281933087)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637414100933087)
,p_page_template_id=>wwv_flow_api.id(13637126281933087)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637502221933087)
,p_page_template_id=>wwv_flow_api.id(13637126281933087)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637614979933087)
,p_page_template_id=>wwv_flow_api.id(13637126281933087)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637717778933087)
,p_page_template_id=>wwv_flow_api.id(13637126281933087)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13637812867933087)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13637906353933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638015440933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638107729933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638217902933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638325520933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638411707933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638522583933087)
,p_page_template_id=>wwv_flow_api.id(13637812867933087)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13638618099933087)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638703833933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638802021933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13638923576933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639015874933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639114424933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639204886933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639312851933089)
,p_page_template_id=>wwv_flow_api.id(13638618099933087)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13639401551933089)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639502211933089)
,p_page_template_id=>wwv_flow_api.id(13639401551933089)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13639618132933089)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639728800933089)
,p_page_template_id=>wwv_flow_api.id(13639618132933089)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639811544933089)
,p_page_template_id=>wwv_flow_api.id(13639618132933089)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13639901862933089)
,p_page_template_id=>wwv_flow_api.id(13639618132933089)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640030526933089)
,p_page_template_id=>wwv_flow_api.id(13639618132933089)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13640109883933089)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640231705933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640314833933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640419374933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640529713933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640615180933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640723680933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13640814991933089)
,p_page_template_id=>wwv_flow_api.id(13640109883933089)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13640913547933089)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641005542933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641115658933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641201659933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641328793933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641411918933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641502286933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641630874933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641730305933089)
,p_page_template_id=>wwv_flow_api.id(13640913547933089)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13641820128933089)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13641905179933090)
,p_page_template_id=>wwv_flow_api.id(13641820128933089)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642021559933090)
,p_page_template_id=>wwv_flow_api.id(13641820128933089)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642121991933090)
,p_page_template_id=>wwv_flow_api.id(13641820128933089)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642215906933090)
,p_page_template_id=>wwv_flow_api.id(13641820128933089)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642327614933090)
,p_page_template_id=>wwv_flow_api.id(13641820128933089)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642416291933090)
,p_page_template_id=>wwv_flow_api.id(13641820128933089)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13642507039933090)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642611013933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642714897933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642807759933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13642900144933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13643013856933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13643119586933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13643206180933090)
,p_page_template_id=>wwv_flow_api.id(13642507039933090)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13648702779933212)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13648815382933217)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13648901749933217)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13649003596933217)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13649115847933217)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13649206556933217)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643331115933092)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643400936933101)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643517602933101)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643618982933101)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643720012933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643827379933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13643917263933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644023626933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644110256933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13644208557933103)
,p_plug_template_id=>wwv_flow_api.id(13644110256933103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644305571933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644430869933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644517272933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644631963933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13644713342933103)
,p_plug_template_id=>wwv_flow_api.id(13644631963933103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644824438933103)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13644911868933104)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13645010448933104)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13645107345933104)
,p_plug_template_id=>wwv_flow_api.id(13645010448933104)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13645205476933104)
,p_plug_template_id=>wwv_flow_api.id(13645010448933104)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13645316820933104)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13645427501933104)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13646601334933151)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13646718292933192)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13646819735933192)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13646923952933192)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647024191933193)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647124146933193)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647215469933193)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647308440933193)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647405266933193)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647515347933193)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647608660933193)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647719909933193)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647820043933193)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13647903864933193)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13645522125933115)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13645626043933140)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13645716642933140)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13645821852933140)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13645910283933140)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13646014036933140)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13646119491933140)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13646230991933142)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13646320508933142)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13646427492933142)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13646503928933142)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648023559933200)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648117217933210)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648202362933210)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648331412933210)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648410150933210)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648518196933210)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13648618521933210)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(13649319409933217)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(13649528140933229)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(13649415711933225)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(13649617589933235)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(13637126281933087)
,p_error_template=>wwv_flow_api.id(13633420192933084)
,p_printer_friendly_template=>wwv_flow_api.id(13639618132933089)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(13631930635933070)
,p_default_button_template=>wwv_flow_api.id(13648702779933212)
,p_default_region_template=>wwv_flow_api.id(13645010448933104)
,p_default_chart_template=>wwv_flow_api.id(13645010448933104)
,p_default_form_template=>wwv_flow_api.id(13644110256933103)
,p_default_reportr_template=>wwv_flow_api.id(13645010448933104)
,p_default_tabform_template=>wwv_flow_api.id(13645010448933104)
,p_default_wizard_template=>wwv_flow_api.id(13644110256933103)
,p_default_menur_template=>wwv_flow_api.id(13643618982933101)
,p_default_listr_template=>wwv_flow_api.id(13645010448933104)
,p_default_irr_template=>wwv_flow_api.id(13644517272933103)
,p_default_report_template=>wwv_flow_api.id(13646119491933140)
,p_default_label_template=>wwv_flow_api.id(13648202362933210)
,p_default_menu_template=>wwv_flow_api.id(13649319409933217)
,p_default_calendar_template=>wwv_flow_api.id(13649415711933225)
,p_default_list_template=>wwv_flow_api.id(13647719909933193)
,p_default_option_label=>wwv_flow_api.id(13648202362933210)
,p_default_required_label=>wwv_flow_api.id(13648518196933210)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(13649909823933251)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(16751017973262926)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
...
/
prompt --application/shared_components/plugins/dynamic_action/toggle_checkbox
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(81654967952177094447)
,p_plugin_type=>'DYNAMIC ACTION'
,p_name=>'TOGGLE.CHECKBOX'
,p_display_name=>'ToggleCheckbox'
,p_category=>'STYLE'
,p_supported_ui_types=>'DESKTOP'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('DYNAMIC ACTION','TOGGLE.CHECKBOX'),'')
...
'begin',
'  apex_css.add_file(p_name => ''togglecheckbox'', p_directory => p_plugin.file_prefix);',
'',
'  if (p_dynamic_action.attribute_01 = ''CUSTOM'') then',
'    l_css := l_css || ''.c''||p_dynamic_action.id||''{'';',
'    l_css := l_css || ''  background:url("''||p_dynamic_action.attribute_02||''") bottom left;'';',
'    l_css := l_css || ''  width:'' || p_dynamic_action.attribute_03 || ''px;'';',
'    l_css := l_css || ''  height:'' || p_dynamic_action.attribute_04 / 2 || ''px;'';',
'    l_css := l_css || ''}'';   ',
'    ',
'    APEX_CSS.ADD (p_css => l_css, p_key => p_dynamic_action.id);',
'',
'    l_result.javascript_function := ''function(pAction){togglecheckbox(this.affectedElements,"c''||p_dynamic_action.id||''");}'';',
'  else',
'    l_result.javascript_function := ''function(pAction){togglecheckbox(this.affectedElements);}'';',
'  end if;',
'',
'  apex_javascript.add_library (p_name => ''togglecheckbox'', p_directory => p_plugin.file_prefix); ',
'',
'  return l_result;',
'end;'))
,p_api_version=>1
,p_render_function=>'togglecheckbox'
,p_standard_attributes=>'ITEM:REQUIRED'
,p_substitute_attributes=>true
,p_subscribe_plugin_settings=>true
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
'	iOS style checkboxes (toggle switches) are far more user friendly than the old browser checkboxes according to Shawn. This is <a href="http://apex.oracle.com/pls/apex/f?p=702:2" target="_blank">my apex implementation</a> of <a href="http://www.devir'
||'tuoso.com/2011/05/toggle-switches-with-jquery-and-checkboxes/" target="_blank">his toggle switch</a>.</p>',
'<p>',
'	post comments etc on&nbsp;<a href="http://www.apex-plugin.com/oracle-apex-plugins/dynamic-action-plugin/togglecheckbox_372.html" target="_blank">apex-plugin.com</a>!</p>',
''))
,p_version_identifier=>'1.0'
,p_about_url=>'http://www.apex-plugin.com/oracle-apex-plugins/dynamic-action-plugin/togglecheckbox_372.html'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82511485774728534241)
,p_plugin_id=>wwv_flow_api.id(81654967952177094447)
...
,p_lov_type=>'STATIC'
,p_help_text=>'You can use a custom image by selecting <i>Custom</i> here and provide the url of the image, and its width & height'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(82511489471924552161)
,p_plugin_attribute_id=>wwv_flow_api.id(82511485774728534241)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(82511493170415552901)
,p_plugin_attribute_id=>wwv_flow_api.id(82511485774728534241)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82586376878383728507)
,p_plugin_id=>wwv_flow_api.id(81654967952177094447)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_default_value=>'#APP_IMAGES#switch.jpg'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(82511485774728534241)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>The URL to the image. The image upper half should contain the <b>on</b> situation, the bottom contains the part where the selector is switched <b>off</b>.</p>',
unistr('<p>It\00E2\0080\0099s possible to upload the image into the shared component files. You can refer to your image here by using &#35;APP_IMAGES&#35; or &#35;WORKSPACE_IMAGES&#35; (depending on whether you assigned an application id or not) directly followed by the')
||' filename of your image including extension.</p>'))
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82586516479881743024)
,p_plugin_id=>wwv_flow_api.id(81654967952177094447)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'Image height (px)'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82586520274489745559)
,p_plugin_id=>wwv_flow_api.id(81654967952177094447)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'CUSTOM'
,p_help_text=>'Image width (px)'
);
end;
/
begin
wwv_flow_api.g_varchar2_table := wwv_flow_api.empty_varchar2_table;
wwv_flow_api.g_varchar2_table(1) := '2E68696464656E636865636B626F787B0D0A2020646973706C61793A206E6F6E653B0D0A7D0D0A0D0A2E746F67676C65636865636B626F787B0D0A20206261636B67726F756E643A75726C2822746F67676C65636865636B626F782E706E67222920626F';
wwv_flow_api.g_varchar2_table(2) := '74746F6D206C6566743B0D0A2020646973706C61793A696E6C696E652D626C6F636B3B0D0A202077696474683A373070783B0D0A20206865696768743A323270783B0D0A7D0D0A0D0A2E746F67676C65636865636B626F782E636865636B65647B0D0A20';
wwv_flow_api.g_varchar2_table(3) := '206261636B67726F756E642D706F736974696F6E3A746F70206C6566743B0D0A7D0D';
null;
end;
/
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(41322523537142700135)
,p_plugin_id=>wwv_flow_api.id(81654967952177094447)
,p_file_name=>'togglecheckbox.css'
...
begin
wwv_flow_api.g_varchar2_table := wwv_flow_api.empty_varchar2_table;
wwv_flow_api.g_varchar2_table(1) := '66756E6374696F6E20746F67676C65636865636B626F782861666665637465645F656C656D656E74732C206F7074696F6E616C5F636C61737329207B0D0A2020202061666665637465645F656C656D656E74732E66696E642822696E7075743A63686563';
wwv_flow_api.g_varchar2_table(2) := '6B626F7822292E616464436C617373282268696464656E636865636B626F7822293B0D0A0D0A20202020696620286F7074696F6E616C5F636C61737329207B0D0A2020202020202020636C617A7A203D2027746F67676C65636865636B626F782027202B';
wwv_flow_api.g_varchar2_table(3) := '206F7074696F6E616C5F636C6173733B0D0A202020207D20656C7365207B0D0A2020202020202020636C617A7A203D2027746F67676C65636865636B626F78273B0D0A202020207D0D0A0D0A2020202061666665637465645F656C656D656E74732E6669';
wwv_flow_api.g_varchar2_table(4) := '6E642822696E7075743A636865636B626F7822292E6265666F72652866756E6374696F6E202829207B0D0A202020202020202069662028242874686973292E697328223A636865636B6564222929207B0D0A20202020202020202020202072657475726E';
wwv_flow_api.g_varchar2_table(16) := '6C48607084E78A45BF8E22DBD0D000172F5E04ABD57A9378A3EEA4CFE8A7D761D37D669B16185A63B2053D1B30D80F5362606000BABBBB536D656565548D904DE91A838B5434A7D3991518648C2135460FEA765249EFEB76BBA90AE9DF03C1C2F4BA70E1';
wwv_flow_api.g_varchar2_table(17) := '02A555717131E90EEA1182867B3DB79AE0E9AC355C2ADD0963D0309D868686C0E7F3D135AC386BD6AC813367CE40474747EA3E644A737373D6E7CF640CE33727B3D5F6F9342CA518FCDDDCFEC02A84AB65D4A099623CDB5A09FB46A3519A0AE41C63EEC4';
wwv_flow_api.g_varchar2_table(18) := 'F499F19D8A7F2A958CB2BA16B5493573278FF68838282AFF2089DE99D7E71F7A5915B18387EFC623F70432A69597B226D13BF3289A3A38A280418D41E7711C5278E3C66030788297B495C81C513B77050505B43014090C1F243F07A68503F3F23F020C00';
wwv_flow_api.g_varchar2_table(19) := '1A4E9E31827E0C940000000049454E44AE426082';
null;
end;
/
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(82376197056157753204)
,p_plugin_id=>wwv_flow_api.id(81654967952177094447)
,p_file_name=>'togglecheckbox.png'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(13649719739933237)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(13649719739933237)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13651721301955225)
,p_plug_name=>'Checklist diario'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13645010448933104)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16767928580027190)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(13651721301955225)
,p_button_name=>'VOLVER'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(13648702779933212)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14269626729130081)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(13651721301955225)
,p_button_name=>'GUARDAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(13649003596933217)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13653028019047857)
,p_name=>'P1_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar nivel de aceite, nivel de agua, Hidraulico estado y tension de fajas.'
...
,p_field_template=>wwv_flow_api.id(13648331412933210)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13653509028071882)
,p_name=>'P1_2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Documentos validos y vigentes de la unidad y el conductor'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13730803056790246)
,p_name=>'P1_3'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar Limpia brisas '
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13731507560818600)
,p_name=>'P1_4'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar luces del camion y cisterna'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13731701737821232)
,p_name=>'P1_5'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar reflectivos'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13731928682823995)
,p_name=>'P1_6'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar baterias (todo apretado  y limpio) conexiones aisladas.'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13732122859826698)
,p_name=>'P1_7'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar Master Swich'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13732717887844117)
,p_name=>'P1_8'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>unistr('Revision de llantas (revision de aire y ausencia de cortes, ropturas u otros da\00C3\00B1os)')
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13732911848846915)
,p_name=>'P1_9'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Asegurar que la unidad este full de combustible'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13733106241849543)
,p_name=>'P1_10'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Extintores en buen estado con seguro marchamo y carga adecuada, minimo 2 en cisterna de 20 lbs y 1 en cabina de 5 lbs'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13733300850852071)
,p_name=>'P1_11'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar equipo de seguridad,  conos, cable de tierra, arnes linea de vida'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13733523913856585)
,p_name=>'P1_12'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>unistr('EPP (casco, guantes de nutrillo, lentes claros, zapatos punta de acero, uniforme con reflectivo / camisa al pu\00C3\00B1o)')
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13733719815858484)
,p_name=>'P1_13'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Verificar equipo de descarga, codo visor, mangueras, Uniones, '
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13733914424860935)
,p_name=>'P1_14'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>unistr('Kit antiderrame completo (5 cu\00C3\00B1as, martillo de hule, Jabon, 3 mantas absorvente)')
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13734109464863245)
,p_name=>'P1_15'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Cabina limpia , sin objetos pesados sueltos y objetos no autorizados (galones, cubetas, trozos o equipos de descarga u Otros)'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16525430793057685)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Unidad'
...
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(13648117217933210)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'NONE'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16528219504154057)
,p_name=>'P1_CONDUCTOR'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Conductor'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16528417132155193)
,p_name=>'P1_SUPERVISA'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Supervisa'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16749317401172006)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45313810716207790)
,p_name=>'P1_16'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Kit de primeros auxilios'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(13648202362933210)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'1'
,p_attribute_02=>'VERTICAL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45314011216207795)
,p_name=>'P1_17'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Freno funcionando correctamente, purgar (Sacar) el agua de la camara de aire GRADUE SUS FRENOS CON FRECUENCIA'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45314217235207795)
,p_name=>'P1_18'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revisar codo de escape , reflibe de escape, silenciador y punta de escape '
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45314418178207795)
,p_name=>'P1_19'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Revision y drenado de compartimientos abriendo valvulas de fondo  y salida'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45314615948207795)
,p_name=>'P1_20'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(13651721301955225)
,p_prompt=>'Cinturon de seguridad piloto y copiloto'
,p_display_as=>'NATIVE_CHECKBOX'
,p_lov=>'STATIC:;B'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31316625766411065)
,p_name=>'Checkbox'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31316919325411075)
,p_event_id=>wwv_flow_api.id(31316625766411065)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'PLUGIN_TOGGLE.CHECKBOX'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_UNIDAD,P1_CONDUCTOR,P1_SUPERVISA,P1_DOCUMENTOS,P1_CABINA,P1_REVISAR,P1_KIT,P1_AUXILIOS,P1_FULL,P1_LIMPIABRISAS,P1_EXINTORES,P1_NIVEL,P1_REVISION,P1_FRENOS,P1_VERIFICAREQUIPO,P1_FUGAS,P1_VALVULAS,P1_CODOESCAPE,P1_COMENTARIO'
,p_attribute_01=>'DEFAULT'
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14270311884154209)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Grabapregnta'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'maximo numeric;',
'begin',
'SELECT MAX(NMSUPER)+1 into maximo FROM TCHEKLIST_DET;',
'insert into tsupervision values(maximo,:P1_SUPERVISA,:P1_CONDUCTOR,null,:P1_COMENTARIO,sysdate(),''evaluacion'',''SI'',null,sysdate(),0,null,null,:P1_UNIDAD);',
'insert into TCHEKLIST_DET values (maximo,1,7,decode (:P1_DOCUMENTOS,NULL, ''M'', ''B'') ,null,null);',
'insert into TCHEKLIST_DET values (maximo,2,7,decode (:P1_CABINA, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,3,7,decode (:P1_REVISAR, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,4,7,decode (:P1_KIT, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,5,7,decode (:P1_AUXILIOS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,6,7,decode (:P1_FULL, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,7,7,decode (:P1_LIMPIABRISAS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,8,7,decode (:P1_EXINTORES, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,9,7,decode (:P1_NIVEL, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,10,7,decode (:P1_REVISION, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,11,7,decode (:P1_FRENOS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,12,7,decode (:P1_VERIFICAREQUIPO, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,13,7,decode (:P1_FUGAS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,14,7,decode (:P1_VALVULAS, NULL, ''M'',''B''),null,null);',
'insert into TCHEKLIST_DET values (maximo,15,7,decode (:P1_CODOESCAPE, NULL, ''M'',''B''),null,null);',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(14269626729130081)
,p_process_success_message=>'LISTO, INGRESADO CORRECTAMENTE'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(13631930635933070)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171222101952'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13650200617933260)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13644110256933103)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13650526044933275)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(13650200617933260)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13650312801933268)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(13650200617933260)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13650411183933273)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13650727922933278)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13650616907933275)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13650918937933278)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13650801394933278)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(16750628320257670)
);
end;
/
