...
prompt APPLICATION 295 - LP_Reporte_Mantenimiento
--
-- Application Export:
--   Application:     295
--   Name:            LP_Reporte_Mantenimiento
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,295)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_Reporte_Mantenimiento')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_295')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'78A4116F417868F567FF6A9E927B24B232254B4D947E8AD8543825B3F2738549'
...
,p_authentication_id=>wwv_flow_api.id(10595821803115848)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Reporte Mantenimiento'
...
,p_last_upd_yyyymmddhh24miss=>'20210324122357'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8723918937048493)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8724034814048493)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8724167756048493)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8724384903048495)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8724470744048495)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8724585031048495)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(10285811543886110)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(10594628791006275)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(10303812728886168)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(10305007005886184)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(10305419154886189)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10285902411886117)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286000227886121)
,p_page_template_id=>wwv_flow_api.id(10285902411886117)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10286128552886123)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286211232886123)
,p_page_template_id=>wwv_flow_api.id(10286128552886123)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286326894886123)
,p_page_template_id=>wwv_flow_api.id(10286128552886123)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286423862886125)
,p_page_template_id=>wwv_flow_api.id(10286128552886123)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286507856886125)
,p_page_template_id=>wwv_flow_api.id(10286128552886123)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286632213886125)
,p_page_template_id=>wwv_flow_api.id(10286128552886123)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10286710652886125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286830111886125)
,p_page_template_id=>wwv_flow_api.id(10286710652886125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10286924666886125)
,p_page_template_id=>wwv_flow_api.id(10286710652886125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287020355886125)
,p_page_template_id=>wwv_flow_api.id(10286710652886125)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287111071886125)
,p_page_template_id=>wwv_flow_api.id(10286710652886125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287225548886125)
,p_page_template_id=>wwv_flow_api.id(10286710652886125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287303839886125)
,p_page_template_id=>wwv_flow_api.id(10286710652886125)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10287432283886125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287520284886125)
,p_page_template_id=>wwv_flow_api.id(10287432283886125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287604285886125)
,p_page_template_id=>wwv_flow_api.id(10287432283886125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287725650886125)
,p_page_template_id=>wwv_flow_api.id(10287432283886125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10287800350886125)
,p_page_template_id=>wwv_flow_api.id(10287432283886125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10287919910886125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288000844886125)
,p_page_template_id=>wwv_flow_api.id(10287919910886125)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288125505886125)
,p_page_template_id=>wwv_flow_api.id(10287919910886125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288222979886125)
,p_page_template_id=>wwv_flow_api.id(10287919910886125)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288327938886125)
,p_page_template_id=>wwv_flow_api.id(10287919910886125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288420731886125)
,p_page_template_id=>wwv_flow_api.id(10287919910886125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10288523886886125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288620203886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288722018886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288807427886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10288925359886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289002632886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289100283886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289220889886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289319780886125)
,p_page_template_id=>wwv_flow_api.id(10288523886886125)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10289423048886125)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289531240886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289632643886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289710969886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289810312886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10289929539886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290004060886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290114460886125)
,p_page_template_id=>wwv_flow_api.id(10289423048886125)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10290229303886126)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290326657886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290413347886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290515135886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290619719886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290717966886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290816523886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10290922960886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291016219886126)
,p_page_template_id=>wwv_flow_api.id(10290229303886126)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10291124138886126)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291223678886128)
,p_page_template_id=>wwv_flow_api.id(10291124138886126)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291321015886128)
,p_page_template_id=>wwv_flow_api.id(10291124138886126)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291401005886128)
,p_page_template_id=>wwv_flow_api.id(10291124138886126)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291505412886128)
,p_page_template_id=>wwv_flow_api.id(10291124138886126)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291613683886128)
,p_page_template_id=>wwv_flow_api.id(10291124138886126)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291709585886128)
,p_page_template_id=>wwv_flow_api.id(10291124138886126)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10291830911886128)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10291904533886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292008178886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292106028886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292219461886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292325822886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292421220886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292507587886128)
,p_page_template_id=>wwv_flow_api.id(10291830911886128)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10292612561886128)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292726181886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292810528886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10292906234886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293010622886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293117005886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293205427886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293329949886128)
,p_page_template_id=>wwv_flow_api.id(10292612561886128)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10293411937886128)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293530228886128)
,p_page_template_id=>wwv_flow_api.id(10293411937886128)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10293613168886128)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293704597886129)
,p_page_template_id=>wwv_flow_api.id(10293613168886128)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293818220886129)
,p_page_template_id=>wwv_flow_api.id(10293613168886128)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10293913009886129)
,p_page_template_id=>wwv_flow_api.id(10293613168886128)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294009785886129)
,p_page_template_id=>wwv_flow_api.id(10293613168886128)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10294100652886129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294221796886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294326862886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294410380886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294503554886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294610246886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294729316886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10294800721886129)
,p_page_template_id=>wwv_flow_api.id(10294100652886129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10294901327886129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295007989886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295107125886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295219938886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295319771886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295426792886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295501263886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295612379886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295714106886129)
,p_page_template_id=>wwv_flow_api.id(10294901327886129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10295810193886129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10295906270886129)
,p_page_template_id=>wwv_flow_api.id(10295810193886129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296000549886129)
,p_page_template_id=>wwv_flow_api.id(10295810193886129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296101069886129)
,p_page_template_id=>wwv_flow_api.id(10295810193886129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296204304886129)
,p_page_template_id=>wwv_flow_api.id(10295810193886129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296305105886129)
,p_page_template_id=>wwv_flow_api.id(10295810193886129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296400574886129)
,p_page_template_id=>wwv_flow_api.id(10295810193886129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10296512630886129)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296617369886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296723760886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296802762886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10296925979886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10297029922886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10297108029886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(10297228511886129)
,p_page_template_id=>wwv_flow_api.id(10296512630886129)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10302730535886154)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10302806602886156)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10302915216886156)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10303027859886157)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10303122405886157)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(10303214855886159)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297307998886131)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297411154886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297529290886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297629069886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297732250886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297810086886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10297931866886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298030637886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298116897886139)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10298213349886139)
,p_plug_template_id=>wwv_flow_api.id(10298116897886139)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298322043886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298429164886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298524597886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298631367886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10298709603886140)
,p_plug_template_id=>wwv_flow_api.id(10298631367886140)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298806551886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10298917444886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10299006433886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10299112138886140)
,p_plug_template_id=>wwv_flow_api.id(10299006433886140)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(10299230377886140)
,p_plug_template_id=>wwv_flow_api.id(10299006433886140)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10299308008886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(10299404500886140)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10300603963886146)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10300713172886148)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10300801434886148)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10300907511886148)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301001893886148)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301107742886148)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301222176886148)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301330047886148)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301403432886148)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301522078886148)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301606952886148)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301716401886150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301816380886150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(10301932468886150)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10299522823886142)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10299622418886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10299723807886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10299822007886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10299922542886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10300010058886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10300107079886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10300200641886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10300302568886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10300419862886145)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(10300517469886145)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302016944886150)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302117208886153)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302217370886153)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302332193886153)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302414021886153)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302511941886153)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(10302600804886154)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(10303311890886159)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(10303525868886164)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(10303416481886162)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(10303630326886167)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(10291124138886126)
,p_error_template=>wwv_flow_api.id(10287432283886125)
,p_printer_friendly_template=>wwv_flow_api.id(10293613168886128)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(10285902411886117)
,p_default_button_template=>wwv_flow_api.id(10302730535886154)
,p_default_region_template=>wwv_flow_api.id(10299006433886140)
,p_default_chart_template=>wwv_flow_api.id(10299006433886140)
,p_default_form_template=>wwv_flow_api.id(10298116897886139)
,p_default_reportr_template=>wwv_flow_api.id(10299006433886140)
,p_default_tabform_template=>wwv_flow_api.id(10299006433886140)
,p_default_wizard_template=>wwv_flow_api.id(10298116897886139)
,p_default_menur_template=>wwv_flow_api.id(10297629069886139)
,p_default_listr_template=>wwv_flow_api.id(10299006433886140)
,p_default_irr_template=>wwv_flow_api.id(10298524597886140)
,p_default_report_template=>wwv_flow_api.id(10300107079886145)
,p_default_label_template=>wwv_flow_api.id(10302217370886153)
,p_default_menu_template=>wwv_flow_api.id(10303311890886159)
,p_default_calendar_template=>wwv_flow_api.id(10303416481886162)
,p_default_list_template=>wwv_flow_api.id(10301716401886150)
,p_default_option_label=>wwv_flow_api.id(10302217370886153)
,p_default_required_label=>wwv_flow_api.id(10302511941886153)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10303906342886170)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(10595821803115848)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(10303723043886167)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(10303723043886167)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
'.apexir_BUTTONS{margin:0;position:static;float:none;border:1px solid #AAA;border-top:none;padding:0 8px 8px 8px;background-color:#EAEAEA;-webkit-box-shadow:0 1px 1px rgba(0,0,0,0.15);-moz-box-shadow:0 1px 1px rgba(0,0,0,0.15);box-shadow:0 1px 1px rgb'
||'a(0,0,0,0.15);-webkit-border-radius:0 0 3px 3px;-moz-border-radius:0 0 3px 3px;border-radius:0 0 3px 3px}',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10319617113919310)
,p_plug_name=>'MANTENIMIENTO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10298524597886140)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select a.nmorden, a.fecrea, a.cdclase||''-''||a.correlativo unidad, decode(a.cod_falla,44,''SERVICIO MENOR'',43,''SERVICIO MEDIO'',53,''SERVICIO MAYOR'',',
'54,''SERVICIO SUPER MAYOR'',55,''SERVICIO COMPLEMENTO'') Mantenimiento,a.CDASIGNADO, b.nombre_pila ||'' ''||b.primer_apellido NOMBRE,',
'(select sum (recorrido) from tvales where cdclasact||''-''||corract=:P1_UNIDAD and fecha<=a.fecrea   group by cdclasact, corract) as KMS',
'From tordenserv a left join empleado b on a.cdasignado=b.empleado',
'where fecrea between :P1_FECHA_INICIAL and :P1_FECHA_FINAL',
'and cod_falla in(44,43,54,53,55)',
'and cdclase||''-''||correlativo =:P1_UNIDAD and tipo_ot=''MP'' and ESTADO=''C'''))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P1_FECHA_INICIAL,P1_FECHA_FINAL,P1_UNIDAD'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(10319713497919310)
...
,p_owner=>'LP'
,p_internal_uid=>10319713497919310
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10319900381919370)
,p_db_column_name=>'NMORDEN'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Orden'
,p_column_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.::P2_OT,P2_FECHA,P2_UNIDAD,P2_KM,P2_mecanico:#NMORDEN#,#FECREA#,#UNIDAD#,#KMS#,#NOMBRE#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10320019575919378)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10320113387919378)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10320228373919378)
,p_db_column_name=>'MANTENIMIENTO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Mantenimiento'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'MANTENIMIENTO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10603827877599228)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10604406250685185)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31137814607701371)
,p_db_column_name=>'KMS'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(10320311010927004)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'103204'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>1000
,p_report_columns=>'NMORDEN:FECREA:UNIDAD:MANTENIMIENTO:CDASIGNADO:NOMBRE:KMS:'
,p_sort_column_1=>'FECREA'
,p_sort_direction_1=>'DESC'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10320731442932943)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10299006433886140)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(21310404858794811)
,p_name=>'PROGRAMACION SERVICIOS'
,p_template=>wwv_flow_api.id(10299006433886140)
...
'Select * from (',
'select cdclasac||''-''||corract unidad , kmactual, ''KM ACTUAL'' as Descripcion  from trecorre',
'union all',
'select cdclasac||''-''||corract unidad , kmproxserv, ''KM PROXSERVICIO'' as Descripcion  from trecorre  ',
'union all ',
'select cdclasac||''-''||corract unidad , kmsvmed, ''SERVICIO MEDIO'' as Descripcion  from trecorre',
'union all ',
'select cdclasac||''-''||corract unidad , kmsvma, ''SERVICIO MAYOR'' as Descripcion  from trecorre',
'union all ',
'select cdclasac||''-''||corract unidad , kmsvsma, ''SERVICIO SUPER MAYOR'' as Descripcion  from trecorre',
'union all ',
'select  cdclase||''-''|| correlativo,kms_servicio , ''SERVICIOS'' from tactivos where  cdclase||''-''||correlativo=:P1_UNIDAD  group by cdclase, correlativo, kms_servicio',
') where unidad=:p1_unidad'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_UNIDAD'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(10300107079886145)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31167327853378943)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31168604993389562)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31151906407992864)
,p_query_column_id=>3
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(65611417649903828)
,p_name=>'RECORRIDO ENTRE SERVICIOS MEDIOS'
,p_template=>wwv_flow_api.id(10299006433886140)
...
'a.kms,',
'a.recorrido from(',
'select r.fecrea as fecha1, ',
'r.kms,',
'r.kms-r2.kms as recorrido,',
'r.fecrea-r2.fecrea as dif',
'from (       ',
'select  fecrea, (select sum (recorrido) from tvales where cdclasact||''-''||corract=:P1_UNIDAD and fecha<=fecrea   ',
'group by cdclasact, corract) as KMS from tordenserv',
'where fecrea between :P1_FECHA_INICIAL and :P1_FECHA_FINAL',
'and cod_falla in(43,53)and cdclase||''-''||correlativo=:P1_UNIDAD ',
'and cdclase||''-''||correlativo =:P1_UNIDAD and tipo_ot=''MP'' and ESTADO=''C''',
'order by fecrea asc)  r left join ',
'(         ',
'select  fecrea, (select sum (recorrido) from tvales where cdclasact||''-''||corract=:P1_UNIDAD and fecha<=fecrea   ',
'group by cdclasact, corract) as KMS from tordenserv',
'where fecrea between :P1_FECHA_INICIAL and :P1_FECHA_FINAL',
'and cod_falla in(43,53)and cdclase||''-''||correlativo=:P1_UNIDAD ',
'and cdclase||''-''||correlativo =:P1_UNIDAD and tipo_ot=''MP'' and ESTADO=''C''',
'order by fecrea asc)  r2 on r.fecrea>r2.fecrea) a',
'inner join ',
'( select r.fecrea , min(r.fecrea-r2.fecrea) as mindif from (       ',
'select  fecrea, (select sum (recorrido) from tvales where cdclasact||''-''||corract=:P1_UNIDAD and fecha<=fecrea   ',
'group by cdclasact, corract) as KMS from tordenserv',
'where fecrea between :P1_FECHA_INICIAL and :P1_FECHA_FINAL',
'and cod_falla in(43,53)and cdclase||''-''||correlativo=:P1_UNIDAD ',
...
'and cod_falla in(43,53)and cdclase||''-''||correlativo=:P1_UNIDAD ',
'and cdclase||''-''||correlativo =:P1_UNIDAD and tipo_ot=''MP'' and ESTADO=''C''',
'order by fecrea asc)  r2 on r.fecrea>r2.fecrea group by r.fecrea) b',
'on a.fecha1= b.fecrea',
'and a.dif=b.mindif'))
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_FECHA_FINAL,P1_UNIDAD,P1_FECHA_INICIAL'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(10300107079886145)
,p_query_num_rows=>15
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(65611720973903932)
,p_query_column_id=>1
,p_column_alias=>'FECHA1'
,p_column_display_sequence=>1
,p_column_heading=>'FECHA1'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(65611817076903942)
,p_query_column_id=>2
,p_column_alias=>'KMS'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(65611919499903942)
,p_query_column_id=>3
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(10321320622948795)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(10320731442932943)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(10302730535886154)
,p_button_image_alt=>'Generar'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10308906439524784)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(10320731442932943)
,p_prompt=>'Unidad'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select distinct(cdclase||''-''||correlativo) codigo , (cdclase||''-''||correlativo) unidad from tordenserv '
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_cAttributes=>'nowrap'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(10302217370886153)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10309130313524820)
,p_name=>'P1_FECHA_INICIAL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(10320731442932943)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10309307178524820)
,p_name=>'P1_FECHA_FINAL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(10320731442932943)
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(10303723043886167)
,p_name=>'Detalle Checklist'
,p_step_title=>'Detalle Checklist'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190216143126'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10323004196133257)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10297629069886139)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10325107462295006)
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select a.nmsuper,d.cdclase ||''-''||d.correlativo unidad,b.item,b.evaluacion, c.descripcion,b.cumple,b.ot_relacionada,a.cdresponsable,a.ot from tsupervision a inner join tcheklist_det b on a.nmsuper=b.nmsuper',
'inner join tcat_supervision c on b.evaluacion =c.nmexamen and b.item =c.item inner join ',
'tordenserv d on a.ot=d.nmorden and A.CDESTACION=D.CDDELEGACION   where smant=1 and a.ot=:P2_OT',
'',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P2_OT'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(10325222461295006)
,p_name=>'CHECKLIST'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>10325222461295006
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10325428730295009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10325500490295009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10325632311295009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10325706848295009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10325919151295009)
,p_db_column_name=>'OT_RELACIONADA'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Ot Relacionada'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'OT_RELACIONADA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10558125520807759)
,p_db_column_name=>'CDRESPONSABLE'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cdresponsable'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CDRESPONSABLE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10558912094807764)
,p_db_column_name=>'OT'
,p_display_order=>15
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10590100848639378)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(10591029913686668)
,p_db_column_name=>'UNIDAD'
,p_display_order=>17
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(10326108286304796)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'103262'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'NMSUPER:ITEM:DESCRIPCION:CUMPLE:OT:UNIDAD:OT_RELACIONADA:'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(10591626775788185)
,p_report_id=>wwv_flow_api.id(10326108286304796)
,p_name=>'marcar'
...
,p_operator=>'contains'
,p_expr=>'.'
,p_condition_sql=>' (case when (upper("ITEM") like ''%''||upper(#APXWS_EXPR#)||''%'') then #APXWS_HL_ID# end) '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(48776829179987067)
,p_plug_name=>'Unidad'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10299006433886140)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(10593328572968504)
,p_button_sequence=>2
,p_button_plug_id=>wwv_flow_api.id(10325107462295006)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10323305129135920)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(48776829179987067)
,p_prompt=>'Nmorden'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10324615585267804)
,p_name=>'P2_OT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(48776829179987067)
,p_prompt=>'OT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(48778131237005150)
,p_name=>'P2_FECHA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(48776829179987067)
,p_prompt=>'Fecha'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(48778322589005154)
,p_name=>'P2_UNIDAD'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(48776829179987067)
,p_prompt=>'Unidad'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(48778516086005154)
,p_name=>'P2_KM'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(48776829179987067)
,p_prompt=>'Km'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(48779311156044868)
,p_name=>'P2_MECANICO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(48776829179987067)
,p_prompt=>'Mecanico'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(10324730749282876)
,p_name=>'AsignarNMORDEN'
,p_event_sequence=>10
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(10325023108282884)
,p_event_id=>wwv_flow_api.id(10324730749282876)
,p_event_result=>'TRUE'
...
,p_attribute_03=>'select nmsuper from tsupervision where ot=:P2_OT'
,p_attribute_07=>'P2_OT'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
...
,p_step_template=>wwv_flow_api.id(10285902411886117)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171005170927'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10304229019886175)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(10298116897886139)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(10304503265886181)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(10304229019886175)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10304314089886178)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(10304229019886175)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(10304426178886181)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10304726103886184)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10304625812886181)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10304928969886184)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(10304807341886184)
,p_process_sequence=>10
