...
prompt APPLICATION 318 - J_reporte llantas
--
-- Application Export:
--   Application:     318
--   Name:            J_reporte llantas
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_reporte llantas')
...
,p_authentication_id=>wwv_flow_api.id(41566652845552969)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20210322135908'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8755538752055744)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8755688861055744)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8755756093055744)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8755971080055746)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8756024344055746)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8756183746055746)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(41256642586323231)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(41565459833443396)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(41274643771323289)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(41275838048323305)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(41276250197323310)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41256733454323238)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41256831270323242)
,p_page_template_id=>wwv_flow_api.id(41256733454323238)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41256959595323244)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257042275323244)
,p_page_template_id=>wwv_flow_api.id(41256959595323244)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257157937323244)
,p_page_template_id=>wwv_flow_api.id(41256959595323244)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257254905323246)
,p_page_template_id=>wwv_flow_api.id(41256959595323244)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257338899323246)
,p_page_template_id=>wwv_flow_api.id(41256959595323244)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257463256323246)
,p_page_template_id=>wwv_flow_api.id(41256959595323244)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41257541695323246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257661154323246)
,p_page_template_id=>wwv_flow_api.id(41257541695323246)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257755709323246)
,p_page_template_id=>wwv_flow_api.id(41257541695323246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257851398323246)
,p_page_template_id=>wwv_flow_api.id(41257541695323246)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41257942114323246)
,p_page_template_id=>wwv_flow_api.id(41257541695323246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258056591323246)
,p_page_template_id=>wwv_flow_api.id(41257541695323246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258134882323246)
,p_page_template_id=>wwv_flow_api.id(41257541695323246)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41258263326323246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258351327323246)
,p_page_template_id=>wwv_flow_api.id(41258263326323246)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258435328323246)
,p_page_template_id=>wwv_flow_api.id(41258263326323246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258556693323246)
,p_page_template_id=>wwv_flow_api.id(41258263326323246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258631393323246)
,p_page_template_id=>wwv_flow_api.id(41258263326323246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41258750953323246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258831887323246)
,p_page_template_id=>wwv_flow_api.id(41258750953323246)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41258956548323246)
,p_page_template_id=>wwv_flow_api.id(41258750953323246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259054022323246)
,p_page_template_id=>wwv_flow_api.id(41258750953323246)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259158981323246)
,p_page_template_id=>wwv_flow_api.id(41258750953323246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259251774323246)
,p_page_template_id=>wwv_flow_api.id(41258750953323246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41259354929323246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259451246323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259553061323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259638470323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259756402323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259833675323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41259931326323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260051932323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260150823323246)
,p_page_template_id=>wwv_flow_api.id(41259354929323246)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41260254091323246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260362283323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260463686323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260542012323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260641355323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260760582323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260835103323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41260945503323246)
,p_page_template_id=>wwv_flow_api.id(41260254091323246)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41261060346323247)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261157700323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261244390323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261346178323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261450762323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261549009323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261647566323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261754003323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41261847262323247)
,p_page_template_id=>wwv_flow_api.id(41261060346323247)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(41261955181323247)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41262054721323249)
,p_page_template_id=>wwv_flow_api.id(41261955181323247)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41262152058323249)
,p_page_template_id=>wwv_flow_api.id(41261955181323247)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41262232048323249)
,p_page_template_id=>wwv_flow_api.id(41261955181323247)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41262336455323249)
,p_page_template_id=>wwv_flow_api.id(41261955181323247)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41262444726323249)
,p_page_template_id=>wwv_flow_api.id(41261955181323247)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(41

...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(41274247524323283)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(41274461369323288)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(41261955181323247)
,p_error_template=>wwv_flow_api.id(41258263326323246)
,p_printer_friendly_template=>wwv_flow_api.id(41264444211323249)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(41256733454323238)
,p_default_button_template=>wwv_flow_api.id(41273561578323275)
,p_default_region_template=>wwv_flow_api.id(41269837476323261)
,p_default_chart_template=>wwv_flow_api.id(41269837476323261)
,p_default_form_template=>wwv_flow_api.id(41268947940323260)
,p_default_reportr_template=>wwv_flow_api.id(41269837476323261)
,p_default_tabform_template=>wwv_flow_api.id(41269837476323261)
,p_default_wizard_template=>wwv_flow_api.id(41268947940323260)
,p_default_menur_template=>wwv_flow_api.id(41268460112323260)
,p_default_listr_template=>wwv_flow_api.id(41269837476323261)
,p_default_irr_template=>wwv_flow_api.id(41269355640323261)
,p_default_report_template=>wwv_flow_api.id(41270938122323266)
,p_default_label_template=>wwv_flow_api.id(41273048413323274)
,p_default_menu_template=>wwv_flow_api.id(41274142933323280)
,p_default_calendar_template=>wwv_flow_api.id(41274247524323283)
,p_default_list_template=>wwv_flow_api.id(41272547444323271)
,p_default_option_label=>wwv_flow_api.id(41273048413323274)
,p_default_required_label=>wwv_flow_api.id(41273342984323274)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(41274737385323291)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(41566652845552969)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(41274554086323288)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(41274554086323288)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20180306110609'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30989733959993821)
,p_plug_name=>'Suma'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(41269355640323261)
,p_plug_display_sequence=>35
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Select n.correlativo,n.cdmedida,b.dsbodega as ubicacion,n.Cdmedida ||''-''|| n.Correlativo as llanta,n.estado,m.dsmedida,d.dsdiseno,a.dsmarca,n.nueva as n,n.reencauche1 as r1,n.reencauche2 as r2,n.reencauche3 as r3,',
'round(n.recorrido,2) as recorrido,n.fechaalta,n.fechabaja,n.seriefac,n.cddelegacion,n.precio',
...
'n.recorrido <> 0 and n.precio <> 0 and n.fechabaja >= :P1_FECHA_INICIAL and n.fechabaja <= :P1_FECHA_FINAL'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(30989841798993821)
,p_name=>'Suma'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30990332677993827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16607022882425659)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16607131785425659)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16608231446425662)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16608311175425662)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16608532305425662)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21213409947505334)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21213520096505334)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21213605703505334)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21213700214505334)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21213820138505334)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21213903651505334)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21214022164505334)
,p_db_column_name=>'N'
,p_display_order=>27
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21214101756505336)
,p_db_column_name=>'R1'
,p_display_order=>28
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21214208192505336)
,p_db_column_name=>'R2'
,p_display_order=>29
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21214324099505336)
,p_db_column_name=>'R3'
,p_display_order=>30
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21214419314505336)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(21214519086505336)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(30990434652994053)
...
,p_is_default=>'Y'
,p_display_rows=>1000
,p_report_columns=>'UBICACION:CORRELATIVO:CDMEDIDA:RECORRIDO:PRECIO:FECHAALTA:FECHABAJA:LLANTA:DSMEDIDA:DSDISENO:DSMARCA:N:R1:R2:R3:SERIEFAC:CDDELEGACION::APXWS_CC_001'
,p_sort_column_1=>'FECHABAJA'
,p_sort_direction_1=>'ASC'
,p_sum_columns_on_break=>'RECORRIDO:PRECIO'
);
wwv_flow_api.create_worksheet_computation(
 p_id=>wwv_flow_api.id(63572129638118040)
,p_report_id=>wwv_flow_api.id(30990434652994053)
,p_db_column_name=>'APXWS_CC_001'
,p_column_identifier=>'C01'
,p_computation_expr=>' Q /D'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41291562485370064)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(41269837476323261)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41292151665385916)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(41291562485370064)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(41273561578323275)
,p_button_image_alt=>'Generar'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41279961355961941)
,p_name=>'P1_FECHA_INICIAL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(41291562485370064)
...
,p_field_template=>wwv_flow_api.id(41273048413323274)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41280138220961941)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41293835238570378)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(41268460112323260)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41295938504732127)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(41296053503732127)
,p_name=>'CHECKLIST'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41296259772732130)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41296331532732130)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41296463353732130)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41296537890732130)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41296750193732130)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41528956563244880)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41529743137244885)
,p_db_column_name=>'OT'
,p_display_order=>15
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41560931891076499)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41561860956123789)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(41296939328741917)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(41562457818225306)
,p_report_id=>wwv_flow_api.id(41296939328741917)
,p_name=>'marcar'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41564159615405625)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(41295938504732127)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41294136171573041)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(41293835238570378)
,p_prompt=>'Nmorden'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41295446627704925)
,p_name=>'P2_OT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(41293835238570378)
,p_prompt=>'OT'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(41295561791719997)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(41295854150720005)
,p_event_id=>wwv_flow_api.id(41295561791719997)
,p_event_result=>'TRUE'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180306120330'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16621519443552340)
,p_plug_name=>'Detalle'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(41269837476323261)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16623802053641959)
,p_plug_name=>'Montajes'
,p_parent_plug_id=>wwv_flow_api.id(16621519443552340)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(41269355640323261)
,p_plug_display_sequence=>20
...
'cdbodega,',
'posicion,',
'profund_montaje as PM,',
'profund_desmontaje as PD,',
'tipomovimiento as movimiento,',
'km_desmontaje as recorrido',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(16623921246641959)
,p_name=>'Montajes'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16624108450641975)
,p_db_column_name=>'CORRELATIVO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Correlativo'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16624205641641976)
,p_db_column_name=>'CDMEDIDA'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Cdmedida'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16625721209687590)
,p_db_column_name=>'N'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16625801333687590)
,p_db_column_name=>'R1'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'R1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16625919793687592)
,p_db_column_name=>'R2'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'R2'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16626006752687592)
,p_db_column_name=>'R3'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'R3'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16647027579337970)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16647132413337970)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16647207389337971)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16648327782353110)
,p_db_column_name=>'PM'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16648432646353110)
,p_db_column_name=>'PD'
,p_display_order=>11
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16648521061353110)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17433427185682481)
,p_db_column_name=>'RECORRIDO'
,p_display_order=>13
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(16624703092642278)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CORRELATIVO:CDMEDIDA:N:R1:R2:R3:MOVIMIENTO:FECHAMONTAJE:CDBODEGA:PD:POSICION:PM:RECORRIDO:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(21224716280853814)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(16621519443552340)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16621814851553739)
,p_name=>'P3_CORRELATIVO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16621519443552340)
...
,p_step_template=>wwv_flow_api.id(41256733454323238)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(41275060062323296)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(41268947940323260)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41275334308323302)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(41275060062323296)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41275145132323299)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(41275060062323296)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41275257221323302)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(41275557146323305)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(41275456855323302)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(41275760012323305)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(41275638384323305)
,p_process_sequence=>10
