...
prompt APPLICATION 301 - J_Servicios SUR
--
-- Application Export:
--   Application:     301
--   Name:            J_Servicios SUR
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,301)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_Servicios SUR')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_301')
...
,p_authentication_id=>wwv_flow_api.id(13600217851762117)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20180615154424'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8732251548050857)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8732398736050857)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8732490072050857)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8732639339050857)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8732700840050858)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8732810665050858)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13517908076405509)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(13600702970768967)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(13535913497405650)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(13537126288405682)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(13537532601405700)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13518002124405520)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518131481405537)
,p_page_template_id=>wwv_flow_api.id(13518002124405520)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13518215784405542)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518325472405542)
,p_page_template_id=>wwv_flow_api.id(13518215784405542)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518420901405542)
,p_page_template_id=>wwv_flow_api.id(13518215784405542)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518518201405542)
,p_page_template_id=>wwv_flow_api.id(13518215784405542)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518610478405542)
,p_page_template_id=>wwv_flow_api.id(13518215784405542)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518716563405542)
,p_page_template_id=>wwv_flow_api.id(13518215784405542)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13518814882405542)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13518925593405542)
,p_page_template_id=>wwv_flow_api.id(13518814882405542)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519002957405542)
,p_page_template_id=>wwv_flow_api.id(13518814882405542)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519117273405542)
,p_page_template_id=>wwv_flow_api.id(13518814882405542)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519207211405542)
,p_page_template_id=>wwv_flow_api.id(13518814882405542)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519331035405542)
,p_page_template_id=>wwv_flow_api.id(13518814882405542)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519429913405542)
,p_page_template_id=>wwv_flow_api.id(13518814882405542)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13519524878405542)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519632510405542)
,p_page_template_id=>wwv_flow_api.id(13519524878405542)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519708688405542)
,p_page_template_id=>wwv_flow_api.id(13519524878405542)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519823579405542)
,p_page_template_id=>wwv_flow_api.id(13519524878405542)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13519925561405542)
,p_page_template_id=>wwv_flow_api.id(13519524878405542)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13520026105405542)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520132601405543)
,p_page_template_id=>wwv_flow_api.id(13520026105405542)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520218808405543)
,p_page_template_id=>wwv_flow_api.id(13520026105405542)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520319202405543)
,p_page_template_id=>wwv_flow_api.id(13520026105405542)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520426149405543)
,p_page_template_id=>wwv_flow_api.id(13520026105405542)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520522237405543)
,p_page_template_id=>wwv_flow_api.id(13520026105405542)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13520621281405543)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520707633405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520811780405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13520922346405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521015037405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521127240405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521227549405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521324912405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521414099405543)
,p_page_template_id=>wwv_flow_api.id(13520621281405543)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13521528290405543)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521615557405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521728475405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521813820405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13521909548405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522005551405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522130705405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522208840405545)
,p_page_template_id=>wwv_flow_api.id(13521528290405543)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13522313956405545)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522418871405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522526923405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522631600405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522700720405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522808811405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13522905368405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523017852405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523118785405545)
,p_page_template_id=>wwv_flow_api.id(13522313956405545)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13523212506405545)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523311887405545)
,p_page_template_id=>wwv_flow_api.id(13523212506405545)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523410165405545)
,p_page_template_id=>wwv_flow_api.id(13523212506405545)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523508904405545)
,p_page_template_id=>wwv_flow_api.id(13523212506405545)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523617698405545)
,p_page_template_id=>wwv_flow_api.id(13523212506405545)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523712724405545)
,p_page_template_id=>wwv_flow_api.id(13523212506405545)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13523814349405545)
,p_page_template_id=>wwv_flow_api.id(13523212506405545)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13523919736405545)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524014388405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524121294405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524219789405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524301341405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524429675405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524520998405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524622912405546)
,p_page_template_id=>wwv_flow_api.id(13523919736405545)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13524727036405554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524825933405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13524918915405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525007710405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525108685405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525217696405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525324549405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525417467405554)
,p_page_template_id=>wwv_flow_api.id(13524727036405554)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13525518517405554)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525625265405554)
,p_page_template_id=>wwv_flow_api.id(13525518517405554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13525726336405554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525809457405554)
,p_page_template_id=>wwv_flow_api.id(13525726336405554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13525920423405554)
,p_page_template_id=>wwv_flow_api.id(13525726336405554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526023776405554)
,p_page_template_id=>wwv_flow_api.id(13525726336405554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526122234405554)
,p_page_template_id=>wwv_flow_api.id(13525726336405554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13526219978405554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526325500405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526430064405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526513255405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526603826405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526731857405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526827277405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13526916259405554)
,p_page_template_id=>wwv_flow_api.id(13526219978405554)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13527006621405554)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527109793405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527200671405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527304881405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527401332405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527513252405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527613902405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527731506405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13527814662405554)
,p_page_template_id=>wwv_flow_api.id(13527006621405554)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13527923303405556)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528009430405556)
,p_page_template_id=>wwv_flow_api.id(13527923303405556)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528113193405556)
,p_page_template_id=>wwv_flow_api.id(13527923303405556)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528205676405556)
,p_page_template_id=>wwv_flow_api.id(13527923303405556)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528330540405556)
,p_page_template_id=>wwv_flow_api.id(13527923303405556)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528416013405556)
,p_page_template_id=>wwv_flow_api.id(13527923303405556)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528524270405556)
,p_page_template_id=>wwv_flow_api.id(13527923303405556)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(13528624061405556)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528727684405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528820913405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13528921456405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13529012083405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13529126059405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13529225975405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(13529308079405556)
,p_page_template_id=>wwv_flow_api.id(13528624061405556)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13534815288405604)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13534904446405610)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13535025357405610)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13535131391405610)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13535228710405610)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(13535309539405610)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13529407005405562)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13529529380405578)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13529603922405578)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13529721976405578)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13529809735405578)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13529912982405578)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530011905405578)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530103395405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530214311405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13530305765405579)
,p_plug_template_id=>wwv_flow_api.id(13530214311405579)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530414812405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530508811405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530621065405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530728084405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13530803039405579)
,p_plug_template_id=>wwv_flow_api.id(13530728084405579)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13530907790405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13531003772405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13531115610405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13531222775405579)
,p_plug_template_id=>wwv_flow_api.id(13531115610405579)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(13531323716405579)
,p_plug_template_id=>wwv_flow_api.id(13531115610405579)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13531414078405579)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(13531506691405581)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13532711024405587)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13532824089405595)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13532912060405595)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533030668405595)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533121581405595)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533211540405595)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533315341405595)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533430084405595)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533532539405595)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533603715405596)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533724758405596)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533802148405596)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13533924261405596)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(13534004534405596)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13531615373405581)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13531719363405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13531800294405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13531902346405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532001361405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532125971405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532215376405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532305781405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532414152405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532515118405585)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(13532630734405585)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534104624405598)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534213884405601)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534332174405601)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534425417405601)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534518862405601)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534632108405601)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(13534713098405601)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(13535420831405614)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(13535604458405623)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(13535526588405620)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(13535702385405635)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(13523212506405545)
,p_error_template=>wwv_flow_api.id(13519524878405542)
,p_printer_friendly_template=>wwv_flow_api.id(13525726336405554)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(13518002124405520)
,p_default_button_template=>wwv_flow_api.id(13534815288405604)
,p_default_region_template=>wwv_flow_api.id(13531115610405579)
,p_default_chart_template=>wwv_flow_api.id(13531115610405579)
,p_default_form_template=>wwv_flow_api.id(13530214311405579)
,p_default_reportr_template=>wwv_flow_api.id(13531115610405579)
,p_default_tabform_template=>wwv_flow_api.id(13531115610405579)
,p_default_wizard_template=>wwv_flow_api.id(13530214311405579)
,p_default_menur_template=>wwv_flow_api.id(13529721976405578)
,p_default_listr_template=>wwv_flow_api.id(13531115610405579)
,p_default_irr_template=>wwv_flow_api.id(13530621065405579)
,p_default_report_template=>wwv_flow_api.id(13532215376405585)
,p_default_label_template=>wwv_flow_api.id(13534332174405601)
,p_default_menu_template=>wwv_flow_api.id(13535420831405614)
,p_default_calendar_template=>wwv_flow_api.id(13535526588405620)
,p_default_list_template=>wwv_flow_api.id(13533802148405596)
,p_default_option_label=>wwv_flow_api.id(13534332174405601)
,p_default_required_label=>wwv_flow_api.id(13534632108405601)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(13536017756405653)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(13600217851762117)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(13535821107405637)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(13535821107405637)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180514165806'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13540301877413598)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13530621065405579)
...
'when r.kmsvmed-r.kmactual<=500 then r.kmsvmed',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(13540509275413600)
,p_name=>'Report 1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(13541120936413625)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(13601507881827464)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(13601602113827464)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17700117746339906)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17700205178339910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17700313749339910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17700425348339910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17700501766339910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17700606379339910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(24991602909039062)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(13541525353414560)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(25164920718683643)
,p_report_id=>wwv_flow_api.id(13541525353414560)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(25164825739683643)
,p_report_id=>wwv_flow_api.id(13541525353414560)
...
wwv_flow_api.create_worksheet_computation(
 p_id=>wwv_flow_api.id(25165021502683643)
,p_report_id=>wwv_flow_api.id(13541525353414560)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180418115618'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13538229984413473)
,p_plug_name=>'Form on TRECORRE'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13530214311405579)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13538611219413476)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(13538229984413473)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(13534815288405604)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13562320596220543)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(13538809324413481)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13539000471413550)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(13538229984413473)
...
,p_field_template=>wwv_flow_api.id(13534332174405601)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13539207531413560)
,p_name=>'P2_CDCLASAC'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(13538229984413473)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13539412942413568)
,p_name=>'P2_CORRACT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(13538229984413473)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13561104618143359)
,p_name=>'P2_FECHACREA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(13538229984413473)
,p_prompt=>unistr('Fecha de Creaci\00C3\00B3n')
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13571501481555051)
,p_name=>'P2_DESCRIPCION'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(13538229984413473)
,p_prompt=>unistr('Descripci\00C3\00B3n')
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23139519799954490)
,p_name=>'P2_TIPO_SERV'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(13538229984413473)
,p_prompt=>'Tipo Serv'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13539809850413571)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13562527653231970)
...
'END IF;',
'',
'INSERT INTO TORDENSERV (CDTIPORDEN,NMORDEN,FECREA,CDCLASE,CORRELATIVO,KMACTUAL,KMSIGSERV,DSREPARA,ESTADO,CDEMPRESA,CDDELEGACION,CDEMPLEADO,TIPO_OT,TALLER,CREADO,SERIE,REPORTADO_POR,COD_FALLA,OBSERVACIONES) VALUES (1,CORRELA,:P2_FECHACREA,:P2_CDCLASAC'
||',:P2_CORRACT,KMACT,KMSERVICIO,:P2_TIPO_SERV,''A'',''01'',DELEGA,empleado,''MP'',decode (delega, ''01'', 2, ''02'',6),SYSDATE(),SERI,empleado,falla,:P2_DESCRIPCION);',
'',
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(13562320596220543)
...
,p_user_interface_id=>wwv_flow_api.id(13535821107405637)
,p_name=>'REOCRRE'
,p_step_title=>'REOCRRE'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'REOCRRE'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28211904058950926)
,p_plug_name=>'Form on TRECORRE'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13530214311405579)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(28212108245950950)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(28211904058950926)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(13534815288405604)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(28212307657950956)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(28211904058950926)
,p_button_name=>'INGRESO_OT'
,p_button_action=>'SUBMIT'
...
,p_button_image_alt=>'Ingreso Ot'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_button_condition=>'select * from tordenserv where cdclase = :P4_CDCLASAC and correlativo = :P4_CORRACT and estado = ''A'' and cod_falla in (44,43);'
,p_button_condition_type=>'NOT_EXISTS'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(28214204289950989)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28212520381950959)
,p_name=>'P4_TIPO_SERV'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(28211904058950926)
,p_prompt=>'Tipo Serv'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28212725854950965)
,p_name=>'P4_FECHACREA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(28211904058950926)
,p_prompt=>unistr('Fecha de Creaci\00C3\00B3n')
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28212924541950967)
,p_name=>'P4_CDCLASAC'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(28211904058950926)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28213103679950967)
,p_name=>'P4_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(28211904058950926)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28213307396950967)
,p_name=>'P4_CORRACT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(28211904058950926)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28213506326950967)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28216702406037717)
,p_name=>'P4_COMPLEMENTO'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(28211904058950926)
,p_prompt=>'Complemento'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select CDCLASE||''-''||CORRELATIVO UNIDAD, CDCLASE||''-''||CORRELATIVO UNI from tactivos a  where tipoactivo in (2,3) order by a.tipo asc'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28213715509950976)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TRECORRE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28213907874950982)
,p_process_sequence=>35
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'IngresaOTSERV'
...
'select max(NMORDEN)+1 into correla from TORDENSERV;',
'Select cod_emp into empleado from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'SELECT KMACTUAL INTO KMACT FROM TRECORRE WHERE CDCLASAC = :P4_CDCLASAC AND CORRACT= :P4_CORRACT;',
'SELECT KMPROXSERV INTO KMSERVICIO FROM TRECORRE WHERE CDCLASAC = :P4_CDCLASAC AND CORRACT= :P4_CORRACT;',
'Select CDESTACION into DELEGA from PA_usuarios  where lower(usuario) = lower(:APP_USER);',
'Select SERIE into SERI from PA_Usuarios  where lower(usuario) = lower(:APP_USER);',
'',
'',
'IF :P4_TIPO_SERV= ''SERVICIO MENOR'' THEN',
'FALLA := 44;',
'END IF;',
'',
'IF :P4_TIPO_SERV= ''SERVICIO MEDIO'' THEN',
'FALLA := 43;',
'END IF;',
'',
'IF :P4_TIPO_SERV= ''SERVICIO MAYOR'' THEN',
'FALLA := 53;',
'END IF;',
'',
'IF :P4_TIPO_SERV= ''SERVICIO SUPERMAYOR'' THEN',
'FALLA := 54;',
'END IF;',
'',
'IF :P4_TIPO_SERV= ''SERVICIO COMPLEMENTO'' THEN',
'FALLA := 55;',
'END IF;',
'',
'INSERT INTO TORDENSERV (CDTIPORDEN,NMORDEN,FECREA,CDCLASE,CORRELATIVO,KMACTUAL,KMSIGSERV,DSREPARA,ESTADO,CDEMPRESA,CDDELEGACION,CDEMPLEADO,TIPO_OT,TALLER,CREADO,SERIE,REPORTADO_POR,COD_FALLA,OBSERVACIONES) VALUES (1,CORRELA,:P4_FECHACREA,:P4_CDCLASAC'
||',:P4_CORRACT,KMACT,KMSERVICIO,:P4_TIPO_SERV,''A'',''01'',DELEGA,empleado,''MP'',decode (delega, ''01'', 2, ''02'',6),SYSDATE(),SERI,empleado,falla,:P4_DESCRIPCION);',
'',
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(28212307657950956)
,p_process_success_message=>'OT GENERADA'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(13518002124405520)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13536309200405665)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13530214311405579)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(13536623052405678)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(13536309200405665)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13536418014405671)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(13536309200405665)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(13536500119405676)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13536813613405682)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13536713628405679)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13537024413405682)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13536900361405682)
,p_process_sequence=>10
