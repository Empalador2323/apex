...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,279)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'OT')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_279')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'7C26C7B6EA3568CE5AFB3A1A579497D75464E56333A71162169AE33D3C83C6D5'
...
,p_authentication_id=>wwv_flow_api.id(4493006159400354)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:OT'
...
,p_last_upd_yyyymmddhh24miss=>'20180523104105'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(4494531865400367)
,p_name=>'Navigation'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(4494616309400368)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4482924482400307)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(4519014144004531)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8695699781040099)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8695767717040099)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8695810337040099)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8696091079040099)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8696174555040099)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8696207916040099)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(4492901625400353)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(4494420290400367)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(4526827143985537)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'T_CALCULOS'
,p_tab_text=>'calculos'
,p_tab_step=>3
,p_tab_parent_tabset=>'TS1'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(4535115569963373)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
,p_tab_name=>'T_REPORTE'
,p_tab_text=>'reporte'
,p_tab_step=>4
,p_tab_parent_tabset=>'TS1'
);
...
/
prompt --application/shared_components/user_interface/lovs/unidades
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(4519415210018640)
,p_lov_name=>'UNIDADES'
,p_lov_query=>'select cdclase ||''-''||correlativo unidad , cdclase from tactivos where vehiculo=''S'''
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(4494106391400365)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(4494820821400370)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(4502601539400453)
,p_parent_id=>wwv_flow_api.id(4494820821400370)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483017673400317)
,p_theme_id=>24
,p_name=>'Login'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483112765400320)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483232604400320)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483331670400321)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483405136400321)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483502178400321)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483615102400321)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483704471400323)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483813114400323)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4483925607400323)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484024732400323)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484124083400323)
,p_theme_id=>24
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484201554400325)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484311286400325)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484419871400325)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484531904400325)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(4484603928400325)
,p_theme_id=>24
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(4491528874400343)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(4491602531400343)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(4491706773400343)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(4491813399400343)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(4491909608400343)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(4492023081400343)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4484710668400326)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4484818111400328)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4484931678400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485029258400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485129650400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485217142400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485318545400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485406709400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485518330400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485627300400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485727193400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485813372400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4485926460400329)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486005891400331)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486119571400331)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'    #BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486226472400331)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486323858400331)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486424014400331)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486504340400331)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486630450400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486715537400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486829997400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4486910211400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487015052400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487116363400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487231717400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487310455400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487406774400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487523458400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487629117400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487710546400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487830207400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4487909933400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(4488027699400332)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489227816400337)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489324629400337)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489416413400337)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489531262400337)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489621465400339)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489719394400339)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489814612400339)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4489929983400339)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490001417400339)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490108782400339)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490224730400339)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490309219400339)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490400380400339)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490511482400339)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490609504400339)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490710153400339)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(4490821725400339)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488103006400334)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488210585400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488312625400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488421344400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488501413400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488605602400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488709721400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488813097400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4488921494400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4489024112400335)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(4489121431400335)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(4490908722400340)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(4491022279400342)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(4491121506400342)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(4491224812400342)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(4491312265400342)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(4491411765400342)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(4492127661400343)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(4492217719400345)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(4492602112400348)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(4492311465400345)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(4492426042400346)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(4492529345400346)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(4492710905400351)
,p_theme_id=>24
,p_theme_name=>'Cloudy'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(4483813114400323)
,p_error_template=>wwv_flow_api.id(4483331670400321)
,p_printer_friendly_template=>wwv_flow_api.id(4484201554400325)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(4483017673400317)
,p_default_button_template=>wwv_flow_api.id(4491528874400343)
,p_default_region_template=>wwv_flow_api.id(4487015052400332)
,p_default_chart_template=>wwv_flow_api.id(4485406709400329)
,p_default_form_template=>wwv_flow_api.id(4485727193400329)
,p_default_reportr_template=>wwv_flow_api.id(4487015052400332)
,p_default_tabform_template=>wwv_flow_api.id(4487015052400332)
,p_default_wizard_template=>wwv_flow_api.id(4487830207400332)
,p_default_menur_template=>wwv_flow_api.id(4485029258400329)
,p_default_listr_template=>wwv_flow_api.id(4485318545400329)
,p_default_irr_template=>wwv_flow_api.id(4486119571400331)
,p_default_report_template=>wwv_flow_api.id(4488709721400335)
,p_default_label_template=>wwv_flow_api.id(4491121506400342)
,p_default_menu_template=>wwv_flow_api.id(4492127661400343)
,p_default_calendar_template=>wwv_flow_api.id(4492311465400345)
,p_default_list_template=>wwv_flow_api.id(4490609504400339)
,p_default_option_label=>wwv_flow_api.id(4491224812400342)
,p_default_required_label=>wwv_flow_api.id(4491411765400342)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(4495703949400437)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(4493006159400354)
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(35177324272031005490)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37770597433632207535)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770613945884220515)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
,p_display_sequence=>10
,p_display_value=>'Contains/Case (uses INSTR)'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770623034933226828)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770624539435228140)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770627945322229862)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770641951902231742)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770644524328233219)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37770656531601235304)
,p_plugin_attribute_id=>wwv_flow_api.id(37770597433632207535)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37772341829026773829)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772354137684776360)
,p_plugin_attribute_id=>wwv_flow_api.id(37772341829026773829)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772365441839777523)
,p_plugin_attribute_id=>wwv_flow_api.id(37772341829026773829)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37772377646126788203)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'bar'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(37772341829026773829)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772522033799869835)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>10
,p_display_value=>'Bar'
,p_return_value=>'bar'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772523338648871210)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772525442457872248)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772526846266873401)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772527950422874584)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772530222502876039)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772531429428877988)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37772532333584879228)
,p_plugin_attribute_id=>wwv_flow_api.id(37772377646126788203)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37773455834613503910)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31626937918905401077)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31626939423406402415)
,p_plugin_attribute_id=>wwv_flow_api.id(31626937918905401077)
,p_display_sequence=>10
,p_display_value=>'Slow'
,p_return_value=>'600'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31626940026523403257)
,p_plugin_attribute_id=>wwv_flow_api.id(31626937918905401077)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31626940629640404125)
,p_plugin_attribute_id=>wwv_flow_api.id(31626937918905401077)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31626941334142405496)
,p_plugin_attribute_id=>wwv_flow_api.id(31626937918905401077)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24258381831169851686)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14607820907403557362)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31060158731619936830)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(24169303218600422488)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169286825217377067)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169289027080387035)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169294620416403999)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169295935307408319)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169296808080409896)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169298319854413343)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169303218600422488)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13542338767017339328)
,p_plugin_attribute_id=>wwv_flow_api.id(24169303218600422488)
,p_display_sequence=>10
,p_display_value=>'Not Enterable'
,p_return_value=>'NOT_ENTERABLE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13542376878099342499)
,p_plugin_attribute_id=>wwv_flow_api.id(24169303218600422488)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13542407686410344913)
,p_plugin_attribute_id=>wwv_flow_api.id(24169303218600422488)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169342533407445622)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24169304229335425540)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(8700895961041327)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(29013282638080008338)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773546638876525345)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773550333916527621)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773552430034529339)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773554426584530946)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773556722055533038)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773562249216535730)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773565742314538913)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37773569034982542287)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
,p_file_name=>'bar.gif'
,p_mime_type=>'image/gif'
,p_file_content=>wwv_flow_api.varchar2_to_blob(wwv_flow_api.g_varchar2_table)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(59034662555922950060)
,p_plugin_id=>wwv_flow_api.id(35177324272031005490)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(4492831190400353)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(4492831190400353)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20170831172343'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4494711445400370)
,p_plug_name=>'Navigation'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4487015052400332)
,p_plug_display_sequence=>10
,p_plug_display_column=>1
,p_plug_display_point=>'BODY_3'
,p_list_id=>wwv_flow_api.id(4494531865400367)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(4490609504400339)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4494930200400370)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4485029258400329)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(4494106391400365)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(4492127661400343)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4513515018783412)
,p_plug_name=>'Form on TORDENSERV'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4487015052400332)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4508203815496306)
,p_plug_name=>'grafica'
,p_parent_plug_id=>wwv_flow_api.id(4513515018783412)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4485813372400329)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5041822439100742)
,p_button_sequence=>140
,p_button_plug_id=>wwv_flow_api.id(4513515018783412)
,p_button_name=>'P1_TST'
,p_button_static_id=>'P1_TST'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(4491528874400343)
,p_button_image_alt=>'Tst'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4508529273541467)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4508203815496306)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4513802160783415)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4514131848783415)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4513515018783412)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4508812219555507)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4513715416783415)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4513921885783415)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(4513515018783412)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4526012300946903)
,p_branch_name=>'envio datos'
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_RESULTADO:&P1_NUMBER.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(4508529273541467)
,p_branch_sequence=>11
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5042105504112139)
,p_branch_name=>'cdclase'
,p_branch_action=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_RESULTADO:&P1_CDCLASE.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5041822439100742)
,p_branch_sequence=>21
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4510017066592414)
,p_name=>'P1_TXTNOMBRE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
...
,p_field_template=>wwv_flow_api.id(4491312265400342)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4510808427611546)
,p_name=>'P1_DATE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
,p_use_cache_before_default=>'NO'
...
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(4491121506400342)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4511011434625350)
,p_name=>'P1_NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
,p_prompt=>'Number'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4514926031783420)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4513515018783412)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4515101448783432)
,p_name=>'P1_NMORDEN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(4513515018783412)
,p_use_cache_before_default=>'NO'
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(4491411765400342)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4515305670783432)
,p_name=>'P1_FECREA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(4513515018783412)
,p_use_cache_before_default=>'NO'
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(4491224812400342)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_04=>'button'
,p_attribute_05=>'N'
,p_attribute_07=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4515519840783435)
,p_name=>'P1_DSREPARA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(4513515018783412)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4519608069052343)
,p_name=>'P1_CDCLASE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(4513515018783412)
,p_prompt=>'Cdclase'
,p_display_as=>'PLUGIN_COM_SKILLBUILDERS_SUPER_LOV'
,p_lov=>'select cdclase ||''-''||correlativo unidad, cdclase,correlativo from tactivos where vehiculo=''S'''
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
,p_lov_display_extra=>'YES'
,p_attribute_01=>'Y'
,p_attribute_02=>'listado de unidades'
,p_attribute_03=>'1,2'
,p_attribute_06=>'3'
,p_attribute_07=>'P1_CORRELATIVO'
,p_attribute_08=>'NOT_ENTERABLE'
,p_attribute_09=>'15'
,p_attribute_10=>'&nbsp;'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4519803324054575)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4522405345220809)
,p_name=>'P1_N2'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
,p_prompt=>'N2'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4522600385223057)
,p_name=>'P1_N3'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
,p_prompt=>'N3'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4529908312343817)
,p_name=>'P1_CIAS'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
,p_prompt=>'Cias'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select nom_comercial, cod_cia from cias'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4530124043351712)
,p_name=>'P1_SUCURSALES'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(4508203815496306)
,p_prompt=>'Sucursales'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select nombre, cod_sucursal from sucursales where cod_cia=:p1_cias'
,p_lov_display_null=>'YES'
,p_lov_cascade_parent_items=>'P1_CIAS'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5044110822200875)
,p_name=>'P1_LIST'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(4513515018783412)
,p_prompt=>'List'
,p_display_as=>'PLUGIN_COM_SKILLBUILDERS_SUPER_LOV'
,p_lov=>'select * from (select nmorden, fecrea, dsrepara, estado from tordenserv where cdclase=:P1_CDCLASE and correlativo=:P1_CORRELATIVO order by fecrea desc) where rownum<=6'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(4520120312107501)
,p_validation_name=>'P1_TXTNOMBRE'
,p_validation_sequence=>10
,p_validation=>'P1_TXTNOMBRE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'ingrese nombre'
,p_validation_condition_type=>'NEVER'
,p_when_button_pressed=>wwv_flow_api.id(4508529273541467)
,p_associated_item=>wwv_flow_api.id(4510017066592414)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4516332147783437)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4516530433783437)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4516706454783437)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4513921885783415)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4524712414795057)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'guardar_suma'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'vid number := 0;',
'',
'begin',
'select nvl(max(id),0)+1 into vid from calculos ;',
'calcular_suma( :p1_n2,:p1_n3,:app_user,:app_id,sysdate, vid,:p1_number);',
'end;'))
,p_process_error_message=>'no se realizo el calculo'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_type=>'NEVER'
,p_process_success_message=>'se realizo el calculo'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20170824103042'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4495208955400435)
,p_plug_name=>'TORDENSERV'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4485727193400329)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4502713982400453)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4485029258400329)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4495329622400437)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(4495208955400435)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(4491528874400343)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4495512811400437)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(4495208955400435)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4495613842400437)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(4495208955400435)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4495431208400437)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(4495208955400435)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(4495815592400439)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4495909370400440)
,p_name=>'P2_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4496003099400440)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4496221882400442)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4496428708400442)
,p_name=>'P2_FECREA'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4496613129400443)
,p_name=>'P2_CDCLASE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4496813559400443)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4497023464400443)
,p_name=>'P2_KMACTUAL'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4497217284400443)
,p_name=>'P2_KMSIGSERV'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4497414494400443)
,p_name=>'P2_DSREPARA'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4497601420400443)
,p_name=>'P2_ESTADO'
,p_item_sequence=>9
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4497808754400445)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4498030864400445)
,p_name=>'P2_CDEMPRESA'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4498203576400445)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4498429945400445)
,p_name=>'P2_NMSOLIC'
,p_item_sequence=>13
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4498604315400446)
,p_name=>'P2_SERIE'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4498830089400448)
,p_name=>'P2_TIPO_SERV'
,p_item_sequence=>15
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4499007982400448)
,p_name=>'P2_NUM_CHECK'
,p_item_sequence=>16
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4499227393400448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4499414062400448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4499626644400448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4499824666400448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4500012684400448)
,p_name=>'P2_HORA_FIN'
,p_item_sequence=>21
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4500212470400450)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4500432443400450)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4500615195400450)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4500830244400450)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4501007427400450)
,p_name=>'P2_UBICACION'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4501212907400450)
,p_name=>'P2_COD_FALLA'
,p_item_sequence=>27
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4501403411400451)
,p_name=>'P2_TIPO_OT'
,p_item_sequence=>28
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4501623418400451)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4501808874400451)
,p_name=>'P2_CREADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(4495208955400435)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4502008181400451)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4502213353400451)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4502406881400451)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4502501790400451)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TORDENSERV'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4512817610746323)
,p_process_sequence=>11
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'correlativo'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'select max(nmorden)+1 into :P2_NMORDEN from tordenserv ;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(4495613842400437)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20170824135424'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4525524160921439)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4525825898925418)
,p_name=>'P3_RESULTADO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4525524160921439)
,p_prompt=>'Resultado'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_html_page_header=>'<script type="text/javascript" src="http://mbostock.github.com/d3/d3.js"></script>'
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180216215546'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4535306151966554)
,p_plug_name=>'elementos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4487015052400332)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20167024691372862)
,p_plug_name=>'report'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4487015052400332)
...
'<div id="myviz"></div>',
' ',
'<!-- Some CSS to make graphical styling easier -->',
' ',
'<style type=''text/css''>',
'.chart {',
'  margin-left: 10px;',
...
'<!-- Chart set-up and data gathering/redraw function definitions. -->',
...
' ',
'// Function to retrieve value from our PL/SQL Dynamic Action',
'function next() {',
' ',
...
' ',
'  // Return a JS object with a time sequence and a value',
'  return {',
'    time: ++t,',
'    value: gReturn',
'  };',
...
'var mychart = d3.select("#myviz").append("svg")',
'    .attr("class", "chart")',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4535602629969395)
,p_name=>'P4_PID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4535306151966554)
,p_prompt=>'Pid'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20167310970378375)
,p_process_sequence=>10
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'GetRandom'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'  HTP.PRINT( (1+ABS(MOD(dbms_random.random,100))) );',
'END;'))
);
end;
/
...
,p_step_template=>wwv_flow_api.id(4483017673400317)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20170824093012'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(4493321873400357)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(4485727193400329)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(4493625274400364)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(4493321873400357)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4493416060400360)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(4493321873400357)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4493518248400362)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4493829865400365)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4493712628400364)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4494030936400365)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(4493909637400365)
,p_process_sequence=>10
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(4503306314402417)
);
end;
/
