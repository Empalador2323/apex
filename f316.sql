...
,p_default_application_id=>316
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 316 - reporte_llantas_desmont
--
-- Application Export:
--   Application:     316
--   Name:            reporte_llantas_desmont
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,316)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'reporte_llantas_desmont')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_316')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'21248503989F841D7AE339D9827F0FCB4C5C1F41A510F6040FD99AEE45B69669'
...
,p_authentication_id=>wwv_flow_api.id(17231003435114309)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:reporte_llantas_desmont'
...
,p_last_upd_yyyymmddhh24miss=>'20210325144750'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8754061259055340)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8754184608055340)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8754274988055340)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8754416014055342)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8754512423055342)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8754636577055342)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(17189508375783717)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17229811236065067)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(17207528659784045)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(17209018874784126)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(17208712684784109)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(17209105097784128)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17189607796783731)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17189719302783754)
,p_page_template_id=>wwv_flow_api.id(17189607796783731)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17189807598783759)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17189916905783764)
,p_page_template_id=>wwv_flow_api.id(17189807598783759)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190010923783764)
,p_page_template_id=>wwv_flow_api.id(17189807598783759)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190123958783765)
,p_page_template_id=>wwv_flow_api.id(17189807598783759)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190219367783765)
,p_page_template_id=>wwv_flow_api.id(17189807598783759)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190315760783765)
,p_page_template_id=>wwv_flow_api.id(17189807598783759)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17190417616783765)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190531084783768)
,p_page_template_id=>wwv_flow_api.id(17190417616783765)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190618265783768)
,p_page_template_id=>wwv_flow_api.id(17190417616783765)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190723564783768)
,p_page_template_id=>wwv_flow_api.id(17190417616783765)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190818285783770)
,p_page_template_id=>wwv_flow_api.id(17190417616783765)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17190903935783770)
,p_page_template_id=>wwv_flow_api.id(17190417616783765)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191009543783770)
,p_page_template_id=>wwv_flow_api.id(17190417616783765)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17191113897783770)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191223317783773)
,p_page_template_id=>wwv_flow_api.id(17191113897783770)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191302387783775)
,p_page_template_id=>wwv_flow_api.id(17191113897783770)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191431859783775)
,p_page_template_id=>wwv_flow_api.id(17191113897783770)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191512009783775)
,p_page_template_id=>wwv_flow_api.id(17191113897783770)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17191621919783775)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191718944783779)
,p_page_template_id=>wwv_flow_api.id(17191621919783775)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191812216783779)
,p_page_template_id=>wwv_flow_api.id(17191621919783775)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17191910871783779)
,p_page_template_id=>wwv_flow_api.id(17191621919783775)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192031908783781)
,p_page_template_id=>wwv_flow_api.id(17191621919783775)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192114496783781)
,p_page_template_id=>wwv_flow_api.id(17191621919783775)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17192216493783787)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192312714783792)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192418235783792)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192509437783792)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192626168783793)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192727126783793)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192831476783793)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17192903834783793)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193026671783793)
,p_page_template_id=>wwv_flow_api.id(17192216493783787)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17193104185783795)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193216402783796)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193308256783796)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193429494783798)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193525187783798)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193602318783798)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193724491783798)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17193827028783798)
,p_page_template_id=>wwv_flow_api.id(17193104185783795)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17193908583783800)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194026953783801)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194128374783803)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194226584783803)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194307330783803)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194414096783803)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194523332783803)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194631467783804)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194727593783804)
,p_page_template_id=>wwv_flow_api.id(17193908583783800)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17194805333783804)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17194920272783807)
,p_page_template_id=>wwv_flow_api.id(17194805333783804)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17195017270783807)
,p_page_template_id=>wwv_flow_api.id(17194805333783804)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17195119032783809)
,p_page_template_id=>wwv_flow_api.id(17194805333783804)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17195215788783809)
,p_page_template_id=>wwv_flow_api.id(17194805333783804)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17195312408783809)
,p_page_template_id=>wwv_flow_api.id(17194805333783804)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17195400631783809)
,p_page_template_id=>wwv_flow_api.id(17194805333783804)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(17195515160783809)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(17

,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(17189607796783731)
,p_default_button_template=>wwv_flow_api.id(17206423152783973)
,p_default_region_template=>wwv_flow_api.id(17202711087783898)
,p_default_chart_template=>wwv_flow_api.id(17202711087783898)
,p_default_form_template=>wwv_flow_api.id(17201821021783884)
,p_default_reportr_template=>wwv_flow_api.id(17202711087783898)
,p_default_tabform_template=>wwv_flow_api.id(17202711087783898)
,p_default_wizard_template=>wwv_flow_api.id(17201821021783884)
,p_default_menur_template=>wwv_flow_api.id(17201307603783876)
,p_default_listr_template=>wwv_flow_api.id(17202711087783898)
,p_default_irr_template=>wwv_flow_api.id(17202226059783892)
,p_default_report_template=>wwv_flow_api.id(17203827021783923)
,p_default_label_template=>wwv_flow_api.id(17205900585783968)
,p_default_menu_template=>wwv_flow_api.id(17207007131783984)
,p_default_calendar_template=>wwv_flow_api.id(17207129379783993)
,p_default_list_template=>wwv_flow_api.id(17205424832783956)
,p_default_option_label=>wwv_flow_api.id(17205900585783968)
,p_default_required_label=>wwv_flow_api.id(17206226021783971)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17207629582784053)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(17231003435114309)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(17207414470784026)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(17207414470784026)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20201102135600'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17209610052790326)
,p_plug_name=>'Parametros'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17202711087783898)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17219520460944657)
,p_plug_name=>'LLANTASDESMONT'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17202226059783892)
,p_plug_display_sequence=>30
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT Cdmedida AS MEDIDA,',
'Correlativo AS LLANTA,',
'Nueva AS N,',
'Reencauche1 AS R1,',
'Reencauche2 AS R2,',
'Reencauche3 AS R3,',
'Fechamontaje AS FECHA_DES,',
'Cdbodega AS BODEGA,',
'profund_desmontaje as Prof FROM TMONTAJES_N WHERE TIPOMOVIMIENTO = ''D'' AND FECHAMONTAJE >= :P1_FECHAINICIO AND FECHAMONTAJE <= :P1_FECHAFIN ORDER BY FECHAMONTAJE DESC'))
...
,p_prn_page_header=>'LLANTAS DESMONTADAS'
,p_prn_page_header_font_color=>'#3400C2'
,p_prn_page_header_font_family=>'Helvetica'
,p_prn_page_header_font_weight=>'normal'
,p_prn_page_header_font_size=>'18'
,p_prn_page_footer=>'LAS PIPAS S.A.'
,p_prn_page_footer_font_color=>'#3400C2'
,p_prn_page_footer_font_family=>'Helvetica'
,p_prn_page_footer_font_weight=>'normal'
,p_prn_page_footer_font_size=>'16'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(17219608747944659)
,p_name=>'LLANTASDESMONT'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>17219608747944659
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224204193977185)
,p_db_column_name=>'MEDIDA'
,p_display_order=>16
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224313314977189)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224426634977192)
,p_db_column_name=>'N'
,p_display_order=>18
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224527469977193)
,p_db_column_name=>'R1'
,p_display_order=>19
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224601825977195)
,p_db_column_name=>'R2'
,p_display_order=>20
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224718800977196)
,p_db_column_name=>'R3'
,p_display_order=>21
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224825647977198)
,p_db_column_name=>'FECHA_DES'
,p_display_order=>22
,p_column_identifier=>'V'
,p_column_label=>'Fecha Des'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHA_DES'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17224918320977198)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17226221409014835)
,p_db_column_name=>'PROF'
,p_display_order=>24
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(17219927732946779)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'172200'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100
,p_report_columns=>'LLANTA:MEDIDA:N:R1:R2:R3:FECHA_DES:BODEGA:PROF:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17210501310806704)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(17209610052790326)
,p_button_name=>'MOSTRAR_LLANTAS'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(17206423152783973)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Mostrar Llantas'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17210104342794768)
,p_name=>'P1_FECHAINICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17209610052790326)
...
,p_field_template=>wwv_flow_api.id(17205900585783968)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17210329993798128)
,p_name=>'P1_FECHAFIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17209610052790326)
,p_prompt=>'Fecha fin'
...
,p_step_template=>wwv_flow_api.id(17189607796783731)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180126102117'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17207903859784070)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17201821021783884)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17208232419784098)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(17207903859784070)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17208018704784085)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17207903859784070)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17208104783784093)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17208415348784104)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17208306615784100)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17208621781784109)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17208513691784106)
,p_process_sequence=>10
