...
,p_default_application_id=>352
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 352 - LP_PILOTOS
--
-- Application Export:
--   Application:     352
--   Name:            LP_PILOTOS
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,352)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_PILOTOS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'LP_PILOTOS')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'669551E6ACD58D3D9B0341DECF11913FE377672D9838918040C9FADDB6649654'
...
,p_authentication_id=>wwv_flow_api.id(31049114273397892)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_PILOTOS'
...
,p_last_upd_yyyymmddhh24miss=>'20220216163921'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8821650567070611)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8821718601070611)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8821807206070611)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8822085510070611)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8822135667070611)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8822246105070611)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(30928512466153960)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(30955719843398137)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(30946506795154021)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(30948016355154046)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_PAGE_1'
,p_tab_text=>'VIAJES'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(31229216630219721)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'MIS SOLICITUDES'
,p_tab_text=>'MIS SOLICITUDES'
,p_tab_step=>6
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(31234407645231465)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
,p_tab_name=>'NUEVA SOLICITUD'
,p_tab_text=>'NUEVA SOLICITUD'
,p_tab_step=>7
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(46586911539073612)
,p_tab_set=>'TS1'
,p_tab_sequence=>40
,p_tab_name=>'Prestamos'
,p_tab_text=>'Prestamos'
,p_tab_step=>3
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(59062902164829701)
,p_tab_set=>'TS1'
,p_tab_sequence=>50
,p_tab_name=>'REPORTES CONDICIONES'
,p_tab_text=>'REPORTES CONDICIONES'
,p_tab_step=>4
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(30947703241154045)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30928623697153962)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30928715605153962)
,p_page_template_id=>wwv_flow_api.id(30928623697153962)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30928815346153968)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30928923283153968)
,p_page_template_id=>wwv_flow_api.id(30928815346153968)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929020332153968)
,p_page_template_id=>wwv_flow_api.id(30928815346153968)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929106228153968)
,p_page_template_id=>wwv_flow_api.id(30928815346153968)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929225279153968)
,p_page_template_id=>wwv_flow_api.id(30928815346153968)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929315215153968)
,p_page_template_id=>wwv_flow_api.id(30928815346153968)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30929419626153968)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929511757153968)
,p_page_template_id=>wwv_flow_api.id(30929419626153968)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929605297153968)
,p_page_template_id=>wwv_flow_api.id(30929419626153968)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929705497153968)
,p_page_template_id=>wwv_flow_api.id(30929419626153968)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929820581153968)
,p_page_template_id=>wwv_flow_api.id(30929419626153968)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30929928927153968)
,p_page_template_id=>wwv_flow_api.id(30929419626153968)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930012042153968)
,p_page_template_id=>wwv_flow_api.id(30929419626153968)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30930109513153968)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930223471153968)
,p_page_template_id=>wwv_flow_api.id(30930109513153968)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930305392153968)
,p_page_template_id=>wwv_flow_api.id(30930109513153968)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930417688153968)
,p_page_template_id=>wwv_flow_api.id(30930109513153968)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930517515153968)
,p_page_template_id=>wwv_flow_api.id(30930109513153968)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30930618441153968)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930707832153968)
,p_page_template_id=>wwv_flow_api.id(30930618441153968)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930831696153968)
,p_page_template_id=>wwv_flow_api.id(30930618441153968)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30930927214153968)
,p_page_template_id=>wwv_flow_api.id(30930618441153968)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931018979153968)
,p_page_template_id=>wwv_flow_api.id(30930618441153968)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931115340153968)
,p_page_template_id=>wwv_flow_api.id(30930618441153968)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30931223212153968)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931328812153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931432726153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931529293153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931603522153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931719285153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931809568153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30931927633153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932021797153968)
,p_page_template_id=>wwv_flow_api.id(30931223212153968)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30932108032153968)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932219935153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932328785153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932407553153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932525141153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932615119153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932722516153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30932832241153968)
,p_page_template_id=>wwv_flow_api.id(30932108032153968)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30932928852153970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933012360153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933100188153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933205924153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933318410153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933423731153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933505553153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933604017153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933719477153970)
,p_page_template_id=>wwv_flow_api.id(30932928852153970)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30933814540153970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30933912554153970)
,p_page_template_id=>wwv_flow_api.id(30933814540153970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934010679153970)
,p_page_template_id=>wwv_flow_api.id(30933814540153970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934118933153970)
,p_page_template_id=>wwv_flow_api.id(30933814540153970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934229469153970)
,p_page_template_id=>wwv_flow_api.id(30933814540153970)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934310050153970)
,p_page_template_id=>wwv_flow_api.id(30933814540153970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934411705153970)
,p_page_template_id=>wwv_flow_api.id(30933814540153970)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30934507765153970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934618489153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934701594153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934809912153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30934912250153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935025078153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935105291153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935211154153970)
,p_page_template_id=>wwv_flow_api.id(30934507765153970)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30935309996153970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935406640153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935524015153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935612699153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935704258153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935815163153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30935905456153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936009337153970)
,p_page_template_id=>wwv_flow_api.id(30935309996153970)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30936122035153970)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936208039153970)
,p_page_template_id=>wwv_flow_api.id(30936122035153970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30936324433153970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936416197153970)
,p_page_template_id=>wwv_flow_api.id(30936324433153970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936514425153970)
,p_page_template_id=>wwv_flow_api.id(30936324433153970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936617082153970)
,p_page_template_id=>wwv_flow_api.id(30936324433153970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936718811153970)
,p_page_template_id=>wwv_flow_api.id(30936324433153970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30936825311153970)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30936914600153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937011177153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937132362153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937226002153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937307568153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937416792153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937500985153976)
,p_page_template_id=>wwv_flow_api.id(30936825311153970)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30937606122153976)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937730927153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937828372153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30937902859153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938031441153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938126330153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938210701153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938308955153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938425328153976)
,p_page_template_id=>wwv_flow_api.id(30937606122153976)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30938526381153976)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938616792153976)
,p_page_template_id=>wwv_flow_api.id(30938526381153976)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938721702153976)
,p_page_template_id=>wwv_flow_api.id(30938526381153976)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938801349153976)
,p_page_template_id=>wwv_flow_api.id(30938526381153976)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30938900081153976)
,p_page_template_id=>wwv_flow_api.id(30938526381153976)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939002468153976)
,p_page_template_id=>wwv_flow_api.id(30938526381153976)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939131447153976)
,p_page_template_id=>wwv_flow_api.id(30938526381153976)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(30939210497153976)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939307085153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939416572153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939523156153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939631396153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939716656153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939820286153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(30939920039153978)
,p_page_template_id=>wwv_flow_api.id(30939210497153976)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(30945410000154014)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(30945501483154017)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(30945621229154017)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(30945729683154017)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(30945802531154017)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(30945903783154017)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940015451153978)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940108797154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940214490154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940303343154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940420378154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940508375154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940623565154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940722663154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30940821493154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(30940914351154004)
,p_plug_template_id=>wwv_flow_api.id(30940821493154004)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941024735154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941108343154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941222340154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941331981154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(30941426715154004)
,p_plug_template_id=>wwv_flow_api.id(30941331981154004)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941526297154004)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941621240154006)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30941706267154006)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(30941826319154006)
,p_plug_template_id=>wwv_flow_api.id(30941706267154006)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(30941928079154006)
,p_plug_template_id=>wwv_flow_api.id(30941706267154006)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30942029367154006)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(30942128375154006)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943325387154010)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943402965154012)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943501873154014)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943631749154014)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943704868154014)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943815604154014)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30943904134154014)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944020629154014)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944122576154014)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944207828154014)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944302517154014)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944432074154014)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944500682154014)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(30944623834154014)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942214019154006)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942300355154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942424639154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942523450154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942619261154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942725374154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942804217154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30942912452154007)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30943006069154010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30943109709154010)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(30943219932154010)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30944705054154014)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30944801889154014)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30944914447154014)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30945016268154014)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30945125824154014)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30945218474154014)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(30945307631154014)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(30946015357154017)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(30946201432154020)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(30946122960154017)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(30946313894154020)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(30933814540153970)
,p_error_template=>wwv_flow_api.id(30930109513153968)
,p_printer_friendly_template=>wwv_flow_api.id(30936324433153970)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(30928623697153962)
,p_default_button_template=>wwv_flow_api.id(30945410000154014)
,p_default_region_template=>wwv_flow_api.id(30941706267154006)
,p_default_chart_template=>wwv_flow_api.id(30941706267154006)
,p_default_form_template=>wwv_flow_api.id(30940821493154004)
,p_default_reportr_template=>wwv_flow_api.id(30941706267154006)
,p_default_tabform_template=>wwv_flow_api.id(30941706267154006)
,p_default_wizard_template=>wwv_flow_api.id(30940821493154004)
,p_default_menur_template=>wwv_flow_api.id(30940303343154004)
,p_default_listr_template=>wwv_flow_api.id(30941706267154006)
,p_default_irr_template=>wwv_flow_api.id(30941222340154004)
,p_default_report_template=>wwv_flow_api.id(30942804217154007)
,p_default_label_template=>wwv_flow_api.id(30944914447154014)
,p_default_menu_template=>wwv_flow_api.id(30946015357154017)
,p_default_calendar_template=>wwv_flow_api.id(30946122960154017)
,p_default_list_template=>wwv_flow_api.id(30944432074154014)
,p_default_option_label=>wwv_flow_api.id(30944914447154014)
,p_default_required_label=>wwv_flow_api.id(30945218474154014)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(30946625747154023)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31049114273397892)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(30946432027154020)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>2
,p_user_interface_id=>wwv_flow_api.id(30946432027154020)
,p_tab_set=>'TS1'
,p_name=>'Detalle_viajes'
,p_step_title=>'Detalle_viajes'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Detalle_viajes'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180716161529'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30952714112351123)
,p_plug_name=>'Detalle_Viajes'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30941222340154004)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select nmnota, fechaentrega, nodocto, galones, comision from tdetnota where nmnota=:p2_nmnota'
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P2_NMNOTA'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(30952810925351123)
,p_name=>'Detalle_Viajes'
...
,p_owner=>'LP'
,p_internal_uid=>30952810925351123
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30953009167351126)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30953125785351128)
...
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHAENTREGA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30953205969351128)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30953329587351128)
,p_db_column_name=>'GALONES'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Transportado'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30953405251351128)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(30953517089351273)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'309536'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMNOTA:FECHAENTREGA:NODOCTO:GALONES:COMISION'
,p_sum_columns_on_break=>'COMISION'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30955132027384000)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(30952714112351123)
,p_button_name=>'REGRESAR'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(30945410000154014)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30954312979355751)
,p_name=>'P2_NMNOTA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30952714112351123)
,p_prompt=>'Nmnota'
...
,p_field_template=>wwv_flow_api.id(30944914447154014)
...
,p_tab_set=>'TS1'
,p_name=>'Prestamos'
,p_step_title=>'Prestamos'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Prestamos'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20201208154728'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(46587006428073614)
...
'from  ',
'pipasgt.empleado_concepto@softland a',
'inner join pipasgt.concepto b on a.concepto=b.concepto ',
'inner join pipasgt.empleado c on c.empleado=a.empleado',
'where saldo <>0',
'and to_number( a.empleado)= :APP_USER'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(46587131354073614)
,p_name=>'Prestamos'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>46587131354073614
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46587411383073637)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46587708920073639)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93449721064876050)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93449820912876051)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93449903816876051)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93450027689876051)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93456304164957234)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93456407341957235)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93456526857957235)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93460523524009054)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(93460625284009054)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(46589019853073862)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'465891'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'EMPLEADO:CONCEPTO:SALDO:ACUMULADO:MONTO:N_CUOTAS:APLICADAS:PENDIENTES:NOMBRE:DESCRIPCION'
,p_sum_columns_on_break=>'VALOR_PRESTA:SALDO_ACTUAL'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(108692704063050698)
,p_name=>'NOTA'
,p_template=>wwv_flow_api.id(30941706267154006)
...
,p_query_type=>'SQL'
,p_source=>'select * from v_nota where TO_NUMBER (empleado )=:APP_USER'
,p_ajax_enabled=>'Y'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(30942804217154007)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(108693009934050707)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(108693128434050707)
,p_query_column_id=>2
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190627121548'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(59063032499829707)
,p_plug_name=>'REPORTES CONDICIONES Y ACTOS INSEGUROS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30940821493154004)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(59063424532829734)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(59063032499829707)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(59063224015829731)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(59063629501829740)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(59063811363829815)
,p_name=>'P4_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(59063032499829707)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(59064009336829854)
,p_name=>'P4_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(59063032499829707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(59064226997829868)
,p_name=>'P4_EMPLEADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(59063032499829707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(59064407348829868)
,p_name=>'P4_FECHA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(59063032499829707)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(59064614826829871)
,p_name=>'P4_COMENTARIO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(59063032499829707)
,p_use_cache_before_default=>'NO'
,p_prompt=>'DESCRIBA LA CONDICION / ACTO INSEGURO'
,p_source=>'COMENTARIO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(59067107616857643)
,p_name=>'asigna valor'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(59067413467857678)
,p_event_id=>wwv_flow_api.id(59067107616857643)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(59065402147829885)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TREPORTE'
,p_attribute_02=>'TREPORTE'
,p_attribute_03=>'P4_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(59065624159829909)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TREPORTE'
,p_attribute_02=>'TREPORTE'
,p_attribute_03=>'P4_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'I'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(59065824745829909)
...
,p_user_interface_id=>wwv_flow_api.id(30946432027154020)
,p_tab_set=>'TS1'
,p_name=>'MIS SOLICITUDES'
,p_step_title=>'MIS SOLICITUDES'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'MIS SOLICITUDES'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190121101542'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31229324870219721)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select * from tordenserv where cdempleado =:APP_USER and taller in (13,14)'
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31229411224219721)
,p_name=>'Report 1'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>31229411224219721
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31229610462219725)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31229700800219726)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31229814798219726)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31229900317219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230016393219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230126676219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230206827219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230306950219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230412337219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230509891219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230600685219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230716692219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230807400219728)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31230927369219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231007180219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231131349219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231209386219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231314987219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231400821219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231511384219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231624388219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231709507219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231805701219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31231922530219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232021860219729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232104009219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232213257219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232324052219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232411649219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232501539219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232617589219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232722652219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232802542219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31232916080219731)
,p_db_column_name=>'COMENTARIO_CIERRE'
,p_display_order=>34
,p_column_identifier=>'AH'
,p_column_label=>'Comentario Cierre'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'COMENTARIO_CIERRE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31233011682219731)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31233121627219732)
,p_db_column_name=>'COMENT_TERMINA'
,p_display_order=>36
,p_column_identifier=>'AJ'
,p_column_label=>'Coment Termina'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'COMENT_TERMINA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31233221562219732)
,p_db_column_name=>'COMENT_ANULA'
,p_display_order=>37
,p_column_identifier=>'AK'
,p_column_label=>'Coment Anula'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'COMENT_ANULA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31233315729219732)
...
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHA_ANULA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31233400844219732)
,p_db_column_name=>'FECHA_TERMINA'
,p_display_order=>39
,p_column_identifier=>'AM'
,p_column_label=>'Fecha Termina'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_tz_dependent=>'N'
,p_static_id=>'FECHA_TERMINA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31233530519219732)
,p_db_column_name=>'CERRADO_POR'
,p_display_order=>40
,p_column_identifier=>'AN'
,p_column_label=>'Cerrado Por'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'CERRADO_POR'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46607619665604493)
,p_db_column_name=>'C_BODEGA'
,p_display_order=>41
,p_column_identifier=>'AO'
,p_column_label=>'C Bodega'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'C_BODEGA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46607732534604498)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46607831822604500)
,p_db_column_name=>'COD_CHEKLIST'
,p_display_order=>43
,p_column_identifier=>'AQ'
,p_column_label=>'Cod Cheklist'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'COD_CHEKLIST'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31233606975219907)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'312337'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMORDEN:FECREA:DSREPARA:ESTADO:OBSERVACIONES:CDDELEGACION:CDEMPLEADO:TIPO_OT:CDASIGNADO:FECHA_ASIGNADO:COMENTARIO_CIERRE:CERRADO_POR:'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(30946432027154020)
,p_tab_set=>'TS1'
,p_name=>'NUEVA SOLICITUD'
,p_alias=>'NUEVASOLICITUD'
,p_step_title=>'NUEVA SOLICITUD'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180718180543'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31234529616235898)
,p_plug_name=>'SOLICITUDES '
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30941706267154006)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31234908614238743)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31234529616235898)
,p_button_name=>'CREAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(30945729683154017)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'CREAR'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31235111902238750)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31235928443244687)
,p_name=>'P7_TIPO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31234529616235898)
,p_prompt=>'TIPO DE SOLICITUD'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT DESCRIPCION, COD_FALLA  FROM TBL_FALLAS WHERE TALLER=1'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31236108220244692)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31255311344262067)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
'begin',
'insert into tordenserv (CDTIPORDEN, nmorden, fecrea, dsrepara, estado, observaciones, cdempresa ,serie, cddelegacion, cdempleado, reportado_por,cod_falla, tipo_ot,taller)',
'values(4, (select max(nmorden)+1  from tordenserv    where fecrea>''01/01/2017''),sysdate,(SELECT DESCRIPCION FROM TBL_FALLAS WHERE TALLER=1 and COD_FALLA =:P7_TIPO), ''A'', :P7_DESCRIPCION,''01'',',
'(select SERIE from PA_Usuarios  where lower(usuario) = lower(:APP_USER)), (Select cdestacion from PA_Usuarios  where lower(usuario) = lower(:APP_USER)),(Select cod_emp from PA_Usuarios  where lower(usuario) = lower(:APP_USER)), ',
'(Select cod_emp from PA_Usuarios  where lower(usuario) = lower(:APP_USER)), :P7_TIPO,''RH'',13);',
'end;'))
,p_process_error_message=>'error comunicarse con Recursos Humanos'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31234908614238743)
,p_process_success_message=>'Guardado'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31270623558333140)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31270918279350557)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
'BEGIN',
'htp.init;',
'owa_util.redirect_url(''f?p=352:6:&APP_SESSION.'');',
...
,p_step_template=>wwv_flow_api.id(30928623697153962)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180716153709'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30946914348154026)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30940821493154004)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30947212415154040)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(30946914348154026)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30947012997154028)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30946914348154026)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30947131116154040)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30947415785154045)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30947306472154040)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30947608730154045)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30947511839154045)
,p_process_sequence=>10
