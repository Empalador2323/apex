...
,p_default_application_id=>335
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 335 - Combustible
--
-- Application Export:
--   Application:     335
--   Name:            Combustible
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,335)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_335')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'52AF520FB21441810924391ABB6FE9182849FB6D018E96377E8C53B02FE93464'
...
,p_authentication_id=>wwv_flow_api.id(20743806162286323)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20180228105454'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8783004848062961)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8783148289062962)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8783265670062962)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8783480668062962)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8783525177062962)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8783668917062962)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(20725724062286218)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(20743703819286323)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(20745220442286334)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(20744930425286329)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(20745314456286334)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20725824645286220)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20725909045286221)
,p_page_template_id=>wwv_flow_api.id(20725824645286220)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20726002068286225)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726114787286226)
,p_page_template_id=>wwv_flow_api.id(20726002068286225)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726229713286226)
,p_page_template_id=>wwv_flow_api.id(20726002068286225)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726327559286226)
,p_page_template_id=>wwv_flow_api.id(20726002068286225)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726422328286226)
,p_page_template_id=>wwv_flow_api.id(20726002068286225)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726515544286226)
,p_page_template_id=>wwv_flow_api.id(20726002068286225)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20726613770286226)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726701159286232)
,p_page_template_id=>wwv_flow_api.id(20726613770286226)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726824373286232)
,p_page_template_id=>wwv_flow_api.id(20726613770286226)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20726920027286232)
,p_page_template_id=>wwv_flow_api.id(20726613770286226)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727003178286232)
,p_page_template_id=>wwv_flow_api.id(20726613770286226)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727127268286232)
,p_page_template_id=>wwv_flow_api.id(20726613770286226)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727216900286232)
,p_page_template_id=>wwv_flow_api.id(20726613770286226)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20727300260286246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727400729286246)
,p_page_template_id=>wwv_flow_api.id(20727300260286246)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727503229286246)
,p_page_template_id=>wwv_flow_api.id(20727300260286246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727608896286246)
,p_page_template_id=>wwv_flow_api.id(20727300260286246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727706758286246)
,p_page_template_id=>wwv_flow_api.id(20727300260286246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20727829360286246)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20727927952286251)
,p_page_template_id=>wwv_flow_api.id(20727829360286246)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728024203286251)
,p_page_template_id=>wwv_flow_api.id(20727829360286246)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728124547286251)
,p_page_template_id=>wwv_flow_api.id(20727829360286246)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728214895286251)
,p_page_template_id=>wwv_flow_api.id(20727829360286246)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728305925286251)
,p_page_template_id=>wwv_flow_api.id(20727829360286246)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20728413988286251)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728522263286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728606524286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728713147286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728810182286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20728925374286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729004894286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729119026286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729227331286253)
,p_page_template_id=>wwv_flow_api.id(20728413988286251)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20729328199286253)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729427578286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729532282286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729623137286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729701725286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729809484286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20729918557286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730014965286254)
,p_page_template_id=>wwv_flow_api.id(20729328199286253)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20730108499286254)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730204137286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730302409286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730407230286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730526255286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730621235286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730729088286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730823556286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20730915834286254)
,p_page_template_id=>wwv_flow_api.id(20730108499286254)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20731031965286254)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731105538286257)
,p_page_template_id=>wwv_flow_api.id(20731031965286254)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731229682286257)
,p_page_template_id=>wwv_flow_api.id(20731031965286254)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731331655286257)
,p_page_template_id=>wwv_flow_api.id(20731031965286254)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731401761286257)
,p_page_template_id=>wwv_flow_api.id(20731031965286254)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731513531286257)
,p_page_template_id=>wwv_flow_api.id(20731031965286254)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731608240286257)
,p_page_template_id=>wwv_flow_api.id(20731031965286254)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20731725570286257)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731823230286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20731900265286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732004164286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732127099286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732215735286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732329169286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732408618286262)
,p_page_template_id=>wwv_flow_api.id(20731725570286257)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20732523187286262)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732614600286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732728994286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732824499286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20732923878286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733024939286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733127337286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733217563286262)
,p_page_template_id=>wwv_flow_api.id(20732523187286262)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20733330265286262)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733404300286264)
,p_page_template_id=>wwv_flow_api.id(20733330265286262)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20733503287286264)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733630702286264)
,p_page_template_id=>wwv_flow_api.id(20733503287286264)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733730661286264)
,p_page_template_id=>wwv_flow_api.id(20733503287286264)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733830472286264)
,p_page_template_id=>wwv_flow_api.id(20733503287286264)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20733917648286264)
,p_page_template_id=>wwv_flow_api.id(20733503287286264)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20734001565286264)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734103492286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734206252286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734317589286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734419803286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734520091286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734606059286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734706931286265)
,p_page_template_id=>wwv_flow_api.id(20734001565286264)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20734807102286265)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20734932680286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735026400286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735111693286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735214995286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735330543286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735415686286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735507816286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735625346286276)
,p_page_template_id=>wwv_flow_api.id(20734807102286265)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20735718591286278)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735826741286278)
,p_page_template_id=>wwv_flow_api.id(20735718591286278)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20735927126286278)
,p_page_template_id=>wwv_flow_api.id(20735718591286278)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736022499286278)
,p_page_template_id=>wwv_flow_api.id(20735718591286278)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736109834286278)
,p_page_template_id=>wwv_flow_api.id(20735718591286278)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736224031286278)
,p_page_template_id=>wwv_flow_api.id(20735718591286278)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736318629286278)
,p_page_template_id=>wwv_flow_api.id(20735718591286278)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(20736408415286292)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736510213286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736608138286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736708872286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736808907286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20736923484286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20737022288286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(20737107397286292)
,p_page_template_id=>wwv_flow_api.id(20736408415286292)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20742618149286318)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20742724873286320)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20742808355286320)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20742908082286320)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20743021179286320)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(20743112495286320)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737204417286292)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737321849286293)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737415316286293)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737504416286293)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737630081286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737708310286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737810630286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20737931015286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738018054286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20738118145286301)
,p_plug_template_id=>wwv_flow_api.id(20738018054286301)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738231258286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738306432286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738420076286301)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738521647286303)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20738601156286303)
,p_plug_template_id=>wwv_flow_api.id(20738521647286303)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738730832286303)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738822786286303)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20738901509286303)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20739023159286303)
,p_plug_template_id=>wwv_flow_api.id(20738901509286303)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(20739128942286303)
,p_plug_template_id=>wwv_flow_api.id(20738901509286303)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20739226539286303)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(20739303138286303)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20740525748286309)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20740612686286311)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20740730235286317)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20740811033286317)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20740932177286317)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741003434286317)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741108814286317)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741212737286317)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741323076286317)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741408995286317)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741501849286317)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741610118286317)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741703766286317)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(20741806441286317)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20739408543286303)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20739525543286306)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20739626234286306)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20739705328286306)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20739808861286306)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20739923730286306)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20740007822286307)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20740132140286307)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20740228418286307)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20740313271286307)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(20740425002286307)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20741919458286317)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20742008674286318)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20742125594286318)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20742217287286318)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20742329538286318)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20742426562286318)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(20742531973286318)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(20743208429286320)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(20743420183286321)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(20743303150286320)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(20743526654286323)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(20731031965286254)
,p_error_template=>wwv_flow_api.id(20727300260286246)
,p_printer_friendly_template=>wwv_flow_api.id(20733503287286264)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(20725824645286220)
,p_default_button_template=>wwv_flow_api.id(20742618149286318)
,p_default_region_template=>wwv_flow_api.id(20738901509286303)
,p_default_chart_template=>wwv_flow_api.id(20738901509286303)
,p_default_form_template=>wwv_flow_api.id(20738018054286301)
,p_default_reportr_template=>wwv_flow_api.id(20738901509286303)
,p_default_tabform_template=>wwv_flow_api.id(20738901509286303)
,p_default_wizard_template=>wwv_flow_api.id(20738018054286301)
,p_default_menur_template=>wwv_flow_api.id(20737504416286293)
,p_default_listr_template=>wwv_flow_api.id(20738901509286303)
,p_default_irr_template=>wwv_flow_api.id(20738420076286301)
,p_default_report_template=>wwv_flow_api.id(20740007822286307)
,p_default_label_template=>wwv_flow_api.id(20742125594286318)
,p_default_menu_template=>wwv_flow_api.id(20743208429286320)
,p_default_calendar_template=>wwv_flow_api.id(20743303150286320)
,p_default_list_template=>wwv_flow_api.id(20741610118286317)
,p_default_option_label=>wwv_flow_api.id(20742125594286318)
,p_default_required_label=>wwv_flow_api.id(20742426562286318)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(20743806162286323)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(20743620368286323)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(20743620368286323)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20745707683292565)
,p_plug_name=>'Combustible'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20738901509286303)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_plug_source_type=>'NATIVE_FLASH_CHART5'
);
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(20745919602292565)
,p_default_chart_type=>'2DColumn'
,p_chart_title=>'Combustible'
,p_chart_rendering=>'FLASH_PREFERRED'
,p_chart_name=>'chart_20745919602292565'
,p_chart_width=>1200
,p_chart_height=>500
,p_chart_animation=>'N'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(20746024056292567)
,p_chart_id=>wwv_flow_api.id(20745919602292565)
,p_series_seq=>10
...
'where fecha >= :P1_FECINIC and fecha <= :P1_FECFIN',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20746910510397465)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20747714450407975)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(20746910510397465)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20742618149286318)
,p_button_image_alt=>'Generar'
,p_button_position=>'REGION_TEMPLATE_CLOSE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20747214972402446)
,p_name=>'P1_FECINIC'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20746910510397465)
,p_prompt=>'Fecinic'
...
,p_field_template=>wwv_flow_api.id(20742125594286318)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20747411090404212)
,p_name=>'P1_FECFIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(20746910510397465)
,p_prompt=>'Fecfin'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20750201755484551)
,p_name=>'P1_UNIDAD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(20746910510397465)
,p_prompt=>'Unidad'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180228102858'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(20725824645286220)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180228100105'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20744113891286326)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20738018054286301)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20744425254286329)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(20744113891286326)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20744210319286328)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20744113891286326)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20744303649286329)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20744617844286329)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20744524074286329)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20744821914286329)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(20744708143286329)
,p_process_sequence=>10
