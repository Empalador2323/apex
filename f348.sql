...
,p_default_application_id=>348
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 348 - LP_REPORTE_CHECKLISTS
--
-- Application Export:
--   Application:     348
--   Name:            LP_REPORTE_CHECKLISTS
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,348)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_REPORTE_CHECKLISTS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_348')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'88139CB3ACA89C655D949D96380973C0C0BD5E705F0D8FDB5BB3C7DC6DBBD9E2'
...
,p_authentication_id=>wwv_flow_api.id(29669128245095100)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_REPORTE_CHECKLISTS'
...
,p_last_upd_yyyymmddhh24miss=>'20210322160721'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8813844775069850)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8813997711069850)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8814082552069850)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8814206939069850)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8814350221069850)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8814475163069850)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(29643408667991412)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(29668708632089006)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(29661423226991779)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(29662601260992039)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29643507226991426)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29643605926991434)
,p_page_template_id=>wwv_flow_api.id(29643507226991426)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29643720078991442)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29643800716991442)
,p_page_template_id=>wwv_flow_api.id(29643720078991442)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29643929976991442)
,p_page_template_id=>wwv_flow_api.id(29643720078991442)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644022642991442)
,p_page_template_id=>wwv_flow_api.id(29643720078991442)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644129628991442)
,p_page_template_id=>wwv_flow_api.id(29643720078991442)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644217287991442)
,p_page_template_id=>wwv_flow_api.id(29643720078991442)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29644302818991442)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644410976991442)
,p_page_template_id=>wwv_flow_api.id(29644302818991442)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644532090991442)
,p_page_template_id=>wwv_flow_api.id(29644302818991442)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644615379991442)
,p_page_template_id=>wwv_flow_api.id(29644302818991442)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644725534991442)
,p_page_template_id=>wwv_flow_api.id(29644302818991442)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644831650991442)
,p_page_template_id=>wwv_flow_api.id(29644302818991442)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29644926759991442)
,p_page_template_id=>wwv_flow_api.id(29644302818991442)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29645005722991442)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645113983991443)
,p_page_template_id=>wwv_flow_api.id(29645005722991442)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645213681991443)
,p_page_template_id=>wwv_flow_api.id(29645005722991442)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645300366991443)
,p_page_template_id=>wwv_flow_api.id(29645005722991442)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645412870991443)
,p_page_template_id=>wwv_flow_api.id(29645005722991442)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29645511859991443)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645601999991443)
,p_page_template_id=>wwv_flow_api.id(29645511859991443)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645727280991443)
,p_page_template_id=>wwv_flow_api.id(29645511859991443)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645805916991443)
,p_page_template_id=>wwv_flow_api.id(29645511859991443)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29645926857991443)
,p_page_template_id=>wwv_flow_api.id(29645511859991443)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646004475991443)
,p_page_template_id=>wwv_flow_api.id(29645511859991443)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29646112398991443)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646228184991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646325121991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646402613991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646513690991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646616970991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646713305991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646818355991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29646900576991443)
,p_page_template_id=>wwv_flow_api.id(29646112398991443)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29647000432991443)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647122900991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647214819991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647317873991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647431637991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647524493991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647614947991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647704720991443)
,p_page_template_id=>wwv_flow_api.id(29647000432991443)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29647822569991443)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29647912573991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648019263991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648108832991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648217762991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648326409991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648408426991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648512717991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648621778991445)
,p_page_template_id=>wwv_flow_api.id(29647822569991443)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29648719951991445)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648804991991445)
,p_page_template_id=>wwv_flow_api.id(29648719951991445)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29648913914991445)
,p_page_template_id=>wwv_flow_api.id(29648719951991445)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649018505991445)
,p_page_template_id=>wwv_flow_api.id(29648719951991445)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649101618991445)
,p_page_template_id=>wwv_flow_api.id(29648719951991445)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649221304991445)
,p_page_template_id=>wwv_flow_api.id(29648719951991445)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649301867991445)
,p_page_template_id=>wwv_flow_api.id(29648719951991445)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29649417390991445)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649529252991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649631791991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649714740991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649810904991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29649922355991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650025941991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650117089991446)
,p_page_template_id=>wwv_flow_api.id(29649417390991445)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29650206067991448)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650325463991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650418096991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650511079991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650614288991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650700026991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650804825991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29650923851991448)
,p_page_template_id=>wwv_flow_api.id(29650206067991448)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29651031308991448)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651108041991448)
,p_page_template_id=>wwv_flow_api.id(29651031308991448)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29651208117991448)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651323281991448)
,p_page_template_id=>wwv_flow_api.id(29651208117991448)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651422565991448)
,p_page_template_id=>wwv_flow_api.id(29651208117991448)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651528634991448)
,p_page_template_id=>wwv_flow_api.id(29651208117991448)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651631347991448)
,p_page_template_id=>wwv_flow_api.id(29651208117991448)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29651727335991448)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651811289991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29651908702991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652000710991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652100499991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652222528991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652311401991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652410596991448)
,p_page_template_id=>wwv_flow_api.id(29651727335991448)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29652531866991448)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652613163991448)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652715007991448)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652828095991448)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29652927922991448)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653032638991448)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653112385991448)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653230467991450)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653304426991450)
,p_page_template_id=>wwv_flow_api.id(29652531866991448)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29653423563991450)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653529112991450)
,p_page_template_id=>wwv_flow_api.id(29653423563991450)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653625680991450)
,p_page_template_id=>wwv_flow_api.id(29653423563991450)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653713816991450)
,p_page_template_id=>wwv_flow_api.id(29653423563991450)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653831216991450)
,p_page_template_id=>wwv_flow_api.id(29653423563991450)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653922369991450)
,p_page_template_id=>wwv_flow_api.id(29653423563991450)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654012345991450)
,p_page_template_id=>wwv_flow_api.id(29653423563991450)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(29654106115991451)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654201715991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654332313991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654417277991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654503250991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654603419991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654723755991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654804869991451)
,p_page_template_id=>wwv_flow_api.id(29654106115991451)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(29660310970991528)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(29660403483991546)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(29660531402991546)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(29660613102991546)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(29660724520991546)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(29660818147991546)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29654900020991453)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655018577991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655119223991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655225886991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655304401991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655408696991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655526789991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655606647991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655723633991460)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29655823242991462)
,p_plug_template_id=>wwv_flow_api.id(29655723633991460)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29655903275991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656004958991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656115564991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656206579991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29656311578991462)
,p_plug_template_id=>wwv_flow_api.id(29656206579991462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656406070991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656504914991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656623026991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29656726319991462)
,p_plug_template_id=>wwv_flow_api.id(29656623026991462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29656819517991462)
,p_plug_template_id=>wwv_flow_api.id(29656623026991462)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29656923482991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(29657030638991462)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658212213991484)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658328115991521)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658407677991521)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658503054991521)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658613801991521)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658703007991521)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658816105991521)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29658905930991521)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29659019520991521)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29659115967991521)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29659230082991521)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29659331130991521)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29659401520991521)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(29659532759991521)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657105273991468)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657208829991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657308432991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657421910991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657508486991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657621775991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657705787991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657822461991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29657932275991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29658020375991482)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(29658126860991482)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29659630311991523)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29659704560991528)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29659804256991528)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29659910581991528)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29660003053991528)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29660130311991528)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(29660206849991528)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(29660915236991546)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(29661126571991634)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(29661024066991571)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(29661210531991651)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(29648719951991445)
,p_error_template=>wwv_flow_api.id(29645005722991442)
,p_printer_friendly_template=>wwv_flow_api.id(29651208117991448)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(29643507226991426)
,p_default_button_template=>wwv_flow_api.id(29660310970991528)
,p_default_region_template=>wwv_flow_api.id(29656623026991462)
,p_default_chart_template=>wwv_flow_api.id(29656623026991462)
,p_default_form_template=>wwv_flow_api.id(29655723633991460)
,p_default_reportr_template=>wwv_flow_api.id(29656623026991462)
,p_default_tabform_template=>wwv_flow_api.id(29656623026991462)
,p_default_wizard_template=>wwv_flow_api.id(29655723633991460)
,p_default_menur_template=>wwv_flow_api.id(29655225886991460)
,p_default_listr_template=>wwv_flow_api.id(29656623026991462)
,p_default_irr_template=>wwv_flow_api.id(29656115564991462)
,p_default_report_template=>wwv_flow_api.id(29657705787991482)
,p_default_label_template=>wwv_flow_api.id(29659804256991528)
,p_default_menu_template=>wwv_flow_api.id(29660915236991546)
,p_default_calendar_template=>wwv_flow_api.id(29661024066991571)
,p_default_list_template=>wwv_flow_api.id(29659331130991521)
,p_default_option_label=>wwv_flow_api.id(29659804256991528)
,p_default_required_label=>wwv_flow_api.id(29660130311991528)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(29661513001991828)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(29669128245095100)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(29661316552991659)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(29661316552991659)
,p_tab_set=>'TS1'
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(29663332522996704)
,p_plug_name=>'DATOS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(29656623026991462)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(29666501925054103)
,p_plug_name=>'REPORTE'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(29656115564991462)
,p_plug_display_sequence=>30
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select a.nmsuper,cdclase||''-''||correlativo as unidad, a.cdresponsable,nombre_pila||'' ''||primer_apellido||''-''||segundo_apellido as responsable, a.comentario, a.fecha, a.evaluacion,f.tipo, ot, a.cdestacion,b.item,  c.descripcion,cumple ',
' from tsupervision a inner join  tcheklist_det b on a.nmsuper=b.nmsuper  inner join tcat_supervision c on b.evaluacion=c.nmexamen and b.item=c.item ',
' inner join tordenserv d on a.ot=d.nmorden inner join pipasgt.empleado e on a.cdresponsable=e.empleado',
' inner join (select  distinct(tipo), nmexamen from tcat_supervision  group by tipo,nmexamen)f on a.evaluacion=f.nmexamen',
' where a.evaluacion in (''4'',''5'',''6'',''9'',''10'') and a.fecha>=to_date (:P1_FECHA_INICIO,''dd/mm/yyyy'') and a.fecha <=to_date(:P1_FECHA_FIN,''dd/mm/yyyy'')'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P1_FECHA_FIN,P1_FECHA_INICIO'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(29666618362054103)
,p_name=>'REPORTE'
...
,p_owner=>'LP'
,p_internal_uid=>29666618362054103
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29666831014054121)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29666911550054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667024910054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667116783054125)
...
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'RESPONSABLE'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667232325054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667301640054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667412387054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667507788054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667611938054125)
,p_db_column_name=>'OT'
,p_display_order=>9
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667703145054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667814281054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29667917007054125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(29668031945054126)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(29668111276056850)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'296682'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMSUPER:UNIDAD:CDRESPONSABLE:RESPONSABLE:COMENTARIO:FECHA:EVALUACION:TIPO:OT:CDESTACION:ITEM:DESCRIPCION:CUMPLE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(29663527458004678)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(29663332522996704)
,p_button_name=>'ACTUALIZAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(29660310970991528)
,p_button_image_alt=>'Actualizar'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29663922496006587)
,p_name=>'P1_FECHA_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(29663332522996704)
...
,p_field_template=>wwv_flow_api.id(29659804256991528)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29664111007006587)
,p_name=>'P1_FECHA_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(29663332522996704)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(29665829368043120)
,p_name=>'ACTUALIZAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(29663527458004678)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(29666104996043126)
,p_event_id=>wwv_flow_api.id(29665829368043120)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(29666501925054103)
...
,p_step_template=>wwv_flow_api.id(29643507226991426)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180702092728'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(29661822412991968)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(29655723633991460)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(29662116732992032)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(29661822412991968)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29661910990992004)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(29661822412991968)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(29662017969992028)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(29662310484992039)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(29662203591992032)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(29662522612992039)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(29662428835992039)
,p_process_sequence=>10
