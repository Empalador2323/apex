...
prompt APPLICATION 329 - FACTU
--
-- Application Export:
--   Application:     329
--   Name:            FACTU
--   Date and Time:   12:32 Wednesday April 20, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,329)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'FACTU')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_329')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'350C35A2B5F40F7871769405B02F5F19D155A2FB511140246A580B05B2AD3044'
...
,p_authentication_id=>wwv_flow_api.id(42047813991958121)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:FACTU'
...
,p_last_upd_yyyymmddhh24miss=>'20181120100631'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8774045581061644)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8774196322061644)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8774201700061644)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8774461778061644)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8774536148061644)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8774609795061644)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(42029704913957956)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(42047724101958118)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(42053023341983785)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'Proveedores'
,p_tab_text=>'Proveedores'
,p_tab_step=>2
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(42048919853958154)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(42049916840958190)
,p_parent_id=>0
,p_short_name=>'Report'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42029810844957968)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42029906541957978)
,p_page_template_id=>wwv_flow_api.id(42029810844957968)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42030002143957982)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030129261957984)
,p_page_template_id=>wwv_flow_api.id(42030002143957982)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030230140957984)
,p_page_template_id=>wwv_flow_api.id(42030002143957982)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030324866957984)
,p_page_template_id=>wwv_flow_api.id(42030002143957982)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030408953957984)
,p_page_template_id=>wwv_flow_api.id(42030002143957982)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030526637957984)
,p_page_template_id=>wwv_flow_api.id(42030002143957982)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42030603183957984)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030704982957984)
,p_page_template_id=>wwv_flow_api.id(42030603183957984)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030814022957984)
,p_page_template_id=>wwv_flow_api.id(42030603183957984)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42030901308957984)
,p_page_template_id=>wwv_flow_api.id(42030603183957984)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031021391957984)
,p_page_template_id=>wwv_flow_api.id(42030603183957984)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031110796957984)
,p_page_template_id=>wwv_flow_api.id(42030603183957984)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031203121957984)
,p_page_template_id=>wwv_flow_api.id(42030603183957984)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42031303626957984)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031418332957985)
,p_page_template_id=>wwv_flow_api.id(42031303626957984)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031522374957985)
,p_page_template_id=>wwv_flow_api.id(42031303626957984)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031625470957985)
,p_page_template_id=>wwv_flow_api.id(42031303626957984)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031731537957985)
,p_page_template_id=>wwv_flow_api.id(42031303626957984)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42031807152957985)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42031928448957985)
,p_page_template_id=>wwv_flow_api.id(42031807152957985)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032019670957985)
,p_page_template_id=>wwv_flow_api.id(42031807152957985)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032123018957985)
,p_page_template_id=>wwv_flow_api.id(42031807152957985)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032226214957985)
,p_page_template_id=>wwv_flow_api.id(42031807152957985)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032322990957985)
,p_page_template_id=>wwv_flow_api.id(42031807152957985)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42032427282957985)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032512170957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032609031957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032719513957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032802500957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42032913762957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033007541957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033116535957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033215628957985)
,p_page_template_id=>wwv_flow_api.id(42032427282957985)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42033303830957985)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033401755957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033527882957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033626009957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033719900957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033819732957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42033912955957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034022142957987)
,p_page_template_id=>wwv_flow_api.id(42033303830957985)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42034127544957987)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034230298957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034317238957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034432311957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034502806957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034604786957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034730504957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034817019957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42034908297957987)
,p_page_template_id=>wwv_flow_api.id(42034127544957987)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42035003414957987)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035104055957987)
,p_page_template_id=>wwv_flow_api.id(42035003414957987)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035231300957987)
,p_page_template_id=>wwv_flow_api.id(42035003414957987)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035324355957987)
,p_page_template_id=>wwv_flow_api.id(42035003414957987)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035427235957987)
,p_page_template_id=>wwv_flow_api.id(42035003414957987)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035525986957987)
,p_page_template_id=>wwv_flow_api.id(42035003414957987)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035612829957987)
,p_page_template_id=>wwv_flow_api.id(42035003414957987)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42035701204957987)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035815555957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42035914458957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036009900957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036124583957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036224669957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036309311957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036408575957989)
,p_page_template_id=>wwv_flow_api.id(42035701204957987)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42036512186957990)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036617532957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036728799957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036809243957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42036913053957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037021118957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037114699957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037203394957990)
,p_page_template_id=>wwv_flow_api.id(42036512186957990)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42037302958957992)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037415550957992)
,p_page_template_id=>wwv_flow_api.id(42037302958957992)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42037512251957992)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037609349957992)
,p_page_template_id=>wwv_flow_api.id(42037512251957992)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037718547957992)
,p_page_template_id=>wwv_flow_api.id(42037512251957992)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037816835957992)
,p_page_template_id=>wwv_flow_api.id(42037512251957992)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42037926820957992)
,p_page_template_id=>wwv_flow_api.id(42037512251957992)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42038014347957992)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038114808957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038212201957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038331415957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038414496957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038526475957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038613264957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038725725957992)
,p_page_template_id=>wwv_flow_api.id(42038014347957992)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42038800001957992)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42038917940957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039017092957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039130961957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039211622957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039302297957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039409325957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039519486957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039617489957992)
,p_page_template_id=>wwv_flow_api.id(42038800001957992)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42039710674957992)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039828791957992)
,p_page_template_id=>wwv_flow_api.id(42039710674957992)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42039923961957992)
,p_page_template_id=>wwv_flow_api.id(42039710674957992)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040031126957992)
,p_page_template_id=>wwv_flow_api.id(42039710674957992)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040100969957992)
,p_page_template_id=>wwv_flow_api.id(42039710674957992)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040201796957992)
,p_page_template_id=>wwv_flow_api.id(42039710674957992)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040331776957992)
,p_page_template_id=>wwv_flow_api.id(42039710674957992)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(42040423211957992)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040508054957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040620881957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040707795957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040815154957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42040901945957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42041022566957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(42041111635957993)
,p_page_template_id=>wwv_flow_api.id(42040423211957992)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42046623241958057)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42046718966958067)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42046819403958067)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42046912540958067)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42047001513958067)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(42047116573958067)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041205317958000)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041318167958012)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041430402958012)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041531609958012)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041617665958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041726809958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041816134958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42041925849958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042021973958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42042106178958014)
,p_plug_template_id=>wwv_flow_api.id(42042021973958014)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042221024958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042322104958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042415372958014)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042515248958015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42042616123958015)
,p_plug_template_id=>wwv_flow_api.id(42042515248958015)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042713066958015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042814361958015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42042909910958015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42043012453958015)
,p_plug_template_id=>wwv_flow_api.id(42042909910958015)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(42043123024958015)
,p_plug_template_id=>wwv_flow_api.id(42042909910958015)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42043217699958015)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(42043316409958017)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42044506974958035)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42044614970958043)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42044704564958043)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42044808319958043)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42044927911958043)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045011357958043)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045126925958043)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045214642958043)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045329526958043)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045427569958045)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045519814958045)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045613494958045)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045705828958045)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(42045810592958045)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42043430976958018)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42043517137958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42043616977958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42043713768958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42043817325958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42043929143958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42044016983958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42044107519958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42044232053958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42044314955958025)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(42044411585958025)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42045918525958046)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42046004976958056)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42046109246958056)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42046203804958056)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42046316189958056)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42046410713958056)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(42046531714958056)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(42047232268958071)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(42047431815958090)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(42047329375958082)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(42047530951958096)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(42035003414957987)
,p_error_template=>wwv_flow_api.id(42031303626957984)
,p_printer_friendly_template=>wwv_flow_api.id(42037512251957992)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(42029810844957968)
,p_default_button_template=>wwv_flow_api.id(42046623241958057)
,p_default_region_template=>wwv_flow_api.id(42042909910958015)
,p_default_chart_template=>wwv_flow_api.id(42042909910958015)
,p_default_form_template=>wwv_flow_api.id(42042021973958014)
,p_default_reportr_template=>wwv_flow_api.id(42042909910958015)
,p_default_tabform_template=>wwv_flow_api.id(42042909910958015)
,p_default_wizard_template=>wwv_flow_api.id(42042021973958014)
,p_default_menur_template=>wwv_flow_api.id(42041531609958012)
,p_default_listr_template=>wwv_flow_api.id(42042909910958015)
,p_default_irr_template=>wwv_flow_api.id(42042415372958014)
,p_default_report_template=>wwv_flow_api.id(42044016983958025)
,p_default_label_template=>wwv_flow_api.id(42046109246958056)
,p_default_menu_template=>wwv_flow_api.id(42047232268958071)
,p_default_calendar_template=>wwv_flow_api.id(42047329375958082)
,p_default_list_template=>wwv_flow_api.id(42045613494958045)
,p_default_option_label=>wwv_flow_api.id(42046109246958056)
,p_default_required_label=>wwv_flow_api.id(42046410713958056)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(42047813991958121)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(42047623064958100)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(42047623064958100)
,p_tab_set=>'TS1'
,p_name=>'Report'
,p_step_title=>'Report'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20181120100605'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42049329538958164)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42042415372958014)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select b.nmnota, a.fechasale, nodocto, galones  from tnotaviaje a inner join tdetnota b on a.nmnota=b.nmnota   where cdclaseuni=:P1_TRANSPORTISTA and fechasale>=:P1_FECHA_INICIAL and fechasale<=:P1_FECHA_FINAL'
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P1_TRANSPORTISTA,P1_FECHA_FINAL,P1_FECHA_INICIAL'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(42049430966958165)
,p_name=>'Report'
...
,p_owner=>'LP'
,p_internal_uid=>42049430966958165
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42049506967958182)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42049603793958185)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42049724351958185)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42049800695958187)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(42050311519958868)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'420504'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMNOTA:FECHASALE:NODOCTO:GALONES'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42052220439980371)
,p_plug_name=>'FACTU'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42042909910958015)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42060213316139153)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42041531609958012)
,p_plug_display_sequence=>1
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(42048919853958154)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(42047232268958071)
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42056823652022482)
,p_name=>'P1_FECHA_FINAL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(42052220439980371)
...
,p_field_template=>wwv_flow_api.id(42046109246958056)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42057010529022482)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42057219038022484)
,p_name=>'P1_TRANSPORTISTA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(42052220439980371)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42053104294985231)
,p_plug_name=>'datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42042909910958015)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42054422217009262)
,p_plug_name=>'report'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42042415372958014)
...
'select sum(cantdespacha) cantidad , ''GALONES'' DES , :P2_TRANSPORTISTA ,:P2_FECHA_INICIAL,:P2_FECHA_FINAL from tvales where cdclasact=:P2_TRANSPORTISTA  and fecha>=:P2_FECHA_INICIAL and fecha<=:P2_FECHA_FINAL',
'union all ',
'Select sum (galones) cantidad ,''TONELADAS'' DES, :P2_TRANSPORTISTA ,:P2_FECHA_INICIAL,:P2_FECHA_FINAL from tnotaviaje a inner join tdetnota b on a.nmnota=b.nmnota   where cdclaseuni=:P2_TRANSPORTISTA and fechasale>=:P2_FECHA_INICIAL and fechasale<=:P2'
||'_FECHA_FINAL'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P2_TRANSPORTISTA,P2_FECHA_INICIAL,P2_FECHA_FINAL'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(42054519352009262)
,p_name=>'report'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_owner=>'LP'
,p_internal_uid=>42054519352009262
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42054705521009270)
,p_db_column_name=>'CANTIDAD'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Cantidad'
,p_column_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_FECHA_FINAL,P3_FECHA_INICIAL,P3_TRANSPORTISTA:#:P2_FECHA_FINAL#,#:P2_FECHA_INICIAL#,#:P2_TRANSPORTISTA#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42054830645009271)
,p_db_column_name=>'DES'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Des'
,p_column_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.::P1_FECHA_FINAL,P1_FECHA_INICIAL,P1_TRANSPORTISTA:#:P2_FECHA_FINAL#,#:P2_FECHA_INICIAL#,#:P2_TRANSPORTISTA#'
,p_column_linktext=>'#DES#'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42058216043101979)
,p_db_column_name=>':P2_TRANSPORTISTA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>':P2 Transportista'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>':P2_TRANSPORTISTA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42058312126101981)
,p_db_column_name=>':P2_FECHA_INICIAL'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>':P2 Fecha Inicial'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>':P2_FECHA_INICIAL'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42058410902101981)
,p_db_column_name=>':P2_FECHA_FINAL'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>':P2 Fecha Final'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>':P2_FECHA_FINAL'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(42054923603009679)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'420550'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CANTIDAD:DES'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(42053311566987325)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(42053104294985231)
,p_button_name=>'ACTUALIZAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(42046623241958057)
,p_button_image_alt=>'Actualizar'
,p_button_position=>'TOP'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42053727990990043)
,p_name=>'P2_TRANSPORTISTA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(42053104294985231)
,p_prompt=>'Transportista'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42053904194990043)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42054115130990043)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20181120100118'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42061020429155935)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select  fecha, notaviaje,nmvale, cantdespacha from tvales where cdclasact=:P3_TRANSPORTISTA and fecha>=:P3_FECHA_INICIAL and fecha<=:P3_FECHA_FINAL'
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P3_TRANSPORTISTA,P3_FECHA_FINAL,P3_FECHA_INICIAL'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(42061120852155935)
,p_name=>'Report 1'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>42061120852155935
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42061300665155946)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42061411686155946)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42061525802155946)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(42061613145155946)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(42061706306156075)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'420618'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'FECHA:NOTAVIAJE:NMVALE:CANTDESPACHA'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42062525266158484)
,p_name=>'P3_FECHA_INICIAL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(42061020429155935)
,p_prompt=>'Fecha Inicial'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42062725387158484)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42062906317158484)
,p_name=>'P3_TRANSPORTISTA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(42061020429155935)
,p_prompt=>'Transportista'
,p_display_as=>'NATIVE_HIDDEN'
...
,p_step_template=>wwv_flow_api.id(42029810844957968)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20181120092619'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(42048104683958132)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(42042021973958014)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(42048413232958150)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(42048104683958132)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42048216430958139)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(42048104683958132)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(42048326450958146)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42048629774958153)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42048509255958150)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42048815739958153)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(42048703796958153)
,p_process_sequence=>10
