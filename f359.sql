...
,p_default_application_id=>359
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 359 - LP_BITACORA
--
-- Application Export:
--   Application:     359
--   Name:            LP_BITACORA
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,359)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'LP_BITACORA')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_359')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'037987DE570CD712215DE27C3C2545320A92323B63D6E796A2936599E9CCE271'
...
,p_authentication_id=>wwv_flow_api.id(31848004177346346)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:LP_BITACORA'
...
,p_last_upd_yyyymmddhh24miss=>'20210322112024'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(31851008669346604)
,p_name=>'Navigation'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8830164387071990)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8830262143071990)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8830308669071990)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8830581053071990)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8830655731071990)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8830735744071990)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(31829829497346200)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(32322926047443639)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(31847818819346340)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(31849416024346378)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_INCIDENCIA'
,p_tab_text=>'Mis Incidencia'
,p_tab_step=>1
,p_tab_also_current_for_pages=>'2'
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(32652419198303950)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'Reporte Incidencias'
,p_tab_text=>'Reporte Incidencias'
,p_tab_step=>4
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(31849108964346367)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31851131460346612)
,p_parent_id=>0
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31855017780346806)
,p_parent_id=>wwv_flow_api.id(31851131460346612)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31829907926346214)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830028104346225)
,p_page_template_id=>wwv_flow_api.id(31829907926346214)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31830127141346232)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830221395346232)
,p_page_template_id=>wwv_flow_api.id(31830127141346232)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830320820346232)
,p_page_template_id=>wwv_flow_api.id(31830127141346232)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830417377346232)
,p_page_template_id=>wwv_flow_api.id(31830127141346232)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830529030346232)
,p_page_template_id=>wwv_flow_api.id(31830127141346232)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830620253346234)
,p_page_template_id=>wwv_flow_api.id(31830127141346232)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31830723995346234)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830807323346234)
,p_page_template_id=>wwv_flow_api.id(31830723995346234)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31830901979346234)
,p_page_template_id=>wwv_flow_api.id(31830723995346234)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831007897346234)
,p_page_template_id=>wwv_flow_api.id(31830723995346234)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831115230346234)
,p_page_template_id=>wwv_flow_api.id(31830723995346234)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831223894346234)
,p_page_template_id=>wwv_flow_api.id(31830723995346234)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831331338346234)
,p_page_template_id=>wwv_flow_api.id(31830723995346234)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31831419032346234)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831501005346235)
,p_page_template_id=>wwv_flow_api.id(31831419032346234)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831620528346235)
,p_page_template_id=>wwv_flow_api.id(31831419032346234)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831725267346235)
,p_page_template_id=>wwv_flow_api.id(31831419032346234)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31831803295346235)
,p_page_template_id=>wwv_flow_api.id(31831419032346234)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31831926915346235)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832025655346237)
,p_page_template_id=>wwv_flow_api.id(31831926915346235)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832114873346237)
,p_page_template_id=>wwv_flow_api.id(31831926915346235)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832230651346237)
,p_page_template_id=>wwv_flow_api.id(31831926915346235)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832323307346237)
,p_page_template_id=>wwv_flow_api.id(31831926915346235)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832400240346237)
,p_page_template_id=>wwv_flow_api.id(31831926915346235)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31832527415346237)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832619938346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832701717346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832802312346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31832910753346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833021707346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833107128346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833226713346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833308760346239)
,p_page_template_id=>wwv_flow_api.id(31832527415346237)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31833405775346239)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833501191346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833618720346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833717298346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833820801346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31833931705346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834019581346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834115368346240)
,p_page_template_id=>wwv_flow_api.id(31833405775346239)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31834203978346240)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834311507346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834425132346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834527042346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834609865346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834719160346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834807042346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31834920640346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835005354346242)
,p_page_template_id=>wwv_flow_api.id(31834203978346240)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31835118580346242)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835205547346242)
,p_page_template_id=>wwv_flow_api.id(31835118580346242)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835325066346243)
,p_page_template_id=>wwv_flow_api.id(31835118580346242)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835432581346243)
,p_page_template_id=>wwv_flow_api.id(31835118580346242)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835508293346243)
,p_page_template_id=>wwv_flow_api.id(31835118580346242)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835622306346243)
,p_page_template_id=>wwv_flow_api.id(31835118580346242)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835707610346243)
,p_page_template_id=>wwv_flow_api.id(31835118580346242)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31835817849346243)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31835921771346243)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836015474346245)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836124199346245)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836228361346245)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836306481346245)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836420523346245)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836522581346245)
,p_page_template_id=>wwv_flow_api.id(31835817849346243)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31836625462346245)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836718908346245)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836810791346245)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31836906012346245)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837014494346245)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837109524346246)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837212798346246)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837303478346246)
,p_page_template_id=>wwv_flow_api.id(31836625462346245)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31837400404346246)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837528176346250)
,p_page_template_id=>wwv_flow_api.id(31837400404346246)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31837624776346250)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837729741346250)
,p_page_template_id=>wwv_flow_api.id(31837624776346250)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837826625346250)
,p_page_template_id=>wwv_flow_api.id(31837624776346250)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31837925575346250)
,p_page_template_id=>wwv_flow_api.id(31837624776346250)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838024082346250)
,p_page_template_id=>wwv_flow_api.id(31837624776346250)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31838105508346250)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838201275346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838315796346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838405155346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838517636346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838614179346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838704872346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31838806000346251)
,p_page_template_id=>wwv_flow_api.id(31838105508346250)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31838904937346251)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839029572346251)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839124406346251)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839232093346253)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839303150346253)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839418409346253)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839502939346253)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839632310346253)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839701878346253)
,p_page_template_id=>wwv_flow_api.id(31838904937346251)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31839804991346253)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31839910636346253)
,p_page_template_id=>wwv_flow_api.id(31839804991346253)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840032366346253)
,p_page_template_id=>wwv_flow_api.id(31839804991346253)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840122780346253)
,p_page_template_id=>wwv_flow_api.id(31839804991346253)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840210476346253)
,p_page_template_id=>wwv_flow_api.id(31839804991346253)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840320197346253)
,p_page_template_id=>wwv_flow_api.id(31839804991346253)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840423318346254)
,p_page_template_id=>wwv_flow_api.id(31839804991346253)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31840528861346254)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840623342346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840714447346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840805537346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31840912005346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31841012152346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31841109521346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31841215062346254)
,p_page_template_id=>wwv_flow_api.id(31840528861346254)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31846719367346309)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31846805099346314)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31846928983346314)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31847008692346314)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31847125421346314)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(31847214317346314)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841332439346257)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841412362346264)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841504890346264)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841608470346265)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841700224346265)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841807631346265)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31841918957346265)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842022992346267)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842121022346267)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31842230587346267)
,p_plug_template_id=>wwv_flow_api.id(31842121022346267)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842324878346270)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842429250346270)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842514892346271)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842606885346271)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31842710860346273)
,p_plug_template_id=>wwv_flow_api.id(31842606885346271)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842824434346273)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31842920210346273)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31843029666346273)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31843112367346275)
,p_plug_template_id=>wwv_flow_api.id(31843029666346273)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(31843212652346275)
,p_plug_template_id=>wwv_flow_api.id(31843029666346273)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31843322507346275)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(31843431203346275)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31844624079346292)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31844705982346296)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31844820990346296)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31844906070346298)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845025664346298)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845108331346298)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845219004346298)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845301168346298)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845426071346300)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845506698346300)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845605529346300)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845721243346300)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845822132346300)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(31845929244346301)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31843512803346278)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31843627069346281)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31843732214346282)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31843830353346282)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31843918854346284)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31844004400346284)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31844104768346285)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31844220903346285)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31844310446346285)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31844426824346285)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(31844532145346285)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846029911346303)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846129280346306)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846217880346307)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846328348346307)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846400666346307)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846518463346307)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(31846614140346307)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(31847331800346317)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(31847519672346325)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(31847422341346320)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(31847613022346335)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(31835118580346242)
,p_error_template=>wwv_flow_api.id(31831419032346234)
,p_printer_friendly_template=>wwv_flow_api.id(31837624776346250)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(31829907926346214)
,p_default_button_template=>wwv_flow_api.id(31846719367346309)
,p_default_region_template=>wwv_flow_api.id(31843029666346273)
,p_default_chart_template=>wwv_flow_api.id(31843029666346273)
,p_default_form_template=>wwv_flow_api.id(31842121022346267)
,p_default_reportr_template=>wwv_flow_api.id(31843029666346273)
,p_default_tabform_template=>wwv_flow_api.id(31843029666346273)
,p_default_wizard_template=>wwv_flow_api.id(31842121022346267)
,p_default_menur_template=>wwv_flow_api.id(31841608470346265)
,p_default_listr_template=>wwv_flow_api.id(31843029666346273)
,p_default_irr_template=>wwv_flow_api.id(31842514892346271)
,p_default_report_template=>wwv_flow_api.id(31844104768346285)
,p_default_label_template=>wwv_flow_api.id(31846217880346307)
,p_default_menu_template=>wwv_flow_api.id(31847331800346317)
,p_default_calendar_template=>wwv_flow_api.id(31847422341346320)
,p_default_list_template=>wwv_flow_api.id(31845721243346300)
,p_default_option_label=>wwv_flow_api.id(31846217880346307)
,p_default_required_label=>wwv_flow_api.id(31846518463346307)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(31852030076346696)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31847907450346346)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(31848004177346346)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(31847710091346339)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(31847710091346339)
,p_tab_set=>'TS1'
,p_name=>'Incidencia'
,p_alias=>'HOME'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20181203145635'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31849531083346504)
,p_plug_name=>'INCIDENCIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31842514892346271)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31849601392346506)
,p_name=>'INCIDENCIA'
...
,p_detail_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_ID,p3_status,P3_COMENTARIO:#ID#,#STATUS#,#COMENTARIO#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="Edit" />'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>31849601392346506
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31849716753346525)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31849808366346531)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31849923785346535)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850009111346542)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850111065346548)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850208079346556)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850319197346562)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850416975346568)
,p_db_column_name=>'KM'
,p_display_order=>8
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850511395346575)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850632010346581)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'TIPO_REPORTE'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850713156346587)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850830737346593)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31850913723346601)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31855407727347220)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'318555'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ID:FECHA:USUARIO:COD_EMP:CDCLASE:CORRELATIVO:CDESTACION:KM:DEPARTAMENTO:TIPO_REPORTE:COMENTARIO:STATUS:ASIGNADO'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31851206536346615)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31841608470346265)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(31849108964346367)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(31847331800346317)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31891029647836117)
,p_plug_name=>'INCIDENCIA'
,p_region_name=>'NEW'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31842606885346271)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31891210360836118)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31891029647836117)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31846719367346309)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31891416543836118)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31854905379346800)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31849531083346504)
,p_button_name=>'NUEVO'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31846719367346309)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31891605355836123)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31891812098836125)
,p_name=>'P1_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
...
,p_field_template=>wwv_flow_api.id(31846217880346307)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31892009374836135)
,p_name=>'P1_FECHA'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(31846518463346307)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31892217787836140)
,p_name=>'P1_USUARIO'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31892409952836145)
,p_name=>'P1_COD_EMP'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31892615932836150)
,p_name=>'P1_CDCLASE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31892800137836154)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31893014705836164)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31893212649836168)
,p_name=>'P1_KM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31893418950836173)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31893601519836178)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31893803642836182)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31894016666836187)
,p_name=>'P1_STATUS'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31894215912836192)
,p_name=>'P1_ASIGNADO'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select cod_emp||'' '' || nombre, cod_emp from  pa_usuarios where cod_emp is not null and estado=''A''  and proyecto=1'
,p_cSize=>32
,p_cMaxlength=>20
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31897416141940246)
,p_name=>'P1_GUIONES'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
,p_prompt=>'Guiones'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31897626789940250)
,p_name=>'P1_UNIDAD'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31891029647836117)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31907528195356073)
,p_name=>'numero'
,p_event_sequence=>5
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31854905379346800)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31907820703356073)
,p_event_id=>wwv_flow_api.id(31907528195356073)
,p_event_result=>'TRUE'
...
'begin ',
'select max(nvl(id,1))+1 into :P1_ID from incidencia;',
'end;'))
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31895216749851323)
,p_name=>'ABRIR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31854905379346800)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31895515861851329)
,p_event_id=>wwv_flow_api.id(31895216749851323)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31898511143019932)
,p_name=>'asignar'
,p_event_sequence=>20
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31898807378019932)
,p_event_id=>wwv_flow_api.id(31898511143019932)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31898910581029275)
,p_name=>'UNIDAD'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31899204949029275)
,p_event_id=>wwv_flow_api.id(31898910581029275)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_attribute_04=>'SUBSTR(:p1_UNIDAD, 1, instr(:P1_UNIDAD,''-'',1, :P1_GUIONES)-1)'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31899405931036200)
,p_event_id=>wwv_flow_api.id(31898910581029275)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31900720717088995)
,p_name=>'asignar'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31901030578088995)
,p_event_id=>wwv_flow_api.id(31900720717088995)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_USUARIO'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>':APP_USER'
,p_attribute_07=>'P1_UNIDAD'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31902103940097909)
,p_event_id=>wwv_flow_api.id(31900720717088995)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(32382221245915853)
,p_name=>'cerrar modal'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31891416543836118)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32382527838915875)
,p_event_id=>wwv_flow_api.id(32382221245915853)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(31891029647836117)
,p_attribute_01=>'closeModal(''NEW'');'
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31894623698836193)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31894811630836193)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31895030193836193)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32401212269140340)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31906226632317790)
,p_process_sequence=>50
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'nmorden'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
'select max(ID)+1 into :P1_ID from incidencia;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31854905379346800)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180727171307'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31851527732346689)
,p_plug_name=>'Edit INCIDENCIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31842121022346267)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31855118410346807)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31841608470346265)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31857007297366003)
,p_plug_name=>'Form on TDET_INCIDENCIA'
,p_region_name=>'NEW'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31842606885346271)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31865302280402403)
,p_plug_name=>'report'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31842514892346271)
...
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>'select * from tdet_incidencia where id_incidencia=:P2_ID'
,p_plug_source_type=>'NATIVE_IR'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31865429297402404)
,p_name=>'report'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'LP'
,p_internal_uid=>31865429297402404
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31865619318402410)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31865702310402410)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31865832100402412)
,p_db_column_name=>'FECHA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31865911756402412)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31866028988402414)
,p_db_column_name=>'USUARIO'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Usuario'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31873913764509732)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'318740'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31862622534370398)
,p_button_sequence=>200
,p_button_plug_id=>wwv_flow_api.id(31851527732346689)
,p_button_name=>'P2_SEGUIMIENTO'
,p_button_static_id=>'P2_SEGUIMIENTO'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31847008692346314)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31857315438366009)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31857007297366003)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31846719367346309)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31851618706346690)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31851527732346689)
,p_button_name=>'CANCEL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31857631643366010)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31857007297366003)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31851805787346690)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31851527732346689)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31851917392346690)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31857215480366009)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31857007297366003)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31851708618346690)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31857422981366009)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31857007297366003)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31852125800346703)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31858227270366014)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31852217965346707)
,p_name=>'P2_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Id'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31852316603346712)
,p_name=>'P2_FECHA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31852503607346723)
,p_name=>'P2_USUARIO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31852726870346729)
,p_name=>'P2_COD_EMP'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31852916314346734)
,p_name=>'P2_CDCLASE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31853127360346740)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31853312341346745)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31853519022346751)
,p_name=>'P2_KM'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31853718523346757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31853917037346762)
,p_name=>'P2_TIPO_REPORTE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Tipo Reporte'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31854101402346768)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31854302900346773)
,p_name=>'P2_STATUS'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31854527590346779)
,p_name=>'P2_ASIGNADO'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31858423932366018)
,p_name=>'P2_ROWID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31857007297366003)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31858606938366035)
,p_name=>'P2_ID_INCIDENCIA'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(31857007297366003)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Id Incidencia'
,p_source=>'ID_INCIDENCIA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31858827941366042)
,p_name=>'P2_ID_DET_INCIDENCIA'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(31857007297366003)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Id Det Incidencia'
,p_source=>'ID_DET_INCIDENCIA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31859218422366054)
,p_name=>'P2_DES_SEGUIMIENTO'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(31857007297366003)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Des Seguimiento'
,p_source=>'DES_SEGUIMIENTO'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>60
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31866612476410196)
,p_name=>'P2_UNIDAD'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_prompt=>'Unidad'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31867131873416373)
,p_name=>'P2_GUIONES'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(31851527732346689)
,p_prompt=>'Guiones'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31863716778378210)
,p_name=>'agrear_seguimiento'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31862622534370398)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31864021059378212)
,p_event_id=>wwv_flow_api.id(31863716778378210)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31867526999418993)
,p_name=>'guiones'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31867815686418995)
,p_event_id=>wwv_flow_api.id(31867526999418993)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31867926783428323)
,p_name=>'asignar'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31868203365428325)
,p_event_id=>wwv_flow_api.id(31867926783428323)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
'SUBSTR(:p2_UNIDAD, 1, instr(:P2_UNIDAD,''-'',1, :P2_GUIONES)-1)',
''))
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31868424528435001)
,p_event_id=>wwv_flow_api.id(31867926783428323)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31873010170499223)
,p_name=>'cerrada'
,p_event_sequence=>40
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
,p_display_when_type=>'EXISTS'
,p_display_when_cond=>'Select 1 from incidencia where status=''C'''
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31873302462499228)
,p_event_id=>wwv_flow_api.id(31873010170499223)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DISABLE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P2_ID,P2_FECHA,P2_ROWID,P2_USUARIO,P2_COD_EMP,P2_CDCLASE,P2_CORRELATIVO,P2_CDESTACION,P2_KM,P2_DEPARTAMENTO,P2_TIPO_REPORTE,P2_COMENTARIO,P2_ID_INCIDENCIA,P2_STATUS,P2_ASIGNADO,P2_ID_DET_INCIDENCIA,P2_FECHA_1,P2_DES_SEGUIMIENTO,P2_USUARIO_1,P2_UNIDAD'
||',P2_GUIONES'
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31879932521619298)
,p_name=>'asignar'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31880227137619300)
,p_event_id=>wwv_flow_api.id(31879932521619298)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P2_USUARIO_1,P2_USUARIO'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>':APP_USER'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31880711872623131)
,p_event_id=>wwv_flow_api.id(31879932521619298)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P2_FECHA,P2_FECHA_1'
,p_attribute_01=>'PLSQL_EXPRESSION'
,p_attribute_04=>'sysdate'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31913507398548751)
,p_process_sequence=>50
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'load'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31862030265366079)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31857422981366009)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>3
,p_user_interface_id=>wwv_flow_api.id(31847710091346339)
,p_name=>'Detalle Incidencia'
,p_step_title=>'Detalle Incidencia'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190104094851'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31914314586569796)
,p_plug_name=>'TDET_INCIDENCIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31843029666346273)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31917626707573240)
,p_plug_name=>'INCIDENCIA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31843029666346273)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31922028045895396)
...
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'select fecha, des_seguimiento, usuario from tdet_incidencia where id_incidencia=:P3_ID'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P3_ID_INCIDENCIA'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31922120754895396)
,p_name=>'SEGUIMIENTO'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>31922120754895396
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31922528334895409)
,p_db_column_name=>'FECHA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31922612930895409)
,p_db_column_name=>'DES_SEGUIMIENTO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Des Seguimiento'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31922728361895409)
,p_db_column_name=>'USUARIO'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Usuario'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31922828738895601)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'319229'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'FECHA:DES_SEGUIMIENTO:USUARIO'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31914708769569800)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31914314586569796)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(31846719367346309)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31914504314569798)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31914314586569796)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
,p_button_image_alt=>'Create'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'select 1 from incidencia where :P3_STATUS=''A'' and id=:P3_ID'
,p_button_condition_type=>'EXISTS'
,p_grid_new_grid=>false
,p_database_action=>'INSERT'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32338404624160542)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31917626707573240)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31914908254569801)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31915110652569806)
,p_name=>'P3_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Rowid'
,p_source=>'ROWID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31915301695569815)
,p_name=>'P3_ID_INCIDENCIA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
,p_use_cache_before_default=>'NO'
,p_item_default=>':p3_ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31915512382569820)
,p_name=>'P3_ID_DET_INCIDENCIA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Id Det Incidencia'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31915730722569825)
,p_name=>'P3_FECHA'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31915922930569831)
,p_name=>'P3_DES_SEGUIMIENTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Des Seguimiento'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31916120760569835)
,p_name=>'P3_USUARIO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31918013859625059)
,p_name=>'P3_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(31917626707573240)
,p_prompt=>'Id'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
,p_cAttributes=>'nowrap'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(31846129280346306)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31918219492625059)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32337202884092567)
,p_name=>'P3_STATUS'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(31917626707573240)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(45346207375547185)
,p_name=>'P3_USUARIO2'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(31914314586569796)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(32531632052342925)
,p_name=>'cerrar'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(32338404624160542)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32531919366342931)
,p_event_id=>wwv_flow_api.id(32531632052342925)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'update incidencia set status=''C'' where id=:p3_Id;',
'end;'))
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32532715426350371)
,p_event_id=>wwv_flow_api.id(32531632052342925)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31917002780569840)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from TDET_INCIDENCIA'
,p_attribute_02=>'TDET_INCIDENCIA'
,p_attribute_03=>'P3_ROWID'
,p_attribute_04=>'ROWID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32693217170995192)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'update asignacion'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
'update incidencia set asignado=:P3_USUARIO where id=:P3_ID;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31914504314569798)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31917214591569840)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TDET_INCIDENCIA'
,p_attribute_02=>'TDET_INCIDENCIA'
,p_attribute_03=>'P3_ROWID'
,p_attribute_04=>'ROWID'
,p_attribute_11=>'I'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31917406014569840)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20181004093622'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32652522230303951)
...
'a.DEPARTAMENTO,',
'a.TIPO_REPORTE,',
'(select b.descripcion  from t_tip_reporte b where b.id=a.tipo_reporte) descripcion,',
'a.COMENTARIO,',
'a.STATUS,',
'a.ASIGNADO',
' from   INCIDENCIA a'))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(32652630036303951)
,p_name=>'Incidencias'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_icon_view_columns_per_row=>1
,p_owner=>'LP'
,p_internal_uid=>32652630036303951
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32652827543303981)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32652932544303984)
,p_db_column_name=>'FECHA'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Fecha'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653024463303984)
,p_db_column_name=>'USUARIO'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Usuario'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653126294303984)
,p_db_column_name=>'COD_EMP'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Cod Emp'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653205060303984)
,p_db_column_name=>'CDCLASE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Cdclase'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653317576303984)
,p_db_column_name=>'CORRELATIVO'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Correlativo'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653419109303984)
,p_db_column_name=>'CDESTACION'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cdestacion'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653510114303984)
,p_db_column_name=>'KM'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Km'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653610219303984)
,p_db_column_name=>'DEPARTAMENTO'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Departamento'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653720877303984)
,p_db_column_name=>'TIPO_REPORTE'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Tipo Reporte'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653830095303984)
,p_db_column_name=>'COMENTARIO'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Comentario'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32653911679303984)
,p_db_column_name=>'STATUS'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Status'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32654006868303985)
,p_db_column_name=>'ASIGNADO'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'Asignado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(38230608762199129)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(32654116263304189)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'326542'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'ID:FECHA:USUARIO:COD_EMP:CDCLASE:CORRELATIVO:CDESTACION:KM:DEPARTAMENTO:DESCRIPCION:COMENTARIO:STATUS:ASIGNADO:'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180730110018'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(32663531137457792)
,p_name=>'Detalle'
,p_template=>wwv_flow_api.id(31843029666346273)
...
,p_query_type=>'SQL'
,p_source=>'select fecha, des_seguimiento, usuario from tdet_incidencia where id_incidencia=:P5_ID'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P5_ID'
,p_fixed_header=>'NONE'
,p_query_row_template=>wwv_flow_api.id(31844104768346285)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32663800958457798)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32663917430457798)
,p_query_column_id=>2
,p_column_alias=>'DES_SEGUIMIENTO'
,p_column_display_sequence=>2
,p_column_heading=>'DES_SEGUIMIENTO'
,p_disable_sort_column=>'N'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32664011738457800)
,p_query_column_id=>3
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32665217929475025)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(32663531137457792)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32664304575460793)
,p_name=>'P5_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(32663531137457792)
,p_prompt=>'Id'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
,p_step_template=>wwv_flow_api.id(31829907926346214)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180720085821'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31848313723346354)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(31842121022346267)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31848618127346359)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31848313723346354)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31848410410346359)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31848313723346354)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31848530967346359)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31848813786346365)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31848719938346360)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31849007503346367)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31848909618346365)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
