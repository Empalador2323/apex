...
prompt APPLICATION 500 - Ingreso_OT
--
-- Application Export:
--   Application:     500
--   Name:            Ingreso_OT
--   Date and Time:   12:42 Wednesday April 20, 2022
--   Exported By:     LP
--   Flashback:       0
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'INOT500')
...
,p_authentication_id=>wwv_flow_api.id(114960546882390829)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20210323091953'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(109811136339108915)
,p_name=>'Navigation'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16971074578099180)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16971157643099180)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16971293777099180)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16971492523099180)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16971531458099181)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16971677016099181)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(109796043333108873)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(109888049905068721)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(112673237892227887)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(109806046637108880)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(109807547087108882)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(185432140009067259)
,p_lov_name=>'EMP'
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(185431844119050238)
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(109807234766108882)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(109811240911108915)
,p_parent_id=>0
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(109819135939108921)
,p_parent_id=>wwv_flow_api.id(109811240911108915)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796132778108873)
,p_theme_id=>24
,p_name=>'Login'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796251652108873)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796358457108873)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796429417108873)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796537127108873)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796657363108873)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796743147108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796847776108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109796928589108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797042933108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797128218108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797252612108874)
,p_theme_id=>24
,p_name=>'Popup'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797354332108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797450927108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797536478108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797644455108874)
,p_theme_id=>24
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(109797742810108874)
,p_theme_id=>24
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(109804656922108879)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(109804729103108879)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(109804847970108879)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(109804953373108879)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(109805058402108879)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(109805133107108879)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109797851726108874)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109797928742108874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798058762108874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798137407108874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798232520108874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798334718108874)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798435550108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798555360108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798650772108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798739744108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798852345108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109798933789108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799054539108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799131838108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799242908108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'    #BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799346127108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799442048108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799540111108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799641060108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799738348108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799835228108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109799944728108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800039310108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800154748108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800246398108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800348220108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800442863108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800538817108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800637074108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800757255108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800831283108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109800947874108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109801048112108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(109801135287108876)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802336172108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802450619108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802532273108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802634805108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802754338108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802834685108877)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109802935794108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803039038108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803147246108877)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803246657108877)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803327488108877)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803452238108877)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803553411108877)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803631895108877)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803734302108877)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803842683108879)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(109803931359108879)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801247957108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801332569108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801441399108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801533964108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801631327108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801752670108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801858282108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109801939410108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109802034020108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109802147475108877)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(109802238346108877)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(109804055234108879)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(109804140437108879)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(109804233382108879)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(109804350354108879)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(109804432571108879)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(109804533601108879)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(109805234695108879)
...
begin
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(109805348140108879)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(109805751593108879)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(109805440363108879)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(109805527828108879)
...
begin
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(109805639705108879)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(109805839067108880)
,p_theme_id=>24
,p_theme_name=>'Cloudy'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(109796928589108874)
,p_error_template=>wwv_flow_api.id(109796429417108873)
,p_printer_friendly_template=>wwv_flow_api.id(109797354332108874)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(109796132778108873)
,p_default_button_template=>wwv_flow_api.id(109804656922108879)
,p_default_region_template=>wwv_flow_api.id(109800154748108876)
,p_default_chart_template=>wwv_flow_api.id(109798555360108876)
,p_default_form_template=>wwv_flow_api.id(109798852345108876)
,p_default_reportr_template=>wwv_flow_api.id(109800154748108876)
,p_default_tabform_template=>wwv_flow_api.id(109800154748108876)
,p_default_wizard_template=>wwv_flow_api.id(109800947874108876)
,p_default_menur_template=>wwv_flow_api.id(109798137407108874)
,p_default_listr_template=>wwv_flow_api.id(109798435550108876)
,p_default_irr_template=>wwv_flow_api.id(109799242908108876)
,p_default_report_template=>wwv_flow_api.id(109801858282108877)
,p_default_label_template=>wwv_flow_api.id(109804233382108879)
,p_default_menu_template=>wwv_flow_api.id(109805234695108879)
,p_default_calendar_template=>wwv_flow_api.id(109805440363108879)
,p_default_list_template=>wwv_flow_api.id(109803734302108877)
,p_default_option_label=>wwv_flow_api.id(109804350354108879)
,p_default_required_label=>wwv_flow_api.id(109804533601108879)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(109812134972108915)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(109806126481108880)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(114960546882390829)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(35282693493555070207)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37875966655156272252)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37875983167408285232)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
,p_display_sequence=>10
,p_display_value=>'Contains/Case (uses INSTR)'
,p_return_value=>'CONTAINS_CASE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37875992256457291545)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37875993760959292857)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37875997166846294579)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37876011173426296459)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37876013745852297936)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37876025753125300021)
,p_plugin_attribute_id=>wwv_flow_api.id(37875966655156272252)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37877711050550838546)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877723359208841077)
,p_plugin_attribute_id=>wwv_flow_api.id(37877711050550838546)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'DEFAULT'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877734663363842240)
,p_plugin_attribute_id=>wwv_flow_api.id(37877711050550838546)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37877746867650852920)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'APPLICATION'
...
,p_default_value=>'bar'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(37877711050550838546)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877891255323934552)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>10
,p_display_value=>'Bar'
,p_return_value=>'bar'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877892560172935927)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877894663981936965)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>30
...
begin
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877896067790938118)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877897171946939301)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877899444026940756)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877900650952942705)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(37877901555108943945)
,p_plugin_attribute_id=>wwv_flow_api.id(37877746867650852920)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(37878825056137568627)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31732307140429465794)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31732308644930467132)
,p_plugin_attribute_id=>wwv_flow_api.id(31732307140429465794)
,p_display_sequence=>10
,p_display_value=>'Slow'
,p_return_value=>'600'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31732309248047467974)
,p_plugin_attribute_id=>wwv_flow_api.id(31732307140429465794)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31732309851164468842)
,p_plugin_attribute_id=>wwv_flow_api.id(31732307140429465794)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(31732310555666470213)
,p_plugin_attribute_id=>wwv_flow_api.id(31732307140429465794)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24363751052693916403)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14713190128927622079)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(31165527953144001547)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
,p_default_value=>'Y'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(24274672440124487205)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274656046741441784)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274658248604451752)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274663841940468716)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274665156831473036)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274666029604474613)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274667541378478060)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274672440124487205)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13647707988541404045)
,p_plugin_attribute_id=>wwv_flow_api.id(24274672440124487205)
,p_display_sequence=>10
,p_display_value=>'Not Enterable'
,p_return_value=>'NOT_ENTERABLE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13647746099623407216)
,p_plugin_attribute_id=>wwv_flow_api.id(24274672440124487205)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(13647776907934409630)
,p_plugin_attribute_id=>wwv_flow_api.id(24274672440124487205)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274711754931510339)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(24274673450859490257)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(16975803951100659)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(29118651859604073055)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878915860400590062)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878919555440592338)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878921651558594056)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878923648108595663)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878925943579597755)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878931470740600447)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878934963838603630)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(37878938256506607004)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
,p_file_name=>'bar.gif'
,p_mime_type=>'image/gif'
,p_file_content=>wwv_flow_api.varchar2_to_blob(wwv_flow_api.g_varchar2_table)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(59140031777447014777)
,p_plugin_id=>wwv_flow_api.id(35282693493555070207)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(109805932811108880)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(109805932811108880)
,p_tab_set=>'TS1'
,p_name=>'HOME'
,p_alias=>'HOME'
,p_step_title=>'HOME'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(109807651507108884)
,p_plug_name=>'TORDENSERV'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(109799242908108876)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(109807742126108884)
,p_name=>'TORDENSERV'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808029792108887)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808126451108888)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808233398108890)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808335196108890)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808449499108891)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808543807108893)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808647590108893)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808742798108893)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808837680108895)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109808926223108895)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809044522108896)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809155682108896)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809252844108898)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809349409108898)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809429483108899)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809549555108899)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809628377108901)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809756259108901)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809852324108901)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109809926619108902)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810047228108902)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810148379108904)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810230591108904)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810348026108905)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810440909108907)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810544215108907)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810647091108909)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810748805108910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810850486108910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109810936215108912)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109825755202772910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109825842938772910)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109853340517888002)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109853440484888007)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(109853529484888007)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(115826053909064846)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127164344889390295)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127164443670390295)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127555635371082098)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(130856446053843277)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(130856535859843280)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(201107041547052404)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(201107132170052412)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(109819534374109163)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'NMORDEN:FECREA:CDCLASE:CORRELATIVO:DSREPARA:CDASIGNADO:ESTADO:FECHA_CIERRE:COD_FALLA:DES_FALLA:TIPO_OT:FECHA_ASIGNADO:TIPO_ORDEN:EMPLEADO:AUTORIZA:REPORTA:TALLER:ASIGNADO:UNIDAD:UNIDADFILTRO:FLOTA:'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(62437668676918157)
,p_report_id=>wwv_flow_api.id(109819534374109163)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(62438074986918160)
,p_report_id=>wwv_flow_api.id(109819534374109163)
,p_name=>'Trans'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(62437263387918154)
,p_report_id=>wwv_flow_api.id(109819534374109163)
...
wwv_flow_api.create_worksheet_computation(
 p_id=>wwv_flow_api.id(62438491082918162)
,p_report_id=>wwv_flow_api.id(109819534374109163)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(112651445379686826)
,p_plug_name=>'NUEVA ORDEN DE TRABAJO'
,p_region_name=>'NEW'
,p_parent_plug_id=>wwv_flow_api.id(109807651507108884)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(109799442048108876)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(109811332026108915)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(109798137407108874)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(109807234766108882)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(109805234695108879)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109819043197108921)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(109807651507108884)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(109804656922108879)
,p_button_image_alt=>'Create'
,p_button_position=>'LEFT_OF_TITLE'
,p_grid_new_grid=>false
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112651752005686827)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(112651445379686826)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(109804656922108879)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112651929522686827)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(112651445379686826)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112651632457686827)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(112663341485704665)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(112652248473686827)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(109964637887349671)
,p_branch_name=>'nmorden'
,p_branch_action=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(109819043197108921)
,p_branch_sequence=>10
,p_branch_condition_type=>'SQL_EXPRESSION'
,p_branch_condition=>'select max(nmorden) into :P2_NMORDEN from tordenserv'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112652430957686829)
,p_name=>'P1_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
,p_field_template=>wwv_flow_api.id(109804233382108879)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112652656520686829)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(109804350354108879)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112653042266686830)
,p_name=>'P1_FECREA'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112653232673686830)
,p_name=>'P1_CDCLASE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112653446380686832)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112653628190686832)
,p_name=>'P1_KMACTUAL'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112653829438686832)
,p_name=>'P1_KMSIGSERV'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112654034494686832)
,p_name=>'P1_DSREPARA'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112654226677686835)
,p_name=>'P1_ESTADO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112654454414686835)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112654632208686835)
,p_name=>'P1_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(109804533601108879)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112654830672686835)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112655029482686835)
,p_name=>'P1_NMSOLIC'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112655235093686835)
,p_name=>'P1_SERIE'
,p_is_required=>true
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112655444081686837)
,p_name=>'P1_TIPO_SERV'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112655655705686837)
,p_name=>'P1_NUM_CHECK'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112655845797686837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112656036063686837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112656234836686837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112656451085686837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112656640788686838)
,p_name=>'P1_HORA_FIN'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112656828554686838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112657041537686838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112657247446686838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112657455032686838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112657632425686838)
,p_name=>'P1_UBICACION'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112657850644686838)
,p_name=>'P1_COD_FALLA'
,p_is_required=>true
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select NOMBRE,ID_COD from tipo_falla WHERE ID_PADRE = :P1_TIPO_SISTEMA'
,p_lov_cascade_parent_items=>'P1_TIPO_SISTEMA'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112658039503686840)
,p_name=>'P1_TIPO_OT'
,p_is_required=>true
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112658231336686840)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112658631677686840)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112658845323686840)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112659055245686840)
,p_name=>'P1_UNIDAD'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112669442581028266)
,p_name=>'P1_GUIONES'
,p_item_sequence=>350
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(115826343545084774)
,p_name=>'P1_TALLER'
,p_is_required=>true
,p_item_sequence=>360
,p_item_plug_id=>wwv_flow_api.id(112651445379686826)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(209790451783735748)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(116471942845478845)
,p_validation_name=>'P1_TALLER'
,p_validation_sequence=>10
,p_validation=>'P1_TALLER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Ingrese Taller'
,p_when_button_pressed=>wwv_flow_api.id(112651632457686827)
,p_associated_item=>wwv_flow_api.id(115826343545084774)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(112663656161718388)
,p_name=>'crear_nota'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(112663341485704665)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112663949061718390)
,p_event_id=>wwv_flow_api.id(112663656161718388)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(112666753924831262)
,p_name=>'Cerrar_Modal'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(112651929522686827)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112667055156831262)
,p_event_id=>wwv_flow_api.id(112666753924831262)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(112669526117040862)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112669831410040863)
,p_event_id=>wwv_flow_api.id(112669526117040862)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(112668139650921732)
,p_name=>'asignar'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112668448779921732)
,p_event_id=>wwv_flow_api.id(112668139650921732)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112670545767087557)
,p_event_id=>wwv_flow_api.id(112668139650921732)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(112686928490462643)
,p_name=>'Serie'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112687228947462682)
,p_event_id=>wwv_flow_api.id(112686928490462643)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(112687626029509232)
,p_name=>'Delegacion'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_bind_event_type=>'ready'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(112687939676509232)
,p_event_id=>wwv_flow_api.id(112687626029509232)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(172473649946557032)
,p_name=>'cdempleado'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(172473928247557040)
,p_event_id=>wwv_flow_api.id(172473649946557032)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(112662749908686851)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(112662932543686851)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(112663135328686851)
...
,p_step_template=>wwv_flow_api.id(109796358457108873)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'TRANSPORTE'
,p_last_upd_yyyymmddhh24miss=>'20201128075241'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(109811645911108915)
,p_plug_name=>'Orden de Trabajo'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(109798852345108876)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(109819242178108921)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(109798137407108874)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(116303250492990307)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(109811645911108915)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109811751718108915)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(109811645911108915)
,p_button_name=>'CANCEL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109811952563108915)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(109811645911108915)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109812028022108915)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(109811645911108915)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(109812254171108916)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(108373931752252496)
,p_name=>'P2_TIPOSISTEMA'
,p_item_sequence=>26
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_prompt=>'Tiposistema'
,p_source=>'SISTEMA'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select NOMBRE,ID_COD from tipo_general_falla'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109812356670108916)
,p_name=>'P2_ROWID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109812434353108916)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109812626470108916)
,p_name=>'P2_NMORDEN'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109812832686108916)
,p_name=>'P2_FECREA'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109813037722108916)
,p_name=>'P2_CDCLASE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109813241258108916)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109813446283108918)
,p_name=>'P2_KMACTUAL'
,p_item_sequence=>6
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109813635128108918)
,p_name=>'P2_KMSIGSERV'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109813848762108918)
,p_name=>'P2_DSREPARA'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109814045884108918)
,p_name=>'P2_ESTADO'
,p_item_sequence=>9
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109814246637108918)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109814435879108918)
,p_name=>'P2_CDEMPRESA'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_item_default=>'01'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109814634704108918)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109814829301108918)
,p_name=>'P2_NMSOLIC'
,p_item_sequence=>13
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109815043084108918)
,p_name=>'P2_SERIE'
,p_item_sequence=>14
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_prompt=>'Serie'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109815248484108918)
,p_name=>'P2_TIPO_SERV'
,p_item_sequence=>15
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109815451557108918)
,p_name=>'P2_NUM_CHECK'
,p_item_sequence=>16
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109815642870108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109815837337108920)
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select empleado, nombre_pila  ||'' '' ||primer_apellido from pipasgt.empleado '
,p_cSize=>30
,p_cMaxlength=>22
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(109804350354108879)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109816047145108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109816240567108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109816435061108920)
,p_name=>'P2_HORA_FIN'
,p_item_sequence=>21
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109816649917108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109816833159108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109817051317108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109817226429108920)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109817442193108920)
,p_name=>'P2_UBICACION'
,p_item_sequence=>126
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109817656290108920)
,p_name=>'P2_COD_FALLA'
,p_item_sequence=>27
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select NOMBRE,ID_COD from tipo_falla WHERE ID_PADRE = :P2_TIPOSISTEMA'
,p_lov_cascade_parent_items=>'P2_TIPOSISTEMA'
,p_ajax_optimize_refresh=>'Y'
,p_cSize=>30
,p_cMaxlength=>22
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109817826566108920)
,p_name=>'P2_TIPO_OT'
,p_item_sequence=>28
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109818042923108921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109818255526108921)
,p_name=>'P2_CREADO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109818427250108921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109818633537108921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109982029813733259)
,p_name=>'P2_CLASE'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_prompt=>'Clase'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(112575954523558699)
,p_name=>'P2_FLAG'
,p_item_sequence=>0
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_prompt=>'Flag'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116119739787321634)
,p_name=>'P2_UNIDAD'
,p_is_required=>true
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
...
,p_label_alignment=>'RIGHT'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(109804432571108879)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116120358321328151)
,p_name=>'P2_GUIONES'
,p_item_sequence=>52
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_prompt=>'Guiones'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116301945504985718)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116302140953985723)
,p_name=>'P2_REP_NAME'
,p_item_sequence=>72
,p_item_plug_id=>wwv_flow_api.id(109819242178108921)
,p_item_default=>'OT'
,p_prompt=>'Report Url'
,p_source=>'OT'
,p_source_type=>'STATIC'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116302349323985723)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116302538340985724)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116302728675985724)
,p_name=>'P2_OUT_FILE'
,p_item_sequence=>102
,p_item_plug_id=>wwv_flow_api.id(109819242178108921)
,p_prompt=>'Report Url'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116302955211985724)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116303143560985724)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116304346990015435)
,p_name=>'P2_URL'
,p_item_sequence=>132
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_item_default=>'http://10.14.16.11:3838//JasperReportsIntegration/report?_repName=OT&_repFormat=PDF&_dataSource=default&_outFilename=&_repLocale=en_US&_repEncoding=UTF-8&OT='
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116304552223015435)
,p_name=>'P2_URLR'
,p_item_sequence=>142
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_prompt=>'Urlr'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(116470128100318584)
,p_name=>'P2_TALLER'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(109811645911108915)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(134640048221538674)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(116470430867362880)
,p_validation_name=>'P2_TALLER'
,p_validation_sequence=>10
,p_validation=>'P2_TALLER'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Ingrese Taller'
,p_when_button_pressed=>wwv_flow_api.id(109811952563108915)
,p_associated_item=>wwv_flow_api.id(116470128100318584)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(116120548843335574)
,p_name=>'conteo_guiones'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116120830369335585)
,p_event_id=>wwv_flow_api.id(116120548843335574)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(116120932482349771)
,p_name=>'asignar'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P2_UNIDAD'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116121234763349771)
,p_event_id=>wwv_flow_api.id(116120932482349771)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116122630692371429)
,p_event_id=>wwv_flow_api.id(116120932482349771)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(116305049379084620)
,p_name=>'URL_REPORTE'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116305355639084629)
,p_event_id=>wwv_flow_api.id(116305049379084620)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116371631407883907)
,p_event_id=>wwv_flow_api.id(116305049379084620)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(116305626785097095)
,p_name=>'IMPRIMIR'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(116303250492990307)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116373127760128674)
,p_event_id=>wwv_flow_api.id(116305626785097095)
,p_event_result=>'TRUE'
,p_action_sequence=>5
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116305941477097098)
,p_event_id=>wwv_flow_api.id(116305626785097095)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(116306230107099207)
,p_event_id=>wwv_flow_api.id(116305626785097095)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136136451000342209)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136136729078342230)
,p_event_id=>wwv_flow_api.id(136136451000342209)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(109818836913108921)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(109818953449108921)
,p_process_sequence=>1
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of TORDENSERV'
...
,p_step_template=>wwv_flow_api.id(109796132778108873)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(109806452530108880)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(109798852345108876)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(109806733061108880)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(109806452530108880)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109806550447108880)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(109806452530108880)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(109806636061108880)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(109806927817108882)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(109806828659108880)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(109807143421108882)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(109807056290108882)
,p_process_sequence=>10
