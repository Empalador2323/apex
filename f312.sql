...
prompt APPLICATION 312 - J_Actualizar datos SER
--
-- Application Export:
--   Application:     312
--   Name:            J_Actualizar datos SER
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,312)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_Actualizar datos SER')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_312')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'6D2F6ADA4A91B7BF550C50C466B33711FEB292B9717E6DFF0B7B28FB9A487347'
...
,p_authentication_id=>wwv_flow_api.id(14493431567794614)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:datos unidades'
...
,p_last_upd_yyyymmddhh24miss=>'20210322111513'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8750620209054805)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8750705832054805)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8750881737054805)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8751016542054805)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8751119893054805)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8751232354054805)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(28464128059976218)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(14493719274800323)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(28482123777976227)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(28483332811976229)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(28483735679976229)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28464232877976220)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28464341016976220)
,p_page_template_id=>wwv_flow_api.id(28464232877976220)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28464437593976220)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28464518643976220)
,p_page_template_id=>wwv_flow_api.id(28464437593976220)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28464632176976220)
,p_page_template_id=>wwv_flow_api.id(28464437593976220)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28464726460976220)
,p_page_template_id=>wwv_flow_api.id(28464437593976220)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28464826496976220)
,p_page_template_id=>wwv_flow_api.id(28464437593976220)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28464920271976220)
,p_page_template_id=>wwv_flow_api.id(28464437593976220)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28465017219976220)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465138265976220)
,p_page_template_id=>wwv_flow_api.id(28465017219976220)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465221921976220)
,p_page_template_id=>wwv_flow_api.id(28465017219976220)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465345809976220)
,p_page_template_id=>wwv_flow_api.id(28465017219976220)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465420268976220)
,p_page_template_id=>wwv_flow_api.id(28465017219976220)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465526997976220)
,p_page_template_id=>wwv_flow_api.id(28465017219976220)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465615101976220)
,p_page_template_id=>wwv_flow_api.id(28465017219976220)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28465741312976220)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465819828976220)
,p_page_template_id=>wwv_flow_api.id(28465741312976220)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28465915296976220)
,p_page_template_id=>wwv_flow_api.id(28465741312976220)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466018709976220)
,p_page_template_id=>wwv_flow_api.id(28465741312976220)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466138311976220)
,p_page_template_id=>wwv_flow_api.id(28465741312976220)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28466218350976220)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466332340976220)
,p_page_template_id=>wwv_flow_api.id(28466218350976220)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466419538976220)
,p_page_template_id=>wwv_flow_api.id(28466218350976220)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466531982976220)
,p_page_template_id=>wwv_flow_api.id(28466218350976220)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466642694976220)
,p_page_template_id=>wwv_flow_api.id(28466218350976220)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466717395976220)
,p_page_template_id=>wwv_flow_api.id(28466218350976220)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28466829557976220)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28466926555976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467029452976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467143676976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467241794976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467317547976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467432385976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467517743976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467641577976220)
,p_page_template_id=>wwv_flow_api.id(28466829557976220)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28467724492976220)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467825953976220)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28467924835976220)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468043445976220)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468142077976220)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468237104976220)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468316612976220)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468442103976221)
,p_page_template_id=>wwv_flow_api.id(28467724492976220)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28468523337976221)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468643146976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468744498976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468844341976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28468924961976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469040166976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469129974976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469237519976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469338553976221)
,p_page_template_id=>wwv_flow_api.id(28468523337976221)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28469414762976221)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469545671976221)
,p_page_template_id=>wwv_flow_api.id(28469414762976221)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469628787976221)
,p_page_template_id=>wwv_flow_api.id(28469414762976221)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469731108976221)
,p_page_template_id=>wwv_flow_api.id(28469414762976221)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469826932976221)
,p_page_template_id=>wwv_flow_api.id(28469414762976221)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28469933053976221)
,p_page_template_id=>wwv_flow_api.id(28469414762976221)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470043394976221)
,p_page_template_id=>wwv_flow_api.id(28469414762976221)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28470146227976221)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470238567976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470328852976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470419649976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470537354976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470623093976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470722660976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28470845956976221)
,p_page_template_id=>wwv_flow_api.id(28470146227976221)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28470938244976221)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471023469976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471126303976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471225496976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471314250976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471438725976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471534475976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471633200976221)
,p_page_template_id=>wwv_flow_api.id(28470938244976221)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28471732398976221)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28471828841976221)
,p_page_template_id=>wwv_flow_api.id(28471732398976221)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28471931265976221)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472024594976221)
,p_page_template_id=>wwv_flow_api.id(28471931265976221)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472128334976221)
,p_page_template_id=>wwv_flow_api.id(28471931265976221)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472216451976221)
,p_page_template_id=>wwv_flow_api.id(28471931265976221)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472316967976221)
,p_page_template_id=>wwv_flow_api.id(28471931265976221)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28472430082976221)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472537446976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472618125976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472745962976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472818543976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28472937205976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473045845976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473120702976221)
,p_page_template_id=>wwv_flow_api.id(28472430082976221)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28473239516976223)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473338643976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473442512976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473519002976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473624466976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473732754976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473824867976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28473914926976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474020228976223)
,p_page_template_id=>wwv_flow_api.id(28473239516976223)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28474136532976223)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474235501976223)
,p_page_template_id=>wwv_flow_api.id(28474136532976223)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474332647976223)
,p_page_template_id=>wwv_flow_api.id(28474136532976223)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474438530976223)
,p_page_template_id=>wwv_flow_api.id(28474136532976223)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474541036976223)
,p_page_template_id=>wwv_flow_api.id(28474136532976223)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474646296976223)
,p_page_template_id=>wwv_flow_api.id(28474136532976223)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474719526976223)
,p_page_template_id=>wwv_flow_api.id(28474136532976223)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(28474832547976223)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28474940665976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28475037537976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28475119036976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28475236332976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28475344318976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28475434598976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(28475528105976223)
,p_page_template_id=>wwv_flow_api.id(28474832547976223)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(28481017434976226)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(28481137078976226)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(28481238422976226)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(28481324829976226)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(28481425727976226)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(28481519057976226)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28475627845976223)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28475718278976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28475831536976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28475921174976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476042910976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476121911976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476242240976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476317072976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476435293976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28476527285976223)
,p_plug_template_id=>wwv_flow_api.id(28476435293976223)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476644638976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476715655976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476843019976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28476944250976223)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28477025824976224)
,p_plug_template_id=>wwv_flow_api.id(28476944250976223)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28477140742976224)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28477225024976224)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28477342067976224)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28477424696976224)
,p_plug_template_id=>wwv_flow_api.id(28477342067976224)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(28477518004976224)
,p_plug_template_id=>wwv_flow_api.id(28477342067976224)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28477626572976224)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28477727005976224)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28478943186976224)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479042730976224)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479129922976224)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479234136976224)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479319333976224)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479425486976226)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479514857976226)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479640924976226)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479716177976226)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479832938976226)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28479925458976226)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28480038534976226)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28480143739976226)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(28480215110976226)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28477819522976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28477919244976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478037543976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478129120976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478215755976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478344665976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478438171976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478529964976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478617701976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478738421976224)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(28478822320976224)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480336740976226)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480415504976226)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480525338976226)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480636647976226)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480727166976226)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480841165976226)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(28480937493976226)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(28481630711976226)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(28481820952976226)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(28481737549976226)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(28481944451976227)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(28469414762976221)
,p_error_template=>wwv_flow_api.id(28465741312976220)
,p_printer_friendly_template=>wwv_flow_api.id(28471931265976221)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(28464232877976220)
,p_default_button_template=>wwv_flow_api.id(28481017434976226)
,p_default_region_template=>wwv_flow_api.id(28477342067976224)
,p_default_chart_template=>wwv_flow_api.id(28477342067976224)
,p_default_form_template=>wwv_flow_api.id(28476435293976223)
,p_default_reportr_template=>wwv_flow_api.id(28477342067976224)
,p_default_tabform_template=>wwv_flow_api.id(28477342067976224)
,p_default_wizard_template=>wwv_flow_api.id(28476435293976223)
,p_default_menur_template=>wwv_flow_api.id(28475921174976223)
,p_default_listr_template=>wwv_flow_api.id(28477342067976224)
,p_default_irr_template=>wwv_flow_api.id(28476843019976223)
,p_default_report_template=>wwv_flow_api.id(28478438171976224)
,p_default_label_template=>wwv_flow_api.id(28480525338976226)
,p_default_menu_template=>wwv_flow_api.id(28481630711976226)
,p_default_calendar_template=>wwv_flow_api.id(28481737549976226)
,p_default_list_template=>wwv_flow_api.id(28480038534976226)
,p_default_option_label=>wwv_flow_api.id(28480525338976226)
,p_default_required_label=>wwv_flow_api.id(28480841165976226)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(14493431567794614)
,p_name=>'CUSTOM'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(28482224084976227)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(28482030619976227)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(28482030619976227)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20180718114539'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28490535265988493)
,p_plug_name=>'Report 1'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(28476843019976223)
...
'"CORRELATIVO",',
'"DSACTIVO",',
'kms_servicio as "km menor",',
'cantservmen as "Cantidad",',
'kmsermayor as "km mayor"',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(28490727044988493)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.:2:P2_CDCLASE,P2_CORRELATIVO,P2_KILOSERV:#CDCLASE#,#CORRELATIVO#,#km menor#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#edit_big.gif"  border="0">'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
,p_owner=>'JFAJARDO'
,p_internal_uid=>14050813057434126
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(28490844062988502)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(28490937095988504)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(28491044520988504)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(28491116941988506)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14602820018296378)
,p_db_column_name=>'km menor'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Km Menor'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'km menor'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14602922997296384)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14603022689296384)
,p_db_column_name=>'km mayor'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Km Mayor'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'km mayor'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(28491344474988629)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'140515'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'CDCLASE:CORRELATIVO:DSACTIVO:km menor:Cantidad:km mayor:'
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20190509170129'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28498717902387831)
,p_plug_name=>'DATOS DE SERVICIO'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(28476435293976223)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14465004859013243)
,p_button_sequence=>35
,p_button_plug_id=>wwv_flow_api.id(28498717902387831)
,p_button_name=>'ACTUALIZARDATOS'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(28481324829976226)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14452826068650282)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(28498717902387831)
,p_button_name=>'VOLVER'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(28481017434976226)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(28484941119988477)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14592032374682889)
,p_name=>'P2_DELEGACION'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(28498717902387831)
,p_prompt=>'Delegacion'
...
,p_field_template=>wwv_flow_api.id(28480525338976226)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28485318247988479)
,p_name=>'P2_CDCLASE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(28498717902387831)
...
,p_grid_column=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(28480841165976226)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28485527369988479)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28499940557405096)
,p_name=>'P2_KILOSERV'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(28498717902387831)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Kilometraje de servicios menores'
,p_source=>'kms_servicio'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'Static:3000,4000,5000,6000,7000,10000'
,p_cSize=>8
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28508027684593398)
,p_name=>'P2_CANTSERV'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(28498717902387831)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Cantidad de servicios (Incluyendo el mayor)'
,p_source=>'CANTSERVMEN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28509019477612388)
,p_name=>'P2_KMSERVMAY'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(28498717902387831)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Kilometraje servicio mayor'
,p_source=>'KMSERMAYOR'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>8
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31204714323777298)
,p_name=>'asignar'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31205006645777300)
,p_event_id=>wwv_flow_api.id(31204714323777298)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P2_DELEGACION'
,p_attribute_01=>'SQL_STATEMENT'
,p_attribute_03=>'select cddelegacion  from tactivos where  cdclase=:P2_CDCLASE and correlativo=:P2_CORRELATIVO'
,p_attribute_07=>'P2_CDCLASE,P2_CORRELATIVO'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14465825075028454)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'actualizadatos'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'UPDATE TACTIVOS SET KMS_SERVICIO = :P2_KILOSERV, CANTSERVMEN = :P2_CANTSERV, KMSERMAYOR = :P2_KMSERVMAY, CDDELEGACION = :P2_DELEGACION WHERE CDCLASE = :P2_CDCLASE AND CORRELATIVO= :P2_CORRELATIVO;',
'',
'UPDATE PROYECTO SET DELEGACION = :P2_DELEGACION where proyecto = :P2_CDCLASE||''-''||:P2_CORRELATIVO;'))
...
,p_step_template=>wwv_flow_api.id(28464232877976220)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20171228145439'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28482527732976227)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(28476435293976223)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(28482826673976229)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(28482527732976227)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28482638743976227)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(28482527732976227)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28482728258976229)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28483045580976229)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28482922653976229)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28483216218976229)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28483127413976229)
,p_process_sequence=>10
