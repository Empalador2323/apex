...
,p_default_application_id=>326
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 326 - J_REPORSATIS
--
-- Application Export:
--   Application:     326
--   Name:            J_REPORSATIS
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,326)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'J_REPORSATIS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_326')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'3D35B0F654FC3C5CDF44E6414DDBCDD44B403E112C76B36458D9A1F2058C62AC'
...
,p_authentication_id=>wwv_flow_api.id(18228421780905182)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:J_REPORSATIS'
...
,p_last_upd_yyyymmddhh24miss=>'20210325160909'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8769499218060031)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8769570319060031)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8769657740060031)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8769831984060031)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8769958205060031)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(8770002875060031)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(18187315850125339)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(18229202346944642)
,p_icon_sequence=>10
,p_icon_subtext=>'HOME'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(18205309333125360)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(18206514740125367)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(18206903996125367)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18187408596125340)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18187531354125340)
,p_page_template_id=>wwv_flow_api.id(18187408596125340)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18187626816125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18187717142125342)
,p_page_template_id=>wwv_flow_api.id(18187626816125342)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18187815025125342)
,p_page_template_id=>wwv_flow_api.id(18187626816125342)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18187901267125342)
,p_page_template_id=>wwv_flow_api.id(18187626816125342)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188012099125342)
,p_page_template_id=>wwv_flow_api.id(18187626816125342)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188112782125342)
,p_page_template_id=>wwv_flow_api.id(18187626816125342)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18188222508125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188302329125342)
,p_page_template_id=>wwv_flow_api.id(18188222508125342)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188423162125342)
,p_page_template_id=>wwv_flow_api.id(18188222508125342)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188524157125342)
,p_page_template_id=>wwv_flow_api.id(18188222508125342)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188607639125342)
,p_page_template_id=>wwv_flow_api.id(18188222508125342)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188730698125342)
,p_page_template_id=>wwv_flow_api.id(18188222508125342)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18188806134125342)
,p_page_template_id=>wwv_flow_api.id(18188222508125342)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18188914573125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189023144125342)
,p_page_template_id=>wwv_flow_api.id(18188914573125342)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189117214125342)
,p_page_template_id=>wwv_flow_api.id(18188914573125342)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189222362125342)
,p_page_template_id=>wwv_flow_api.id(18188914573125342)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189321288125342)
,p_page_template_id=>wwv_flow_api.id(18188914573125342)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18189404833125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189510141125342)
,p_page_template_id=>wwv_flow_api.id(18189404833125342)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189607396125342)
,p_page_template_id=>wwv_flow_api.id(18189404833125342)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189707791125342)
,p_page_template_id=>wwv_flow_api.id(18189404833125342)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189822017125342)
,p_page_template_id=>wwv_flow_api.id(18189404833125342)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18189905985125342)
,p_page_template_id=>wwv_flow_api.id(18189404833125342)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18190013884125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190100568125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190207785125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190300781125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190415741125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190509612125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190620816125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190731468125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18190805761125342)
,p_page_template_id=>wwv_flow_api.id(18190013884125342)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18190901984125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191009579125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191126093125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191221106125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191317522125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191432279125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191518879125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191609614125342)
,p_page_template_id=>wwv_flow_api.id(18190901984125342)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18191707880125342)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191801737125342)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18191924616125342)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192023354125342)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192112261125343)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192206840125343)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192330123125343)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192429770125343)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192521676125343)
,p_page_template_id=>wwv_flow_api.id(18191707880125342)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18192617609125343)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192719803125343)
,p_page_template_id=>wwv_flow_api.id(18192617609125343)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192823440125343)
,p_page_template_id=>wwv_flow_api.id(18192617609125343)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192914009125343)
,p_page_template_id=>wwv_flow_api.id(18192617609125343)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193025531125343)
,p_page_template_id=>wwv_flow_api.id(18192617609125343)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193101529125343)
,p_page_template_id=>wwv_flow_api.id(18192617609125343)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193223715125343)
,p_page_template_id=>wwv_flow_api.id(18192617609125343)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18193303228125343)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193416019125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193515445125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193618673125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193727992125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193805450125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193926339125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194030471125343)
,p_page_template_id=>wwv_flow_api.id(18193303228125343)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18194121275125343)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194231157125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194309883125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194402080125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194510560125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194631926125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194702327125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194808173125343)
,p_page_template_id=>wwv_flow_api.id(18194121275125343)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18194900387125343)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195031649125343)
,p_page_template_id=>wwv_flow_api.id(18194900387125343)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18195130696125343)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195231396125343)
,p_page_template_id=>wwv_flow_api.id(18195130696125343)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195319587125343)
,p_page_template_id=>wwv_flow_api.id(18195130696125343)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195406641125343)
,p_page_template_id=>wwv_flow_api.id(18195130696125343)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195520793125343)
,p_page_template_id=>wwv_flow_api.id(18195130696125343)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18195603403125343)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195712669125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195813100125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195926023125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196007238125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196124903125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196220756125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196322367125343)
,p_page_template_id=>wwv_flow_api.id(18195603403125343)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18196429728125345)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196500140125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196629199125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196705754125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196812438125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18196901350125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197011225125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197130357125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197215850125345)
,p_page_template_id=>wwv_flow_api.id(18196429728125345)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18197309089125345)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197430312125345)
,p_page_template_id=>wwv_flow_api.id(18197309089125345)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197506581125345)
,p_page_template_id=>wwv_flow_api.id(18197309089125345)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197600102125345)
,p_page_template_id=>wwv_flow_api.id(18197309089125345)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197709550125345)
,p_page_template_id=>wwv_flow_api.id(18197309089125345)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197811039125345)
,p_page_template_id=>wwv_flow_api.id(18197309089125345)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18197911354125345)
,p_page_template_id=>wwv_flow_api.id(18197309089125345)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(18198020014125348)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198118949125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198201080125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198312001125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198410059125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198502240125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198610347125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(18198718463125348)
,p_page_template_id=>wwv_flow_api.id(18198020014125348)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18204210420125356)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18204330590125356)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18204427833125356)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18204515938125356)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18204625598125356)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(18204715710125356)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18198822517125350)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18198921013125350)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199003812125350)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199123867125350)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199228961125350)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199311539125350)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199418276125351)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199527340125351)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199617227125351)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18199719327125351)
,p_plug_template_id=>wwv_flow_api.id(18199617227125351)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199829365125351)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18199923348125351)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200018309125351)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200129008125353)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18200230548125353)
,p_plug_template_id=>wwv_flow_api.id(18200129008125353)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200322076125353)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200408897125353)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200519304125353)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18200615962125353)
,p_plug_template_id=>wwv_flow_api.id(18200519304125353)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18200717905125353)
,p_plug_template_id=>wwv_flow_api.id(18200519304125353)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200812123125353)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18200904501125353)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202129418125354)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202227847125354)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202321710125354)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202412343125354)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202515635125354)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202605123125354)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202704983125354)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202805309125354)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18202912015125354)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18203024158125354)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18203102108125354)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18203209430125354)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18203318796125354)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(18203432277125354)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201001196125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201103262125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201214570125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201304040125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201403172125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201510443125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201622088125353)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201729332125354)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201814974125354)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18201916533125354)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(18202003552125354)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18203509744125354)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18203624868125354)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18203729001125354)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18203822629125354)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18203926121125354)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18204019736125354)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(18204123309125354)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(18204816563125356)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(18205026755125359)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(18204911255125357)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(18205105332125360)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(18192617609125343)
,p_error_template=>wwv_flow_api.id(18188914573125342)
,p_printer_friendly_template=>wwv_flow_api.id(18195130696125343)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(18187408596125340)
,p_default_button_template=>wwv_flow_api.id(18204210420125356)
,p_default_region_template=>wwv_flow_api.id(18200519304125353)
,p_default_chart_template=>wwv_flow_api.id(18200519304125353)
,p_default_form_template=>wwv_flow_api.id(18199617227125351)
,p_default_reportr_template=>wwv_flow_api.id(18200519304125353)
,p_default_tabform_template=>wwv_flow_api.id(18200519304125353)
,p_default_wizard_template=>wwv_flow_api.id(18199617227125351)
,p_default_menur_template=>wwv_flow_api.id(18199123867125350)
,p_default_listr_template=>wwv_flow_api.id(18200519304125353)
,p_default_irr_template=>wwv_flow_api.id(18200018309125351)
,p_default_report_template=>wwv_flow_api.id(18201622088125353)
,p_default_label_template=>wwv_flow_api.id(18203729001125354)
,p_default_menu_template=>wwv_flow_api.id(18204816563125356)
,p_default_calendar_template=>wwv_flow_api.id(18204911255125357)
,p_default_list_template=>wwv_flow_api.id(18203209430125354)
,p_default_option_label=>wwv_flow_api.id(18203729001125354)
,p_default_required_label=>wwv_flow_api.id(18204019736125354)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(18205417839125362)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(18228421780905182)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(18205227810125360)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(18205227810125360)
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Home'
...
,p_last_upd_yyyymmddhh24miss=>'20180228095510'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18213328598297589)
,p_plug_name=>'Datos'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18200519304125353)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY_3'
,p_plug_source_type=>'NATIVE_FLASH_CHART5'
);
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(18213503100297595)
,p_default_chart_type=>'2DColumn'
,p_chart_rendering=>'FLASH_PREFERRED'
,p_chart_name=>'chart_18213503100297595'
,p_chart_width=>700
,p_chart_height=>500
,p_chart_animation=>'show'
,p_display_attr=>':H:N:V:X:N:N::V:Y:Circle:::N:::AquaLight:::S'
,p_dial_tick_attr=>':::::::::::'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(18213604459297604)
,p_chart_id=>wwv_flow_api.id(18213503100297595)
,p_series_seq=>10
,p_series_name=>'Series 1'
,p_series_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select null link, SATIFECHO label, COUNT(CODSATISFA) value1',
'from  "TRANSPORTE"."J_SATISCLIENTE" where fecha >= :P1_FECHAINI and fecha <= :P1_FECHAFIN group by SATIFECHO'))
,p_series_type=>'Bar'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18387019262665004)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(19284805087687609)
,p_plug_name=>'clientes'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18200018309125351)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select s.codsatisfa,c.dscliente,s.cliente,s.cabezal,s.pipa,e.nombre||''-''||e.apellidos as piloto,s.conductor,s.satifecho from j_satiscliente s,templeados e,tclientes c ',
'where s.cliente = cdcliente and s.conductor = e.cdempleado and s.fecha >= :P1_FECHAINI and s.fecha <= :P1_FECHAFIN order by s.codsatisfa desc ;'))
...
,p_prn_page_header=>'Reporte de atencion al cliente'
,p_prn_page_header_font_color=>'#0712DE'
,p_prn_page_header_font_family=>'Helvetica'
,p_prn_page_header_font_weight=>'normal'
,p_prn_page_header_font_size=>'16'
,p_prn_page_footer=>'LAS PIPAS S.A.'
,p_prn_page_footer_font_color=>'#00408F'
,p_prn_page_footer_font_family=>'Helvetica'
,p_prn_page_footer_font_weight=>'normal'
,p_prn_page_footer_font_size=>'14'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(19284914230687609)
,p_name=>'clienes'
...
,p_owner=>'JFAJARDO'
,p_internal_uid=>19284914230687609
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19285111268687610)
,p_db_column_name=>'CODSATISFA'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Codsatisfa'
,p_column_link=>'f?p=&APP_ID.:2:&SESSION.::&DEBUG.::P2_CODSATISFA,P2_CABEZAL,P2_DSCLIENTE,P2_PILOTO,P2_PIPA,P2_SATIFECHO:#CODSATISFA#,#CABEZAL#,#CLIENTE#,#CONDUCTOR#,#PIPA#,#SATIFECHO#'
,p_column_linktext=>'#CODSATISFA#'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CODSATISFA'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19285218372687610)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19285318959687610)
,p_db_column_name=>'CABEZAL'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Cabezal'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'CABEZAL'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19285421484687610)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19285600042687610)
,p_db_column_name=>'SATIFECHO'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Satifecho'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'SATIFECHO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19286525216697710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19298700278408278)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(19298806544408278)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CONDUCTOR'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(19285705433687737)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'192858'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100
,p_report_columns=>'CODSATISFA:DSCLIENTE:PILOTO:CABEZAL:PIPA:SATIFECHO:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18387916623673717)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18387019262665004)
,p_button_name=>'GENERAR'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(18204210420125356)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18387612254669004)
,p_name=>'P1_FECHAINI'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18387019262665004)
...
,p_field_template=>wwv_flow_api.id(18203729001125354)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18387807725671156)
,p_name=>'P1_FECHAFIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(18387019262665004)
,p_prompt=>'Fecha fin'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'JFAJARDO'
,p_last_upd_yyyymmddhh24miss=>'20180206150317'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(19287905695056843)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19292111516228850)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(19287905695056843)
,p_button_name=>'ACTUALIZAR_DATOS'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(18204210420125356)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19303314754513620)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19288226176107557)
,p_name=>'P2_CODSATISFA'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(19287905695056843)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19288418628111029)
,p_name=>'P2_PILOTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(19287905695056843)
,p_prompt=>'Piloto'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'SELECT NOMBRE||'' ''||APELLIDOS, CDEMPLEADO FROM TEMPLEADOS'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19288615609112415)
,p_name=>'P2_DSCLIENTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(19287905695056843)
,p_prompt=>'Dscliente'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'SELECT DSCLIENTE, CDCLIENTE FROM TCLIENTES'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19288811511114379)
,p_name=>'P2_CABEZAL'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(19287905695056843)
,p_prompt=>'Cabezal'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19289009570115204)
,p_name=>'P2_PIPA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(19287905695056843)
,p_prompt=>'Pipa'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19289206767116501)
,p_name=>'P2_SATIFECHO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(19287905695056843)
,p_prompt=>'Satifecho'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'Static: SI;S,NO;N,NO SE CONTACTO;NSC'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19292318442230835)
,p_process_sequence=>10
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Actualizasatisfaccion'
,p_process_sql_clob=>'update j_satiscliente set cabezal = :P2_CABEZAL, cliente = :P2_DSCLIENTE,conductor = :P2_PILOTO, pipa = :P2_PIPA, satifecho = :P2_SATIFECHO WHERE codsatisfa = :P2_CODSATISFA;'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(19292111516228850)
...
,p_step_template=>wwv_flow_api.id(18187408596125340)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20180201114449'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18205718497125365)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(18199617227125351)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18206014094125367)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(18205718497125365)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18205810313125367)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18205718497125365)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18205906297125367)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18206214048125367)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18206116466125367)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18206409120125367)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18206320297125367)
,p_process_sequence=>10
