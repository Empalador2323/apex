...
,p_default_application_id=>388
,p_default_owner=>'TRANSPORTE'
);
end;
/
 
prompt APPLICATION 388 - Planilla Bonificacion
--
-- Application Export:
--   Application:     388
--   Name:            Planilla Bonificacion
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,388)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'TRANSPORTE')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Planilla Bonificacion')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_388')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'84F1617C261D01CBBBC9EB31F471010E03946CD86A8612EA8FFC2BD2C68792FA'
...
,p_authentication_id=>wwv_flow_api.id(91519121311786428)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Planilla Bonificacion'
...
,p_last_upd_yyyymmddhh24miss=>'20220217154253'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13042816948089079)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13042924839089079)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13043048064089079)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13043270526089079)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13043369877089079)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(13043441117089079)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(91500904180785998)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(91529429043937390)
,p_icon_sequence=>10
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(91518926377786398)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(91520527527786568)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_PLANILLA_BONIFICACION'
,p_tab_text=>'Planilla bonificacion'
,p_tab_step=>1
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(91525003582857309)
,p_tab_set=>'TS1'
,p_tab_sequence=>20
,p_tab_name=>'CHEQUES'
,p_tab_text=>'CHEQUES'
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6845824671400445)
,p_tab_set=>'TS1'
,p_tab_sequence=>30
,p_tab_name=>'Bonificacion_RHNYS'
,p_tab_text=>'Bonificacion_RHNYS'
,p_tab_step=>3
);
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(6860966933768287)
,p_tab_set=>'TS1'
,p_tab_sequence=>40
,p_tab_name=>'cheques_rhnys'
,p_tab_text=>'cheques_rhnys'
,p_tab_step=>4
);
end;
/
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(91520231290786560)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(91520613536786595)
,p_parent_id=>0
,p_short_name=>'Planilla bonificacion'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91501031797786035)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501118439786054)
,p_page_template_id=>wwv_flow_api.id(91501031797786035)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91501206714786059)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501301833786060)
,p_page_template_id=>wwv_flow_api.id(91501206714786059)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501425219786060)
,p_page_template_id=>wwv_flow_api.id(91501206714786059)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501510644786060)
,p_page_template_id=>wwv_flow_api.id(91501206714786059)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501614515786060)
,p_page_template_id=>wwv_flow_api.id(91501206714786059)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501718392786060)
,p_page_template_id=>wwv_flow_api.id(91501206714786059)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91501826228786062)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91501913491786062)
,p_page_template_id=>wwv_flow_api.id(91501826228786062)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502030713786062)
,p_page_template_id=>wwv_flow_api.id(91501826228786062)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502131195786062)
,p_page_template_id=>wwv_flow_api.id(91501826228786062)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502208759786062)
,p_page_template_id=>wwv_flow_api.id(91501826228786062)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502324722786062)
,p_page_template_id=>wwv_flow_api.id(91501826228786062)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502422474786062)
,p_page_template_id=>wwv_flow_api.id(91501826228786062)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91502530400786062)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502629312786064)
,p_page_template_id=>wwv_flow_api.id(91502530400786062)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502700887786064)
,p_page_template_id=>wwv_flow_api.id(91502530400786062)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502820222786064)
,p_page_template_id=>wwv_flow_api.id(91502530400786062)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91502903643786064)
,p_page_template_id=>wwv_flow_api.id(91502530400786062)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91503013571786064)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503102663786064)
,p_page_template_id=>wwv_flow_api.id(91503013571786064)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503214886786064)
,p_page_template_id=>wwv_flow_api.id(91503013571786064)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503329811786064)
,p_page_template_id=>wwv_flow_api.id(91503013571786064)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503417971786064)
,p_page_template_id=>wwv_flow_api.id(91503013571786064)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503518712786064)
,p_page_template_id=>wwv_flow_api.id(91503013571786064)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91503620326786064)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503718054786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503806716786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91503928185786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504005008786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504120829786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504203390786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504326432786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504403202786065)
,p_page_template_id=>wwv_flow_api.id(91503620326786064)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91504501719786068)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504618124786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504716980786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504811458786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91504919569786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505019621786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505122012786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505213399786068)
,p_page_template_id=>wwv_flow_api.id(91504501719786068)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91505304627786070)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505408369786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505516104786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505600746786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505722689786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505801599786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91505932061786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506005918786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506106304786070)
,p_page_template_id=>wwv_flow_api.id(91505304627786070)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91506219070786070)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506315943786070)
,p_page_template_id=>wwv_flow_api.id(91506219070786070)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506414125786071)
,p_page_template_id=>wwv_flow_api.id(91506219070786070)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506512902786071)
,p_page_template_id=>wwv_flow_api.id(91506219070786070)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506611321786071)
,p_page_template_id=>wwv_flow_api.id(91506219070786070)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506707770786071)
,p_page_template_id=>wwv_flow_api.id(91506219070786070)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91506832451786071)
,p_page_template_id=>wwv_flow_api.id(91506219070786070)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91506921671786075)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507016087786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507128425786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507219999786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507301341786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507425746786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507519851786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507622120786078)
,p_page_template_id=>wwv_flow_api.id(91506921671786075)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91507714391786078)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507815351786078)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91507905481786078)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508016205786079)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508108486786079)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508207327786079)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508331597786079)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508408673786079)
,p_page_template_id=>wwv_flow_api.id(91507714391786078)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91508510916786079)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508632556786079)
,p_page_template_id=>wwv_flow_api.id(91508510916786079)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91508723752786079)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508821686786079)
,p_page_template_id=>wwv_flow_api.id(91508723752786079)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91508916421786079)
,p_page_template_id=>wwv_flow_api.id(91508723752786079)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509027782786079)
,p_page_template_id=>wwv_flow_api.id(91508723752786079)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509103714786079)
,p_page_template_id=>wwv_flow_api.id(91508723752786079)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91509217719786079)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509322018786079)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509420567786079)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509514631786079)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509623115786079)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509723490786079)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509819141786081)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91509903248786081)
,p_page_template_id=>wwv_flow_api.id(91509217719786079)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91510007208786081)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510101196786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510223919786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510322703786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510407540786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510504747786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510604010786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510721695786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91510824995786081)
,p_page_template_id=>wwv_flow_api.id(91510007208786081)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91510903777786085)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511026109786087)
,p_page_template_id=>wwv_flow_api.id(91510903777786085)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511109515786087)
,p_page_template_id=>wwv_flow_api.id(91510903777786085)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511215501786087)
,p_page_template_id=>wwv_flow_api.id(91510903777786085)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511307567786087)
,p_page_template_id=>wwv_flow_api.id(91510903777786085)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511418651786087)
,p_page_template_id=>wwv_flow_api.id(91510903777786085)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511526590786087)
,p_page_template_id=>wwv_flow_api.id(91510903777786085)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(91511626446786087)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511722435786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511813983786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91511921899786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91512018019786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91512121987786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91512223757786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(91512317181786087)
,p_page_template_id=>wwv_flow_api.id(91511626446786087)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(91517809208786184)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(91517905408786293)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(91518006322786293)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(91518104946786293)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(91518230801786293)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(91518331002786293)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91512407426786090)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91512523417786107)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91512629832786107)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91512703937786107)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91512810682786109)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91512918975786109)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513032335786109)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513118674786109)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513226700786109)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(91513319629786109)
,p_plug_template_id=>wwv_flow_api.id(91513226700786109)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513414588786110)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513506245786110)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513629896786110)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513725568786110)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(91513828670786110)
,p_plug_template_id=>wwv_flow_api.id(91513725568786110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91513915030786110)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91514019435786112)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91514116748786112)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(91514231958786112)
,p_plug_template_id=>wwv_flow_api.id(91514116748786112)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(91514306131786112)
,p_plug_template_id=>wwv_flow_api.id(91514116748786112)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91514425785786112)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(91514507493786112)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91515700542786134)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91515830983786146)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91515931052786146)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516008113786148)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516123317786148)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516230542786150)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516327640786150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516422503786150)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516526305786150)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516610358786150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516716258786150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516815186786150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91516926579786150)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(91517015110786150)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91514606096786118)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91514716935786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91514824407786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91514928971786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515021508786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515126761786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515217707786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515318036786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515425228786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515502790786126)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(91515605686786126)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517108519786151)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517226361786168)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517319281786168)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517419578786168)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517514359786170)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517627657786170)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(91517732736786170)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(91518412869786298)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(91518623867786323)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(91518517008786315)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(91518714773786339)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(91506219070786070)
,p_error_template=>wwv_flow_api.id(91502530400786062)
,p_printer_friendly_template=>wwv_flow_api.id(91508723752786079)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(91501031797786035)
,p_default_button_template=>wwv_flow_api.id(91517809208786184)
,p_default_region_template=>wwv_flow_api.id(91514116748786112)
,p_default_chart_template=>wwv_flow_api.id(91514116748786112)
,p_default_form_template=>wwv_flow_api.id(91513226700786109)
,p_default_reportr_template=>wwv_flow_api.id(91514116748786112)
,p_default_tabform_template=>wwv_flow_api.id(91514116748786112)
,p_default_wizard_template=>wwv_flow_api.id(91513226700786109)
,p_default_menur_template=>wwv_flow_api.id(91512703937786107)
,p_default_listr_template=>wwv_flow_api.id(91514116748786112)
,p_default_irr_template=>wwv_flow_api.id(91513629896786110)
,p_default_report_template=>wwv_flow_api.id(91515217707786126)
,p_default_label_template=>wwv_flow_api.id(91517319281786168)
,p_default_menu_template=>wwv_flow_api.id(91518412869786298)
,p_default_calendar_template=>wwv_flow_api.id(91518517008786315)
,p_default_list_template=>wwv_flow_api.id(91516815186786150)
,p_default_option_label=>wwv_flow_api.id(91517319281786168)
,p_default_required_label=>wwv_flow_api.id(91517627657786170)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(91519013261786426)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(91519121311786428)
,p_name=>'CUSTOM'
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(91518823691786343)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(91518823691786343)
,p_tab_set=>'TS1'
,p_name=>'Planilla bonificacion'
,p_alias=>'HOME'
,p_step_title=>'Planilla bonificacion'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Planilla bonificacion'
...
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20200507091829'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(91520729680786631)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91512703937786107)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(91520231290786560)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(91518412869786298)
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(91521030913793770)
,p_plug_name=>'fechas'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91514116748786112)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(91522513298817120)
,p_plug_name=>'PLANILLA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91513629896786110)
,p_plug_display_sequence=>30
,p_plug_display_point=>'BODY_3'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select cdempleado codigo_empleado , nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido nombre, cuenta_entidad cuenta,sum(comision_extra) pago,ubicacion',
' from tcomiemp a inner join empleado@softland  b on a.cdempleado=b.empleado ',
'  where fecha>=to_date(:P1_FECHA_INICIO,''dd/mm/yyyy'') and fecha<=to_Date(:P1_FECHA_FIN,''dd/mm/yyyy'') and forma_pago=''T''  and centro_costo in (''1.01.02.0010'',''2.01.02.0010'')',
'  group by cdempleado, nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido,cuenta_entidad,ubicacion'))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(91522626338817121)
,p_name=>'PLANILLA'
...
,p_owner=>'LP'
,p_internal_uid=>91522626338817121
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91522815869817173)
...
,p_tz_dependent=>'N'
,p_static_id=>'CODIGO_EMPLEADO'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91522915968817185)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91523027784817185)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91523104627817185)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91523231984817185)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(91524023472829459)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'915241'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100000
,p_report_columns=>'CODIGO_EMPLEADO:NOMBRE:CUENTA:PAGO:UBICACION'
,p_sum_columns_on_break=>'PAGO'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(91523329575821785)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(91521030913793770)
,p_button_name=>'P1_ACTUALIZAR'
,p_button_static_id=>'P1_ACTUALIZAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(91517809208786184)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91521405012796556)
,p_name=>'P1_FECHA_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(91521030913793770)
...
,p_field_template=>wwv_flow_api.id(91517319281786168)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91521612064796556)
,p_name=>'P1_FECHA_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(91521030913793770)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(91523615853827304)
,p_name=>'ACTUALIZAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(91523329575821785)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(91523922718827320)
,p_event_id=>wwv_flow_api.id(91523615853827304)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(91522513298817120)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20200507091515'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(91525128021859146)
,p_plug_name=>'FECHAS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91514116748786112)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(91526202787880309)
,p_plug_name=>'CHEQUES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91513629896786110)
...
'select cdempleado codigo_empleado , nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido nombre, cuenta_entidad cuenta,sum(comision_extra) pago,ubicacion',
' from tcomiemp a inner join empleado@softland  b on a.cdempleado=b.empleado ',
'  where fecha>=to_date(:P2_FECHA_INICIO,''dd/mm/yyyy'') and fecha<=to_Date(:P2_FECHA_FIN,''dd/mm/yyyy'') and forma_pago=''C''  and centro_costo in (''1.01.02.0010'',''2.01.02.0010'')',
'  group by cdempleado, nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido,cuenta_entidad,ubicacion'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P2_FECHA_INICIO,P2_FECHA_FIN'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(91526321113880309)
,p_name=>'CHEQUES'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'LP'
,p_internal_uid=>91526321113880309
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91526522967880318)
,p_db_column_name=>'CODIGO_EMPLEADO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Codigo Empleado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91526608885880318)
,p_db_column_name=>'NOMBRE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nombre'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91526709921880320)
,p_db_column_name=>'CUENTA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Cuenta'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91526807548880320)
,p_db_column_name=>'PAGO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Pago'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(91526911199880320)
,p_db_column_name=>'UBICACION'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Ubicacion'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(91528304650890265)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'915284'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CODIGO_EMPLEADO:NOMBRE:CUENTA:PAGO:UBICACION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(91525829191869026)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(91525128021859146)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91525520262865467)
,p_name=>'P2_FECHA_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(91525128021859146)
,p_prompt=>'Fecha Inicio'
,p_display_as=>'NATIVE_DATE_PICKER'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91525712387865467)
,p_name=>'P2_FECHA_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(91525128021859146)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(91527902572889704)
,p_name=>'ACTUALIZAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(91525829191869026)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(91528210646889706)
,p_event_id=>wwv_flow_api.id(91527902572889704)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(91526202787880309)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(91518823691786343)
,p_tab_set=>'TS1'
,p_name=>'Bonificacion_RHNYS'
,p_step_title=>'Bonificacion_RHNYS'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'Bonificacion_RHNYS'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(98366379970194205)
,p_plug_name=>'fechas'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91514116748786112)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(98367862355217555)
,p_plug_name=>'PLANILLA'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91513629896786110)
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select cdempleado codigo_empleado , nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido nombre, cuenta_entidad cuenta,sum(comision_extra) pago,ubicacion,c.descripcion',
' from tcomiemp a inner join rhnys.empleado  b on a.cdempleado=b.empleado ',
' inner join rhnys.puesto c on b.puesto=c.puesto',
'  where fecha>=to_date(:P3_FECHA_INICIO,''dd/mm/yyyy'') and fecha<=to_Date(:P3_FECHA_FIN,''dd/mm/yyyy'') and forma_pago=''T''  and centro_costo in (''1.01.02.0022'',''1.01.03.0022'')',
'  group by cdempleado, nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido,cuenta_entidad,ubicacion,c.descripcion'))
,p_plug_source_type=>'NATIVE_IR'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(98367975395217556)
,p_name=>'PLANILLA'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'LP'
,p_internal_uid=>98367975395217556
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6848148810400457)
,p_db_column_name=>'CODIGO_EMPLEADO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Codigo Empleado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6848513177400462)
,p_db_column_name=>'NOMBRE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nombre'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6848973106400462)
,p_db_column_name=>'CUENTA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Cuenta'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6849395536400462)
,p_db_column_name=>'PAGO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Pago'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6849722375400462)
,p_db_column_name=>'UBICACION'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Ubicacion'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(5497599642929714)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(98369372529229894)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'68501'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100000
,p_report_columns=>'CODIGO_EMPLEADO:NOMBRE:CUENTA:PAGO:UBICACION:DESCRIPCION'
,p_sum_columns_on_break=>'PAGO'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6846657045400450)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(98366379970194205)
,p_button_name=>'P3_ACTUALIZAR'
,p_button_static_id=>'P1_ACTUALIZAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(91517809208786184)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6847048968400451)
,p_name=>'P3_FECHA_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(98366379970194205)
,p_prompt=>'Fecha Inicio'
,p_display_as=>'NATIVE_DATE_PICKER'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6847476047400453)
,p_name=>'P3_FECHA_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(98366379970194205)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6850897778400475)
,p_name=>'ACTUALIZAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(6846657045400450)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6851351395400475)
,p_event_id=>wwv_flow_api.id(6850897778400475)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(98367862355217555)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(91518823691786343)
,p_tab_set=>'TS1'
,p_name=>'cheques_rhnys'
,p_step_title=>'cheques_rhnys'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_step_sub_title=>'cheques_rhnys'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_autocomplete_on_off=>'ON'
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'LP'
,p_last_upd_yyyymmddhh24miss=>'20220118151147'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(98385578995627433)
,p_plug_name=>'FECHAS'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91514116748786112)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(98386653761648596)
,p_plug_name=>'CHEQUES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91513629896786110)
...
'select cdempleado codigo_empleado , nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido nombre, cuenta_entidad cuenta,sum(comision_extra) pago,ubicacion',
' from tcomiemp a inner join RHNYS.empleado  b on a.cdempleado=b.empleado ',
'  where fecha>=to_date(:P4_FECHA_INICIO,''dd/mm/yyyy'') and fecha<=to_Date(:P4_FECHA_FIN,''dd/mm/yyyy'') and forma_pago=''C''  and centro_costo in (''1.01.02.0022'',''1.01.03.0022'')',
'  group by cdempleado, nombre_pila ||'' ''||primer_apellido||'' ''|| segundo_apellido,cuenta_entidad,ubicacion'))
,p_plug_source_type=>'NATIVE_IR'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(98386772087648596)
,p_name=>'CHEQUES'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL'
,p_owner=>'LP'
,p_internal_uid=>98386772087648596
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6862900231768290)
,p_db_column_name=>'CODIGO_EMPLEADO'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Codigo Empleado'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6863381387768290)
,p_db_column_name=>'NOMBRE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Nombre'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6863733796768290)
,p_db_column_name=>'CUENTA'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Cuenta'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6864138483768290)
,p_db_column_name=>'PAGO'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Pago'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(6864573059768290)
,p_db_column_name=>'UBICACION'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Ubicacion'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(98388755624658552)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'68649'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CODIGO_EMPLEADO:NOMBRE:CUENTA:PAGO:UBICACION'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6861431051768289)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(98385578995627433)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6861891545768289)
,p_name=>'P4_FECHA_INICIO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(98385578995627433)
,p_prompt=>'Fecha Inicio'
,p_display_as=>'NATIVE_DATE_PICKER'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6862296396768289)
,p_name=>'P4_FECHA_FIN'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(98385578995627433)
,p_prompt=>'Fecha Fin'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6865329481768290)
,p_name=>'ACTUALIZAR'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(6861431051768289)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6865844529768290)
,p_event_id=>wwv_flow_api.id(6865329481768290)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(98386653761648596)
,p_stop_execution_on_error=>'Y'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(91501031797786035)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_upd_yyyymmddhh24miss=>'20200507085803'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(91519414908786496)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(91513226700786109)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(91519720736786535)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(91519414908786496)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91519529338786525)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(91519414908786496)
,p_prompt=>'Username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(91519605041786531)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(91519900862786559)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(91519805844786540)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(91520104349786560)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(91520019530786559)
,p_process_sequence=>10
