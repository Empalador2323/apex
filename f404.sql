...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'vales')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_404')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'AAECC5F03FCE7543F053981CB926955A720D66641AEE4E1D7E54CE44D0A47417'
...
,p_authentication_id=>wwv_flow_api.id(107242726219925971)
,p_populate_roles=>'A'
,p_application_tab_set=>0
,p_logo_image=>'TEXT:vales'
...
,p_last_upd_yyyymmddhh24miss=>'20201015082218'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16964220201097609)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16964324409097609)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_RICH_TEXT_EDITOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16964437346097609)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16964672828097610)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16964705690097610)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(16964890318097612)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(107224509287925871)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(107242513628925970)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(107244412656925979)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_TVALES'
,p_tab_text=>'Tvales'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(107244103960925978)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(107248017656926076)
,p_parent_id=>0
,p_short_name=>'Tvales'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107224622826925875)
,p_theme_id=>25
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107224702330925878)
,p_page_template_id=>wwv_flow_api.id(107224622826925875)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107224813677925882)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107224911538925882)
,p_page_template_id=>wwv_flow_api.id(107224813677925882)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225005905925882)
,p_page_template_id=>wwv_flow_api.id(107224813677925882)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225114349925882)
,p_page_template_id=>wwv_flow_api.id(107224813677925882)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225207606925882)
,p_page_template_id=>wwv_flow_api.id(107224813677925882)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225319989925882)
,p_page_template_id=>wwv_flow_api.id(107224813677925882)
,p_name=>'Header'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107225426122925882)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225527244925884)
,p_page_template_id=>wwv_flow_api.id(107225426122925882)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225617644925884)
,p_page_template_id=>wwv_flow_api.id(107225426122925882)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225721393925884)
,p_page_template_id=>wwv_flow_api.id(107225426122925882)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225828642925884)
,p_page_template_id=>wwv_flow_api.id(107225426122925882)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107225913304925884)
,p_page_template_id=>wwv_flow_api.id(107225426122925882)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226022211925884)
,p_page_template_id=>wwv_flow_api.id(107225426122925882)
,p_name=>'Right Column'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107226127796925884)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226223654925884)
,p_page_template_id=>wwv_flow_api.id(107226127796925884)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226313720925884)
,p_page_template_id=>wwv_flow_api.id(107226127796925884)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226429882925884)
,p_page_template_id=>wwv_flow_api.id(107226127796925884)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226526356925884)
,p_page_template_id=>wwv_flow_api.id(107226127796925884)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107226601164925884)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226707539925884)
,p_page_template_id=>wwv_flow_api.id(107226601164925884)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226817385925885)
,p_page_template_id=>wwv_flow_api.id(107226601164925884)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107226912942925885)
,p_page_template_id=>wwv_flow_api.id(107226601164925884)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227026081925885)
,p_page_template_id=>wwv_flow_api.id(107226601164925884)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227129769925885)
,p_page_template_id=>wwv_flow_api.id(107226601164925884)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107227230988925885)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227301981925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227425138925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227513331925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227603793925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227719741925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227806015925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107227925563925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228004703925885)
,p_page_template_id=>wwv_flow_api.id(107227230988925885)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107228106273925885)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228223580925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228313533925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228412839925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228526418925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228611049925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228723775925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107228831471925885)
,p_page_template_id=>wwv_flow_api.id(107228106273925885)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107228926987925885)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229003381925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229110702925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229228443925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229332018925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229418734925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229502714925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229625663925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229713239925885)
,p_page_template_id=>wwv_flow_api.id(107228926987925885)
,p_name=>'Icon Nav Bar'
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107229827020925885)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107229902387925885)
,p_page_template_id=>wwv_flow_api.id(107229827020925885)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230021218925885)
,p_page_template_id=>wwv_flow_api.id(107229827020925885)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230132722925885)
,p_page_template_id=>wwv_flow_api.id(107229827020925885)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230225022925885)
,p_page_template_id=>wwv_flow_api.id(107229827020925885)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230329317925885)
,p_page_template_id=>wwv_flow_api.id(107229827020925885)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230401173925885)
,p_page_template_id=>wwv_flow_api.id(107229827020925885)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107230525913925885)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230624532925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230709680925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230819509925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107230918656925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231005743925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231119404925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231213436925929)
,p_page_template_id=>wwv_flow_api.id(107230525913925885)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107231315318925929)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231402790925929)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231527932925931)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231620687925931)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231723932925931)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231813242925931)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107231909936925931)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232007235925931)
,p_page_template_id=>wwv_flow_api.id(107231315318925929)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107232112551925931)
,p_theme_id=>25
,p_name=>'Popup'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232229500925931)
,p_page_template_id=>wwv_flow_api.id(107232112551925931)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107232330720925931)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232404848925931)
,p_page_template_id=>wwv_flow_api.id(107232330720925931)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232500569925931)
,p_page_template_id=>wwv_flow_api.id(107232330720925931)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232614973925931)
,p_page_template_id=>wwv_flow_api.id(107232330720925931)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232725767925931)
,p_page_template_id=>wwv_flow_api.id(107232330720925931)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107232829051925931)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107232913659925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233024694925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233127070925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233218142925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233307807925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233431097925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233532409925931)
,p_page_template_id=>wwv_flow_api.id(107232829051925931)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107233617531925931)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233715348925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233815063925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107233908070925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234030817925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234128682925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234214035925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234307587925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234424030925932)
,p_page_template_id=>wwv_flow_api.id(107233617531925931)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107234505639925932)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234631943925932)
,p_page_template_id=>wwv_flow_api.id(107234505639925932)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234712288925932)
,p_page_template_id=>wwv_flow_api.id(107234505639925932)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234828741925932)
,p_page_template_id=>wwv_flow_api.id(107234505639925932)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107234903689925932)
,p_page_template_id=>wwv_flow_api.id(107234505639925932)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235027029925932)
,p_page_template_id=>wwv_flow_api.id(107234505639925932)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235100502925932)
,p_page_template_id=>wwv_flow_api.id(107234505639925932)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(107235211265925932)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235307775925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235413393925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235515047925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235610714925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235716002925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235800812925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(107235914967925932)
,p_page_template_id=>wwv_flow_api.id(107235211265925932)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(107241430857925965)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(107241522211925967)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(107241630489925967)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(107241707710925967)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(107241817665925967)
...
begin
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(107241921234925967)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236016519925946)
,p_layout=>'TABLE'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236113528925948)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236205283925948)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236302026925948)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236422645925950)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236505643925950)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236618666925950)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236711327925950)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107236824023925950)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107236902534925951)
,p_plug_template_id=>wwv_flow_api.id(107236824023925950)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237006035925951)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237130572925951)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237231982925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237328433925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107237415747925953)
,p_plug_template_id=>wwv_flow_api.id(107237328433925953)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237527162925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237605274925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107237714861925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107237812055925953)
,p_plug_template_id=>wwv_flow_api.id(107237714861925953)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107237916579925953)
,p_plug_template_id=>wwv_flow_api.id(107237714861925953)
,p_name=>'Sub Regions'
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107238002850925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(107238111123925953)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239303878925960)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239421868925962)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239508465925962)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239617470925964)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239716879925964)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239820457925964)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107239917198925964)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240014784925964)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240124838925964)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240215968925964)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240330650925964)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240418292925964)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240518030925964)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(107240621335925964)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238206802925954)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238323562925956)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238428992925956)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238514697925956)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238601738925956)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238700602925956)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238808049925959)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107238918533925960)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107239023059925960)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107239114019925960)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(107239214715925960)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107240730185925965)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107240808907925965)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107240920192925965)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107241017198925965)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107241122172925965)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107241208189925965)
...
begin
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(107241314864925965)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(107242025419925967)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(107242223051925968)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(107242102650925968)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(107242314402925970)
,p_theme_id=>25
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(107229827020925885)
,p_error_template=>wwv_flow_api.id(107226127796925884)
,p_printer_friendly_template=>wwv_flow_api.id(107232330720925931)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(107224622826925875)
,p_default_button_template=>wwv_flow_api.id(107241430857925965)
,p_default_region_template=>wwv_flow_api.id(107237714861925953)
,p_default_chart_template=>wwv_flow_api.id(107237714861925953)
,p_default_form_template=>wwv_flow_api.id(107236824023925950)
,p_default_reportr_template=>wwv_flow_api.id(107237714861925953)
,p_default_tabform_template=>wwv_flow_api.id(107237714861925953)
,p_default_wizard_template=>wwv_flow_api.id(107236824023925950)
,p_default_menur_template=>wwv_flow_api.id(107236302026925948)
,p_default_listr_template=>wwv_flow_api.id(107237714861925953)
,p_default_irr_template=>wwv_flow_api.id(107237231982925953)
,p_default_report_template=>wwv_flow_api.id(107238808049925959)
,p_default_label_template=>wwv_flow_api.id(107240920192925965)
,p_default_menu_template=>wwv_flow_api.id(107242025419925967)
,p_default_calendar_template=>wwv_flow_api.id(107242102650925968)
,p_default_list_template=>wwv_flow_api.id(107240418292925964)
,p_default_option_label=>wwv_flow_api.id(107240920192925965)
,p_default_required_label=>wwv_flow_api.id(107241208189925965)
...
wwv_flow_api.create_shortcut(
 p_id=>wwv_flow_api.id(107249826166937603)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(107242605672925970)
,p_name=>'ASIGNACION'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(107242726219925971)
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(107242819154925971)
,p_name=>'CUSTOM'
,p_scheme_type=>'NATIVE_CUSTOM'
,p_attribute_03=>'custom_auth'
,p_attribute_05=>'N'
...
begin
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(107243029262925971)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(107242402158925970)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(107242402158925970)
,p_tab_set=>'TS1'
,p_name=>'Tvales'
,p_step_title=>'Tvales'
...
,p_last_upd_yyyymmddhh24miss=>'20201014172743'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(107244505049925998)
,p_plug_name=>'TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(107237231982925953)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(107244606482925998)
,p_name=>'TVALES'
...
,p_owner=>'1462'
,p_internal_uid=>107244606482925998
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107244718393926015)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107244803236926017)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107244931861926018)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245027980926020)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245109414926021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245226883926021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245317112926023)
,p_db_column_name=>'CANTPROMEDIO'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Cantpromedio'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CANTPROMEDIO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245400490926029)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245520908926031)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245607544926032)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245711283926034)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245828206926035)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107245932046926037)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246012489926039)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246118591926040)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246230705926042)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246320425926043)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246412699926045)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'COD_GRUPO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246522196926046)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246616269926048)
,p_db_column_name=>'CDCLASE_COMP'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Cdclase Comp'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'CDCLASE_COMP'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246724176926051)
,p_db_column_name=>'CORRELCOMP'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Correlcomp'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'CORRELCOMP'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246830921926053)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107246909225926054)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'RENDIMIENTO_REAL'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247017356926056)
...
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'RENDIMIENTO_ESTIMADO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247125195926057)
,p_db_column_name=>'NOBOMBA'
,p_display_order=>25
,p_column_identifier=>'Y'
,p_column_label=>'Nobomba'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247216870926059)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247319149926060)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247418961926064)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247512913926065)
,p_db_column_name=>'GRABA'
,p_display_order=>29
,p_column_identifier=>'AC'
,p_column_label=>'Graba'
,p_allow_pivot=>'N'
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'GRABA'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247617936926067)
...
,p_column_type=>'STRING'
,p_tz_dependent=>'N'
,p_static_id=>'AUDITADO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247726085926068)
,p_db_column_name=>'FECHA_ACTUALIZADO'
,p_display_order=>31
,p_column_identifier=>'AE'
,p_column_label=>'Fecha Actualizado'
,p_allow_pivot=>'N'
,p_column_type=>'DATE'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'FECHA_ACTUALIZADO'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247830405926071)
,p_db_column_name=>'RECORRIDO_ANT'
,p_display_order=>32
,p_column_identifier=>'AF'
,p_column_label=>'Recorrido Ant'
,p_allow_pivot=>'N'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
,p_static_id=>'RECORRIDO_ANT'
,p_help_text=>'No help available for this page item.'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(107247914597926073)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(107248332187927456)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1072484'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'NMVALE:FECHA:NOTAVIAJE:CDCLASACT:CORRACT:CANTDESPACHA:CANTPROMEDIO:CDDESPACHA:CDRECIBE:CDEMPRESA:CDTIPCOMB:NMBOMBA:OBSERVACIONES:NMORDENC:KMSALE:KMRETORNO:RECORRIDO:COD_GRUPO:CDDELEGACION:CDCLASE_COMP:CORRELCOMP:CREADO:RENDIMIENTO_REAL:RENDIMIENTO_ES'
||'TIMADO:NOBOMBA:PRECIO_GALON:ORIGEN:NOFACTURA:GRABA:AUDITADO:FECHA_ACTUALIZADO:RECORRIDO_ANT:OPERADO'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(107248106248926082)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(107236302026925948)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_api.id(107244103960925978)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(107242025419925967)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'1462'
,p_last_upd_yyyymmddhh24miss=>'20201014173259'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(107249002479937592)
,p_plug_name=>'Form on TVALES'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(107236824023925950)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY_3'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(107249302750937592)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(107249002479937592)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(107241430857925965)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(107249622287937592)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(107249202357937592)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(107249430126937592)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(107250516886937606)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107250728877937610)
,p_name=>'P2_ROWID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
,p_field_template=>wwv_flow_api.id(107240920192925965)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107250915512937610)
,p_name=>'P2_NMVALE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(107241208189925965)
,p_item_template_options=>'#DEFAULT#'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107251108916937612)
,p_name=>'P2_FECHA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107251308949937612)
,p_name=>'P2_NOTAVIAJE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
'select nmvale,nmvale as vale from tvales ',
'where fecha = to_date (:p2_fecha,''dd/mm/yyyy'') '))
,p_lov_cascade_parent_items=>'P2_FECHA'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107251514628937612)
,p_name=>'P2_CDCLASACT'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107251725500937615)
,p_name=>'P2_CORRACT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107251914528937615)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107252102870937615)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107252305806937617)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107252500802937617)
,p_name=>'P2_CDRECIBE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107252701456937617)
,p_name=>'P2_CDEMPRESA'
,p_is_required=>true
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107252921846937617)
,p_name=>'P2_CDTIPCOMB'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107253124385937617)
,p_name=>'P2_NMBOMBA'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107253329042937618)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107253517363937618)
,p_name=>'P2_NMORDENC'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107253712069937618)
,p_name=>'P2_KMSALE'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107253920040937618)
,p_name=>'P2_KMRETORNO'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107254102501937620)
,p_name=>'P2_RECORRIDO'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107254330383937620)
,p_name=>'P2_COD_GRUPO'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107254520778937620)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107254700064937620)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107254919403937621)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107255103738937621)
,p_name=>'P2_CREADO'
,p_is_required=>true
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107255301564937621)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107255515931937621)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107255719239937623)
,p_name=>'P2_NOBOMBA'
,p_is_required=>true
,p_item_sequence=>260
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107255923616937631)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107256100617937631)
,p_name=>'P2_ORIGEN'
,p_is_required=>true
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107256306495937632)
,p_name=>'P2_NOFACTURA'
,p_is_required=>true
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107256528399937632)
,p_name=>'P2_GRABA'
,p_item_sequence=>300
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107256721538937632)
,p_name=>'P2_AUDITADO'
,p_item_sequence=>310
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107256902994937635)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107257122118937635)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107257300303937635)
,p_name=>'P2_OPERADO'
,p_item_sequence=>340
,p_item_plug_id=>wwv_flow_api.id(107249002479937592)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107261008272937643)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107261223450937643)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107261402838937643)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(107249430126937592)
);
end;
/
...
,p_step_template=>wwv_flow_api.id(107224622826925875)
,p_page_template_options=>'#DEFAULT#'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(107243326446925973)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(107236824023925950)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(107243618826925976)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(107243326446925973)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107243407062925975)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(107243326446925973)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(107243524233925976)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107243801320925978)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107243719096925976)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107244005767925978)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(107243914790925978)
,p_process_sequence=>10
